...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:38:18+00:00",
...
Azure Developer CLI (azd) konusunda uzmanlaşın ve yapılandırılmış bölümlerle öğreniminizi ilerletin. **Azure AI Foundry entegrasyonu ile AI uygulama dağıtımına özel odaklanma.**
...
Atölye materyallerimiz, yukarıdaki bölüme dayalı müfredatı tamamlayan yapılandırılmış, etkileşimli bir öğrenme deneyimi sunar. Atölye, hem kendi hızınızda öğrenme hem de eğitmen eşliğinde oturumlar için tasarlanmıştır.
...
- **Üretim AI Uygulamaları Dağıtımı**: AZD ile Azure AI Foundry hizmetlerini kullanın
- **Çoklu Ajan Mimarilerini Öğrenin**: Koordineli AI ajan çözümleri uygulayın
- **Güvenlik En İyi Uygulamaları**: Kimlik doğrulama ve erişim kontrolü yapılandırın
- **Ölçek için Optimize Edin**: Maliyet etkin, yüksek performanslı dağıtımlar tasarlayın
...
- **AI'ye Özel Yardım**: [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG) adresine katılın
...
- AI dağıtımında en iyi uygulamalara katkıda bulunun  
- Gelecekteki AI + AZD özellik geliştirmelerine etki edin  

### Kursa Katkıda Bulunma  
Katkılarınızı memnuniyetle karşılıyoruz! Detaylar için lütfen [Katkı Rehberi](CONTRIBUTING.md) dosyamızı okuyun:  
