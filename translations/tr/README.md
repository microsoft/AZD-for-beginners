...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T18:50:16+00:00",
...
- Dağıtım öncesi doğrulama ve kapasite planlamasını anlayın
...
- [**Ön Kontroller**](docs/pre-deployment/preflight-checks.md) - Otomatik doğrulama komut dosyaları
...
- [**Basit Web Uygulaması**](../../examples/simple-web-app) - Temel Node.js web uygulaması dağıtımı
- [**Statik Web Sitesi**](../../examples/static-website) - Azure Storage üzerinde statik web sitesi barındırma
- [**Konteyner Uygulaması**](../../examples/container-app) - Konteynerize edilmiş uygulama dağıtımı
- [**Veritabanı Uygulaması**](../../examples/database-app) - Veritabanı entegrasyonlu web uygulaması

### İleri Düzey Senaryolar
- [**Mikroservisler**](../../examples/microservices) - Çok hizmetli uygulama mimarisi
- [**Sunucusuz Fonksiyonlar**](../../examples/serverless-function) - Azure Functions dağıtımı
- [**Yapılandırma Örnekleri**](../../examples/configurations) - Yeniden kullanılabilir yapılandırma desenleri
...
2. [Kurulum Rehberi](docs/getting-started/installation.md) adımlarını izleyin
...
- **Sorunlar**: [Hata bildirin ve özellik isteyin](https://github.com/microsoft/azd-for-beginners/issues)
...
- [Web Geliştirme için Başlangıç](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
- [IoT için Başlangıç](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)
- [XR Geliştirme için Başlangıç](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
- [GitHub Copilot ile Yapay Zeka Eşli Programlamayı Ustalaştırma](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
- [GitHub Copilot ile C#/.NET Geliştiricileri için Ustalaştırma](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
