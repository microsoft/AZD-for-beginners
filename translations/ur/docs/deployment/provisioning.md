...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:23:05+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "ur"
}
-->
# وسائل کی فراہمی - AZD کے ساتھ انفراسٹرکچر کوڈ کے طور پر

## تعارف

یہ جامع گائیڈ آپ کو Azure Developer CLI کے ذریعے Azure وسائل کی فراہمی اور انتظام کے بارے میں سب کچھ سکھاتا ہے۔ بنیادی وسائل کی تخلیق سے لے کر اعلیٰ درجے کے انٹرپرائز انفراسٹرکچر آرکیٹیکچرز تک، Bicep، ARM templates، Terraform، اور Pulumi کا استعمال کرتے ہوئے انفراسٹرکچر کوڈ (IaC) کے پیٹرنز کو نافذ کرنے کا طریقہ سیکھیں۔

## سیکھنے کے اہداف

اس گائیڈ کو مکمل کرنے کے بعد، آپ:
- انفراسٹرکچر کوڈ کے اصولوں اور Azure وسائل کی فراہمی میں مہارت حاصل کریں گے
- Azure Developer CLI کے ذریعے متعدد IaC فراہم کنندگان کو سمجھیں گے
- عام ایپلیکیشن آرکیٹیکچرز کے لیے Bicep templates کو ڈیزائن اور نافذ کریں گے
...
- Bicep اور ARM templates کا استعمال کرتے ہوئے Azure انفراسٹرکچر کو ڈیزائن اور فراہم کریں
- مناسب وسائل کے انحصار کے ساتھ پیچیدہ ملٹی سروس آرکیٹیکچرز کو ترتیب دیں
- متعدد ماحول اور کنفیگریشنز کے لیے پیرامیٹرائزڈ templates کو نافذ کریں
- انفراسٹرکچر کی فراہمی کے مسائل کو حل کریں اور تعیناتی کی ناکامیوں کو درست کریں
- Azure Well-Architected Framework کے اصولوں کو انفراسٹرکچر ڈیزائن میں نافذ کریں
- انفراسٹرکچر اپڈیٹس کو منظم کریں اور انفراسٹرکچر ورژننگ کی حکمت عملیوں کو نافذ کریں

## انفراسٹرکچر کی فراہمی کا جائزہ

Azure Developer CLI متعدد انفراسٹرکچر کوڈ (IaC) فراہم کنندگان کی حمایت کرتا ہے:
- **Bicep** (تجویز کردہ) - Azure کی ڈومین مخصوص زبان
- **ARM Templates** - JSON پر مبنی Azure Resource Manager templates
- **Terraform** - ملٹی کلاؤڈ انفراسٹرکچر ٹول
- **Pulumi** - جدید انفراسٹرکچر کوڈ کے ساتھ پروگرامنگ زبانیں
...
- **اسٹوریج**: Storage Account، Cosmos DB، SQL Database، PostgreSQL
- **نیٹ ورکنگ**: Virtual Network، Application Gateway، CDN
- **سیکیورٹی**: Key Vault، Application Insights، Log Analytics
- **AI/ML**: Cognitive Services، OpenAI، Machine Learning

## Bicep انفراسٹرکچر templates

### بنیادی Bicep template کی ساخت
```bicep
// infra/main.bicep
...
- [پری تعیناتی منصوبہ بندی](../pre-deployment/capacity-planning.md) - وسائل کی دستیابی کی توثیق کریں
