...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T05:27:18+00:00",
  "source_file": "docs/troubleshooting/debugging.md",
  "language_code": "ur"
}
-->
# ڈیبگنگ گائیڈ - پیچیدہ مسائل کے تجزیے کے لیے اعلیٰ درجے کی تکنیکیں

## تعارف

یہ جامع گائیڈ Azure Developer CLI کی تعیناتیوں کے پیچیدہ مسائل کی تشخیص اور حل کے لیے اعلیٰ درجے کی ڈیبگنگ حکمت عملی، ٹولز، اور تکنیکیں فراہم کرتی ہے۔ منظم طریقے سے مسائل کو حل کرنے کے طریقے، لاگ تجزیے کی تکنیکیں، کارکردگی پروفائلنگ، اور اعلیٰ درجے کے تشخیصی ٹولز سیکھیں تاکہ تعیناتی اور رن ٹائم مسائل کو مؤثر طریقے سے حل کیا جا سکے۔

## سیکھنے کے اہداف

اس گائیڈ کو مکمل کرنے کے بعد آپ:
- Azure Developer CLI کے مسائل کے لیے منظم ڈیبگنگ طریقے سیکھیں گے
- اعلیٰ درجے کی لاگنگ کنفیگریشن اور لاگ تجزیے کی تکنیکوں کو سمجھیں گے
- کارکردگی پروفائلنگ اور مانیٹرنگ حکمت عملیوں کو نافذ کریں گے
- پیچیدہ مسائل کے حل کے لیے Azure کے تشخیصی ٹولز اور خدمات استعمال کریں گے
- نیٹ ورک ڈیبگنگ اور سیکیورٹی مسائل کے حل کی تکنیکوں کو اپنائیں گے
- مسائل کی پیشگی شناخت کے لیے جامع مانیٹرنگ اور الرٹنگ کو ترتیب دیں گے

## سیکھنے کے نتائج

گائیڈ مکمل کرنے کے بعد آپ:
- پیچیدہ تعیناتی مسائل کو منظم طریقے سے ڈیبگ کرنے کے لیے TRIAGE طریقہ کار اپنائیں گے
- جامع لاگنگ اور ٹریسنگ معلومات کو ترتیب دیں گے اور تجزیہ کریں گے
...
- کارکردگی کی نگرانی اور اصلاح کی حکمت عملیوں کو نافذ کریں گے
- بار بار پیش آنے والے مسائل کے لیے حسب ضرورت ڈیبگنگ اسکرپٹس اور آٹومیشن بنائیں گے
...
- `log-analyzer.py` - اعلیٰ درجے کی لاگ پارسنگ اور تجزیہ
...
- [پری فلائٹ چیکس](../pre-deployment/preflight-checks.md) - تعیناتی سے پہلے کی توثیق
- [چیٹ شیٹ](../../resources/cheat-sheet.md) - فوری حوالہ کمانڈز

---

**یاد رکھیں**: اچھی ڈیبگنگ منظم، مکمل، اور صبر سے کام لینے کے بارے میں ہے۔ یہ ٹولز اور تکنیکیں آپ کو مسائل کی تشخیص تیز اور مؤثر طریقے سے کرنے میں مدد کریں گی۔
