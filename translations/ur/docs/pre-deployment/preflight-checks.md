...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:35:09+00:00",
  "source_file": "docs/pre-deployment/preflight-checks.md",
  "language_code": "ur"
}
-->
# پری فلائٹ چیکس - تعیناتی کی تیاری کی تصدیق

## تعارف

یہ جامع گائیڈ تعیناتی سے پہلے Azure Developer CLI کی کامیاب تعیناتی کو یقینی بنانے کے لیے پری تعیناتی تصدیقی اسکرپٹس اور طریقہ کار فراہم کرتا ہے۔ تصدیق کے خودکار چیکس کو نافذ کرنا سیکھیں، جیسے کہ توثیق، وسائل کی دستیابی، کوٹاز، سیکیورٹی کی تعمیل، اور کارکردگی کی ضروریات، تاکہ تعیناتی کی ناکامیوں کو روکا جا سکے اور کامیابی کی شرح کو بہتر بنایا جا سکے۔

## سیکھنے کے اہداف

اس گائیڈ کو مکمل کرنے کے بعد، آپ:
- پری تعیناتی کی خودکار تصدیقی تکنیک اور اسکرپٹس میں مہارت حاصل کریں گے
- توثیق، اجازتوں، اور کوٹاز کے لیے جامع چیکنگ حکمت عملی کو سمجھیں گے
- وسائل کی دستیابی اور صلاحیت کی تصدیق کے طریقہ کار کو نافذ کریں گے
- تنظیمی پالیسیوں کے لیے سیکیورٹی اور تعمیل چیکس کو ترتیب دیں گے
- لاگت کے تخمینے اور بجٹ کی تصدیق کے ورک فلو کو ڈیزائن کریں گے
- CI/CD پائپ لائنز کے لیے حسب ضرورت پری فلائٹ چیک آٹومیشن بنائیں گے

## سیکھنے کے نتائج

گائیڈ مکمل کرنے کے بعد، آپ:
- جامع پری فلائٹ تصدیقی اسکرپٹس بنا اور چلا سکیں گے
- مختلف تعیناتی کے منظرناموں کے لیے خودکار چیکنگ ورک فلو ڈیزائن کریں گے
- ماحول کے لحاظ سے مخصوص تصدیقی طریقہ کار اور پالیسیاں نافذ کریں گے
- تعیناتی کی تیاری کے لیے فعال نگرانی اور الرٹ ترتیب دیں گے
- پری تعیناتی کے مسائل کو حل کریں گے اور اصلاحی اقدامات نافذ کریں گے
...
- [دستی تصدیقی چیک لسٹ](../../../../docs/pre-deployment)
- [ماحول کی تصدیق](../../../../docs/pre-deployment)
- [وسائل کی تصدیق](../../../../docs/pre-deployment)
- [سیکیورٹی اور تعمیل چیکس](../../../../docs/pre-deployment)
- [کارکردگی اور صلاحیت کی منصوبہ بندی](../../../../docs/pre-deployment)
...
پری فلائٹ چیکس تعیناتی سے پہلے کیے جانے والے ضروری تصدیقی اقدامات ہیں تاکہ یہ یقینی بنایا جا سکے:

- **وسائل کی دستیابی** اور ہدف کے علاقوں میں کوٹاز
- **توثیق اور اجازتیں** مناسب طریقے سے ترتیب دی گئی ہیں
- **ٹیمپلیٹ کی درستگی** اور پیرامیٹرز کی درستگی
- **نیٹ ورک کنیکٹیویٹی** اور انحصار
- **سیکیورٹی کی تعمیل** تنظیمی پالیسیوں کے ساتھ
- **لاگت کا تخمینہ** بجٹ کی حدود میں

### پری فلائٹ چیکس کب چلائیں

- **پہلی تعیناتی سے پہلے** کسی نئے ماحول میں
- **اہم ٹیمپلیٹ تبدیلیوں کے بعد**
- **پروڈکشن تعیناتیوں سے پہلے**
- **Azure کے علاقوں کو تبدیل کرتے وقت**
...
اس چیک لسٹ کو پرنٹ کریں اور تعیناتی سے پہلے ہر آئٹم کی تصدیق کریں:

#### ✅ ماحول کی ترتیب
- [ ] AZD CLI انسٹال اور تازہ ترین ورژن پر اپ ڈیٹ کیا گیا
- [ ] Azure CLI انسٹال اور توثیق شدہ
- [ ] درست Azure سبسکرپشن منتخب کی گئی
- [ ] ماحول کا نام منفرد ہے اور نام دینے کے اصولوں پر عمل کرتا ہے
- [ ] ہدف کے وسائل گروپ کی شناخت کی گئی یا بنایا جا سکتا ہے

#### ✅ توثیق اور اجازتیں
- [ ] `azd auth login` کے ساتھ کامیابی سے توثیق کی گئی
...
- [ ] ہدف Azure علاقہ منتخب اور تصدیق شدہ
- [ ] ہدف کے علاقے میں مطلوبہ Azure سروسز دستیاب ہیں
- [ ] منصوبہ بند وسائل کے لیے کافی کوٹاز دستیاب ہیں
- [ ] وسائل کے نام کے تنازعات کی جانچ کی گئی
- [ ] وسائل کے درمیان انحصار کو سمجھا گیا

#### ✅ نیٹ ورک اور سیکیورٹی
- [ ] Azure کے اینڈ پوائنٹس کے لیے نیٹ ورک کنیکٹیویٹی کی تصدیق کی گئی
...
- [ ] بحالی کے وقت کے مقاصد (RTO) دستاویزی کیے گئے
- [ ] بحالی کے نقطہ کے مقاصد (RPO) دستاویزی کیے گئے
...
1. **جہاں ممکن ہو خودکار بنائیں**
   ...
   - دہرائے جانے والے تصدیقی اقدامات کے لیے اسکرپٹس استعمال کریں
   - آڈٹ ٹریلز کے لیے نتائج کو محفوظ کریں

2. **ماحول کے لحاظ سے مخصوص تصدیق**
...
1. **تصدیق کو چھوڑ دینا** "جلدی" تعیناتیوں کے لیے
2. **ناکافی اجازتوں** کی جانچ تعیناتی سے پہلے
3. **کوٹا حدود کو نظر انداز کرنا** جب تک کہ تعیناتی ناکام نہ ہو
4. **ٹیمپلیٹس کی تصدیق نہ کرنا** CI/CD پائپ لائنز میں
5. **پروڈکشن ماحول کے لیے سیکیورٹی کی تصدیق کو چھوڑ دینا**
6. **ناکافی لاگت کا تخمینہ** جس سے بجٹ کے حیرت انگیز مسائل پیدا ہوتے ہیں

---

**پرو ٹپ**: پری فلائٹ چیکس کو اپنی CI/CD پائپ لائن میں ایک علیحدہ جاب کے طور پر چلائیں، اصل تعیناتی جاب سے پہلے۔ یہ آپ کو مسائل جلدی پکڑنے کی اجازت دیتا ہے اور ڈویلپرز کو تیز تر فیڈبیک فراہم کرتا ہے۔
