...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:41:36+00:00",
...
**پچھلا:** [مین دستاویزات](../../README.md) | **اگلا:** [AZD بنیادی معلومات](azd-basics.md)

## تعارف

یہ جامع گائیڈ آپ کو Azure Developer CLI (azd) کو اپنے سسٹم پر انسٹال اور کنفیگر کرنے کے مراحل سے گزارے گی۔ آپ مختلف آپریٹنگ سسٹمز کے لیے انسٹالیشن کے متعدد طریقے، تصدیق کی سیٹ اپ، اور ابتدائی کنفیگریشن سیکھیں گے تاکہ آپ اپنے ڈیولپمنٹ ماحول کو Azure ڈیپلائمنٹس کے لیے تیار کر سکیں۔
...
- اپنی انسٹالیشن کی تصدیق کریں اور azd کے بنیادی کمانڈز کو ٹیسٹ کریں
...
- **Git** - ٹیمپلیٹس کو کلون کرنے اور ورژن کنٹرول کے لیے
...
#### آپشن 2: ونڈوز پیکج مینیجر (winget)
```cmd
...
1. **تصدیق مکمل کریں**: یقینی بنائیں کہ آپ اپنے Azure سبسکرپشن تک رسائی حاصل کر سکتے ہیں
