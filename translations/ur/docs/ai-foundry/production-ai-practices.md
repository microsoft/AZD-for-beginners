...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:32:03+00:00",
...
**پچھلا:** [AI ورکشاپ لیب](ai-workshop-lab.md) | **اگلا:** [AI ٹربل شوٹنگ گائیڈ](../troubleshooting/ai-troubleshooting.md)

## جائزہ

یہ گائیڈ Azure Developer CLI (AZD) کا استعمال کرتے ہوئے پروڈکشن کے لیے تیار AI ورک لوڈز کو ڈیپلائے کرنے کے بہترین طریقے فراہم کرتی ہے۔ Azure AI Foundry Discord کمیونٹی اور حقیقی دنیا کے کسٹمر ڈیپلائمنٹس سے حاصل کردہ فیڈبیک کی بنیاد پر، یہ طریقے پروڈکشن AI سسٹمز میں عام چیلنجز کو حل کرتے ہیں۔
...
- **29%** کو مانیٹرنگ اور ٹربل شوٹنگ میں بہتری کی ضرورت ہوتی ہے  
...
- نیٹ ورک کو پرائیویٹ اینڈ پوائنٹس کے ساتھ الگ کریں  
- کم سے کم رسائی کے کنٹرولز نافذ کریں  
...
- [ ] وسائل کی درست سائز بندی  
- [ ] ڈیو/ٹیسٹ ڈسکاؤنٹس اپلائیڈ  
...
- ❌ ہیلتھ چیکس کے بغیر ڈیپلائمنٹ  

## اضافی وسائل

- **Azure Well-Architected Framework**: [AI ورک لوڈ گائیڈنس](https://learn.microsoft.com/azure/well-architected/ai/)  
- **Azure AI Foundry Documentation**: [آفیشل ڈاکس](https://learn.microsoft.com/azure/ai-studio/)  
