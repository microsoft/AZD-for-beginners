...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:18:36+00:00",
...
**پچھلا:** [AI ماڈل ڈیپلائمنٹ](ai-model-deployment.md) | **اگلا:** [پروڈکشن اے آئی پریکٹسز](production-ai-practices.md)

## ورکشاپ کا جائزہ

یہ عملی لیب ڈویلپرز کو موجودہ اے آئی ایپلیکیشن کو Azure Developer CLI (AZD) کے ذریعے ڈیپلائمنٹ کے قابل بنانے کے عمل سے گزارتا ہے۔ آپ Azure AI Foundry سروسز کا استعمال کرتے ہوئے پروڈکشن اے آئی ڈیپلائمنٹ کے ضروری پیٹرنز سیکھیں گے۔

**دورانیہ:** 2-3 گھنٹے  
**سطح:** درمیانی  
**ضروریات:** Azure کا بنیادی علم، AI/ML تصورات سے واقفیت

## 🎓 سیکھنے کے مقاصد

اس ورکشاپ کے اختتام تک، آپ یہ کرنے کے قابل ہوں گے:
- ✅ موجودہ اے آئی ایپلیکیشن کو AZD ٹیمپلیٹس میں تبدیل کریں
- ✅ AZD کے ساتھ Azure AI Foundry سروسز کو کنفیگر کریں
- ✅ اے آئی سروسز کے لیے محفوظ کریڈینشل مینجمنٹ نافذ کریں
- ✅ پروڈکشن کے لیے تیار اے آئی ایپلیکیشنز کو مانیٹرنگ کے ساتھ ڈیپلائے کریں
...
### اے آئی AZD ٹیمپلیٹ کی ساخت

اے آئی کے لیے تیار AZD ٹیمپلیٹ میں کلیدی فائلز کو دریافت کریں:
...
- **لاگت کا انتظام**: اگر صحیح طریقے سے کنفیگر نہ کیا جائے تو اے آئی سروسز مہنگی ہو سکتی ہیں
...
3. **اے آئی فنکشنلٹی کو ٹیسٹ کریں:**
...
**حل کے اشارے:**
- Cognitive Services کے لیے F0 (مفت) درجے کا استعمال کریں جب ممکن ہو
...
**چیک لسٹ:**
- [ ] کوڈ یا کنفیگریشن میں کوئی ہارڈ کوڈڈ سیکریٹس نہیں
- [ ] سروس ٹو سروس آتھینٹیکیشن کے لیے Managed Identity استعمال کیا گیا ہے
...
**علامات:** 403 Forbidden ایررز جب اے آئی سروسز کو کال کیا جاتا ہے
**حل:**
```bash
...
- ہائی لوڈ کے منظرناموں کے لیے ریڈ ریپلیکاز پر غور کریں
...
- OpenAI کے لیے ٹوکن استعمال کی مانیٹرنگ کریں
...
آپ کو ایک پروڈکشن کے لیے تیار اے آئی پاورڈ کسٹمر سروس چیٹ بوٹ بنانے کا کام دیا گیا ہے جس میں یہ ضروریات ہوں:
...
### Microsoft دستاویزات
- [Azure Developer CLI دستاویزات](https://learn.microsoft.com/azure/developer/azure-developer
- ✅ اے آئی ورک لوڈز کے لیے سیکیورٹی کے بہترین طریقے نافذ کریں  
- ✅ اے آئی ایپلیکیشن کی کارکردگی کی نگرانی کریں اور اسے بہتر بنائیں  
- ✅ عام تعیناتی مسائل کو حل کریں  

### اگلے اقدامات  
1. ان پیٹرنز کو اپنے اے آئی پروجیکٹس میں نافذ کریں  
2. کمیونٹی کے ساتھ ٹیمپلیٹس شیئر کریں  
...
**پچھلا:** [AI ماڈل کی تعیناتی](ai-model-deployment.md) | **اگلا:** [پروڈکشن اے آئی کے طریقے](production-ai-practices.md)  

**مدد چاہیے؟** AZD اور اے آئی تعیناتیوں کے بارے میں مدد اور گفتگو کے لیے ہماری کمیونٹی میں شامل ہوں۔  
