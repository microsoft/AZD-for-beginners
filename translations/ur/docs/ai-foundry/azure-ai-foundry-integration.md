...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:27:55+00:00",
...
**پچھلا:** [پہلا پروجیکٹ](../getting-started/first-project.md) | **اگلا:** [AI ماڈل کی تعیناتی](ai-model-deployment.md)

## جائزہ

یہ گائیڈ دکھاتا ہے کہ Azure AI Foundry سروسز کو Azure Developer CLI (AZD) کے ساتھ کیسے مربوط کیا جائے تاکہ AI ایپلیکیشنز کی تعیناتی کو آسان بنایا جا سکے۔ Azure AI Foundry ایک جامع پلیٹ فارم فراہم کرتا ہے جو AI ایپلیکیشنز کی تعمیر، تعیناتی، اور انتظام کے لیے ہے، جبکہ AZD انفراسٹرکچر اور تعیناتی کے عمل کو آسان بناتا ہے۔

## Azure AI Foundry کیا ہے؟

Azure AI Foundry مائیکروسافٹ کا متحد پلیٹ فارم ہے جو AI کی ترقی کے لیے شامل کرتا ہے:
...
|---------|-----------------|------------------------|
| **ماڈل کی تعیناتی** | دستی پورٹل تعیناتی | خودکار، دہرائی جانے والی تعیناتیاں |
...
- Azure AI Foundry کی بنیادی معلومات
...
6. **پروڈکشن تک اسکیل کریں**: متعدد خطوں اور اعلی دستیابی کی خصوصیات شامل کریں
