...
4. **اپنا تعلیمی راستہ منتخب کریں**: نیچے سے اپنا تجربہ کی سطح کے مطابق باب منتخب کریں
...
- **انفراسٹرکچر ایز کوڈ نافذ کریں گے**: Bicep ٹیمپلیٹس کے ذریعے Azure وسائل کا انتظام کریں
...
**💰 لاگت کی آگاہی:** $80-150/ماہ ترقیاتی لاگت، $300-3500/ماہ پروڈکشن لاگت سمجھیں
...
> **نوٹ:** یہ ٹیمپلیٹس مختلف AI نمونے دکھاتے ہیں۔ کچھ بیرونی Azure Samples ہیں، کچھ مقامی نفاذ۔
...
### ❌ "InsufficientQuota" یا "کوٹا ختم ہو گیا"
...
### ❌ ٹیمپلیٹ کی تعیناتی میں بہت زیادہ وقت لگ رہا ہے
