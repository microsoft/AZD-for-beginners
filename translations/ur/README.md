...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:53:17+00:00",
...
AZD سیکھنے کے سفر کا آغاز کرنے کے لیے ان مراحل پر عمل کریں:
...
2. **ریپوزٹری کلون کریں**: `git clone https://github.com/microsoft/azd-for-beginners.git`
...
Azure AI Foundry Discord کمیونٹی کی بصیرت کے مطابق، **45% ڈویلپرز AZD کو AI ورک لوڈز کے لیے استعمال کرنا چاہتے ہیں** لیکن انہیں درج ذیل چیلنجز کا سامنا ہے:
...
- **AZD بنیادی اصولوں میں مہارت حاصل کریں گے**: بنیادی تصورات، تنصیب، اور ترتیب
...
- AI مخصوص خرابیوں کا سراغ لگانا
...
- **🤖 AI مسائل**: [AI مخصوص خرابیوں کا سراغ لگانا](docs/troubleshooting/ai-troubleshooting.md) - AI سروس کے مسائل
...
**💡 باب کا نتیجہ**: عام تعیناتی کے مسائل کی خود سے تشخیص اور حل کریں
...
#### عملی مشقیں
- انٹرپرائز سیکیورٹی پیٹرنز کو نافذ کریں  
- جامع مانیٹرنگ سیٹ اپ کریں  
- مناسب گورننس کے ساتھ پروڈکشن میں ڈیپلائے کریں  

**💡 باب کا نتیجہ**: مکمل پروڈکشن صلاحیتوں کے ساتھ انٹرپرائز ریڈی ایپلیکیشنز کو ڈیپلائے کریں  
...
ہمارے ورکشاپ مواد ایک منظم، انٹرایکٹو سیکھنے کا تجربہ فراہم کرتے ہیں جو اوپر دیے گئے باب پر مبنی نصاب کی تکمیل کرتے ہیں۔ یہ ورکشاپ خود سے سیکھنے اور انسٹرکٹر کی رہنمائی میں سیشنز دونوں کے لیے ڈیزائن کی گئی ہے۔

#### 🛠️ ورکشاپ کی خصوصیات
- **براؤزر پر مبنی انٹرفیس**: MkDocs پر مبنی ورکشاپ جس میں سرچ، کاپی، اور تھیم کی خصوصیات شامل ہیں  
...
- **انٹرایکٹو DevContainer ماحول**: پہلے سے کنفیگرڈ ٹولز اور ڈیپینڈنسیز  

#### 📚 ورکشاپ کا ڈھانچہ
ورکشاپ **ڈسکوری → ڈیپلائمنٹ → کسٹمائزیشن** کے طریقہ کار پر عمل کرتی ہے:
...
2. **ڈیپلائمنٹ مرحلہ** (2 گھنٹے)  
   ...
   - سیکیورٹی اور تصدیق کے پیٹرنز کو نافذ کریں  
...
- **پروڈکشن AI ایپلیکیشنز کو ڈیپلائے کریں گے**: AZD کے ساتھ Azure AI Foundry سروسز کا استعمال  
...
- **اسکیل کے لیے اصلاح کریں گے**: لاگت مؤثر اور کارکردگی کے حامل ڈیپلائمنٹس ڈیزائن کریں گے  
...
- **📋 مرحلہ وار ہدایات**: [گائیڈڈ مشقیں](../../workshop/docs/instructions) - تفصیلی واک تھروز  
...
- **انٹیگریٹڈ ورک فلو** - ایپلیکیشنز کو بآسانی پروویژن، ڈیپلائے، اور مانیٹر کریں  
- **ڈیولپر فرینڈلی** - ڈیولپر کی پیداواریت اور تجربے کے لیے بہتر بنایا گیا  
...
- **لاگت کی اصلاح** - AI ورک لوڈز کے لیے اسمارٹ وسائل کی تقسیم اور اسکیلنگ کی حکمت عملیاں  
...
**اگر آپ AI ایپلیکیشنز کو ڈیپلائے کر رہے ہیں تو یہاں سے شروع کریں!**
...
- [بنیادی API](../../examples/basic-api) - REST API کی ڈیپلائمنٹ  
...
#### جدید پیٹرنز (ابواب 4-8)
- [کنٹینر ایپس](../../examples/container-app) - کنٹینرائزڈ ڈیپلائمنٹس  
- [مائیکرو سروسز](../../examples/microservices) - ملٹی سروس آرکیٹیکچرز  
- [انٹرپرائز حل](../../examples/enterprise) - پروڈکشن ریڈی پیٹرنز  

### بیرونی ٹیمپلیٹ کلیکشنز
- [**آفیشل AZD ٹیمپلیٹ گیلری**](https://azure.github.io/awesome-azd/) - آفیشل اور کمیونٹی ٹیمپلیٹس کا منتخب مجموعہ  
...
### فوری حوالہ جات
- [**کمانڈ چیٹ شیٹ**](resources/cheat-sheet.md) - ضروری azd کمانڈز ابواب کے لحاظ سے منظم  
- [**اصطلاحات**](resources/glossary.md) - Azure اور azd کی اصطلاحات  
- [**عمومی سوالات**](resources/faq.md) - عام سوالات ابواب کے لحاظ سے منظم  
...
- **پیشہ ورانہ مہارتیں**: انٹرپرائز ریڈی ڈیپلائمنٹ کی صلاحیتیں  
- **کمیونٹی کی پہچان**: Azure ڈیولپر کمیونٹی کے فعال رکن  
- **کیریئر کی ترقی**: AZD اور AI ڈیپلائمنٹ کی مہارتوں کی مانگ  
...
- **AI سے متعلق مدد**: [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG) میں شامل ہوں  
- **دستاویزات**: [Azure Developer CLI کی آفیشل دستاویزات](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)  

### Azure
- AI کی تعیناتی کے بہترین طریقوں میں تعاون کریں  
- مستقبل کے AI + AZD فیچر کی ترقی پر اثر ڈالیں  

### کورس میں تعاون  
ہم تعاون کا خیر مقدم کرتے ہیں! براہ کرم ہمارے [Contributing Guide](CONTRIBUTING.md) کو پڑھیں تاکہ آپ کو درج ذیل پر تفصیلات مل سکیں:  
...
- **کمیونٹی کے معیار**: ہماری جامع کمیونٹی کے رہنما اصولوں پر عمل کریں  
