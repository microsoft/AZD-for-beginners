...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T14:49:33+00:00",
...
Azure Developer CLI (azd) کے لیے جامع گائیڈ میں خوش آمدید۔ یہ ریپوزٹری طلباء سے لے کر پیشہ ور ڈویلپرز تک ہر سطح کے ڈویلپرز کو Azure Developer CLI سیکھنے اور کلاؤڈ ڈیپلائمنٹ کو مؤثر طریقے سے انجام دینے میں مدد فراہم کرنے کے لیے ڈیزائن کی گئی ہے، **خاص طور پر Azure AI Foundry کے ذریعے AI ایپلیکیشن ڈیپلائمنٹ پر توجہ کے ساتھ**۔ یہ منظم تعلیمی وسائل Azure کلاؤڈ ڈیپلائمنٹ، عام مسائل کے حل، اور کامیاب AZD ٹیمپلیٹ ڈیپلائمنٹ کے لیے بہترین طریقوں کو نافذ کرنے کا عملی تجربہ فراہم کرتے ہیں۔

### **AI ڈویلپرز کے لیے یہ گائیڈ کیوں اہم ہے**
...
- Azure Developer CLI کے بنیادی اصولوں اور بنیادی تصورات میں مہارت حاصل کریں گے
- انفراسٹرکچر کوڈ کے ذریعے Azure وسائل کو ڈیپلائے اور پروویژن کرنا سیکھیں گے
- عام AZD ڈیپلائمنٹ مسائل کے لیے حل تلاش کرنے کی مہارت حاصل کریں گے
...
- AZD ٹیمپلیٹس کا استعمال کرتے ہوئے ایپلیکیشنز بنائیں اور ڈیپلائے کریں گے
- تصدیق، انفراسٹرکچر، اور ڈیپلائمنٹ کے مسائل کو حل کریں گے
- پری ڈیپلائمنٹ چیکس بشمول صلاحیت کی منصوبہ بندی اور SKU کا انتخاب انجام دیں گے
- مانیٹرنگ، سیکیورٹی، اور لاگت کے انتظام کے بہترین طریقے نافذ کریں گے
- AZD ورک فلو کو CI/CD پائپ لائنز میں انٹیگریٹ کریں گے
...
- **ٹیمپلیٹ پر مبنی ڈیپلائمنٹ** - عام ایپلیکیشن پیٹرنز کے لیے پہلے سے تیار کردہ ٹیمپلیٹس استعمال کریں
- **انفراسٹرکچر کوڈ کے طور پر** - Bicep یا Terraform کے ذریعے Azure وسائل کا انتظام کریں
...
- **پروڈکشن AI پیٹرنز** - قابل توسیع، لاگت مؤثر AI ایپلیکیشن ڈیپلائمنٹ کے بہترین طریقے
- **اینڈ ٹو اینڈ AI ورک فلو** - ماڈل ڈیولپمنٹ سے پروڈکشن ڈیپلائمنٹ تک مناسب مانیٹرنگ کے ساتھ
- **لاگت کی اصلاح** - AI ورک لوڈز کے لیے سمارٹ وسائل کی مختص اور اسکیلنگ حکمت عملی
- **Azure AI Foundry انٹیگریشن** - AI Foundry ماڈل کیٹلاگ اور اینڈ پوائنٹس سے آسان کنکشن

## جلدی شروع کریں

### ضروریات
- Azure سبسکرپشن
- Azure CLI انسٹال کیا ہوا
...
### AI ڈویلپرز کے لیے (یہاں سے شروع کریں!)
1. **جلدی شروع کریں**: [azure-search-openai-demo](https://github.com/Azure-Samples/azure-search-openai-demo) ٹیمپلیٹ آزمائیں
2. **بنیادی اصول سیکھیں**: [AZD Basics](docs/getting-started/azd-basics.md) + [Azure AI Foundry انٹیگریشن](docs/ai-foundry/azure-ai-foundry-integration.md)
3. **عملی تجربہ**: [AI ورکشاپ لیب](docs/ai-foundry/ai-workshop-lab.md) مکمل کریں
...
### DevOps انجینئرز کے لیے
1. [وسائل پروویژننگ](docs/deployment/provisioning.md) میں مہارت حاصل کریں
2. [پری فلائٹ چیکس](docs/pre-deployment/preflight-checks.md) نافذ کریں
3. [صلاحیت کی منصوبہ بندی](docs/pre-deployment/capacity-planning.md) پر مشق کریں
...
- [**وسائل پروویژننگ**](docs/deployment/provisioning.md) - Azure وسائل کا انتظام
...
- [**AI ورکشاپ لیب**](docs/ai-foundry/ai-workshop-lab.md) - عملی تجربہ: AI حل کو AZD ریڈی بنانا
...
| [**اپنا گفتگو کرنے والا ایجنٹ بنائیں**](https://github.com/Azure-Samples/get-started-with-ai-chat) | جدید گفتگو کی سمجھ بوجھ کا فائدہ اٹھائیں تاکہ چیٹ بوٹس اور ایجنٹس کو ڈیٹرمینسٹک اور انسانی کنٹرول کے قابل ورک فلو کے ساتھ بنائیں اور بہتر کریں۔ |⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Azure Storage + Azure Container Registry|
| [**گفتگو کے ڈیٹا سے ان سائٹس حاصل کریں**](https://github.com/Azure-Samples/get-started-with-ai-chat) | بڑے آڈیو اور ٹیکسٹ ڈیٹا سیٹس سے ان سائٹس حاصل کرکے کانٹیکٹ سینٹر کی کارکردگی کو بہتر بنائیں۔ |⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
| [**ملٹی موڈل مواد کی پروسیسنگ**](https://github.com/Azure-Samples/get-started-with-ai-chat) | غیر ساختہ مواد سے معلومات نکال کر اور اسے ساختہ فارمیٹ میں میپ کرکے دعوے، انوائسز، معاہدے اور دیگر دستاویزات کو تیزی اور درستگی سے پروسیس کریں۔ یہ ٹیمپلیٹ ٹیکسٹ، تصاویر، ٹیبلز اور گرافز کو سپورٹ کرتا ہے۔ |⭐⭐⭐⭐ | AzureOpenAI + Azure Content Understanding + Azure CosmosDB + Azure Container Apps|
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | AI آرکیسٹریشن کے ساتھ انٹرپرائز چیٹ | ⭐⭐⭐ | AzureOpenAI + Azure AI Search + Container Apps |
...
- **AI سے متعلق سپورٹ**: AZD + AI Foundry مباحثے کے لیے [#Azure چینل](https://discord.gg/microsoft-azure) میں شامل ہوں
- **ای میل**: نجی انکوائری کے لیے
- **Microsoft Learn**: [Azure Developer CLI دستاویزات](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)
