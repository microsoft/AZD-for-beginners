...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:44:21+00:00",
...
**پچھلا:** [AI ٹربل شوٹنگ گائیڈ](../docs/troubleshooting/ai-troubleshooting.md) | **اگلا:** [ورکشاپ لیب ماڈیولز](../../../workshop)
...
- 🤖 **AI سروس انضمام**: Azure OpenAI، AI Search، اور دیگر AI سروسز کی تعیناتی  
- **کنٹینر تعیناتی**: Azure Container Apps کا استعمال کرتے ہوئے AI ایپلیکیشنز  
...
- **پروڈکشن پیٹرنز**: انٹرپرائز کے لیے تیار تعیناتی کی حکمت عملی  
...
- **[lab-3-rag-search/](../../../workshop/lab-3-rag-search)** - AI Search کے ساتھ RAG ایپلیکیشن  
...
ورکشاپ شروع کرنے کا سب سے تیز طریقہ:
...
✅ **RAG ایپلیکیشنز بنائیں** Azure AI Search انضمام کے ساتھ  
✅ **پروڈکشن پیٹرنز نافذ کریں** انٹرپرائز AI ورک لوڈز کے لیے  
✅ **مانیٹر اور ٹربل شوٹ کریں** AI ایپلیکیشنز کی تعیناتی  
✅ **لاگت کی اصلاح کی حکمت عملی اپنائیں** AI ورک لوڈز کے لیے  
...
- **ٹپس**: دریافتیں دوسرے شرکاء کے ساتھ شیئر کریں  

### ورکشاپ کے بعد

- 💬 **ڈسکارڈ**: [Azure AI Foundry کمیونٹی](https://aka.ms/foundry/discord)  
- **GitHub Issues**: [ٹیمپلیٹ مسائل رپورٹ کریں](https://github.com/YOUR_ORG/AZD-for-beginners/issues)  
...
[لیب 1 شروع کریں: AZD کی بنیادیں →](./lab-1-azd-basics/README.md)
