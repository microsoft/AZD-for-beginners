...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:49:29+00:00",
...
- **🔧 ایڈوانسڈ**: [باب 4: انفراسٹرکچر بطور کوڈ](../README.md#️-chapter-4-infrastructure-as-code--deployment)

## تعارف

یہ جامع چیٹ شیٹ Azure Developer CLI کمانڈز کے لیے فوری حوالہ فراہم کرتی ہے، جو زمرہ جات کے لحاظ سے عملی مثالوں کے ساتھ ترتیب دی گئی ہیں۔ ترقی، مسئلہ حل کرنے، اور روزمرہ کے آپریشنز کے دوران azd پروجیکٹس کے لیے بہترین ہے۔

## سیکھنے کے اہداف

اس چیٹ شیٹ کے استعمال سے آپ:
- ضروری Azure Developer CLI کمانڈز اور ان کے سینٹیکس تک فوری رسائی حاصل کریں گے
...
- مسئلہ حل کرنے کے کمانڈز کو فوری طور پر استعمال کریں گے
...
اس چیٹ شیٹ کا باقاعدہ حوالہ دینے سے آپ:
- azd کمانڈز کو اعتماد کے ساتھ استعمال کریں گے بغیر مکمل دستاویزات کا حوالہ دیے
- مناسب تشخیصی کمانڈز کے ذریعے عام مسائل کو جلدی حل کریں گے
- متعدد ماحول اور تعیناتی کے منظرناموں کو مؤثر طریقے سے منظم کریں گے
- ضرورت کے مطابق azd کی ایڈوانسڈ خصوصیات اور کنفیگریشن کے اختیارات کو لاگو کریں گے
- تعیناتی کے مسائل کو منظم کمانڈ سیکوینسز کے ذریعے حل کریں گے
