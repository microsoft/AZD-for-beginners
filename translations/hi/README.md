...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:07:16+00:00",
...
- **इन्फ्रास्ट्रक्चर ऐज़ कोड लागू करेंगे**: Bicep टेम्प्लेट के साथ Azure संसाधनों का प्रबंधन
...
- **📋 टेम्प्लेट**: [Microsoft Foundry टेम्प्लेट](../..)
...
- उपभोग-आधारित बिलिंग से शुरू करें, केवल प्रोडक्शन के लिए PTU में अपग्रेड करें
...
**💡 अध्याय परिणाम**: कस्टम इन्फ्रास्ट्रक्चर टेम्प्लेट का उपयोग करके जटिल मल्टी-सर्विस एप्लिकेशन तैनात करें
...
**💡 अध्याय परिणाम**: पूर्ण उत्पादन क्षमताओं के साथ एंटरप्राइज-तैयार अनुप्रयोग तैनात करें
...
- **टेम्प्लेट-आधारित तैनाती** - सामान्य अनुप्रयोग पैटर्न के लिए पूर्व-निर्मित टेम्प्लेट का उपयोग करें
- **इन्फ्रास्ट्रक्चर ऐज़ कोड** - Bicep या Terraform का उपयोग करके Azure संसाधनों का प्रबंधन करें  
- **एकीकृत वर्कफ़्लोज़** - अनुप्रयोगों को सहजता से प्रोविजन, तैनात और मॉनिटर करें
...
- **उत्पादन AI पैटर्न** - स्केलेबल, लागत-कुशल AI अनुप्रयोग तैनाती के लिए सर्वोत्तम प्रथाएँ
...
- [**कंटेनर ऐप उदाहरण**](examples/container-app/README.md) - कंटेनरीकृत तैनाती के लिए पूर्ण मार्गदर्शिका
...
# तो फिर से नए वातावरण के साथ पुनः प्रयास करें
azd env new dev-v2
azd up
```
...
- **प्रोडक्शन अनुभव**: Azure पर वास्तविक AI एप्लिकेशन डिप्लॉय किए
