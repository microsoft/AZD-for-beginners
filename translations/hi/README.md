...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T10:44:11+00:00",
...
Azure Developer CLI (azd) को चरणबद्ध अध्यायों के माध्यम से मास्टर करें, जो प्रगतिशील सीखने के लिए डिज़ाइन किए गए हैं। **Microsoft Foundry एकीकरण के साथ AI एप्लिकेशन डिप्लॉयमेंट पर विशेष ध्यान।**

### यह कोर्स आधुनिक डेवलपर्स के लिए क्यों आवश्यक है

Microsoft Foundry Discord समुदाय की अंतर्दृष्टि के आधार पर, **45% डेवलपर्स AZD का उपयोग AI वर्कलोड्स के लिए करना चाहते हैं**, लेकिन उन्हें इन चुनौतियों का सामना करना पड़ता है:
...
- **AZD की मूल बातें मास्टर करें**: कोर अवधारणाएं, इंस्टॉलेशन और कॉन्फ़िगरेशन
...
- **📖 सिद्धांत**: [AZD की मूल बातें](docs/getting-started/azd-basics.md) - कोर अवधारणाएं और शब्दावली
- **⚙️ सेटअप**: [इंस्टॉलेशन और सेटअप](docs/getting-started/installation.md) - प्लेटफ़ॉर्म-विशिष्ट गाइड्स
...
**📈 कौशल स्तर बाद में:** बेसिक एप्लिकेशन को स्वतंत्र रूप से डिप्लॉय कर सकते हैं
...
#### सीखने के संसाधन
- **🎯 यहां से शुरू करें**: [Microsoft Foundry एकीकरण](docs/microsoft-foundry/microsoft-foundry-integration.md)
- **📖 पैटर्न**: [AI मॉडल डिप्लॉयमेंट](docs/microsoft-foundry/ai-model-deployment.md) - AI मॉडल को डिप्लॉय और प्रबंधित करें
- **🛠️ वर्कशॉप**: [AI वर्कशॉप लैब](docs/microsoft-foundry/ai-workshop-lab.md) - अपने AI समाधानों को AZD-रेडी बनाएं
- **🎥 इंटरैक्टिव गाइड**: [वर्कशॉप सामग्री](workshop/README.md) - MkDocs * DevContainer Environment के साथ ब्राउज़र-आधारित सीखना
...
# सुनिश्चित करें कि खोज एकीकरण काम करता है
...
- Azure OpenAI (PTU के लिए सुसंगत प्रदर्शन): $3,000+/माह या उच्च वॉल्यूम के साथ पे-एज़-गो
...
- जब सक्रिय रूप से विकास न कर रहे हों तो `azd down` चलाकर संसाधनों को डीलोकेट करें
- उपभोग-आधारित बिलिंग के साथ शुरू करें, केवल प्रोडक्शन के लिए PTU में अपग्रेड करें
...
- **🛠️ एआरएम टेम्पलेट्स**: [एआरएम टेम्पलेट पैकेज](../../examples/retail-multiagent-arm-template) - एक-क्लिक डिप्लॉयमेंट
- **📖 आर्किटेक्चर**: [मल्टी-एजेंट कोऑर्डिनेशन पैटर्न्स](/docs/pre-deployment/coordination-patterns.md) - पैटर्न्स
...
**💡 अध्याय का परिणाम**: ग्राहक और इन्वेंटरी एजेंट्स के साथ प्रोडक्शन-रेडी मल्टी-एजेंट एआई समाधान को डिप्लॉय और प्रबंधित करें

---

### 🔍 अध्याय 6: प्री-डिप्लॉयमेंट वैलिडेशन और योजना
**पूर्व आवश्यकताएँ**: अध्याय 4 पूरा किया गया हो  
**अवधि**: 1 घंटा  
**जटिलता**: ⭐⭐
...
- **✅ वैलिडेशन**: [प्री-फ्लाइट चेक्स](docs/pre-deployment/preflight-checks.md) - स्वचालित स्क्रिप्ट्स

#### व्यावहारिक अभ्यास
- क्षमता वैलिडेशन स्क्रिप्ट्स चलाएँ
- लागत के लिए SKU चयन को ऑप्टिमाइज़ करें
- स्वचालित प्री-डिप्लॉयमेंट चेक्स लागू करें

**💡 अध्याय का परिणाम**: निष्पादन से पहले डिप्लॉयमेंट्स को वैलिडेट और ऑप्टिमाइज़ करें

---

### 🚨 अध्याय 7: समस्या निवारण और डिबगिंग
**पूर्व आवश्यकताएँ**: कोई भी डिप्लॉयमेंट अध्याय पूरा किया गया हो  
**अवधि**: 1-1.5 घंटे  
**जटिलता**: ⭐⭐
...
- **🤖 एआई समस्याएँ**: [एआई-विशिष्ट समस्या निवारण](docs/troubleshooting/ai-troubleshooting.md) - एआई सेवा समस्याएँ
...
### 🏢 अध्याय 8: प्रोडक्शन और एंटरप्राइज पैटर्न्स
**पूर्व आवश्यकताएँ**: अध्याय 1-4 पूरा किया गया हो  
**अवधि**: 2-3 घंटे  
**जटिलता**: ⭐⭐⭐⭐

#### आप क्या सीखेंगे
- प्रोडक्शन डिप्लॉयमेंट रणनीतियाँ
- एंटरप्राइज सुरक्षा पैटर्न्स
- मॉनिटरिंग और लागत अनुकूलन

#### शिक्षण संसाधन
- **🏭 प्रोडक्शन**: [प्रोडक्शन एआई बेस्ट प्रैक्टिसेज](docs/microsoft-foundry/production-ai-practices.md) - एंटरप्राइज पैटर्न्स
- **📝 उदाहरण**: [माइक्रोसर्विसेज उदाहरण](../../examples/microservices) - जटिल आर्किटेक्चर
- **📊 मॉनिटरिंग**: [एप्लिकेशन इनसाइट्स इंटीग्रेशन](docs/pre-deployment/application-insights.md) - मॉनिटरिंग

#### व्यावहारिक अभ्यास
- एंटरप्राइज सुरक्षा पैटर्न्स लागू करें
...
## 🎓 वर्कशॉप अवलोकन: व्यावहारिक शिक्षण अनुभव
...
**ब्राउज़र-आधारित उपकरणों और निर्देशित अभ्यासों के साथ व्यापक व्यावहारिक शिक्षण**

हमारी वर्कशॉप सामग्री अध्याय-आधारित पाठ्यक्रम को पूरक करने के लिए एक संरचित, इंटरएक्टिव शिक्षण अनुभव प्रदान करती है। वर्कशॉप को स्व-गति से सीखने और प्रशिक्षक-नेतृत्व वाले सत्रों दोनों के लिए डिज़ाइन किया गया है।

#### 🛠️ वर्कशॉप विशेषताएँ
- **ब्राउज़र-आधारित इंटरफेस**: MkDocs-संचालित वर्कशॉप जिसमें खोज, कॉपी और थीम सुविधाएँ हैं
- **GitHub Codespaces इंटीग्रेशन**: एक-क्लिक डेवलपमेंट वातावरण सेटअप
- **संरचित शिक्षण पथ**: 7-चरणीय निर्देशित अभ्यास (कुल 3.5 घंटे)
...
1. **डिस्कवरी चरण** (45 मिनट)
   ...
   - मल्टी-एजेंट आर्किटेक्चर पैटर्न्स को समझें
   - डिप्लॉयमेंट आवश्यकताओं और पूर्व आवश्यकताओं की समीक्षा करें

2. **डिप्लॉयमेंट चरण** (2 घंटे)
   - AZD के साथ एआई एप्लिकेशन का व्यावहारिक डिप्लॉयमेंट
...
#### 🚀 वर्कशॉप के साथ शुरुआत करें
```bash
# विकल्प 1: GitHub Codespaces (अनुशंसित)
# "Code" पर क्लिक करें → रिपॉजिटरी में "Create codespace on main" चुनें
...
वर्कशॉप को पूरा करके, प्रतिभागी:
- **प्रोडक्शन एआई एप्लिकेशन डिप्लॉय करें**: Microsoft Foundry सेवाओं के साथ AZD का उपयोग करें
- **मल्टी-एजेंट आर्किटेक्चर में महारत हासिल करें**: समन्वित एआई एजेंट समाधान लागू करें
- **सुरक्षा सर्वोत्तम प्रथाएँ लागू करें**: प्रमाणीकरण और एक्सेस नियंत्रण कॉन्फ़िगर करें
- **स्केल के लिए ऑप्टिमाइज़ करें**: लागत प्रभावी, प्रदर्शनकारी डिप्लॉयमेंट डिज़ाइन करें
- **डिप्लॉयमेंट्स को समस्या-मुक्त करें**: सामान्य समस्याओं को स्वतंत्र रूप से हल करें

#### 📖 वर्कशॉप संसाधन
- **🎥 इंटरएक्टिव गाइड**: [वर्कशॉप सामग्री](workshop/README.md) - ब्राउज़र-आधारित शिक्षण वातावरण
- **📋 चरण-दर-चरण निर्देश**: [निर्देशित अभ्यास](../../workshop/docs/instructions) - विस्तृत वॉकथ्रू
- **🛠️ एआई वर्कशॉप लैब**: [एआई वर्कशॉप लैब](docs/microsoft-foundry/ai-workshop-lab.md) - एआई-केंद्रित अभ्यास
- **💡 त्वरित शुरुआत**: [वर्कशॉप सेटअप गाइड](workshop/README.md#quick-start) - वातावरण कॉन्फ़िगरेशन
...
Azure Developer CLI (azd) एक डेवलपर-केंद्रित कमांड-लाइन इंटरफेस है जो Azure पर एप्लिकेशन बनाने और डिप्लॉय करने की प्रक्रिया को तेज करता है। यह प्रदान करता है:

- **टेम्पलेट-आधारित डिप्लॉयमेंट्स** - सामान्य एप्लिकेशन पैटर्न्स के लिए पूर्व-निर्मित टेम्पलेट्स का उपयोग करें
- **कोड के रूप में इन्फ्रास्ट्रक्चर** - Bicep या Terraform का उपयोग करके Azure संसाधनों का प्रबंधन करें  
- **एकीकृत वर्कफ़्लो** - एप्लिकेशन को सहजता से प्रोविजन, डिप्लॉय और मॉनिटर करें
- **डेवलपर-फ्रेंडली** - डेवलपर उत्पादकता और अनुभव के लिए अनुकूलित

### **AZD + Microsoft Foundry: एआई डिप्लॉयमेंट्स के लिए आदर्श**

**एआई समाधानों के लिए AZD क्यों?** AZD एआई डेवलपर्स द्वारा सामना की जाने वाली शीर्ष चुनौतियों का समाधान करता है:

- **एआई-रेडी टेम्पलेट्स** - Azure OpenAI, Cognitive Services, और ML वर्कलोड्स के लिए पूर्व-कॉन्फ़िगर टेम्पलेट्स
- **सुरक्षित एआई डिप्लॉयमेंट्स** - एआई सेवाओं, एपीआई कीज़, और मॉडल एंडपॉइंट्स के लिए बिल्ट-इन सुरक्षा पैटर्न  
- **प्रोडक्शन एआई पैटर्न्स** - स्केलेबल, लागत प्रभावी एआई एप्लिकेशन डिप्लॉयमेंट्स के लिए सर्वोत्तम प्रथाएँ
- **एंड-टू-एंड एआई वर्कफ़्लो** - मॉडल विकास से लेकर प्रोडक्शन डिप्लॉयमेंट तक उचित मॉनिटरिंग के साथ
- **लागत अनुकूलन** - एआई वर्कलोड्स के लिए स्मार्ट संसाधन आवंटन और स्केलिंग रणनीतियाँ
...
**यदि आप एआई एप्लिकेशन डिप्लॉय कर रहे हैं, तो यहाँ से शुरू करें!**

> **नोट:** ये टेम्पलेट्स विभिन्न एआई पैटर्न्स को प्रदर्शित करते हैं। कुछ बाहरी Azure Samples हैं, अन्य स्थानीय कार्यान्वयन हैं।

| टेम्पलेट | अध्याय | जटिलता | सेवाएँ | प्रकार |
|----------|---------|------------|----------|------|
| [**एआई चैट के साथ शुरुआत करें**](https://github.com/Azure-Samples/get-started-with-ai-chat) | अध्याय 2 | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights | बाहरी |
| [**एआई एजेंट्स के साथ शुरुआत करें**](https://github.com/Azure-Samples/get-started-with-ai-agents) | अध्याय 2 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights| बाहरी |
...
**शिक्षण अध्यायों के साथ मैप किए गए प्रोडक्शन-रेडी एप्लिकेशन टेम्पलेट्स**

| टेम्पलेट | शिक्षण अध्याय | जटिलता | मुख्य शिक्षण |
|----------|------------------|------------|--------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | अध्याय 2 | ⭐ | बुनियादी एआई डिप्लॉयमेंट पैटर्न्स |
...
| [**ai-document-processing**](https://github.com/Azure-Samples/ai-document-processing) | अध्याय 4 | ⭐⭐ | डॉक्यूमेंट इंटेलिजेंस इंटीग्रेशन |
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | अध्याय 8 | ⭐⭐⭐ | एंटरप्राइज एआई ऑर्केस्ट्रेशन |
...
- [**रिटेल मल्टी-एजेंट समाधान**](examples/retail-scenario.md) - एआरएम टेम्पलेट्स के साथ पूर्ण प्रोडक्शन-रेडी कार्यान्वयन
  - मल्टी-एजेंट आर्किटेक्चर (ग्राहक + इन्वेंटरी एजेंट्स)
  - व्यापक मॉनिटरिंग और मूल्यांकन
  - एआरएम टेम्पलेट के माध्यम से एक-क्लिक डिप्लॉयमेंट

#### स्थानीय उदाहरण - कंटेनर एप्लिकेशन (अध्याय 2-5)
**इस रिपॉजिटरी में व्यापक कंटेनर डिप्लॉयमेंट उदाहरण:**
- [**कंटेनर ऐप उदाहरण**](examples/container-app/README.md) - कंटेनराइज्ड डिप्लॉयमेंट्स के लिए पूर्ण गाइड
  ...
  - क्विक स्टार्ट, प्रोडक्शन, और एडवांस्ड डिप्लॉयमेंट पैटर्न्स
  - मॉनिटरिंग, सुरक्षा, और लागत अनुकूलन गाइडेंस

#### बाहरी उदाहरण - सरल एप्लिकेशन (अध्याय 1-2)
**शुरू करने के लिए इन Azure Samples रिपॉजिटरी को क्लोन करें:**
- [सिंपल वेब ऐप - Node.js + MongoDB](https://github.com/Azure-Samples/todo-nodejs-mongo) - बुनियादी डिप्लॉयमेंट पैटर्न्स
- [स्टैटिक वेबसाइट - React SPA](https://github.com/Azure-Samples/todo-csharp-sql-swa-func) - स्टैटिक सामग्री डिप्लॉयमेंट
...
- [डेटाबेस ऐप - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - डेटाबेस कनेक्टिविटी पैटर्न्स
- [Functions + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - सर्वरलेस डेटा वर्कफ़्लो

#### बाहरी उदाहरण - उन्नत पैटर्न्स (अध्याय 4-8)
- [Java माइक्रोस
- [**कमांड चीट शीट**](resources/cheat-sheet.md) - अध्याय अनुसार व्यवस्थित आवश्यक azd कमांड्स
- [**शब्दावली**](resources/glossary.md) - Azure और azd शब्दावली  
- [**FAQ**](resources/faq.md) - सामान्य प्रश्न, अध्याय अनुसार व्यवस्थित
- [**अध्ययन गाइड**](resources/study-guide.md) - व्यापक अभ्यास सामग्री

### प्रैक्टिकल वर्कशॉप्स
- [**AI वर्कशॉप लैब**](docs/microsoft-foundry/ai-workshop-lab.md) - अपने AI समाधान को AZD-डिप्लॉय करने योग्य बनाएं (2-3 घंटे)
- [**इंटरएक्टिव वर्कशॉप गाइड**](workshop/README.md) - ब्राउज़र आधारित वर्कशॉप MkDocs और DevContainer Environment के साथ
- [**संरचित लर्निंग पथ**](../../workshop/docs/instructions) - 7-स्टेप गाइडेड अभ्यास (डिस्कवरी → डिप्लॉयमेंट → कस्टमाइजेशन)
- [**AZD शुरुआती वर्कशॉप**](workshop/README.md) - GitHub Codespaces इंटीग्रेशन के साथ पूर्ण प्रैक्टिकल वर्कशॉप सामग्री
...
### ❌ टेम्पलेट डिप्लॉयमेंट में अधिक समय लग रहा है
...
# यदि 30 मिनट से अधिक समय तक अटका हुआ है, तो Azure पोर्टल जांचें:
azd monitor
# असफल तैनाती की तलाश करें
```
...
<details>
<summary><strong>❌ टेम्पलेट डिप्लॉयमेंट में अधिक समय लग रहा है"</strong></summary>
...
1. **प्रैक्टिकल अभ्यास**: अध्याय का प्रैक्टिकल डिप्लॉयमेंट पूरा करें
...
- **पेशेवर कौशल**: एंटरप्राइज़-रेडी डिप्लॉयमेंट क्षमताएं  
...
### कोर्स में योगदान
हम योगदान का स्वागत करते हैं! कृपया हमारे [Contributing Guide](CONTRIBUTING.md) को पढ़ें, जिसमें विवरण है:
...
[![AZD शुरुआती लोगों के लिए](https://img.shields.io/badge/AZD%20for%20Beginners-0078D4?style=for-the-badge&labelColor=E5E7EB&color=0078D4)](https://github.com/microsoft/AZD-for-beginners?WT.mc_id=academic-105485-koreyst)
[![Edge AI शुरुआती लोगों के लिए](https://img.shields.io/badge/Edge%20AI%20for%20Beginners-00B8E4?style=for-the-badge&labelColor=E5E7EB&color=00B8E4)](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
[![MCP शुरुआती लोगों के लिए](https://img.shields.io/badge/MCP%20for%20Beginners-009688?style=for-the-badge&labelColor=E5E7EB&color=009688)](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)
[![AI एजेंट्स शुरुआती लोगों के लिए](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)

---

### जनरेटिव AI सीरीज
[![जनरेटिव AI शुरुआती लोगों के लिए](https://img.shields.io/badge/Generative%20AI%20for%20Beginners-8B5CF6?style=for-the-badge&labelColor=E5E7EB&color=8B5CF6)](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)
...
### कोर लर्निंग
[![ML शुरुआती लोगों के लिए](https://img.shields.io/badge/ML%20for%20Beginners-22C55E?style=for-the-badge&labelColor=E5E7EB&color=22C55E)](https://aka.ms/ml-beginners?WT.mc_id=academic-105485-koreyst)
[![डेटा साइंस शुरुआती लोगों के लिए](https://img.shields.io/badge/Data%20Science%20for%20Beginners-84CC16?style=for-the-badge&labelColor=E5E7EB&color=84CC16)](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
[![AI शुरुआती लोगों के लिए](https://img.shields.io/badge/AI%20for%20Beginners-A3E635?style=for-the-badge&labelColor=E5E7EB&color=A3E635)](https://aka.ms/ai-beginners?WT.mc_id=academic-105485-koreyst)
[![साइबर सुरक्षा शुरुआती लोगों के लिए](https://img.shields.io/badge/Cybersecurity%20for%20Beginners-F97316?style=for-the-badge&labelColor=E5E7EB&color=F97316)](https://github.com/microsoft/Security-101?WT.mc_id=academic-96948-sayoung)
[![शुरुआती वेब डेवलपर्स के लिए](https://img.shields.io/badge/Web%20Dev%20for%20Beginners-EC4899?style=for-the-badge&labelColor=E5E7EB&color=EC4899)](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)  
[![शुरुआती IoT के लिए](https://img.shields.io/badge/IoT%20for%20Beginners-14B8A6?style=for-the-badge&labelColor=E5E7EB&color=14B8A6)](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)  
[![शुरुआती XR डेवलपमेंट के लिए](https://img.shields.io/badge/XR%20Development%20for%20Beginners-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
