...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:37:11+00:00",
...
#### सीखने के संसाधन
- **🏭 उत्पादन**: [Production AI Best Practices](docs/ai-foundry/production-ai-practices.md) - एंटरप्राइज़ पैटर्न
- **📝 उदाहरण**: [Microservices Example](../../examples/microservices) - जटिल आर्किटेक्चर
- **📊 निगरानी**: Application Insights इंटीग्रेशन
...
**💡 अध्याय परिणाम**: पूर्ण उत्पादन क्षमताओं के साथ एंटरप्राइज़-तैयार एप्लिकेशन परिनियोजित करें
...
- **खोज → परिनियोजन → अनुकूलन**: प्रगतिशील कार्यप्रणाली
- **इंटरएक्टिव DevContainer वातावरण**: पूर्व-कॉन्फ़िगर किए गए उपकरण और निर्भरताएँ

#### 📚 कार्यशाला संरचना
कार्यशाला **खोज → परिनियोजन → अनुकूलन** कार्यप्रणाली का अनुसरण करती है:

1. **खोज चरण** (45 मिनट)
   - Azure AI Foundry टेम्पलेट और सेवाओं का अन्वेषण करें
...
कार्यशाला पूरी करने के बाद, प्रतिभागी:
- **उत्पादन AI एप्लिकेशन परिनियोजित करें**: AZD का उपयोग करके Azure AI Foundry सेवाओं के साथ
...
#### 📖 कार्यशाला संसाधन
- **🎥 इंटरएक्टिव गाइड**: [Workshop Materials](workshop/README.md) - ब्राउज़र-आधारित सीखने का वातावरण
- **📋 चरण-दर-चरण निर्देश**: [Guided Exercises](../../workshop/docs/instructions) - विस्तृत वॉकथ्रू
- **🛠️ AI Workshop Lab**: [AI Workshop Lab](docs/ai-foundry/ai-workshop-lab.md) - AI-केंद्रित अभ्यास
- **💡 त्वरित प्रारंभ**: [Workshop Setup Guide](workshop/README.md#quick-start) - वातावरण कॉन्फ़िगरेशन

**उपयुक्त**: कॉर्पोरेट प्रशिक्षण, विश्वविद्यालय पाठ्यक्रम, स्व-गति से सीखना, और डेवलपर बूटकैंप।
...
- **टेम्पलेट-आधारित परिनियोजन** - सामान्य एप्लिकेशन पैटर्न के लिए पूर्व-निर्मित टेम्पलेट का उपयोग करें
- **कोड के रूप में बुनियादी ढाँचा** - Bicep या Terraform का उपयोग करके Azure संसाधनों का प्रबंधन करें  
- **एकीकृत कार्यप्रवाह** - एप्लिकेशन को सहजता से प्रावधान, परिनियोजित और मॉनिटर करें
...
- **AI-तैयार टेम्पलेट** - Azure OpenAI, Cognitive Services, और ML वर्कलोड के लिए पूर्व-कॉन्फ़िगर किए गए टेम्पलेट
...
**AI एप्लिकेशन परिनियोजित कर रहे हैं तो यहाँ से शुरू करें!**
...
**उत्पादन-तैयार एप्लिकेशन टेम्पलेट्स को सीखने के अध्यायों से जोड़ा गया**
...
- [Simple Web App](../../examples/simple-web-app) - बुनियादी परिनियोजन पैटर्न
- [Static Website](../../examples/static-site) - स्थिर सामग्री परिनियोजन
- [Basic API](../../examples/basic-api) - REST API परिनियोजन

#### डेटाबेस इंटीग्रेशन (अध्याय 3-4)  
- [Database App](../../examples/database-app) - डेटाबेस कनेक्टिविटी पैटर्न
- [Data Processing](../../examples/data-processing) - ETL वर्कफ़्लो परिनियोजन

#### उन्नत पैटर्न (अध्याय 4-8)
- [Container Apps](../../examples/container-app) - कंटेनरीकृत परिनियोजन
- [Microservices](../../examples/microservices) - मल्टी-सर्विस आर्किटेक्चर  
- [Enterprise Solutions](../../examples/enterprise) - उत्पादन-तैयार पैटर्न

### बाहरी टेम्पलेट संग्रह
- [**Azure-Samples AZD Templates**](https://github.com/Azure-Samples/azd-templates) - आधिकारिक Microsoft नमूने
- [**Awesome AZD Gallery**](https://azure.github.io/awesome-azd/) - समुदाय द्वारा योगदान किए गए टेम्पलेट्स
- [**Examples Directory**](examples/README.md) - विस्तृत व्याख्याओं के साथ स्थानीय सीखने के उदाहरण
...
- [**FAQ**](resources/faq.md) - सीखने के अध्याय द्वारा व्यवस्थित सामान्य प्रश्न
- [**अध्ययन गाइड**](resources/study-guide.md) - व्यापक अभ्यास अभ्यास

### व्यावहारिक कार्यशालाएँ
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - अपने AI समाधान को AZD-परिनियोज्य बनाएं (2-3 घंटे)
- [**Interactive Workshop Guide**](workshop/README.md) - MkDocs और DevContainer वातावरण के साथ ब्राउज़र-आधारित कार्यशाला
- [**Structured Learning Path**](../../workshop/docs/instructions) - 7-चरण निर्देशित अभ्यास (खोज → परिनियोजन → अनुकूलन)
- [**AZD For Beginners Workshop**](workshop/README.md) - GitHub Codespaces इंटीग्रेशन के साथ पूर्ण व्यावहारिक कार्यशाला सामग्री
...
- [ ] **अध्याय 4**: कोड के रूप में बुनियादी ढाँचा और परिनियोजन ✅
...
सभी अध्यायों को पूरा करने पर, आपके पास होगा:
...
- **सीखने के प्रश्न**: [Microsoft Azure Discord Community](https://discord.gg/microsoft-azure)
...
**#Azure चैनल से हाल के सर्वेक्षण परिणाम:**
