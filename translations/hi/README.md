...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T22:01:06+00:00",
...
- **🛠️ कार्यशाला**: [AI कार्यशाला लैब](docs/microsoft-foundry/ai-workshop-lab.md) - अपने AI समाधान AZD-तैयार बनाएं
...
- **🛠️ ARM टेम्प्लेट्स**: [ARM टेम्प्लेट पैकेज](../../examples/retail-multiagent-arm-template) - एक-क्लिक परिनियोजन  
...
**💡 अध्याय परिणाम**: ग्राहक और इन्वेंटरी एजेंट के साथ उत्पादन-तैयार मल्टी-एजेंट AI समाधान को परिनियोजित और प्रबंधित करें
...
- स्वचालित पूर्व-परिनियोजन जांच लागू करें
...
**पूर्वापेक्षाएँ**: कोई भी परिनियोजन अध्याय पूरा हुआ  
**अवधि**: 1-1.5 घंटे  
**जटिलता**: ⭐⭐
...
#### सीखने के संसाधन  
- **🏭 उत्पादन**: [उत्पादन AI सर्वोत्तम प्रथाएँ](docs/microsoft-foundry/production-ai-practices.md) - एंटरप्राइज पैटर्न  
...
- उचित शासन के साथ उत्पादन में परिनियोजित करें

**💡 अध्याय परिणाम**: पूर्ण उत्पादन क्षमताओं के साथ एंटरप्राइज-तैयार अनुप्रयोग परिनियोजित करें
...
#### 📚 कार्यशाला संरचना  
कार्यशाला एक **खोज → परिनियोजन → अनुकूलन** कार्यप्रणाली का पालन करती है:
...
- **उत्पादन AI अनुप्रयोग परिनियोजित करें**: Microsoft Foundry सेवाओं के साथ AZD का उपयोग करें  
...
- **स्केल के लिए अनुकूलित करें**: लागत-कुशल, प्रदर्शनक्षम परिनियोजन डिज़ाइन करें  
- **परिनियोजन समस्या निवारण करें**: सामान्य समस्याओं को स्वतंत्र रूप से हल करें

#### 📖 कार्यशाला संसाधन  
- **🎥 इंटरैक्टिव गाइड**: [कार्यशाला सामग्री](workshop/README.md) - ब्राउज़र-आधारित सीखने का वातावरण  
- **📋 चरण-दर-चरण निर्देश**: [मार्गदर्शित अभ्यास](../../workshop/docs/instructions) - विस्तृत वॉकथ्रू  
...
Azure Developer CLI (azd) एक डेवलपर-केंद्रित कमांड-लाइन इंटरफ़ेस है जो Azure पर अनुप्रयोगों के निर्माण और परिनियोजन की प्रक्रिया को तेज करता है। यह प्रदान करता है:

- **टेम्प्लेट-आधारित परिनियोजन** - सामान्य अनुप्रयोग पैटर्न के लिए पूर्व-निर्मित टेम्प्लेट का उपयोग करें  
- **इन्फ्रास्ट्रक्चर ऐज़ कोड** - Bicep या Terraform का उपयोग करके Azure संसाधनों का प्रबंधन करें  
- **एकीकृत वर्कफ़्लोज़** - अनुप्रयोगों को सहजता से प्रोविजन, परिनियोजित और मॉनिटर करें  
- **डेवलपर-अनुकूल** - डेवलपर उत्पादकता और अनुभव के लिए अनुकूलित

### **AZD + Microsoft Foundry: AI परिनियोजनों के लिए परफेक्ट**
...
- **सुरक्षित AI परिनियोजन** - AI सेवाओं, API कुंजियों, और मॉडल एंडपॉइंट्स के लिए अंतर्निर्मित सुरक्षा पैटर्न  
- **उत्पादन AI पैटर्न** - स्केलेबल, लागत-कुशल AI अनुप्रयोग परिनियोजन के लिए सर्वोत्तम प्रथाएँ  
- **एंड-टू-एंड AI वर्कफ़्लोज़** - मॉडल विकास से लेकर उत्पादन परिनियोजन तक उचित निगरानी के साथ  
...
**यदि आप AI अनुप्रयोग परिनियोजित कर रहे हैं तो यहाँ से शुरू करें!**

> **नोट:** ये टेम्प्लेट विभिन्न AI पैटर्न प्रदर्शित करते हैं। कुछ बाहरी Azure सैंपल हैं, कुछ स्थानीय कार्यान्वयन।
...
**उत्पादन-तैयार अनुप्रयोग टेम्प्लेट्स जो सीखने के अध्यायों से जुड़े हैं**

| टेम्प्लेट | सीखने का अध्याय | जटिलता | मुख्य सीखना |
|----------|------------------|------------|--------------|
...
- [**रिटेल मल्टी-एजेंट समाधान**](examples/retail-scenario.md) - ARM टेम्प्लेट्स के साथ पूर्ण उत्पादन-तैयार कार्यान्वयन  
  ...
  - ARM टेम्प्लेट के माध्यम से एक-क्लिक परिनियोजन

#### स्थानीय उदाहरण - कंटेनर अनुप्रयोग (अध्याय 2-5)  
**इस रिपॉजिटरी में व्यापक कंटेनर परिनियोजन उदाहरण:**  
- [**कंटेनर ऐप उदाहरण**](examples/container-app/README.md) - कंटेनरयुक्त परिनियोजन के लिए पूर्ण मार्गदर्शिका  
  - [सरल Flask API](../../examples/container-app/simple-flask-api) - स्केल-टू-जीरो के साथ बुनियादी REST API  
  - [माइक्रोसर्विसेज़ आर्किटेक्चर](../../examples/container-app/microservices) - उत्पादन-तैयार मल्टी-सर्विस परिनियोजन  
  - क्विक स्टार्ट, उत्पादन, और उन्नत परिनियोजन पैटर्न  
...
- [सरल वेब ऐप - Node.js + MongoDB](https://github.com/Azure-Samples/todo-nodejs-mongo) - बुनियादी परिनियोजन पैटर्न  
- [स्थैतिक वेबसाइट - React SPA](https://github.com/Azure-Samples/todo-csharp-sql-swa-func) - स्थैतिक सामग्री परिनियोजन  
- [कंटेनर ऐप - Python Flask](https://github.com/Azure-Samples/container-apps-store-api-microservice) - REST API परिनियोजन
...
- [एंटरप्राइज ML पाइपलाइन](https://github.com/Azure-Samples/mlops-v2) - उत्पादन-तैयार ML पैटर्न
...
- **प्रोडक्शन अनुभव**: Azure पर वास्तविक AI अनुप्रयोगों को डिप्लॉय किया
...
- **शीर्ष चुनौतियाँ**: मल्टी-सर्विस डिप्लॉयमेंट, क्रेडेंशियल प्रबंधन, प्रोडक्शन रेडीनेस  
