...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T17:09:44+00:00",
...
- **🤖 एआई कमांड्स**: [अध्याय 2: एआई-फर्स्ट डेवलपमेंट](../README.md#-chapter-2-ai-first-development-recommended-for-ai-developers)
- **🔧 उन्नत**: [अध्याय 4: कोड के रूप में इंफ्रास्ट्रक्चर](../README.md#️-chapter-4-infrastructure-as-code--deployment)

## परिचय

यह व्यापक चीट शीट सबसे सामान्य रूप से उपयोग किए जाने वाले Azure Developer CLI कमांड्स का त्वरित संदर्भ प्रदान करती है, जो श्रेणी के अनुसार व्यवस्थित हैं और व्यावहारिक उदाहरणों के साथ हैं। विकास, समस्या निवारण, और दैनिक संचालन के दौरान AZD प्रोजेक्ट्स के साथ त्वरित खोज के लिए आदर्श।

## सीखने के लक्ष्य

इस चीट शीट का उपयोग करके, आप:
- आवश्यक Azure Developer CLI कमांड्स और सिंटैक्स तक तुरंत पहुंच प्राप्त करेंगे
- कार्यात्मक श्रेणियों और उपयोग मामलों के अनुसार कमांड्स का संगठन समझेंगे
- सामान्य विकास और परिनियोजन परिदृश्यों के लिए व्यावहारिक उदाहरणों का संदर्भ देंगे
- समस्या निवारण कमांड्स का उपयोग करके त्वरित मुद्दों का समाधान पाएंगे
- उन्नत कॉन्फ़िगरेशन और कस्टमाइज़ेशन विकल्पों को कुशलतापूर्वक ढूंढेंगे
- पर्यावरण प्रबंधन और मल्टी-एनवायरनमेंट वर्कफ़्लो कमांड्स का पता लगाएंगे

## सीखने के परिणाम

इस चीट शीट का नियमित संदर्भ लेने से, आप:
...
- कई पर्यावरण और परिनियोजन परिदृश्यों को कुशलतापूर्वक प्रबंधित कर पाएंगे
