...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:35:32+00:00",
...
- Azure Developer CLI का उपयोग करके विभिन्न प्रकार के एप्लिकेशन को आत्मविश्वास के साथ डिप्लॉय करना
...
- व्यावहारिक अनुभव के आधार पर डिप्लॉयमेंट का समस्या निवारण और अनुकूलन करना
...
4. **[डाटाबेस ऐप](../../../examples/database-app)** - PostgreSQL डाटाबेस के साथ वेब एप्लिकेशन
...
**जटिलता**: मध्यम  
**अवधारणाएं**: डाटाबेस कनेक्शन, सीक्रेट्स प्रबंधन, माइग्रेशन
...
4. **डाटाबेस इंटीग्रेशन जोड़ें**
   - डाटाबेस प्रावधान सीखें
...
- **Python**: डाटाबेस ऐप, सर्वरलेस फंक्शन
- **स्टैटिक साइट्स**: स्टैटिक वेबसाइट
- **कंटेनर्स**: कंटेनर ऐप, माइक्रोसर्विसेज
- **डाटाबेस**: डाटाबेस ऐप, सर्वरलेस फंक्शन

### आर्किटेक्चर पैटर्न के अनुसार
- **मोनोलिथिक**: सिंपल वेब ऐप, डाटाबेस ऐप
...
- **मध्यम**: कंटेनर ऐप, डाटाबेस ऐप, सर्वरलेस फंक्शन  
...
- [AZD टेम्पलेट्स गैलरी](https://azure.github.io/awesome-azd/)
...
**प्रो टिप**: उस सबसे सरल उदाहरण से शुरू करें जो आपके तकनीकी स्टैक से मेल खाता है, फिर धीरे-धीरे अधिक जटिल परिदृश्यों की ओर बढ़ें। प्रत्येक उदाहरण पिछले वाले से अवधारणाओं को बनाता है!

**अगले कदम**: 
- एक ऐसा उदाहरण चुनें जो आपके कौशल स्तर से मेल खाता हो
