...
graph TB
    ...
    Gateway[एपीआई गेटवे<br/>नोड.जेएस कंटेनर<br/>पोर्ट 8080]
    Product[उत्पाद सेवा<br/>पायथन कंटेनर<br/>पोर्ट 8000]
    AppInsights[एप्लिकेशन इनसाइट्स<br/>निगरानी और लॉग्स]
    
    Internet -->|HTTPS| Gateway
    Gateway -->|HTTP आंतरिक| Product
...
graph TB
    User[उपयोगकर्ता]
    Gateway[एपीआई गेटवे<br/>✅ शामिल]
    Product[उत्पाद सेवा<br/>✅ शामिल]
    Order[ऑर्डर सेवा<br/>🔜 अगला जोड़ें]
    UserSvc[उपयोगकर्ता सेवा<br/>🔜 अगला जोड़ें]
    Notify[सूचना सेवा<br/>🔜 अंतिम जोड़ें]
    
    CosmosDB[(कॉसमॉस डीबी<br/>🔜 उत्पाद डेटा)]
    AzureSQL[(एज्योर एसक्यूएल<br/>🔜 ऑर्डर डेटा)]
    ServiceBus[एज्योर सर्विस बस<br/>🔜 असिंक्रोनस इवेंट्स]
    AppInsights[एप्लिकेशन इनसाइट्स<br/>✅ शामिल]
    ...
    Product -.->|उत्पाद बनाया गया इवेंट| ServiceBus
    ServiceBus -.->|सदस्यता लें| Notify
    ServiceBus -.->|सदस्यता लें| Order
...
```mermaid
graph LR
    A[azd up] --> B[संसाधन समूह बनाएँ]
    B --> C[कंटेनर रजिस्ट्री तैनात करें]
    C --> D[लॉग एनालिटिक्स तैनात करें]
    D --> E[ऐप इनसाइट्स तैनात करें]
    E --> F[कंटेनर वातावरण बनाएँ]
    F --> G[एपीआई गेटवे इमेज बनाएं]
    F --> H[उत्पाद सेवा इमेज बनाएं]
    G --> I[रजिस्ट्री में पुश करें]
    H --> I
    I --> J[एपीआई गेटवे तैनात करें]
    I --> K[उत्पाद सेवा तैनात करें]
    J --> L[इंग्रेस और स्वास्थ्य जांच कॉन्फ़िगर करें]
    K --> L
    L --> M[तैनाती पूर्ण ✓]
