...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T18:30:50+00:00",
...
यह पाठ आपको Azure Developer CLI (azd) से परिचित कराता है, जो एक शक्तिशाली कमांड-लाइन टूल है जो स्थानीय विकास से Azure पर तैनाती तक की यात्रा को तेज करता है। आप मौलिक अवधारणाओं, मुख्य विशेषताओं को जानेंगे और समझेंगे कि azd क्लाउड-नेटिव एप्लिकेशन की तैनाती को कैसे सरल बनाता है।

## सीखने के लक्ष्य

इस पाठ के अंत तक, आप:
- समझ पाएंगे कि Azure Developer CLI क्या है और इसका मुख्य उद्देश्य क्या है
- टेम्पलेट्स, एनवायरनमेंट्स, और सर्विसेज की मुख्य अवधारणाओं को जानेंगे
- टेम्पलेट-ड्रिवन डेवलपमेंट और Infrastructure as Code जैसी प्रमुख विशेषताओं का अन्वेषण करेंगे
...
- समझ पाएंगे कि टेम्पलेट्स, एनवायरनमेंट्स, और सर्विसेज कैसे एक साथ काम करते हैं
...
- **इंफ्रास्ट्रक्चर परिभाषाएँ** - Azure संसाधन जो Bicep या Terraform में परिभाषित हैं
...
`azd down --force --purge` कमांड आपके azd एनवायरनमेंट और सभी संबंधित संसाधनों को पूरी तरह से हटाने का एक शक्तिशाली तरीका है। प्रत्येक फ्लैग का विवरण यहां दिया गया है:
```
--force
```
...
azd को "पिछली तैनातियों को याद रखने" से रोकता है, जो संसाधन समूहों के बेमेल या पुराने रजिस्ट्री संदर्भों जैसी समस्याओं का कारण बन सकता है।

### दोनों का उपयोग क्यों करें?
जब आप `azd up` के साथ शेष स्थिति या आंशिक तैनातियों के कारण अटक जाते हैं, तो यह संयोजन एक **स्वच्छ शुरुआत** सुनिश्चित करता है।

यह विशेष रूप से उपयोगी है जब Azure पोर्टल में मैनुअल संसाधन हटाने के बाद या टेम्पलेट्स, एनवायरनमेंट्स, या संसाधन समूह नामकरण सम्मेलनों को बदलते समय।
...
सफल azd तैनातियों के लिए प्रमाणीकरण को समझना महत्वपूर्ण है। Azure कई प्रमाणीकरण विधियों का उपयोग करता है, और azd उन्हीं क्रेडेंशियल चेन का उपयोग करता है जो अन्य Azure टूल्स द्वारा उपयोग किए जाते हैं।
...
2. **डिवाइस कोड प्रवाह**: उन एनवायरनमेंट्स के लिए जहां ब्राउज़र एक्सेस नहीं है
...
- कोड या कॉन्फ़िगरेशन फाइलों में क्रेडेंशियल्स संग्रहीत करने से बचें
...
1. **क्रेडेंशियल स्टोरेज**: क्रेडेंशियल्स को सोर्स कोड में कभी भी संग्रहीत न करें
2. **स्कोप लिमिटेशन**: सर्विस प्रिंसिपल्स के लिए न्यूनतम-विशेषाधिकार सिद्धांत का उपयोग करें
...
5. **नेटवर्क सुरक्षा**: जब संभव हो तो निजी एंडपॉइंट्स का उपयोग करें
...
- [अध्याय 2: AI-फर्स्ट डेवलपमेंट](../ai-foundry/azure-ai-foundry-integration.md) - AI एप्लिकेशन बनाना शुरू करें
