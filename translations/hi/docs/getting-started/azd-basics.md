...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T16:59:25+00:00",
...
azd को "पिछली तैनातियों को याद रखने" से रोकता है, जो संसाधन समूहों के मेल न खाने या पुराने रजिस्ट्री संदर्भों जैसी समस्याएँ पैदा कर सकता है।

### दोनों का उपयोग क्यों करें?
जब आप `azd up` के साथ अटके हुए हैं, तो शेष स्थिति या आंशिक तैनातियों के कारण, यह संयोजन एक **साफ़ स्लेट** सुनिश्चित करता है।

यह विशेष रूप से उपयोगी है जब Azure पोर्टल में मैन्युअल संसाधन हटाने के बाद या टेम्पलेट्स, एनवायरनमेंट्स, या संसाधन समूह नामकरण सम्मेलनों को स्विच करते समय।
