...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:19:45+00:00",
...
**पिछला:** [मुख्य दस्तावेज़](../../README.md) | **अगला:** [AZD बेसिक्स](azd-basics.md)
...
- आवश्यक प्रीरेक्विज़िट्स के साथ अपना डेवलपमेंट एनवायरनमेंट सेटअप कर पाएंगे
...
- azd के इष्टतम उपयोग के लिए अपना डेवलपमेंट एनवायरनमेंट कॉन्फ़िगर कर पाएंगे
...
- **Git** - टेम्पलेट्स को क्लोन करने और वर्ज़न कंट्रोल के लिए
- **Docker** (वैकल्पिक) - कंटेनराइज़्ड एप्लिकेशन के लिए
...
2. इसे `C:\Program Files\azd\` में एक्सट्रैक्ट करें
...
azd GitHub Codespaces में पहले से इंस्टॉल आता है। बस एक कोडस्पेस बनाएं और तुरंत azd का उपयोग शुरू करें।
