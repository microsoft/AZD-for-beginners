...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T13:00:53+00:00",
...
यह व्यापक गाइड Azure Developer CLI को प्रभावी विकास और परिनियोजन वर्कफ़्लो के लिए कॉन्फ़िगर करने के सभी पहलुओं को कवर करता है। आप कॉन्फ़िगरेशन पदानुक्रम, पर्यावरण प्रबंधन, प्रमाणीकरण विधियों, और उन्नत कॉन्फ़िगरेशन पैटर्न के बारे में जानेंगे जो सुरक्षित और कुशल Azure परिनियोजन को सक्षम बनाते हैं।
...
- विभिन्न कॉन्फ़िगरेशन वाले कई पर्यावरण प्रबंधित करेंगे
...
- विकास वर्कफ़्लो के लिए azd को कॉन्फ़िगर कर सकेंगे
- कई परिनियोजन पर्यावरण सेटअप और प्रबंधित कर सकेंगे
- सुरक्षित कॉन्फ़िगरेशन प्रबंधन प्रथाओं को लागू कर सकेंगे
- कॉन्फ़िगरेशन से संबंधित समस्याओं का समाधान कर सकेंगे
- विशिष्ट संगठनात्मक आवश्यकताओं के लिए azd व्यवहार को अनुकूलित कर सकेंगे

यह व्यापक गाइड Azure Developer CLI को प्रभावी विकास और परिनियोजन वर्कफ़्लो के लिए कॉन्फ़िगर करने के सभी पहलुओं को कवर करता है।
...
### azure.yaml संरचना
`azure.yaml` फ़ाइल आपके azd प्रोजेक्ट का मुख्य हिस्सा है:
...
प्रत्येक पर्यावरण का अपना कॉन्फ़िगरेशन `.azure/<env-name>/config.json` में होता है:
...
### पर्यावरण टेम्पलेट्स
संगत पर्यावरण सेटअप के लिए `.azure/env.template` बनाएं:
```bash
# Required variables
...
### बाइसेप पैरामीटर्स
`infra/main.parameters.json` में इन्फ्रास्ट्रक्चर पैरामीटर्स कॉन्फ़िगर करें:
```json
{
...
- [आपका पहला प्रोजेक्ट](first-project.md) - व्यावहारिक रूप से कॉन्फ़िगरेशन लागू करें
- [परिनियोजन गाइड](../deployment/deployment-guide.md) - परिनियोजन के लिए कॉन्फ़िगरेशन का उपयोग करें
- [संसाधनों का प्रावधान](../deployment/provisioning.md) - उत्पादन-तैयार कॉन्फ़िगरेशन
...
**नेविगेशन**
- **पिछला पाठ**: [इंस्टॉलेशन और सेटअप](installation.md)
