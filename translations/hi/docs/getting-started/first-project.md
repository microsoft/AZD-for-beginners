...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T16:45:51+00:00",
...
आपका स्वागत है आपके पहले Azure Developer CLI प्रोजेक्ट में! यह व्यापक हैंड्स-ऑन ट्यूटोरियल आपको Azure पर azd का उपयोग करके एक फुल-स्टैक एप्लिकेशन बनाने, डिप्लॉय करने और प्रबंधित करने की पूरी प्रक्रिया सिखाएगा। आप एक वास्तविक टूडू एप्लिकेशन पर काम करेंगे जिसमें React फ्रंटएंड, Node.js API बैकएंड और MongoDB डेटाबेस शामिल है।
...
- Azure पर इंफ्रास्ट्रक्चर प्रोविज़निंग के साथ पूरी एप्लिकेशन डिप्लॉयमेंट को निष्पादित करेंगे
...
- सामान्य डिप्लॉयमेंट समस्याओं और प्रमाणीकरण मुद्दों का समाधान करना
...
`azd up` कमांड निम्नलिखित चरणों को निष्पादित करता है:
...
3. **आइटम्स हटाएं** - उन टूडू को हटा दें जिनकी अब आवश्यकता नहीं है
...
### केवल कोड परिवर्तनों को डिप्लॉय करें
```bash
...
प्रोडक्शन से पहले परिवर्तनों का परीक्षण करने के लिए एक स्टेजिंग वातावरण बनाएं:
...
- कोड परिवर्तनों को किया और पुनः डिप्लॉय किया
...
- [निगरानी और लॉगिंग](../deployment/best-practices.md#monitoring)

### 4. और टेम्पलेट्स का अन्वेषण करें
```bash
...
**अपने पहले azd प्रोजेक्ट को पूरा करने पर बधाई!** अब आप आत्मविश्वास के साथ Azure पर अद्भुत एप्लिकेशन बनाने और डिप्लॉय करने के लिए तैयार हैं।
