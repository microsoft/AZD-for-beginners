...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:19:21+00:00",
...
**पिछला:** [कॉन्फ़िगरेशन](configuration.md) | **अगला:** [Azure AI Foundry इंटीग्रेशन](../ai-foundry/azure-ai-foundry-integration.md)

## परिचय

आपका Azure Developer CLI प्रोजेक्ट में स्वागत है! यह व्यापक हैंड्स-ऑन ट्यूटोरियल आपको Azure पर azd का उपयोग करके एक फुल-स्टैक एप्लिकेशन बनाने, डिप्लॉय करने और प्रबंधित करने की पूरी प्रक्रिया सिखाएगा। आप एक असली टूडू एप्लिकेशन पर काम करेंगे जिसमें React फ्रंटएंड, Node.js API बैकएंड और MongoDB डेटाबेस शामिल है।
...
- Azure पर एप्लिकेशन को पूरी तरह से डिप्लॉय करने और इंफ्रास्ट्रक्चर प्रोविज़निंग को निष्पादित करेंगे
...
- एक `azure.yaml` फ़ाइल बनाई गई जिसमें सर्विस डिफिनिशन हैं
...
- [एंटरप्राइज़ पैटर्न्स](https://github.com/Azure/azure-dev/tree/main/templates)
