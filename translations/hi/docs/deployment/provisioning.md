...
-->
# संसाधनों का प्रावधान - AZD के साथ इंफ्रास्ट्रक्चर कोड के रूप में

## परिचय

यह व्यापक मार्गदर्शिका आपको Azure Developer CLI का उपयोग करके Azure संसाधनों को प्रावधान और प्रबंधित करने के बारे में सब कुछ सिखाती है। Bicep, ARM टेम्पलेट्स, Terraform, और Pulumi का उपयोग करके बुनियादी संसाधन निर्माण से लेकर उन्नत एंटरप्राइज़-ग्रेड इंफ्रास्ट्रक्चर आर्किटेक्चर तक इंफ्रास्ट्रक्चर कोड (IaC) पैटर्न को लागू करना सीखें।

## सीखने के लक्ष्य

इस मार्गदर्शिका को पूरा करके, आप:
- इंफ्रास्ट्रक्चर कोड के सिद्धांतों और Azure संसाधन प्रावधान में महारत हासिल करेंगे
- Azure Developer CLI द्वारा समर्थित विभिन्न IaC प्रदाताओं को समझेंगे
...
- इंफ्रास्ट्रक्चर प्रावधान समस्याओं का समाधान करें और डिप्लॉयमेंट विफलताओं को ठीक करें
- Azure Well-Architected Framework के सिद्धांतों को इंफ्रास्ट्रक्चर डिज़ाइन में लागू करें
- इंफ्रास्ट्रक्चर अपडेट का प्रबंधन करें और इंफ्रास्ट्रक्चर वर्जनिंग रणनीतियों को लागू करें

## इंफ्रास्ट्रक्चर प्रावधान का अवलोकन

Azure Developer CLI कई इंफ्रास्ट्रक्चर कोड (IaC) प्रदाताओं का समर्थन करता है:
...
- [पूर्व-डिप्लॉयमेंट योजना](../pre-deployment/capacity-planning.md) - संसाधन उपलब्धता को मान्य करें
