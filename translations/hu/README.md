...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-23T10:07:57+00:00",
...
Sajátítsd el az Azure Developer CLI (azd) használatát strukturált fejezeteken keresztül, amelyek progresszív tanulást biztosítanak. **Különös hangsúly az AI alkalmazások telepítésére a Microsoft Foundry integrációval.**

### Miért elengedhetetlen ez a kurzus a modern fejlesztők számára?

A Microsoft Foundry Discord közösség visszajelzései alapján **a fejlesztők 45%-a szeretné az AZD-t AI munkaterhelésekhez használni**, de nehézségekbe ütköznek az alábbiak miatt:
...
- **Optimalizálás termelésre**: Biztonság, skálázás, monitorozás és költségkezelés
- **Több ügynökös megoldások építése**: Összetett AI architektúrák telepítése

## 📚 Tanulási fejezetek

*Válaszd ki a tanulási utadat tapasztalati szint és célok alapján*
...
**📈 Készségszint utána:** Képes leszel önállóan telepíteni alapvető alkalmazásokat
...
**📈 Készségszint utána:** Képes leszel termelésre kész AI alkalmazásokat telepíteni és konfigurálni  
**💰 Költségtudatosság:** Értsd meg a $80-150/hó fejlesztési költségeket, $300-3500/hó termelési költségeket
...
- Azure OpenAI (PTU a következetes teljesítményért): $3,000+/hó VAGY Pay-as-go nagy volumen esetén
...
- Kezdd fogyasztás-alapú számlázással, frissíts PTU-ra csak termeléshez
- Használd az `azd provision --preview` parancsot, hogy becsüld meg a költségeket telepítés előtt
...
- Több szolgáltatást magában foglaló alkalmazások telepítése
- Blue-green telepítési stratégiák megvalósítása

**💡 Fejezet eredménye**: Összetett, több szolgáltatást magában foglaló alkalmazások telepítése egyedi infrastruktúra sablonokkal
...
- **📖 Architektúra**: [Több ügynök koordinációs minták](/docs/pre-deployment/coordination-patterns.md) - Minták
...
**💡 Fejezet eredménye**: Telepíts és kezelj egy éles, többügynökös AI megoldást Ügyfél és Készlet ügynökökkel
...
- SKU kiválasztások optimalizálása költségek szempontjából  
...
- AI szolgáltatás kapcsolódási hibáinak elhárítása  
...
#### Tanulási források
- **🏭 Éles telepítés**: [Éles AI legjobb gyakorlatok](docs/microsoft-foundry/production-ai-practices.md) - Vállalati minták  
...
**💡 Fejezet eredménye**: Vállalati szintű alkalmazások telepítése teljes éles képességekkel  
...
Workshop anyagaink strukturált, interaktív tanulási élményt nyújtanak, amely kiegészíti a fent bemutatott fejezet-alapú tantervet. A workshop önálló tanulásra és oktató által vezetett foglalkozásokra egyaránt alkalmas.

#### 🛠️ Workshop funkciók
- **Böngészőalapú felület**: Teljes MkDocs-alapú workshop keresési, másolási és témabeállítási funkciókkal  
- **GitHub Codespaces integráció**: Egy kattintásos fejlesztési környezet beállítása  
...
3. **Testreszabási fázis** (45 perc)  
   ...
   - Optimalizálás éles telepítéshez  
   - Felügyelet és költségkezelés megvalósítása  

#### 🚀 Workshop kezdése  
```bash
# Opció 1: GitHub Codespaces (Ajánlott)
# Kattints a "Code" → "Create codespace on main" lehetőségre a repóban
...
A workshop befejezésével a résztvevők:  
- **Éles AI alkalmazásokat telepítenek**: AZD használata Microsoft Foundry szolgáltatásokkal  
...
- **🛠️ AI Workshop Lab**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - AI-fókuszú gyakorlatok  
...
- **Fejlesztőbarát** - Optimalizálva a fejlesztői produktivitás és élmény érdekében  
...
- **Teljes AI munkafolyamatok** - Modellfejlesztéstől az éles telepítésig megfelelő felügyelettel  
...
> **Megjegyzés:** Ezek a sablonok különböző AI mintákat mutatnak be. Néhány külső Azure Samples, mások helyi implementációk.

| Sablon | Fejezet | Komplexitás | Szolgáltatások | Típus |
|--------|---------|-------------|----------------|-------|
| [**AI chat kezdése**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 2. fejezet | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights | Külső |
| [**AI ügynökök kezdése**](https://github.com/Azure-Samples/get-started-with-ai-agents) | 2. fejezet | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights | Külső |
...
**Éles alkalmazás sablonok tanulási fejezetekhez igazítva**
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | 2. fejezet | ⭐⭐ | RAG implementáció Azure AI Search segítségével |
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | 8. fejezet | ⭐⭐⭐ | Vállalati AI orkestráció |
...
### Példák tanulási típus szerint  

> **📌 Helyi vs. Külső példák:**  
> **Helyi példák** (ebben a repóban) = Azonnal használatra kész  
> **Külső példák** (Azure Samples) = Klónozás a hivatkozott repókból  

#### Helyi példák (Azonnal használható)  
- [**Kiskereskedelmi többügynökös megoldás**](examples/retail-scenario.md) - Teljes éles implementáció ARM sablonokkal  
...
#### Helyi példák - Konténeres alkalmazások (2-5. fejezetek)  
...
- [**Konténeres alkalmazás példák**](examples/container-app/README.md) - Teljes útmutató konténeres telepítésekhez  
  ...
  - [Mikroszolgáltatások architektúra](../../examples/container-app/microservices) - Éles több szolgáltatás telepítés  
  - Gyors kezdés, éles és haladó telepítési minták  
  - Felügyelet, biztonság és költségoptimalizálás útmutató  

#### Külső példák - Egyszerű alkalmazások (1-2. fejezetek)  
**Klónozd ezeket az Azure Samples repókat a kezdéshez:**  
...
- [Funkciók + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - Szerver nélküli adatfolyamat  

#### Külső példák - Haladó minták (4-8. fejezetek)  
- [Java mikroszolgáltatások](https://github.com/Azure-Samples/java-microservices-aca-lab) - Több szolgáltatás architektúrák  
- [Konténeres alkalmazások feladat
### Gyakorlati Workshopok
- [**AI Workshop Lab**](docs/microsoft-foundry/ai-workshop-lab.md) - Tegye AI megoldásait AZD-kompatibilissé (2-3 óra)
...
**Gyakori problémák, amelyekkel a kezdők szembesülnek, és azonnali megoldások:**
...
- AI alkalmazások: 15-25 perc (OpenAI telepítése lassú)

```bash
# Ellenőrizze a haladást
azd show

# Ha elakad >30 percig, ellenőrizze az Azure Portált:
azd monitor
...
## 🎓 Tanfolyam Teljesítése és Tanúsítvány
...
### Tanfolyam Teljesítésének Előnyei
A fejezetek befejezése után:
- **Produkciós Tapasztalat**: Valós AI alkalmazásokat telepített az Azure-ra
...
- **Karrierfejlesztés**: Keresett AZD és AI telepítési szakértelem
...
### Közösségi Észrevételek a Microsoft Foundry Discordról

**Legutóbbi Szavazási Eredmények az #Azure Csatornán:**
- **45%** fejlesztő szeretné AZD-t használni AI munkaterhelésekhez
- **Fő kihívások**: Több szolgáltatás telepítése, hitelesítési problémák, produkciós készenlét  
...
- Hatással legyen a jövőbeli AI + AZD funkciófejlesztésre
...
- **Tartalomfejlesztés**: Javítsa a meglévő fejezeteket és példákat
- **Új Példák**: Adjon hozzá valós forgatókönyveket és sablonokat  
- **Fordítás**: Segítsen a többnyelvű támogatás fenntartásában
- **Hibajelentések**: Javítsa a pontosságot és az érthetőséget
- **Közösségi Normák**: Kövesse befogadó közösségi irányelveinket
...
### Copilot sorozat  
[![Copilot az AI páros programozáshoz](https://img.shields.io/badge/Copilot%20az%20AI%20p%C3%A1ros%20programoz%C3%A1shoz-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
...
**Kezdők**: Kezdd itt: [1. fejezet: Alapok és gyors kezdés](../..)  
**AI fejlesztők**: Ugorj ide: [2. fejezet: AI-első fejlesztés](../..)  
**Tapasztalt fejlesztők**: Kezdd itt: [3. fejezet: Konfiguráció és hitelesítés](../..)
