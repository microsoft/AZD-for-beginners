...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T10:19:47+00:00",
...
![AZD-für-Einsteiger](../../translated_images/de/azdbeginners.5527441dd9f74068.png) 
...
Befolgen Sie diese Schritte, um Ihre AZD-Lernreise zu beginnen:
...
4. **Wählen Sie Ihren Lernpfad**: Wählen Sie unten ein Kapitel aus, das Ihrem Erfahrungsniveau entspricht

### Mehrsprachige Unterstützung

#### Automatische Übersetzungen (immer auf dem neuesten Stand)
...
Beherrschen Sie Azure Developer CLI (azd) durch strukturierte Kapitel, die für fortschreitendes Lernen ausgelegt sind. **Besonderer Schwerpunkt auf der Bereitstellung von KI-Anwendungen mit Microsoft Foundry-Integration.**

### Warum dieser Kurs für moderne Entwickler essentiell ist
...
- **Probleme bei Bereitstellungen beheben**: Häufige Probleme lösen und Fehler debuggen
...
- **📋 Kurzübersicht**: [Befehls-Cheat-Sheet](resources/cheat-sheet.md)
...
**💡 Kapitelziel**: Erfolgreiche Bereitstellung einer einfachen Webanwendung in Azure mit AZD
...
**📈 Fähigkeitsniveau danach:** Kann einfache Anwendungen eigenständig bereitstellen
...
### 🤖 Kapitel 2: KI-fokussierte Entwicklung (empfohlen für KI-Entwickler)
...
**💡 Kapitelziel**: Eine KI-gestützte Chat-Anwendung mit RAG-Funktionen bereitstellen und konfigurieren
...
azd init --template azure-search-openai-demo
azd up
# Die KI-Chat-Schnittstelle testen
...
**💰 Kostenbewusstsein:** Entwickeln Sie ein Verständnis für Entwicklungs‑kosten von $80-150/Monat, Produktionskosten von $300-3.500/Monat
...
- Azure OpenAI (PTU für konsistente Leistung): $3.000+/Monat ODER Pay-as-go bei großem Volumen
...
- Verwenden Sie die **Free Tier** von Azure OpenAI zum Lernen (50.000 Tokens/Monat enthalten)
- Führen Sie `azd down` aus, um Ressourcen freizugeben, wenn Sie nicht aktiv entwickeln
- Beginnen Sie mit verbrauchsabhängiger Abrechnung, auf PTU nur für Produktion umstellen
...
#### Lernressourcen
- **📖 Konfiguration**: [Konfigurationsleitfaden](docs/getting-started/configuration.md) - Umgebungseinrichtung
...
- Einrichten der Authentifizierung mit Managed Identity
- Implementieren umgebungsspezifischer Konfigurationen

**💡 Kapitelziel**: Mehrere Umgebungen mit geeigneter Authentifizierung und Sicherheit verwalten
...
- Strategien zur Bereitstellung von Ressourcen

#### Lernressourcen
- **📖 Bereitstellung**: [Bereitstellungsleitfaden](docs/deployment/deployment-guide.md) - Vollständige Workflows
- **🏗️ Bereitstellung von Ressourcen**: [Provisioning Resources](docs/deployment/provisioning.md) - Azure-Ressourcenverwaltung
...
**💡 Kapitelziel**: Komplexe Multi-Service-Anwendungen unter Verwendung eigener Infrastrukturvorlagen bereitstellen
...
#### Lernressourcen
- **🤖 Vorgestelltes Projekt**: [Einzelhandels-Multi-Agenten-Lösung](examples/retail-scenario.md) - Vollständige Implementierung
...
**💡 Kapitel-Ergebnis**: Bereitstellung und Verwaltung einer produktionsbereiten Multi-Agent-KI-Lösung mit Customer- und Inventory-Agenten
...
- **💰 Auswahl**: [SKU Selection](docs/pre-deployment/sku-selection.md) - Kostenbewusste Entscheidungen
...
- Optimieren Sie SKU-Auswahlen hinsichtlich der Kosten
...
- **🤖 KI-Probleme**: [AI-Specific Troubleshooting](docs/troubleshooting/ai-troubleshooting.md) - Probleme mit KI-Diensten

#### Praktische Übungen
- Diagnostizieren Sie Bereitstellungsfehler
- Beheben Sie Authentifizierungsprobleme
- Debuggen Sie die Konnektivität zu KI-Diensten

**💡 Kapitel-Ergebnis**: Unabhängige Diagnose und Behebung häufiger Bereitstellungsprobleme
...
- **📊 Überwachung**: [Application Insights integration](docs/pre-deployment/application-insights.md) - Überwachung

#### Praktische Übungen
- Implementieren Sie Unternehmenssicherheitsmuster
- Richten Sie umfassende Überwachung ein
- Bereitstellen in der Produktion mit angemessener Governance

**💡 Kapitel-Ergebnis**: Deployment von unternehmensbereiten Anwendungen mit vollständigen Produktionsfähigkeiten
...
> Die Workshop-Materialien werden derzeit entwickelt und verfeinert. Kernmodule sind funktionsfähig, aber einige fortgeschrittene Abschnitte sind unvollständig. Wir arbeiten aktiv daran, alle Inhalte fertigzustellen. [Track progress →](workshop/README.md)

### Interaktive Workshop-Materialien
**Umfassendes praxisorientiertes Lernen mit browserbasierten Tools und geführten Übungen**

Unsere Workshop-Materialien bieten ein strukturiertes, interaktives Lernerlebnis, das das oben stehende kapitelbasierte Curriculum ergänzt. Der Workshop ist sowohl für Selbstlernende als auch für geleitete Sitzungen durch Instruktoren konzipiert.
...
- **Discovery → Deployment → Customization**: Progressive Methodik
- **Interaktive DevContainer-Umgebung**: Vorgefertigte Tools und Abhängigkeiten

#### 📚 Workshop-Struktur
Der Workshop folgt einer **Discovery → Deployment → Customization**-Methodik:

1. **Discovery-Phase** (45 Minuten)
   - Erkunden Sie Microsoft Foundry-Vorlagen und -Dienste
   - Verstehen Sie Multi-Agent-Architekturmuster
   - Überprüfen Sie Bereitstellungsanforderungen und Voraussetzungen

2. **Deployment-Phase** (2 Stunden)
   - Praktische Bereitstellung von KI-Anwendungen mit AZD
   - Konfigurieren Sie Azure KI-Dienste und Endpunkte
   - Implementieren Sie Sicherheits- und Authentifizierungsmuster

3. **Customization-Phase** (45 Minuten)
   - Passen Sie Anwendungen für spezifische Anwendungsfälle an
   - Optimieren Sie für Produktionsbereitstellungen
   - Implementieren Sie Überwachung und Kostenmanagement
...
# Befolge die Einrichtungshinweise in workshop/README.md
```

#### 🎯 Lernziele des Workshops
Durch den Abschluss des Workshops werden die Teilnehmenden in der Lage sein:
- **Produktions-KI-Anwendungen bereitzustellen**: Verwenden Sie AZD mit Microsoft Foundry-Diensten
- **Multi-Agent-Architekturen zu meistern**: Implementieren Sie koordinierte Agenten-Lösungen
- **Sicherheits-Best-Practices umzusetzen**: Konfigurieren Sie Authentifizierung und Zugriffskontrolle
- **Für Skalierung zu optimieren**: Entwerfen Sie kosteneffiziente, leistungsfähige Bereitstellungen
- **Bereitstellungen zu debuggen**: Häufige Probleme eigenständig beheben

#### 📖 Workshop-Ressourcen
- **🎥 Interaktiver Leitfaden**: [Workshop Materials](workshop/README.md) - Browserbasiertes Lernumfeld
- **📋 Schritt-für-Schritt-Anleitungen**: [Guided Exercises](../../workshop/docs/instructions) - Detaillierte Durchläufe
- **🛠️ AI Workshop Lab**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - KI-fokussierte Übungen
- **💡 Schnellstart**: [Workshop Setup Guide](workshop/README.md#quick-start) - Umgebungskonfiguration

**Perfekt für**: Firmen-Schulungen, Universitätskurse, selbstgesteuertes Lernen und Entwicklercamps.

---

## 📖 Was ist Azure Developer CLI?

Azure Developer CLI (azd) ist eine entwicklerorientierte Kommandozeilenschnittstelle, die den Prozess des Erstellens und Bereitstellens von Anwendungen in Azure beschleunigt. Sie bietet:

- **Vorlagenbasierte Bereitstellungen** - Verwenden Sie vordefinierte Vorlagen für gängige Anwendungs‑Muster
...
### **AZD + Microsoft Foundry: Ideal für KI-Bereitstellungen**

**Warum AZD für KI-Lösungen?** AZD adressiert die wichtigsten Herausforderungen, denen KI-Entwickler gegenüberstehen:

- **KI-bereite Vorlagen** - Vorgefertigte Vorlagen für Azure OpenAI, Cognitive Services und ML-Workloads
- **Sichere KI-Bereitstellungen** - Eingebaute Sicherheitsmuster für KI-Dienste, API-Schlüssel und Modellendpunkte  
- **Produktions-KI-Muster** - Best Practices für skalierbare, kosteneffiziente KI-Anwendungs-Bereitstellungen
- **End-to-End KI-Workflows** - Vom Modellentwicklungsprozess bis zur Produktionsbereitstellung mit geeigneter Überwachung
...
## 🎯 Vorlagen- & Beispiele-Bibliothek

### Empfohlen: Microsoft Foundry-Vorlagen
**Beginnen Sie hier, wenn Sie KI-Anwendungen bereitstellen!**

> **Hinweis:** Diese Vorlagen demonstrieren verschiedene KI-Muster. Einige stammen aus externen Azure Samples, andere sind lokale Implementierungen.
...
| Template | Lernkapitel | Komplexität | Wichtiger Lerninhalt |
|----------|------------------|------------|--------------|
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Kapitel 5 | ⭐⭐⭐⭐ | Multi-Agent-Architektur mit Customer- und Inventory-Agenten |

### Lernen nach Beispieltyp

> **📌 Lokale vs. Externe Beispiele:**  
> **Lokale Beispiele** (in diesem Repo) = Sofort einsatzbereit  
> **Externe Beispiele** (Azure Samples) = Vom verlinkten Repository klonen

#### Lokale Beispiele (sofort einsatzbereit)
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Vollständige produktionsbereite Implementierung mit ARM-Templates
...
- [**Container App Examples**](examples/container-app/README.md) - Vollständige Anleitung zu containerisierten Bereitstellungen
  ...
  - Quick Start-, Produktions- und erweiterte Bereitstellungsmuster
  - Überwachung, Sicherheit und kostenoptimierende Hinweise
...
### Schnelle Referenzen
- [**Command Cheat Sheet**](resources/cheat-sheet.md) - Wesentliche azd-Befehle, nach Kapiteln geordnet
- [**Glossary**](resources/glossary.md) - Azure- und azd‑Terminologie  
- [**FAQ**](resources/faq.md) - Häufig gestellte Fragen, nach Lernkapitel geordnet
- [**Study Guide**](resources/study-guide.md) - Umfassende Praxisübungen

### Praktische Workshops
- [**AI Workshop Lab**](docs/microsoft-foundry/ai-workshop-lab.md) - Machen Sie Ihre KI-Lösungen AZD-bereitstellbar (2-3 Stunden)
- [**Interactive Workshop Guide**](workshop/README.md) - Browserbasierter Workshop mit MkDocs und DevContainer-Umgebung
- [**Structured Learning Path**](../../workshop/docs/instructions) -7-stufige geführte Übungen (Discovery → Deployment → Customization)
- [**AZD For Beginners Workshop**](workshop/README.md) - Vollständige praktische Workshop-Materialien mit GitHub Codespaces-Integration
...
```bash
# AZD generiert eindeutige Namen, aber im Falle eines Konflikts:
azd down --force --purge
...
# Bei Stillstand >30 Minuten das Azure-Portal prüfen:
azd monitor
...
- **Debugging Guide:** [Schritt-für-Schritt-Debugging](docs/troubleshooting/debugging.md)
...
# Wenn länger als 30 Minuten feststeckt, das Azure-Portal überprüfen:
azd monitor
# Nach fehlgeschlagenen Bereitstellungen suchen
```
</details>
...
1. **Praktische Übung**: Schließe die praktische Bereitstellung des Kapitels ab
2. **Wissensüberprüfung**: Überprüfe den FAQ-Bereich für dein Kapitel
3. **Community-Diskussion**: Teile deine Erfahrungen im Azure Discord
4. **Nächstes Kapitel**: Gehe zum nächsten Komplexitätsniveau

### Vorteile beim Abschluss des Kurses
...
- **Karrierefortschritt**: Gefragte AZD- und KI-Bereitstellungskenntnisse
...
### Einblicke aus dem Microsoft Foundry Discord

**Aktuelle Umfrageergebnisse aus dem #Azure-Kanal:**
- **45%** der Entwickler möchten AZD für KI-Workloads verwenden
- **Hauptprobleme**: Mehrdienst-Bereitstellungen, Verwaltung von Anmeldeinformationen, Produktionsbereitschaft  
- **Am meisten gewünscht**: KI-spezifische Vorlagen, Fehlerbehebungsleitfäden, Best Practices

**Tritt unserer Community bei, um:**
- Teile deine AZD- und KI-Erfahrungen und erhalte Hilfe
- Erhalte frühzeitige Vorschauen neuer KI-Vorlagen
- Trage zu Best Practices für KI-Bereitstellungen bei
- Beeinflusse die zukünftige Entwicklung von KI- und AZD-Funktionen
...
- **Neue Beispiele**: Szenarien aus der Praxis und Vorlagen hinzufügen  
- **Übersetzung**: Hilf bei der Pflege der Mehrsprachigkeit
- **Fehlerberichte**: Verbesserung der Genauigkeit und Klarheit
