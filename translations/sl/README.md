...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T20:21:19+00:00",
...
1. **Razvejite repozitorij (fork)**: Kliknite [![GitHub forkov](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
...
Na podlagi vpogledov skupnosti Microsoft Foundry na Discordu, **45 % razvijalcev želi uporabljati AZD za AI delovne obremenitve**, vendar naletijo na izzive pri:
- Zapletene večstorivne AI arhitekture
- Najboljše prakse za postavitev AI v produkciji  
- Integracija in konfiguracija Azure AI storitev
- Optimizacija stroškov za AI delovne obremenitve
- Odpravljanje težav, specifičnih za AI nameščanje

### Cilji učenja

Z dokončanjem tega strukturiranega tečaja boste:
- **Obvladali temeljne pojme AZD**: osnovni koncepti, namestitev in konfiguracija
- **Postavili AI aplikacije**: uporaba AZD z Microsoft Foundry storitvami
- **Uvedli infrastrukturo kot kodo**: upravljanje Azure virov z Bicep predlogami
- **Odpravili napake pri nameščanju**: reševanje pogostih težav in odpravljanje napak
- **Optimizirali za produkcijo**: varnost, skaliranje, spremljanje in upravljanje stroškov
- **Zgradili večagentne rešitve**: nameščanje zapletenih AI arhitektur
...
- **🛠️ Praktično**: [Vaš prvi projekt](docs/getting-started/first-project.md) - Korak-po-koraku vadnica
- **📋 Hitri priročnik**: [Povzetek ukazov](resources/cheat-sheet.md)
...
**💡 Izhod poglavja**: Uspešno postavite preprosto spletno aplikacijo v Azure z uporabo AZD
...
**📈 Raven spretnosti po:** Sposoben samostojno namestiti osnovne aplikacije

**✅ Preverjanje uspeha:**
```bash
# Po zaključku 1. poglavja boste lahko:
azd version              # Prikaže nameščeno različico
azd init --template todo-nodejs-mongo  # Inicializira projekt
azd up                  # Razporedi v Azure
...
- Postavitev aplikacij, poganjanih z AI
...
- **📖 Vzorce**: [Nameščanje AI modelov](docs/microsoft-foundry/ai-model-deployment.md) - Postavitev in upravljanje AI modelov
- **🛠️ Delavnica**: [AI delavnica](docs/microsoft-foundry/ai-workshop-lab.md) - Pripravite svoje AI rešitve za AZD
- **🎥 Interaktivni vodnik**: [Gradiva delavnice](workshop/README.md) - Učenje v brskalniku z MkDocs * DevContainer okoljem
- **📋 Predloge**: [Predloge Microsoft Foundry](../..)
- **📝 Primeri**: [Primeri AZD nameščanja](examples/README.md)
...
**💡 Izhod poglavja**: Postavite in konfigurirajte klepetalno aplikacijo, poganjano z AI, z RAG zmogljivostmi
...
# Postavljati vprašanja in prejemati odgovore, ki jih poganja AI, z viri
# Preveriti, ali integracija iskanja deluje
azd monitor  # Preveriti, ali Application Insights prikazuje telemetrijo
azd down --force --purge
```

**📊 Časovni vložek:** 1-2 ure  
**📈 Raven spretnosti po:** Sposoben postaviti in konfigurirati aplikacije, pripravljene za produkcijo  
**💰 Zavedanje stroškov:** Razumeti stroške razvoja $80-150/mesec, stroški produkcije $300-3500/mesec

#### 💰 Razmisleki o stroških za AI nameščanja

**Razvojno okolje (ocenjeno $80-150/mesec):**
- Azure OpenAI (plačilo po porabi): $0-50/mesec (odvisno od uporabe tokenov)
...
- Azure OpenAI (PTU za dosledne zmogljivosti): $3,000+/mesec OR Pay-as-go with high volume
...
- Uporabite **brezplačen nivo** Azure OpenAI za učenje (50,000 tokenov/mesec vključeno)
- Zaženite `azd down` , da sprostite vire, kadar aktivno ne razvijate
- Začnite z obračunavanjem po porabi, na PTU nadgradite le za produkcijo
- Uporabite `azd provision --preview` , da ocenite stroške pred nameščanjem
...
- **📝 Primeri**: [Primer aplikacije z bazo podatkov](examples/database-app/README.md) - AZD primeri baz podatkov
...
**💡 Izhod poglavja**: Upravljajte več okolij z ustrezno avtentikacijo in varnostjo
...
- Strategije dodeljevanja virov

#### Viri za učenje
- **📖 Nameščanje**: [Vodnik za nameščanje](docs/deployment/deployment-guide.md) - Celotni poteki dela
- **🏗️ Dodeljevanje**: [Dodeljevanje virov](docs/deployment/provisioning.md) - Upravljanje Azure virov
- **📝 Primeri**: [Primer Container App](../../examples/container-app) - Nameščanja v vsebnikih

#### Praktične vaje
- Ustvarite lastne Bicep predloge
- Namestite večstorivne aplikacije
- Uvedite strategije blue-green nameščanja

**💡 Izhod poglavja**: Namestite kompleksne večstorivne aplikacije z uporabo lastnih infrastrukturnih predlog
...
#### Kaj se boste naučili
- Vzorci arhitektur več agentov
- Orkestracija in koordinacija agentov
- AI nameščanja, pripravljena za produkcijo

#### Viri za učenje
- **🤖 Izpostavljen projekt**: [Večagentna rešitev za trgovino](examples/retail-scenario.md) - Celovita implementacija
- **🛠️ ARM Templates**: [ARM Template Package](../../examples/retail-multiagent-arm-template) - Namestitev z enim klikom
- **📖 Architecture**: [Multi-agent coordination patterns](/docs/pre-deployment/coordination-patterns.md) - Vzorci
...
### Quick References
- [**Hitri pregled ukazov**](resources/cheat-sheet.md) - Osnovni azd ukazi, razporejeni po poglavjih
- [**Slovar**](resources/glossary.md) - Terminologija za Azure in azd  
- [**Pogosta vprašanja**](resources/faq.md) - Pogosta vprašanja, razporejena po učnih poglavjih
- [**Študijski vodnik**](resources/study-guide.md) - Celovite praktične vaje

### Praktične delavnice
- [**AI Workshop Lab**](docs/microsoft-foundry/ai-workshop-lab.md) - Pripravite svoje AI rešitve za nameščanje z AZD (2-3 hours)
- [**Interaktivni vodič delavnice**](workshop/README.md) - Delavnica v brskalniku z MkDocs in okoljem DevContainer Environment
- [**Strukturirana učna pot**](../../workshop/docs/instructions) -7-korakovne vodene vaje (Raziskovanje → Namestitev → Prilagoditev)
- [**AZD For Beginners Workshop**](workshop/README.md) - Celoten praktični material delavnice z integracijo GitHub Codespaces
...
- AI aplikacije: 15-25 minut (OpenAI provisioning is slow)
...
- **Vodič za razhroščevanje:** [Korak-po-koraku razhroščevanje](docs/troubleshooting/debugging.md)
...
# Nato poskusite znova z novim okoljem
azd env new dev-v2
azd up
```
</details>
...
# Potrebujete vsaj vlogo "Contributor"
# Prosite svojega skrbnika za Azure, naj dodeli:
# - Contributor (za vire)
# - User Access Administrator (za dodeljevanje vlog)
```
</details>
...
## 🎓 Dokončanje tečaja in potrdila

### Sledenje napredku
Spremljajte svoj napredek pri učenju v vsakem poglavju:

- [ ] **Poglavje 1**: Osnove & Hiter začetek ✅
- [ ] **Poglavje 2**: Razvoj, osredotočen na AI ✅  
- [ ] **Poglavje 3**: Konfiguracija & Avtentikacija ✅
- [ ] **Poglavje 4**: Infrastruktura kot koda & Namestitev ✅
- [ ] **Poglavje 5**: Večagentne AI rešitve ✅
- [ ] **Poglavje 6**: Validacija in načrtovanje pred nameščanjem ✅
- [ ] **Poglavje 7**: Odpravljanje težav & Razhroščevanje ✅
- [ ] **Poglavje 8**: Produkcija & Podjetniški vzorci ✅

### Preverjanje znanja
Po zaključku vsakega poglavja preverite svoje znanje tako:
1. **Praktična vaja**: Izvedite praktično namestitev iz poglavja
2. **Preverjanje znanja**: Preglejte razdelek z vprašanji (FAQ) za svoje poglavje
...
### Koristi ob zaključku tečaja
Po zaključku vseh poglavij boste imeli:
- **Izkušnje z produkcijo**: Nameščene resnične AI aplikacije v Azure
- **Strokovne veščine**: Sposobnosti nameščanja, primerne za podjetja  
- **Priznanje v skupnosti**: Aktivni član Azure razvijalške skupnosti
- **Napredovanje v karieri**: Iskane veščine za nameščanje AZD in AI
...
- **Glavne težave**: Implementacije z več storitvami, upravljanje poverilnic, priprava za produkcijo  
...
- Prispevajte k najboljšim praksam nameščanja AI
- Vplivajte na razvoj prihodnjih funkcij AI + AZD

### Sodelovanje pri tečaju
Prispevke sprejemamo! Za podrobnosti preberite naš [Vodič za prispevke](CONTRIBUTING.md) za podrobnosti o:
...
- **Standardi skupnosti**: Sledite našim vodilom za vključujočo skupnost
...
### Serija Copilot
[![Copilot za soprogramiranje z AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
**Začetniki**: Začnite z [Poglavje 1: Osnove in hiter začetek](../..)  
**Razvijalci AI**: Pojdite na [Poglavje 2: Razvoj, osredotočen na AI](../..)  
**Izkušeni razvijalci**: Začnite pri [Poglavje 3: Konfiguracija in avtentikacija](../..)
