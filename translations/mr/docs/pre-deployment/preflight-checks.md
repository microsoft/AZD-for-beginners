...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:36:33+00:00",
  "source_file": "docs/pre-deployment/preflight-checks.md",
  "language_code": "mr"
}
-->
# प्री-फ्लाइट तपासणी - डिप्लॉयमेंट तयारीची पडताळणी

## परिचय

ही सविस्तर मार्गदर्शिका Azure Developer CLI डिप्लॉयमेंट्स सुरू होण्यापूर्वी यशस्वी होण्यासाठी प्री-डिप्लॉयमेंट पडताळणी स्क्रिप्ट्स आणि प्रक्रिया प्रदान करते. ऑथेंटिकेशन, संसाधन उपलब्धता, कोटा, सुरक्षा अनुपालन, आणि कार्यक्षमता आवश्यकता यासाठी स्वयंचलित तपासणी कशी करावी हे शिका, जेणेकरून डिप्लॉयमेंट अपयश टाळता येईल आणि यशाचे प्रमाण वाढवता येईल.

## शिकण्याची उद्दिष्टे

ही मार्गदर्शिका पूर्ण करून, तुम्ही:
- प्री-डिप्लॉयमेंट स्वयंचलित पडताळणी तंत्र आणि स्क्रिप्ट्समध्ये प्राविण्य मिळवाल
- ऑथेंटिकेशन, परवानग्या, आणि कोटा यासाठी सविस्तर तपासणी रणनीती समजून घ्याल
- संसाधन उपलब्धता आणि क्षमता पडताळणी प्रक्रिया अंमलात आणाल
- संस्थात्मक धोरणांसाठी सुरक्षा आणि अनुपालन तपासणी कॉन्फिगर कराल
- खर्चाचा अंदाज आणि बजेट पडताळणी कार्यप्रवाह डिझाइन कराल
- CI/CD पाइपलाइन्ससाठी कस्टम प्री-फ्लाइट तपासणी स्वयंचलितपणे तयार कराल

## शिकण्याचे परिणाम

पूर्ण झाल्यावर, तुम्ही:
- सविस्तर प्री-फ्लाइट पडताळणी स्क्रिप्ट्स तयार आणि अंमलात आणू शकाल
- विविध डिप्लॉयमेंट परिस्थितीसाठी स्वयंचलित तपासणी कार्यप्रवाह डिझाइन करू शकाल
- पर्यावरण-विशिष्ट पडताळणी प्रक्रिया आणि धोरणे अंमलात आणू शकाल
- डिप्लॉयमेंट तयारीसाठी सक्रिय मॉनिटरिंग आणि अलर्टिंग कॉन्फिगर करू शकाल
- प्री-डिप्लॉयमेंट समस्यांचे निराकरण करू शकाल आणि सुधारात्मक उपाय अंमलात आणू शकाल
- प्री-फ्लाइट तपासणी DevOps पाइपलाइन्स आणि स्वयंचलित कार्यप्रवाहांमध्ये समाकलित करू शकाल

## विषय सूची

- [आढावा](../../../../docs/pre-deployment)
- [स्वयंचलित प्री-फ्लाइट स्क्रिप्ट](../../../../docs/pre-deployment)
- [मॅन्युअल पडताळणी चेकलिस्ट](../../../../docs/pre-deployment)
- [पर्यावरण पडताळणी](../../../../docs/pre-deployment)
- [संसाधन पडताळणी](../../../../docs/pre-deployment)
...
प्री-फ्लाइट तपासण्या डिप्लॉयमेंटपूर्वी आवश्यक पडताळणी आहेत, ज्यामुळे सुनिश्चित होते:

- **संसाधन उपलब्धता** आणि लक्ष्यित प्रदेशांतील कोटा
- **ऑथेंटिकेशन आणि परवानग्या** योग्य प्रकारे कॉन्फिगर केल्या आहेत
- **टेम्पलेट वैधता** आणि पॅरामीटरची अचूकता
...
## मॅन्युअल पडताळणी चेकलिस्ट

### प्री-डिप्लॉयमेंट चेकलिस्ट

ही चेकलिस्ट प्रिंट करा आणि डिप्लॉयमेंटपूर्वी प्रत्येक आयटम पडताळा:
...
- [ ] azure.yaml मध्ये परिभाषित सर्व सेवा संबंधित स्त्रोत कोडसह आहेत
- [ ] `infra/` डिरेक्टरीतील Bicep टेम्पलेट्स उपस्थित आहेत
- [ ] `main.bicep` त्रुटीशिवाय संकलित होते (`az bicep build --file infra/main.bicep`)
- [ ] सर्व आवश्यक पॅरामीटर्सना डिफॉल्ट मूल्ये आहेत किंवा प्रदान केली जातील
- [ ] टेम्पलेट्समध्ये हार्डकोडेड गुपिते नाहीत

#### ✅ संसाधन नियोजन
- [ ] लक्ष्यित Azure प्रदेश निवडले आणि पडताळले
...
#### ✅ नेटवर्क आणि सुरक्षा
- [ ] Azure एंडपॉइंट्ससाठी नेटवर्क कनेक्टिव्हिटी पडताळली
- [ ] फायरवॉल/प्रॉक्सी सेटिंग्ज आवश्यक असल्यास कॉन्फिगर केल्या
- [ ] गुपित व्यवस्थापनासाठी Key Vault कॉन्फिगर केले
- [ ] शक्य असल्यास व्यवस्थापित ओळखी वापरल्या
- [ ] वेब अनुप्रयोगांसाठी HTTPS अंमलात आणले

#### ✅ खर्च व्यवस्थापन
- [ ] Azure Pricing Calculator वापरून खर्चाचा अंदाज काढला
...
- [ ] Log Analytics कार्यक्षेत्र नियोजित
...
- [ ] डेटा संसाधनांसाठी बॅकअप रणनीती परिभाषित केली
- [ ] पुनर्प्राप्ती वेळ उद्दिष्टे (RTO) दस्तऐवजीकरण केली
- [ ] पुनर्प्राप्ती बिंदू उद्दिष्टे (RPO) दस्तऐवजीकरण केली
...
1. **जिथे शक्य असेल तिथे स्वयंचलित करा**
   ...
   - पुनरावृत्ती पडताळणीसाठी स्क्रिप्ट्स वापरा
   - ऑडिट ट्रेल्ससाठी निकाल संग्रहित करा
...
3. **सविस्तर कव्हरेज**
   ...
   - टेम्पलेट पडताळणी आणि सिंटॅक्स
   - सुरक्षा आणि अनुपालन आवश्यकता

4. **स्पष्ट रिपोर्टिंग**
   - रंग-कोडेड स्थिती निर्देशक
   - सुधारात्मक उपायांसह तपशीलवार त्रुटी संदेश
   - जलद मूल्यांकनासाठी सारांश रिपोर्ट्स
...
1. **"जलद" डिप्लॉयमेंटसाठी पडताळणी वगळणे**
2. **डिप्लॉयमेंटपूर्वी अपुरी परवानग्या तपासणी**
3. **कोटा मर्यादा दुर्लक्षित करणे** जोपर्यंत डिप्लॉयमेंट अपयशी होत नाही
4. **CI/CD पाइपलाइन्समध्ये टेम्पलेट्स पडताळणी न करणे**
5. **प्रॉडक्शन पर्यावरणासाठी सुरक्षा पडताळणी गाळणे**
6. **अपुरा खर्चाचा अंदाज** ज्यामुळे बजेट आश्चर्य निर्माण होते

---

**प्रो टिप**: प्री-फ्लाइट तपासण्या तुमच्या CI/CD पाइपलाइनमध्ये वास्तविक डिप्लॉयमेंट जॉबसाठी स्वतंत्र जॉब म्हणून चालवा. यामुळे तुम्हाला समस्या लवकर पकडता येतात आणि विकसकांना जलद फीडबॅक मिळतो.
