...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:08:37+00:00",
...
ही सविस्तर मार्गदर्शिका तुम्हाला Azure Developer CLI (azd) तुमच्या प्रणालीवर स्थापित आणि कॉन्फिगर करण्याची प्रक्रिया समजावून सांगेल. तुम्ही वेगवेगळ्या ऑपरेटिंग सिस्टमसाठी विविध स्थापना पद्धती, प्रमाणीकरण सेटअप, आणि Azure डिप्लॉयमेंटसाठी तुमचे विकास वातावरण तयार करण्यासाठी प्रारंभिक कॉन्फिगरेशन शिकाल.

## शिकण्याची उद्दिष्टे

या धड्याच्या शेवटी, तुम्ही:
- तुमच्या ऑपरेटिंग सिस्टमवर Azure Developer CLI यशस्वीपणे स्थापित कराल
...
- तुमची स्थापना सत्यापित करून azd चे मूलभूत आदेश चाचणी करू शकाल
...
- **Docker** (ऐच्छिक) - कंटेनराइज्ड अनुप्रयोगांसाठी
...
azd GitHub Codespaces मध्ये पूर्व-स्थापित असतो. फक्त एक codespace तयार करा आणि azd वापरण्यास सुरुवात करा.
...
स्थापना केल्यानंतर, azd योग्यरित्या कार्यरत आहे का ते सत्यापित करा:
...
### Visual Studio Code
Azure Developer CLI एक्स्टेंशन इंस्टॉल करा:
1. VS Code उघडा
2. एक्स्टेंशन्स (Ctrl+Shift+X) वर जा
3. "Azure Developer CLI" शोधा
4. एक्स्टेंशन इंस्टॉल करा
...
2. **तुमचा पहिला डिप्लॉयमेंट प्रयत्न करा**: [पहिल्या प्रोजेक्ट मार्गदर्शिका](first-project.md) अनुसरा
...
**नेव्हिगेशन**
- **मागील धडा**: [AZD मूलभूत गोष्टी](azd-basics.md)
- **पुढील धडा**: [कॉन्फिगरेशन](configuration.md)

**स्थापना पूर्ण!** [तुमचा पहिला प्रोजेक्ट](first-project.md) वर पुढे जा आणि azd वापरून बिल्डिंग सुरू करा.
