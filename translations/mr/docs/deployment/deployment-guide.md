...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:19:56+00:00",
...
ही व्यापक मार्गदर्शिका Azure Developer CLI वापरून अनुप्रयोग डिप्लॉय करण्याबद्दल सर्व काही कव्हर करते, मूलभूत सिंगल-कमांड डिप्लॉयमेंटपासून कस्टम हुक्स, एकाधिक वातावरण आणि CI/CD एकत्रीकरणासह प्रगत उत्पादन परिस्थितीपर्यंत. व्यावहारिक उदाहरणे आणि सर्वोत्तम पद्धतींसह संपूर्ण डिप्लॉयमेंट जीवनचक्रात प्राविण्य मिळवा.

## शिकण्याची उद्दिष्टे

या मार्गदर्शिकेचा अभ्यास करून, तुम्ही:
- Azure Developer CLI च्या सर्व डिप्लॉयमेंट कमांड्स आणि वर्कफ्लोमध्ये प्राविण्य मिळवाल
- प्रोव्हिजनिंगपासून मॉनिटरिंगपर्यंत संपूर्ण डिप्लॉयमेंट जीवनचक्र समजून घ्याल
- प्री आणि पोस्ट-डिप्लॉयमेंट ऑटोमेशनसाठी कस्टम डिप्लॉयमेंट हुक्स अंमलात आणाल
...
- azd डिप्लॉयमेंट्सना CI/CD पाइपलाइन्स आणि DevOps वर्कफ्लोमध्ये एकत्रित कराल

## शिकण्याचे परिणाम

ही मार्गदर्शिका पूर्ण केल्यानंतर, तुम्ही:
- सर्व azd डिप्लॉयमेंट वर्कफ्लो स्वतंत्रपणे अंमलात आणू आणि त्यातील अडचणी सोडवू शकाल
- हुक्स वापरून कस्टम डिप्लॉयमेंट ऑटोमेशन डिझाइन आणि अंमलात आणू शकाल
...
- एंटरप्राइझ DevOps पद्धतींमध्ये azd डिप्लॉयमेंट्स एकत्रित करू शकाल
...
- `azd deploy` - फक्त अनुप्रयोग कोड डिप्लॉय करा
- `azd package` - अनुप्रयोग तयार करा आणि पॅकेज करा

## मूलभूत डिप्लॉयमेंट वर्कफ्लो

### संपूर्ण डिप्लॉयमेंट (azd up)
नवीन प्रकल्पांसाठी सर्वात सामान्य वर्कफ्लो:
```bash
...
### टप्पा 6: अनुप्रयोग डिप्लॉयमेंट
- पॅकेज केलेले अनुप्रयोग Azure सेवांवर डिप्लॉय करतो
- कॉन्फिगरेशन सेटिंग्ज अपडेट करतो
- सेवा सुरू/पुनः सुरू करतो
...
- [संसाधने प्रोव्हिजन करणे](provisioning.md) - इन्फ्रास्ट्रक्चर व्यवस्थापनाचा सखोल अभ्यास
...
**नेव्हिगेशन**
- **मागील धडा**: [तुमचा पहिला प्रकल्प](../getting-started/first-project.md)
- **पुढील धडा**: [संसाधने प्रोव्हिजन करणे](provisioning.md)
