...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:50:21+00:00",
...
3. [**Azure Discord समुदायांमध्ये सामील व्हा आणि तज्ञ व इतर विकसकांशी भेटा**](https://discord.com/invite/ByRwuEEgH4)
...
Azure Developer CLI (azd) साठी व्यापक मार्गदर्शकात आपले स्वागत आहे. हे रेपॉजिटरी विद्यार्थ्यांपासून व्यावसायिक विकसकांपर्यंत सर्व स्तरांवरील विकसकांना Azure Developer CLI शिकण्यासाठी आणि क्लाउड डिप्लॉयमेंटसाठी कार्यक्षमतेने मास्टर करण्यासाठी मदत करण्यासाठी डिझाइन केले आहे, **Azure AI Foundry वापरून AI अनुप्रयोग डिप्लॉयमेंटवर विशेष लक्ष केंद्रित करून**. ही संरचित शिक्षण संसाधने Azure क्लाउड डिप्लॉयमेंट, सामान्य समस्यांचे निराकरण, आणि यशस्वी AZD टेम्पलेट डिप्लॉयमेंटसाठी सर्वोत्तम पद्धती अंमलात आणण्यासाठी व्यावहारिक अनुभव प्रदान करते.
...
या रेपॉजिटरीवर काम करून, तुम्ही:
...
- सामान्य AZD डिप्लॉयमेंट समस्यांचे निराकरण कौशल्य विकसित करा
...
- **एकत्रित वर्कफ्लो** - अनुप्रयोग सहजपणे प्रोव्हिजन, डिप्लॉय आणि मॉनिटर करा
...
- **AI-रेडी टेम्पलेट्स** - Azure OpenAI, Cognitive Services, आणि ML वर्कलोडसाठी पूर्व-कॉन्फिगर केलेले टेम्पलेट्स
- **सुरक्षित AI डिप्लॉयमेंट्स** - AI सेवा, API की, आणि मॉडेल एंडपॉइंट्ससाठी अंगभूत सुरक्षा पॅटर्न
...
### AI विकसकांसाठी (इथून सुरुवात करा!)
1. **जलद सुरुवात**: [azure-search-openai-demo](https://github.com/Azure-Samples/azure-search-openai-demo) टेम्पलेट वापरून पहा
...
4. [साधे वेब अॅप उदाहरण](../../examples/simple-web-app) वापरून सराव करा
...
### AI आणि Azure AI Foundry
- [**Azure AI Foundry एकत्रीकरण**](docs/ai-foundry/azure-ai-foundry-integration.md) - AZD सह Azure AI Foundry सेवांशी कनेक्ट करा
- [**AI मॉडेल डिप्लॉयमेंट पॅटर्न्स**](docs/ai-foundry/ai-model-deployment.md) - AZD सह AI मॉडेल्स डिप्लॉय आणि व्यवस्थापित करा
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - व्यावहारिक लॅब: AI सोल्यूशन्स AZD-रेडी बनवणे
...
| [**एजंट्ससह ग्राहक बैठका सुधारित करा**](https://github.com/Azure-Samples/get-started-with-ai-chat) | एजंट्सच्या टीमचा उपयोग करून जुना कोड आधुनिक भाषांमध्ये स्थलांतरित करा. |⭐⭐⭐| AzureOpenAI + Azure AI Search + Azure CosmosDB + Azure SQL Database |
| [**तुमच्या कोडचे आधुनिकीकरण करा**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Azure Container Apps वापरून तुमच्या डेटा आणि टेलीमेट्री इनसाइट्ससह एक मूलभूत चॅट अ‍ॅप्लिकेशन तयार करा आणि डिप्लॉय करा |⭐⭐⭐ | AzureOpenAI + Azure Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
...
| [**संवादात्मक डेटामधून इनसाइट्स अनलॉक करा**](https://github.com/Azure-Samples/get-started-with-ai-chat) | प्रगत सामग्री समज क्षमतांचा उपयोग करून मोठ्या ऑडिओ आणि मजकूर-आधारित डेटासेट्समधून इनसाइट्स शोधून संपर्क केंद्राची कार्यक्षमता सुधारित करा. |⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
| [**मल्टी-मोडल सामग्री प्रक्रिया**](https://github.com/Azure-Samples/get-started-with-ai-chat) | असंरचित सामग्रीमधून माहिती काढून आणि ती संरचित स्वरूपात मॅप करून दावे, इनव्हॉइस, करार आणि इतर दस्तऐवज जलद आणि अचूकपणे प्रक्रिया करा. हा टेम्पलेट मजकूर, प्रतिमा, टेबल्स आणि ग्राफ्सला समर्थन देतो. |⭐⭐⭐⭐ | AzureOpenAI + Azure Content Understanding + Azure CosmosDB + Azure Container Apps|
...
### अतिरिक्त AZD टेम्पलेट्स
- [**उदाहरणे निर्देशिका**](examples/README.md) - व्यावहारिक उदाहरणे, टेम्पलेट्स आणि वास्तविक परिस्थिती
...
- [GitHub Copilot AI पॅअर्ड प्रोग्रामिंगसाठी मास्टरींग](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
- [GitHub Copilot C#/.NET विकसकांसाठी मास्टरींग](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
