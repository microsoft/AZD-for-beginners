...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T18:46:37+00:00",
...
1. **रेपॉजिटरी फोर्क करा**: क्लिक करा [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)  
...
Azure Developer CLI (azd) साठी व्यापक मार्गदर्शकात आपले स्वागत आहे. हे रेपॉजिटरी विद्यार्थ्यांपासून व्यावसायिक विकसकांपर्यंत सर्व स्तरांवरील विकसकांना Azure Developer CLI शिकण्यासाठी आणि कार्यक्षम क्लाउड डिप्लॉयमेंटसाठी मास्टर करण्यास मदत करण्यासाठी डिझाइन केले आहे. ही संरचित शिक्षण संसाधने Azure क्लाउड डिप्लॉयमेंटसह व्यावहारिक अनुभव, सामान्य समस्या सोडवणे आणि यशस्वी AZD टेम्पलेट डिप्लॉयमेंटसाठी सर्वोत्तम पद्धती लागू करण्यासाठी प्रदान करतात.

## शिक्षण उद्दिष्टे

या रेपॉजिटरीद्वारे काम करून, तुम्ही:  
...
- सामान्य AZD डिप्लॉयमेंट समस्यांसाठी समस्या सोडवण्याचे कौशल्य विकसित करा  
...
- AZD वर्कफ्लो CI/CD पाइपलाइनमध्ये समाकलित करू शकता  
...
### स्टार्टर टेम्पलेट्स  
- [**साधा वेब अनुप्रयोग**](../../examples/simple-web-app) - मूलभूत Node.js वेब अनुप्रयोग डिप्लॉयमेंट  
- [**स्थिर वेबसाइट**](../../examples/static-website) - Azure Storage वर स्थिर वेबसाइट होस्टिंग  
- [**कंटेनर अनुप्रयोग**](../../examples/container-app) - कंटेनराइज्ड अनुप्रयोग डिप्लॉयमेंट  
- [**डेटाबेस अनुप्रयोग**](../../examples/database-app) - डेटाबेस एकत्रीकरणासह वेब अनुप्रयोग  

### प्रगत परिस्थिती  
- [**मायक्रोसर्व्हिसेस**](../../examples/microservices) - मल्टी-सर्व्हिस अनुप्रयोग आर्किटेक्चर  
- [**सर्व्हरलेस फंक्शन्स**](../../examples/serverless-function) - Azure Functions डिप्लॉयमेंट  
- [**कॉन्फिगरेशन उदाहरणे**](../../examples/configurations) - पुनर्वापरयोग्य कॉन्फिगरेशन पॅटर्न  
...
1. [AZD मूलभूत गोष्टी](docs/getting-started/azd-basics.md) पासून प्रारंभ करा  
...
4. [साधा वेब अनुप्रयोग उदाहरण](../../examples/simple-web-app) सराव करा  
...
3. [डेटाबेस अनुप्रयोग उदाहरण](../../examples/database-app) पूर्ण करा  
4. [कंटेनर अनुप्रयोग उदाहरण](../../examples/container-app) एक्सप्लोर करा  
...
4. प्रगत [मायक्रोसर्व्हिसेस उदाहरण](../../examples/microservices)  

## योगदान

आम्ही योगदानांचे स्वागत करतो! कृपया आमचे [योगदान मार्गदर्शक](CONTRIBUTING.md) वाचा:  
- समस्या आणि वैशिष्ट्य विनंत्या कशा सबमिट करायच्या  
...
- **Microsoft Learn**: [Azure Developer CLI चे अधिकृत दस्तऐवजीकरण](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)  
...
- [वेब डेव्हलपमेंटसाठी नवशिके](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
- [IoT साठी नवशिके](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)
- [XR डेव्हलपमेंटसाठी नवशिके](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
...
- [आपल्या Copilot साहसाची निवड करा](https://github.com/microsoft/CopilotAdventures?WT.mc_id=academic-105485-koreyst)
