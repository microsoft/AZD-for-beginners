...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:22:47+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "ar"
}
-->
# توفير الموارد - البنية التحتية ككود باستخدام AZD
...
- فهم مقدمي خدمات IaC المتعددة المدعومة من Azure Developer CLI
- تصميم وتنفيذ قوالب Bicep لتصاميم التطبيقات الشائعة
- تكوين معلمات الموارد، المتغيرات، والإعدادات الخاصة بالبيئة
...
- تصميم وتوفير بنية تحتية Azure باستخدام Bicep وقوالب ARM
- تكوين بنى متعددة الخدمات مع تبعيات الموارد المناسبة
- تنفيذ قوالب مخصصة للبيئات والتكوينات المختلفة
- استكشاف مشكلات توفير البنية التحتية وحل أخطاء النشر
- تطبيق مبادئ إطار العمل المعماري الجيد لـ Azure على تصميم البنية التحتية
- إدارة تحديثات البنية التحتية وتنفيذ استراتيجيات إصدار البنية التحتية

## نظرة عامة على توفير البنية التحتية

يدعم Azure Developer CLI العديد من مقدمي خدمات البنية التحتية ككود (IaC):
- **Bicep** (موصى به) - لغة مخصصة لـ Azure
- **قوالب ARM** - قوالب JSON الخاصة بـ Azure Resource Manager
...
- [مركز Azure المعماري](https://learn.microsoft.com/en-us/azure/architecture/)
