...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:23:23+00:00",
...
- تكوين معلمات الموارد، المتغيرات، وإعدادات البيئة المحددة
...
- حل مشكلات توفير البنية التحتية ومعالجة أخطاء النشر
...
- **Bicep** (موصى به) - لغة خاصة بمجال Azure
- **قوالب ARM** - قوالب مدير موارد Azure القائمة على JSON
...
- [المشكلات الشائعة](../troubleshooting/common-issues.md) - حل مشكلات البنية التحتية
