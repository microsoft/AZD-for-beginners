...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T12:51:22+00:00",
...
يغطي هذا الدليل الشامل جميع جوانب تكوين Azure Developer CLI لتحقيق أفضل تدفقات عمل للتطوير والنشر. ستتعلم عن تسلسل التكوين، وإدارة البيئات، وطرق المصادقة، وأنماط التكوين المتقدمة التي تتيح عمليات نشر فعالة وآمنة على Azure.

## أهداف التعلم

بنهاية هذا الدرس، ستتمكن من:
- إتقان تسلسل التكوين في azd وفهم كيفية تحديد أولوية الإعدادات
- تكوين الإعدادات العامة والخاصة بالمشاريع بشكل فعال
...
- تكوين azd لتحقيق أفضل تدفقات عمل للتطوير
- إعداد وإدارة بيئات نشر متعددة
- تنفيذ ممارسات إدارة التكوين الآمنة
- حل المشكلات المتعلقة بالتكوين
- تخصيص سلوك azd لتلبية متطلبات مؤسستك

يغطي هذا الدليل الشامل جميع جوانب تكوين Azure Developer CLI لتحقيق أفضل تدفقات عمل للتطوير والنشر.

## تسلسل التكوين

يستخدم azd نظام تكوين هرمي:
1. **علامات سطر الأوامر** (الأولوية الأعلى)
2. **متغيرات البيئة**
  ...
  api:
    ...
    docker:
      ...
      buildArgs:
        ...
        API_VERSION: v1.0.0
```  
مثال على `Dockerfile`: https://github.com/Azure-Samples/deepseek-go/blob/main/azure.yaml 
...
### 4. توثيق التكوين
قم بتوثيق التكوين الخاص بك في `CONFIG.md`:
```markdown
# Configuration Guide
...
**التنقل**
- **الدرس السابق**: [التثبيت والإعداد](installation.md)
