...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:11:04+00:00",
...
يغطي هذا الدليل الشامل جميع جوانب تكوين Azure Developer CLI لتحقيق أفضل تدفقات العمل للتطوير والنشر. ستتعلم عن التسلسل الهرمي للتكوين، إدارة البيئات، طرق المصادقة، وأنماط التكوين المتقدمة التي تُمكّن من عمليات نشر آمنة وفعالة على Azure.
...
- إدارة بيئات متعددة ذات تكوينات مختلفة
...
### تكوين Terraform
بالنسبة لمشاريع Terraform، قم بالتكوين في `infra/terraform.tfvars`:
```hcl
