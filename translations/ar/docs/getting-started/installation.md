...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:07:17+00:00",
...
3. أضف المسار إلى متغير PATH في النظام
...
azd مثبت مسبقًا في GitHub Codespaces. ببساطة قم بإنشاء مساحة عمل وابدأ باستخدام azd مباشرة.
...
1. **إكمال المصادقة**: تأكد من إمكانية الوصول إلى اشتراك Azure الخاص بك
...
4. **تكوين بيئة التطوير الخاصة بك**: قم بإعداد بيئة التطوير الخاصة بك
...
**التنقل**
- **الدرس السابق**: [أساسيات AZD](azd-basics.md)
- **الدرس التالي**: [التكوين](configuration.md)
