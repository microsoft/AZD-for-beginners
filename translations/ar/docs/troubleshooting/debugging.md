...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:30:56+00:00",
  "source_file": "docs/troubleshooting/debugging.md",
  "language_code": "ar"
}
-->
# دليل تصحيح الأخطاء - تقنيات استكشاف الأخطاء المتقدمة

## المقدمة

يوفر هذا الدليل الشامل استراتيجيات وأدوات وتقنيات متقدمة لتشخيص وحل المشكلات المعقدة المتعلقة بنشر Azure Developer CLI. تعلم منهجيات استكشاف الأخطاء بشكل منهجي، تقنيات تحليل السجلات، تحليل الأداء، وأدوات التشخيص المتقدمة لحل مشكلات النشر والتشغيل بكفاءة.

## أهداف التعلم

عند إكمال هذا الدليل، ستتمكن من:
- إتقان منهجيات تصحيح الأخطاء المنهجية لمشكلات Azure Developer CLI
- فهم تكوين السجلات المتقدم وتقنيات تحليل السجلات
- تنفيذ استراتيجيات مراقبة وتحليل الأداء
...
- تطبيق منهجية TRIAGE لتصحيح الأخطاء في مشكلات النشر المعقدة بشكل منهجي
- تكوين وتحليل معلومات السجلات والتتبع بشكل شامل
- استخدام Azure Monitor وApplication Insights وأدوات التشخيص بفعالية
- تصحيح مشكلات الاتصال بالشبكة والمصادقة والأذونات بشكل مستقل
...
1. **قم دائمًا بتمكين تسجيل التصحيح** في بيئات غير الإنتاج
...
- [ورقة الغش](../../resources/cheat-sheet.md) - مرجع سريع للأوامر

---

**تذكر**: التصحيح الجيد يعتمد على أن تكون منهجيًا، دقيقًا، وصبورًا. ستساعدك هذه الأدوات والتقنيات على تشخيص المشكلات بشكل أسرع وأكثر فعالية.

---

**التنقل**
- **الدرس السابق**: [المشكلات الشائعة](common-issues.md)
