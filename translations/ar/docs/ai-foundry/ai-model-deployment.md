...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:36:10+00:00",
...
**السابق:** [دمج Azure AI Foundry](azure-ai-foundry-integration.md) | **التالي:** [مختبر ورشة عمل الذكاء الاصطناعي](ai-workshop-lab.md)
...
- [إعداد AZD لنماذج الذكاء الاصطناعي](../../../../docs/ai-foundry)
...
## إعداد AZD لنماذج الذكاء الاصطناعي
...
قم بإعداد بيئة التطبيق الخاص بك:
...
تتبع إصدارات النماذج في إعدادات AZD الخاصة بك:
...
قم بإعداد التوسع التلقائي لتطبيقات الحاويات:
...
قم بإعداد المراقبة لأعباء عمل الذكاء الاصطناعي:
