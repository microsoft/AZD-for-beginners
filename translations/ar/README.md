...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:47:11+00:00",
...
استنادًا إلى رؤى مجتمع Azure AI Foundry على Discord، **45% من المطورين يرغبون في استخدام AZD لتطبيقات الذكاء الاصطناعي** ولكنهم يواجهون تحديات مع:
- تعقيد بنى الذكاء الاصطناعي متعددة الخدمات
...
- **بناء حلول متعددة الوكلاء**: نشر بنى ذكاء اصطناعي معقدة
...
#### موارد التعلم
- **🎯 ابدأ هنا**: [تكامل Azure AI Foundry](docs/ai-foundry/azure-ai-foundry-integration.md)
- **📖 الأنماط**: [نشر نموذج الذكاء الاصطناعي](docs/ai-foundry/ai-model-deployment.md) - نشر وإدارة نماذج الذكاء الاصطناعي
- **🛠️ ورشة عمل**: [مختبر ورشة عمل الذكاء الاصطناعي](docs/ai-foundry/ai-workshop-lab.md) - جعل حلول الذكاء الاصطناعي جاهزة لـ AZD
...
#### موارد التعلم
- **🤖 مشروع مميز**: [حل متعدد الوكلاء للبيع بالتجزئة](examples/retail-scenario.md) - تنفيذ كامل
...
- **🕵️ تصحيح الأخطاء**: [دليل تصحيح الأخطاء](docs/troubleshooting/debugging.md) - استراتيجيات خطوة بخطوة
- **🤖 مشكلات الذكاء الاصطناعي**: [استكشاف أخطاء الذكاء الاصطناعي](docs/troubleshooting/ai-troubleshooting.md) - مشكلات خدمات الذكاء الاصطناعي
...
- **📝 أمثلة**: [مثال على الخدمات المصغرة](../../examples/microservices) - هياكل معمارية معقدة
...
توفر مواد ورشة العمل تجربة تعلم منظمة وتفاعلية تكمل المنهج القائم على الفصول المذكور أعلاه. تم تصميم الورشة للتعلم الذاتي والجلسات التي يقودها المدرب.

#### 🛠️ ميزات ورشة العمل
- **واجهة مستندة إلى المتصفح**: ورشة عمل مدعومة بـ MkDocs مع ميزات البحث والنسخ والتخصيص
...
- **إتقان هياكل الوكلاء المتعددين**: تنفيذ حلول منسقة للوكلاء الذكاء الاصطناعي
...
- **🛠️ مختبر ورشة عمل الذكاء الاصطناعي**: [مختبر ورشة عمل الذكاء الاصطناعي](docs/ai-foundry/ai-workshop-lab.md) - تمارين تركز على الذكاء الاصطناعي
...
- **مناسب للمطورين** - مُحسّن لإنتاجية وتجربة المطورين
...
- **تكامل Azure AI Foundry** - اتصال سلس بفهرس نماذج AI Foundry ونقاط النهاية
...
| القالب | الفصل | الصعوبة | الخدمات |
|----------|---------|------------|----------|
| [**ابدأ مع دردشة الذكاء الاصطناعي**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 2 | ⭐⭐ | AzureOpenAI + واجهة استنتاج نماذج Azure AI + بحث Azure AI + تطبيقات Azure Container + Application Insights |
| [**ابدأ مع وكلاء الذكاء الاصطناعي**](https://github.com/Azure-Samples/get-started-with-ai-agents) | الفصل 2 | ⭐⭐ | خدمة وكلاء Azure AI + AzureOpenAI + بحث Azure AI + تطبيقات Azure Container + Application Insights|
| [**أتمتة سير العمل متعدد الوكلاء**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 5 | ⭐⭐⭐ | AzureOpenAI + خدمة وكلاء Azure AI + النواة الدلالية + Azure CosmosDB + تطبيقات Azure Container|
| [**إنشاء مستندات من بياناتك**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 4 | ⭐⭐⭐  | AzureOpenAI + بحث Azure AI + خدمات Azure AI + Azure CosmosDB|
| [**تحسين الاجتماعات مع العملاء باستخدام الوكلاء**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 5 | ⭐⭐⭐| AzureOpenAI + بحث Azure AI + Azure CosmosDB + قاعدة بيانات Azure SQL |
| [**تحديث الكود الخاص بك باستخدام الوكلاء**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 5 | ⭐⭐⭐ | AzureOpenAI + خدمة وكلاء Azure + النواة الدلالية + Azure CosmosDB + تطبيقات Azure Container|
| [**بناء وكيل المحادثة الخاص بك**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 4 | ⭐⭐⭐ | لغة الذكاء الاصطناعي + AzureOpenAI + بحث الذكاء الاصطناعي + تخزين Azure + سجل حاويات Azure|
| [**اكتشاف رؤى من بيانات المحادثة**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 8 | ⭐⭐⭐ | AzureOpenAI + بحث الذكاء الاصطناعي + النواة الدلالية + خدمة وكلاء Azure + فهم محتوى الذكاء الاصطناعي|
| [**معالجة المحتوى متعدد الوسائط**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 8 | ⭐⭐⭐⭐ | AzureOpenAI + فهم محتوى Azure + Azure CosmosDB + تطبيقات Azure Container|

### المميز: سيناريوهات تعلم كاملة
**قوالب تطبيقات جاهزة للإنتاج مرتبطة بفصول التعلم**

| القالب | فصل التعلم | الصعوبة | التعلم الرئيسي |
|----------|------------------|------------|--------------|
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | الفصل 2 | ⭐⭐ | تنفيذ RAG باستخدام بحث Azure AI |
...
| [**حل متعدد الوكلاء للبيع بالتجزئة**](examples/retail-scenario.md) | الفصل 5 | ⭐⭐⭐⭐ | هيكلية متعددة الوكلاء مع وكلاء العملاء والمخزون |

### التعلم حسب نوع المثال

#### تطبيقات بسيطة (الفصول 1-2)
- [تطبيق ويب بسيط](../../examples/simple-web-app) - أنماط نشر أساسية
- [موقع ويب ثابت](../../examples/static-site) - نشر محتوى ثابت
- [واجهة برمجة تطبيقات أساسية](../../examples/basic-api) - نشر REST API

#### تكامل قاعدة البيانات (الفصول 3-4)  
...
#### الأنماط المتقدمة (الفصول 4-8)
- [تطبيقات الحاويات](../../examples/container-app) - نشرات مهيكلة بالحاويات
...
- [**دليل ورشة العمل التفاعلي**](workshop/README.md) - ورشة عمل مستندة إلى المتصفح باستخدام MkDocs وبيئة DevContainer
...
- [ ] **الفصل 7**: استكشاف الأخطاء وإصلاحها ✅
- [ ] **الفصل 8**: الأنماط المؤسسية والإنتاج ✅

### التحقق من التعلم
بعد إكمال كل فصل، تحقق من معرفتك من خلال:
1. **تمرين عملي**: أكمل النشر العملي للفصل
2. **مراجعة المعرفة**: راجع قسم الأسئلة الشائعة لفصلك
...
- **أهم التحديات**: نشرات متعددة الخدمات، إدارة الاعتمادات، الجاهزية للإنتاج  
...
- المساهمة في أفضل الممارسات لنشر الذكاء الاصطناعي  
- التأثير على تطوير ميزات الذكاء الاصطناعي + AZD المستقبلية  

### المساهمة في الدورة  
نرحب بمساهماتكم! يرجى قراءة [دليل المساهمة](CONTRIBUTING.md) للحصول على تفاصيل حول:  
