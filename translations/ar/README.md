...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-20T06:41:24+00:00",
...
استنادًا إلى رؤى مجتمع Microsoft Foundry Discord، **45% من المطورين يرغبون في استخدام AZD لتطبيقات الذكاء الاصطناعي** ولكن يواجهون تحديات مع:
- بنية الذكاء الاصطناعي متعددة الخدمات المعقدة
...
- **حل مشكلات النشر**: معالجة المشكلات الشائعة وتصحيح الأخطاء
...
**📊 الاستثمار الزمني:** 30-45 دقيقة  
**📈 مستوى المهارة بعد ذلك:** القدرة على نشر التطبيقات الأساسية بشكل مستقل
...
#### موارد التعلم
- **🎯 البداية هنا**: [تكامل Microsoft Foundry](docs/microsoft-foundry/microsoft-foundry-integration.md)
- **📖 الأنماط**: [نشر نماذج الذكاء الاصطناعي](docs/microsoft-foundry/ai-model-deployment.md) - نشر وإدارة نماذج الذكاء الاصطناعي
- **🛠️ ورشة العمل**: [مختبر ورشة عمل الذكاء الاصطناعي](docs/microsoft-foundry/ai-workshop-lab.md) - جعل حلول الذكاء الاصطناعي جاهزة لـ AZD
- **🎥 دليل تفاعلي**: [مواد ورشة العمل](workshop/README.md) - تعلم عبر المتصفح مع MkDocs * بيئة DevContainer
...
**📊 الاستثمار الزمني:** 1-2 ساعة  
**📈 مستوى المهارة بعد ذلك:** القدرة على نشر وتكوين تطبيقات الذكاء الاصطناعي الجاهزة للإنتاج  
**💰 الوعي بالتكاليف:** فهم تكاليف التطوير الشهرية ($80-150) وتكاليف الإنتاج الشهرية ($300-3500)

#### 💰 اعتبارات التكلفة لتطبيقات الذكاء الاصطناعي

**بيئة التطوير (تقدير $80-150/شهر):**
- Azure OpenAI (الدفع حسب الاستخدام): $0-50/شهر (حسب استخدام الرموز)
- البحث الذكي (المستوى الأساسي): $75/شهر
- تطبيقات الحاويات (الاستهلاك): $0-20/شهر
- التخزين (قياسي): $1-5/شهر

**بيئة الإنتاج (تقدير $300-3,500+/شهر):**
- Azure OpenAI (PTU لأداء ثابت): $3,000+/شهر أو الدفع حسب الاستخدام مع حجم كبير
- البحث الذكي (المستوى القياسي): $250/شهر
- تطبيقات الحاويات (مخصص): $50-100/شهر
- رؤى التطبيقات: $5-50/شهر
- التخزين (متميز): $10-50/شهر

**💡 نصائح لتقليل التكاليف:**
- استخدم **المستوى المجاني** لـ Azure OpenAI للتعلم (50,000 رمز/شهر مشمول)
- قم بتشغيل `azd down` لإلغاء تخصيص الموارد عند عدم التطوير النشط
- ابدأ بالفوترة حسب الاستهلاك، وقم بالترقية إلى PTU فقط للإنتاج
- استخدم `azd provision --preview` لتقدير التكاليف قبل النشر
- قم بتمكين التوسع التلقائي: الدفع فقط مقابل الاستخدام الفعلي
...
- **📝 أمثلة**: [مثال تطبيق قاعدة البيانات](examples/database-app/README.md) - أمثلة قاعدة بيانات AZD
...
- **📖 البنية**: [أنماط تنسيق متعددة الوكلاء](/docs/pre-deployment/coordination-patterns.md) - الأنماط
...
- **✅ التحقق**: [الفحوصات الأولية](docs/pre-deployment/preflight-checks.md) - سكربتات مؤتمتة  

#### التمارين العملية  
- تشغيل سكربتات التحقق من السعة  
- تحسين اختيارات SKU لتقليل التكلفة  
- تنفيذ الفحوصات المؤتمتة لما قبل النشر  
...
- **🤖 مشكلات الذكاء الاصطناعي**: [استكشاف مشكلات الذكاء الاصطناعي](docs/troubleshooting/ai-troubleshooting.md) - مشاكل خدمات الذكاء الاصطناعي  
...
- **📝 الأمثلة**: [مثال الخدمات المصغرة](../../examples/microservices) - هياكل معمارية معقدة  
- **📊 المراقبة**: [دمج تطبيق Insights](docs/pre-deployment/application-insights.md) - المراقبة  
...
> يتم حالياً تطوير وتحسين مواد الورشة. الوحدات الأساسية تعمل، لكن بعض الأقسام المتقدمة غير مكتملة. نحن نعمل بنشاط على إكمال جميع المحتويات. [تتبع التقدم →](workshop/README.md)  

### مواد الورشة التفاعلية  
**تجربة تعلم عملية شاملة باستخدام أدوات مستندة إلى المتصفح وتمارين موجهة**  

توفر مواد الورشة تجربة تعلم منظمة وتفاعلية تكمل المنهج القائم على الفصول أعلاه. تم تصميم الورشة للتعلم الذاتي والجلسات بقيادة المدربين.  
...
- **بيئة DevContainer تفاعلية**: أدوات وتبعيات مهيأة مسبقاً  

#### 📚 هيكل الورشة  
تتبع الورشة منهجية **الاكتشاف → النشر → التخصيص**:  

1. **مرحلة الاكتشاف** (45 دقيقة)  
   - استكشاف قوالب وخدمات Microsoft Foundry  
   - فهم أنماط معمارية الوكلاء المتعددين  
   - مراجعة متطلبات النشر والمتطلبات الأساسية  

2. **مرحلة النشر** (2 ساعة)  
   - نشر عملي لتطبيقات الذكاء الاصطناعي باستخدام AZD  
   - تكوين خدمات الذكاء الاصطناعي ونقاط النهاية في Azure  
...
- **إتقان أنماط الوكلاء المتعددين**: تنفيذ حلول منسقة لوكلاء الذكاء الاصطناعي  
...
- **🛠️ مختبر ورشة عمل الذكاء الاصطناعي**: [مختبر ورشة عمل الذكاء الاصطناعي](docs/microsoft-foundry/ai-workshop-lab.md) - تمارين مركزة على الذكاء الاصطناعي  
...
- **موجه للمطورين** - مُحسّن لإنتاجية وخبرة المطورين  
...
- **قوالب جاهزة للذكاء الاصطناعي** - قوالب مهيأة مسبقاً لـ Azure OpenAI، خدمات الإدراك، وأعباء عمل ML  
- **نشرات ذكاء اصطناعي آمنة** - أنماط أمان مدمجة لخدمات الذكاء الاصطناعي، مفاتيح API، ونقاط نهاية النماذج  
- **أنماط ذكاء اصطناعي للإنتاج** - أفضل الممارسات لتطبيقات الذكاء الاصطناعي القابلة للتوسع والفعالة من حيث التكلفة  
- **تدفقات عمل ذكاء اصطناعي شاملة** - من تطوير النموذج إلى نشر الإنتاج مع مراقبة مناسبة  
- **تحسين التكلفة** - استراتيجيات تخصيص الموارد والتوسع الذكية لأعباء عمل الذكاء الاصطناعي  
- **تكامل Microsoft Foundry** - اتصال سلس بكاتالوج نماذج Microsoft Foundry ونقاط النهاية  
...
|----------|---------|------------|----------|------|  
| [**ابدأ مع دردشة الذكاء الاصطناعي**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 2 | ⭐⭐ | AzureOpenAI + واجهة استنتاج نموذج Azure AI + بحث Azure AI + تطبيقات الحاويات + تطبيق Insights | خارجي |  
| [**ابدأ مع وكلاء الذكاء الاصطناعي**](https://github.com/Azure-Samples/get-started-with-ai-agents) | الفصل 2 | ⭐⭐ | خدمة وكلاء Azure AI + AzureOpenAI + بحث Azure AI + تطبيقات الحاويات + تطبيق Insights | خارجي |  
...
| [**تطبيق دردشة OpenAI Quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | الفصل 2 | ⭐ | AzureOpenAI + تطبيقات الحاويات + تطبيق Insights | خارجي |  
...
| [**دردشة Contoso RAG**](https://github.com/Azure-Samples/contoso-chat) | الفصل 8 | ⭐⭐⭐⭐ | AzureOpenAI + بحث الذكاء الاصطناعي + Cosmos DB + تطبيقات الحاويات | خارجي |  
| [**حل متعدد الوكلاء للبيع بالتجزئة**](examples/retail-scenario.md) | الفصل 5 | ⭐⭐⭐⭐ | AzureOpenAI + بحث الذكاء الاصطناعي + التخزين + تطبيقات الحاويات + Cosmos DB | **محلي** |  
...
| [**عرض بحث Azure + OpenAI**](https://github.com/Azure-Samples/azure-search-openai-demo) | الفصل 2 | ⭐⭐ | تنفيذ RAG مع بحث الذكاء الاصطناعي في Azure |  
| [**معالجة مستندات الذكاء الاصطناعي**](https://github.com/Azure-Samples/ai-document-processing) | الفصل 4 | ⭐⭐ | تكامل ذكاء المستندات |  
| [**وكيل OpenAI Python Prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | الفصل 5 | ⭐⭐⭐ | إطار عمل الوكيل واستدعاء الوظائف |  
| [**دردشة Contoso**](https://github.com/Azure-Samples/contoso-chat) | الفصل 8 | ⭐⭐⭐ | تنسيق الذكاء الاصطناعي للمؤسسات |  
| [**حل متعدد الوكلاء للبيع بالتجزئة**](examples/retail-scenario.md) | الفصل 5 | ⭐⭐⭐⭐ | بنية متعددة الوكلاء مع وكلاء العملاء والمخزون |  
...
- [**حل متعدد الوكلاء للبيع بالتجزئة**](examples/retail-scenario.md) - تنفيذ جاهز للإنتاج بالكامل مع قوالب ARM  
...
- [**أمثلة تطبيقات الحاويات**](examples/container-app/README.md) - دليل كامل لنشر الحاويات  
  ...
  - أنماط النشر السريع، الإنتاج، والمتقدم  
...
- [وظائف + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - سير عمل البيانات بدون خادم  
...
### ❌ "استغرق نشر القالب وقتًا طويلاً"
...
<details>
<summary><strong>❌ "azd up" يفشل في منتصف الطريق</strong></summary>
...
<details>
<summary><strong>❌ "استغرق نشر القالب وقتًا طويلاً"</strong></summary>
...
- [ ] **الفصل 6**: التحقق من النشر والتخطيط ✅
- [ ] **الفصل 7**: استكشاف الأخطاء وإصلاحها ✅
- [ ] **الفصل 8**: الإنتاج والأنماط المؤسسية ✅
...
- التأثير على تطوير ميزات AZD + AI المستقبلية
