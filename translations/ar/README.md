...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:15:26+00:00",
...
4. **اختر مسار التعلم الخاص بك**: اختر الفصل أدناه الذي يتناسب مع مستوى خبرتك
...
استنادًا إلى رؤى مجتمع Microsoft Foundry Discord، **يريد 45% من المطورين استخدام AZD لأعباء عمل الذكاء الاصطناعي** لكنهم يواجهون تحديات في:
...
- **اتقان أساسيات AZD**: المفاهيم الأساسية، التثبيت، والتكوين
...
**💰 الوعي بالتكلفة:** فهم تكاليف التطوير 80-150 دولارًا شهريًا، وتكاليف الإنتاج 300-3500 دولار شهريًا
...
**💡 نصائح تحسين التكلفة:**
- استخدم **الطبقة المجانية** من Azure OpenAI للتعلم (50,000 رمز شهريًا مشمول)
...
- **📝 الأمثلة**: [مثال تطبيق الحاويات](../../examples/container-app) - نشر التطبيقات المحوسبة بالحاويات
...
#### تمارين عملية  
```bash
# نشر الحل الكامل لوكلاء التجزئة المتعددين
...
- **نشر قائم على القوالب** - استخدام قوالب معدة مسبقاً لأنماط التطبيقات الشائعة  
...
- **أنماط إنتاج الذكاء الاصطناعي** - أفضل الممارسات لنشر تطبيقات الذكاء الاصطناعي القابلة للتوسع وفعالة التكلفة  
...
- [**أمثلة تطبيقات الحاويات**](examples/container-app/README.md) - دليل كامل للنشر بالحاويات  
...
- [**معرض قوالب AZD الرسمي**](https://azure.github.io/awesome-azd/) - مجموعة من القوالب الرسمية ومجتمع المستخدمين  
...
### ❌ فشل أمر "azd up" في منتصف التنفيذ
...
- **مشكلات الذكاء الاصطناعي الخاصة:** [استكشاف أخطاء الذكاء الاصطناعي](docs/troubleshooting/ai-troubleshooting.md)  
...
<details>
<summary><strong>❌ فشل أمر "azd up" في منتصف التنفيذ</strong></summary>
...
### تتبع التقدم  
تابع تقدمك في التعلم عبر كل فصل:
