...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T11:41:46+00:00",
...
استنادًا إلى رؤى مجتمع Azure AI Foundry Discord، **45% من المطورين يرغبون في استخدام AZD لأعباء عمل الذكاء الاصطناعي** ولكنهم يواجهون تحديات مع:
...
- **📖 الأنماط**: [نشر نموذج الذكاء الاصطناعي](docs/ai-foundry/ai-model-deployment.md) - إدارة ونشر نماذج الذكاء الاصطناعي
- **🛠️ ورشة العمل**: [مختبر ورشة عمل الذكاء الاصطناعي](docs/ai-foundry/ai-workshop-lab.md) - جعل حلول الذكاء الاصطناعي جاهزة لـ AZD
- **🎥 دليل تفاعلي**: [مواد ورشة العمل](workshop/README.md) - تعلم عبر المتصفح باستخدام MkDocs * بيئة DevContainer
...
- **📝 أمثلة**: [مثال تطبيق الحاوية](../../examples/container-app) - نشر التطبيقات المحاوية
...
- **🤖 مشكلات الذكاء الاصطناعي**: [استكشاف الأخطاء الخاصة بالذكاء الاصطناعي](docs/troubleshooting/ai-troubleshooting.md) - مشاكل خدمات الذكاء الاصطناعي
...
توفر مواد الورشة تجربة تعلم منظمة وتفاعلية تكمل المنهج القائم على الفصول المذكور أعلاه. تم تصميم الورشة للتعلم الذاتي والجلسات بقيادة المدربين.  
...
- **التحسين للتوسع**: تصميم نشرات فعالة من حيث التكلفة والأداء  
...
**مثالي لـ**: تدريب الشركات، دورات الجامعات، التعلم الذاتي، ومعسكرات تدريب المطورين.  
...
- **أنماط إنتاج الذكاء الاصطناعي** - أفضل الممارسات لنشر تطبيقات ذكاء اصطناعي قابلة للتوسع وفعالة من حيث التكلفة  
...
| [**تحسين الاجتماعات مع الوكلاء**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 5 | ⭐⭐⭐| AzureOpenAI + Azure AI Search + Azure CosmosDB + Azure SQL Database |  
| [**تحديث الكود الخاص بك مع الوكلاء**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 5 | ⭐⭐⭐ | AzureOpenAI + Azure Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|  
...
| [**معالجة محتوى متعدد الوسائط**](https://github.com/Azure-Samples/get-started-with-ai-chat) | الفصل 8 | ⭐⭐⭐⭐ | AzureOpenAI + Azure Content Understanding + Azure CosmosDB + Azure Container Apps|  
