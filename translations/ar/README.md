...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:57:44+00:00",
...
استنادًا إلى رؤى مجتمع Microsoft Foundry Discord، **يرغب 45% من المطورين في استخدام AZD لأعباء عمل الذكاء الاصطناعي** لكنهم يواجهون تحديات في:
...
- Azure OpenAI (PTU للأداء المستقر): 3000 دولار شهريًا أو أكثر أو الدفع حسب الاستخدام مع حجم مرتفع
...
- **أنماط الذكاء الاصطناعي للإنتاج** - أفضل الممارسات لنشر تطبيقات الذكاء الاصطناعي القابلة للتوسع وفعالة التكلفة  
