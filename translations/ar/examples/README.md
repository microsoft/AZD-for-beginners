...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:55:28+00:00",
...
- فهم معماريات التطبيقات المختلفة وتنفيذها باستخدام azd
...
- تعديل القوالب المقدمة لتناسب متطلبات تطبيقك
...
**التعقيد**: مبتدئ  
**المفاهيم**: استضافة ثابتة، تكامل CDN، النطاقات المخصصة

### تطبيق الحاويات
**التقنيات**: Docker، Container Apps، Container Registry  
**التعقيد**: متوسط  
**المفاهيم**: الحاويات، التوسيع، تكوين الوصول
...
### الخدمات المصغرة
**التقنيات**: خدمات متعددة، Service Bus، بوابة API  
**التعقيد**: متقدم  
...
### روابط الوثائق
- [مواصفات قوالب AZD](https://aka.ms/azd/templates)
