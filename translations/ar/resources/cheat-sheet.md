...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T20:24:51+00:00",
...
تقدم هذه القائمة الشاملة مرجعًا سريعًا لأكثر أوامر Azure Developer CLI استخدامًا، مرتبة حسب الفئات مع أمثلة عملية. مثالية للبحث السريع أثناء التطوير، استكشاف الأخطاء وإصلاحها، والعمليات اليومية مع مشاريع azd.
...
- الوصول إلى أوامر استكشاف الأخطاء وإصلاحها لحل المشكلات بسرعة
...
- تحسين سير العمل من خلال الاستخدام الفعال لاختصارات azd وخياراته
