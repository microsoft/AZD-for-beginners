...
Ten przewodnik pokazuje, jak zintegrować usługi Microsoft Foundry z Azure Developer CLI (AZD) w celu usprawnienia wdrożeń aplikacji AI. Microsoft Foundry zapewnia kompleksową platformę do tworzenia, wdrażania i zarządzania aplikacjami AI, podczas gdy AZD upraszcza proces zarządzania infrastrukturą i wdrażania.

## What is Microsoft Foundry?

Microsoft Foundry to zunifikowana platforma Microsoftu do tworzenia rozwiązań AI, która obejmuje:

- **Model Catalog**: Dostęp do najnowocześniejszych modeli AI
- **Prompt Flow**: Wizualny kreator przepływów pracy AI
- **AI Foundry Portal**: Zintegrowane środowisko programistyczne dla aplikacji AI
- **Deployment Options**: Wiele opcji hostingu i skalowania
- **Safety and Security**: Wbudowane funkcje odpowiedzialnego AI
...
azd env set AZURE_DOCUMENT_INTELLIGENCE_SKU "F0"  # Darmowy plan
```
...
1. **Wypróbuj przykłady**: Zacznij od gotowego szablonu, który odpowiada twojemu scenariuszowi
...
5. **Zabezpiecz wdrożenie**: Wdróż wzorce bezpieczeństwa klasy korporacyjnej
...
# Przejdź do Portalu Azure > Limity > Złóż wniosek o zwiększenie
```
</details>
