...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T13:35:23+00:00",
...
本场景介绍如何为零售商构建一个生产级的多代理客户支持聊天机器人，具备高级AI功能，包括库存管理、文档处理和智能客户交互。
...
**目标**: 部署两个专业代理 - "客户代理"（客户服务）和"库存代理"（库存管理）
...
**目标**: 部署聊天模型（客户代理）、嵌入模型（搜索）和推理模型（评分）并进行适当的配额管理
...
为了立即部署完整的零售多代理解决方案，我们提供了一个全面的ARM模板，可通过单一命令配置所有所需的Azure资源。

### ARM模板包含内容

位于[`retail-multiagent-arm-template/`](../../../examples/retail-multiagent-arm-template)的ARM模板包括：

#### **完整基础设施**
- ✅ **多区域Azure OpenAI**部署（GPT-4o、GPT-4o-mini、嵌入模型、评分模型）
- ✅ **Azure AI搜索**，支持向量搜索功能
- ✅ **Azure存储**，包含文档和上传容器
- ✅ **容器应用环境**，支持自动扩展
- ✅ **代理路由器和前端**容器应用
...
| 模式 | 使用场景 | 资源 | 预计月成本 |
|------|----------|------|-----------|
| **最小化** | 开发、测试 | 基础SKU，单区域 | $100-370 |
| **标准** | 生产、中等规模 | 标准SKU，多区域 | $420-1,450 |
| **高级** | 企业、高规模 | 高级SKU，高可用设置 | $1,150-3,500 |
...
编辑`azuredeploy.parameters.json`以定制您的部署：
...
部署完成后，通过以下方式监控您的解决方案：

- **应用洞察**: 性能指标、依赖跟踪和自定义遥测
- **日志分析**: 所有组件的集中日志记录
- **Azure监控**: 资源健康和可用性监控
- **成本管理**: 实时成本跟踪和预算警报
...
本场景文档结合ARM模板提供了部署生产级多代理客户支持解决方案所需的一切。实施内容包括：

✅ **架构设计** - 全面的系统设计及组件关系  
✅ **基础设施配置** - 一键部署的完整ARM模板  
✅ **代理配置** - 客户代理和库存代理的详细设置  
✅ **多模型部署** - 跨区域的战略模型部署  
✅ **搜索集成** - AI搜索，支持向量功能和数据索引  
✅ **安全实施** - 红队测试、漏洞扫描和安全实践  
✅ **监控与评估** - 全面的遥测和代理评估框架  
✅ **生产准备** - 企业级部署，支持高可用性和灾难恢复  
✅ **成本优化** - 智能路由和基于使用的扩展  
✅ **故障排除指南** - 常见问题及解决策略  

本综合场景涵盖了零售商多代理解决方案的所有需求，提供了实用的实施指导、故障排除支持以及高级探索主题，帮助您使用AZD构建生产级AI应用。
