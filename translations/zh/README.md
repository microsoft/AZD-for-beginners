...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T16:38:53+00:00",
...
欢迎来到 Azure Developer CLI (azd) 的全面指南。本仓库旨在帮助从学生到专业开发者的各类开发者学习并掌握 Azure Developer CLI，以实现高效的云部署，**特别是针对使用 Azure AI Foundry 的 AI 应用部署**。本结构化学习资源提供了 Azure 云部署的实践经验、常见问题的排查，以及成功部署 AZD 模板的最佳实践。
...
### 针对 AI 开发者（推荐从这里开始！）
1. **快速入门**：尝试 [azure-search-openai-demo](https://github.com/Azure-Samples/azure-search-openai-demo) 模板
...
5. **高级内容**：部署 [contoso-chat](https://github.com/Azure-Samples/contoso-chat) 企业模板
...
- [**生产级 AI 最佳实践**](docs/ai-foundry/production-ai-practices.md) - 针对 AI 工作负载的安全性、扩展性和监控
...
| [**构建您的对话代理**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 利用高级对话理解创建和增强具有确定性和人类可控工作流的聊天机器人和代理 |⭐⭐⭐ | AI语言 + AzureOpenAI + AI搜索 + Azure存储 + Azure容器注册表 |
| [**从对话数据中解锁洞察**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 通过高级内容理解能力从大量音频和文本数据集中发现洞察，提高联络中心效率 |⭐⭐⭐ | AzureOpenAI + AI搜索 + 语义内核 + Azure代理服务 + AI内容理解 |
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | 支持RAG的聊天应用，使用Azure OpenAI | ⭐⭐ | AzureOpenAI + 搜索 + 应用服务 |
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | 使用AI编排的企业聊天 | ⭐⭐⭐ | AzureOpenAI + Azure AI搜索 + 容器应用 |
...
### 实践实验与工作坊  
- [**AI工作坊实验**](docs/ai-foundry/ai-workshop-lab.md) - **新**：使您的AI解决方案支持AZD部署  
...
此项目根据MIT许可授权 - 详情请参阅[LICENSE](../../LICENSE)文件。  
...
- [AI代理初学者](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)  
- [使用.NET的生成式AI初学者](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)  
- [生成式AI初学者](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)  
- [使用Java的生成式AI初学者](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)  
...
- [AI初学者](https://aka.ms/ai-beginners?WT.mc_id=academic-105485-koreyst)  
- [网络安全初学者](https://github.com/microsoft/Security-101??WT.mc_id=academic-96948-sayoung)  
- [Web开发初学者](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)  
- [物联网初学者](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)  
- [XR开发初学者](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)  
...
- [选择您的Copilot冒险](https://github.com/microsoft/CopilotAdventures?WT.mc_id=academic-105485-koreyst)  
