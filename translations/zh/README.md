...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T09:29:56+00:00",
...
通过结构化章节掌握 Azure Developer CLI (azd)，逐步学习。**特别关注通过 Microsoft Foundry 集成部署 AI 应用。**
...
- **部署 AI 应用**：使用 AZD 集成 Microsoft Foundry 服务
...
- **🛠️ 工作坊**：[AI 工作坊实验](docs/microsoft-foundry/ai-workshop-lab.md) - 让您的 AI 解决方案适配 AZD
...
**生产环境（估计 $300-3,500+/月）：**
- Azure OpenAI（PTU 保证性能一致性）：$3,000+/月 或按需付费高流量
- AI 搜索（标准层）：$250/月
- 容器应用（专用）：$50-100/月
- 应用洞察：$5-50/月
- 存储（高级）：$10-50/月
...
### 互动式工作坊材料
**通过浏览器工具和指导练习提供全面的实践学习体验**

我们的工作坊材料提供结构化的互动学习体验，补充了上述章节式课程。工作坊适用于自学和讲师指导的课程。
...
- **安全AI部署** - 内置AI服务的安全模式、API密钥和模型端点  
- **生产AI模式** - 可扩展、成本优化的AI应用部署最佳实践
- **端到端AI工作流** - 从模型开发到生产部署，配备适当的监控
...
> **注意:** 这些模板展示了各种AI模式。一些是外部Azure示例，另一些是本地实现。
...
- [**互动式工作坊指南**](workshop/README.md) - 使用MkDocs和DevContainer环境的基于浏览器的工作坊
- [**结构化学习路径**](../../workshop/docs/instructions) - 7步指导练习（探索 → 部署 → 定制）
- [**AZD初学者工作坊**](workshop/README.md) - 完整的实践工作坊材料，支持GitHub Codespaces集成
...
- **AI 特定问题：** [AI 故障排除](docs/troubleshooting/ai-troubleshooting.md)
