...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:42:39+00:00",
  "source_file": "docs/troubleshooting/ai-troubleshooting.md",
  "language_code": "zh"
}
-->
# Azure Developer CLI AI 故障排除指南

**上一章：** [生产级 AI 实践](../ai-foundry/production-ai-practices.md) | **下一章：** [AZD 入门](../getting-started/README.md)

本全面故障排除指南解决了使用 AZD 部署 AI 解决方案时的常见问题，并提供了针对 Azure AI 服务的解决方案和调试技术。
...
2. **完成 [生产级 AI 实践](production-ai-practices.md)**，构建企业级解决方案
...
**上一章：** [生产级 AI 实践](../ai-foundry/production-ai-practices.md) | **下一章：** [工作坊](../../workshop/README.md)
