...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:05:20+00:00",
...
本全面故障排除指南涵盖使用 Azure Developer CLI 时最常遇到的问题。学习如何诊断、排查和解决与身份验证、部署、基础设施配置以及应用程序设置相关的常见问题。每个问题都包含详细的症状、根本原因以及逐步解决方案。
