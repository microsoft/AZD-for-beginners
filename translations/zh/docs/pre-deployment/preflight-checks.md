...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:13:48+00:00",
...
本指南提供了全面的部署前验证脚本和流程，以确保 Azure Developer CLI 部署在开始之前能够成功。学习如何实施自动化检查，包括身份验证、资源可用性、配额、安全合规性和性能要求，以防止部署失败并优化部署成功率。
...
- 配置主动监控和警报以确保部署准备就绪
- 排查部署前问题并实施纠正措施
- 将部署前检查集成到 DevOps 流水线和自动化工作流中

## 目录

- [概述](../../../../docs/pre-deployment)
- [自动化部署前脚本](../../../../docs/pre-deployment)
...
- [常见问题排查](../../../../docs/pre-deployment)

---

## 概述

部署前检查是部署前执行的重要验证，用于确保：
...
**提示**：在 CI/CD 流水线中将部署前检查作为单独的作业运行，优先于实际部署作业。这可以让您及早发现问题，并为开发人员提供更快的反馈。
