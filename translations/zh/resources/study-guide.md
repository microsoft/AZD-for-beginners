...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T09:38:54+00:00",
...
- [ ] **AI 监控**：为 AI 工作负载实施应用程序洞察  
- [ ] **性能优化**：调整 AI 应用性能  

#### ⚙️ 第 3 章：配置与身份验证  
- [ ] **多环境设置**：配置开发、预发布和生产环境  
- [ ] **安全实施**：设置托管身份认证  
- [ ] **机密管理**：集成 Azure Key Vault 以管理敏感数据  
- [ ] **参数管理**：创建环境特定的配置  
- [ ] **身份验证掌握**：实施安全访问模式  
...
#### 🚨 第 7 章：故障排除与调试  
- [ ] **诊断技能**：成功调试故意破坏的部署  
- [ ] **日志分析**：有效使用 Azure Monitor 和应用程序洞察  
- [ ] **性能调优**：优化性能较慢的应用程序  
- [ ] **恢复程序**：实施备份与灾难恢复  
- [ ] **监控设置**：创建主动监控与警报  
...
**章节导航:**
- **📚 课程主页**: [AZD 初学者指南](../README.md)
- **📖 开始学习**: [第 1 章: 基础与快速入门](../README.md#-chapter-1-foundation--quick-start)
- **🎯 进度跟踪**: 通过全面的 8 章学习系统跟踪您的学习进展
- **🤝 社区**: [Azure Discord](https://discord.gg/microsoft-azure) 提供支持与讨论

**学习进度跟踪**: 使用此结构化指南，通过渐进式、实践性的学习掌握 Azure Developer CLI，同时获得可衡量的成果和职业发展收益。
