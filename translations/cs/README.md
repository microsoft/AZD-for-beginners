...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:17:38+00:00",
...
- Složitá AI architektura s více službami
...
- Rozvíjet dovednosti v řešení běžných problémů s nasazením AZD
...
- **Nasazení na základě šablon** - Používejte předem připravené šablony pro běžné aplikační vzory
...
- **Optimalizace nákladů** - Chytré strategie alokace a škálování zdrojů pro AI pracovní zátěže
...
4. **Připraveno pro produkci**: Projděte [Osvědčené postupy pro produkční AI](docs/ai-foundry/production-ai-practices.md)
...
### Pro vývojáře
1. Projděte si [Konfigurační příručku](docs/getting-started/configuration.md)
...
- [**Instalace a nastavení**](docs/getting-started/installation.md) - Platformově specifické instalační příručky
...
### AI a Azure AI Foundry
- [**Integrace Azure AI Foundry**](docs/ai-foundry/azure-ai-foundry-integration.md) - Propojení AZD se službami Azure AI Foundry
- [**Vzory nasazení AI modelů**](docs/ai-foundry/ai-model-deployment.md) - Nasazení a správa AI modelů pomocí AZD
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - Praktická laboratoř: Připravení AI řešení pro AZD
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | Chatovací aplikace s podporou RAG s Azure OpenAI | ⭐⭐ | AzureOpenAI + Search + App Service |
...
- [**Azure-Samples AZD Templates**](https://github.com/Azure-Samples/azd-templates) - Oficiální šablony od Microsoftu  
...
- **Diskuse**: [Komunita Microsoft Azure na Discordu - otázky a diskuse](https://discord.gg/microsoft-azure)
...
### Postřehy z komunity na Discordu Azure AI Foundry
...
- **Nejvíce požadované**: AI-specifické šablony, průvodce řešením problémů, osvědčené postupy
