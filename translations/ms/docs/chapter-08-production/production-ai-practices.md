...
Panduan ini menyediakan amalan terbaik yang komprehensif untuk menyebarkan beban kerja AI yang siap produksi menggunakan Azure Developer CLI (AZD). Berdasarkan maklum balas dari komuniti Microsoft Foundry Discord dan penyebaran pelanggan sebenar, amalan ini menangani cabaran paling biasa dalam sistem AI produksi.
...
- **45%** menghadapi kesukaran dengan penyebaran AI berbilang perkhidmatan
- **38%** menghadapi masalah pengurusan kelayakan dan rahsia  
- **35%** mendapati kesukaran dalam kesiapsiagaan produksi dan penskalaan
...
**Bila digunakan**: Aplikasi AI yang kompleks dengan pelbagai keupayaan
...
### Corak 2: Pemprosesan AI Berpandukan Acara

**Bila digunakan**: Pemprosesan berkumpulan, analisis dokumen, aliran kerja tak segerak
...
- Pengasingan rangkaian dengan titik akhir persendirian
...
**Konfigurasi Titik Akhir Persendirian**:
...
### 1. Strategi Skala Automatik

**Skala automatik Container Apps**:
...
### 3. Pengimbangan Beban dan Pengurusan Lalulintas
...
# Semak sama ada semua perkhidmatan yang diperlukan sedang berjalan
...
### Cadangan Teratas daripada Komuniti:

1. **Mula Kecil, Skala Secara Berperingkat**: Mulakan dengan SKU asas dan skala naik berdasarkan penggunaan sebenar
2. **Pantau Segalanya**: Sediakan pemantauan menyeluruh dari hari pertama
3. **Automatkan Keselamatan**: Gunakan infrastruktur sebagai kod untuk keselamatan yang konsisten
4. **Uji Secara Menyeluruh**: Sertakan ujian khusus AI dalam saluran anda
5. **Rancang untuk Kos**: Pantau penggunaan token dan tetapkan amaran belanjawan awal

### Perangkap Biasa yang Perlu Dielakkan:

- ❌ Menetapkan kunci API secara keras dalam kod
...
**Ingat**: Beban kerja AI produksi memerlukan perancangan, pemantauan, dan pengoptimuman berterusan yang teliti. Mulakan dengan corak ini dan sesuaikan kepada keperluan khusus anda.

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**Penafian**:
Dokumen ini telah diterjemahkan menggunakan perkhidmatan terjemahan AI [Co-op Translator](https://github.com/Azure/co-op-translator). Walaupun kami berusaha untuk ketepatan, sila ambil maklum bahawa terjemahan automatik mungkin mengandungi kesilapan atau ketidakakuratan. Dokumen asal dalam bahasa asalnya hendaklah dianggap sebagai sumber yang muktamad. Untuk maklumat yang kritikal, disarankan mendapatkan terjemahan profesional oleh penterjemah manusia. Kami tidak bertanggungjawab terhadap sebarang salah faham atau salah tafsiran yang timbul daripada penggunaan terjemahan ini.
