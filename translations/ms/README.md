...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-11T10:09:36+00:00",
...
Selamat datang ke panduan lengkap untuk Azure Developer CLI (azd). Repositori ini direka untuk membantu pembangun pada semua peringkat, daripada pelajar hingga pembangun profesional, mempelajari dan menguasai Azure Developer CLI untuk penyebaran awan yang cekap. Sumber pembelajaran yang terstruktur ini menyediakan pengalaman langsung dengan penyebaran awan Azure, menyelesaikan masalah biasa, dan melaksanakan amalan terbaik untuk penyebaran templat AZD yang berjaya.
...
- Membina dan menyebarkan aplikasi menggunakan templat AZD  
- Menyelesaikan masalah pengesahan, infrastruktur, dan isu penyebaran  
...
### Bermula
- [**Asas AZD**](docs/getting-started/azd-basics.md) - Konsep dan istilah teras  
...
## Contoh & Templat
- [**Contoh**](examples/README.md) - Contoh praktikal, templat, dan senario dunia sebenar untuk membantu anda mempelajari Azure Developer CLI melalui latihan langsung. Setiap contoh menyediakan kod kerja lengkap, templat infrastruktur, dan arahan terperinci untuk pelbagai seni bina aplikasi dan corak penyebaran.  

### Makmal/Workshop Praktikal
- [**AZD Untuk Pemula**](workshop/README.md) - Bengkel ini akan memberi tumpuan kepada templat AZD Get Started with AI Agents dan menyediakan amalan terbaik untuk penyebaran perkhidmatan AI Azure menggunakan AZD  

## Sumber

### Rujukan Pantas
- [**Senarai Perintah**](resources/cheat-sheet.md) - Perintah azd penting  
- [**Glosari**](resources/glossary.md) - Istilah Azure dan azd  
- [**Soalan Lazim**](resources/faq.md) - Soalan yang sering ditanya  
- [**Panduan Kajian**](resources/study-guide.md) - Objektif pembelajaran dan latihan amali yang komprehensif  
...
4. Berlatih dengan [Contoh Aplikasi Web Ringkas](../../examples/simple-web-app)  
...
- **Perbincangan**: [Komuniti Microsoft Azure Discord untuk Q&A dan perbincangan](https://discord.gg/microsoft-azure)  
