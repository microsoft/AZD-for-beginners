...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T20:55:12+00:00",
...
- Udvikle færdigheder i fejlfinding af almindelige AZD-implementeringsproblemer  
...
Azure Developer CLI (azd) er en udviklercentreret kommandolinjegrænseflade, der fremskynder processen med at bygge og implementere applikationer til Azure. Det tilbyder:  
...
- **Udviklervenligt** - Optimeret for udviklerproduktivitet og oplevelse  
...
- [**Pre-flight kontroller**](docs/pre-deployment/preflight-checks.md) - Automatiserede valideringsscripts  

### Fejlfinding  
- [**Almindelige problemer**](docs/troubleshooting/common-issues.md) - Hyppigt forekommende problemer og løsninger  
- [**Fejlfindingsguide**](docs/troubleshooting/debugging.md) - Trin-for-trin fejlfindingsstrategier  

## Eksempler & Templates

### Starttemplates  
- [**Simple Web Application**](../../examples/simple-web-app) - Grundlæggende Node.js webapplikationsimplementering  
- [**Statisk hjemmeside**](../../examples/static-website) - Statisk hjemmesidehosting på Azure Storage  
- [**Containerapplikation**](../../examples/container-app) - Containeriseret applikationsimplementering  
- [**Databaseapplikation**](../../examples/database-app) - Webapplikation med databaseintegration  

### Avancerede scenarier  
- [**Mikrotjenester**](../../examples/microservices) - Multi-service applikationsarkitektur  
- [**Serverløse funktioner**](../../examples/serverless-function) - Azure Functions implementering  
- [**Konfigurationseksempler**](../../examples/configurations) - Genanvendelige konfigurationsmønstre  

## Ressourcer

### Hurtige referencer  
- [**Kommandosnydeark**](resources/cheat-sheet.md) - Væsentlige azd-kommandoer  
...
2. Følg [Installationsguide](docs/getting-started/installation.md)  
...
### For udviklere  
1. Gennemgå [Konfigurationsguide](docs/getting-started/configuration.md)  
2. Studér [Implementeringsguide](docs/deployment/deployment-guide.md)  
...
2. Implementér [Pre-flight kontroller](docs/pre-deployment/preflight-checks.md)  
3. Øv dig med [Kapacitetsplanlægning](docs/pre-deployment/capacity-planning.md)  
4. Avanceret [Mikrotjenester Eksempel](../../examples/microservices)  
