...
function Test-Permissions {
    ...
    try {
        # Hae nykyisen käyttäjän roolimääritykset
        ...
        # Testaa resurssiryhmän luonti (jos määritelty)
        if ($ResourceGroup) {
...
function Test-QuotasAndLimits {
    ...
    try {
        ...
        # Tarkista tallennustilin rajoitukset
...
function Test-TemplateValidation {
    ...
    # Tarkista, onko azure.yaml olemassa
    ...
    # Tarkista infrastruktuuritiedostot
    if (Test-Path "infra") {
...
function Test-RegionalAvailability {
    ...
    try {
        # Tarkista, onko sijainti kelvollinen
        ...
        # Tarkista palvelun saatavuus alueella
...
function Test-CostEstimation {
    ...
    # Tarkista, onko budjetti olemassa
    try {
...
```bash
#!/bin/bash
# Kehitysympäristökohtaiset tarkistukset
...
validate_dev_environment() {
    ...
    # Tarkista automaattisen sammutuksen asetukset
    ...
    # Tarkista kehitystietokannan asetukset
...
validate_prod_environment() {
    ...
    # Tarkista varmuuskopiointiasetukset
...
def check_storage_limits(location: str) -> bool:
    ...
    max_accounts = 250  # Azuren oletusraja
...
def check_network_limits(location: str) -> bool:
    ...
    # Tarkista virtuaaliverkot
    vnets = run_command(['az', 'network', 'vnet', 'list'])
    if vnets is not None:
        vnet_count = len(vnets)
        print(f"✅ Virtual Networks: {vnet_count}/1000")
    
    # Tarkista julkiset IP-osoitteet
...
check_compliance_requirements() {
    ...
    # Tarkista varmuuskopiointi- ja säilytyskäytännöt
