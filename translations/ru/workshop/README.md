...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:10:36+00:00",
...
- **🛠️ Практическая лаборатория**: [Лаборатория AI Workshop](../docs/ai-foundry/ai-workshop-lab.md)
- **🚀 Следующие шаги**: [Модули семинара](../../../workshop)

Добро пожаловать на практический семинар по изучению Azure Developer CLI (AZD) с акцентом на развертывание AI-приложений. Этот семинар поможет вам освоить основы AZD и перейти к развертыванию готовых к производству AI-решений.

## Обзор семинара

**Продолжительность:** 2-3 часа  
**Уровень:** Начальный до среднего  
**Требования:** Базовые знания Azure, инструментов командной строки и концепций AI
...
- **Лаборатория**: Развертывание простого веб-приложения
...
- **Лаборатория**: Развертывание чат-приложения с GPT-4
...
- **Лаборатория**: Создание системы вопросов и ответов на основе документов
...
- **Лаборатория**: Развертывание в производственной среде с наблюдаемостью
...
- **[Руководство по устранению неполадок AI](../docs/troubleshooting/ai-troubleshooting.md)** - Частые проблемы и их решения
...
- **Обратная связь о семинаре**: [Поделитесь своим опытом](https://aka.ms/azd-workshop-feedback)
...
✅ **Настраивать Azure OpenAI** с соблюдением безопасности  
...
2. **Шаблоны**: Начните с наших [шаблонов для AI](../../../workshop/templates)
3. **Поддержка**: Присоединяйтесь к [Discord Azure AI Foundry](https://aka.ms/foundry/discord)

### Делитесь успехами

- ⭐ **Поставьте звезду репозиторию**, если семинар был полезен
...
Ваши отзывы помогают нам улучшать семинар:
...
**Предыдущая тема:** [Руководство по устранению неполадок AI](../docs/troubleshooting/ai-troubleshooting.md) | **Следующая тема:** Начните с [Лаборатории 1: Основы AZD](../../../workshop/lab-1-azd-basics)
