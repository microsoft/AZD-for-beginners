...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:15:39+00:00",
...
**Краткий справочник для всех глав**
- **📚 Домашняя страница курса**: [AZD для начинающих](../README.md)
- **📖 Быстрый старт**: [Глава 1: Основы и быстрый старт](../README.md#-chapter-1-foundation--quick-start)
- **🤖 Команды для ИИ**: [Глава 2: Разработка с приоритетом ИИ](../README.md#-chapter-2-ai-first-development-recommended-for-ai-developers)
- **🔧 Продвинутое**: [Глава 4: Инфраструктура как код](../README.md#️-chapter-4-infrastructure-as-code--deployment)
