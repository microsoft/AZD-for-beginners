...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:34:33+00:00",
...
**Предыдущая:** [Основы AZD](azd-basics.md) | **Следующая:** [Первый проект](first-project.md)
...
- [Руководство по развертыванию](../deployment/deployment-guide.md) - Использование конфигурации для развертывания
- [Создание ресурсов](../deployment/provisioning.md) - Конфигурации для готовности к производству
