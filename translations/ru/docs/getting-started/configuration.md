...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T12:50:21+00:00",
...
- Поймете сложные шаблоны конфигурации для сложных сценариев
...
- Решать проблемы, связанные с конфигурацией
...
- [Руководство по развертыванию](../deployment/deployment-guide.md) - Используйте конфигурацию для развертывания
