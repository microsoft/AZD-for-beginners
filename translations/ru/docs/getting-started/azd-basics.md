...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:07:09+00:00",
...
# Основы AZD - Основные концепции и фундаментальные принципы
...
- **🚀 Следующая глава**: [Глава 2: Разработка с приоритетом на ИИ](../ai-foundry/azure-ai-foundry-integration.md)
...
Команда `azd down --force --purge` — это мощный способ полностью удалить окружение azd и все связанные ресурсы. Вот что делает каждый флаг:
```
--force
```
...
Особенно полезно после ручного удаления ресурсов в портале Azure или при смене шаблонов, окружений или соглашений о наименовании групп ресурсов.
...
- Используйте отдельные окружения для разработки, стадии и продакшна
- Никогда не развертывайте напрямую в продакшн с локальной машины
- Используйте CI/CD для развертываний в продакшн
...
- [Глава 2: Разработка с приоритетом на ИИ](../ai-foundry/azure-ai-foundry-integration.md) — Начните создавать приложения с использованием ИИ
