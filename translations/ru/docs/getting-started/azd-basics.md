...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:34:51+00:00",
...
**Предыдущий:** [Установка и настройка](installation.md) | **Следующий:** [Конфигурация](configuration.md)
...
- Используйте CI/CD для развертывания в продакшн
