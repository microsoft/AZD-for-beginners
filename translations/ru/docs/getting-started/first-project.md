...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:33:53+00:00",
...
**Предыдущий:** [Конфигурация](configuration.md) | **Следующий:** [Интеграция с Azure AI Foundry](../ai-foundry/azure-ai-foundry-integration.md)
...
3. **Удалите задачи** - Удалите задачи, которые больше не нужны
