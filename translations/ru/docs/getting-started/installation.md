...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:06:54+00:00",
...
3. Добавьте в переменную PATH среды
...
azd уже установлен в GitHub Codespaces. Просто создайте codespace и начните использовать azd сразу.
...
### Сервисная учетная запись (CI/CD)
...
**Навигация**
- **Предыдущий урок**: [Основы AZD](azd-basics.md)
- **Следующий урок**: [Конфигурация](configuration.md)
