...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:07:57+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "ru"
}
-->
# Подготовка ресурсов Azure с помощью AZD
...
- **🔧 Связанная**: [Глава 6: Проверка перед развертыванием](../pre-deployment/capacity-planning.md)

## Введение

Этот подробный гид охватывает все аспекты подготовки и управления ресурсами Azure с помощью Azure Developer CLI. Вы узнаете, как применять шаблоны инфраструктуры как кода (IaC) — от базового создания ресурсов до сложных архитектур корпоративного уровня с использованием Bicep, ARM-шаблонов, Terraform и Pulumi.
...
- Проектировать и подготавливать инфраструктуру Azure с помощью Bicep и ARM-шаблонов
...
- **ARM-шаблоны** - JSON-шаблоны для Azure Resource Manager
- **Terraform** - инструмент для мультиоблачной инфраструктуры
- **Pulumi** - современный подход к инфраструктуре как коду с использованием языков программирования
...
- [ARM-шаблоны Azure](https://learn.microsoft.com/en-us/azure/azure-resource-manager/templates/)
