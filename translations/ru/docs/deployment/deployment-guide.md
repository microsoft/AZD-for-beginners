...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:18:17+00:00",
...
Этот подробный гид охватывает все аспекты развертывания приложений с использованием Azure Developer CLI, начиная с базовых развертываний одной командой и заканчивая сложными сценариями для продакшена с пользовательскими хуками, несколькими окружениями и интеграцией CI/CD. Освойте полный жизненный цикл развертывания с практическими примерами и лучшими практиками.

## Цели обучения

Пройдя этот гид, вы:
- Овладеете всеми командами и рабочими процессами развертывания Azure Developer CLI
- Поймете полный жизненный цикл развертывания от подготовки до мониторинга
...
- Освоите сложные стратегии развертывания, включая blue-green и canary развертывания
- Интегрируете развертывания azd в CI/CD пайплайны и DevOps процессы
...
- Настраивать развертывания для продакшена с учетом безопасности и мониторинга
- Управлять сложными сценариями развертывания для нескольких окружений
...
- `azd up` - Полный рабочий процесс (подготовка + развертывание)
- `azd provision` - Создание/обновление только ресурсов Azure
- `azd deploy` - Развертывание только кода приложения
...
Когда необходимо обновить только ресурсы Azure:
```bash
...
### Конфигурации, специфичные для окружений
```bash
...
- [Подготовка ресурсов](provisioning.md) - Подробное изучение управления инфраструктурой
- [Планирование до развертывания](../pre-deployment/capacity-planning.md) - Планирование стратегии развертывания
- [Распространенные проблемы](../troubleshooting/common-issues.md) - Решение проблем с развертыванием
...
- **Следующий урок**: [Подготовка ресурсов](provisioning.md)
