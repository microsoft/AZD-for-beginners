...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:05:16+00:00",
...
Этот гид предоставляет подробные рекомендации по развертыванию готовых к продакшену рабочих нагрузок ИИ с использованием Azure Developer CLI (AZD). Основываясь на обратной связи от сообщества Azure AI Foundry в Discord и реальных внедрениях у клиентов, эти практики решают наиболее распространенные проблемы в системах ИИ для продакшена.

## Основные проблемы, которые решаются

На основе результатов опроса нашего сообщества, вот главные проблемы, с которыми сталкиваются разработчики:

- **45%** испытывают трудности с развертыванием ИИ, включающим несколько сервисов
...
### Шаблон 2: Обработка ИИ, основанная на событиях
...
### 2. Резервное копирование данных и восстановление
...
На основе обратной связи сообщества Azure AI Foundry в Discord:

### Основные рекомендации от сообщества:

1. **Начинайте с малого, масштабируйтесь постепенно**: Используйте базовые SKUs и увеличивайте масштаб на основе реального использования
2. **Мониторьте всё**: Настройте полный мониторинг с первого дня
3. **Автоматизируйте безопасность**: Используйте инфраструктуру как код для обеспечения консистентной безопасности
...
- **Документация Azure AI Foundry**: [Официальные документы](https://learn.microsoft.com/azure/ai-studio/)
- **Шаблоны сообщества**: [Примеры Azure](https://github.com/Azure-Samples)
- **Сообщество в Discord**: [Канал #Azure](https://discord.gg/microsoft-azure)
