...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:27:14+00:00",
...
**Предыдущая:** [Первый проект](../getting-started/first-project.md) | **Следующая:** [Развертывание AI-модели](ai-model-deployment.md)
...
| **Управление окружением** | Фокус на одном окружении | Много окружений (dev/staging/prod) |
| **Интеграция CI/CD** | Ограниченная | Поддержка GitHub Actions |
| **Управление затратами** | Базовый мониторинг | Оптимизация затрат для каждого окружения |
...
- Базовые знания о Azure AI Foundry
...
6. **Масштабируйте до продакшена**: Добавьте функции для работы в нескольких регионах и высокой доступности
...
**Нужна помощь?** Присоединяйтесь к обсуждениям в сообществе или создайте запрос в репозитории. Сообщество Azure AI + AZD готово помочь вам добиться успеха!
