...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:17:05+00:00",
  "source_file": "docs/ai-foundry/ai-workshop-lab.md",
  "language_code": "ru"
}
-->
# Лаборатория AI Workshop: Подготовка AI-решений к развертыванию с помощью AZD

**Предыдущая тема:** [Развертывание AI-моделей](ai-model-deployment.md) | **Следующая тема:** [Практики AI в продакшене](production-ai-practices.md)

## Обзор мастер-класса

Этот практический мастер-класс помогает разработчикам преобразовать существующее AI-приложение для развертывания с использованием Azure Developer CLI (AZD). Вы изучите ключевые шаблоны для развертывания AI-решений в продакшене с использованием сервисов Azure AI Foundry.
...
- ✅ Решать распространенные проблемы при развертывании AI
...
## Модуль 2: Развертывание первого AI-приложения
...
**Симптомы:** Ошибки в ответах AI или ошибки развертывания модели  
**Решения:**  
```bash
...
3. Проверьте сетевую связь и задержки
...
- Портал Azure для детальных журналов сервисов
...
- ✅ **Масштабируемость**: Может ли приложение справляться с нагрузкой?
...
- ✅ Развертывать готовые к продакшену AI-приложения
- ✅ Реализуйте лучшие практики безопасности для рабочих нагрузок ИИ  
- ✅ Отслеживайте и оптимизируйте производительность приложений ИИ  
- ✅ Устраняйте распространенные проблемы при развертывании  

### Следующие шаги  
1. Примените эти шаблоны в своих проектах ИИ  
2. Делитесь шаблонами с сообществом  
3. Присоединяйтесь к Discord-сообществу Azure AI Foundry для получения постоянной поддержки  
...
**Предыдущий:** [Развертывание моделей ИИ](ai-model-deployment.md) | **Следующий:** [Практики использования ИИ в продакшене](production-ai-practices.md)  

**Нужна помощь?** Присоединяйтесь к нашему сообществу для поддержки и обсуждений по AZD и развертыванию ИИ.  
