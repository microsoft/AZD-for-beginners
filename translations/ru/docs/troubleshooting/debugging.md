...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:30:38+00:00",
  "source_file": "docs/troubleshooting/debugging.md",
  "language_code": "ru"
}
-->
# Руководство по отладке - Расширенные методы устранения неполадок

## Введение

Этот подробный справочник предоставляет расширенные стратегии, инструменты и методы отладки для диагностики и устранения сложных проблем с развертыванием Azure Developer CLI. Узнайте систематические методы устранения неполадок, техники анализа логов, профилирование производительности и использование продвинутых диагностических инструментов для эффективного решения проблем развертывания и выполнения.

## Цели обучения

После изучения этого руководства вы сможете:
- Овладеть систематическими методами отладки проблем Azure Developer CLI
- Понять конфигурацию расширенного логирования и техники анализа логов
- Реализовать стратегии профилирования производительности и мониторинга
- Использовать диагностические инструменты и сервисы Azure для решения сложных проблем
- Применять методы отладки сети и устранения проблем безопасности
- Настроить комплексный мониторинг и оповещения для проактивного обнаружения проблем

## Результаты обучения

После завершения вы сможете:
- Применять методологию TRIAGE для систематической отладки сложных проблем развертывания
- Настраивать и анализировать подробную информацию о логировании и трассировке
...
## 🛠️ Расширенные инструменты отладки
...
- [Проверки перед развертыванием](../pre-deployment/preflight-checks.md) - Валидация перед развертыванием
