...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:26:04+00:00",
...
Этот подробный справочник по устранению неполадок охватывает наиболее часто встречающиеся проблемы при использовании Azure Developer CLI. Узнайте, как диагностировать, устранять и решать распространенные проблемы с аутентификацией, развертыванием, созданием инфраструктуры и конфигурацией приложений. Каждая проблема включает подробное описание симптомов, причин и пошаговые процедуры решения.

## Цели обучения

Пройдя этот справочник, вы:
- Освоите методы диагностики проблем с Azure Developer CLI
- Поймете распространенные проблемы с аутентификацией и разрешениями, а также их решения
- Научитесь устранять сбои развертывания, ошибки создания инфраструктуры и конфигурационные проблемы
- Реализуете стратегии мониторинга и отладки для предотвращения проблем
- Примените систематические методы устранения сложных неполадок
- Настроите правильное ведение журналов и мониторинг для предотвращения будущих проблем
...
- Отлаживать конфигурационные проблемы приложений и проблемы, связанные с конкретной средой
- Реализовывать мониторинг и оповещения для проактивного выявления потенциальных проблем
- Применять лучшие практики ведения журналов, отладки и рабочих процессов решения проблем
...
**Симптомы:**
- Развертывание завершается с ошибками разрешений
...
- Некоторые SKUs недоступны в выбранном регионе
...
**Симптомы:**
- Развертывания занимают слишком много времени
...
- Проблемы с инфраструктурой, связанные с сервисами Azure
...
- [Планирование емкости](../pre-deployment/capacity-planning.md) - Рекомендации по планированию ресурсов
- [Выбор SKU](../pre-deployment/sku-selection.md) - Рекомендации по выбору уровня обслуживания

---

**Совет**: Сохраните этот справочник в закладках и обращайтесь к нему всякий раз, когда сталкиваетесь с проблемами. Большинство проблем уже встречались ранее и имеют проверенные решения!
