...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-20T06:04:42+00:00",
...
На основе данных сообщества Microsoft Foundry Discord, **45% разработчиков хотят использовать AZD для задач с искусственным интеллектом**, но сталкиваются с трудностями:
...
**✅ Проверка успеха:**
```bash
# После завершения главы 1 вы должны быть в состоянии:
...
- **📖 Шаблоны**: [Развертывание моделей ИИ](docs/microsoft-foundry/ai-model-deployment.md) - развертывание и управление моделями ИИ
- **🛠️ Практикум**: [Лаборатория ИИ](docs/microsoft-foundry/ai-workshop-lab.md) - подготовка ваших решений ИИ к AZD
- **🎥 Интерактивное руководство**: [Материалы практикума](workshop/README.md) - обучение в браузере с MkDocs * DevContainer Environment
- **📋 Шаблоны**: [Шаблоны Microsoft Foundry](../..)
- **📝 Примеры**: [Примеры развертывания AZD](examples/README.md)

#### Практические упражнения
```bash
# Разверните свое первое AI-приложение
...
**✅ Проверка успеха:**
```bash
# После главы 2 вы должны быть в состоянии:
azd init --template azure-search-openai-demo
azd up
...
**📈 Уровень навыков после:** Возможность развертывать и настраивать готовые к продакшену приложения с ИИ  
**💰 Осведомленность о затратах:** Понимание затрат $80-150/месяц для разработки, $300-3500/месяц для продакшена

#### 💰 Учет затрат на развертывание ИИ

**Среда разработки (примерно $80-150/месяц):**
- Azure OpenAI (оплата по факту использования): $0-50/месяц (в зависимости от использования токенов)
- AI Search (базовый уровень): $75/месяц
- Container Apps (потребление): $0-20/месяц
- Хранилище (стандартное): $1-5/месяц

**Среда продакшена (примерно $300-3,500+/месяц):**
- Azure OpenAI (PTU для стабильной производительности): $3,000+/месяц ИЛИ оплата по факту использования с высоким объемом
- AI Search (стандартный уровень): $250/месяц
- Container Apps (выделенные): $50-100/месяц
...
- Запускайте `azd down`, чтобы освободить ресурсы, когда активно не работаете
- Начинайте с оплаты по факту использования, переходите на PTU только для продакшена
...
- **📝 Примеры**: [Пример приложения с базой данных](examples/database-app/README.md) - примеры базы данных AZD
...
- **📖 Архитектура**: [Шаблоны координации агентов](/docs/pre-deployment/coordination-patterns.md) - шаблоны
...
**💡 Результат главы**: Развернуть и управлять готовым к производству многоагентным AI-решением с агентами Клиента и Инвентаризации
...
#### Чему вы научитесь
- Планирование ресурсов и проверка их доступности
- Стратегии выбора SKU
- Предварительные проверки и автоматизация

#### Учебные материалы
- **📊 Планирование**: [Планирование ресурсов](docs/pre-deployment/capacity-planning.md) - Проверка доступности ресурсов
...
- **🤖 Проблемы AI**: [Устранение неполадок AI](docs/troubleshooting/ai-troubleshooting.md) - Проблемы AI-сервисов
...
- Развертывание в производственной среде с соблюдением правил управления

**💡 Результат главы**: Развернуть корпоративные приложения с полным набором возможностей для производства

---

## 🎓 Обзор мастерской: Практическое обучение

> **⚠️ СТАТУС МАСТЕРСКОЙ: Активная разработка**  
> Материалы мастерской находятся в процессе разработки и доработки. Основные модули функциональны, но некоторые расширенные разделы еще не завершены. Мы активно работаем над завершением всего контента. [Отслеживать прогресс →](workshop/README.md)

### Интерактивные материалы мастерской
**Комплексное практическое обучение с инструментами в браузере и пошаговыми упражнениями**

Материалы мастерской предоставляют структурированный, интерактивный опыт обучения, который дополняет учебную программу, основанную на главах. Мастерская предназначена как для самостоятельного обучения, так и для занятий с инструктором.

#### 🛠️ Особенности мастерской
- **Интерфейс в браузере**: Полноценная мастерская на основе MkDocs с функциями поиска, копирования и выбора темы
...
Мастерская следует методологии **Открытие → Развертывание → Настройка**:

1. **Фаза открытия** (45 минут)
   - Изучение шаблонов и сервисов Microsoft Foundry
   - Понимание архитектурных шаблонов многоагентных систем
...
После завершения мастерской участники смогут:
- **Развернуть производственные AI-приложения**: Использовать AZD с сервисами Microsoft Foundry
- **Освоить многоагентные архитектуры**: Реализовать координированные решения с AI-агентами
- **Реализовать лучшие практики безопасности**: Настроить аутентификацию и контроль доступа
- **Оптимизировать масштабирование**: Спроектировать экономически эффективные и производительные развертывания
...
- **💡 Быстрый старт**: [Руководство по настройке мастерской](workshop/README.md#quick-start) - Конфигурация среды

**Идеально подходит для**: Корпоративного обучения, университетских курсов, самостоятельного обучения и интенсивных курсов для разработчиков.
...
- **Развертывания на основе шаблонов** - Использование готовых шаблонов для распространенных архитектур приложений
...
- **Шаблоны AI для производства** - Лучшие практики для масштабируемых и экономически эффективных AI-приложений
- **Полные рабочие процессы AI** - От разработки модели до развертывания в производственной среде с мониторингом
...
> **Примечание:** Эти шаблоны демонстрируют различные AI-шаблоны. Некоторые из них являются внешними примерами Azure Samples, другие — локальными реализациями.
...
| [**Решение для розничной торговли с многоагентной архитектурой**](examples/retail-scenario.md) | Глава 5 | ⭐⭐⭐⭐ | AzureOpenAI + AI Search + Storage + Container Apps + Cosmos DB | **Локальный** |
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Глава 5 | ⭐⭐⭐⭐ | Многоагентная архитектура с агентами Клиента и Инвентаризации |
...
- [**Решение для розничной торговли с многоагентной архитектурой**](examples/retail-scenario.md) - Полная реализация, готовая к производству, с ARM-шаблонами
  - Многоагентная архитектура (агенты Клиента + Инвентаризации)
...
- [**Примеры контейнерных приложений**](examples/container-app/README.md) - Полное руководство по развертыванию контейнеров
  ...
  - [Архитектура микросервисов](../../examples/container-app/microservices) - Готовое к производству развертывание многосервисного приложения
  - Шаблоны быстрого старта, производства и расширенного развертывания
...
- [Функции + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - Серверные рабочие процессы с данными

#### Внешние примеры - Расширенные шаблоны (Главы 4-8)
- [Java микросервисы](https://github.com/Azure-Samples/java-microservices-aca-lab) - Архитектуры многосервисных приложений
- [Задачи контейнерных приложений](https://github.com/Azure-Samples/container-apps-jobs) - Фоновая обработка  
...
- [**FAQ**](resources/faq.md) - Часто задаваемые вопросы, организованные по учебным главам
- [**Учебное пособие**](resources/study-guide.md) - Комплексные практические упражнения
### Практические мастер-классы
- [**AI Workshop Lab**](docs/microsoft-foundry/ai-workshop-lab.md) - Сделайте свои AI-решения готовыми к развертыванию с помощью AZD (2-3 часа)
- [**Интерактивное руководство по мастер-классу**](workshop/README.md) - Мастер-класс в браузере с использованием MkDocs и DevContainer Environment
- [**Структурированный путь обучения**](../../workshop/docs/instructions) - 7 шагов с пошаговыми упражнениями (от исследования до развертывания и настройки)
- [**Мастер-класс для начинающих по AZD**](workshop/README.md) - Полный набор материалов для практических занятий с интеграцией GitHub Codespaces
...
### ❌ "azd up" завершился с ошибкой на полпути
...
# Вариант 3: Проверить детализированные логи
azd show
azd logs
```
...
# Тогда повторите с новой средой
azd env new dev-v2
azd up
```
...
- AI-приложения: 15-25 минут (провизия OpenAI медленная)
...
# Вам нужна как минимум роль "Сотрудник"
# Попросите вашего администратора Azure предоставить:
# - Сотрудник (для ресурсов)
...
- **AI-специфические проблемы:** [Устранение неполадок AI](docs/troubleshooting/ai-troubleshooting.md)
...
<details>
<summary><strong>❌ "azd up" завершился с ошибкой на полпути</strong></summary>
...
- **Практический опыт**: Развернутые реальные AI-приложения в Azure
...
- Получить ранний доступ к новым AI-шаблонам
- Внести вклад в лучшие практики развертывания AI
- Влиять на разработку будущих функций AI + AZD

### Вклад в курс
Мы приветствуем ваш вклад! Пожалуйста, ознакомьтесь с нашим [Руководством по вкладу](CONTRIBUTING.md) для получения информации о:
...
- **Сообщении об ошибках**: Повышение точности и ясности
...
**Для опытных разработчиков**: Начните с [Глава 3: Настройка и аутентификация](../..)
