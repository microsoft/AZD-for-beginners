...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T11:35:20+00:00",
...
- **🛠️ Практика**: [Ваш первый проект](docs/getting-started/first-project.md) - пошаговый туториал
...
- **🛠️ Практикум**: [Лаборатория AI](docs/ai-foundry/ai-workshop-lab.md) - подготовка AI-решений для AZD
...
### 🎯 Глава 5: Решения с несколькими агентами (продвинутый уровень)
...
- **🤖 Проблемы AI**: [Устранение проблем AI](docs/troubleshooting/ai-troubleshooting.md) - проблемы с сервисами AI
...
#### Ресурсы для обучения
- **🏭 Продакшен**: [Лучшие практики для AI в продакшене](docs/ai-foundry/production-ai-practices.md) - шаблоны для предприятий
...
**💡 Результат главы**: Развертывание приложений корпоративного уровня с полной готовностью к продакшну
...
**Полноценное практическое обучение с использованием инструментов в браузере и пошаговых упражнений**
...
- **Интерфейс в браузере**: Полноценный воркшоп на базе MkDocs с функциями поиска, копирования и выбора темы
...
- **Оптимизировать масштабирование**: Спроектировать экономичные и производительные развертывания
- **Устранить проблемы развертывания**: Решать распространенные проблемы самостоятельно
...
- **🛠️ Лаборатория AI Workshop**: [AI Workshop Lab](docs/ai-foundry/ai-workshop-lab.md) - Упражнения, ориентированные на AI
...
- **Полные рабочие процессы AI** - От разработки модели до развертывания в продакшн с надлежащим мониторингом
- **Оптимизация затрат** - Умные стратегии распределения ресурсов и масштабирования для AI-нагрузок
- **Интеграция с Azure AI Foundry** - Бесшовное подключение к каталогу моделей AI Foundry и конечным точкам
...
- [**Шаблоны AZD от Azure-Samples**](https://github.com/Azure-Samples/azd-templates) - Официальные примеры от Microsoft
...
- [**Лаборатория AI Workshop**](docs/ai-foundry/ai-workshop-lab.md) - Сделайте свои AI-решения готовыми к развертыванию через AZD (2-3 часа)
- [**Интерактивное руководство по воркшопу**](workshop/README.md) - Воркшоп в браузере с MkDocs и средой DevContainer
...
- **Опыт работы в продакшне**: Развернутые реальные AI-приложения в Azure
...
- **Стандартах сообщества**: Соблюдение наших инклюзивных принципов сообщества
