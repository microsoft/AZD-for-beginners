...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:52:12+00:00",
...
**Продакшн-среда (примерно $300-3,500+/мес):**
- Azure OpenAI (PTU для стабильной производительности): $3,000+/мес ИЛИ оплата по факту при большом объеме
...
- Решить проблемы аутентификации
...
Наши материалы мастер-класса обеспечивают структурированный, интерактивный опыт обучения, дополняющий учебный план по главам выше. Мастер-класс рассчитан как на самостоятельное обучение, так и на занятия с инструктором.

#### 🛠️ Особенности мастер-класса
- **Интерфейс в браузере**: Полный мастер-класс на базе MkDocs с поиском, копированием и темами
- **Интеграция GitHub Codespaces**: Настройка среды разработки в один клик
- **Структурированный учебный путь**: 7 пошаговых упражнений (всего 3.5 часа)
- **Методология Открытие → Развертывание → Настройка**
...
1. **Фаза открытия** (45 мин)
   ...
   - Понимание паттернов мультиагентной архитектуры
...
- **Освоить мультиагентные архитектуры**: Реализовывать координированные решения с ИИ-агентами
...
- **🛠️ Лаборатория ИИ**: [Лаборатория ИИ](docs/microsoft-foundry/ai-workshop-lab.md) - Упражнения с фокусом на ИИ
...
- **Паттерны производственного ИИ** — Лучшие практики масштабируемых и экономичных развертываний ИИ-приложений
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Глава 5 | ⭐⭐⭐⭐ | Мультиагентная архитектура с агентами Клиента и Инвентаря |
...
- [**Розничное мультиагентное решение**](examples/retail-scenario.md) - Полная производственная реализация с ARM шаблонами
  - Мультиагентная архитектура (агенты Клиента и Инвентаря)
...
- [**Примеры контейнерных приложений**](examples/container-app/README.md) - Полное руководство по развертыванию контейнеров
  ...
  - [Архитектура микросервисов](../../examples/container-app/microservices) - Производственное развертывание мультисервисов
...
- [**Лаборатория AI Workshop**](docs/microsoft-foundry/ai-workshop-lab.md) - Сделайте ваши AI-решения готовыми к развертыванию через AZD (2-3 часа)  
...
- Документация Azure Developer CLI: [https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)  
- Центр архитектуры Azure: [https://learn.microsoft.com/en-us/azure/architecture/](https://learn.microsoft.com/en-us/azure/architecture/)  
- Калькулятор цен Azure: [https://azure.microsoft.com/pricing/calculator/](https://azure.microsoft.com/pricing/calculator/)  
- Статус Azure: [https://status.azure.com/](https://status.azure.com/)  
