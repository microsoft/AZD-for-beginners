...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T21:03:39+00:00",
...
**📈 Уровень после:** Способен самостоятельно развертывать базовые приложения
...
**📈 Уровень после:** Способен развертывать и настраивать AI-приложения, готовые к продакшн  
**💰 Осведомленность о затратах:** Понимание затрат на разработку $80-150/мес, продакшн $300-3500/мес
...
**💡 Результат главы**: Развертывать сложные много-сервисные приложения с использованием кастомных инфраструктурных шаблонов
...
- **📖 Architecture**: [Multi-agent coordination patterns](/docs/pre-deployment/coordination-patterns.md) - Шаблоны
...
**💡 Результат главы**: Развернуть и управлять готовым к производству решением с несколькими агентами AI с агентами Customer и Inventory
...
- **💰 Выбор**: [SKU Selection](docs/pre-deployment/sku-selection.md) - Экономичные варианты
- **✅ Валидация**: [Pre-flight Checks](docs/pre-deployment/preflight-checks.md) - Автоматизированные скрипты
...
- Особенности устранения неполадок AI

#### Учебные материалы
- **🔧 Распространенные проблемы**: [Common Issues](docs/troubleshooting/common-issues.md) - FAQ и решения
- **🕵️ Отладка**: [Debugging Guide](docs/troubleshooting/debugging.md) - Пошаговые стратегии
- **🤖 Проблемы AI**: [AI-Specific Troubleshooting](docs/troubleshooting/ai-troubleshooting.md) - Проблемы сервисов AI

#### Практические упражнения
- Диагностировать сбои развертывания
- Решать проблемы аутентификации
- Отлаживать подключение к AI-сервисам
...
#### Учебные материалы
- **🏭 Производство**: [Production AI Best Practices](docs/microsoft-foundry/production-ai-practices.md) - Корпоративные шаблоны
...
- **Интерфейс в браузере**: Полный мастер-класс на базе MkDocs с поиском, копированием и темами
...
1. **Фаза изучения** (45 мин)  
   ...
   - Понимание архитектурных шаблонов с несколькими агентами  
...
- **Освоить архитектуры с несколькими агентами**: Реализовывать координированные решения AI-агентов
...
- **📋 Пошаговые инструкции**: [Guided Exercises](../../workshop/docs/instructions) - Детальные пошаговые инструкции
- **🛠️ Лаборатория AI**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Упражнения, ориентированные на AI
- **💡 Быстрый старт**: [Workshop Setup Guide](workshop/README.md#quick-start) - Настройка среды
...
### **AZD + Microsoft Foundry: Идеально для развертываний AI**
...
- **Полные AI-рабочие процессы** — От разработки модели до производственного развертывания с мониторингом  
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Глава 5 | ⭐⭐⭐⭐ | Архитектура с несколькими агентами (Customer и Inventory) |
...
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Полная готовая к производству реализация с ARM шаблонами
  - Архитектура с несколькими агентами (Customer + Inventory)
...
- [**Container App Examples**](examples/container-app/README.md) - Полное руководство по развертыванию контейнеров
...
- **Улучшение контента**: Расширение существующих глав и примеров  
- **Новые примеры**: Добавление реальных сценариев и шаблонов  
- **Переводы**: Помощь в поддержке многоязычности  
- **Отчёты об ошибках**: Повышение точности и ясности  
