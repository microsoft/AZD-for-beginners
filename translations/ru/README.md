...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-11T09:46:15+00:00",
...
3. [**Присоединяйтесь к сообществам Azure Discord и познакомьтесь с экспертами и другими разработчиками**](https://discord.com/invite/ByRwuEEgH4)
...
## Примеры и шаблоны
- [**Примеры**]([examples/README.md) — Практические примеры, шаблоны и реальные сценарии, которые помогут вам изучить Azure Developer CLI через практику. Каждый пример содержит полный рабочий код, шаблоны инфраструктуры и подробные инструкции для различных архитектур приложений и шаблонов развертывания.

### Практическая лаборатория/семинар
- [**AZD для начинающих**](workshop/README.md) — Этот семинар сосредоточен на шаблоне Get Started with AI Agents AZD и предоставляет практические рекомендации по развертыванию сервисов Azure AI с использованием AZD.

## Ресурсы

### Быстрые ссылки
- [**Шпаргалка команд**](resources/cheat-sheet.md) — Основные команды azd
- [**Глоссарий**](resources/glossary.md) — Терминология Azure и azd
- [**FAQ**](resources/faq.md) — Часто задаваемые вопросы
- [**Учебное пособие**](resources/study-guide.md) — Полные учебные цели и практические упражнения
...
Мы приветствуем вклад! Пожалуйста, ознакомьтесь с нашим [Руководством по вкладу](CONTRIBUTING.md) для получения информации о:
- Как отправлять проблемы и запросы на функции
...
- [Освоение GitHub Copilot для совместного программирования с ИИ](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
