...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:19:36+00:00",
...
- **AI एप्लिकेसन तैनात गर्नुहोस्**: AZD लाई Azure AI Foundry सेवाहरूको साथ प्रयोग गर्नुहोस्
- **Infrastructure as Code लागू गर्नुहोस्**: Bicep टेम्प्लेटहरूको साथ Azure स्रोतहरू व्यवस्थापन गर्नुहोस्
- **तैनाती समस्या समाधान गर्नुहोस्**: सामान्य समस्याहरू समाधान गर्नुहोस् र डिबग समस्याहरू
...
*आफ्नो अनुभव स्तर र लक्ष्यहरूमा आधारित सिकाइ मार्ग चयन गर्नुहोस्*
...
- AI-संचालित एप्लिकेसन तैनात गर्दै
- AI सेवा कन्फिगरेसन बुझ्दै

#### सिकाइ स्रोतहरू
- **🎯 यहाँबाट सुरु गर्नुहोस्**: [Azure AI Foundry एकीकरण](docs/ai-foundry/azure-ai-foundry-integration.md)
- **📖 ढाँचाहरू**: [AI मोडेल तैनाती](docs/ai-foundry/ai-model-deployment.md) - AI मोडेल तैनात र व्यवस्थापन गर्नुहोस्
- **🛠️ कार्यशाला**: [AI कार्यशाला प्रयोगशाला](docs/ai-foundry/ai-workshop-lab.md) - तपाईंको AI समाधानहरू AZD-तयार बनाउनुहोस्
- **🎥 अन्तरक्रियात्मक मार्गदर्शन**: [कार्यशाला सामग्रीहरू](workshop/README.md) - MkDocs * DevContainer वातावरणको साथ ब्राउजर-आधारित सिकाइ
...
- बहु-सेवा एप्लिकेसन तैनात गर्नुहोस्
- ब्लू-ग्रीन तैनाती रणनीतिहरू लागू गर्नुहोस्

**💡 अध्यायको परिणाम**: अनुकूलित Infrastructure टेम्प्लेटहरू प्रयोग गरेर जटिल बहु-सेवा एप्लिकेसन तैनात गर्नुहोस्
...
- उचित शासनसहित उत्पादनमा तैनाती गर्नुहोस्

**💡 अध्यायको नतिजा**: पूर्ण उत्पादन क्षमतासहित उद्यम-तयार एप्लिकेशनहरू तैनाती गर्नुहोस्
...
2. **तैनाती चरण** (२ घण्टा)
   - AZD सँग AI एप्लिकेशनहरूको व्यावहारिक तैनाती
...
3. **अनुकूलन चरण** (४५ मिनेट)
   - विशिष्ट प्रयोगका लागि एप्लिकेशनहरू परिमार्जन गर्नुहोस्
...
- **उत्पादन AI एप्लिकेशनहरू तैनाती गर्नुहोस्**: Azure AI Foundry सेवाहरूको साथ AZD प्रयोग गर्नुहोस्
...
- **तैनातीहरू समस्या समाधान गर्नुहोस्**: सामान्य समस्याहरू स्वतन्त्र रूपमा समाधान गर्नुहोस्
...
Azure Developer CLI (azd) एक विकासकर्ता-केंद्रित कमाण्ड-लाइन इन्टरफेस हो जसले Azure मा एप्लिकेशन निर्माण र तैनातीको प्रक्रियालाई तीव्र बनाउँछ। यसले प्रदान गर्दछ:

- **टेम्प्लेट-आधारित तैनातीहरू** - सामान्य एप्लिकेशन ढाँचाहरूको लागि पूर्व-निर्मित टेम्प्लेटहरू प्रयोग गर्नुहोस्
- **कोडको रूपमा पूर्वाधार** - Bicep वा Terraform प्रयोग गरेर Azure स्रोतहरू व्यवस्थापन गर्नुहोस्  
- **एकीकृत कार्यप्रवाहहरू** - एप्लिकेशनहरू सहज रूपमा प्रावधान, तैनाती, र निगरानी गर्नुहोस्
...
- **उत्पादन AI ढाँचाहरू** - मापनयोग्य, लागत-प्रभावकारी AI एप्लिकेशन तैनातीहरूको लागि उत्कृष्ट अभ्यासहरू
- **एन्ड-टु-एन्ड AI कार्यप्रवाहहरू** - मोडेल विकासदेखि उत्पादन तैनातीसम्म उचित निगरानीको साथ
...
**यदि तपाईं AI एप्लिकेशनहरू तैनाती गर्दै हुनुहुन्छ भने यहाँबाट सुरु गर्नुहोस्!**
...
| [**AI एजेन्टहरूसँग सुरु गर्नुहोस्**](https://github.com/Azure-Samples/get-started-with-ai-agents) | अध्याय २ | ⭐⭐ | Azure AI एजेन्ट सेवा + AzureOpenAI + Azure AI खोज + Azure कन्टेनर एप्स + एप्लिकेशन इनसाइट्स|
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | अध्याय २ | ⭐⭐ | RAG कार्यान्वयन Azure AI खोजको साथ |
...
- [सरल वेब एप](../../examples/simple-web-app) - आधारभूत तैनाती ढाँचाहरू
- [स्थिर वेबसाइट](../../examples/static-site) - स्थिर सामग्री तैनाती
- [आधारभूत API](../../examples/basic-api) - REST API तैनाती

#### डाटाबेस एकीकरण (अध्याय ३-४)  
- [डाटाबेस एप](../../examples/database-app) - डाटाबेस कनेक्टिविटी ढाँचाहरू
- [डाटा प्रशोधन](../../examples/data-processing) - ETL कार्यप्रवाह तैनाती

#### उन्नत ढाँचाहरू (अध्याय ४-८)
- [कन्टेनर एप्स](../../examples/container-app) - कन्टेनराइज्ड तैनातीहरू
- [माइक्रोसर्भिसेस](../../examples/microservices) - बहु-सेवा आर्किटेक्चरहरू  
...
- [**उदाहरण निर्देशिका**](examples/README.md) - विस्तृत व्याख्याहरूको साथ स्थानीय सिकाइ उदाहरणहरू
...
- [**AI कार्यशाला प्रयोगशाला**](docs/ai-foundry/ai-workshop-lab.md) - तपाईंको AI समाधानहरू AZD-तैनातीयोग्य बनाउनुहोस् (२-३ घण्टा)
- [**अन्तरक्रियात्मक कार्यशाला मार्गदर्शक**](workshop/README.md) - MkDocs र DevContainer वातावरणको साथ ब्राउजर-आधारित कार्यशाला
- [**संरचित सिकाइ पथ**](../../workshop/docs/instructions) - ७-चरण निर्देशित अभ्यासहरू (खोज → तैनाती → अनुकूलन)
- [**AZD को लागि शुरुआती कार्यशाला**](workshop/README.md) - GitHub Codespaces एकीकरणको साथ पूर्ण व्यावहारिक कार्यशाला सामग्रीहरू
...
- **उत्पादन अनुभव**: वास्तविक AI एप्लिकेशनहरू Azure मा तैनाती गर्नुभयो
- **व्यावसायिक सीपहरू**: उद्यम-तयार तैनाती क्षमताहरू  
- **समुदाय मान्यता**: Azure विकासकर्ता समुदायको सक्रिय सदस्य
- **क्यारियर उन्नति**: मागमा AZD र AI तैनाती विशेषज्ञता
...
- **AI-विशिष्ट सहयोग**: [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG) मा सामेल हुनुहोस्
...
-
- एआई परिनियोजनका उत्कृष्ट अभ्यासहरूमा योगदान गर्नुहोस्  
- भविष्यको एआई + AZD विशेषता विकासलाई प्रभाव पार्नुहोस्  

### पाठ्यक्रममा योगदान गर्ने  
हामी योगदानहरूलाई स्वागत गर्दछौं! कृपया हाम्रो [योगदान मार्गदर्शिका](CONTRIBUTING.md) पढ्नुहोस्, जसमा निम्न विषयहरू समावेश छन्:  
...
### लाइसेन्स  
यो परियोजना MIT लाइसेन्स अन्तर्गत लाइसेन्स गरिएको छ - थप जानकारीका लागि [LICENSE](../../LICENSE) फाइल हेर्नुहोस्।  
...
**एआई विकासकर्ता**: [अध्याय २: एआई-प्रथम विकास](../..) मा जानुहोस्  
