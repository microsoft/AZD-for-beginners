...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:42:47+00:00",
...
- **AI एप्लिकेसन परिनियोजन गर्नुहोस्**: AZD लाई Azure AI Foundry सेवाहरूको साथ प्रयोग गर्नुहोस्
...
**💡 अध्यायको परिणाम**: AZD प्रयोग गरेर Azure मा एक साधारण वेब एप्लिकेसन सफलतापूर्वक परिनियोजन गर्नुहोस्
...
- AI-संचालित एप्लिकेसन परिनियोजन
- AI सेवा कन्फिगरेसनको समझ

#### सिकाइ स्रोतहरू
- **🎯 यहाँबाट सुरु गर्नुहोस्**: [Azure AI Foundry एकीकरण](docs/ai-foundry/azure-ai-foundry-integration.md)
- **📖 ढाँचाहरू**: [AI मोडेल परिनियोजन](docs/ai-foundry/ai-model-deployment.md) - AI मोडेल व्यवस्थापन र परिनियोजन
- **🛠️ कार्यशाला**: [AI कार्यशाला प्रयोगशाला](docs/ai-foundry/ai-workshop-lab.md) - तपाईंको AI समाधानहरू AZD-तयार बनाउनुहोस्
- **🎥 अन्तरक्रियात्मक मार्गदर्शन**: [कार्यशाला सामग्री](workshop/README.md) - ब्राउजर-आधारित सिकाइ MkDocs * DevContainer Environment को साथ
...
**💡 अध्यायको परिणाम**: RAG क्षमता भएको AI-संचालित च्याट एप्लिकेसन परिनियोजन र कन्फिगर गर्नुहोस्
...
- **📝 उदाहरणहरू**: [कन्टेनर एप्लिकेसन उदाहरण](../../examples/container-app) - कन्टेनराइज्ड परिनियोजन

#### व्यावहारिक अभ्यासहरू
- अनुकूलित Bicep टेम्प्लेटहरू सिर्जना गर्नुहोस्
- बहु-सेवा एप्लिकेसन परिनियोजन गर्नुहोस्
- ब्लू-ग्रीन परिनियोजन रणनीतिहरू लागू गर्नुहोस्

**💡 अध्यायको परिणाम**: अनुकूलित Infrastructure टेम्प्लेटहरू प्रयोग गरेर जटिल बहु-सेवा एप्लिकेसन परिनियोजन गर्नुहोस्
...
**💡 अध्यायको परिणाम**: ग्राहक र इन्वेन्टरी एजेन्टहरूसहित उत्पादन-तयार बहु-एजेन्ट AI समाधान परिनियोजन र व्यवस्थापन गर्नुहोस्
...
**💡 अध्यायको परिणाम**: परिनियोजन अघि मान्यता र अनुकूलन गर्नुहोस्
...
**💡 अध्यायको परिणाम**: सामान्य परिनियोजन समस्याहरू स्वतन्त्र रूपमा निदान र समाधान गर्नुहोस्
...
#### सिकाइ स्रोतहरू
- **🏭 उत्पादन**: [Production AI Best Practices](docs/ai-foundry/production-ai-practices.md) - उद्यम ढाँचाहरू
...
**💡 अध्यायको परिणाम**: पूर्ण उत्पादन क्षमतासहित उद्यम-तयार अनुप्रयोगहरू परिनियोजन गर्नुहोस्
...
- **उत्पादन AI अनुप्रयोगहरू परिनियोजन गर्नुहोस्**: AZD र Azure AI Foundry सेवाहरू प्रयोग गर्नुहोस्
...
- **मापनको लागि अनुकूलन गर्नुहोस्**: लागत-प्रभावकारी, प्रदर्शनक्षम परिनियोजनहरू डिजाइन गर्नुहोस्
...
- **📋 चरण-दर-चरण निर्देशनहरू**: [Guided Exercises](../../workshop/docs/instructions) - विस्तृत वाकथ्रुहरू
...
Azure Developer CLI (azd) एक विकासकर्ता-केंद्रित कमाण्ड-लाइन इन्टरफेस हो जसले Azure मा अनुप्रयोगहरू निर्माण र परिनियोजनको प्रक्रियालाई तीव्र बनाउँछ। यसले प्रदान गर्दछ:

- **टेम्प्लेट-आधारित परिनियोजनहरू** - सामान्य अनुप्रयोग ढाँचाहरूको लागि पूर्व-निर्मित टेम्प्लेटहरू प्रयोग गर्नुहोस्
- **कोडको रूपमा पूर्वाधार** - Bicep वा Terraform प्रयोग गरेर Azure स्रोतहरू व्यवस्थापन गर्नुहोस्  
- **एकीकृत कार्यप्रवाहहरू** - सहज रूपमा प्रावधान, परिनियोजन, र अनुप्रयोगहरू निगरानी गर्नुहोस्
...
- **उत्पादन AI ढाँचाहरू** - मापनयोग्य, लागत-प्रभावकारी AI अनुप्रयोग परिनियोजनहरूको लागि उत्कृष्ट अभ्यासहरू
...
- [Simple Web App](../../examples/simple-web-app) - आधारभूत परिनियोजन ढाँचाहरू
...
- [Data Processing](../../examples/data-processing) - ETL कार्यप्रवाह परिनियोजन

#### उन्नत ढाँचाहरू (अध्याय ४-८)
- [Container Apps](../../examples/container-app) - कन्टेनराइज्ड परिनियोजनहरू
...
- [**Examples Directory**](examples/README.md) - विस्तृत व्याख्याहरूसहित स्थानीय सिकाइ उदाहरणहरू
...
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - तपाईंको AI समाधानहरू AZD-परिनियोज्य बनाउनुहोस् (२-३ घण्टा)
- [**Interactive Workshop Guide**](workshop/README.md) - MkDocs र DevContainer वातावरणसहित ब्राउजर-आधारित कार्यशाला
- [**Structured Learning Path**](../../workshop/docs/instructions) - ७-चरण निर्देशित अभ्यासहरू (खोज → परिनियोजन → अनुकूलन)
...
- **उत्पादन अनुभव**: वास्तविक AI अनुप्रयोगहरू Azure मा परिनियोजन गर्नुहोस्
...
### लाइसेन्स  
यो परियोजना MIT लाइसेन्स अन्तर्गत लाइसेन्स गरिएको छ - थप विवरणको लागि [LICENSE](../../LICENSE) फाइल हेर्नुहोस्।  
