...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:37:04+00:00",
  "source_file": "docs/pre-deployment/preflight-checks.md",
  "language_code": "ne"
}
-->
# प्रि-फ्लाइट जाँच - परिनियोजन तयारीको मान्यता

## परिचय

यो व्यापक मार्गदर्शनले Azure Developer CLI परिनियोजनहरू सुरु हुनु अघि सफल परिनियोजन सुनिश्चित गर्न प्रि-डिप्लोयमेन्ट मान्यता स्क्रिप्टहरू र प्रक्रियाहरू प्रदान गर्दछ। प्रमाणीकरण, स्रोत उपलब्धता, कोटा, सुरक्षा अनुपालन, र प्रदर्शन आवश्यकताहरूको लागि स्वचालित जाँच कार्यान्वयन गर्न सिक्नुहोस् जसले परिनियोजन असफलता रोक्न र परिनियोजन सफलताको दरलाई अनुकूलित गर्न मद्दत गर्दछ।

## सिक्ने लक्ष्यहरू

यो मार्गदर्शन पूरा गरेर, तपाईं:
- स्वचालित प्रि-डिप्लोयमेन्ट मान्यता प्रविधि र स्क्रिप्टहरूमा निपुणता हासिल गर्नुहुनेछ
- प्रमाणीकरण, अनुमति, र कोटाको लागि व्यापक जाँच रणनीतिहरू बुझ्नुहुनेछ
- स्रोत उपलब्धता र क्षमता मान्यता प्रक्रियाहरू कार्यान्वयन गर्नुहुनेछ
- संगठनात्मक नीतिहरूको लागि सुरक्षा र अनुपालन जाँचहरू कन्फिगर गर्नुहुनेछ
- लागत अनुमान र बजेट मान्यता कार्यप्रवाहहरू डिजाइन गर्नुहुनेछ
- CI/CD पाइपलाइनहरूको लागि अनुकूलित प्रि-फ्लाइट चेक स्वचालन सिर्जना गर्नुहुनेछ

## सिक्ने परिणामहरू

पूरा गरेपछि, तपाईं सक्षम हुनुहुनेछ:
- व्यापक प्रि-फ्लाइट मान्यता स्क्रिप्टहरू सिर्जना र कार्यान्वयन गर्न
- विभिन्न परिनियोजन परिदृश्यहरूको लागि स्वचालित जाँच कार्यप्रवाहहरू डिजाइन गर्न
- वातावरण-विशिष्ट मान्यता प्रक्रियाहरू र नीतिहरू कार्यान्वयन गर्न
- परिनियोजन तयारीको लागि सक्रिय निगरानी र चेतावनी कन्फिगर गर्न
- प्रि-डिप्लोयमेन्ट समस्याहरू समाधान गर्न र सुधारात्मक कार्यहरू कार्यान्वयन गर्न
- प्रि-फ्लाइट चेकहरू DevOps पाइपलाइनहरू र स्वचालन कार्यप्रवाहहरूमा एकीकृत गर्न

## सामग्री तालिका

- [सारांश](../../../../docs/pre-deployment)
- [स्वचालित प्रि-फ्लाइट स्क्रिप्ट](../../../../docs/pre-deployment)
- [म्यानुअल मान्यता चेकलिस्ट](../../../../docs/pre-deployment)
- [वातावरण मान्यता](../../../../docs/pre-deployment)
- [स्रोत मान्यता](../../../../docs/pre-deployment)
...
प्रि-फ्लाइट जाँचहरू परिनियोजन अघि गरिने आवश्यक मान्यताहरू हुन् जसले सुनिश्चित गर्दछ:
...
## म्यानुअल मान्यता चेकलिस्ट

### प्रि-डिप्लोयमेन्ट चेकलिस्ट

यो चेकलिस्ट प्रिन्ट गर्नुहोस् र परिनियोजन अघि प्रत्येक वस्तु प्रमाणित गर्नुहोस्:

#### ✅ वातावरण सेटअप
- [ ] AZD CLI स्थापना गरिएको र पछिल्लो संस्करणमा अपडेट गरिएको
- [ ] Azure CLI स्थापना गरिएको र प्रमाणित गरिएको
- [ ] सही Azure सदस्यता चयन गरिएको
- [ ] वातावरण नाम अद्वितीय छ र नामकरण नियमहरू पालना गर्दछ
- [ ] लक्षित स्रोत समूह पहिचान गरिएको वा सिर्जना गर्न सकिन्छ

#### ✅ प्रमाणीकरण र अनुमति
- [ ] `azd auth login` प्रयोग गरेर सफलतापूर्वक प्रमाणित गरिएको
- [ ] प्रयोगकर्तासँग लक्षित सदस्यता/स्रोत समूहमा Contributor भूमिका छ
...
- [ ] टेम्प्लेटहरूमा कुनै हार्डकोड गरिएको गोप्य जानकारी छैन

#### ✅ स्रोत योजना
- [ ] लक्षित Azure क्षेत्र चयन गरिएको र मान्यता गरिएको
...
- [ ] आवश्यक परेमा बजेट चेतावनीहरू कन्फिगर गरिएको
...
- [ ] महत्वपूर्ण मेट्रिक्सको लागि चेतावनी नियमहरू परिभाषित गरिएको
...
- [ ] पुन: प्राप्ति समय उद्देश्यहरू (RTO) दस्तावेज गरिएको
- [ ] पुन: प्राप्ति बिन्दु उद्देश्यहरू (RPO) दस्तावेज गरिएको
- [ ] उत्पादनको लागि आपतकालीन पुन: प्राप्ति योजना तयार गरिएको

---

## वातावरण मान्यता

### विकास वातावरण मान्यता
...
1. **जहाँ सम्भव छ स्वचालन गर्नुहोस्**
   ...
   - दोहोरिने मान्यताहरूको लागि स्क्रिप्टहरू प्रयोग गर्नुहोस्
   - अडिट ट्रेलहरूको लागि परिणामहरू भण्डारण गर्नुहोस्

2. **वातावरण-विशिष्ट मान्यता**
   - विकास/स्टेजिङ/उत्पादनका लागि फरक जाँचहरू
...
3. **व्यापक कवरेज**
   ...
   - टेम्प्लेट मान्यता र वाक्यविन्यास
   - सुरक्षा र अनुपालन आवश्यकताहरू

4. **स्पष्ट रिपोर्टिङ**
   - रंग-कोड गरिएको स्थिति संकेतकहरू
   - समाधान चरणहरूसहित विस्तृत त्रुटि सन्देशहरू
   - छिटो मूल्याङ्कनको लागि सारांश रिपोर्टहरू

5. **छिटो असफल हुनुहोस्**
   - यदि महत्वपूर्ण जाँचहरू असफल भए भने परिनियोजन रोक्नुहोस्
   - समाधानको लागि स्पष्ट मार्गदर्शन प्रदान गर्नुहोस्
   - जाँचहरू पुन: चलाउन सजिलो बनाउनुहोस्

### सामान्य प्रि-फ्लाइट समस्याहरू

1. **"छिटो" परिनियोजनको लागि मान्यता छोड्नु**
2. **पर्याप्त अनुमति जाँच नगर्नु** परिनियोजन अघि
3. **कोटा सीमाहरू बेवास्ता गर्नु** जबसम्म परिनियोजन असफल हुँदैन
4. **CI/CD पाइपलाइनहरूमा टेम्प्लेटहरू मान्यता नगर्नु**
5. **उत्पादन वातावरणहरूको लागि सुरक्षा मान्यता छुटाउनु**
6. **अपर्याप्त लागत अनुमान** जसले बजेटमा आश्चर्य ल्याउँछ

---

**प्रो टिप**: प्रि-फ्लाइट जाँचहरू आफ्नो CI/CD पाइपलाइनमा वास्तविक परिनियोजन कार्य अघि छुट्टै कामको रूपमा चलाउनुहोस्। यसले समस्याहरू चाँडै पत्ता लगाउन मद्दत गर्दछ र विकासकर्ताहरूलाई छिटो प्रतिक्रिया प्रदान गर्दछ।
