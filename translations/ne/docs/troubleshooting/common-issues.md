...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:28:30+00:00",
...
यो विस्तृत समस्या समाधान मार्गदर्शकले Azure Developer CLI प्रयोग गर्दा प्रायः देखिने समस्याहरूलाई समेट्छ। प्रमाणीकरण, डिप्लोयमेन्ट, पूर्वाधार प्रावधान, र एप्लिकेशन कन्फिगरेसनसँग सम्बन्धित सामान्य समस्याहरूलाई निदान, समाधान, र समाधान गर्न सिक्नुहोस्। प्रत्येक समस्यामा विस्तृत लक्षणहरू, मूल कारणहरू, र चरणबद्ध समाधान प्रक्रियाहरू समावेश छन्।

## सिक्ने लक्ष्यहरू

यो मार्गदर्शक पूरा गरेर, तपाईं:
...
- Azure Developer CLI समस्याहरूलाई बिल्ट-इन निदान उपकरणहरू प्रयोग गरेर निदान गर्न
- प्रमाणीकरण, सदस्यता, र अनुमति सम्बन्धित समस्याहरू स्वतन्त्र रूपमा समाधान गर्न
- डिप्लोयमेन्ट असफलता र पूर्वाधार प्रावधान त्रुटिहरू प्रभावकारी रूपमा समाधान गर्न
- एप्लिकेशन कन्फिगरेसन समस्याहरू र वातावरण-विशिष्ट समस्याहरू डिबग गर्न
- सम्भावित समस्याहरूलाई सक्रिय रूपमा पहिचान गर्न निगरानी र अलर्टिङ कार्यान्वयन गर्न
- लगिङ, डिबगिङ, र समस्या समाधान कार्यप्रवाहहरूको लागि उत्कृष्ट अभ्यासहरू लागू गर्न
...
### समस्या: कोटा नाघेको त्रुटिहरू
**लक्षणहरू:**
- "स्रोत प्रकारको लागि कोटा नाघेको"
- "स्रोतहरूको अधिकतम संख्या पुगेको"
...
### समस्या: Bicep टेम्प्लेट त्रुटिहरू
**लक्षणहरू:**
- टेम्प्लेट मान्यता असफल
...
**लक्षणहरू:**
- डिप्लोयमेन्टको क्रममा एप्लिकेशन निर्माण असफल
...
**लक्षणहरू:**
- एप्लिकेशन डाटाबेससँग जडान गर्न सक्दैन
...
**लक्षणहरू:**
- एप्लिकेशन कन्फिगरेसन मानहरू पढ्न सक्दैन
...
### समस्या: एप्लिकेशन प्रदर्शन समस्याहरू
**लक्षणहरू:**
...
सहयोग सम्पर्क गर्नु अघि, निम्न संकलन गर्नुहोस्:
- `azd version` आउटपुट
- `azd info` आउटपुट
- त्रुटि सन्देशहरू (पूर्ण पाठ)
- समस्या पुन: उत्पादन गर्ने चरणहरू
- वातावरण विवरण (`azd env show`)
...
- [डिबगिङ मार्गदर्शक](debugging.md) - उन्नत डिबगिङ प्रविधिहरू
- [स्रोत प्रावधान](../deployment/provisioning.md) - पूर्वाधार समस्या समाधान
...
**सुझाव**: यो मार्गदर्शकलाई बुकमार्क गर्नुहोस् र जब तपाईं समस्याहरू सामना गर्नुहुन्छ तब यसलाई सन्दर्भ गर्नुहोस्। अधिकांश समस्याहरू पहिले देखिएका छन् र स्थापित समाधानहरू छन्!

---

**नेभिगेसन**
- **अघिल्लो पाठ**: [स्रोत प्रावधान](../deployment/provisioning.md)
- **अर्को पाठ**: [डिबगिङ मार्गदर्शक](debugging.md)
