...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:09:00+00:00",
  "source_file": "docs/getting-started/installation.md",
  "language_code": "ne"
}
-->
# स्थापना र सेटअप मार्गदर्शन

## परिचय

यो विस्तृत मार्गदर्शनले तपाईंलाई Azure Developer CLI (azd) लाई तपाईंको प्रणालीमा स्थापना र कन्फिगर गर्न सिकाउनेछ। तपाईं विभिन्न अपरेटिङ प्रणालीहरूको लागि स्थापना विधिहरू, प्रमाणीकरण सेटअप, र Azure डिप्लोयमेन्टको लागि तपाईंको विकास वातावरण तयार गर्न प्रारम्भिक कन्फिगरेसन सिक्नुहुनेछ।

## सिक्ने लक्ष्यहरू

यस पाठको अन्त्यसम्म, तपाईं:
- तपाईंको अपरेटिङ प्रणालीमा Azure Developer CLI सफलतापूर्वक स्थापना गर्नुहुनेछ
- Azure सँग विभिन्न विधिहरू प्रयोग गरेर प्रमाणीकरण कन्फिगर गर्नुहुनेछ
- आवश्यक पूर्वाधारहरूसहित तपाईंको विकास वातावरण सेटअप गर्नुहुनेछ
...
यो मार्गदर्शनले तपाईंलाई तपाईंको अपरेटिङ प्रणाली वा विकास वातावरणको परवाह नगरी Azure Developer CLI स्थापना र कन्फिगर गर्न मद्दत गर्नेछ।
...
1. [GitHub](https://github.com/Azure/azure-dev/releases) बाट पछिल्लो संस्करण डाउनलोड गर्नुहोस्
...
2. **तपाईंको पहिलो डिप्लोयमेन्ट प्रयास गर्नुहोस्**: [पहिलो परियोजना मार्गदर्शन](first-project.md) अनुसरण गर्नुहोस्
...
- [औपचारिक दस्तावेज](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)
...
**नेभिगेसन**
- **अघिल्लो पाठ**: [AZD आधारभूत](azd-basics.md)
- **अर्को पाठ**: [कन्फिगरेसन](configuration.md)
