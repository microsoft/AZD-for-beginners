...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T13:04:51+00:00",
...
यो विस्तृत गाइडले Azure Developer CLI को कन्फिगरेसनका सबै पक्षहरू समेट्छ, जसले विकास र डिप्लोयमेन्ट वर्कफ्लोहरूलाई प्रभावकारी बनाउँछ। तपाईं कन्फिगरेसनको पदानुक्रम, वातावरण व्यवस्थापन, प्रमाणीकरण विधिहरू, र जटिल Azure डिप्लोयमेन्टहरूका लागि उन्नत कन्फिगरेसन ढाँचाहरू सिक्नुहुनेछ।
...
- विकास वर्कफ्लोहरूका लागि azd कन्फिगर गर्न
- धेरै डिप्लोयमेन्ट वातावरणहरू सेटअप र व्यवस्थापन गर्न
- सुरक्षित कन्फिगरेसन व्यवस्थापन अभ्यासहरू कार्यान्वयन गर्न
- कन्फिगरेसनसँग सम्बन्धित समस्याहरू समाधान गर्न
- विशिष्ट संस्थागत आवश्यकताहरूका लागि azd को व्यवहार अनुकूलन गर्न

यो विस्तृत गाइडले Azure Developer CLI को कन्फिगरेसनका सबै पक्षहरू समेट्छ, जसले विकास र डिप्लोयमेन्ट वर्कफ्लोहरूलाई प्रभावकारी बनाउँछ।
...
### 1. Environment Variables प्रयोग गर्नुहोस्
```yaml
...
### 4. कन्फिगरेसन डकुमेन्टेसन
तपाईंको कन्फिगरेसन `CONFIG.md` मा डकुमेन्ट गर्नुहोस्:
```markdown
# Configuration Guide
...
- [डिप्लोयमेन्ट गाइड](../deployment/deployment-guide.md) - डिप्लोयमेन्टका लागि कन्फिगरेसन प्रयोग गर्नुहोस्
- [स्रोतहरू प्रावधान गर्नुहोस्](../deployment/provisioning.md) - उत्पादन-तयार कन्फिगरेसनहरू

## सन्दर्भहरू

- [azd कन्फिगरेसन सन्दर्भ](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/reference)
- [azure.yaml स्किमा](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/reference/azure-yaml-schema)
