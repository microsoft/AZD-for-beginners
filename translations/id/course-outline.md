# AZD Untuk Pemula: Kerangka Kursus & Pembelajaran
...
- **Waktu Fleksibel**: Selesaikan bab-bab sesuai kecepatan Anda sendiri dalam beberapa hari atau minggu
- **Sistem Checkpoint**: Validasi pembelajaran sebelum melanjutkan ke topik yang lebih kompleks
- **Perpustakaan Sumber Daya**: Dokumentasi lengkap, contoh, dan panduan pemecahan masalah
- **Pengembangan Portofolio**: Bangun proyek yang dapat diterapkan untuk portofolio profesional
...
- **Hari 1**: Dasar + Pengembangan AI (Bab 1-2) - 6 jam
- **Hari 2**: Konfigurasi + Infrastruktur (Bab 3-4) - 6 jam  
- **Hari 3**: Pola Lanjutan + Produksi (Bab 5-8) - 8 jam
- **Tindak Lanjut**: Mentorship opsional selama 2 minggu untuk penyelesaian proyek
...
#### 🛠️ Metodologi Pembelajaran Workshop
**Pendekatan Discovery → Deployment → Customization untuk pengembangan keterampilan langsung**

**Fase 1: Discovery (45 menit)**
- **Eksplorasi Template**: Evaluasi template dan layanan Azure AI Foundry
- **Analisis Arsitektur**: Memahami pola multi-agent dan strategi penerapan
- **Penilaian Kebutuhan**: Mengidentifikasi kebutuhan dan kendala organisasi
- **Pengaturan Lingkungan**: Konfigurasi lingkungan pengembangan dan sumber daya Azure
...
- **Kepemimpinan Proyek**: Memimpin tim teknis dalam inisiatif penerapan cloud
- **Desain Arsitektur**: Merancang solusi Azure yang skalabel dan hemat biaya
- **Transfer Pengetahuan**: Melatih dan membimbing rekan kerja dalam praktik terbaik AZD
...
**Untuk Peserta:**
- **Lingkungan Workshop Interaktif**: [Materi Workshop](workshop/README.md) - Platform pembelajaran berbasis browser
- **Instruksi Langkah-demi-Langkah**: [Latihan Terpandu](../../workshop/docs/instructions) - Panduan implementasi terperinci  
- **Dokumentasi Referensi**: [Lab Workshop AI](docs/ai-foundry/ai-workshop-lab.md) - Pendalaman fokus AI
- **Sumber Daya Komunitas**: Saluran Discord Azure, diskusi GitHub, dan dukungan ahli
...
- **Desain Workshop Khusus**: Konten yang disesuaikan untuk kebutuhan organisasi tertentu
- **Manajemen Program Percontohan**: Peluncuran terstruktur dengan metrik keberhasilan dan umpan balik  
- **Mentorship Berkelanjutan**: Dukungan pasca-workshop untuk implementasi proyek
...
### Bab 1: Dasar & Quick Start (30-45 menit) 🌱
...
#### Jalur Pembelajaran Workshop (Peningkatan Opsional)
**Pengalaman Interaktif BARU**: [Panduan Workshop Lengkap](workshop/README.md)
1. **Discovery** (30 menit): Pemilihan dan evaluasi template
2. **Deployment** (45 menit): Menerapkan dan memvalidasi fungsi template AI  
3. **Deconstruction** (30 menit): Memahami arsitektur dan komponen template
4. **Configuration** (30 menit): Menyesuaikan pengaturan dan parameter
5. **Customization** (45 menit): Memodifikasi dan iterasi untuk membuatnya sesuai kebutuhan Anda
6. **Teardown** (15 menit): Membersihkan sumber daya dan memahami siklus hidup
7. **Wrap-up** (15 menit): Langkah berikutnya dan jalur pembelajaran lanjutan
...
### Bab 4: Infrastruktur sebagai Kode & Penerapan (1-1.5 jam) 🏗️
...
### Bab 5: Solusi AI Multi-Agent (2-3 jam) 🤖🤖
...
### Bab 6: Validasi Pra-Penerapan & Perencanaan (1 jam) 🔍
...
3. **Bab 4**: Infrastruktur sebagai Kode & Penerapan (1,5 jam)
4. **Bab 6**: Validasi & Perencanaan Pra-Penerapan (1 jam)
...
- ✅ Mengelola penerapan multi-lingkungan
...
### Tingkat Dasar (Bab 1-2)
Setelah menyelesaikan bab dasar, peserta akan menunjukkan:
...
**Keterampilan Profesional:**
- Mengikuti alur kerja penerapan terstruktur untuk hasil yang konsisten
- Memecahkan masalah penerapan dasar menggunakan log dan dokumentasi
- Berkomunikasi secara efektif tentang proses penerapan cloud
- Menerapkan praktik terbaik untuk integrasi layanan AI yang aman
...
Setelah menyelesaikan bab menengah, peserta akan menunjukkan:

**Kemampuan Teknis:**
- Mengelola penerapan multi-lingkungan (dev, staging, produksi)
- Membuat template Bicep kustom untuk infrastruktur sebagai kode
- Menerapkan pola autentikasi yang aman dengan identitas terkelola
- Menerapkan aplikasi multi-layanan yang kompleks dengan konfigurasi kustom
- Mengoptimalkan strategi provisioning sumber daya untuk biaya dan kinerja

**Keterampilan Profesional:**
- Merancang arsitektur infrastruktur yang skalabel
- Menerapkan praktik terbaik keamanan untuk penerapan cloud
- Mendokumentasikan pola infrastruktur untuk kolaborasi tim
- Mengevaluasi dan memilih layanan Azure yang sesuai dengan kebutuhan

**Verifikasi Pembelajaran:**
- ✅ Mengonfigurasi lingkungan terpisah dengan pengaturan spesifik lingkungan
- ✅ Membuat dan menerapkan template Bicep kustom untuk aplikasi multi-layanan
- ✅ Menerapkan autentikasi identitas terkelola untuk akses yang aman
- ✅ Menyelesaikan latihan manajemen konfigurasi dengan skenario nyata

### Tingkat Lanjutan (Bab 5-6)
Setelah menyelesaikan bab lanjutan, peserta akan menunjukkan:
...
**Keterampilan Profesional:**
- Merancang solusi AI yang kompleks untuk lingkungan produksi
- Memimpin diskusi teknis tentang strategi penerapan AI
- Membimbing pengembang junior dalam praktik terbaik penerapan AZD dan AI
- Mengevaluasi dan merekomendasikan pola arsitektur AI untuk kebutuhan bisnis
...
**Kemampuan Teknis:**
- Mendiagnosis dan menyelesaikan masalah penerapan yang kompleks secara mandiri
- Menerapkan pola keamanan tingkat perusahaan dan kerangka kerja tata kelola
- Merancang strategi pemantauan dan peringatan yang komprehensif
- Mengoptimalkan penerapan produksi untuk skala, biaya, dan kinerja
- Membangun pipeline CI/CD dengan pengujian dan validasi yang tepat
...
**Verifikasi Pembelajaran:**
- ✅ Menyelesaikan kegagalan penerapan multi-layanan yang kompleks
- ✅ Menerapkan pola keamanan perusahaan dengan persyaratan kepatuhan
- ✅ Merancang dan menerapkan pemantauan produksi dengan Application Insights
- ✅ Menyelesaikan implementasi kerangka kerja tata kelola perusahaan
...
Setelah menyelesaikan semua bab dengan verifikasi, lulusan akan memiliki:
...
- **Dokumentasi**: Panduan penerapan dan prosedur pemecahan masalah yang komprehensif  
- **Kontribusi Komunitas**: Diskusi, contoh, dan perbaikan yang dibagikan dengan komunitas Azure
- **Jaringan Profesional**: Koneksi dengan pakar Azure dan praktisi penerapan AI
