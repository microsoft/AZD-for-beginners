...
- **⚙️ Setup**: [Instalasi & Setup](docs/getting-started/installation.md) - Panduan spesifik platform
...
**📊 Waktu Investasi:** 30-45 menit  
**📈 Tingkat Keahlian Setelah:** Dapat menerapkan aplikasi dasar secara mandiri
...
- **📖 Pola**: [Penerapan Model AI](docs/microsoft-foundry/ai-model-deployment.md) - Terapkan dan kelola model AI
- **🛠️ Workshop**: [Lab Workshop AI](docs/microsoft-foundry/ai-workshop-lab.md) - Siapkan solusi AI Anda agar siap AZD
...
**📊 Waktu Investasi:** 1-2 jam  
**📈 Tingkat Keahlian Setelah:** Dapat menerapkan dan mengonfigurasi aplikasi AI siap produksi  
...
- Azure OpenAI (PTU untuk performa konsisten): $3,000+/bulan ATAU Bayar sesuai pemakaian dengan volume tinggi
...
#### Sumber Belajar
- **📖 Konfigurasi**: [Panduan Konfigurasi](docs/getting-started/configuration.md) - Setup lingkungan
...
**💡 Hasil Bab**: Terapkan aplikasi multi-layanan kompleks menggunakan template infrastruktur kustom
...
- **🛠️ ARM Templates**: [Paket Template ARM](../../examples/retail-multiagent-arm-template) - Deploy dengan satu klik
...
**💡 Hasil Bab**: Mendeploy dan mengelola solusi AI multi-agen siap produksi dengan agen Pelanggan dan Inventaris

---

### 🔍 Bab 6: Validasi & Perencanaan Pra-Deploy
...
- **💰 Pemilihan**: [Pemilihan SKU](docs/pre-deployment/sku-selection.md) - Pilihan hemat biaya
...
- Terapkan pemeriksaan pra-deploy otomatis
...
**💡 Hasil Bab**: Mendiagnosa dan menyelesaikan masalah deployment umum secara mandiri
...
#### Latihan Praktis
- Terapkan pola keamanan enterprise
...
- **🛠️ Lab Workshop AI**: [Lab Workshop AI](docs/microsoft-foundry/ai-workshop-lab.md) - Latihan fokus AI
...
Azure Developer CLI (azd) adalah antarmuka baris perintah yang berfokus pada pengembang yang mempercepat proses membangun dan mendeploy aplikasi ke Azure. Ini menyediakan:

- **Deployment berbasis template** - Gunakan template siap pakai untuk pola aplikasi umum
- **Infrastruktur sebagai Kode** - Kelola sumber daya Azure menggunakan Bicep atau Terraform  
- **Alur kerja terintegrasi** - Provisi, deploy, dan pantau aplikasi secara mulus
...
- **Optimasi Biaya** - Alokasi sumber daya dan strategi penskalaan cerdas untuk beban kerja AI
...
**Mulai di sini jika Anda mendeploy aplikasi AI!**

> **Catatan:** Template ini menunjukkan berbagai pola AI. Beberapa adalah Azure Samples eksternal, lainnya implementasi lokal.
...
- [**Solusi Multi-Agen Retail**](examples/retail-scenario.md) - Implementasi lengkap siap produksi dengan template ARM
  ...
  - Deploy satu klik via template ARM
...
- [Aplikasi Container - Python Flask](https://github.com/Azure-Samples/container-apps-store-api-microservice) - Deployment REST API
...
- [Microservices Java](https://github.com/Azure-Samples/java-microservices-aca-lab) - Arsitektur multi-layanan
...
- [**Galeri Template AZD Resmi**](https://azure.github.io/awesome-azd/) - Koleksi template resmi dan komunitas yang dikurasi
...
### Referensi Cepat
- [**Command Cheat Sheet**](resources/cheat-sheet.md) - Perintah azd penting yang diatur berdasarkan bab
...
- [**Study Guide**](resources/study-guide.md) - Latihan praktik komprehensif

### Hands-On Workshops
- [**AI Workshop Lab**](docs/microsoft-foundry/ai-workshop-lab.md) - Buat solusi AI Anda dapat dideploy dengan AZD (2-3 jam)
- [**Interactive Workshop Guide**](workshop/README.md) - Workshop berbasis browser dengan MkDocs dan Lingkungan DevContainer
...
Tim kami memproduksi kursus pembelajaran komprehensif lainnya:
