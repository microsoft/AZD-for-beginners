...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T07:51:55+00:00",
...
- **Optimasi untuk Produksi**: Keamanan, penskalaan, pemantauan, dan manajemen biaya
- **Membangun Solusi Multi-Agen**: Menerapkan arsitektur AI yang kompleks

## 📚 Bab Pembelajaran

*Pilih jalur belajar Anda berdasarkan tingkat pengalaman dan tujuan*
...
#### Latihan Praktis
- Mengonfigurasi beberapa lingkungan (dev, staging, prod)
...
- **📝 Contoh**: [Contoh Aplikasi Kontainer](../../examples/container-app) - Penerapan kontainerisasi
...
- **🤖 Masalah AI**: [Pemecahan Masalah AI](docs/troubleshooting/ai-troubleshooting.md) - Masalah layanan AI
...
#### Sumber Belajar
- **🏭 Produksi**: [Praktik Terbaik AI Produksi](docs/ai-foundry/production-ai-practices.md) - Pola perusahaan
...
- Lakukan deployment ke produksi dengan tata kelola yang tepat

**💡 Hasil Bab**: Mendeploy aplikasi siap produksi dengan kemampuan tingkat perusahaan

---

## 📖 Apa itu Azure Developer CLI?

Azure Developer CLI (azd) adalah antarmuka baris perintah yang berfokus pada pengembang untuk mempercepat proses pembangunan dan deployment aplikasi ke Azure. Fitur yang disediakan:

- **Deployment berbasis template** - Gunakan template yang sudah dibuat untuk pola aplikasi umum
...
### **AZD + Azure AI Foundry: Solusi Ideal untuk Deployment AI**
...
- **Deployment AI yang Aman** - Pola keamanan bawaan untuk layanan AI, kunci API, dan endpoint model  
- **Pola AI Produksi** - Praktik terbaik untuk deployment aplikasi AI yang skalabel dan hemat biaya
- **Alur Kerja AI End-to-End** - Dari pengembangan model hingga deployment produksi dengan pemantauan yang tepat
...
**Mulai di sini jika Anda ingin mendeploy aplikasi AI!**
...
- [Aplikasi Web Sederhana](../../examples/simple-web-app) - Pola deployment dasar
- [Situs Statis](../../examples/static-site) - Deployment konten statis
- [API Dasar](../../examples/basic-api) - Deployment REST API

#### Integrasi Database (Bab 3-4)  
- [Aplikasi Database](../../examples/database-app) - Pola konektivitas database
- [Pemrosesan Data](../../examples/data-processing) - Deployment alur kerja ETL

#### Pola Lanjutan (Bab 4-8)
- [Aplikasi Container](../../examples/container-app) - Deployment terkontainerisasi
- [Mikroservices](../../examples/microservices) - Arsitektur multi-layanan  
- [Solusi Perusahaan](../../examples/enterprise) - Pola siap produksi

### Koleksi Template Eksternal
- [**Azure-Samples AZD Templates**](https://github.com/Azure-Samples/azd-templates) - Contoh resmi dari Microsoft
- [**Awesome AZD Gallery**](https://azure.github.io/awesome-azd/) - Template kontribusi komunitas
- [**Direktori Contoh**](examples/README.md) - Contoh pembelajaran lokal dengan penjelasan rinci

---

## 📚 Sumber Daya & Referensi Pembelajaran
...
- [**Panduan Studi**](resources/study-guide.md) - Latihan praktis yang komprehensif

### Workshop Praktis
- [**Lab Workshop AI**](docs/ai-foundry/ai-workshop-lab.md) - Jadikan solusi AI Anda dapat dideploy dengan AZD
- [**Workshop AZD untuk Pemula**](workshop/README.md) - Materi workshop praktis lengkap
...
- [ ] **Bab 4**: Infrastructure as Code & Deployment ✅
...
1. **Latihan Praktis**: Selesaikan deployment hands-on bab tersebut
...
- **Keterampilan Profesional**: Kemampuan deployment tingkat perusahaan  
...
- **Bantuan Khusus AI**: Bergabunglah di [#Azure channel](https://discord.gg/microsoft-azure) untuk diskusi AZD + AI Foundry
...
**Hasil Polling Terbaru dari #Azure Channel:**
...
**Langkah Berikutnya**: [Mulai Bab 1 - Dasar-dasar AZD](docs/getting-started/azd-basics.md) →
