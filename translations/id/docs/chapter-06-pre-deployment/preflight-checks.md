...
function Test-Permissions {
    ...
    try {
        ...
        # Uji pembuatan grup sumber daya (jika ditentukan)
        if ($ResourceGroup) {
            ...
            if ($rgExists -eq "true") {
                ...
                # Uji kemampuan untuk membuat grup sumber daya
                try {
...
function Test-QuotasAndLimits {
    ...
    try {
        ...
        # Periksa batas akun penyimpanan
...
function Test-TemplateValidation {
    ...
    # Periksa keberadaan file infrastruktur
    if (Test-Path "infra") {
        $bicepFiles = Get-ChildItem -Path "infra" -Filter "*.bicep" -Recurse
        if ($bicepFiles.Count -gt 0) {
            Write-Status "Infrastructure templates" "Success" "$($bicepFiles.Count) Bicep files found"
            
            # Validasi main.bicep jika ada
...
function Test-RegionalAvailability {
    ...
    try {
        ...
        # Periksa ketersediaan layanan di wilayah
...
function Test-SecurityCompliance {
    ...
    # Periksa praktik keamanan umum
    try {
        # Periksa apakah Key Vault dikonfigurasi
...
validate_dev_environment() {
    ...
    # Periksa konfigurasi pematian otomatis
...
validate_prod_environment() {
    ...
    # Validasi pengaturan pemantauan
...
def check_storage_limits(location: str) -> bool:
    ...
    # Dapatkan akun penyimpanan dalam langganan
    ...
    max_accounts = 250  # Batas default Azure
...
```bash
#!/bin/bash
# Validasi keamanan dan kepatuhan untuk penyebaran AZD
...
check_security_practices() {
    ...
    # Periksa pembatasan akses publik
    ...
    # Periksa grup keamanan jaringan
...
check_compliance_requirements() {
    ...
    # Periksa kebijakan cadangan dan retensi
