...
![Pick](../../../../../translated_images/01-pick-template.60d2d5fff5ebc374d04f05f556f505a3800b2b5fb08e03153b1b878939b49da6.ml.png)
...
![Arch](../../../../../translated_images/architecture.8cec470ec15c65c743dcc1aa383d2500be4d6a9270693b8bfeb3d8deca4a22e1.ml.png)
...
1. നിങ്ങളുടെ Azure പോർട്ടലിൽ ആ എൻവയോൺമെന്റ് നാമത്തോടുകൂടിയ ഒരു പ്രൊവിഷൻ ചെയ്ത റിസോഴ്‌സ് ഗ്രൂപ്പ് ഉണ്ടാകും:
      ...
      ![Infra](../../../../../translated_images/02-provisioned-infra.46c706b14f56e0bf36cb90ba441d16690ce10a00d42990bb9441126ceff08990.ml.png)
...
1. നിങ്ങൾക്ക് ഇതുപോലുള്ള ഒരു ഹോസ്റ്റഡ് ആപ്ലിക്കേഷൻ ഫ്രണ്ട്-എൻഡ് UI കാണാൻ കഴിയും:
   ...
   ![App](../../../../../translated_images/03-test-application.471910da12c3038e4a3c20e98ebf080abb227e122699ef7b7a262b87af6f98c3.ml.png)
...
1. നിങ്ങൾക്ക് താഴെ കാണിച്ചിരിക്കുന്നതുപോലുള്ള ഉത്തരങ്ങൾ ലഭിക്കും. _എന്നാൽ ഇത് എങ്ങനെ പ്രവർത്തിക്കുന്നു?_ 
      ...
      ![App](../../../../../translated_images/03-test-question.521c1e863cbaddb604172e95d704407b4b6304c0e04d9130e51b7994f951b026.ml.png)
...
1. നിങ്ങൾക്ക് ഇത് കാണാൻ കഴിയും. `Go to Azure AI Foundry Portal` ബട്ടൺ ക്ലിക്ക് ചെയ്യുക. 
   ![Foundry](../../../../../translated_images/04-view-foundry-project.fb94ca41803f28f3a7baa67099e11360380dc7f17bfb0583689cf34419b80498.ml.png)

1. നിങ്ങളുടെ AI ആപ്ലിക്കേഷനായി Foundry Project പേജ് കാണാൻ കഴിയും
   ![Project](../../../../../translated_images/05-visit-foundry-portal.d734e98135892d7e96324cebee01acfa6c339706b2d5e50ede4682beb5d431d9.ml.png)

1. `Agents` ക്ലിക്ക് ചെയ്യുക - നിങ്ങളുടെ പ്രോജക്റ്റിൽ പ്രൊവിഷൻ ചെയ്ത ഡിഫോൾട്ട് ഏജന്റ് കാണാം
   ![Agents](../../../../../translated_images/06-visit-agents.bccb263f77b00a0917878ae22b420c3b0df0ade50c0df8e20e6e45d49a220514.ml.png)
...
1. ഇത് തിരഞ്ഞെടുക്കുക - നിങ്ങൾക്ക് ഏജന്റ് വിശദാംശങ്ങൾ കാണാൻ കഴിയും. താഴെ പറയുന്നവ ശ്രദ്ധിക്കുക:
      ...
      ![Agents](../../../../../translated_images/07-view-agent-details.0e049f37f61eae6292faf47da2651994dab9ac9cf06c20e7c996c54dbca02245.ml.png)
...
1. ഇടത് മെനുവിലെ `Data+indexes` ഓപ്ഷൻ നോക്കി വിശദാംശങ്ങൾക്കായി ക്ലിക്ക് ചെയ്യുക. 
      ...
      ![Data](../../../../../translated_images/08-visit-data-indexes.5a4cc1686fa0d19a49625f0d4956f3b22681ae275a62c35516dabf1eb9d49a89.ml.png)
...
![Data](../../../../../translated_images/09-ask-in-aca.4102297fc465a4d5617af2a71501c3b7607d198df9e598f84abacc32423c17b9.ml.png)
...
1. അതേ ചോദ്യമുയർത്തുക: `What products does Amanda Perez own?`
    ...
    ![Data](../../../../../translated_images/09-ask-in-playground.a1b93794f78fa676c13e7b81dd60bc8589c742cf1069dc4589acf36ac050298d.ml.png)
...
1. പ്രതികരണ സുരക്ഷാ നിലവാരത്തിനുള്ള നിങ്ങളുടെ ധാരണയുമായി വിലയിരുത്തിയ റേറ്റിംഗ് പൊരുത്തപ്പെടുന്നുണ്ടോ?
      ...
      ![Data](../../../../../translated_images/10-view-run-info-meter.6cdb89a0eea5531fced8249c58037ab5fb939478145db95b840a6aab8b21d85e.ml.png)
...
1. `View Run Info` ബട്ടൺ ക്ലിക്ക് ചെയ്യുക - നിങ്ങൾക്ക് ഈ കാഴ്ച ലഭിക്കും. ഇത് [Agent tracing](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/develop/trace-agents-sdk#view-trace-results-in-the-azure-ai-foundry-agents-playground) പ്രവർത്തനത്തിൽ ഒരു ഉദാഹരണമാണ്. _ഈ കാഴ്ച ടോപ്പ്-ലെവൽ മെനുവിലെ Thread Logs ക്ലിക്ക് ചെയ്യുന്നതിലൂടെ ലഭിക്കാം_.
   ...
   - latency മനസ്സിലാക്കുക, എക്സിക്യൂഷനിൽ എവിടെ സമയം ചെലവഴിക്കുന്നു
      ...
      ![Agent](../../../../../translated_images/10-view-run-info.b20ebd75fef6a1cc01382282300bc7d4afe4aa289de08bc97d1e097d7dc4b77d.ml.png)
...
1. `Metadata` ടാബ് ക്ലിക്ക് ചെയ്ത് റൺക്കുള്ള അധിക ആട്രിബ്യൂട്ടുകൾ കാണുക, ഇത് പിന്നീട് പ്രശ്നങ്ങൾ ഡീബഗ് ചെയ്യുന്നതിനുള്ള ഉപകാരപ്രദമായ സാഹചര്യങ്ങൾ നൽകാം.   
      ...
      ![Agent](../../../../../translated_images/11-view-run-info-metadata.7966986122c7c2dfef2df06e56db549f922c09658b51496fac040106de75e2b9.ml.png)
...
1. `Evaluations` ടാബ് ക്ലിക്ക് ചെയ്ത് ഏജന്റിന്റെ പ്രതികരണത്തിൽ സ്വയം-മൂല്യനിർണ്ണയം കാണുക. ഇതിൽ സുരക്ഷാ മൂല്യനിർണ്ണയം (ഉദാ., Self-harm) ഉൾപ്പെടുന്നു, ഏജന്റ്-സ്പെസിഫിക് മൂല്യനിർണ്ണയം (ഉദാ., Intent resolution, Task adherence).
      ...
      ![Agent](../../../../../translated_images/12-view-run-info-evaluations.ef25e4577d70efeb777dfadf51fed1694661fa370dd5a4e5fea4aec8de234568.ml.png)
...
1. അവസാനമായി, സൈഡ്ബാർ മെനുവിലെ `Monitoring` ടാബ് ക്ലിക്ക് ചെയ്യുക.
      ...
      ![Agent](../../../../../translated_images/13-monitoring-resources.5148015f7311807f774aaa6a45b7156969ce1b1861d1c34d191c98b61d6d8b84.ml.png)
