...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T16:43:09+00:00",
...
このチュートリアルを完了することで以下を習得できます：
- テンプレートを使用したazdプロジェクト初期化ワークフローのマスター
...
### 必要条件チェックリスト
- ✅ Azure Developer CLIがインストール済み（[インストールガイド](installation.md)）
- ✅ Azure CLIがインストール済みで認証済み
- ✅ Gitがシステムにインストール済み
...
### アプリケーションにアクセス
デプロイ出力で提供されたURLをクリックするか、いつでも以下を使用して取得できます：
```bash
