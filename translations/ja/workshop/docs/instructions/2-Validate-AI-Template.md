...
![Pick](../../../../../translated_images/ja/01-pick-template.60d2d5fff5ebc374.png)
...
![Arch](../../../../../translated_images/ja/architecture.8cec470ec15c65c7.png)
...
1. Azureポータルには、環境名を持つプロビジョニングされたリソースグループが表示されます:
      ...
      ![Infra](../../../../../translated_images/ja/02-provisioned-infra.46c706b14f56e0bf.png)
...
1. 以下のようなホストされたアプリケーションのフロントエンドUIが表示されるはずです:
   ...
   ![App](../../../../../translated_images/ja/03-test-application.471910da12c3038e.png)
...
1. 以下のような回答が得られるはずです。_でも、これがどう動作しているのでしょうか？_
      ...
      ![App](../../../../../translated_images/ja/03-test-question.521c1e863cbaddb6.png)
...
1. 以下の画面が表示されます。`Go to Azure AI Foundry Portal`ボタンをクリックしてください。
   ![Foundry](../../../../../translated_images/ja/04-view-foundry-project.fb94ca41803f28f3.png)

1. AIアプリケーション用のFoundryプロジェクトページが表示されます。
   ![Project](../../../../../translated_images/ja/05-visit-foundry-portal.d734e98135892d7e.png)

1. `Agents`をクリックすると、プロジェクト内でプロビジョニングされたデフォルトのエージェントが表示されます。
   ![Agents](../../../../../translated_images/ja/06-visit-agents.bccb263f77b00a09.png)
...
1. それを選択すると、エージェントの詳細が表示されます。以下を確認してください:
      ...
      ![Agents](../../../../../translated_images/ja/07-view-agent-details.0e049f37f61eae62.png)
...
1. 左側のメニューで`Data+indexes`オプションを探し、詳細をクリックしてください。
      ...
      ![Data](../../../../../translated_images/ja/08-visit-data-indexes.5a4cc1686fa0d19a.png)
...
![Data](../../../../../translated_images/ja/09-ask-in-aca.4102297fc465a4d5.png)
...
1. 同じ質問をしてください: `What products does Amanda Perez own?`
    ...
    ![Data](../../../../../translated_images/ja/09-ask-in-playground.a1b93794f78fa676.png)
...
1. 評価された安全性のレベルが回答の安全性に対する直感と一致しているか確認してください。
      ...
      ![Data](../../../../../translated_images/ja/10-view-run-info-meter.6cdb89a0eea5531f.png)
...
1. `View Run Info`ボタンをクリックすると、以下のビューが表示されます。これは[エージェントトレーシング](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/develop/trace-agents-sdk#view-trace-results-in-the-azure-ai-foundry-agents-playground)の例です。_トップレベルメニューのThread Logsをクリックしてもこのビューを取得できます_。
   ...
   - 実行中に時間が費やされた場所とレイテンシを理解します。
      ...
      ![Agent](../../../../../translated_images/ja/10-view-run-info.b20ebd75fef6a1cc.png)

1. `Metadata`タブをクリックすると、後で問題をデバッグする際に役立つコンテキストを提供する実行の追加属性が表示されます。

      ![Agent](../../../../../translated_images/ja/11-view-run-info-metadata.7966986122c7c2df.png)

1. `Evaluations`タブをクリックすると、エージェントの回答に対して行われた自動評価が表示されます。これには安全性評価（例: 自傷行為）やエージェント固有の評価（例: 意図解決、タスク遵守）が含まれます。

      ![Agent](../../../../../translated_images/ja/12-view-run-info-evaluations.ef25e4577d70efeb.png)
...
1. 最後に、サイドバーメニューの`Monitoring`タブをクリックしてください。
      ...
      ![Agent](../../../../../translated_images/ja/13-monitoring-resources.5148015f7311807f.png)
