...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T14:24:57+00:00",
  "source_file": "README.md",
  "language_code": "my"
}
-->
# AZD အတွက် စတင်သင်ယူသူများအတွက်: တိကျစွာ ဖွဲ့စည်းထားသော သင်ယူမှု ခရီးစဉ်
...
သင်၏ AZD သင်ယူမှု ခရီးစဉ်ကို စတင်ရန် အောက်ပါအဆင့်များကို လိုက်နာပါ-

1. **Repository ကို Fork လုပ်ပါ**: Click [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
...
4. **သင်ယူမှု လမ်းကြောင်းကို ရွေးချယ်ပါ**: အောက်ပါ အခန်းများထဲမှ သင့်အတွေ့အကြုံနှင့် ကိုက်ညီသည့် အခန်းကို ရွေးချယ်ပါ

### ဘာသာစကား များစွာကို ထောက်ပံ့ခြင်း
...
- ရှုပ်ထွေးသော မျိုးစုံ AI ဝန်ဆောင်မှု ဖွဲ့စည်းမှုများ
...
- AI အထူးတပ်ဆင်မှု ပြဿနာများ ဖြေရှင်းခြင်း
...
- **AI အပလီကေးရှင်းများ တပ်ဆင်ခြင်း**: AZD နှင့် Microsoft Foundry ဝန်ဆောင်မှုများ အသုံးပြုခြင်း
- **Infrastructure as Code ကို အကောင်အထည်ဖော်ခြင်း**: Bicep template များဖြင့် Azure အရင်းအမြစ်များ စီမံခန့်ခွဲခြင်း
- **တပ်ဆင်မှု ပြဿနာများ ဖြေရှင်းခြင်း**: ပုံမှန်ပြဿနာများ ဖြေရှင်းခြင်းနှင့် debug လုပ်ခြင်း
...
*သင့်အတွေ့အကြုံနှင့် ရည်မှန်းချက်အရ သင်ယူမှု လမ်းကြောင်းကို ရွေးချယ်ပါ*
...
- သင့်ပထမဆုံး အောင်မြင်သော တပ်ဆင်မှု
...
**📊 ကြာချိန်**: ၃၀-၄၅ မိနစ်  
**📈 သင်ယူမှု အဆင့်**: အခြေခံ အပလီကေးရှင်းများကို ကိုယ်တိုင် တပ်ဆင်နိုင်ခြင်း
...
- **🛠️ အလုပ်ရုံခန်း**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - သင့် AI ဖြေရှင်းချက်များကို AZD အတွက် အသင့်ပြုလုပ်ခြင်း
- **🎥 အပြန်အလှန် လမ်းညွှန်ချက်**: [Workshop Materials](workshop/README.md) - MkDocs * DevContainer ပတ်ဝန်းကျင်ဖြင့် Browser အခြေပြု သင်ယူမှု
...
# ထပ်မံ AI ပုံစံများကို စမ်းသပ်ပါ
...
azd monitor  # Application Insights တွင် တယ်လီမက်ထရီ ပြသမှုကို စစ်ဆေးပါ
azd down --force --purge
```

**📊 ကြာချိန်**: ၁-၂ နာရီ  
**📈 သင်ယူမှု အဆင့်**: ထုတ်လုပ်မှုအဆင့် AI အပလီကေးရှင်းများ တပ်ဆင်ပြီး ဖွဲ့စည်းနိုင်ခြင်း  
**💰 ကုန်ကျစရိတ် အသိပညာ**: တိုးတက်ရေးအတွက် $80-150/လ၊ ထုတ်လုပ်မှုအတွက် $300-3500/လ ကုန်ကျစရိတ်ကို နားလည်ခြင်း

#### 💰 AI တပ်ဆင်မှုများအတွက် ကုန်ကျစရိတ် စဉ်းစားချက်များ

**တိုးတက်ရေး ပတ်ဝန်းကျင် (ခန့်မှန်း $80-150/လ):**
- Azure OpenAI (Pay-as-you-go): $0-50/လ (token အသုံးပြုမှုအပေါ် မူတည်၍)
- AI Search (အခြေခံ အဆင့်): $75/လ
- Container Apps (စားသုံးမှုအပေါ် မူတည်): $0-20/လ
- Storage (စံချိန်): $1-5/လ

**ထုတ်လုပ်မှု ပတ်ဝန်းကျင် (ခန့်မှန်း $300-3,500+/လ):**
- Azure OpenAI (PTU ဖြင့် တည်ငြိမ်သော စွမ်းဆောင်ရည်): $3,000+/လ သို့မဟုတ် အများအပြား အသုံးပြုမှုဖြင့် Pay-as-go
- AI Search (စံချိန် အဆင့်): $250/လ
- Container Apps (သီးသန့်): $50-100/လ
- Application Insights: $5-50/လ
- Storage (အဆင့်မြင့်): $10-50/လ
...
- ဖွံ့ဖြိုးတိုးတက်မှု မလုပ်သည့်အချိန်တွင် `azd down` ဖြင့် အရင်းအမြစ်များကို ပိတ်ထားပါ
- စားသုံးမှုအပေါ် မူတည်သော ဘီလ်ကို စတင်အသုံးပြုပြီး ထုတ်လုပ်မှုအတွက်သာ PTU သို့ မြှင့်တင်ပါ
- တပ်ဆင်မှုမပြုမီ `azd provision --preview` ဖြင့် ကုန်ကျစရိတ် ခန့်မှန်းပါ
- auto-scaling ကို ဖွင့်ထား၍ အသုံးပြုမှုအတိုင်းသာ ပေးဆောင်ပါ
...
- **🔐 လုံခြုံရေး**: [Authentication patterns and managed identity](docs/getting-started/authsecurity.md) - အတည်ပြုခြင်း ပုံစံများ
...
- managed identity အတည်ပြုခြင်း တပ်ဆင်ပါ
- ပတ်ဝန်းကျင်အလိုက် ဖွဲ့စည်းမှုများ အကောင်အထည်ဖော်ပါ

**💡 အခန်းရလဒ်**: လုံခြုံရေးနှင့် အတည်ပြုခြင်းမှန်ကန်စွာဖြင့် ပတ်ဝန်းကျင် များစွာကို စီမံခန့်ခွဲနိုင်ခြင်း
...
#### သင်ယူမည့်အရာများ
- တိုးတက်သော တပ်ဆင်မှု ပုံစံများ
- Bicep ဖြင့် Infrastructure as Code
- အရင်းအမြစ် တပ်ဆင်မှု မဟာဗျူဟာများ

#### သင်ယူမှု အရင်းအမြစ်များ
- **📖 တပ်ဆင်မှု**: [Deployment Guide](docs/deployment/deployment-guide.md) - ပြည့်စုံသော လုပ်ငန်းစဉ်များ
- **🏗️ Provisioning**: [Provisioning Resources](docs/deployment/provisioning.md) - Azure အရင်းအမြစ် စီမံခန့်ခွဲမှု
- **📝 ဥပမာများ**: [Container App Example](../../examples/container-app) - Containerized တပ်ဆင်မှုများ

#### လက်တွေ့ လေ့ကျင့်ခန်းများ
- ကိုယ်ပိုင် Bicep template များ ဖန်တီးပါ
- မျိုးစုံ ဝန်ဆောင်မှု အပလီကေးရှင်းများ တပ်ဆင်ပါ
- blue-green deployment မဟာဗျူဟာများ အကောင်အထည်ဖော်ပါ

**💡 အခန်းရလဒ်**: ကိုယ်ပိုင် infrastructure template များ အသုံးပြု၍ ရှုပ်ထွေးသော မျိုးစုံ ဝန်ဆောင်မှု အပလီကေးရှင်းများ တပ်ဆင်နိုင်ခြင်း
...
- ထုတ်လုပ်မှုအဆင့် AI တပ်ဆင်မှုများ
...
**💡 Chapter Outcome**: Customer နှင့် Inventory အေးဂျင့်များပါသော ထုတ်လုပ်မှုအဆင်သင့် multi-agent AI ဖြေရှင်းချက် တပ်ဆင်ပြီး စီမံခန့်ခွဲခြင်း
...
- **💰 Selection**: [SKU Selection](docs/pre-deployment/sku-selection.md) - ကုန်ကျစရိတ်သက်သာစေရေး ရွေးချယ်မှုများ  
...
**💡 Chapter Outcome**: တပ်ဆင်မှုများကို လုပ်ဆောင်မတိုင်မီ အတည်ပြု၍ အကောင်းဆုံးပြုလုပ်နိုင်ခြင်း

---

### 🚨 Chapter 7: Troubleshooting & Debugging  
**Prerequisites**: မည်သည့် တပ်ဆင်မှုအခန်းကဏ္ဍမဆို ပြီးစီးထားရန်  
**Duration**: ၁ မှ ၁.၅ နာရီ  
**Complexity**: ⭐⭐
...
#### Learning Resources  
- **🔧 Common Issues**: [Common Issues](docs/troubleshooting/common-issues.md) - မေးခွန်းများနှင့် ဖြေရှင်းချက်များ  
...
- အတည်ပြုမှု ပြဿနာများကို ဖြေရှင်းပါ  
...
**💡 Chapter Outcome**: ထုတ်လုပ်မှုအဆင့်သင့် အက်ပလီကေးရှင်းများကို တပ်ဆင်နိုင်ခြင်း
...
> Workshop ပစ္စည်းများကို လက်ရှိ ဖန်တီးနေဆဲဖြစ်ပြီး တိုးတက်မှုရှိနေပါသည်။ အခြေခံ module များ လုပ်ဆောင်နိုင်ပြီး advanced အပိုင်းအချို့ မပြီးစီးသေးပါ။ အကြောင်းအရာအားလုံး ပြီးစီးအောင် ဆက်လက်လုပ်ဆောင်နေပါသည်။ [Track progress →](workshop/README.md)

### Interactive Workshop Materials  
**Browser-based tools နှင့် လမ်းညွှန်လေ့ကျင့်ခန်းများဖြင့် လက်တွေ့လေ့လာမှု**

Workshop ပစ္စည်းများသည် အထက်ပါ အခန်းကဏ္ဍများနှင့် ကိုက်ညီသော စနစ်တကျ၊ အပြန်အလှန် လေ့လာနိုင်သော အတွေ့အကြုံကို ပေးစွမ်းပါသည်။ Workshop သည် ကိုယ်တိုင် လေ့လာသူများနှင့် သင်ကြားသူများအတွက် တို့အတွက် ရည်ရွယ်ထားပါသည်။

#### 🛠️ Workshop Features  
- **Browser-Based Interface**: MkDocs ဖြင့် ပြုလုပ်ထားသော workshop, ရှာဖွေရေး၊ ကူးယူရေးနှင့် theme များပါဝင်သည်  
- **GitHub Codespaces Integration**: တစ်ချက်နှိပ်ပြီး ဖွင့်လှစ်နိုင်သော ဖွံ့ဖြိုးရေးပတ်ဝန်းကျင်  
- **Structured Learning Path**: ၇ အဆင့် လမ်းညွှန်လေ့ကျင့်ခန်းများ (စုစုပေါင်း ၃.၅ နာရီ)  
...
2. **Deployment Phase** (၂ နာရီ)  
   - AZD ဖြင့် AI အက်ပလီကေးရှင်းများကို လက်တွေ့တပ်ဆင်ပါ  
...
3. **Customization Phase** (၄၅ မိနစ်)  
   - အထူးသီးသန့် အသုံးပြုမှုများအတွက် အက်ပလီကေးရှင်းများကို ပြင်ဆင်ပါ  
   - ထုတ်လုပ်မှုတပ်ဆင်မှုအတွက် အကောင်းဆုံးပြုလုပ်ပါ  
...
# workshop/README.md တွင် ဖော်ပြထားသော စတင်ပြင်ဆင်မှု လမ်းညွှန်ချက်များကို လိုက်နာပါ
```
...
- **လုံခြုံရေး အကောင်းဆုံးနည်းလမ်းများ အကောင်အထည်ဖော်နိုင်ခြင်း**: အတည်ပြုမှုနှင့် ဝင်ရောက်ခွင့် ထိန်းချုပ်မှု  
- **အရွယ်အစားအတွက် အကောင်းဆုံးပြုလုပ်နိုင်ခြင်း**: ကုန်ကျစရိတ်သက်သာပြီး စွမ်းဆောင်ရည်မြင့်တင်မှု  
- **တပ်ဆင်မှု ပြဿနာများကို ကိုယ်တိုင် ဖြေရှင်းနိုင်ခြင်း**

#### 📖 Workshop Resources  
- **🎥 Interactive Guide**: [Workshop Materials](workshop/README.md) - Browser-based လေ့လာရေးပတ်ဝန်းကျင်  
- **📋 Step-by-Step Instructions**: [Guided Exercises](../../workshop/docs/instructions) - အသေးစိတ် လမ်းညွှန်ချက်များ  
- **🛠️ AI Workshop Lab**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - AI အထူးလေ့ကျင့်ခန်းများ  
- **💡 Quick Start**: [Workshop Setup Guide](workshop/README.md#quick-start) - ပတ်ဝန်းကျင် ပြင်ဆင်ခြင်း

**သင့်တော်သည်**: ကုမ္ပဏီသင်တန်းများ၊ တက္ကသိုလ်သင်တန်းများ၊ ကိုယ်တိုင်လေ့လာသူများနှင့် developer bootcamp များအတွက်။
...
- **Developer-friendly** - developer များ၏ ထုတ်လုပ်မှုနှင့် အတွေ့အကြုံအတွက် အထူးပြုလုပ်ထားခြင်း

### **AZD + Microsoft Foundry: AI တပ်ဆင်မှုများအတွက် အကောင်းဆုံး**

**AI ဖြေရှင်းချက်များအတွက် AZD ရွေးချယ်ရခြင်း** - AZD သည် AI developer များ ကြုံတွေ့ရသော အဓိက စိန်ခေါ်မှုများကို ဖြေရှင်းပေးသည် -
...
- **Production AI Patterns** - တိုးချဲ့နိုင်ပြီး ကုန်ကျစရိတ်သက်သာသော AI အက်ပလီကေးရှင်း တပ်ဆင်မှုအတွက် အကောင်းဆုံးနည်းလမ်းများ  
- **End-to-End AI Workflows** - မော်ဒယ်ဖွံ့ဖြိုးမှုမှ ထုတ်လုပ်မှုတပ်ဆင်မှုအထိ စောင့်ကြည့်မှုနှင့်အတူ  
...
> **မှတ်ချက်**: ဤ template များသည် AI ပုံစံအမျိုးမျိုးကို ပြသသည်။ အချို့သည် Azure Samples အပြင်၊ အချို့သည် ဒေသခံ အကောင်အထည်ဖော်မှုများဖြစ်သည်။
...
**ထုတ်လုပ်မှုအဆင့် အက်ပလီကေးရှင်း template များကို သင်ယူမှု အခန်းများနှင့် တွဲဖက်ထားသည်**
...
| [**ai-document-processing**](https://github.com/Azure-Samples/ai-document-processing) | Chapter 4 | ⭐⭐ | စာရွက်စာတမ်း ဉာဏ်ရည် ပေါင်းစပ်ခြင်း |  
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Chapter 5 | ⭐⭐⭐⭐ | Customer နှင့် Inventory အေးဂျင့်များပါသော multi-agent architecture |
...
- [**Container App Examples**](examples/container-app/README.md) - containerized deployment များအတွက် လမ်းညွှန်ချက်  
  ...
  - စောင့်ကြည့်မှု၊ လုံခြုံရေးနှင့် ကုန်ကျစရိတ် ထိရောက်စွာ စီမံခန့်ခွဲခြင်း

#### External Examples - Simple Applications (Chapters 1-2)  
**ဤ Azure Samples repository များကို clone ရယူ၍ စတင်ပါ**  
...
- [**Official AZD Template Gallery**](https://azure.github.io/awesome-azd/) - တရားဝင်နှင့် အသိုင်းအဝိုင်း template များ စုစည်းထားသော စာမျက်နှာ  
...
- [**Structured Learning Path**](../../workshop/docs/instructions) - ၇ အဆင့် လမ်းညွှန် လေ့ကျင့်ခန်းများ (ရှာဖွေခြင်း → တပ်ဆင်ခြင်း → စိတ်ကြိုက်ပြင်ဆင်ခြင်း)  
...
```bash
# AZD သည် ထူးခြားသောနာမည်များကို ဖန်တီးပေးသည်၊ သို့သော် ပဋိပက္ခဖြစ်ပါက:
azd down --force --purge
...
# ၃၀ မိနစ်ထက်ပိုကြာပြီး အတားအဆီးရှိပါက Azure Portal ကို စစ်ဆေးပါ
azd monitor
...
- **AI အထူးပြဿနာများ:** [AI ပြဿနာဖြေရှင်းချက်](docs/troubleshooting/ai-troubleshooting.md)  
...
သင်ယူမှု အခန်းတိုင်းအလိုက် သင်၏ တိုးတက်မှုကို ခြေရာခံပါ -  
...
- **ထုတ်လုပ်မှု အတွေ့အကြုံ**: Azure တွင် အမှန်တကယ် AI application များ တပ်ဆင်ပြီး  
- **ပရော်ဖက်ရှင်နယ် ကျွမ်းကျင်မှုများ**: စီးပွားရေးအဆင့် တပ်ဆင်မှု စွမ်းရည်များ  
- **အသိုင်းအဝိုင်း အသိအမှတ်ပြုခြင်း**: Azure developer အသိုင်းအဝိုင်း အဖွဲ့ဝင် တက်ကြွမှု  
...
- **နည်းပညာဆိုင်ရာ ပြဿနာများ**: [Bug များ တင်ပြခြင်းနှင့် လိုအပ်ချက်များ တောင်းဆိုခြင်း](https://github.com/microsoft/azd-for-beginners/issues)  
- **သင်ယူမှု မေးခွန်းများ**: [Microsoft Azure Discord အသိုင်းအဝိုင်း](https://discord.gg/microsoft-azure) နှင့် [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)  
- **AI အထူးအကူအညီ**: [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG) တွင် ပါဝင်ဆွေးနွေးပါ  
...
**#Azure ချန်နယ်မှ မကြာသေးမီက စစ်တမ်းရလဒ်များ**  
- **၄၅%** က AZD ကို AI အလုပ်များအတွက် အသုံးပြုလိုကြသည်  
- **အကြီးဆုံး စိန်ခေါ်မှုများ**: Multi-service တပ်ဆင်မှုများ၊ အတည်ပြုချက် စီမံခန့်ခွဲမှု၊ ထုတ်လုပ်မှုအဆင့် ပြင်ဆင်မှု  
- **အများဆုံး တောင်းဆိုမှုများ**: AI အထူး template များ၊ ပြဿနာဖြေရှင်း လမ်းညွှန်များ၊ အကောင်းဆုံး လေ့လာမှုနည်းလမ်းများ  

**အသိုင်းအဝိုင်းတွင် ပါဝင်ရန်**  
- သင့် AZD + AI အတွေ့အကြုံများ မျှဝေပြီး အကူအညီ ရယူပါ  
- AI template အသစ်များ၏ မျှော်မှန်းချက်များကို ကြိုတင်ကြည့်ရှုနိုင်ပါသည်  
- AI တပ်ဆင်မှု အကောင်းဆုံး လေ့လာမှုနည်းလမ်းများတွင် ပါဝင်ဆောင်ရွက်ပါ  
- အနာဂတ် AI + AZD လုပ်ဆောင်ချက်များ ဖန်တီးမှုကို သက်ရောက်မှု ရရှိစေပါ  
...
- **ဘာသာပြန်ခြင်း**: ဘာသာစကား များစွာ ထောက်ပံ့မှု ထိန်းသိမ်းရန် အကူအညီပေးခြင်း  
- **Bug များ တင်ပြခြင်း**: တိကျမှန်ကန်မှုနှင့် ရှင်းလင်းမှု တိုးတက်အောင် ပြုလုပ်ခြင်း  
...
### လိုင်စင်  
ဤပရောဂျက်သည် MIT License အောက်တွင် လိုင်စင်ရရှိထားသည် - အသေးစိတ်အတွက် [LICENSE](../../LICENSE) ဖိုင်ကို ကြည့်ပါ။  
...
**စတင်သင်ယူသူများ**: [အခန်း ၁: အခြေခံနှင့် အမြန်စတင်ခြင်း](../..) မှ စတင်ပါ  
