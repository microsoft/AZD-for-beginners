...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:49:19+00:00",
...
**💡 Risultato del Capitolo**: Deployare e configurare un'applicazione AI con funzionalità RAG
...
- Risoluzione di problemi specifici per AI
...
- **🤖 Problemi AI**: [Risoluzione Problemi AI](docs/troubleshooting/ai-troubleshooting.md) - Problemi con i servizi AI

#### Esercizi Pratici
- Diagnosticare fallimenti di deployment
- Risolvere problemi di autenticazione
- Debugging della connettività dei servizi AI
...
#### Risorse di Apprendimento
- **🏭 Produzione**: [Best Practice per l'AI in Produzione](docs/ai-foundry/production-ai-practices.md) - Modelli aziendali
...
**💡 Risultato del Capitolo**: Distribuire applicazioni pronte per l'azienda con capacità di produzione complete
...
I materiali del nostro workshop offrono un'esperienza di apprendimento strutturata e interattiva che integra il curriculum basato sui capitoli sopra. Il workshop è progettato sia per l'apprendimento autonomo che per le sessioni guidate da istruttori.
...
- **Integrazione con GitHub Codespaces**: Configurazione dell'ambiente di sviluppo con un solo clic
...
- **Distribuzioni basate su modelli** - Utilizzo di modelli predefiniti per schemi applicativi comuni
...
- **Modelli AI per la Produzione** - Best practice per distribuzioni di applicazioni AI scalabili e convenienti
- **Flussi di Lavoro AI Completi** - Dallo sviluppo del modello alla distribuzione in produzione con monitoraggio adeguato
...
**Inizia da qui se stai distribuendo applicazioni AI!**
...
| [**Sblocca informazioni dai dati conversazionali**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capitolo 8 | ⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
| [**Elaborazione di contenuti multi-modali**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capitolo 8 | ⭐⭐⭐⭐ | AzureOpenAI + Azure Content Understanding + Azure CosmosDB + Azure Container Apps|
...
- [App con Database](../../examples/database-app) - Modelli di connettività con database
...
- [**Azure-Samples AZD Templates**](https://github.com/Azure-Samples/azd-templates) - Esempi ufficiali di Microsoft
- [**Awesome AZD Gallery**](https://azure.github.io/awesome-azd/) - Modelli contribuiti dalla community
- [**Directory degli Esempi**](examples/README.md) - Esempi locali con spiegazioni dettagliate
...
### Riferimenti Rapidi
- [**Scheda dei Comandi**](resources/cheat-sheet.md) - Comandi essenziali di azd organizzati per capitolo
...
### Workshop Pratici
- [**Laboratorio AI Workshop**](docs/ai-foundry/ai-workshop-lab.md) - Rendi le tue soluzioni AI pronte per AZD (2-3 ore)
...
- [**Workshop per Principianti AZD**](workshop/README.md) - Materiali completi per workshop pratici con integrazione GitHub Codespaces
...
- **Esperienza in Produzione**: Distribuzione di applicazioni AI reali su Azure
...
- **Richieste più frequenti**: Modelli specifici per l'AI, guide alla risoluzione dei problemi, best practice

**Unisciti alla nostra community per:**
- Condividere le tue esperienze con AZD + AI e ricevere supporto
- Accedere in anteprima ai nuovi modelli AI
- Contribuire alle best practice per la distribuzione AI
- Influenzare lo sviluppo futuro delle funzionalità AI + AZD

### Contribuire al Corso
Accogliamo con favore i contributi! Leggi la nostra [Guida al Contributo](CONTRIBUTING.md) per dettagli su:
- **Miglioramenti ai Contenuti**: Migliora i capitoli ed esempi esistenti
...
- [Protocollo Model Context (MCP) per principianti](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)  
