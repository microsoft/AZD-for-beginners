...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-25T03:19:19+00:00",
...
1. **Crea un fork del repository**: Click [![Fork GitHub](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
...
Basato sulle informazioni della community Discord di Microsoft Foundry, **il 45% degli sviluppatori desidera utilizzare AZD per carichi di lavoro AI** ma incontra difficoltà con:
...
- Risoluzione dei problemi specifici per il deployment AI

### Obiettivi di apprendimento

Completando questo corso strutturato, sarai in grado di:
- **Padroneggiare le basi di AZD**: concetti fondamentali, installazione e configurazione
...
- **⚙️ Configurazione**: [Installazione e configurazione](docs/getting-started/installation.md) - Guide specifiche per piattaforma
- **🛠️ Pratica**: [Il tuo primo progetto](docs/getting-started/first-project.md) - Tutorial passo dopo passo
...
**📈 Livello di competenza dopo:** Puoi distribuire applicazioni di base in modo indipendente
...
- Distribuzione di applicazioni con funzionalità AI
...
- **📖 Pattern**: [Deployment di modelli AI](docs/microsoft-foundry/ai-model-deployment.md) - Distribuire e gestire modelli AI
- **🛠️ Workshop**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Rendere le tue soluzioni AI pronte per AZD
...
- **📋 Modelli**: [Template Microsoft Foundry](../..)
...
**💡 Risultato del capitolo**: Distribuire e configurare un'applicazione chat potenziata da AI con funzionalità RAG
...
**📈 Livello di competenza dopo:** Puoi distribuire e configurare applicazioni AI pronte per la produzione  
**💰 Consapevolezza dei costi:** Comprendere i costi di sviluppo di $80-150/mese, costi di produzione $300-3500/mese
...
- Usa il **Free Tier** di Azure OpenAI per l'apprendimento (inclusi 50.000 token/mese)
- Esegui `azd down` per deallocare le risorse quando non stai sviluppando attivamente
- Inizia con fatturazione basata sul consumo, esegui l'upgrade a PTU solo per la produzione
...
```bash
# Verificare i costi mensili stimati
azd provision --preview

# Monitorare i costi effettivi nel Portale di Azure
...
#### Risorse di apprendimento
- **📖 Configurazione**: [Guida alla configurazione](docs/getting-started/configuration.md) - Impostazione dell'ambiente
...
- Deployment AI pronte per la produzione

#### Risorse di apprendimento
- **🤖 Progetto in evidenza**: [Soluzione multi-agente per retail](examples/retail-scenario.md) - Implementazione completa
- **🛠️ Modelli ARM**: [Pacchetto modelli ARM](../../examples/retail-multiagent-arm-template) - Distribuzione con un clic
- **📖 Architettura**: [Pattern di coordinamento multi-agente](/docs/pre-deployment/coordination-patterns.md) - Modelli

#### Esercizi pratici
```bash
# Distribuire l'intera soluzione multi-agente per il retail
...
#### Risorse di apprendimento
- **📊 Pianificazione**: [Pianificazione della capacità](docs/pre-deployment/capacity-planning.md) - Convalida delle risorse
- **💰 Selezione**: [Selezione SKU](docs/pre-deployment/sku-selection.md) - Scelte economicamente vantaggiose
- **✅ Convalida**: [Controlli preliminari](docs/pre-deployment/preflight-checks.md) - Script automatizzati

#### Esercizi pratici
- Eseguire script di convalida della capacità
- Ottimizzare la selezione degli SKU per i costi
- Implementare controlli automatici pre-distribuzione

**💡 Risultato del capitolo**: Convalidare e ottimizzare le distribuzioni prima dell'esecuzione
...
- **🤖 Problemi AI**: [Risoluzione problemi specifica per l'AI](docs/troubleshooting/ai-troubleshooting.md) - Problemi dei servizi AI
...
**💡 Risultato del capitolo**: Diagnosticare e risolvere in autonomia i problemi di distribuzione comuni
...
- Pattern di sicurezza aziendali
- Monitoraggio e ottimizzazione dei costi

#### Risorse di apprendimento
- **🏭 Produzione**: [Best practice AI per la produzione](docs/microsoft-foundry/production-ai-practices.md) - Pattern aziendali
...
**💡 Risultato del capitolo**: Distribuire applicazioni pronte per l'ambiente di produzione a livello enterprise
...
> I materiali del workshop sono attualmente in fase di sviluppo e perfezionamento. I moduli principali sono funzionali, ma alcune sezioni avanzate sono incomplete. Stiamo lavorando attivamente per completare tutti i contenuti. [Segui i progressi →](workshop/README.md)

### Materiali interattivi del workshop
**Apprendimento pratico e completo con strumenti basati su browser ed esercizi guidati**

I materiali del workshop offrono un'esperienza di apprendimento strutturata e interattiva che integra il curriculum per capitoli sopra descritto. Il workshop è progettato sia per l'apprendimento autodidatta sia per sessioni guidate da istruttori.

#### 🛠️ Caratteristiche del workshop
- **Interfaccia basata su browser**: Completo workshop basato su MkDocs con ricerca, copia e funzionalità di tema
- **Integrazione GitHub Codespaces**: Configurazione dell'ambiente di sviluppo con un clic
- **Percorso di apprendimento strutturato**: Esercizi guidati in 7 passaggi (3.5 hours total)
...
1. **Fase di scoperta** (45 mins)
   - Esplorare i template e i servizi di Microsoft Foundry
   - Comprendere i pattern architetturali multi-agente
   - Rivedere i requisiti di distribuzione e i prerequisiti

2. **Fase di distribuzione** (2 hours)
   - Distribuzione pratica di applicazioni AI con AZD
   - Configurare i servizi e gli endpoint Azure AI
   - Implementare pattern di sicurezza e autenticazione

3. **Fase di personalizzazione** (45 mins)
...
- **Distribuire applicazioni AI di produzione**: Utilizzare AZD con i servizi Microsoft Foundry
- **Padroneggiare architetture multi-agente**: Implementare soluzioni coordinate di agenti AI
...
- **📋 Istruzioni passo-passo**: [Esercizi guidati](../../workshop/docs/instructions) - Procedura dettagliata
- **🛠️ Laboratorio AI del workshop**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Esercizi focalizzati sull'AI
...
Azure Developer CLI (azd) è un'interfaccia a riga di comando orientata allo sviluppatore che accelera il processo di creazione e distribuzione delle applicazioni su Azure. Fornisce:

- **Distribuzioni basate su template** - Usa template predefiniti per pattern applicativi comuni
- **Infrastructure as Code** - Gestire le risorse Azure usando Bicep o Terraform  
- **Workflow integrati** - Provisioning, distribuzione e monitoraggio senza soluzione di continuità
...
- **Distribuzioni AI sicure** - Pattern di sicurezza integrati per servizi AI, chiavi API ed endpoint dei modelli  
...
- **Ottimizzazione dei costi** - Allocazione intelligente delle risorse e strategie di scaling per carichi di lavoro AI
...
|----------|---------|------------|----------|------|
| [**Primi passi con chat AI**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capitolo 2 | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights | Esterno |
| [**Primi passi con agenti AI**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Capitolo 2 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights| Esterno |
...
|----------|------------------|------------|--------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Capitolo 2 | ⭐ | Basic AI deployment patterns |
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | Capitolo 2 | ⭐⭐ | RAG implementation with Azure AI Search |
| [**ai-document-processing**](https://github.com/Azure-Samples/ai-document-processing) | Capitolo 4 | ⭐⭐ | Document Intelligence integration |
| [**agent-openai-python-prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Capitolo 5 | ⭐⭐⭐ | Agent framework and function calling |
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Capitolo 8 | ⭐⭐⭐ | Enterprise AI orchestration |
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Capitolo 5 | ⭐⭐⭐⭐ | Multi-agent architecture with Customer and Inventory agents |
...
- [**Esempi Container App**](examples/container-app/README.md) - Guida completa alle distribuzioni containerizzate
  ...
  - Avvio rapido, produzione e pattern di distribuzione avanzati
...
- [Simple Web App - Node.js + MongoDB](https://github.com/Azure-Samples/todo-nodejs-mongo) - Pattern di distribuzione di base
...
- [**Official AZD Template Gallery**](https://azure.github.io/awesome-azd/) - Raccolta curata di template ufficiali e della community
...
## 📚 Risorse e riferimenti per l'apprendimento

### Riferimenti rapidi
- [**Tabelle di Comandi**](resources/cheat-sheet.md) - Comandi azd essenziali organizzati per capitolo
...
### Laboratori Pratici
- [**AI Workshop Lab**](docs/microsoft-foundry/ai-workshop-lab.md) - Rendere le tue soluzioni AI distribuibili con AZD (2-3 ore)
- [**Guida al Workshop Interattivo**](workshop/README.md) - Workshop basato su browser con MkDocs e ambiente DevContainer
- [**Structured Learning Path**](../../workshop/docs/instructions) -7-step esercizi guidati (Scoperta → Distribuzione → Personalizzazione)
- [**AZD For Beginners Workshop**](workshop/README.md) - Materiale completo del workshop pratico con integrazione GitHub Codespaces
...
# Opzione 2: Riparare solo l'infrastruttura
azd provision
...
# - User Access Administrator (per le assegnazioni dei ruoli)
```
...
- **Problemi specifici per l'AI:** [Risoluzione problemi AI](docs/troubleshooting/ai-troubleshooting.md)
- **Guida al debug:** [Debug passo dopo passo](docs/troubleshooting/debugging.md)
...
```bash
# AZD genera nomi univoci, ma in caso di conflitto:
azd down --force --purge

# Quindi riprovare con un ambiente pulito
azd env new dev-v2
azd up
```
</details>
...
Dopo aver completato ogni capitolo, verifica le tue conoscenze con:
...
Al completamento di tutti i capitoli, otterrai:
- **Esperienza di produzione**: Distribuzione di vere applicazioni AI su Azure
...
- **Avanzamento di carriera**: Competenze AZD e deployment AI molto richieste
...
- **Aiuto specifico per l'AI**: Unisciti a [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- Contribuire alle migliori pratiche per il deployment AI
- Influenzare lo sviluppo futuro delle funzionalità AI + AZD

### Contribuire al corso
Accogliamo contributi! Leggi la nostra [Contributing Guide](CONTRIBUTING.md) per dettagli su:
- **Miglioramenti dei contenuti**: Migliora capitoli ed esempi esistenti
- **Nuovi esempi**: Aggiungi scenari e template real-world  
...
**Sviluppatori IA**: Vai a [Capitolo 2: Sviluppo AI-First](../..)  
**Sviluppatori esperti**: Inizia con [Capitolo 3: Configurazione e Autenticazione](../..)

**Prossimi passi**: [Inizia Capitolo 1 - Nozioni di base su AZD](docs/getting-started/azd-basics.md) →
