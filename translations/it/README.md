...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T11:15:13+00:00",
...
3. **Unisciti alla Community**: [Azure Discord Communities](https://discord.com/invite/ByRwuEEgH4) per supporto da esperti
...
Impara a padroneggiare Azure Developer CLI (azd) attraverso capitoli strutturati per un apprendimento progressivo. **Focus speciale sul deployment di applicazioni AI con integrazione Microsoft Foundry.**

### Perché Questo Corso è Essenziale per gli Sviluppatori Moderni

Basato sui feedback della community Discord di Microsoft Foundry, **il 45% degli sviluppatori vuole utilizzare AZD per carichi di lavoro AI**, ma incontra difficoltà con:
- Architetture AI complesse e multi-servizio
...
**📈 Livello di Competenza Dopo:** Capacità di distribuire applicazioni base in autonomia
...
- Distribuzione di applicazioni AI
- Comprensione delle configurazioni dei servizi AI

#### Risorse di Apprendimento
- **🎯 Inizia Qui**: [Integrazione con Microsoft Foundry](docs/microsoft-foundry/microsoft-foundry-integration.md)
- **📖 Modelli**: [Deployment di Modelli AI](docs/microsoft-foundry/ai-model-deployment.md) - Distribuire e gestire modelli AI
...
# Fare domande e ottenere risposte alimentate dall'AI con fonti
...
**📈 Livello di Competenza Dopo:** Capacità di distribuire e configurare applicazioni AI pronte per la produzione  
**💰 Consapevolezza dei Costi:** Comprendere costi di $80-150/mese per sviluppo, $300-3500/mese per produzione

#### 💰 Considerazioni sui Costi per i Deployment AI

**Ambiente di Sviluppo (Stimato $80-150/mese):**
- Azure OpenAI (Pay-as-you-go): $0-50/mese (in base all'uso dei token)
...
- Azure OpenAI (PTU per prestazioni consistenti): $3,000+/mese O Pay-as-go con alto volume
...
- Usa il **Free Tier** di Azure OpenAI per l'apprendimento (50,000 token/mese inclusi)
...
- **📝 Esempi**: [Esempio di App con Database](examples/database-app/README.md) - Esempi di Database con AZD
...
- **📝 Esempi**: [Esempio di App Containerizzata](../../examples/container-app) - Deployment containerizzati
...
- **📖 Architettura**: [Schemi di coordinamento multi-agente](/docs/pre-deployment/coordination-patterns.md) - Schemi
...
**💡 Obiettivo del Capitolo**: Distribuire e gestire una soluzione AI multi-agente pronta per la produzione con agenti per Clienti e Inventario
...
- Ottimizza le selezioni SKU per il costo
...
- **🤖 Problemi AI**: [Risoluzione Problemi Specifici per l'AI](docs/troubleshooting/ai-troubleshooting.md) - Problemi con i servizi AI

#### Esercizi Pratici
- Diagnostica errori di distribuzione
- Risolvi problemi di autenticazione
- Effettua il debug della connettività dei servizi AI

**💡 Obiettivo del Capitolo**: Diagnosticare e risolvere autonomamente i problemi comuni di distribuzione
...
**💡 Obiettivo del Capitolo**: Distribuire applicazioni pronte per l'azienda con capacità di produzione complete
...
I materiali del workshop offrono un'esperienza di apprendimento strutturata e interattiva che integra il curriculum basato sui capitoli sopra. Il workshop è progettato sia per l'apprendimento autonomo che per le sessioni guidate da istruttori.

#### 🛠️ Caratteristiche del Workshop
- **Interfaccia Basata su Browser**: Workshop completo con MkDocs con funzionalità di ricerca, copia e temi
...
2. **Fase di Distribuzione** (2 ore)
   ...
   - Configura i servizi Azure AI e gli endpoint
...
# Clicca "Code" → "Create codespace on main" nel repository
...
- **Distribuire Applicazioni AI in Produzione**: Utilizzare AZD con i servizi di Microsoft Foundry
- **Padroneggiare le Architetture Multi-Agente**: Implementare soluzioni AI coordinate
...
- **Distribuzioni basate su modelli** - Utilizza modelli predefiniti per schemi applicativi comuni
...
- **Distribuzioni AI Sicure** - Modelli di sicurezza integrati per servizi AI, chiavi API ed endpoint dei modelli  
...
- **Integrazione con Microsoft Foundry** - Connessione senza interruzioni al catalogo modelli e agli endpoint di Microsoft Foundry
...
> **Nota:** Questi modelli dimostrano vari schemi AI. Alcuni sono esempi Azure esterni, altri implementazioni locali.
...
| [**agent-openai-python-prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Capitolo 5 | ⭐⭐⭐ | Framework per agenti e chiamate a funzioni |
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Capitolo 8 | ⭐⭐⭐ | Orchestrazione AI aziendale |
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Capitolo 5 | ⭐⭐⭐⭐ | Architettura multi-agente con agenti per Clienti e Inventario |
...
- [**Soluzione Multi-Agente Retail**](examples/retail-scenario.md) - Implementazione completa pronta per la produzione con modelli ARM
  - Architettura multi-agente (agenti per Clienti + Inventario)
...
- [**Esempi di Applicazioni Container**](examples/container-app/README.md) - Guida completa alle distribuzioni containerizzate
  ...
  - Schemi di distribuzione Rapida, Produzione e Avanzata
  - Guida a monitoraggio, sicurezza e ottimizzazione dei costi
...
- [App Database - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - Schemi di connettività al database
...
- [**Galleria Ufficiale Modelli AZD**](https://azure.github.io/awesome-azd/) - Collezione curata di modelli ufficiali e della community
...
### Workshop Pratici
- [**Laboratorio AI Workshop**](docs/microsoft-foundry/ai-workshop-lab.md) - Rendi le tue soluzioni AI pronte per il deployment con AZD (2-3 ore)
...
### ❌ "QuotaInsufficiente" o "Quota superata"
...
# - User Access Administrator (per assegnazioni di ruoli)
```
...
<details>
<summary><strong>❌ "QuotaInsufficiente" o "Quota superata"</strong></summary>
...
Tieni traccia dei tuoi progressi di apprendimento attraverso ogni capitolo:

- [ ] **Capitolo 1**: Fondamenti & Avvio Rapido ✅
- [ ] **Capitolo 2**: Sviluppo AI-First ✅  
- [ ] **Capitolo 3**: Configurazione & Autenticazione ✅
- [ ] **Capitolo 4**: Infrastruttura come Codice & Deployment ✅
...
- **Domande di Apprendimento**: [Community Discord di Microsoft Azure](https://discord.gg/microsoft-azure) e [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- Accedere a anteprime esclusive di nuovi template AI
