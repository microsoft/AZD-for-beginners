...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T12:55:09+00:00",
...
歡迎來到您的第一個 Azure Developer CLI 專案！這份全面的實作教學將帶您完整了解如何使用 azd 在 Azure 上建立、部署和管理一個全端應用程式。您將操作一個真實的待辦事項應用程式，包含 React 前端、Node.js API 後端，以及 MongoDB 資料庫。

## 學習目標

完成本教學後，您將能夠：
- 掌握使用範本初始化 azd 專案的工作流程
- 理解 Azure Developer CLI 專案結構與配置檔案
...
我們從一個流行的待辦事項應用程式範本開始，該範本包含 React 前端和 Node.js API 後端。
...
`azd up` 指令執行以下步驟：
1. **配置資源** (`azd provision`) - 建立 Azure 資源
2. **打包** - 建置應用程式程式碼
...
- [新增資料庫、儲存體及其他服務](../deployment/provisioning.md#adding-services)
...
**恭喜完成您的第一個 azd 專案！** 現在，您已準備好自信地在 Azure 上建置並部署令人驚豔的應用程式。
