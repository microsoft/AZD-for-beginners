...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:45:23+00:00",
...
本課程將介紹 Azure Developer CLI (azd)，這是一個強大的命令列工具，能加速從本地開發到 Azure 部署的過程。您將學習基本概念、核心功能，以及了解 azd 如何簡化雲原生應用程式的部署。
...
`azd down --force --purge` 命令是一種強大的方式，可以完全拆除您的 azd 環境及所有相關資源。以下是每個標誌的功能：
```
--force
```
- 跳過確認提示。
...
### 為什麼要同時使用？
當您因殘留狀態或部分部署而在使用 `azd up` 時遇到問題時，這個組合能確保 **完全清理**。
