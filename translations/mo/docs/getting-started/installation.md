...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:07:56+00:00",
...
這份完整指南將引導您在系統上安裝並設定 Azure Developer CLI (azd)。您將學習針對不同作業系統的多種安裝方法、身份驗證設定，以及初始配置，為 Azure 部署準備您的開發環境。
...
這份指南將協助您在系統上安裝並設定 Azure Developer CLI，無論您的作業系統或開發環境為何。
