...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T19:44:50+00:00",
...
歡迎參加這場專注於 AI 應用部署的 Azure Developer CLI (AZD) 實作工作坊。本工作坊旨在帶領您從 AZD 基礎知識到部署可供生產使用的 AI 解決方案。
