...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T11:56:53+00:00",
...
我們的工作坊材料提供結構化的互動學習體驗，與上述章節式課程相輔相成。工作坊設計適合自學和講師引導的課程。
...
| [**構建您的對話代理**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 第 4 章 | ⭐⭐⭐ | AI 語言 + AzureOpenAI + AI 搜索 + Azure 存儲 + Azure 容器註冊表|
...
### 為課程做出貢獻
我們歡迎貢獻！請閱讀 [貢獻指南](CONTRIBUTING.md)，了解以下細節：
- **內容改進**: 增強現有章節和範例
- **新增範例**: 添加真實場景和模板  
- **翻譯**: 協助維護多語言支持
- **錯誤回報**: 提高準確性和清晰度
