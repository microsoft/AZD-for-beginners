...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-25T00:22:10+00:00",
...
![AZD 初學者](../../translated_images/azdbeginners.5527441dd9f7406899cccfc907016b09f9370137543280d95f62ebf23637a2ee.mo.png) 
...
1. **Fork 該儲存庫**: Click [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Clone 該儲存庫**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **加入社群**: [Azure Discord Communities](https://discord.com/invite/ByRwuEEgH4) 以取得專家支援
4. **選擇您的學習路徑**: 從下方挑選符合您經驗程度的章節
...
[阿拉伯語](../ar/README.md) | [孟加拉語](../bn/README.md) | [保加利亞語](../bg/README.md) | [緬甸語（Myanmar）](../my/README.md) | [中文（簡體）](../zh/README.md) | [中文（繁體，香港）](../hk/README.md) | [中文（繁體，澳門）](./README.md) | [中文（繁體，台灣）](../tw/README.md) | [克羅埃西亞語](../hr/README.md) | [捷克語](../cs/README.md) | [丹麥語](../da/README.md) | [荷蘭語](../nl/README.md) | [愛沙尼亞語](../et/README.md) | [芬蘭語](../fi/README.md) | [法文](../fr/README.md) | [德語](../de/README.md) | [希臘語](../el/README.md) | [希伯來語](../he/README.md) | [印地語](../hi/README.md) | [匈牙利語](../hu/README.md) | [印尼語](../id/README.md) | [義大利語](../it/README.md) | [日語](../ja/README.md) | [卡納達語](../kn/README.md) | [韓語](../ko/README.md) | [立陶宛語](../lt/README.md) | [馬來語](../ms/README.md) | [馬拉雅拉姆語](../ml/README.md) | [馬拉地語](../mr/README.md) | [尼泊爾語](../ne/README.md) | [奈及利亞皮欽語](../pcm/README.md) | [挪威語](../no/README.md) | [波斯語（法爾西）](../fa/README.md) | [波蘭語](../pl/README.md) | [葡萄牙語（巴西）](../br/README.md) | [葡萄牙語（葡萄牙）](../pt/README.md) | [旁遮普語（Gurmukhi）](../pa/README.md) | [羅馬尼亞語](../ro/README.md) | [俄語](../ru/README.md) | [塞爾維亞語（西里爾文）](../sr/README.md) | [斯洛伐克語](../sk/README.md) | [斯洛維尼亞語](../sl/README.md) | [西班牙語](../es/README.md) | [斯瓦希里語](../sw/README.md) | [瑞典語](../sv/README.md) | [他加祿語（菲律賓）](../tl/README.md) | [泰米爾語](../ta/README.md) | [泰盧固語](../te/README.md) | [泰語](../th/README.md) | [土耳其語](../tr/README.md) | [烏克蘭語](../uk/README.md) | [烏爾都語](../ur/README.md) | [越南語](../vi/README.md)
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## 課程概覽

透過結構化章節掌握 Azure Developer CLI (azd)。**特別強調與 Microsoft Foundry 整合的 AI 應用部署。**
...
- **部署 AI 應用**：使用 AZD 結合 Microsoft Foundry 服務
...
- **🛠️ 工作坊**： [AI 工作坊實驗室](docs/microsoft-foundry/ai-workshop-lab.md) - 讓您的 AI 解決方案能與 AZD 協同
- **🎥 互動式指南**： [工作坊教材](workshop/README.md) - 基於瀏覽器的學習，使用 MkDocs * DevContainer 環境
...
**💰 成本概念：** 了解開發成本約為 $80-150/月，生產成本約為 $300-3500/月

#### 💰 AI 部署的成本考量

**開發環境（估計 $80-150/月）：**
- Azure OpenAI（按用量付費）：$0-50/月（依代幣使用量而定）
- AI Search（基礎層）：$75/月
- Container Apps（Consumption）：$0-20/月
- 儲存（標準）：$1-5/月

**生產環境（估計 $300-3,500+/月）：**
- Azure OpenAI（PTU 以維持一致效能）：$3,000+/月 或 高流量時採按用量付費
- AI Search（標準層）：$250/月
...
**💡 成本優化建議：**
- 學習時使用 **Azure OpenAI 免費層**（每月包含 50,000 代幣）
- 在非開發時執行 `azd down` 以解除配置資源
- 開始採用消耗量計費，僅在生產環境才升級為 PTU
...
- **🔐 安全**： [驗證模式與 Managed Identity](docs/getting-started/authsecurity.md) - 驗證模式
- **📝 範例**： [資料庫應用範例](examples/database-app/README.md) - AZD 資料庫範例

#### 實作練習
- 設定多個環境（dev、staging、prod）
- 設置 Managed Identity 驗證
- 實作環境專屬設定

**💡 章節成果**：以適當的驗證與安全管理多個環境
...
- **📖 架構**: [Multi-agent coordination patterns](/docs/pre-deployment/coordination-patterns.md) - 模式
...
**💡 章節成果**: 部署並管理具生產力等級的多代理 AI 解決方案，包含 Customer 與 Inventory 代理
...
- **💰 選擇**: [SKU Selection](docs/pre-deployment/sku-selection.md) - 成本效益選擇
...
#### 學習資源
- **🔧 常見問題**: [Common Issues](docs/troubleshooting/common-issues.md) - 常見問答與解法
- **🕵️ 偵錯**: [Debugging Guide](docs/troubleshooting/debugging.md) - 逐步策略
...
- **📊 監控**: [Application Insights integration](docs/pre-deployment/application-insights.md) - 監控整合
...
> **⚠️ 工作坊狀態：開發中**  
> 工作坊教材目前正在開發與精修中。核心模組可運作，但部分進階章節尚未完成。我們正積極補完所有內容。[追蹤進度 →](workshop/README.md)

### 互動式工作坊教材
**完整的實作學習，使用瀏覽器為基礎的工具與引導式練習**

我們的工作坊教材提供結構化、互動式的學習體驗，作為上述章節課程的補充。工作坊設計可支援自學或由講師帶領的課程。

#### 🛠️ 工作坊特色
- **瀏覽器介面**: 完整以 MkDocs 提供的工作坊，具搜尋、複製與主題功能
...
# 在儲存庫中按「Code」→ 選擇「Create codespace on main」
...
- **實作安全最佳實務**: 配置認證與存取控管
- **為擴展最佳化**: 設計具成本效益與效能的部署
- **故障排除部署問題**: 能獨立解決常見問題

#### 📖 工作坊資源
- **🎥 互動指南**: [Workshop Materials](workshop/README.md) - 瀏覽器式學習環境
- **📋 逐步指引**: [Guided Exercises](../../workshop/docs/instructions) - 詳細步驟
- **🛠️ AI 工作坊實驗室**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - 以 AI 為主的練習
- **💡 快速開始**: [Workshop Setup Guide](workshop/README.md#quick-start) - 環境設定

**適合對象**: 企業培訓、大學課程、自學者與開發者訓練營。

---

## 📖 什麼是 Azure Developer CLI？

Azure Developer CLI (azd) 是以開發者為中心的命令列介面，加速將應用建置並部署到 Azure 的流程。它提供：

- **基於範本的部署** - 使用預建範本來處理常見的應用模式
- **基礎設施即程式碼** - 使用 Bicep 或 Terraform 管理 Azure 資源  
- **整合的工作流程** - 無縫地佈建、部署與監控應用
- **開發者友善** - 為提高開發者生產力與體驗而優化

### **AZD + Microsoft Foundry：AI 部署的完美組合**

**為什麼選擇 AZD 來部署 AI 解決方案？** AZD 解決了 AI 開發者面臨的主要挑戰：

- **AI 準備好的範本** - 預先配置的範本，支援 Azure OpenAI、Cognitive Services 與 ML 工作負載
- **安全的 AI 部署** - 內建 AI 服務、API 金鑰與模型端點的安全模式  
- **生產級 AI 模式** - 可擴展且具成本效益的 AI 應用部署最佳實務
- **端到端 AI 工作流程** - 從模型開發到生產部署並搭配適當監控
- **成本最佳化** - 為 AI 工作負載提供智慧的資源分配與縮放策略
- **Microsoft Foundry 整合** - 與 Microsoft Foundry 模型目錄與端點無縫連結
...
> **注意：** 這些範本展示不同的 AI 模式。有些是外部的 Azure Samples，其他則是本地實作。

| Template | Chapter | Complexity | Services | Type |
|----------|---------|------------|----------|------|
| [**開始使用 AI 聊天**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapter 2 | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights | External |
| [**開始使用 AI 代理**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Chapter 2 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights| External |
| [**Azure Search + OpenAI 示範**](https://github.com/Azure-Samples/azure-search-openai-demo) | Chapter 2 | ⭐⭐ | AzureOpenAI + Azure AI Search + App Service + Storage | External |
| [**OpenAI Chat App 快速入門**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Chapter 2 | ⭐ | AzureOpenAI + Container Apps + Application Insights | External |
...
| [**零售多代理解決方案**](examples/retail-scenario.md) | Chapter 5 | ⭐⭐⭐⭐ | AzureOpenAI + AI Search + Storage + Container Apps + Cosmos DB | **Local** |
...
|----------|------------------|------------|--------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Chapter 2 | ⭐ | 基本 AI 部署模式 |
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | Chapter 2 | ⭐⭐ | 以 Azure AI Search 實作 RAG |
| [**ai-document-processing**](https://github.com/Azure-Samples/ai-document-processing) | Chapter 4 | ⭐⭐ | 文件智能整合 |
| [**agent-openai-python-prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Chapter 5 | ⭐⭐⭐ | 代理框架與函數呼叫 |
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Chapter 8 | ⭐⭐⭐ | 企業級 AI 協調 |
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Chapter 5 | ⭐⭐⭐⭐ | 包含 Customer 與 Inventory 代理的多代理架構 |

### 以範例類型學習

> **📌 本地 vs. 外部 範例：**  
> **本地範例** (在此 repo 中) = 可立即使用  
> **外部範例** (Azure Samples) = 從連結的倉庫 clone
...
#### 外部範例 - 簡單應用（第1-2章）
**Clone 這些 Azure Samples 倉庫開始：**
- [Simple Web App - Node.js + MongoDB](https://github.com/Azure-Samples/todo-nodejs-mongo) - 基本部署模式
- [Static Website - React SPA](https://github.com/Azure-Samples/todo-csharp-sql-swa-func) - 靜態網站部署
...
### 快速參考
- [**指令速查表**](resources/cheat-sheet.md) - 組織化的重點 azd 指令，按章節分類
- [**詞彙表**](resources/glossary.md) - Azure 與 azd 術語  
- [**常見問題**](resources/faq.md) - 按學習章節整理的常見問題
- [**學習指南**](resources/study-guide.md) - 綜合練習題

### 實作工作坊
- [**AI 工作坊實驗室**](docs/microsoft-foundry/ai-workshop-lab.md) - 讓你的 AI 解決方案能以 AZD 部署（2-3 小時）
...
### 完成課程的好處
完成所有章節後，您將擁有：
- **生產經驗**：在 Azure 部署實際的 AI 應用程式
- **專業技能**：具備企業級部署能力  
- **社群認可**：成為活躍的 Azure 開發者社群成員
- **職涯提升**：具備熱門的 AZD 與 AI 部署專業能力
...
- **學習相關問題：** [Microsoft Azure Discord 社群](https://discord.gg/microsoft-azure) and [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
免責聲明：
本文件已使用 AI 翻譯服務 Co-op Translator (https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們力求準確，但自動翻譯可能包含錯誤或不準確之處，敬請留意。原始語言之原文應視為具權威性的版本。若內容屬於重要資訊，建議採用專業人工翻譯。我們對因使用本翻譯而產生的任何誤解或錯誤詮釋概不負責。
