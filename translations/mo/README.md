...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T11:47:09+00:00",
...
![AZD-初學者](../../translated_images/mo/azdbeginners.5527441dd9f74068.webp) 
...
請按照以下步驟開始你的 AZD 學習旅程：

1. **Fork 該儲存庫**: Click [![GitHub 派生](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **複製儲存庫**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **加入社群**: [Azure Discord 社群](https://discord.com/invite/ByRwuEEgH4) 以獲取專家支援
4. **選擇你的學習路徑**: 從下方選擇符合你程度的章節
...
[阿拉伯語](../ar/README.md) | [孟加拉語](../bn/README.md) | [保加利亞語](../bg/README.md) | [緬甸語 (Myanmar)](../my/README.md) | [中文（簡體）](../zh/README.md) | [中文（繁體，香港）](../hk/README.md) | [中文（繁體，澳門）](./README.md) | [中文（繁體，臺灣）](../tw/README.md) | [克羅地亞語](../hr/README.md) | [捷克語](../cs/README.md) | [丹麥語](../da/README.md) | [荷蘭語](../nl/README.md) | [愛沙尼亞語](../et/README.md) | [芬蘭語](../fi/README.md) | [法語](../fr/README.md) | [德語](../de/README.md) | [希臘語](../el/README.md) | [希伯來語](../he/README.md) | [印地語](../hi/README.md) | [匈牙利語](../hu/README.md) | [印尼語](../id/README.md) | [義大利語](../it/README.md) | [日語](../ja/README.md) | [坎納達語](../kn/README.md) | [韓語](../ko/README.md) | [立陶宛語](../lt/README.md) | [馬來語](../ms/README.md) | [馬拉雅拉姆語](../ml/README.md) | [馬拉地語](../mr/README.md) | [尼泊爾語](../ne/README.md) | [奈及利亞洋泣語 (Nigerian Pidgin)](../pcm/README.md) | [挪威語](../no/README.md) | [波斯語 (Farsi)](../fa/README.md) | [波蘭語](../pl/README.md) | [葡萄牙語（巴西）](../br/README.md) | [葡萄牙語（葡萄牙）](../pt/README.md) | [旁遮普語（古魯穆奇）](../pa/README.md) | [羅馬尼亞語](../ro/README.md) | [俄語](../ru/README.md) | [塞爾維亞語（西里爾）](../sr/README.md) | [斯洛伐克語](../sk/README.md) | [斯洛文尼亞語](../sl/README.md) | [西班牙語](../es/README.md) | [史瓦西里語](../sw/README.md) | [瑞典語](../sv/README.md) | [塔加洛語（菲律賓語）](../tl/README.md) | [泰米爾語](../ta/README.md) | [泰盧固語](../te/README.md) | [泰語](../th/README.md) | [土耳其語](../tr/README.md) | [烏克蘭語](../uk/README.md) | [烏爾都語](../ur/README.md) | [越南語](../vi/README.md)
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## 課程概覽

透過結構化章節學習，掌握 Azure Developer CLI (azd)。**特別聚焦於與 Microsoft Foundry 整合的 AI 應用部署。**

### 為何本課程對現代開發者至關重要

根據 Microsoft Foundry Discord 社群的見解，**45% 的開發者希望使用 AZD 處理 AI 工作負載**，但遇到以下挑戰：
- 複雜的多服務 AI 架構
- 生產環境 AI 部署最佳實務
- Azure AI 服務整合與設定
- AI 工作負載的成本最佳化
...
- **部署 AI 應用**：將 AZD 與 Microsoft Foundry 服務結合使用
- **實作基礎設施即程式碼**：使用 Bicep 範本管理 Azure 資源
- **排除部署問題**：解決常見問題並進行除錯
- **最佳化生產環境**：安全性、擴展、監控與成本管理
...
- **⚙️ 設定**： [安裝與設定](docs/getting-started/installation.md) - 針對各平台的指南
...
- **🛠️ 工作坊**： [AI 工作坊實驗室](docs/microsoft-foundry/ai-workshop-lab.md) - 讓你的 AI 解決方案適用於 AZD
- **🎥 互動導引**： [工作坊教材](workshop/README.md) - 瀏覽器式學習，使用 MkDocs * DevContainer Environment
...
**📊 所需時間：** 1-2 小時  
**📈 完成後技能等級：** 能部署並設定生產等級的 AI 應用  
**💰 成本認知：** 了解開發環境每月約 $80-150，生產環境每月約 $300-3500

#### 💰 AI 部署的成本考量

**開發環境（估計每月 $80-150）：**
- Azure OpenAI（隨用隨付）：$0-50/月（視 token 使用量而定）
- AI Search（基礎等級）：$75/月
- Container Apps（按用量計費）：$0-20/月
- 儲存（標準）：$1-5/月

**生產環境（估計每月 $300-3,500+）：**
- Azure OpenAI（PTU 以確保一致效能）：$3,000+/月 或 高流量時使用隨用隨付
- AI Search（標準等級）：$250/月
- Container Apps（專用）：$50-100/月
- Application Insights：$5-50/月
- 儲存（高階）：$10-50/月

**💡 成本最佳化建議：**
- 學習時使用 **免費額度** 的 Azure OpenAI（包含每月 50,000 tokens）
- 不開發時執行 `azd down` 以解除配置資源
- 以按用量計費開始，僅在生產使用時升級到 PTU
...
- **🔐 安全**： [驗證範式與 Managed Identity](docs/getting-started/authsecurity.md) - 驗證範式
- **📝 範例**： [資料庫應用範例](examples/database-app/README.md) - AZD 資料庫範例

#### 實作練習
- 設定多個環境（dev、staging、prod）
- 建立 Managed Identity 驗證
- 實作環境專屬的設定
...
**💡 章節成果**: 部署與管理已準備投入生產的多代理 AI 解決方案，含 Customer 與 Inventory 代理
...
> **⚠️ 工作坊狀態：開發中**  
> 工作坊教材目前正在開發與精進中。核心模組可運作，但部分進階章節尚未完成。我們正積極補齊所有內容。[追蹤進度 →](workshop/README.md)

### 互動式工作坊教材
**以瀏覽器為基礎的工具與引導式練習，提供結構化的實作學習體驗**

我們的工作坊教材提供一個結構化、互動的學習體驗，作為上述章節式課程的補充。工作坊適合自學與講師帶領課程。

#### 🛠️ 工作坊特色
- **瀏覽器介面**: 完整由 MkDocs 驅動的工作坊，具搜尋、複製與主題功能
- **GitHub Codespaces 整合**: 一鍵建立開發環境
- **結構化學習路徑**: 7 步驟引導練習（共 3.5 小時）
- **發現 → 部署 → 客製化**: 進階式方法論
- **互動 DevContainer 環境**: 預先設定的工具與相依性

#### 📚 工作坊結構
工作坊遵循 **發現 → 部署 → 客製化** 的方法論：
...
- **實作安全最佳實務**: 設定認證與存取控制
- **為擴充性最佳化**: 設計具成本效益且效能良好的部署
- **排解部署問題**: 能獨立解決常見問題

#### 📖 工作坊資源
- **🎥 互動指南**: [Workshop Materials](workshop/README.md) - 瀏覽器式學習環境
- **📋 逐步指引**: [Guided Exercises](../../workshop/docs/instructions) - 詳細操作流程
- **🛠️ AI 工作坊實驗室**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - AI 專注練習
- **💡 快速上手**: [Workshop Setup Guide](workshop/README.md#quick-start) - 環境設定

**適合對象**: 公司訓練、大學課程、自主學習與開發者訓練營。
...
- **範本式部署** - 使用預先建立的範本來應對常見應用模式
- **基礎設施即程式碼** - 使用 Bicep 或 Terraform 管理 Azure 資源  
- **整合式工作流程** - 無縫地佈建、部署與監控應用
- **對開發者友善** - 優化以提升開發者生產力與體驗

### **AZD + Microsoft Foundry：AI 部署的理想組合**

**為何選擇 AZD 作為 AI 解決方案？** AZD 可解決 AI 開發者面臨的主要挑戰：

- **AI 就緒範本** - 為 Azure OpenAI、Cognitive Services 與 ML 工作負載預先配置的範本
- **安全的 AI 部署** - 內建 AI 服務、API 金鑰與模型端點的安全模式  
- **生產級 AI 模式** - 可擴充且具成本效益的 AI 應用部署最佳實務
- **端到端 AI 工作流程** - 從模型開發到生產部署並搭配適當監控
- **成本最佳化** - 為 AI 工作負載設計智慧的資源配置與自動縮放策略
- **與 Microsoft Foundry 整合** - 與 Microsoft Foundry 模型目錄與端點無縫連線
...
> **注意：** 這些範本示範各種 AI 模式。有些為外部 Azure Samples，另一些為本地實作。
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | 第5章 | ⭐⭐⭐⭐ | 含 Customer 與 Inventory 代理的多代理架構 |
...
#### 本地範例（可立即使用）
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - 完整生產就緒實作，含 ARM 範本
...
### 快速參考
- [**指令速查表**](resources/cheat-sheet.md) - 重要的 azd 指令，按章節分類
- [**術語表**](resources/glossary.md) - Azure 與 azd 術語  
- [**常見問題**](resources/faq.md) - 按學習章節分類的常見問題
- [**學習指南**](resources/study-guide.md) - 完整的實作練習

### 實作工作坊
- [**AI 工作坊實驗室**](docs/microsoft-foundry/ai-workshop-lab.md) - 讓你的 AI 解決方案能用 AZD 部署（2-3 小時）
- [**互動式工作坊指南**](workshop/README.md) - 以瀏覽器為基礎的工作坊，使用 MkDocs 與 DevContainer 環境
- [**結構化學習路徑**](../../workshop/docs/instructions) -7 步驟指引練習（探索 → 部署 → 客製化）
...
- **學習疑問**： [Microsoft Azure Discord 社群](https://discord.gg/microsoft-azure) 以及 [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- **主要挑戰**：多服務部署、憑證管理、上線準備性  
- **最常被要求**：AI 專用範本、疑難排解指南、最佳實務
...
### 授權
本專案以 MIT 授權條款授權 - 詳情請見 [LICENSE](../../LICENSE) 檔案。
...
**初學者**：請從 [第 1 章：基礎與快速上手](../..)  
**AI 開發者**：請前往 [第 2 章：以 AI 為先的開發](../..)  
**有經驗的開發者**：請從 [第 3 章：設定與驗證](../..)
...
免責聲明：
本文件已使用 AI 翻譯服務 Co-op Translator (https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們力求準確，但請注意，自動翻譯可能包含錯誤或不準確之處。原始語言的文件應視為具權威性的版本。如涉及重要資訊，建議採用專業人工翻譯。我們對於因使用本翻譯而引起的任何誤解或曲解概不負責。
