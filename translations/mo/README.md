...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T10:24:56+00:00",
...
透過有結構的章節掌握 Azure Developer CLI (azd)，逐步學習。**特別聚焦於使用 Microsoft Foundry 整合進行 AI 應用程式部署。**
...
- **🛠️ 實踐操作**：[您的第一個專案](docs/getting-started/first-project.md) - 步驟教學
...
**💡 章節成果**：部署並管理具備客戶及庫存代理的生產級多代理人工智能解決方案  
...
> **⚠️ 工作坊狀態：開發中**  
> 工作坊材料目前正在開發和完善中。核心模組已可使用，但部分高級章節尚未完成。我們正積極努力完成所有內容。[追蹤進度 →](workshop/README.md)  

### 互動式工作坊材料  
**透過瀏覽器工具和指導練習進行全面的實踐學習**  

我們的工作坊材料提供結構化的互動學習體驗，補充上述章節式課程。工作坊設計適合自學和講師指導課程。  

#### 🛠️ 工作坊特色  
- **瀏覽器介面**：完整的 MkDocs 驅動工作坊，具備搜尋、複製及主題功能  
- **GitHub Codespaces 整合**：一鍵設置開發環境  
- **結構化學習路徑**：7步指導練習（共3.5小時）  
- **探索 → 部署 → 自訂**：漸進式方法  
...
Azure Developer CLI (azd) 是一個以開發者為中心的命令行介面，加速應用程序在 Azure 上的構建和部署過程。它提供：  

- **基於模板的部署** - 使用預構建模板應對常見應用模式  
- **基礎設施即代碼** - 使用 Bicep 或 Terraform 管理 Azure 資源  
- **整合工作流程** - 無縫配置、部署和監控應用程序  
- **開發者友好** - 為開發者生產力和體驗而優化  
...
- **AI 就緒模板** - 為 Azure OpenAI、認知服務和 ML 工作負載預配置模板  
- **安全 AI 部署** - 內建 AI 服務的安全模式、API 密鑰和模型端點  
- **生產 AI 模式** - 可擴展且成本效益高的 AI 應用部署最佳實踐  
- **端到端 AI 工作流程** - 從模型開發到生產部署，配備完善的監控  
- **成本優化** - 智能資源分配和擴展策略，適用於 AI 工作負載  
- **Microsoft Foundry 整合** - 無縫連接至 Microsoft Foundry 模型目錄和端點  
...
| 模板 | 章節 | 複雜度 | 服務 | 類型 |  
|----------|---------|------------|----------|------|  
| [**開始 AI 聊天**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 第二章 | ⭐⭐ | AzureOpenAI + Azure AI 模型推理 API + Azure AI 搜索 + Azure 容器應用 + 應用洞察 | 外部 |  
| [**開始 AI 代理**](https://github.com/Azure-Samples/get-started-with-ai-agents) | 第二章 | ⭐⭐ | Azure AI 代理服務 + AzureOpenAI + Azure AI 搜索 + Azure 容器應用 + 應用洞察 | 外部 |  
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | 第二章 | ⭐⭐ | RAG 實現與 Azure AI 搜索 |  
...
> **📌 本地 vs. 外部範例：**  
> **本地範例**（此存儲庫中）= 可立即使用  
> **外部範例**（Azure 範例）= 從鏈接的存儲庫克隆  

#### 本地範例（可立即使用）  
- [**零售多代理解決方案**](examples/retail-scenario.md) - 使用 ARM 模板的完整生產級實現  
  - 多代理架構（客戶 + 庫存代理）  
  - 全面監控與評估  
  - 一鍵部署通過 ARM 模板  
...
- [企業 ML 管道](https://github.com/Azure-Samples/mlops-v2) - 生產級 ML 模式  
...
### 快速參考  
- [**指令速查表**](resources/cheat-sheet.md) - 按章節整理的重要 azd 指令
- [**術語表**](resources/glossary.md) - Azure 和 azd 的術語  
- [**常見問題解答**](resources/faq.md) - 按學習章節整理的常見問題
- [**學習指南**](resources/study-guide.md) - 全面的練習題目

### 實作工作坊
- [**AI 工作坊實驗**](docs/microsoft-foundry/ai-workshop-lab.md) - 讓您的 AI 解決方案可用 AZD 部署 (2-3 小時)
