...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T14:52:10+00:00",
...
歡迎來到 Azure Developer CLI (azd) 的全面指南。本儲存庫旨在幫助各個層級的開發者，從學生到專業開發者，學習並掌握 Azure Developer CLI，以便高效進行雲端部署，**特別是針對使用 Azure AI Foundry 的 AI 應用部署**。此結構化學習資源提供 Azure 雲端部署的實作經驗、常見問題的排解，以及成功部署 AZD 模板的最佳實踐。
...
- **基於模板的部署** - 使用預建模板來應對常見的應用模式
- **基礎架構即程式碼** - 使用 Bicep 或 Terraform 管理 Azure 資源
- **整合工作流程** - 無縫配置、部署及監控應用
- **友好的開發者體驗** - 專為提升開發者生產力而設計
...
| 模板 | 描述 | 複雜度 | 服務 |  
|----------|-------------|------------|----------|  
| [**開始使用 AI 聊天**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 使用 Azure Container Apps 建立並部署整合您的資料及遙測洞察的基本聊天應用程式 |⭐⭐ | AzureOpenAI + Azure AI 模型推理 API + Azure AI 搜尋 + Azure Container Apps + 應用程式洞察 |  
| [**開始使用 AI 代理**](https://github.com/Azure-Samples/get-started-with-ai-agents) | 使用 Azure Container Apps 建立並部署具有動作及遙測洞察的基本代理應用程式 |⭐⭐ | Azure AI 代理服務 + AzureOpenAI + Azure AI 搜尋 + Azure Container Apps + 應用程式洞察 |  
...
| [**從您的資料生成文件**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 加速生成如合約、發票及投資提案等文件，透過尋找及摘要化您的資料中的相關資訊 |⭐⭐⭐ | AzureOpenAI + Azure AI 搜尋 + Azure AI 服務 + Azure CosmosDB |  
| [**使用代理改善客戶會議**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 利用一組代理將舊版程式碼遷移至現代語言 |⭐⭐⭐ | AzureOpenAI + Azure AI 搜尋 + Azure CosmosDB + Azure SQL Database |  
| [**使用代理現代化您的程式碼**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 使用 Azure Container Apps 建立並部署整合您的資料及遙測洞察的基本聊天應用程式 |⭐⭐⭐ | AzureOpenAI + Azure 代理服務 + Semantic Kernel + Azure CosmosDB + Azure Container Apps |  
| [**建立您的對話代理**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 利用進階對話理解，建立及增強具有確定性及人類可控工作流程的聊天機器人及代理 |⭐⭐⭐ | AI Language + AzureOpenAI + AI 搜尋 + Azure Storage + Azure Container Registry |  
| [**從對話資料中解鎖洞察**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 透過進階內容理解功能，從大量音頻及文字資料集中發掘洞察，提升聯絡中心效率 |⭐⭐⭐ | AzureOpenAI + AI 搜尋 + Semantic Kernel + Azure 代理服務 + AI AI 內容理解 |  
| [**多模態內容處理**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 快速且準確地處理索賠、發票、合約及其他文件，透過從非結構化內容中提取資訊並映射至結構化格式。此模板支援文字、圖片、表格及圖表 |⭐⭐⭐⭐ | AzureOpenAI + Azure 內容理解 + Azure CosmosDB + Azure Container Apps |  
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | 支援 RAG 的聊天應用程式，使用 Azure OpenAI | ⭐⭐ | AzureOpenAI + 搜尋 + 應用程式服務 |  
...
### 實作實驗室與工作坊  
- [**AI 工作坊實驗室**](docs/ai-foundry/ai-workshop-lab.md) - **全新**：讓您的 AI 解決方案可 AZD 部署  
...
- [**全新** 初學者模型上下文協議 (MCP)](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)  
- [初學者 AI 代理](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)  
...
- [初學者網路安全](https://github.com/microsoft/Security-101??WT.mc_id=academic-96948-sayoung)  
