...
graph TB
    ...
    LB --> WebApp[வலை முன்புறம்<br/>கண்டெய்னர் பயன்பாடு]
    
    WebApp --> Router[முகவர் ரவுட்டர்<br/>கண்டெய்னர் பயன்பாடு]
    Router --> CustomerAgent[வாடிக்கையாளர் முகவர்<br/>வாடிக்கையாளர் சேவை]
    Router --> InvAgent[சரக்கு முகவர்<br/>பங்கு மேலாண்மை]
    
    CustomerAgent --> OpenAI1[Azure OpenAI<br/>GPT-4o<br/>கிழக்கு US 2]
    InvAgent --> OpenAI2[Azure OpenAI<br/>GPT-4o-mini<br/>மேற்கு US 2]
    
    CustomerAgent --> AISearch[Azure AI தேடல்<br/>தயாரிப்பு பட்டியல்]
    CustomerAgent --> BingSearch[Bing தேடல் API<br/>நேரடி தகவல்]
    InvAgent --> AISearch
    
    AISearch --> Storage[Azure சேமிப்பு<br/>ஆவணங்கள் & கோப்புகள்]
    Storage --> DocIntel[ஆவண நுண்ணறிவு<br/>உள்ளடக்க செயலாக்கம்]
    
    OpenAI1 --> Embeddings[உரை எம்பெட்ங்ஸ்<br/>ada-002<br/>பிரான்ஸ் மத்திய]
    OpenAI2 --> Embeddings
    
    Router --> AppInsights[பயன்பாட்டு பார்வைகள்<br/>மேலாண்மை]
    CustomerAgent --> AppInsights
    InvAgent --> AppInsights
    
    GraderModel[GPT-4o தரவரிசை<br/>சுவிட்சர்லாந்து வடக்கு] --> Evaluation[மதிப்பீட்டு கட்டமைப்பு]
    RedTeam[சிகப்பு குழு ஸ்கேனர்] --> SecurityReports[பாதுகாப்பு அறிக்கைகள்]
    
    subgraph "தரவு அடுக்கு"
        Storage
        AISearch
        CosmosDB[காஸ்மோஸ் DB<br/>அரட்டை வரலாறு]
    end
    ...
    subgraph "மேலாண்மை & பாதுகாப்பு"
        AppInsights
        LogAnalytics[பதிவு பகுப்பாய்வு பணிமனை]
        KeyVault[Azure முக்கிய களஞ்சியம்<br/>ரகசியங்கள் & அமைப்புகள்]
        RedTeam
        Evaluation
    end
...
- ✅ **Azure Storage** ஆவண மற்றும் பதிவேற்ற கொண்டெயினர்களுடன்
- ✅ **Container Apps Environment** தானியங்கி அளவீடு கொண்ட
- ✅ **Agent Router & Frontend** கொண்டெயினர் பயன்பாடுகள்
...
[![Azure க்கு விநியோகிக்க](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fmicrosoft%2Fazd-for-beginners%2Fmain%2Fexamples%2Fretail-multiagent-arm-template%2Fazuredeploy.json)
