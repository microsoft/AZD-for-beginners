...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-16T01:15:20+00:00",
...
- **🛠️ Лабораторія**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - підготуйте AI-рішення для AZD
...
- **💰 Вибір**: [Вибір SKU](docs/pre-deployment/sku-selection.md) - Вартісно ефективні рішення
...
- Моніторинг та оптимізація вартості
...
- **Оптимізувати масштабування**: Проєктувати вартісно ефективні та продуктивні розгортання
...
- **Безпечне розгортання AI** — Вбудовані патерни безпеки для AI-сервісів, API-ключів та кінцевих точок моделей  
- **Виробничі AI-патерни** — Кращі практики для масштабованих, вартісно ефективних AI-додатків
...
- [**Часті питання**](resources/faq.md) - Поширені запитання, організовані за розділами для навчання  
...
- Документація Azure Developer CLI: [Azure Developer CLI Documentation](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)  
- Центр архітектури Azure: [Azure Architecture Center](https://learn.microsoft.com/en-us/azure/architecture/)  
- Калькулятор цін Azure: [Azure Pricing Calculator](https://azure.microsoft.com/pricing/calculator/)  
- Статус Azure: [Azure Status](https://status.azure.com/)  
...
Відстежуйте свій навчальний прогрес по кожному розділу:
...
### Внесок у курс  
Ми вітаємо внески! Будь ласка, ознайомтеся з нашим [Посібником для внесків](CONTRIBUTING.md) для деталей:  
