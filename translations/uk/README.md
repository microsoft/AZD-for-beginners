...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T13:36:58+00:00",
...
Виконайте наступні кроки, щоб розпочати навчання з AZD:
...
- **Вирішуватимете проблеми розгортання**: Виправлення поширених помилок та налагодження
...
- **🛠️ Лабораторія**: [Лабораторія AI](docs/ai-foundry/ai-workshop-lab.md) - Підготовка AI-рішень до AZD
...
**💡 Результат розділу**: Розгорніть та налаштуйте AI-додаток з функціями RAG
...
- Встановіть автентифікацію через керовану ідентичність
- Реалізуйте конфігурації, специфічні для середовища

**💡 Результат розділу**: Управляйте кількома середовищами з правильною автентифікацією та безпекою
...
- Розгорніть додатки з кількома сервісами
- Реалізуйте стратегії розгортання "синьо-зелене"

**💡 Результат розділу**: Розгорніть складні додатки з кількома сервісами, використовуючи власні шаблони інфраструктури
...
**💡 Результат розділу**: Розгорніть та керуйте рішенням з багатьма агентами, готовим до продакшн, з агентами для клієнтів та інвентаризації
...
- **🤖 AI-проблеми**: [Вирішення проблем AI](docs/troubleshooting/ai-troubleshooting.md) - Проблеми з AI-сервісами

#### Практичні вправи
- Діагностуйте помилки розгортання
- Вирішуйте проблеми автентифікації
- Налагоджуйте підключення до AI-сервісів
...
**💡 Результат розділу**: Розгортання додатків, готових до використання в корпоративному середовищі, з повними можливостями для продакшну
...
- **Розгортання на основі шаблонів** - Використовуйте готові шаблони для поширених архітектур додатків
- **Інфраструктура як код** - Керуйте ресурсами Azure за допомогою Bicep або Terraform  
- **Інтегровані робочі процеси** - Безперешкодно забезпечуйте, розгортайте та моніторте додатки
...
- **Шаблони для продакшну AI** - Найкращі практики для масштабованих та економічно ефективних AI-додатків
- **Повні робочі процеси AI** - Від розробки моделі до розгортання в продакшн із належним моніторингом
- **Оптимізація витрат** - Розумні стратегії розподілу ресурсів і масштабування для AI-навантажень
- **Інтеграція з Azure AI Foundry** - Безперешкодне підключення до каталогу моделей Foundry та кінцевих точок
...
| [**Автоматизація робочих процесів з мультиагентами**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Розділ 5 | ⭐⭐⭐ | AzureOpenAI + Azure AI Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
...
| [**Створіть свого розмовного агента**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Розділ 4 | ⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Azure Storage + Azure Container Registry|
| [**Розкрийте інсайти з розмовних даних**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Розділ 8 | ⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
...
- [Контейнерні додатки](../../examples/container-app) - Розгортання контейнерів
...
- [**Azure-Samples AZD Templates**](https://github.com/Azure-Samples/azd-templates) - Офіційні приклади від Microsoft
- [**Awesome AZD Gallery**](https://azure.github.io/awesome-azd/) - Шаблони, створені спільнотою
...
### Практичні воркшопи
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - Зробіть ваші AI-рішення готовими до розгортання через AZD
- [**AZD For Beginners Workshop**](workshop/README.md) - Повні матеріали для практичного воркшопу
...
- [ ] **Розділ 5**: Рішення з мультиагентами AI ✅
- [ ] **Розділ 6**: Перевірка перед розгортанням та планування ✅
...
2. **Перевірка знань**: Перегляньте розділ FAQ
...
- **Досвід продакшну**: Розгорнуті реальні AI-додатки в Azure
- **Професійні навички**: Можливості розгортання, готові до корпоративного середовища  
...
### Отримайте допомогу та підтримку
- **Технічні проблеми**: [Повідомте про помилки та запитайте функції](https://github.com/microsoft/azd-for-beginners/issues)
- **Навчальні запитання**: [Спільнота Microsoft Azure Discord](https://discord.gg/microsoft-azure)
- **Допомога з AI**: Приєднуйтесь до [#Azure каналу](https://discord.gg/microsoft-azure) для обговорень AZD + AI Foundry
...
**Останні результати опитування з #Azure каналу:**
...
- Поділитися досвідом AZD + AI та отримати допомогу
- Отримати ранній доступ до нових шаблонів AI
- Сприяти найкращим практикам розгортання AI
- Впливати на майбутній розвиток функцій AI + AZD

### Внесок у курс
Ми вітаємо внески! Ознайомтеся з нашим [Посібником з внесків](CONTRIBUTING.md) для деталей про:
...
- **Повідомлення про помилки**: Поліпшення точності та ясності
...
- [Опанування GitHub Copilot для парного програмування AI](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
**Розробники AI**: Перейдіть до [Розділу 2: Розробка з фокусом на AI](../..)
