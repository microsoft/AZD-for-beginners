...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T12:57:37+00:00",
...
# Задавати питання та отримувати відповіді з підтримкою AI і джерелами
...
**Продакшн середовище (приблизно $300-3,500+/місяць):**
- Azure OpenAI (PTU для стабільної продуктивності): $3,000+/місяць АБО оплата за використання з високим обсягом
...
- Починайте з оплати за використання, переходьте на PTU лише для продакшн
...
- **🔐 Безпека**: [Шаблони автентифікації та керованої ідентичності](docs/getting-started/authsecurity.md) - Шаблони автентифікації
...
**💡 Результат розділу**: Управління кількома середовищами з належною автентифікацією та безпекою
...
- **📝 Приклади**: [Приклад додатку в контейнері](../../examples/container-app) - Розгортання в контейнерах
...
**💡 Результат розділу**: Розгорнути та керувати готовим до виробництва мультиагентним AI-рішенням із агентами для клієнтів та інвентаризації
...
#### Практичні вправи
- Запустіть скрипти перевірки потужностей
- Оптимізуйте вибір SKU для економії
...
- Налагодження, специфічне для AI
...
- **🤖 Проблеми AI**: [Налагодження AI](docs/troubleshooting/ai-troubleshooting.md) - Проблеми з AI-сервісами

#### Практичні вправи
- Діагностуйте збої розгортання
- Вирішіть проблеми з автентифікацією
- Налагодьте підключення до AI-сервісів
...
#### Чого ви навчитеся
- Стратегії розгортання у виробництво
...
- Розгорніть у виробництво з належним управлінням

**💡 Результат розділу**: Розгорнути корпоративні додатки з повними виробничими можливостями
...
> Матеріали воркшопу наразі розробляються та вдосконалюються. Основні модулі функціональні, але деякі розширені розділи ще не завершені. Ми активно працюємо над завершенням усього контенту. [Відстежити прогрес →](workshop/README.md)

### Інтерактивні матеріали воркшопу
**Комплексне практичне навчання з інструментами у браузері та керованими вправами**

Наші матеріали воркшопу забезпечують структурований, інтерактивний навчальний досвід, який доповнює навчальну програму, описану вище. Воркшоп розроблений як для самостійного навчання, так і для занять під керівництвом інструктора.

#### 🛠️ Особливості воркшопу
- **Інтерфейс у браузері**: Повний воркшоп на основі MkDocs з функціями пошуку, копіювання та тем
...
1. **Фаза відкриття** (45 хвилин)
   - Дослідження шаблонів та сервісів Microsoft Foundry
   - Розуміння шаблонів архітектури мультиагентів
   - Огляд вимог та передумов для розгортання
...
- **Опанувати мультиагентні архітектури**: Реалізовувати скоординовані рішення AI-агентів
- **Реалізовувати найкращі практики безпеки**: Налаштовувати автентифікацію та контроль доступу
- **Оптимізувати для масштабування**: Проектувати економічно ефективні, продуктивні розгортання
...
- **💡 Швидкий старт**: [Посібник із налаштування воркшопу](workshop/README.md#quick-start) - Налаштування середовища
...
- **Розгортання на основі шаблонів** - Використовуйте попередньо створені шаблони для поширених шаблонів додатків
- **Інфраструктура як код** - Керуйте ресурсами Azure за допомогою Bicep або Terraform  
- **Інтегровані робочі процеси** - Безперешкодно забезпечуйте, розгортайте та моніторьте додатки
...
- **Повні AI-робочі процеси** - Від розробки моделі до розгортання у виробництво з належним моніторингом
...
> **Примітка:** Ці шаблони демонструють різні AI-шаблони. Деякі є зовнішніми прикладами Azure, інші — локальними реалізаціями.
...
| [**Рішення для роздрібної торгівлі з мультиагентами**](examples/retail-scenario.md) | Розділ 5 | ⭐⭐⭐⭐ | AzureOpenAI + AI Search + Storage + Container Apps + Cosmos DB | **Локальний** |
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Розділ 5 | ⭐⭐⭐⭐ | Архітектура мультиагентів із агентами для клієнтів та інвентаризації |
...
- [**Рішення для роздрібної торгівлі з мультиагентами**](examples/retail-scenario.md) - Повна реалізація, готова до виробництва, з ARM-шаблонами
  - Архітектура мультиагентів (агенти для клієнтів + інвентаризації)
...
- [**Приклади контейнерних додатків**](examples/container-app/README.md) - Повний посібник із розгортання контейнерів
  ...
  - [Архітектура мікросервісів](../../examples/container-app/microservices) - Готове до виробництва розгортання багатосервісних додатків
...
- [Простий веб-додаток - Node.js + MongoDB](https://github.com/Azure-Samples/todo-nodejs-mongo) - Основні шаблони розгортання
...
- [**Часті запитання**](resources/faq.md) - Поширені запитання, організовані за розділами навчання
- [**Навчальний посібник**](resources/study-guide.md) - Комплексні практичні вправи

### Практичні майстер-класи
- [**Лабораторія AI Workshop**](docs/microsoft-foundry/ai-workshop-lab.md) - Зробіть свої AI-рішення готовими до розгортання через AZD (2-3 години)
- [**Інтерактивний посібник для майстер-класу**](workshop/README.md) - Майстер-клас у браузері з використанням MkDocs та DevContainer Environment
- [**Структурований навчальний шлях**](../../workshop/docs/instructions) - 7 кроків вправ (Відкриття → Розгортання → Налаштування)
- [**Майстер-клас для початківців з AZD**](workshop/README.md) - Повний набір матеріалів для практичного навчання з інтеграцією GitHub Codespaces
...
**Поширені проблеми, з якими стикаються початківці, та їх швидкі рішення:**
...
### ❌ "azd up" зупиняється на півдорозі
...
- AI-додатки: 15-25 хвилин (підготовка OpenAI займає більше часу)
...
<details>
<summary><strong>❌ "azd up" зупиняється на півдорозі</strong></summary>
...
- **Практичний досвід**: Розгорнуті реальні AI-додатки в Azure
...
- **Кар'єрний ріст**: Затребувані навички розгортання AZD та AI
...
- **Питання щодо навчання**: [Спільнота Microsoft Azure Discord](https://discord.gg/microsoft-azure) та [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
**Останні результати опитувань у каналі #Azure:**
- **45%** розробників хочуть використовувати AZD для AI-навантажень
- **Основні виклики**: Розгортання кількох сервісів, управління обліковими даними, готовність до виробництва  
- **Найбільш запитуване**: AI-шаблони, посібники з усунення несправностей, найкращі практики
...
### Внесок у курс
Ми вітаємо ваші внески! Будь ласка, ознайомтеся з нашим [Посібником для учасників](CONTRIBUTING.md) для отримання інформації про:
...
- **Звіти про помилки**: Підвищення точності та ясності
...
**Розробники AI**: Перейдіть до [Розділу 2: Розробка з акцентом на AI](../..)  
**Досвідчені розробники**: Почніть з [Розділу 3: Налаштування та автентифікація](../..)
