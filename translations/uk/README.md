...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T14:32:11+00:00",
...
- **Розгорнете AI-застосунки**: використання AZD з сервісами Microsoft Foundry
...
- **🛠️ Практика**: [Ваш перший проєкт](docs/getting-started/first-project.md) - покрокове керівництво
- **📋 Шпаргалка**: [Командний довідник](resources/cheat-sheet.md)
...
**💰 Усвідомлення витрат:** Розуміння витрат на розробку $80-150/місяць, виробничих $300-3500/місяць
...
#### Навчальні ресурси
- **🤖 Особливий проєкт**: [Роздрібне мультиагентне рішення](examples/retail-scenario.md) - повна реалізація
...
#### Практичні вправи
```bash
# Розгорнути повне роздрібне мультиагентне рішення
...
**💡 Результат розділу**: Розгорнути та керувати готовим до виробництва багатокористувацьким AI-рішенням з агентами Customer та Inventory
...
#### Навчальні ресурси
- **📊 Планування**: [Capacity Planning](docs/pre-deployment/capacity-planning.md) - Валідація ресурсів
- **💰 Вибір**: [SKU Selection](docs/pre-deployment/sku-selection.md) - Вигідні варіанти
...
#### Навчальні ресурси
- **🔧 Поширені проблеми**: [Common Issues](docs/troubleshooting/common-issues.md) - FAQ та рішення
- **🕵️ Налагодження**: [Debugging Guide](docs/troubleshooting/debugging.md) - Покрокові стратегії
- **🤖 AI-проблеми**: [AI-Specific Troubleshooting](docs/troubleshooting/ai-troubleshooting.md) - Проблеми AI-сервісів
...
> Матеріали воркшопу наразі розробляються та вдосконалюються. Основні модулі працюють, але деякі розділи ще не завершені. Ми активно працюємо над повним завершенням контенту. [Відстежити прогрес →](workshop/README.md)

### Інтерактивні матеріали воркшопу
**Повноцінне практичне навчання з браузерними інструментами та покроковими вправами**

Наші матеріали воркшопу забезпечують структурований, інтерактивний досвід навчання, що доповнює навчальну програму за розділами вище. Воркшоп розрахований як на самостійне навчання, так і на заняття під керівництвом інструктора.
...
- **Опанувати багатокористувацькі архітектури**: Реалізувати скоординовані AI-агентські рішення
- **Впроваджувати найкращі практики безпеки**: Налаштовувати автентифікацію та контроль доступу
- **Оптимізувати масштабування**: Проєктувати вигідні та продуктивні розгортання
- **Вирішувати проблеми розгортання**: Самостійно усувати поширені помилки

#### 📖 Ресурси воркшопу
- **🎥 Інтерактивний посібник**: [Workshop Materials](workshop/README.md) - Навчальне середовище у браузері
- **📋 Покрокові інструкції**: [Guided Exercises](../../workshop/docs/instructions) - Детальні покрокові керівництва
- **🛠️ AI Workshop Lab**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - AI-орієнтовані вправи
- **💡 Швидкий старт**: [Workshop Setup Guide](workshop/README.md#quick-start) - Налаштування середовища

**Ідеально для**: Корпоративного навчання, університетських курсів, самостійного вивчення та буткемпів для розробників.
...
- **Зручність для розробника** — Оптимізовано для продуктивності та зручності розробки
...
- **Виробничі AI-шаблони** — Найкращі практики для масштабованих та економічних AI-додатків
...
|----------|------------------|------------|--------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Розділ 2 | ⭐ | Базові шаблони AI-розгортання |
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Розділ 5 | ⭐⭐⭐⭐ | Архітектура багатокористувацьких агентів з Customer та Inventory |
...
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Повна готова до виробництва реалізація з ARM шаблонами
  - Архітектура багатокористувацьких агентів (Customer + Inventory)
...
- [**Container App Examples**](examples/container-app/README.md) - Повний посібник з розгортання контейнерів
  ...
  - Шаблони швидкого старту, виробничі та розширені
...
- [Functions + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - Серверлес-робочі процеси з даними

#### Зовнішні приклади - Розширені шаблони (Розділи 4-8)
...
### ❌ "Ресурс вже існує" або конфлікти імен
...
**Розробники AI**: Перейдіть до [Розділ 2: Розробка з пріоритетом AI](../..)  
