...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:49:19+00:00",
...
1. **Зробіть форк репозиторію**: Натисніть [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Клонуйте репозиторій**:   `git clone https://github.com/microsoft/azd-for-beginners.git`
3. [**Приєднуйтесь до спільнот Azure Discord та знайомтеся з експертами та іншими розробниками**](https://discord.com/invite/ByRwuEEgH4)
...
- Отримаєте впевненість у розгортанні готових до продакшну додатків на Azure
...
- **Повні AI-робочі процеси** - Від розробки моделі до розгортання в продакшн із належним моніторингом
...
4. Досліджуйте [Приклад додатку в контейнері](../../examples/container-app)
...
- [**Найкращі практики для AI у продакшні**](docs/ai-foundry/production-ai-practices.md) - Безпека, масштабування та моніторинг AI-навантажень
...
| [**Автоматизація робочих процесів з багатьма агентами**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Покращуйте планування завдань та автоматизацію, оркеструючи та керуючи групою AI-агентів.|⭐⭐⭐ | AzureOpenAI + Azure AI Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
| [**Генерація документів з ваших даних**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Прискорюйте створення документів, таких як контракти, рахунки та інвестиційні пропозиції, знаходячи та підсумовуючи релевантну інформацію з ваших даних. |⭐⭐⭐  | AzureOpenAI + Azure AI Search + Azure AI Services + Azure CosmosDB|
...
| [**Розкрийте інсайти з розмовних даних**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Покращуйте ефективність контакт-центрів, виявляючи інсайти з великих аудіо- та текстових наборів даних, використовуючи розширені можливості розуміння контенту. |⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
...
### Рекомендовано: Сценарії Azure AI Foundry E2E
**Почніть тут, якщо розгортаєте AI-додатки!**
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | Додаток чату з підтримкою RAG та Azure OpenAI | ⭐⭐ | AzureOpenAI + Search + App Service |
...
- [**Шаблони AZD від Azure-Samples**](https://github.com/Azure-Samples/azd-templates) - Офіційні шаблони від Microsoft  
...
- [**Воркшоп для початківців з AZD**](workshop/README.md) - Зосередження на розгортанні шаблонів AI-агентів через AZD
...
- **Найбільш запитуване**: Шаблони, специфічні для AI, посібники з вирішення проблем, найкращі практики

**Приєднуйтесь до нашої спільноти, щоб:**
- Ділитися своїм досвідом використання AZD + AI та отримувати допомогу
- Отримувати ранній доступ до нових шаблонів AI
