...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T15:23:11+00:00",
...
На основі даних спільноти Azure AI Foundry Discord, **45% розробників хочуть використовувати AZD для AI-навантажень**, але стикаються з труднощами:
...
- **Вирішуватимете проблеми розгортання**: Вирішення поширених проблем і налагодження
- **Оптимізуєте для продакшн**: Безпека, масштабування, моніторинг і управління витратами
- **Створите рішення з багатьма агентами**: Розгортання складних AI-архітектур
...
- **⚙️ Налаштування**: [Встановлення та налаштування](docs/getting-started/installation.md) - Посібники для конкретних платформ
...
**💡 Результат розділу**: Розгорнути та налаштувати AI-додаток з функціями RAG
...
#### Що ви дізнаєтесь
- Управління конфігурацією середовища
...
- **📝 Приклади**: [Приклад додатку з базою даних](../../examples/database-app) - Шаблони конфігурації
...
- **📝 Приклади**: [Приклад додатку в контейнері](../../examples/container-app) - Розгортання контейнерів

#### Практичні вправи
- Створення власних шаблонів Bicep
- Розгортання додатків з кількома сервісами
- Реалізація стратегій розгортання "синьо-зелене"

**💡 Результат розділу**: Розгортання складних додатків з кількома сервісами за допомогою власних шаблонів інфраструктури
...
#### Навчальні ресурси
- **🤖 Рекомендований проєкт**: [Рішення для роздрібної торгівлі з багатьма агентами](examples/retail-scenario.md) - Повна реалізація
...
**💡 Результат розділу**: Розгортання та управління рішенням з багатьма агентами для продакшн з агентами клієнтів та інвентаризації
...
#### Практичні вправи
- Реалізація шаблонів безпеки для підприємств
...
- **Інтерфейс у браузері**: Воркшоп на основі MkDocs з функціями пошуку, копіювання та зміни теми
- **Інтеграція з GitHub Codespaces**: Налаштування середовища розробки в один клік
- **Структурований навчальний шлях**: 7 етапів керованих вправ (загалом 3,5 години)
...
1. **Фаза відкриття** (45 хвилин)
   - Дослідження шаблонів та сервісів Azure AI Foundry
...
- **Опанувати архітектури з багатьма агентами**: Реалізовувати скоординовані рішення з AI-агентами
...
- **💡 Швидкий старт**: [Посібник з налаштування воркшопу](workshop/README.md#quick-start) - Налаштування середовища
...
### **AZD + Azure AI Foundry: Ідеально для розгортання AI**
...
- **Безпечне розгортання AI** - Вбудовані шаблони безпеки для AI-сервісів, API-ключів та кінцевих точок моделей  
...
- **Інтеграція з Azure AI Foundry** - Безшовне підключення до каталогу моделей та кінцевих точок AI Foundry
...
| [**Покращення зустрічей з клієнтами за допомогою агентів**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Розділ 5 | ⭐⭐⭐| AzureOpenAI + Azure AI Search + Azure CosmosDB + Azure SQL Database |
...
| [**Обробка мультимедійного контенту**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Розділ 8 | ⭐⭐⭐⭐ | AzureOpenAI + Azure Content Understanding + Azure CosmosDB + Azure Container Apps|

### Рекомендовано: Повні навчальні сценарії
**Шаблони додатків, готових до виробництва, відповідно до навчальних розділів**

| Шаблон | Навчальний розділ | Складність | Основні знання |
|--------|-------------------|------------|----------------|
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Розділ 5 | ⭐⭐⭐⭐ | Архітектура з багатьма агентами для клієнтів та інвентаризації |
...
- [Додаток з базою даних](../../examples/database-app) - Шаблони підключення до бази даних
- [Обробка даних](../../examples/data-processing) - Розгортання ETL-робочих процесів

#### Складні шаблони (Розділи 4-8)
- [Додатки в контейнерах](../../examples/container-app) - Розгортання контейнерів
...
- [**Azure-Samples AZD Templates**](https://github.com/Azure-Samples/azd-templates) - Офіційні зразки Microsoft
- [**Awesome AZD Gallery**](https://azure.github.io/awesome-azd/) - Шаблони від спільноти
...
- [**FAQ**](resources/faq.md) - Поширені запитання, організовані за розділами
...
- [**Структурований навчальний шлях**](../../workshop/docs/instructions) - 7 етапів керованих вправ (Відкриття → Розгортання → Налаштування)
...
Відстежуйте свій прогрес у навчанні через кожен розділ:
...
1. **Практична вправа**: Виконайте практичне розгортання для розділу
2. **Перевірка знань**: Перегляньте розділ FAQ для вашого розділу
3. **Обговорення у спільноті**: Поділіться своїм досвідом у Discord Azure
...
- **Професійні навички**: Можливості розгортання на рівні підприємства  
...
- **Технічні питання**: [Повідомити про помилки та запропонувати функції](https://github.com/microsoft/azd-for-beginners/issues)
- **Питання щодо навчання**: [Спільнота Microsoft Azure
- **Переклад**: Допомагайте підтримувати багатомовну підтримку
