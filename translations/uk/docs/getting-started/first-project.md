...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:52:00+00:00",
...
**Попередній:** [Конфігурація](configuration.md) | **Наступний:** [Інтеграція з Azure AI Foundry](../ai-foundry/azure-ai-foundry-integration.md)
...
### Перевірка передумов
- ✅ Встановлено Azure Developer CLI ([Посібник з установки](installation.md))
...
Розпочнемо з популярного шаблону додатка для управління завданнями, який включає React-фронтенд та бекенд на Node.js.
...
## Крок 3: Налаштування вашого проєкту (опціонально)
...
1. **Додати завдання** - Натисніть "Add Todo" і введіть задачу
2. **Позначити як виконане** - Відмітьте виконані завдання
3. **Видалити завдання** - Видаліть ті, що більше не потрібні
...
Коли ви завершите експерименти, очистіть ресурси, щоб уникнути постійних витрат:
...
### 3. Найкращі практики для продакшн
