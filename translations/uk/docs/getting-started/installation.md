...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:52:26+00:00",
...
**Попередній:** [Основна документація](../../README.md) | **Наступний:** [Основи AZD](azd-basics.md)
...
- Успішно встановити Azure Developer CLI на вашій операційній системі
- Налаштувати автентифікацію з Azure за допомогою різних методів
- Підготувати середовище розробки з необхідними передумовами
- Зрозуміти різні варіанти встановлення та коли їх використовувати
- Вирішувати поширені проблеми з встановленням та налаштуванням
