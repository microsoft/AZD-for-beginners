...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:52:51+00:00",
...
**Попередній:** [AZD Основи](azd-basics.md) | **Наступний:** [Перший проєкт](first-project.md)
...
### Встановлення глобальних параметрів за замовчуванням
```bash
...
- [Посібник з розгортання](../deployment/deployment-guide.md) - Використання конфігурації для розгортання
