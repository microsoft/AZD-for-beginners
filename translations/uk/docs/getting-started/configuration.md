...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T13:45:27+00:00",
...
- Навчитеся керувати кількома середовищами з різними конфігураціями
...
### Поширені глобальні налаштування
```bash
...
Для проектів Terraform налаштування знаходяться у `infra/terraform.tfvars`:
```hcl
...
### 3. Розгляньте питання контролю версій
```bash
# .gitignore
...
Документуйте вашу конфігурацію у файлі `CONFIG.md`:
```markdown
# Configuration Guide
