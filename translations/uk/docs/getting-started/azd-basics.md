...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:53:10+00:00",
...
**Попереднє:** [Встановлення та налаштування](installation.md) | **Наступне:** [Конфігурація](configuration.md)
...
- **Виробництво** - Живе виробниче середовище
...
- Забезпечує безперервне завершення, навіть якщо CLI виявляє невідповідності.
...
Запобігає тому, щоб azd "запам’ятовував" попередні розгортання, що може викликати проблеми, такі як невідповідність груп ресурсів або застарілі посилання на реєстр.
