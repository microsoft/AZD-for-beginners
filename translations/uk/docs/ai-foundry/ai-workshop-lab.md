...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:09:11+00:00",
...
**Попереднє:** [AI Model Deployment](ai-model-deployment.md) | **Наступне:** [Production AI Practices](production-ai-practices.md)

## Огляд воркшопу

Ця практична лабораторія допоможе розробникам пройти процес адаптації існуючого AI-додатку для розгортання за допомогою Azure Developer CLI (AZD). Ви навчитеся основним шаблонам для розгортання AI-рішень у продакшн середовищі, використовуючи сервіси Azure AI Foundry.
...
- ✅ Розгорнути AI-додатки, готові до продакшн, з моніторингом
...
2. **Клонування репозиторію воркшопу:**
```bash
...
2. **Ознайомтеся з основною інфраструктурою main.bicep:**
```bash
cat infra/main.bicep
```

**Основні AI-шаблони для ідентифікації:**
...
**Найкраща практика**: Різні конфігурації для розробки та продакшн.

1. **Створіть продакшн середовище:**
```bash
azd env new myai-production
```

2. **Встановіть параметри для продакшн:**
```bash
...
3. Розгорніть і порівняйте витрати з конфігурацією продакшн
...
## Модуль 4: Безпека та найкращі практики для продакшн
...
**Перед перетворенням вашого додатку**, дайте відповіді на ці питання:
...
**Завдання**: Створіть шаблон AZD для AI-додатку обробки документів.
...
**Сценарій**: Розгортання успішне, але додаток повертає помилки 500.
...
Вам доручено створити готовий до продакшн AI-чатбот для обслуговування клієнтів з такими вимогами:
...
- Розгортання в кількох середовищах (розробка, тестування, продакшн)
...
6. **Задокументуйте рішення**

### Критерії оцінки

- ✅ **Функціональність**: Чи відповідає всім вимогам?
- ✅ **Безпека**: Чи реалізовані найкращі практики?
- ✅ **Масштабованість**: Чи витримує навантаження?
- ✅ **Підтримуваність**
- ✅ Реалізуйте найкращі практики безпеки для робочих навантажень AI
- ✅ Моніторьте та оптимізуйте продуктивність AI-додатків
- ✅ Вирішуйте поширені проблеми розгортання
...
**Попереднє:** [Розгортання AI-моделі](ai-model-deployment.md) | **Наступне:** [Практики AI у продакшені](production-ai-practices.md)
