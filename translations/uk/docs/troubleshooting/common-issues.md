...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T06:30:31+00:00",
...
Цей детальний посібник з усунення несправностей охоплює найпоширеніші проблеми, які виникають під час використання Azure Developer CLI. Дізнайтеся, як діагностувати, усувати та вирішувати типові проблеми з автентифікацією, розгортанням, забезпеченням інфраструктури та конфігурацією додатків. Кожна проблема включає детальні симптоми, причини та покрокові процедури вирішення.

## Цілі навчання

Після завершення цього посібника ви:
- Опануєте техніки діагностики проблем Azure Developer CLI
- Зрозумієте поширені проблеми з автентифікацією та дозволами, а також їх вирішення
- Навчитеся вирішувати помилки розгортання, проблеми з забезпеченням інфраструктури та конфігурацією
- Реалізуєте проактивні стратегії моніторингу та налагодження
- Застосуєте систематичні методології усунення складних проблем
- Налаштуєте правильне ведення журналів і моніторинг для запобігання майбутнім проблемам
...
- Ефективно усувати помилки розгортання та проблеми з забезпеченням інфраструктури
- Налагоджувати проблеми конфігурації додатків та специфічні для середовища проблеми
- Реалізувати моніторинг і оповіщення для проактивного виявлення потенційних проблем
...
## 🏗️ Помилки забезпечення інфраструктури

### Проблема: Конфлікти імен ресурсів
**Симптоми:**
- Помилки "The resource name already exists"
- Розгортання завершується помилками під час створення ресурсів
...
### Проблема: Недоступність локації/регіону
**Симптоми:**
- Помилки "The location 'xyz' is not available for resource type"
...
**Симптоми:**
- Помилки "Quota exceeded for resource type"
...
- Запит заблоковано через політику крос-доменного доступу
...
- [Забезпечення ресурсів](../deployment/provisioning.md) - Усунення несправностей інфраструктури
- [Планування потужностей](../pre-deployment/capacity-planning.md) - Рекомендації щодо планування ресурсів
- [Вибір SKU](../pre-deployment/sku-selection.md) - Рекомендації щодо вибору рівня послуг

---

**Порада**: Збережіть цей посібник у закладках і звертайтеся до нього щоразу, коли стикаєтеся з проблемами. Більшість проблем уже були вирішені раніше і мають встановлені рішення!

---

**Навігація**
- **Попередній урок**: [Забезпечення ресурсів](../deployment/provisioning.md)
