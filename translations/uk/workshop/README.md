...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T13:50:41+00:00",
...
- **🛠️ Практичний лабораторний курс**: [Лабораторія AI](../docs/ai-foundry/ai-workshop-lab.md)
- **🚀 Наступні кроки**: [Модулі лабораторії воркшопу](../../../workshop)
...
- Ваше перше розгортання з AZD
- **Лабораторія**: Розгорніть простий веб-додаток
...
- **Лабораторія**: Розгорніть чат-додаток з GPT-4
...
- **Лабораторія**: Створіть систему запитань і відповідей для документів

### Модуль 4: Розгортання у виробництво (30 хвилин)
- Конфігурація Container Apps
- Оптимізація масштабування та продуктивності
- Моніторинг та логування
- **Лабораторія**: Розгорніть у виробництво з функціями спостереження
...
Запустіть цей скрипт, щоб перевірити налаштування:
...
Кожен модуль включає практичні лабораторії зі стартовим кодом та покроковими інструкціями:

- **[lab-1-azd-basics/](../../../workshop/lab-1-azd-basics)** - Ваше перше розгортання з AZD
...
**Надішліть відгук**: [Форма оцінки воркшопу](https://aka.ms/azd-workshop-feedback)
