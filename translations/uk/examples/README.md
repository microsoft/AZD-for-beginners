...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T07:04:56+00:00",
...
3. **[Додаток у контейнері](../../../examples/container-app)** - Розгортання додатка в контейнері
...
**Складність**: Початковий рівень  
**Концепції**: Статичний хостинг, інтеграція CDN, кастомні домени

### Додаток у контейнері
...
- Інструменти для перевірки розгортання
...
| Додаток у контейнері | 1 | ❌ | Базова | Повна | ⭐⭐ |
...
3. **Перейдіть до додатка в контейнері**
...
- **Контейнери**: Додаток у контейнері, Мікросервіси
...
- **Гібридний**: Додаток у контейнері

### За рівнем складності
- **Початковий рівень**: Простий веб-додаток, Статичний веб-сайт
- **Середній рівень**: Додаток у контейнері, Додаток з базою даних, Серверлес функція  
- **Високий рівень**: Мікросервіси

## 📚 Додаткові ресурси

### Посилання на документацію
- [Специфікація шаблонів AZD](https://aka.ms/azd/templates)
...
**Корисна порада**: Почніть із найпростішого прикладу, який відповідає вашому технологічному стеку, а потім поступово переходьте до більш складних сценаріїв. Кожен приклад базується на концепціях попереднього!
