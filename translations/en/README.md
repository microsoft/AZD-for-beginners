...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-11T09:43:33+00:00",
...
Welcome to the comprehensive guide for Azure Developer CLI (azd). This repository is designed to help developers at all levels, from students to professionals, learn and master Azure Developer CLI for efficient cloud deployments. This structured learning resource provides hands-on experience with Azure cloud deployments, troubleshooting common issues, and implementing best practices for successful AZD template deployments.
...
- [**AZD For Beginners**](workshop/README.md) - This workshop will focus on the Get Started with AI Agents AZD template and provide hands-on best practices for deploying Azure AI services using AZD  
