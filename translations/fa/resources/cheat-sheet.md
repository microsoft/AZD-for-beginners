...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T18:01:41+00:00",
...
این برگه تقلب جامع، مرجع سریعی برای پرکاربردترین دستورات CLI توسعه‌دهنده Azure ارائه می‌دهد که بر اساس دسته‌بندی و مثال‌های عملی سازماندهی شده‌اند. مناسب برای جستجوی سریع در طول توسعه، رفع مشکلات و عملیات روزانه با پروژه‌های azd.

## اهداف یادگیری

با استفاده از این برگه تقلب، شما:
- به دسترسی فوری به دستورات ضروری CLI توسعه‌دهنده Azure و نحوه استفاده از آن‌ها دست پیدا می‌کنید
- سازماندهی دستورات بر اساس دسته‌بندی‌های کاربردی و موارد استفاده را درک می‌کنید
- به مثال‌های عملی برای سناریوهای رایج توسعه و استقرار دسترسی پیدا می‌کنید
- دستورات رفع مشکلات برای حل سریع مسائل را پیدا می‌کنید
