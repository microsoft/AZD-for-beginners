...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:38:11+00:00",
...
**قبلی:** [آزمایشگاه کارگاه هوش مصنوعی](ai-workshop-lab.md) | **بعدی:** [راهنمای رفع اشکال هوش مصنوعی](../troubleshooting/ai-troubleshooting.md)
...
- **۲۹٪** به نظارت و رفع اشکال بهبود یافته نیاز دارند  

## الگوهای معماری برای هوش مصنوعی تولیدی

### الگوی ۱: معماری هوش مصنوعی میکروسرویس‌ها
...
### الگوی ۲: پردازش هوش مصنوعی مبتنی بر رویداد
...
| **استفاده از توکن** | کمتر از ۵۰۰ دلار در ماه | مدیریت هزینه |
...
4. **به طور کامل آزمایش کنید**: آزمایش‌های خاص هوش مصنوعی را در خط لوله خود بگنجانید  
