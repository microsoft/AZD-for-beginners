...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:28:39+00:00",
...
**قبلی:** [استقرار مدل هوش مصنوعی](ai-model-deployment.md) | **بعدی:** [روش‌های تولید هوش مصنوعی](production-ai-practices.md)

## نمای کلی کارگاه

این کارگاه عملی، توسعه‌دهندگان را در فرآیند تبدیل یک برنامه هوش مصنوعی موجود به یک برنامه قابل استقرار با استفاده از Azure Developer CLI (AZD) راهنمایی می‌کند. شما الگوهای ضروری برای استقرارهای تولیدی هوش مصنوعی با استفاده از خدمات Azure AI Foundry را خواهید آموخت.
...
- مفاهیم پایه‌ای هوش مصنوعی/یادگیری ماشین (APIها، مدل‌ها، درخواست‌ها)
...
**بهترین روش**: پیکربندی‌های متفاوت برای توسعه در مقابل تولید.
...
**وظایف:**
1. شناسایی اینکه کدام SKUs می‌توانند به سطوح رایگان/پایه تنظیم شوند
2. پیکربندی متغیرهای محیطی برای هزینه کم
...
1. **بررسی پیکربندی امنیتی در الگوی خود:**
```bash
...
**چالش**: ایجاد یک الگوی AZD برای یک برنامه پردازش اسناد هوش مصنوعی.
...
به پورتال Azure مراجعه کنید و داشبوردی با موارد زیر ایجاد کنید:
...
تبریک! شما کارگاه عملی هوش مصنوعی را به پایان رساندید. اکنون باید بتوانید:

- ✅ تبدیل برنامه‌های هوش مصنوعی موجود به الگوهای AZD
...
**بازخورد کارگاه**: با به اشتراک گذاشتن تجربه خود در [کانال Azure دیسکورد Azure AI Foundry](https://discord.gg/microsoft-azure)، به ما کمک کنید این کارگاه را بهبود دهیم.  

---

**قبلی:** [استقرار مدل هوش مصنوعی](ai-model-deployment.md) | **بعدی:** [روش‌های تولیدی هوش مصنوعی](production-ai-practices.md)  
