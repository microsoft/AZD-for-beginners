...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:33:51+00:00",
...
**قبلی:** [پروژه اول](../getting-started/first-project.md) | **بعدی:** [استقرار مدل‌های هوش مصنوعی](ai-model-deployment.md)

## مرور کلی

این راهنما نشان می‌دهد که چگونه می‌توان خدمات Azure AI Foundry را با Azure Developer CLI (AZD) ادغام کرد تا فرآیند استقرار برنامه‌های هوش مصنوعی ساده‌تر شود. Azure AI Foundry یک پلتفرم جامع برای ساخت، استقرار و مدیریت برنامه‌های هوش مصنوعی ارائه می‌دهد، در حالی که AZD فرآیند زیرساخت و استقرار را ساده می‌کند.

## Azure AI Foundry چیست؟

Azure AI Foundry پلتفرم یکپارچه مایکروسافت برای توسعه هوش مصنوعی است که شامل موارد زیر می‌شود:

- **کاتالوگ مدل‌ها**: دسترسی به مدل‌های پیشرفته هوش مصنوعی
...
| **مدیریت هزینه** | نظارت پایه‌ای | بهینه‌سازی هزینه بر اساس محیط |
...
**مورد استفاده**: استقرار برنامه‌های تولید مبتنی بر بازیابی (RAG)
...
6. **به تولید مقیاس دهید**: ویژگی‌های چند منطقه‌ای و قابلیت دسترسی بالا اضافه کنید
