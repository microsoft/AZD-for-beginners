...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T05:26:55+00:00",
  "source_file": "docs/troubleshooting/debugging.md",
  "language_code": "fa"
}
-->
# راهنمای اشکال‌زدایی - تکنیک‌های پیشرفته تحلیل لاگ

## مقدمه

این راهنمای جامع، استراتژی‌ها، ابزارها و تکنیک‌های پیشرفته‌ای برای اشکال‌زدایی و حل مشکلات پیچیده در استقرارهای Azure Developer CLI ارائه می‌دهد. با یادگیری روش‌های سیستماتیک اشکال‌زدایی، تکنیک‌های تحلیل لاگ، پروفایل‌سازی عملکرد و ابزارهای تشخیصی پیشرفته، می‌توانید مشکلات استقرار و اجرا را به‌طور مؤثر حل کنید.
...
- استراتژی‌های پروفایل‌سازی عملکرد و نظارت را پیاده‌سازی خواهید کرد
- از ابزارها و خدمات تشخیصی Azure برای حل مشکلات پیچیده استفاده خواهید کرد
- تکنیک‌های اشکال‌زدایی شبکه و امنیت را به کار خواهید گرفت
...
- `log-analyzer.py` - تجزیه و تحلیل پیشرفته لاگ
...
5. **ابزارهای اشکال‌زدایی را با تغییرات برنامه به‌روز نگه دارید**
6. **روش‌های اشکال‌زدایی را در زمان‌های غیرحادثه تمرین کنید**
...
- [بررسی‌های پیش‌پرواز](../pre-deployment/preflight-checks.md) - اعتبارسنجی پیش از استقرار
