...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:12:51+00:00",
  "source_file": "docs/troubleshooting/debugging.md",
  "language_code": "fa"
}
-->
# راهنمای اشکال‌زدایی - تکنیک‌های پیشرفته رفع مشکلات

## مقدمه

این راهنمای جامع، استراتژی‌ها، ابزارها و تکنیک‌های پیشرفته‌ای برای تشخیص و رفع مشکلات پیچیده در استقرارهای Azure Developer CLI ارائه می‌دهد. با یادگیری روش‌های سیستماتیک اشکال‌زدایی، تکنیک‌های تحلیل لاگ، پروفایل‌سازی عملکرد و ابزارهای تشخیصی پیشرفته، می‌توانید مشکلات استقرار و اجرا را به‌طور مؤثر حل کنید.

## اهداف یادگیری

با تکمیل این راهنما، شما:
- روش‌های سیستماتیک اشکال‌زدایی برای مشکلات Azure Developer CLI را فرا خواهید گرفت
- تنظیمات پیشرفته لاگ‌گیری و تکنیک‌های تحلیل لاگ را درک خواهید کرد
- استراتژی‌های پروفایل‌سازی عملکرد و نظارت را اجرا خواهید کرد
- از ابزارها و خدمات تشخیصی Azure برای حل مشکلات پیچیده استفاده خواهید کرد
- تکنیک‌های اشکال‌زدایی شبکه و امنیت را به کار خواهید برد
- نظارت جامع و هشداردهی را برای شناسایی پیشگیرانه مشکلات پیکربندی خواهید کرد

## نتایج یادگیری

پس از تکمیل این راهنما، شما قادر خواهید بود:
- روش TRIAGE را برای اشکال‌زدایی سیستماتیک مشکلات پیچیده استقرار به کار ببرید
- اطلاعات جامع لاگ‌گیری و ردیابی را پیکربندی و تحلیل کنید
- از Azure Monitor، Application Insights و ابزارهای تشخیصی به‌طور مؤثر استفاده کنید
- مشکلات اتصال شبکه، احراز هویت و مجوزها را به‌طور مستقل اشکال‌زدایی کنید
- استراتژی‌های نظارت و بهینه‌سازی عملکرد را اجرا کنید
- اسکریپت‌های سفارشی اشکال‌زدایی و اتوماسیون برای مشکلات تکراری ایجاد کنید

## روش اشکال‌زدایی

### رویکرد TRIAGE
- **T**ime: مشکل از چه زمانی شروع شده است؟
...
### اشکال‌زدایی پرس‌وجوهای پایگاه داده
```javascript
...
2. **موارد تست قابل بازتولید** برای مشکلات ایجاد کنید
3. **روش‌های اشکال‌زدایی را مستند کنید** برای تیم خود
4. **بررسی‌های سلامت و نظارت را خودکار کنید**
5. **ابزارهای اشکال‌زدایی را به‌روز نگه دارید** با تغییرات برنامه
6. **روش‌های اشکال‌زدایی را تمرین کنید** در زمان‌های غیرحادثه
...
**به یاد داشته باشید**: اشکال‌زدایی خوب به معنای سیستماتیک بودن، دقیق بودن و صبور بودن است. این ابزارها و تکنیک‌ها به شما کمک می‌کنند مشکلات را سریع‌تر و مؤثرتر تشخیص دهید.
