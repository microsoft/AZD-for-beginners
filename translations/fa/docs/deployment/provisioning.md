...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:04:22+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "fa"
}
-->
# تهیه منابع - زیرساخت به‌عنوان کد با AZD

## مقدمه

این راهنمای جامع هر آنچه را که باید درباره تهیه و مدیریت منابع Azure با استفاده از Azure Developer CLI بدانید، پوشش می‌دهد. یاد بگیرید که الگوهای زیرساخت به‌عنوان کد (IaC) را از ایجاد منابع پایه تا معماری‌های پیشرفته زیرساخت سازمانی با استفاده از Bicep، ARM templates، Terraform و Pulumi پیاده‌سازی کنید.

## اهداف یادگیری

با تکمیل این راهنما، شما:
- اصول زیرساخت به‌عنوان کد و تهیه منابع Azure را به‌طور کامل فرا خواهید گرفت
- ارائه‌دهندگان مختلف IaC که توسط Azure Developer CLI پشتیبانی می‌شوند را درک خواهید کرد
- طراحی و پیاده‌سازی الگوهای Bicep برای معماری‌های رایج برنامه‌ها را یاد خواهید گرفت
...
- طراحی و تهیه زیرساخت Azure با استفاده از Bicep و ARM templates را انجام دهید
- معماری‌های پیچیده چند سرویس با وابستگی‌های مناسب منابع را پیکربندی کنید
- الگوهای پارامتری برای محیط‌ها و تنظیمات مختلف را پیاده‌سازی کنید
- مشکلات تهیه زیرساخت را عیب‌یابی کرده و شکست‌های استقرار را حل کنید
