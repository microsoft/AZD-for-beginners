...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T16:24:53+00:00",
...
- **➡️ فصل بعدی**: [فصل ۵: راه‌حل‌های هوش مصنوعی چند عاملی](../../examples/retail-scenario.md)
...
- اصول زیرساخت به عنوان کد و تهیه منابع Azure را فرا خواهید گرفت
- ارائه‌دهندگان مختلف IaC که توسط Azure Developer CLI پشتیبانی می‌شوند را درک خواهید کرد
- الگوهای Bicep را برای معماری‌های رایج برنامه طراحی و پیاده‌سازی خواهید کرد
- پارامترهای منابع، متغیرها و تنظیمات خاص محیط را پیکربندی خواهید کرد
...
- معماری‌های پیچیده چند سرویس را با وابستگی‌های مناسب منابع پیکربندی کنید
...
- اصول چارچوب معماری خوب Azure را در طراحی زیرساخت اعمال کنید
...
- [مشکلات رایج](../troubleshooting/common-issues.md) - مشکلات زیرساخت را عیب‌یابی کنید
- [راهنمای اشکال‌زدایی](../troubleshooting/debugging.md) - مشکلات تهیه را اشکال‌زدایی کنید
- [انتخاب SKU](../pre-deployment/sku-selection.md) - سطوح خدمات مناسب را انتخاب کنید
