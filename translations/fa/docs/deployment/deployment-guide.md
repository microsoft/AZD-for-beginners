...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:00:35+00:00",
...
این راهنمای جامع همه چیزهایی که باید درباره استقرار برنامه‌ها با استفاده از Azure Developer CLI بدانید را پوشش می‌دهد، از استقرارهای ساده با یک فرمان تا سناریوهای پیشرفته تولید با هوک‌های سفارشی، محیط‌های متعدد و یکپارچه‌سازی CI/CD. چرخه کامل استقرار را با مثال‌های عملی و بهترین روش‌ها بیاموزید.

## اهداف یادگیری

با تکمیل این راهنما، شما:
- به تمام فرمان‌ها و جریان‌های کاری استقرار Azure Developer CLI مسلط خواهید شد
- چرخه کامل استقرار از تهیه منابع تا نظارت را درک خواهید کرد
- هوک‌های سفارشی برای خودکارسازی قبل و بعد از استقرار پیاده‌سازی خواهید کرد
...
- تمام جریان‌های کاری استقرار azd را به صورت مستقل اجرا و رفع اشکال کنید
- خودکارسازی استقرار سفارشی با استفاده از هوک‌ها طراحی و پیاده‌سازی کنید
- استقرارهای آماده تولید با امنیت و نظارت مناسب پیکربندی کنید
- سناریوهای پیچیده استقرار چند محیطی را مدیریت کنید
- عملکرد استقرار را بهینه کنید و استراتژی‌های بازگشت به حالت قبل را پیاده‌سازی کنید
- استقرارهای azd را در جریان‌های کاری DevOps سازمانی ادغام کنید

## نمای کلی استقرار

Azure Developer CLI چندین فرمان استقرار ارائه می‌دهد:
- `azd up` - جریان کامل (تهیه منابع + استقرار)
...
### مرحله ۱: هوک‌های پیش از تهیه منابع
```yaml
# azure.yaml
hooks:
  preprovision:
...
### بهینه‌سازی چند مرحله‌ای Dockerfile
```dockerfile
# Dockerfile
...
- [تهیه منابع](provisioning.md) - بررسی عمیق مدیریت زیرساخت
...
- [استقرار سرویس برنامه Azure](https://learn.microsoft.com/en-us/azure/app-service/deploy-local-git)
- [استقرار برنامه‌های کانتینری Azure](https://learn.microsoft.com/en-us/azure/container-apps/deploy-artifact)
- [استقرار توابع Azure](https://learn.microsoft.com/en-us/azure/azure-functions/functions-deployment-slots)

---

**ناوبری**
- **درس قبلی**: [پروژه اول شما](../getting-started/first-project.md)
- **درس بعدی**: [تهیه منابع](provisioning.md)
