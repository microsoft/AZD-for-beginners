...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:11:09+00:00",
...
**قبلی:** [مستندات اصلی](../../README.md) | **بعدی:** [مبانی AZD](azd-basics.md)
...
- گزینه‌های مختلف نصب را خواهید شناخت و خواهید دانست که هر کدام چه زمانی مناسب است
...
2. فایل‌ها را به مسیر `C:\Program Files\azd\` استخراج کنید
...
azd به‌صورت پیش‌فرض در GitHub Codespaces نصب شده است. کافی است یک Codespace ایجاد کنید و فوراً از azd استفاده کنید.
...
پس از نصب، مطمئن شوید که azd به‌درستی کار می‌کند:
...
**نصب کامل شد!** به [پروژه اول شما](first-project.md) ادامه دهید تا ساخت با azd را آغاز کنید.
