...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:11:43+00:00",
...
**قبلی:** [نصب و راه‌اندازی](installation.md) | **بعدی:** [پیکربندی](configuration.md)

## مقدمه

این درس شما را با Azure Developer CLI (azd) آشنا می‌کند، یک ابزار قدرتمند خط فرمان که فرآیند توسعه محلی تا استقرار در Azure را تسریع می‌کند. شما با مفاهیم پایه، ویژگی‌های اصلی و نحوه ساده‌سازی استقرار برنامه‌های ابری توسط azd آشنا خواهید شد.
...
دستور `azd down --force --purge` یک روش قدرتمند برای حذف کامل محیط azd و تمام منابع مرتبط است. در اینجا توضیحی از عملکرد هر پرچم آورده شده است:
```
--force
```
...
--purge
```
**تمام متادیتاهای مرتبط** را حذف می‌کند، از جمله:
وضعیت محیط
پوشه محلی `.azure`
