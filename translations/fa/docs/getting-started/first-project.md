...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T16:45:04+00:00",
...
به اولین پروژه CLI توسعه‌دهنده Azure خوش آمدید! این آموزش جامع و عملی یک راهنمای کامل برای ایجاد، استقرار و مدیریت یک برنامه فول‌استک در Azure با استفاده از azd ارائه می‌دهد. شما با یک برنامه واقعی مدیریت وظایف کار خواهید کرد که شامل یک رابط کاربری React، بک‌اند API Node.js و پایگاه داده MongoDB است.
...
## مرحله 1: انتخاب و اولیه‌سازی یک قالب
...
## مرحله 4: استقرار در Azure

حالا به بخش هیجان‌انگیز - همه چیز را در Azure مستقر کنید!
...
1. **افزودن یک وظیفه** - روی "Add Todo" کلیک کنید و یک کار وارد کنید
...
## مرحله 6: ایجاد تغییرات و استقرار مجدد
...
تبریک! شما با موفقیت:
- یک پروژه azd را از یک قالب اولیه‌سازی کرده‌اید
- ساختار پروژه و فایل‌های کلیدی را بررسی کرده‌اید
- یک برنامه فول‌استک را در Azure مستقر کرده‌اید
- تغییرات کد ایجاد کرده و مجدداً مستقر کرده‌اید
- محیط‌های مختلف را مدیریت کرده‌اید
- منابع را پاکسازی کرده‌اید
...
**تبریک بابت تکمیل اولین پروژه azd شما!** اکنون آماده هستید تا با اعتماد به نفس برنامه‌های شگفت‌انگیزی را در Azure بسازید و مستقر کنید.
