...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T16:52:52+00:00",
...
- محیط‌های متعدد با تنظیمات مختلف را مدیریت خواهید کرد
...
### پیکربندی محیط
هر محیط تنظیمات خاص خود را در `.azure/<env-name>/config.json` دارد:
...
### قالب‌های محیط
برای تنظیم محیط‌های سازگار، `.azure/env.template` ایجاد کنید:
```bash
# Required variables
...
**ناوبری**
- **درس قبلی**: [نصب و راه‌اندازی](installation.md)
