...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T15:02:53+00:00",
...
- تجربه‌ای در رفع اشکال و دیباگ سناریوهای واقعی استقرار کسب می‌کنید
...
- برنامه‌های چند سرویس پیچیده را با وابستگی‌های مناسب پیکربندی کنید
...
2. **[وب‌سایت استاتیک](../../../examples/static-website)** - میزبانی یک وب‌سایت استاتیک در Azure Storage  
...
6. **[معماری میکروسرویس‌ها](../../../examples/microservices)** - برنامه چند سرویس با API Gateway  
...
**پیچیدگی**: متوسط  
**مفاهیم**: کانتینری‌سازی، مقیاس‌پذیری، پیکربندی ورودی  
...
**پیچیدگی**: متوسط  
**مفاهیم**: معماری رویدادمحور، اتصال‌ها، مدیریت API  

### میکروسرویس‌ها
**فناوری‌ها**: چند سرویس، Service Bus، API Gateway  
**پیچیدگی**: پیشرفته  
**مفاهیم**: ارتباط سرویس‌ها، صف پیام، تعادل بار  
...
5. **تابع بدون سرور را بررسی کنید**
...
- **مونولیتیک**: برنامه وب ساده، برنامه پایگاه داده  
...
مثالی مفید برای اشتراک دارید؟ ما از مشارکت‌ها استقبال می‌کنیم!
