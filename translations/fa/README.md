...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:51:09+00:00",
...
برای آغاز سفر یادگیری AZD مراحل زیر را دنبال کنید:
...
4. **انتخاب مسیر یادگیری**: فصل مورد نظر خود را بر اساس سطح تجربه انتخاب کنید
...
- **مهارت‌های پایه AZD را فرا خواهید گرفت**: مفاهیم اصلی، نصب و پیکربندی
- **برنامه‌های هوش مصنوعی را مستقر خواهید کرد**: استفاده از AZD با خدمات Azure AI Foundry
...
- **✅ اعتبارسنجی**: [بررسی‌های پیش از پرواز](docs/pre-deployment/preflight-checks.md) - اسکریپت‌های خودکار
...
مواد آموزشی کارگاه ما تجربه یادگیری ساختاریافته و تعاملی را ارائه می‌دهند که مکمل برنامه درسی فصل‌بندی شده بالا است. این کارگاه برای یادگیری خودمحور و جلسات تحت هدایت مربی طراحی شده است.
...
- **مسیر یادگیری ساختاریافته**: ۷ مرحله تمرین هدایت‌شده (مجموعاً ۳.۵ ساعت)
...
- **استقرار برنامه‌های هوش مصنوعی در محیط تولید**: استفاده از AZD با خدمات Azure AI Foundry
...
Azure Developer CLI (azd) یک رابط خط فرمان متمرکز بر توسعه‌دهندگان است که فرآیند ساخت و استقرار برنامه‌ها در Azure را تسریع می‌کند. این ابزار ارائه می‌دهد:
...
- **گردش کار یکپارچه** - تهیه، استقرار و نظارت بر برنامه‌ها به‌صورت یکپارچه
- **مناسب برای توسعه‌دهندگان** - بهینه‌سازی شده برای بهره‌وری و تجربه توسعه‌دهندگان
...
- **گردش کارهای کامل هوش مصنوعی** - از توسعه مدل تا استقرار در محیط تولید با نظارت مناسب
...
| [**اتوماسیون گردش کار چندعاملی**](https://github.com/Azure-Samples/get-started-with-ai-chat) | فصل ۵ | ⭐⭐⭐ | AzureOpenAI + Azure AI Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
...
- [پردازش داده‌ها](../../examples/data-processing) - استقرار گردش کار ETL
...
### مراجع سریع
- [**برگه تقلب دستورات**](resources/cheat-sheet.md) - دستورات ضروری azd مرتب شده بر اساس فصل
...
### کارگاه‌های عملی
- [**آزمایشگاه کارگاه هوش مصنوعی**](docs/ai-foundry/ai-workshop-lab.md) - راه‌حل‌های هوش مصنوعی خود را AZD-قابل استقرار کنید (۲-۳ ساعت)
- [**راهنمای کارگاه تعاملی**](workshop/README.md) - کارگاه مبتنی بر مرورگر با MkDocs و محیط DevContainer
- [**مسیر یادگیری ساختاریافته**](../../workshop/docs/instructions) - ۷ مرحله تمرین هدایت‌شده (کشف → استقرار → سفارشی‌سازی)
...
1. **تمرین عملی**: تمرین استقرار فصل را کامل کنید
...
- **پیشرفت شغلی**: تخصص مورد تقاضای AZD و استقرار هوش مصنوعی
...
- **سوالات یادگیری**: [جامعه Discord Microsoft Azure](https://discord.gg/microsoft-azure) و [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- مشارکت در بهترین شیوه‌های استقرار هوش مصنوعی  
- تأثیرگذاری بر توسعه ویژگی‌های آینده هوش مصنوعی + AZD  

### مشارکت در دوره  
ما از مشارکت شما استقبال می‌کنیم! لطفاً [راهنمای مشارکت](CONTRIBUTING.md) ما را بخوانید تا با جزئیات زیر آشنا شوید:  
- **بهبود محتوا**: ارتقاء فصل‌ها و مثال‌های موجود  
- **مثال‌های جدید**: افزودن سناریوها و قالب‌های واقعی  
- **ترجمه**: کمک به پشتیبانی چندزبانه  
- **گزارش اشکالات**: بهبود دقت و شفافیت  
- **استانداردهای جامعه**: رعایت دستورالعمل‌های جامع و فراگیر ما  
...
**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما برای دقت تلاش می‌کنیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است شامل خطاها یا نادرستی‌هایی باشد. سند اصلی به زبان اصلی آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حساس، ترجمه حرفه‌ای انسانی توصیه می‌شود. ما مسئولیتی در قبال هرگونه سوءتفاهم یا تفسیر نادرست ناشی از استفاده از این ترجمه نداریم.
