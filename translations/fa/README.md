...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T12:03:22+00:00",
...
- **عیب‌یابی استقرارها را انجام می‌دهید**: حل مشکلات رایج و اشکال‌زدایی
- **برای تولید بهینه‌سازی می‌کنید**: امنیت، مقیاس‌پذیری، نظارت و مدیریت هزینه
- **راه‌حل‌های چندعاملی می‌سازید**: استقرار معماری‌های پیچیده هوش مصنوعی
...
مواد کارگاه ما تجربه یادگیری ساختاریافته و تعاملی را ارائه می‌دهد که مکمل برنامه درسی مبتنی بر فصل‌های بالا است. این کارگاه برای یادگیری خودآموز و جلسات با راهنما طراحی شده است.
...
- [**مسیر یادگیری ساختاریافته**](../../workshop/docs/instructions) - تمرینات راهنمای ۷ مرحله‌ای (کشف → استقرار → سفارشی‌سازی)  
