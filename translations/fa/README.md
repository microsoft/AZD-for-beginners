...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T23:12:59+00:00",
...
3. **پیوستن به جامعه**: [جامعه‌های دیسکورد Azure](https://discord.com/invite/ByRwuEEgH4) برای پشتیبانی تخصصی
...
با یادگیری ساختاریافته در فصل‌های مختلف، به مهارت در Azure Developer CLI (azd) دست پیدا کنید. **تمرکز ویژه بر استقرار برنامه‌های هوش مصنوعی با ادغام Microsoft Foundry.**
...
# استقرار اولین برنامه خود
azd init --template todo-nodejs-mongo
azd up
```

**💡 نتیجه فصل**: با موفقیت یک برنامه وب ساده را با استفاده از AZD در Azure مستقر کنید
...
**محیط توسعه (تقریباً ۸۰-۱۵۰ دلار در ماه):**
- Azure OpenAI (پرداخت به‌ازای استفاده): ۰-۵۰ دلار در ماه (بر اساس استفاده از توکن)
- AI Search (سطح پایه): ۷۵ دلار در ماه
- برنامه‌های کانتینری (مصرف): ۰-۲۰ دلار در ماه
- ذخیره‌سازی (استاندارد): ۱-۵ دلار در ماه

**محیط تولید (تقریباً ۳۰۰-۳۵۰۰+ دلار در ماه):**
- Azure OpenAI (PTU برای عملکرد ثابت): ۳۰۰۰+ دلار در ماه یا پرداخت به‌ازای استفاده با حجم بالا
...
- از `azd down` برای آزادسازی منابع زمانی که به‌طور فعال توسعه نمی‌دهید استفاده کنید
...
#### 🛠️ ویژگی‌های کارگاه
- **رابط مبتنی بر مرورگر**: کارگاه مبتنی بر MkDocs با قابلیت جستجو، کپی و ویژگی‌های تم
- **یکپارچه‌سازی GitHub Codespaces**: راه‌اندازی محیط توسعه با یک کلیک
- **مسیر یادگیری ساختاریافته**: تمرین‌های راهنمایی‌شده ۷ مرحله‌ای (مجموعاً ۳.۵ ساعت)
...
# روی "Code" کلیک کنید → "Create codespace on main" را در مخزن انتخاب کنید
...
> **توجه:** این قالب‌ها الگوهای مختلف هوش مصنوعی را نشان می‌دهند. برخی نمونه‌های Azure خارجی هستند، برخی دیگر پیاده‌سازی‌های محلی.
...
| [**پردازش اسناد هوش مصنوعی**](https://github.com/Azure-Samples/ai-document-processing) | فصل ۴ | ⭐⭐ | یکپارچه‌سازی Document Intelligence |
...
- [**مثال‌های برنامه کانتینری**](examples/container-app/README.md) - راهنمای کامل برای استقرار کانتینری
  ...
  - راهنمایی برای نظارت، امنیت و بهینه‌سازی هزینه
...
### مراجع سریع
- [**برگه تقلب دستورات**](resources/cheat-sheet.md) - دستورات ضروری azd بر اساس فصل سازماندهی شده
- [**واژه‌نامه**](resources/glossary.md) - اصطلاحات Azure و azd  
- [**سوالات متداول**](resources/faq.md) - سوالات رایج بر اساس فصل یادگیری
- [**راهنمای مطالعه**](resources/study-guide.md) - تمرین‌های جامع
### کارگاه‌های عملی
- [**آزمایشگاه کارگاه هوش مصنوعی**](docs/microsoft-foundry/ai-workshop-lab.md) - راه‌حل‌های هوش مصنوعی خود را برای استقرار با AZD آماده کنید (۲-۳ ساعت)
- [**راهنمای کارگاه تعاملی**](workshop/README.md) - کارگاه مبتنی بر مرورگر با MkDocs و محیط DevContainer
- [**مسیر یادگیری ساختاریافته**](../../workshop/docs/instructions) - تمرینات هدایت‌شده در ۷ مرحله (کشف → استقرار → سفارشی‌سازی)
- [**کارگاه AZD برای مبتدیان**](workshop/README.md) - مواد کارگاه عملی کامل با ادغام GitHub Codespaces
...
# گزینه ۲: فقط زیرساخت را تعمیر کنید
azd provision
...
```bash
# AZD نام‌های منحصربه‌فرد تولید می‌کند، اما اگر تضاد وجود داشت:
azd down --force --purge
...
- برنامه‌های هوش مصنوعی: ۱۵-۲۵ دقیقه (پروویژن OpenAI کند است)

```bash
# بررسی پیشرفت
azd show

# اگر بیش از ۳۰ دقیقه گیر کرد، پورتال Azure را بررسی کنید:
azd monitor
...
- **سوالات یادگیری**: [جامعه دیسکورد Microsoft Azure](https://discord.gg/microsoft-azure) و [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- **چالش‌های اصلی**: استقرار چندسرویسی، مدیریت اعتبارنامه، آمادگی برای تولید  
...
### منابع یادگیری مرتبط با مایکروسافت

تیم ما دوره‌های یادگیری جامع دیگری نیز تولید می‌کند:
