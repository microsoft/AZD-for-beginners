...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:21:20+00:00",
...
4. **انتخاب مسیر یادگیری خود**: یک فصل زیر را که با سطح تجربه شما مطابقت دارد انتخاب کنید
...
- **برنامه‌های هوش مصنوعی را مستقر می‌کنید**: استفاده از AZD با خدمات Microsoft Foundry
...
#### آنچه یاد می‌گیرید
- درک مفاهیم پایه Azure Developer CLI
...
**💡 نتیجه فصل**: استقرار و پیکربندی یک برنامه چت هوش مصنوعی با قابلیت‌های RAG
...
- Azure OpenAI (PTU برای عملکرد پایدار): ۳۰۰۰+ دلار در ماه یا پرداخت به ازای مصرف با حجم بالا
...
- **📝 نمونه‌ها**: [نمونه برنامه کانتینری](../../examples/container-app) - استقرارهای کانتینری
...
#### 🛠️ ویژگی‌های کارگاه
- **رابط مبتنی بر مرورگر**: کارگاه کامل با MkDocs با قابلیت جستجو، کپی و تم‌ها
- **ادغام GitHub Codespaces**: راه‌اندازی محیط توسعه با یک کلیک
- **مسیر یادگیری ساختاریافته**: ۷ مرحله تمرین راهنمایی شده (۳.۵ ساعت کل)
...
- **گردش‌کارهای یکپارچه** - فراهم‌سازی، استقرار و نظارت برنامه‌ها به صورت یکپارچه
...
- **ادغام Microsoft Foundry** - اتصال یکپارچه به کاتالوگ مدل‌ها و نقاط انتهایی Microsoft Foundry
...
#### مثال‌های خارجی - برنامه‌های ساده (فصل‌های ۱ تا ۲)
...
#### مثال‌های خارجی - ادغام پایگاه داده (فصل‌های ۳ تا ۴)  
...
- **مشکلات خاص هوش مصنوعی:** [عیب‌یابی هوش مصنوعی](docs/troubleshooting/ai-troubleshooting.md)  
...
**توسعه‌دهندگان هوش مصنوعی**: به [فصل ۲: توسعه هوش مصنوعی-اول](../..) بروید  
