...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:26:54+00:00",
...
- **مهارت‌های پایه AZD را به دست خواهید آورد**: مفاهیم اصلی، نصب و پیکربندی
...
- درک پیکربندی‌های خدمات هوش مصنوعی

#### منابع یادگیری
- **🎯 از اینجا شروع کنید**: [ادغام Azure AI Foundry](docs/ai-foundry/azure-ai-foundry-integration.md)
- **📖 الگوها**: [استقرار مدل هوش مصنوعی](docs/ai-foundry/ai-model-deployment.md) - مدیریت و استقرار مدل‌های هوش مصنوعی
...
#### منابع آموزشی
- **🏭 تولید**: [بهترین شیوه‌های هوش مصنوعی در تولید](docs/ai-foundry/production-ai-practices.md) - الگوهای سازمانی
...
#### 🛠️ ویژگی‌های کارگاه
- **رابط مبتنی بر مرورگر**: کارگاه کامل با قابلیت‌های جستجو، کپی و تم با استفاده از MkDocs
...
- **جریان‌های کاری کامل هوش مصنوعی** - از توسعه مدل تا استقرار در محیط تولید با نظارت مناسب
...
- [**سؤالات متداول**](resources/faq.md) - سؤالات رایج سازماندهی شده بر اساس فصل یادگیری
...
### ردیابی پیشرفت
پیشرفت یادگیری خود را از طریق هر فصل دنبال کنید:
...
1. **تمرین عملی**: تمرین عملی فصل را تکمیل کنید
...
- **سؤالات یادگیری**: [جامعه Discord مایکروسافت Azure](https://discord.gg/microsoft-azure)
...
- **مثال‌های جدید**: سناریوها و قالب‌های واقعی را اضافه کنید  
...
تیم ما دوره‌های آموزشی جامع دیگری نیز تولید کرده است:  
