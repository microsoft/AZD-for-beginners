...
**📈 Úroveň zručností po:** Schopnosť samostatne nasadzovať základné aplikácie
...
- Azure OpenAI (PTU pre konzistentný výkon): $3,000+/mesiac ALEBO Pay-as-go s vysokým objemom
...
#### Praktické cvičenia
- Konfigurácia viacerých prostredí (vývoj, staging, produkcia)
...
> Materiály workshopu sú momentálne vo vývoji a zdokonaľovaní. Základné moduly sú funkčné, ale niektoré pokročilé sekcie sú neúplné. Aktívne pracujeme na dokončení všetkého obsahu. [Sledovať pokrok →](workshop/README.md)
...
#### Lokálne príklady - Aplikácie v kontajneroch (Kapitoly 2-5)
**Komplexné príklady nasadenia kontajnerov v tomto repozitári:**
- [**Príklady aplikácií v kontajneroch**](examples/container-app/README.md) - Kompletný sprievodca nasadením kontajnerov
...
- [Úlohy aplikácií v kontajneroch](https://github.com/Azure-Samples/container-apps-jobs) - Spracovanie na pozadí  
- [Podniková ML pipeline](https://github.com/Azure-Samples/mlops-v2) - Produkčne pripravené ML vzory
...
```bash
# Skúste iný región Azure
azd env set AZURE_LOCATION "westus2"
azd up

# Alebo použite menšie SKUs pri vývoji
...
# Možnosť 2: Opraviť iba infraštruktúru
azd provision
...
### ❌ "Autentifikácia zlyhala" alebo "Token vypršal"
...
- **Otázky k učeniu**: [Komunita Microsoft Azure Discord](https://discord.gg/microsoft-azure) a [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
- **Pomoc špecifická pre AI**: Pripojte sa k [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- Prispeli k osvedčeným postupom nasadenia AI
