...
!!! tip "BY THE END OF THIS MODULE YOU WILL BE ABLE TO"
    ...
    - [ ] **Lab 2:** Nasadenie a overenie šablóny AI agentov
...
1. When done, your console will show a SUCCESS message like this:
      ...
      ```
1. Váš Azure Portal bude mať teraz provisionovanú skupinu prostriedkov s názvom toho prostredia:

      ![Infrastruktúra](../../../../../translated_images/sk/02-provisioned-infra.46c706b14f56e0bf.webp)
...
1. Try asking a couple of [sample questions](https://github.com/Azure-Samples/get-started-with-ai-agents/blob/main/docs/sample_questions.md)
      ...
      1. Ask: ```Aké je hlavné mesto Francúzska?``` 
      1. Ask: ```Aký je najlepší stan do $200 pre dve osoby, a aké vlastnosti zahŕňa?```
...
1. Select it - and you see the Agent details. Note the following:
      ...
      ![Agenti](../../../../../translated_images/sk/07-view-agent-details.0e049f37f61eae62.webp)
...
Revisit the browser tab with the Container App endpoint and ask: `Aké produkty vlastní Amanda Perez?`. You should see something like this:
...
1. Ask the same question: `Aké produkty vlastní Amanda Perez?`
...
1. **Refresh** If you had previously deployed infrastructure using an azd template - you can _refresh_ the state of your local environment variables based on the current state of your Azure deployment using this command:
      ...
      Toto je silný spôsob, ako _synchronizovať_ premenné prostredia medzi dvoma alebo viacerými lokálnymi vývojovými prostrediami (napr., tím s viacerými vývojármi) - čo umožňuje, aby nasadená infraštruktúra slúžila ako základná pravda stavu premenných prostredia. Členovia tímu jednoducho _obnovia_ premenné, aby sa opäť zosúladili.
...
- [X] Nasadili šablónu a overili ste, že funguje
