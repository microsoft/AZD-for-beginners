...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:25:00+00:00",
...
**Predchádzajúce:** [Hlavná dokumentácia](../../README.md) | **Ďalšie:** [Základy AZD](azd-basics.md)

## Úvod

Tento komplexný sprievodca vás prevedie inštaláciou a konfiguráciou Azure Developer CLI (azd) na vašom systéme. Naučíte sa rôzne metódy inštalácie pre rôzne operačné systémy, nastavenie autentifikácie a počiatočnú konfiguráciu na prípravu vášho vývojového prostredia pre nasadenie na Azure.
...
1. Stiahnite najnovšiu verziu z [GitHub](https://github.com/Azure/azure-dev/releases)
2. Rozbaľte do `C:\Program Files\azd\`
3. Pridajte do PATH environmentálnej premennej
...
2. Konfigurujte Azure prihlasovacie údaje
...
3. **Preskúmajte šablóny**: Prezrite dostupné šablóny pomocou `azd template list`
...
**Inštalácia dokončená!** Pokračujte na [Váš prvý projekt](first-project.md) a začnite budovať s azd.
