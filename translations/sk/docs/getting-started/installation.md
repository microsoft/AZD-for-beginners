...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T06:03:31+00:00",
  "source_file": "docs/getting-started/installation.md",
  "language_code": "sk"
}
-->
# Príručka na inštaláciu a nastavenie

## Úvod

Táto komplexná príručka vás prevedie procesom inštalácie a konfigurácie Azure Developer CLI (azd) na vašom systéme. Naučíte sa rôzne metódy inštalácie pre rôzne operačné systémy, nastavenie autentifikácie a počiatočnú konfiguráciu na prípravu vášho vývojového prostredia pre nasadenia v Azure.
...
- Nastaviť vaše vývojové prostredie pre optimálne používanie azd
...
### GitHub Codespaces
Vytvorte súbor `.devcontainer/devcontainer.json`:
```json
{
...
2. Nakonfigurujte Azure prihlasovacie údaje
...
2. **Vyskúšajte prvé nasadenie**: Postupujte podľa [Príručky pre prvý projekt](first-project.md)
...
**Navigácia**
- **Predchádzajúca lekcia**: [Základy AZD](azd-basics.md)
- **Ďalšia lekcia**: [Konfigurácia](configuration.md)
