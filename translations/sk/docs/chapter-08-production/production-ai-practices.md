# Najlepšie postupy pre produkčné AI pracovné záťaže s AZD
...
Tento sprievodca poskytuje komplexné najlepšie postupy pre nasadenie produkčných AI pracovných záťaží pomocou Azure Developer CLI (AZD). Na základe spätnej väzby z komunity Microsoft Foundry na Discorde a skutočných zákazníckych nasadení tieto postupy riešia najbežnejšie výzvy v produkčných AI systémoch.

## Hlavné riešené výzvy

Na základe výsledkov prieskumu našej komunity sú toto hlavné výzvy, ktorým čelia vývojári:

- **45%** majú problém s viacservisnými AI nasadeniami
...
### Vzor 1: Architektúra AI založená na mikroslužbách

**Kedy použiť**: Komplexné AI aplikácie s viacerými funkciami
...
- Všetky volania API používajú spravované identity
- Izolácia siete s privátnymi endpointmi
- Prístupy s najmenšími potrebnými privilégiami
...
### 3. Vyrovnávanie záťaže a správa prevádzky
...
### 1. Prispôsobenie veľkosti zdrojov
...
### 3. Optimalizácia využitia tokenov
...
class TokenOptimizer {
  ...
  optimizePrompt(userInput: string, context: string): string {
    ...
    if (estimatedTokens > availableTokens) {
      // Orezávajte kontext, nie vstup používateľa
...
# Otestujte pripojenie k AI službe
...
- [ ] Nakonfigurované stratégie opakovaní
- [ ] Plynulá degradácia
- [ ] Endpointy kontroly stavu

### Riadenie nákladov ✅
- [ ] Upozornenia rozpočtu nakonfigurované
- [ ] Prispôsobenie veľkosti zdrojov
- [ ] Uplatnené zľavy pre vývoj/testovanie
- [ ] Zakúpené rezervované inštancie
- [ ] Dashboard pre monitorovanie nákladov
- [ ] Pravidelné prehodnocovanie nákladov

### Súlad s predpismi ✅
- [ ] Splnené požiadavky na umiestnenie údajov
- [ ] Povolené auditné záznamy
- [ ] Uplatnené politiky súladu
- [ ] Implementované bezpečnostné základné nastavenia
- [ ] Pravidelné bezpečnostné hodnotenia
- [ ] Plán reakcie na incidenty

## Výkonnostné referenčné hodnoty
...
1. **Začnite s malým, škálujte postupne**: Začnite s základnými SKU a škálujte podľa skutočného využitia
2. **Sledujte všetko**: Nastavte komplexné monitorovanie od prvého dňa
3. **Automatizujte bezpečnosť**: Používajte infraštruktúru ako kód pre konzistentnú bezpečnosť
4. **Testujte dôkladne**: Zahrňte testovanie špecifické pre AI do svojho pipeline
5. **Plánujte náklady**: Sledujte využitie tokenov a včas nastavte upozornenia rozpočtu
...
- ❌ Nasadenie bez kontrol stavu

## Ďalšie zdroje

- **Azure Well-Architected Framework**: [AI workload guidance](https://learn.microsoft.com/azure/well-architected/ai/)
- **Dokumentácia Microsoft Foundry**: [Official docs](https://learn.microsoft.com/azure/ai-studio/)
- **Community Templates**: [Azure Samples](https://github.com/Azure-Samples)
- **Komunita na Discorde**: [#Azure channel](https://discord.gg/microsoft-azure)
...
**Pamätajte**: Produkčné AI pracovné záťaže vyžadujú starostlivé plánovanie, monitorovanie a neustálu optimalizáciu. Začnite s týmito vzormi a prispôsobte ich svojim špecifickým požiadavkám.

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
Vylúčenie zodpovednosti:
Tento dokument bol preložený pomocou AI prekladateľskej služby Co-op Translator (https://github.com/Azure/co-op-translator). Hoci sa snažíme o presnosť, majte prosím na pamäti, že automatické preklady môžu obsahovať chyby alebo nepresnosti. Pôvodný dokument v jeho pôvodnom jazyku by mal byť považovaný za autoritatívny zdroj. Pre kritické informácie sa odporúča profesionálny preklad vykonaný človekom. Nezodpovedáme za akékoľvek nedorozumenia alebo nesprávne interpretácie vyplývajúce z použitia tohto prekladu.
