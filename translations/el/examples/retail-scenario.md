...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T23:38:01+00:00",
...
- **⬅️ Προαπαιτούμενα**: [Κεφάλαιο 2: Ανάπτυξη με Προτεραιότητα στο AI](../docs/ai-foundry/azure-ai-foundry-integration.md)
...
Αυτό το σενάριο περιγράφει τη διαδικασία δημιουργίας ενός chatbot υποστήριξης πελατών με πολλαπλούς πράκτορες, έτοιμο για παραγωγή, για έναν λιανοπωλητή που χρειάζεται προηγμένες δυνατότητες AI, όπως διαχείριση αποθεμάτων, επεξεργασία εγγράφων και έξυπνες αλληλεπιδράσεις με πελάτες.

## Στόχοι Αρχιτεκτονικής

Η λύση υποστήριξης πελατών απαιτεί:
- **Πολλαπλούς εξειδικευμένους πράκτορες** για διαφορετικές ανάγκες πελατών
- **Ανάπτυξη πολλαπλών μοντέλων** με σωστό σχεδιασμό χωρητικότητας
- **Δυναμική ενσωμάτωση δεδομένων** με AI Search και μεταφορτώσεις αρχείων
- **Ολοκληρωμένη παρακολούθηση** και δυνατότητες αξιολόγησης
- **Ασφάλεια επιπέδου παραγωγής** με επικύρωση μέσω red teaming
...
| **Inventory Agent** | Διαχειρίζεται αποθέματα και εκπλήρωση παραγγελιών | Container Apps + GPT-4o-mini | Κύρια Περιοχή |
| **Azure OpenAI** | Επεξεργασία LLM για πράκτορες | Cognitive Services | Πολλαπλές Περιοχές |
| **AI Search** | Αναζήτηση με διανύσματα και RAG | AI Search Service | Κύρια Περιοχή |
...
**Στόχος**: Ανάπτυξη 2 εξειδικευμένων πρακτόρων - "Customer Agent" (εξυπηρέτηση πελατών) και "Inventory" (διαχείριση αποθεμάτων)
...
#### Διαμόρφωση Εναλλακτικής Περιοχής:
...
### 3. AI Search με Διαμόρφωση Δείκτη Δεδομένων
...
#### Ρύθμιση Δεδομένων Μετά την Προ-Διαμόρφωση:
...
### 4. Διαμόρφωση Εργαλείου Πράκτορα για AI Search

**Στόχος**: Διαμόρφωση πρακτόρων ώστε να χρησιμοποιούν το AI Search ως εργαλείο θεμελίωσης
...
### 5. Ενσωμάτωση Αποθήκευσης Μεταφορτώσεων Αρχείων

**Στόχος**: Ενεργοποίηση πρακτόρων για επεξεργασία μεταφορτωμένων αρχείων (εγχειρίδια, έγγραφα) για RAG context
...
### 7. Ιχνηλάτηση και Application Insights

**Στόχος**: Ολοκληρωμένη παρακολούθηση με αρχεία ιχνηλάτησης και application insights
...
### 8. Επικύρωση Ασφάλειας μέσω Red Teaming

**Στόχος**: Αυτοματοποιημένος έλεγχος ασφάλειας για πράκτορες και μοντέλα
...
#### Αυτοματοποιημένος Αγωγός Ασφάλειας:
...
### 9. Αξιολόγηση Πράκτορα με Grader Model

**Στόχος**: Ανάπτυξη συστήματος αξιολόγησης με ειδικό grader model
...
## Εξατομίκευση & Ενημερώσεις

### 10. Εξατομίκευση Εφαρμογής Container

**Στόχος**: Ενημέρωση διαμόρφωσης εφαρμογής container και αντικατάσταση με προσαρμοσμένο UI
...
#### Σενάριο Δημιουργίας και Ανάπτυξης:
...
#### 1. Όρια Ποσοστώσεων Εφαρμογών Container

**Πρόβλημα**: Η ανάπτυξη αποτυγχάνει λόγω ορίων ποσοστώσεων περιοχής
...
## Συχνές Ερωτήσεις & Ανοιχτή Εξερεύνηση

### Συχνές Ερωτήσεις

#### Ε: Υπάρχει εύκολος τρόπος για ανάπτυξη πολλαπλών πρακτόρων (σχεδιαστικό μοτίβο);
...
#### Ε: Μπορώ να αναπτύξω "router μοντέλου" ως μοντέλο (επιπτώσεις κόστους);
...
- **Ανταλλαγές**: Ελαφρά αύξηση καθυστέρησης για λογική δρομολόγησης
- **Παρακολούθηση**: Παρακολούθηση ακρίβειας έναντι μετρήσεων κόστους

#### Ε: Μπορώ να ξεκινήσω μια εργασία fine-tuning από ένα πρότυπο azd;

**Α: Ναι, χρησιμοποιώντας hooks μετά την προ-διαμόρφωση:**
...
Για άμεση ανάπτυξη της πλήρους λύσης λιανικής με πολλαπλούς πράκτορες, έχουμε παρέχει ένα ολοκληρωμένο ARM template που προμηθεύει όλους τους απαιτούμενους πόρους Azure με μία εντολή.
...
#### **Πλήρης Υποδομή**
- ✅ **Αναπτύξεις Azure OpenAI σε πολλαπλές περιοχές** (GPT-4o, GPT-4o-mini, embeddings, grader)
- ✅ **Azure AI Search** με δυνατότητες αναζήτησης με διανύσματα
- ✅ **Azure Storage** με δοχεία εγγράφων και μεταφορτώσεων
- ✅ **Περιβάλλον Εφαρμογών Container** με αυτόματη κλιμάκωση
...
| Λειτουργία | Χρήση | Πόροι | Εκτιμώμενο Κόστος/Μήνα |
|------|----------|-----------|---------------------|
| **Ελάχιστη** | Ανάπτυξη, Δοκιμή | Βασικά SKUs, Μία περιοχή | $100-370 |
| **Κανονική** | Παραγωγή, Μέτρια κλίμακα | Κανονικά SKUs, Πολλαπλές περιοχές | $420-1,450 |
| **Premium** | Επιχειρηματική, Υψηλή κλίμακα | Premium SKUs, Ρύθμιση HA | $1,150-3,500 |
...
Το ARM template χειρίζεται την προμήθεια υποδομής. Μετά την ανάπτυξη:
...
- ✅ **Υψηλή διαθεσιμότητα πολλαπλών περιοχών** με αυτόματη εναλλακτική
- ✅ **Ολοκληρωμένη παρακολούθηση** με Application Insights και Log Analytics
- ✅ **Βέλτιστες πρακτικές ασφάλειας** με Key Vault και RBAC
- ✅ **Βελτιστοποίηση κόστους** με διαμορφώσιμες λειτουργίες ανάπτυξης
- ✅ **Αυτόματη κλιμάκωση** βάσει μοτίβων ζήτησης
- ✅ **Ενημερώσεις χωρίς διακοπή λειτουργίας** με αναθεωρήσεις εφαρμογών container
...
Αυτό το έγγραφο σεναρίου σε συνδυασμό με το ARM template παρέχει όλα όσα χρειάζονται για την ανάπτυξη μιας λύσης υποστήριξης πελατών με πολλαπλούς πράκτορες, έτοιμη για παραγωγή. Η υλοποίηση καλύπτει:
...
✅ **Διαμόρφωση Πρακτόρων** - Λεπτομερής ρύθμιση για Customer και Inventory πράκτορες  
✅ **Ανάπτυξη Πολλαπλών Μοντέλων** - Στρατηγική τοποθέτηση μοντέλων σε περιοχές  
✅ **Ενσωμάτωση Αναζήτησης** - AI Search με δυνατότητες διανυσμάτων και ευρετηρίασης δεδομένων  
✅ **Υλοποίηση Ασφάλειας** - Red teaming, σάρωση ευπαθειών και ασφαλείς πρακτικές  
✅ **Παρακολούθηση & Αξιολόγηση** - Ολοκληρωμένη τηλεμετρία και πλαίσιο αξιολόγησης πρακτόρων  
✅ **Ετοιμότητα Παραγωγής** - Ανάπτυξη επιπέδου επιχείρησης με HA και ανάκτηση από καταστροφή  
✅ **Βελτιστοποίηση Κόστους** - Έξυπνη δρομολόγηση και κλιμάκωση βάσει χρήσης  
✅ **Οδηγός Επίλυσης Προβλημάτων** - Συνηθισμένα προβλήματα και στρατηγικές επίλυσης
