...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T12:07:25+00:00",
...
1. **Κλωνοποιήστε το Αποθετήριο**: Κάντε κλικ [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
...
Βασισμένο σε πληροφορίες από την κοινότητα Microsoft Foundry Discord, **το 45% των προγραμματιστών θέλει να χρησιμοποιήσει το AZD για AI workloads** αλλά αντιμετωπίζει προκλήσεις με:
...
- **Επιλύσετε Προβλήματα Ανάπτυξης**: Εντοπίστε και διορθώστε κοινά ζητήματα
- **Βελτιστοποιήσετε για Παραγωγή**: Ασφάλεια, κλιμάκωση, παρακολούθηση και διαχείριση κόστους
- **Δημιουργήσετε Πολυ-Πρακτορικές Λύσεις**: Αναπτύξτε πολύπλοκες αρχιτεκτονικές AI
...
**💡 Αποτέλεσμα Κεφαλαίου**: Αναπτύξτε και ρυθμίστε μια εφαρμογή chat με AI και δυνατότητες RAG
...
# Κάνετε ερωτήσεις και να λαμβάνετε απαντήσεις με τεχνητή νοημοσύνη και πηγές
...
- Azure OpenAI (Πληρωμή ανά χρήση): $0-50/μήνα (ανάλογα με τη χρήση tokens)
...
- Ενεργοποιήστε πιστοποίηση με διαχειριζόμενη ταυτότητα
...
#### Πόροι Μάθησης
- **🤖 Προτεινόμενο Έργο**: [Λύση Πολυ-Πρακτόρων για Λιανική](examples/retail-scenario.md) - Πλήρης υλοποίηση
...
- **Εφαρμόσουν Καλές Πρακτικές Ασφάλειας**: Διαμόρφωση πιστοποίησης και ελέγχου πρόσβασης
...
- **Αναπτύξεις βασισμένες σε πρότυπα** - Χρήση προ-κατασκευασμένων προτύπων για κοινά μοτίβα εφαρμογών
...
- **Ενσωμάτωση Microsoft Foundry** - Απρόσκοπτη σύνδεση με τον κατάλογο μοντέλων και endpoints Microsoft Foundry
...
> **Σημείωση:** Αυτά τα πρότυπα παρουσιάζουν διάφορα μοτίβα AI. Μερικά είναι εξωτερικά δείγματα Azure, άλλα τοπικές υλοποιήσεις.
...
- [**Λύση Λιανικής Πολλαπλών Πρακτόρων**](examples/retail-scenario.md) - Πλήρης υλοποίηση παραγωγής με πρότυπα ARM
...
- [Απλή Web App - Node.js + MongoDB](https://github.com/Azure-Samples/todo-nodejs-mongo) - Βασικά μοτίβα ανάπτυξης
...
- [**Συχνές Ερωτήσεις (FAQ)**](resources/faq.md) - Συχνές ερωτήσεις οργανωμένες κατά κεφάλαιο μάθησης  
...
- [**Διαδραστικός Οδηγός Εργαστηρίου**](workshop/README.md) - Εργαστήριο μέσω browser με MkDocs και περιβάλλον DevContainer  
...
### ❌ "InsufficientQuota" ή "Υπέρβαση ορίου"
...
### ❌ "Αποτυχία πιστοποίησης" ή "Το διακριτικό έληξε"
...
<details>
<summary><strong>❌ "Αποτυχία πιστοποίησης" ή "Το διακριτικό έληξε"</strong></summary>
...
- **Προώθηση Καριέρας**: Ζητούμενη εμπειρία AZD και ανάπτυξης AI
...
- Έχετε πρόσβαση σε πρώιμες εκδόσεις νέων προτύπων AI  
...
- **Νέα Παραδείγματα**: Προσθήκη σεναρίων και προτύπων πραγματικού κόσμου  
- **Μετάφραση**: Βοήθεια στη διατήρηση υποστήριξης πολλαπλών γλωσσών  
- **Αναφορές Σφαλμάτων**: Βελτίωση ακρίβειας και σαφήνειας  
- **Πρότυπα Κοινότητας**: Τήρηση των συμπεριληπτικών κατευθυντήριων γραμμών της κοινότητας
