...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-11T10:02:07+00:00",
...
- Κατανοήσετε την επικύρωση πριν την ανάπτυξη και τον προγραμματισμό δυναμικότητας
...
- Εγκαταστήσετε, ρυθμίσετε και χρησιμοποιήσετε με επιτυχία το Azure Developer CLI
- Δημιουργήσετε και να αναπτύξετε εφαρμογές χρησιμοποιώντας πρότυπα AZD
- Εντοπίσετε και να επιλύσετε προβλήματα αυθεντικοποίησης, υποδομής και ανάπτυξης
- Εκτελέσετε ελέγχους πριν την ανάπτυξη, συμπεριλαμβανομένου του προγραμματισμού δυναμικότητας και της επιλογής SKU
- Εφαρμόσετε βέλτιστες πρακτικές παρακολούθησης, ασφάλειας και διαχείρισης κόστους
- Ενσωματώσετε ροές εργασίας AZD σε pipelines CI/CD
...
### Ξεκινώντας
- [**Βασικά του AZD**](docs/getting-started/azd-basics.md) - Κύριες έννοιες και ορολογία
...
- [**Προγραμματισμός Δυναμικότητας**](docs/pre-deployment/capacity-planning.md) - Επικύρωση δυναμικότητας πόρων Azure
...
## Παραδείγματα & Πρότυπα
- [**Παραδείγματα**]([examples/README.md) - Πρακτικά παραδείγματα, πρότυπα και σενάρια πραγματικού κόσμου για να μάθετε το Azure Developer CLI μέσω πρακτικής εξάσκησης. Κάθε παράδειγμα παρέχει πλήρη λειτουργικό κώδικα, πρότυπα υποδομής και λεπτομερείς οδηγίες για διαφορετικές αρχιτεκτονικές εφαρμογών και μοτίβα ανάπτυξης.

### Εργαστήριο/Workshop
- [**AZD Για Αρχάριους**](workshop/README.md) - Αυτό το workshop επικεντρώνεται στο πρότυπο Get Started with AI Agents AZD και παρέχει πρακτική εξάσκηση για την ανάπτυξη υπηρεσιών Azure AI χρησιμοποιώντας AZD

## Πόροι

### Γρήγορες Αναφορές
- [**Φυλλάδιο Εντολών**](resources/cheat-sheet.md) - Βασικές εντολές azd
- [**Γλωσσάρι**](resources/glossary.md) - Ορολογία Azure και azd
- [**Συχνές Ερωτήσεις**](resources/faq.md) - Συχνές ερωτήσεις
- [**Οδηγός Μελέτης**](resources/study-guide.md) - Ολοκληρωμένοι στόχοι μάθησης και ασκήσεις πρακτικής
...
1. Ξεκινήστε με [Βασικά του AZD](docs/getting-started/azd-basics.md)
...
4. Εξασκηθείτε με [Παράδειγμα Απλής Εφαρμογής Ιστού](../../examples/simple-web-app)
...
3. Εργαστείτε με [Παράδειγμα Εφαρμογής Βάσης Δεδομένων](../../examples/database-app)
4. Εξερευνήστε [Παράδειγμα Εφαρμογής Container](../../examples/container-app)

### Για Μηχανικούς DevOps
1. Κατακτήστε την [Προμήθεια Πόρων](docs/deployment/provisioning.md)
2. Εφαρμόστε [Έλεγχους Πριν την Πτήση](docs/pre-deployment/preflight-checks.md)
3. Εξασκηθείτε στον [Προγραμματισμό Δυναμικότητας](docs/pre-deployment/capacity-planning.md)
4. Προχωρήστε στο [Παράδειγμα Μικροϋπηρεσιών](../../examples/microservices)
