...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T15:12:22+00:00",
...
- Εγκαταστήσετε, διαμορφώσετε και χρησιμοποιήσετε με επιτυχία το Azure Developer CLI
...
### Για Προγραμματιστές
1. Ανασκόπηση [Οδηγού Διαμόρφωσης](docs/getting-started/configuration.md)
...
- [**Διαμόρφωση**](docs/getting-started/configuration.md) - Ρύθμιση περιβάλλοντος και αυθεντικοποίηση
...
- [**Ελέγχοι Πριν την Ανάπτυξη**](docs/pre-deployment/preflight-checks.md) - Αυτοματοποιημένα σενάρια επικύρωσης

### AI & Azure AI Foundry
- [**Ενσωμάτωση Azure AI Foundry**](docs/ai-foundry/azure-ai-foundry-integration.md) - Σύνδεση AZD με υπηρεσίες Azure AI Foundry
- [**Μοτίβα Ανάπτυξης Μοντέλων AI**](docs/ai-foundry/ai-model-deployment.md) - Ανάπτυξη και διαχείριση μοντέλων AI με AZD
- [**Εργαστήριο AI Workshop**](docs/ai-foundry/ai-workshop-lab.md) - Πρακτικό εργαστήριο: Κάνοντας λύσεις AI έτοιμες για AZD
- [**Βέλτι
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | Εφαρμογή συνομιλίας με δυνατότητα RAG και Azure OpenAI | ⭐⭐ | AzureOpenAI + Search + App Service |  
...
### Εργαστήρια & Εργαστήρια Εφαρμογής  
...
- **Συζητήσεις**: [Ερωτήσεις και συζητήσεις στην κοινότητα Microsoft Azure Discord](https://discord.gg/microsoft-azure)  
...
### Ενημερώσεις από την Κοινότητα Azure AI Foundry Discord  
