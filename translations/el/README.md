...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T15:38:52+00:00",
...
![AZD-για-αρχάριους](../../translated_images/el/azdbeginners.5527441dd9f74068.png) 
...
1. **Κάντε fork το αποθετήριο**: Click [![Forks στο GitHub](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Κλωνοποιήστε το αποθετήριο**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **Ενταχθείτε στην κοινότητα**: [Κοινότητες Discord του Azure](https://discord.com/invite/ByRwuEEgH4) για υποστήριξη από ειδικούς
4. **Επιλέξτε το μονοπάτι μάθησης σας**: Επιλέξτε ένα κεφάλαιο παρακάτω που ταιριάζει στο επίπεδο εμπειρίας σας
...
[Αραβικά](../ar/README.md) | [Μπενγκάλι](../bn/README.md) | [Βουλγαρικά](../bg/README.md) | [Βιρμανικά (Μιανμάρ)](../my/README.md) | [Κινέζικα (Απλοποιημένα)](../zh/README.md) | [Κινέζικα (Παραδοσιακά, Χονγκ Κονγκ)](../hk/README.md) | [Κινέζικα (Παραδοσιακά, Μακάο)](../mo/README.md) | [Κινέζικα (Παραδοσιακά, Ταϊβάν)](../tw/README.md) | [Κροατικά](../hr/README.md) | [Τσέχικα](../cs/README.md) | [Δανικά](../da/README.md) | [Ολλανδικά](../nl/README.md) | [Εσθονικά](../et/README.md) | [Φινλανδικά](../fi/README.md) | [Γαλλικά](../fr/README.md) | [Γερμανικά](../de/README.md) | [Ελληνικά](./README.md) | [Εβραϊκά](../he/README.md) | [Χίντι](../hi/README.md) | [Ουγγρικά](../hu/README.md) | [Ινδονησιακά](../id/README.md) | [Ιταλικά](../it/README.md) | [Ιαπωνικά](../ja/README.md) | [Κανάντα](../kn/README.md) | [Κορεατικά](../ko/README.md) | [Λιθουανικά](../lt/README.md) | [Μαλαιικά](../ms/README.md) | [Μαλαγιαλάμ](../ml/README.md) | [Μαραθικά](../mr/README.md) | [Νεπάλι](../ne/README.md) | [Νιγηριανό Pidgin](../pcm/README.md) | [Νορβηγικά](../no/README.md) | [Περσικά (Φαρσί)](../fa/README.md) | [Πολωνικά](../pl/README.md) | [Πορτογαλικά (Βραζιλία)](../br/README.md) | [Πορτογαλικά (Πορτογαλία)](../pt/README.md) | [Πουντζάμπι (Gurmukhi)](../pa/README.md) | [Ρουμανικά](../ro/README.md) | [Ρωσικά](../ru/README.md) | [Σερβικά (Κυριλλικά)](../sr/README.md) | [Σλοβάκικα](../sk/README.md) | [Σλοβενικά](../sl/README.md) | [Ισπανικά](../es/README.md) | [Σουαχίλι](../sw/README.md) | [Σουηδικά](../sv/README.md) | [Ταγκάλογκ (Φιλιππινέζικα)](../tl/README.md) | [Ταμίλ](../ta/README.md) | [Τελούγκου](../te/README.md) | [Ταϊλανδικά](../th/README.md) | [Τούρκικα](../tr/README.md) | [Ουκρανικά](../uk/README.md) | [Ουρντού](../ur/README.md) | [Βιετναμέζικα](../vi/README.md)
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## Επισκόπηση Μαθήματος

Κατακτήστε το Azure Developer CLI (azd) μέσω δομημένων κεφαλαίων σχεδιασμένων για προοδευτική μάθηση. **Ειδική έμφαση στην ανάπτυξη εφαρμογών AI με ενσωμάτωση του Microsoft Foundry.**

### Γιατί αυτό το μάθημα είναι απαραίτητο για σύγχρονους προγραμματιστές

Βάσει των γνώσεων της κοινότητας Discord του Microsoft Foundry, **το 45% των προγραμματιστών θέλει να χρησιμοποιήσει το AZD για φορτία εργασίας AI** αλλά αντιμετωπίζει προκλήσεις με:
...
- Επίλυση σφαλμάτων σε ζητήματα ανάπτυξης ειδικά για AI

### Στόχοι Μάθησης

Ολοκληρώνοντας αυτό το δομημένο μάθημα, θα:
- **Κατακτήστε τα Βασικά του AZD**: Βασικές έννοιες, εγκατάσταση και διαμόρφωση
- **Αναπτύξτε Εφαρμογές AI**: Χρησιμοποιήστε το AZD με τις υπηρεσίες Microsoft Foundry
- **Υλοποιήστε Υποδομή ως Κώδικα**: Διαχειριστείτε πόρους Azure με πρότυπα Bicep
- **Αντιμετωπίστε Σφάλματα Αναπτύξεων**: Επίλυση συνηθισμένων προβλημάτων και αποσφαλμάτωση
- **Βελτιστοποίηση για Παραγωγή**: Ασφάλεια, κλιμάκωση, παρακολούθηση και διαχείριση κόστους
- **Δημιουργήστε Λύσεις Πολλαπλών Πρακτόρων**: Αναπτύξτε σύνθετες αρχιτεκτονικές AI

## 📚 Κεφάλαια Μάθησης

*Επιλέξτε το μονοπάτι μάθησής σας με βάση το επίπεδο εμπειρίας και τους στόχους σας*
...
- **📖 Θεωρία**: [Βασικά AZD](docs/getting-started/azd-basics.md) - Κύριες έννοιες και ορολογία
- **⚙️ Ρύθμιση**: [Εγκατάσταση & Ρύθμιση](docs/getting-started/installation.md) - Οδηγοί ανά πλατφόρμα
- **🛠️ Πρακτική**: [Το Πρώτο σας Έργο](docs/getting-started/first-project.md) - Οδηγός βήμα προς βήμα
...
**📈 Επίπεδο Δεξιοτήτων Μετά:** Μπορείτε να αναπτύσσετε βασικές εφαρμογές ανεξάρτητα
...
- **📖 Σχέδια**: [Ανάπτυξη Μοντέλων AI](docs/microsoft-foundry/ai-model-deployment.md) - Αναπτύξτε και διαχειριστείτε μοντέλα AI
...
**💡 Αποτέλεσμα Κεφαλαίου**: Αναπτύξτε και διαμορφώστε μια εφαρμογή chat με δυνατότητες AI και RAG
...
azd init --template azure-search-openai-demo
azd up
# Δοκιμάστε τη διεπαφή συνομιλίας με τεχνητή νοημοσύνη
# Κάντε ερωτήσεις και λάβετε απαντήσεις που υποστηρίζονται από τεχνητή νοημοσύνη με πηγές
# Επιβεβαιώστε ότι η ενσωμάτωση αναζήτησης λειτουργεί
azd monitor  # Ελέγξτε ότι το Application Insights εμφανίζει τηλεμετρία
azd down --force --purge
```

**📊 Χρόνος Επένδυσης:** 1-2 ώρες  
**📈 Επίπεδο Δεξιοτήτων Μετά:** Μπορείτε να αναπτύσσετε και να διαμορφώνετε εφαρμογές AI έτοιμες για παραγωγή  
**💰 Συνειδητοποίηση Κόστους:** Κατανοήστε τα έξοδα ανάπτυξης $80-150/μήνα, κόστη παραγωγής $300-3500/μήνα

#### 💰 Σκέψεις Κόστους για Αναπτύξεις AI

**Περιβάλλον Ανάπτυξης (Εκτιμώμενο $80-150/μήνα):**
- Azure OpenAI (Πληρωμή κατά Χρήση): $0-50/μήνα (βάσει χρήσης tokens)
...
- Χρησιμοποιήστε **Δωρεάν Επίπεδο** Azure OpenAI για εκμάθηση (50,000 tokens/μήνα συμπεριλαμβάνονται)
- Εκτελέστε `azd down` για απελευθέρωση πόρων όταν δεν αναπτύσσετε ενεργά
- Ξεκινήστε με τιμολόγηση βάσει κατανάλωσης, αναβαθμίστε σε PTU μόνο για παραγωγή
...
#### Τι θα Μάθετε
- Διαμόρφωση και διαχείριση περιβαλλοντικών ρυθμίσεων
- Βέλτιστες πρακτικές αυθεντικοποίησης και ασφάλειας
- Ονομασία και οργάνωση πόρων

#### Πόροι Μάθησης
- **📖 Διαμόρφωση**: [Οδηγός Διαμόρφωσης](docs/getting-started/configuration.md) - Ρύθμιση περιβάλλοντος
- **🔐 Ασφάλεια**: [Σχέδια αυθεντικοποίησης και managed identity](docs/getting-started/authsecurity.md) - Σχέδια αυθεντικοποίησης
...
#### Τι θα Μάθετε
- Σύνθετα πρότυπα ανάπτυξης
- Υποδομή ως Κώδικας με Bicep
- Στρατηγικές παροχής πόρων

#### Πόροι Μάθησης
- **📖 Ανάπτυξη**: [Οδηγός Ανάπτυξης](docs/deployment/deployment-guide.md) - Πλήρη ροή εργασιών
...
### 🎯 Κεφάλαιο 5: Λύσεις AI με Πολλαπλούς Πράκτορες (Σύνθετο)
...
#### Πόροι Μάθησης
- **🤖 Επιλεγμένο Έργο**: [Λύση Λιανικής με Πολλαπλούς Πράκτορες](examples/retail-scenario.md) - Πλήρης υλοποίηση
- **🛠️ Πρότυπα ARM**: [Πακέτο Προτύπων ARM](../../examples/retail-multiagent-arm-template) - Εγκατάσταση με ένα κλικ
...
**💡 Αποτέλεσμα Κεφαλαίου**: Αναπτύξτε και διαχειριστείτε μια έτοιμη για παραγωγή λύση πολλαπλών πρακτόρων AI με τους πράκτορες Customer και Inventory

---

### 🔍 Κεφάλαιο 6: Επαλήθευση και Σχεδιασμός πριν την Ανάπτυξη
**Προαπαιτούμενα**: Ολοκληρωμένο το Κεφάλαιο 4  
**Διάρκεια**: 1 ώρα  
**Πολυπλοκότητα**: ⭐⭐

#### Τι θα Μάθετε
- Προγραμματισμός δυναμικότητας και επαλήθευση πόρων
- Στρατηγικές επιλογής SKU
- Προ-αναπτυξιακοί έλεγχοι και αυτοματοποίηση

#### Πόροι Μάθησης
- **📊 Σχεδιασμός**: [Σχεδιασμός Δυναμικότητας](docs/pre-deployment/capacity-planning.md) - Επαλήθευση πόρων
- **💰 Επιλογή**: [Επιλογή SKU](docs/pre-deployment/sku-selection.md) - Οικονομικά αποδοτικές επιλογές
- **✅ Επαλήθευση**: [Προ-αναπτυξιακοί Έλεγχοι](docs/pre-deployment/preflight-checks.md) - Αυτοματοποιημένα σενάρια

#### Πρακτικές Ασκήσεις
- Εκτελέστε σενάρια επαλήθευσης δυναμικότητας
- Βελτιστοποιήστε τις επιλογές SKU για κόστος
- Υλοποιήστε αυτοματοποιημένους προ-αναπτυξιακούς ελέγχους
...
- **🕵️ Αποσφαλμάτωση**: [Οδηγός Αποσφαλμάτωσης](docs/troubleshooting/debugging.md) - Στρατηγικές βήμα-βήμα
- **🤖 Προβλήματα AI**: [Επίλυση Προβλημάτων για AI](docs/troubleshooting/ai-troubleshooting.md) - Προβλήματα υπηρεσιών AI
...
#### Πόροι Μάθησης
- **🏭 Παραγωγή**: [Καλές Πρακτικές AI για Παραγωγή](docs/microsoft-foundry/production-ai-practices.md) - Επιχειρησιακά πρότυπα
- **📝 Παραδείγματα**: [Παράδειγμα Μικροϋπηρεσιών](../../examples/microservices) - Πολύπλοκες αρχιτεκτονικές
...
## 🎓 Επισκόπηση Εργαστηρίου: Εμπειρία Πρακτικής Εκμάθησης

> **⚠️ ΚΑΤΑΣΤΑΣΗ ΕΡΓΑΣΤΗΡΙΟΥ: Σε Ενεργή Ανάπτυξη**  
> Τα υλικά του εργαστηρίου αναπτύσσονται και βελτιώνονται αυτή τη στιγμή. Οι βασικές ενότητες λειτουργούν, αλλά κάποιες προχωρημένες ενότητες δεν έχουν ολοκληρωθεί. Δουλεύουμε ενεργά για να ολοκληρώσουμε όλο το περιεχόμενο. [Παρακολουθήστε την πρόοδο →](workshop/README.md)
...
Τα υλικά του εργαστηρίου παρέχουν μια δομημένη, διαδραστική εμπειρία μάθησης που συμπληρώνει το κεφαλαιοκεντρικό πρόγραμμα σπουδών παραπάνω. Το εργαστήριο έχει σχεδιαστεί τόσο για αυτορυθμιζόμενη μάθηση όσο και για συνεδρίες υπό καθοδήγηση εκπαιδευτή.

#### 🛠️ Χαρακτηριστικά Εργαστηρίου
- **Περιβάλλον στο πρόγραμμα περιήγησης**: Ολοκληρωμένο εργαστήριο με βάση το MkDocs με λειτουργίες αναζήτησης, αντιγραφής και θέματος
- **Ενσωμάτωση GitHub Codespaces**: Ρύθμιση περιβάλλοντος ανάπτυξης με ένα κλικ
- **Δομημένη Διαδρομή Μάθησης**: 7 βήματα καθοδηγούμενες ασκήσεις (συνολικά 3,5 ώρες)
...
#### 📚 Δομή Εργαστηρίου
Το εργαστήριο ακολουθεί μια μεθοδολογία **Ανακάλυψη → Ανάπτυξη → Προσαρμογή**:

1. **Φάση Ανακάλυψης** (45 λεπτά)
   - Εξερευνήστε πρότυπα και υπηρεσίες του Microsoft Foundry
   - Κατανοήστε πρότυπα αρχιτεκτονικής πολλαπλών πρακτόρων
   - Επανεξετάστε τις απαιτήσεις ανάπτυξης και τα προαπαιτούμενα

2. **Φάση Ανάπτυξης** (2 ώρες)
   - Πρακτική ανάπτυξη εφαρμογών AI με το AZD
   - Διαμορφώστε υπηρεσίες Azure AI και endpoints
   - Υλοποιήστε πρότυπα ασφάλειας και πιστοποίησης

3. **Φάση Προσαρμογής** (45 λεπτά)
   - Τροποποιήστε εφαρμογές για συγκεκριμένες περιπτώσεις χρήσης
   - Βελτιστοποιήστε για ανάπτυξη σε παραγωγή
   - Υλοποιήστε παρακολούθηση και διαχείριση κόστους
...
#### 🎯 Αποτέλεσμα Μάθησης Εργαστηρίου
Ολοκληρώνοντας το εργαστήριο, οι συμμετέχοντες θα:
- **Αναπτύξτε Εφαρμογές AI για Παραγωγή**: Χρησιμοποιήστε το AZD με υπηρεσίες Microsoft Foundry
- **Κατακτήστε Αρχιτεκτονικές Πολλαπλών Πρακτόρων**: Υλοποιήστε συντονισμένες λύσεις πράκτορων AI
- **Υλοποιήστε Καλές Πρακτικές Ασφάλειας**: Διαμορφώστε πιστοποίηση και έλεγχο πρόσβασης
- **Βελτιστοποιήστε για Κλιμάκωση**: Σχεδιάστε οικονομικά αποδοτικές αναπτύξεις υψηλής απόδοσης
- **Επιλύστε Προβλήματα Αναπτύξεων**: Επίλυση κοινών προβλημάτων ανεξάρτητα

#### 📖 Πόροι Εργαστηρίου
- **🎥 Διαδραστικός Οδηγός**: [Υλικά Εργαστηρίου](workshop/README.md) - Περιβάλλον μάθησης στο πρόγραμμα περιήγησης
- **📋 Οδηγίες Βήμα-Βήμα**: [Καθοδηγούμενες Ασκήσεις](../../workshop/docs/instructions) - Αναλυτικές οδηγίες
- **🛠️ Εργαστήριο AI**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Ασκήσεις εστιασμένες στο AI
- **💡 Γρήγορη Εκκίνηση**: [Οδηγός Ρύθμισης Εργαστηρίου](workshop/README.md#quick-start) - Ρύθμιση περιβάλλοντος

**Ιδανικό για**: Επιχειρησιακή εκπαίδευση, πανεπιστημιακά μαθήματα, αυτορυθμιζόμενη μάθηση και bootcamps για προγραμματιστές.

---

## 📖 Τι είναι το Azure Developer CLI;

Το Azure Developer CLI (azd) είναι μια διεπαφή γραμμής εντολών επικεντρωμένη στον προγραμματιστή που επιταχύνει τη διαδικασία δημιουργίας και ανάπτυξης εφαρμογών στο Azure. Παρέχει:
...
- **Ενοποιημένες ροές εργασίας** - Παρέχετε, αναπτύσσετε και παρακολουθείτε εφαρμογές απρόσκοπτα
...
- **Πρότυπα Έτοιμα για AI** - Προ-διαμορφωμένα πρότυπα για Azure OpenAI, Cognitive Services, και φόρτους εργασίας ML
- **Ασφαλείς Αναπτύξεις AI** - Ενσωματωμένα πρότυπα ασφάλειας για υπηρεσίες AI, κλειδιά API, και endpoints μοντέλων  
- **Πρότυπα Παραγωγής AI** - Καλές πρακτικές για κλιμακούμενες, οικονομικά αποδοτικές αναπτύξεις εφαρμογών AI
- **Ροές Εργασίας AI End-to-End** - Από την ανάπτυξη μοντέλου έως την παραγωγική ανάπτυξη με σωστή παρακολούθηση
...
| [**Γρήγορη Εκκίνηση Εφαρμογής OpenAI Chat**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Κεφάλαιο 2 | ⭐ | AzureOpenAI + Container Apps + Application Insights | Εξωτερικό |
...
| [**Λύση Λιανικής Πολλαπλών Πρακτόρων**](examples/retail-scenario.md) | Κεφάλαιο 5 | ⭐⭐⭐⭐ | AzureOpenAI + AI Search + Storage + Container Apps + Cosmos DB | **Τοπικό** |

### Επιλεγμένα: Πλήρη Σενάρια Μάθησης
**Πρότυπα εφαρμογών έτοιμα για παραγωγή αντιστοιχισμένα με κεφάλαια μάθησης**

| Πρότυπο | Κεφάλαιο Μάθησης | Πολυπλοκότητα | Κύριο Μάθημα |
|----------|------------------|------------|--------------|
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Κεφάλαιο 8 | ⭐⭐⭐ | Ενορχήστρωση AI για επιχειρήσεις |
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Κεφάλαιο 5 | ⭐⭐⭐⭐ | Αρχιτεκτονική πολλαπλών πρακτόρων με πράκτορες Customer και Inventory |

### Μάθηση μέσω Παραδειγμάτων ανά Τύπο
...
- [**Λύση Λιανικής Πολλαπλών Πρακτόρων**](examples/retail-scenario.md) - Πλήρης υλοποίηση έτοιμη για παραγωγή με πρότυπα ARM
  - Αρχιτεκτονική πολλαπλών πρακτόρων (Customer + Inventory agents)
  - Ολοκληρωμένη παρακολούθηση και αξιολόγηση
  - Εγκατάσταση με ένα κλικ μέσω προτύπου ARM

#### Τοπικά Παραδείγματα - Εφαρμογές Container (Κεφάλαια 2-5)
**Ολοκληρωμένα παραδείγματα ανάπτυξης container σε αυτό το αποθετήριο:**
- [**Παραδείγματα Container App**](examples/container-app/README.md) - Πλήρης οδηγός για αναπτύξεις με containers
  - [Απλό Flask API](../../examples/container-app/simple-flask-api) - Βασικό REST API με κλιμάκωση στο μηδέν
  - [Αρχιτεκτονική Μικροϋπηρεσιών](../../examples/container-app/microservices) - Αναπτυξη πολλαπλών υπηρεσιών έτοιμη για παραγωγή
  - Γρήγορη Έναρξη, Παραγωγή, και Προχωρημένα μοτίβα ανάπτυξης
...
- [Database App - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - Μοτίβα συνδεσιμότητας βάσης δεδομένων
...
### Γρήγορες Αναφορές
- [**Συνοπτική Αναφορά Εντολών**](resources/cheat-sheet.md) - Βασικές εντολές azd οργανωμένες ανά κεφάλαιο
- [**Γλωσσάρι**](resources/glossary.md) - Όροι Azure και azd  
- [**Συχνές Ερωτήσεις**](resources/faq.md) - Συνήθεις ερωτήσεις οργανωμένες ανά κεφάλαιο μάθησης
- [**Οδηγός Μελέτης**](resources/study-guide.md) - Περιεκτικές ασκήσεις εξάσκησης

### Πρακτικά Εργαστήρια
- [**AI Workshop Lab**](docs/microsoft-foundry/ai-workshop-lab.md) - Κάντε τις λύσεις AI σας αναπτύξιμες με AZD (2-3 hours)
- [**Interactive Workshop Guide**](workshop/README.md) - Εργαστήριο στον περιηγητή με MkDocs και περιβάλλον DevContainer
- [**Structured Learning Path**](../../workshop/docs/instructions) -7-βηματικές καθοδηγούμενες ασκήσεις (Ανακάλυψη → Ανάπτυξη → Προσαρμογή)
- [**AZD For Beginners Workshop**](workshop/README.md) - Πλήρες πρακτικό υλικό εργαστηρίου με ενσωμάτωση GitHub Codespaces
...
# Τότε επαναπροσπαθήστε με νέο περιβάλλον
azd env new dev-v2
azd up
```
...
# Αν κολλήσετε για πάνω από 30 λεπτά, ελέγξτε το Azure Portal:
azd monitor
...
- **Προβλήματα Σχετικά με AI:** [Επίλυση Προβλημάτων AI](docs/troubleshooting/ai-troubleshooting.md)
- **Οδηγός Αποσφαλμάτωσης:** [Αποσφαλμάτωση βήμα προς βήμα](docs/troubleshooting/debugging.md)
...
<details>
<summary><strong>❌ Η ανάπτυξη του template διαρκεί πολύ</strong></summary>
...
# Ζητήστε από τον διαχειριστή Azure να χορηγήσει:
# - Contributor (για πόρους)
# - User Access Administrator (για εκχώρηση ρόλων)
```
</details>

<details>
<summary><strong>❌ Δεν μπορείτε να βρείτε το URL της αναπτυγμένης εφαρμογής</strong></summary>
...
- [ ] **Κεφάλαιο 3**: Διαμόρφωση & Επαλήθευση ταυτότητας ✅
...
- [ ] **Κεφάλαιο 7**: Επίλυση Προβλημάτων & Αποσφαλμάτωση ✅
- [ ] **Κεφάλαιο 8**: Μοτίβα Παραγωγής & Επιχειρησιακά ✅

### Επαλήθευση Μάθησης
Μετά την ολοκλήρωση κάθε κεφαλαίου, επαληθεύστε τη γνώση σας με:
1. **Πρακτική Άσκηση**: Ολοκληρώστε την πρακτική ανάπτυξη του κεφαλαίου
2. **Έλεγχος Γνώσης**: Αναθεωρήστε την ενότητα Συχνές Ερωτήσεις για το κεφάλαιό σας
...
- **Επαγγελματική Ανάπτυξη**: Εξειδίκευση σε AZD και ανάπτυξη AI σε ζήτηση
...
- **Τεχνικά Προβλήματα**: [Αναφέρετε σφάλματα και ζητήστε χαρακτηριστικά](https://github.com/microsoft/azd-for-beginners/issues)
- **Ερωτήσεις Μάθησης**: [Κοινότητα Discord του Microsoft Azure](https://discord.gg/microsoft-azure) και [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
- **Βοήθεια για AI**: Join the [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- **45%** των προγραμματιστών θέλει να χρησιμοποιήσει το AZD για φόρτο εργασίας AI
- **Κύριες προκλήσεις**: Ανάπτυξη πολλαπλών υπηρεσιών, διαχείριση διαπιστευτηρίων, ετοιμότητα για παραγωγή  
- **Τα πιο απαιτούμενα**: AI-specific templates, οδηγοί επίλυσης προβλημάτων, βέλτιστες πρακτικές
...
- Επηρεάστε την ανάπτυξη μελλοντικών λειτουργιών AI + AZD
...
### Άδεια
Αυτό το έργο διατίθεται υπό την άδεια MIT - δείτε το [LICENSE](../../LICENSE) αρχείο για λεπτομέρειες.
...
**Προγραμματιστές AI**: Πηγαίνετε στο [Κεφάλαιο 2: Ανάπτυξη με Προτεραιότητα στο AI](../..)  
**Έμπειροι Προγραμματιστές**: Ξεκινήστε με [Κεφάλαιο 3: Διαμόρφωση & Αυθεντικοποίηση](../..)

**Επόμενα Βήματα**: [Ξεκινήστε Κεφάλαιο 1 - Βασικά του AZD](docs/getting-started/azd-basics.md) →

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**Αποποίηση ευθυνών**:
Αυτό το έγγραφο έχει μεταφραστεί χρησιμοποιώντας την υπηρεσία μετάφρασης με ΤΝ [Co-op Translator](https://github.com/Azure/co-op-translator). Παρά τις προσπάθειές μας για ακρίβεια, παρακαλείστε να λάβετε υπόψη ότι οι αυτοματοποιημένες μεταφράσεις ενδέχεται να περιέχουν σφάλματα ή ανακρίβειες. Το πρωτότυπο έγγραφο στην αρχική του γλώσσα πρέπει να θεωρείται ως η αυθεντική πηγή. Για κρίσιμες πληροφορίες συνιστάται επαγγελματική ανθρώπινη μετάφραση. Δεν φέρουμε ευθύνη για τυχόν παρεξηγήσεις ή λανθασμένες ερμηνείες που προκύπτουν από τη χρήση αυτής της μετάφρασης.
