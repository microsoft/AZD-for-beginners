...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T13:56:41+00:00",
...
1. **Κάντε Fork το Αποθετήριο**: Κάντε κλικ [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Κλωνοποιήστε το Αποθετήριο**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **Εγγραφείτε στην Κοινότητα**: [Azure Discord Communities](https://discord.com/invite/ByRwuEEgH4) για υποστήριξη από ειδικούς
...
Βάσει των πληροφοριών από την κοινότητα Microsoft Foundry Discord, **το 45% των προγραμματιστών θέλει να χρησιμοποιήσει το AZD για AI workloads** αλλά αντιμετωπίζει προκλήσεις με:
...
- Επίλυση προβλημάτων ειδικών για ανάπτυξη AI
...
- **Επιλύσετε Προβλήματα Ανάπτυξης**: Επίλυση κοινών ζητημάτων και αποσφαλμάτωση
...
- **🛠️ Πρακτική**: [Το Πρώτο Σας Έργο](docs/getting-started/first-project.md) - Βήμα-βήμα οδηγός
- **📋 Γρήγορη Αναφορά**: [Φύλλο Απάτης Εντολών](resources/cheat-sheet.md)
...
**💡 Αποτέλεσμα Κεφαλαίου**: Ανάπτυξη και ρύθμιση εφαρμογής chat με AI και δυνατότητες RAG
...
- Azure OpenAI (Πληρωμή ανά χρήση): $0-50/μήνα (ανάλογα με χρήση tokens)
...
- Azure OpenAI (PTU για σταθερή απόδοση): $3,000+/μήνα Ή Πληρωμή ανά χρήση με μεγάλο όγκο
...
- Καλύτερες πρακτικές πιστοποίησης και ασφάλειας
- Ονοματοδοσία και οργάνωση πόρων

#### Πόροι Μάθησης
- **📖 Ρύθμιση**: [Οδηγός Ρύθμισης](docs/getting-started/configuration.md) - Ρύθμιση περιβάλλοντος
- **🔐 Ασφάλεια**: [Πρότυπα πιστοποίησης και διαχειριζόμενη ταυτότητα](docs/getting-started/authsecurity.md) - Πρότυπα πιστοποίησης
...
- Εγκατάσταση πιστοποίησης με διαχειριζόμενη ταυτότητα
- Εφαρμογή ρυθμίσεων ειδικών για κάθε περιβάλλον

**💡 Αποτέλεσμα Κεφαλαίου**: Διαχείριση πολλαπλών περιβαλλόντων με σωστή πιστοποίηση και ασφάλεια
...
- **🏗️ Παροχή Πόρων**: [Παροχή Πόρων](docs/deployment/provisioning.md) - Διαχείριση πόρων Azure
...
**💡 Αποτέλεσμα Κεφαλαίου**: Ανάπτυξη πολύπλοκων εφαρμογών πολλαπλών υπηρεσιών με προσαρμοσμένα πρότυπα υποδομής

---

### 🎯 Κεφάλαιο 5: Πολυ-Πρακτορικές Λύσεις AI (Προχωρημένο)
...
**💡 Αποτέλεσμα Κεφαλαίου**: Ανάπτυξη και διαχείριση μιας έτοιμης για παραγωγή λύσης πολλαπλών πρακτόρων AI με πράκτορες Πελάτη και Αποθεμάτων
...
- Έλεγχοι πριν την πτήση και αυτοματοποίηση

#### Πόροι Μάθησης
- **📊 Σχεδιασμός**: [Σχεδιασμός Χωρητικότητας](docs/pre-deployment/capacity-planning.md) - Επαλήθευση πόρων
- **💰 Επιλογή**: [Επιλογή SKU](docs/pre-deployment/sku-selection.md) - Οικονομικές επιλογές
- **✅ Επαλήθευση**: [Έλεγχοι πριν την πτήση](docs/pre-deployment/preflight-checks.md) - Αυτοματοποιημένα σενάρια
...
**💡 Αποτέλεσμα Κεφαλαίου**: Επαλήθευση και βελτιστοποίηση αναπτύξεων πριν την εκτέλεση
...
- **🤖 Προβλήματα AI**: [Ειδική Αντιμετώπιση AI](docs/troubleshooting/ai-troubleshooting.md) - Προβλήματα υπηρεσιών AI

#### Πρακτικές Ασκήσεις
- Διάγνωση αποτυχιών ανάπτυξης
- Επίλυση προβλημάτων πιστοποίησης
- Αποσφαλμάτωση σύνδεσης υπηρεσιών AI

**💡 Αποτέλεσμα Κεφαλαίου**: Ανεξάρτητη διάγνωση και επίλυση κοινών προβλημάτων ανάπτυξης
...
- Πρότυπα ασφάλειας επιχειρήσεων
- Παρακολούθηση και βελτιστοποίηση κόστους

#### Πόροι Μάθησης
- **🏭 Παραγωγή**: [Καλές Πρακτικές AI Παραγωγής](docs/microsoft-foundry/production-ai-practices.md) - Πρότυπα επιχειρήσεων
...
#### Πρακτικές Ασκήσεις
- Υλοποίηση προτύπων ασφάλειας επιχειρήσεων
...
## 🎓 Επισκόπηση Εργαστηρίου: Εμπειρία Μάθησης με Πρακτική

> **⚠️ ΚΑΤΑΣΤΑΣΗ ΕΡΓΑΣΤΗΡΙΟΥ: Ενεργή Ανάπτυξη**  
> Το υλικό του εργαστηρίου αναπτύσσεται και βελτιώνεται συνεχώς. Οι βασικές ενότητες λειτουργούν, αλλά ορισμένα προχωρημένα τμήματα είναι ατελή. Εργαζόμαστε ενεργά για την ολοκλήρωση όλου του περιεχομένου. [Παρακολούθηση προόδου →](workshop/README.md)

### Διαδραστικό Υλικό Εργαστηρίου
**Ολοκληρωμένη πρακτική μάθηση με εργαλεία browser και καθοδηγούμενες ασκήσεις**

Το υλικό του εργαστηρίου παρέχει μια δομημένη, διαδραστική εμπειρία μάθησης που συμπληρώνει το πρόγραμμα με βάση τα κεφάλαια παραπάνω. Το εργαστήριο είναι σχεδιασμένο για αυτορυθμιζόμενη μάθηση και συνεδρίες με εκπαιδευτή.

#### 🛠️ Χαρακτηριστικά Εργαστηρίου
- **Διεπαφή μέσω Browser**: Πλήρες εργαστήριο με MkDocs, αναζήτηση, αντιγραφή και θέματα
...
2. **Φάση Ανάπτυξης** (2 ώρες)
   ...
   - Ρύθμιση υπηρεσιών Azure AI και endpoints
...
- **Αναπτύξουν Παραγωγικές Εφαρμογές AI**: Χρήση AZD με υπηρεσίες Microsoft Foundry
- **Κατακτήσουν Αρχιτεκτονικές Πολλαπλών Πρακτόρων**: Υλοποίηση συντονισμένων λύσεων πρακτόρων AI
- **Υλοποιήσουν Καλές Πρακτικές Ασφάλειας**: Ρύθμιση πιστοποίησης και ελέγχου πρόσβασης
...
#### 📖 Πόροι Εργαστηρίου
- **🎥 Διαδραστικός Οδηγός**: [Υλικό Εργαστηρίου](workshop/README.md) - Περιβάλλον μάθησης μέσω browser
- **📋 Οδηγίες Βήμα-Βήμα**: [Καθοδηγούμενες Ασκήσεις](../../workshop/docs/instructions) - Αναλυτικές οδηγίες
- **🛠️ Εργαστήριο AI**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Ασκήσεις εστιασμένες σε AI
- **💡 Γρήγορη Εκκίνηση**: [Οδηγός Ρύθμισης Εργαστηρίου](workshop/README.md#quick-start) - Διαμόρφωση περιβάλλοντος

**Ιδανικό για**: Εκπαίδευση εταιρειών, πανεπιστημιακά μαθήματα, αυτορυθμιζόμενη μάθηση και bootcamps προγραμματιστών.

---

## 📖 Τι είναι το Azure Developer CLI;

Το Azure Developer CLI (azd) είναι μια διεπαφή γραμμής εντολών προσανατολισμένη στον προγραμματιστή που επιταχύνει τη διαδικασία δημιουργίας και ανάπτυξης εφαρμογών στο Azure. Παρέχει:

- **Αναπτύξεις βασισμένες σε πρότυπα** - Χρήση προ-κατασκευασμένων προτύπων για κοινά πρότυπα εφαρμογών
...
- **Πρότυπα έτοιμα για AI** - Προδιαμορφωμένα πρότυπα για Azure OpenAI, Cognitive Services και φορτία ML
- **Ασφαλείς αναπτύξεις AI** - Ενσωματωμένα πρότυπα ασφάλειας για υπηρεσίες AI, κλειδιά API και endpoints μοντέλων  
- **Πρότυπα παραγωγής AI** - Καλές πρακτικές για κλιμακούμενες, οικονομικές αναπτύξεις εφαρμογών AI
- **Ολοκληρωμένες ροές εργασίας AI** - Από την ανάπτυξη μοντέλου έως την παραγωγική ανάπτυξη με σωστή παρακολούθηση
- **Βελτιστοποίηση κόστους** - Έξυπνη κατανομή πόρων και στρατηγικές κλιμάκωσης για φορτία AI
- **Ενσωμάτωση Microsoft Foundry** - Αδιάλειπτη σύνδεση με τον κατάλογο μοντέλων και endpoints Microsoft Foundry
...
> **Σημείωση:** Αυτά τα πρότυπα παρουσιάζουν διάφορα πρότυπα AI. Μερικά είναι εξωτερικά δείγματα Azure, άλλα τοπικές υλοποιήσεις.
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Κεφάλαιο 8 | ⭐⭐⭐ | Ορχήστρωση AI επιχειρήσεων |
...
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Πλήρης υλοποίηση παραγωγής με πρότυπα ARM
...
- [Εφαρμογή Βάσης Δεδομένων - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - Πρότυπα σύνδεσης βάσης δεδομένων
...
### Γρήγορες Αναφορές
- [**Φύλλο Απάτης Εντολών**](resources/cheat-sheet.md) - Βασικές εντολές azd οργανωμένες κατά κεφάλαιο  
...
- [**Διαδραστικός Οδηγός Εργαστηρίου**](workshop/README.md) - Εργαστήριο βασισμένο σε πρόγραμμα περιήγησης με MkDocs και Περιβάλλον DevContainer  
...
### ❌ "Ανεπαρκές Όριο" ή "Υπέρβαση Ορίου"
...
### ❌ "Αποτυχία Επαλήθευσης" ή "Το διακριτικό έληξε"
...
### ❌ "Άδεια απορρίφθηκε" ή "Απαγορεύεται"
...
<details>
<summary><strong>❌ "Ανεπαρκές Όριο" ή "Υπέρβαση Ορίου"</strong></summary>
...
<details>
<summary><strong>❌ "Αποτυχία Επαλήθευσης" ή "Το διακριτικό έληξε"</strong></summary>
...
<details>
<summary><strong>❌ "Άδεια απορρίφθηκε" ή "Απαγορεύεται"</strong></summary>
...
- [ ] **Κεφάλαιο 2**: Ανάπτυξη με Προτεραιότητα AI ✅  
- [ ] **Κεφάλαιο 3**: Διαμόρφωση & Επαλήθευση ✅  
...
2. **Έλεγχος Γνώσεων**: Ανασκόπηση της ενότητας FAQ για το κεφάλαιο  
...
- **Προώθηση Καριέρας**: Ζητούμενη εμπειρία σε AZD και ανάπτυξη AI
...
- **Τεχνικά Προβλήματα**: [Αναφέρετε σφάλματα και ζητήστε λειτουργίες](https://github.com/microsoft/azd-for-beginners/issues)  
...
### Εμπειρίες Κοινότητας από το Microsoft Foundry Discord
...
- Επηρεάσετε τη μελλοντική ανάπτυξη χαρακτηριστικών AI + AZD
...
- **Μετάφραση**: Βοήθεια στη διατήρηση υποστήριξης πολλαπλών γλωσσών  
- **Αναφορές Σφαλμάτων**: Βελτίωση ακρίβειας και σαφήνειας  
- **Πρότυπα Κοινότητας**: Ακολουθήστε τις συμπεριληπτικές οδηγίες της κοινότητας
...
**Έμπειροι Προγραμματιστές**: Ξεκινήστε με το [Κεφάλαιο 3: Διαμόρφωση & Πιστοποίηση](../..)
