...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T22:44:09+00:00",
...
Αυτό το αναλυτικό φυλλάδιο παρέχει γρήγορη αναφορά στις πιο συχνά χρησιμοποιούμενες εντολές του Azure Developer CLI, οργανωμένες ανά κατηγορία με πρακτικά παραδείγματα. Ιδανικό για γρήγορες αναζητήσεις κατά την ανάπτυξη, την αντιμετώπιση προβλημάτων και τις καθημερινές λειτουργίες με έργα azd.
...
- Εντοπίσετε αποτελεσματικά επιλογές προηγμένης διαμόρφωσης και προσαρμογής
- Εντοπίσετε εντολές διαχείρισης περιβάλλοντος και ροών εργασίας πολλαπλών περιβαλλόντων
...
### Ροές Εργασίας Pipeline και CI/CD
```bash
