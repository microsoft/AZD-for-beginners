...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:37:46+00:00",
  "source_file": "docs/deployment/deployment-guide.md",
  "language_code": "el"
}
-->
# Οδηγός Ανάπτυξης - Κατακτώντας τις Αναπτύξεις AZD
...
- Κατανοήσετε τον πλήρη κύκλο ζωής ανάπτυξης από την προετοιμασία έως την παρακολούθηση
...
- Εκτελείτε και να επιλύετε προβλήματα σε όλες τις ροές εργασίας ανάπτυξης azd ανεξάρτητα
- Σχεδιάζετε και να εφαρμόζετε προσαρμοσμένη αυτοματοποίηση ανάπτυξης χρησιμοποιώντας hooks
...
- `azd up` - Πλήρης ροή εργασίας (προετοιμασία + ανάπτυξη)
...
### Φάση 3: Hooks Μετά την Προετοιμασία
```yaml
hooks:
  postprovision:
    shell: pwsh
...
### Ρυθμίσεις Ανάπτυξης για Συγκεκριμένες Υπηρεσίες
```yaml
# azure.yaml
services:
  web:
...
### Ρυθμίσεις Συγκεκριμένες για Περιβάλλοντα
```bash
...
- [Προετοιμασία Πόρων](provisioning.md) - Εμβάθυνση στη διαχείριση υποδομής
...
- **Επόμενο Μάθημα**: [Προετοιμασία Πόρων](provisioning.md)
