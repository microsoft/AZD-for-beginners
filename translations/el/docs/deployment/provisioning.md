...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:41:45+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "el"
}
-->
# Παροχή Πόρων - Υποδομή ως Κώδικας με AZD

## Εισαγωγή

Αυτός ο αναλυτικός οδηγός καλύπτει όλα όσα χρειάζεστε για την παροχή και τη διαχείριση πόρων Azure χρησιμοποιώντας το Azure Developer CLI. Μάθετε να εφαρμόζετε μοτίβα Υποδομής ως Κώδικας (IaC) από τη βασική δημιουργία πόρων έως προηγμένες αρχιτεκτονικές υποδομής επιχειρησιακής κλάσης χρησιμοποιώντας Bicep, ARM templates, Terraform και Pulumi.
...
- Ρυθμίσετε παραμέτρους πόρων, μεταβλητές και ρυθμίσεις που εξαρτώνται από το περιβάλλον
...
- Αντιμετωπίσετε προβλήματα παροχής υποδομής και επιλύσετε αποτυχίες ανάπτυξης
- Εφαρμόσετε τις αρχές του Azure Well-Architected Framework στον σχεδιασμό υποδομής
- Διαχειριστείτε ενημερώσεις υποδομής και υλοποιήσετε στρατηγικές έκδοσης υποδομής
...
- **ARM Templates** - Πρότυπα JSON για το Azure Resource Manager
...
## 🔧 Ρυθμίσεις Εξαρτώμενες από το Περιβάλλον
...
## 🔄 Ενημερώσεις και Μετακινήσεις Πόρων
...
- [Κοινά Προβλήματα](../troubleshooting/common-issues.md) - Αντιμετώπιση προβλημάτων υποδομής
- [Οδηγός Εντοπισμού Σφαλμάτων](../troubleshooting/debugging.md) - Εντοπισμός σφαλμάτων παροχής
...
- [Πλαίσιο Well-Architected του Azure](https://learn.microsoft.com/en-us/azure/well-architected/)
