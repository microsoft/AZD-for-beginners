...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:53:17+00:00",
  "source_file": "docs/pre-deployment/preflight-checks.md",
  "language_code": "el"
}
-->
# Έλεγχοι Πριν την Ανάπτυξη - Επικύρωση Ετοιμότητας Ανάπτυξης

## Εισαγωγή

Αυτός ο ολοκληρωμένος οδηγός παρέχει σενάρια και διαδικασίες επικύρωσης πριν την ανάπτυξη, για να διασφαλίσετε επιτυχημένες αναπτύξεις με το Azure Developer CLI πριν ξεκινήσουν. Μάθετε πώς να εφαρμόζετε αυτοματοποιημένους ελέγχους για αυθεντικοποίηση, διαθεσιμότητα πόρων, όρια, συμμόρφωση ασφαλείας και απαιτήσεις απόδοσης, ώστε να αποτρέψετε αποτυχίες ανάπτυξης και να βελτιστοποιήσετε τα ποσοστά επιτυχίας.

## Στόχοι Μάθησης

Με την ολοκλήρωση αυτού του οδηγού, θα:
- Κατακτήσετε τεχνικές και σενάρια αυτοματοποιημένης επικύρωσης πριν την ανάπτυξη
- Κατανοήσετε στρατηγικές ελέγχου για αυθεντικοποίηση, δικαιώματα και όρια
- Εφαρμόσετε διαδικασίες επικύρωσης διαθεσιμότητας και χωρητικότητας πόρων
- Ρυθμίσετε ελέγχους ασφαλείας και συμμόρφωσης για πολιτικές οργανισμών
- Σχεδιάσετε ροές εργασίας εκτίμησης κόστους και επικύρωσης προϋπολογισμού
- Δημιουργήσετε αυτοματοποιημένους ελέγχους πριν την ανάπτυξη για CI/CD pipelines

## Αποτελέσματα Μάθησης

Με την ολοκλήρωση, θα μπορείτε να:
- Δημιουργείτε και να εκτελείτε ολοκληρωμένα σενάρια επικύρωσης πριν την ανάπτυξη
- Σχεδιάζετε αυτοματοποιημένες ροές εργασίας ελέγχου για διαφορετικά σενάρια ανάπτυξης
- Εφαρμόζετε διαδικασίες και πολιτικές επικύρωσης για συγκεκριμένα περιβάλλοντα
- Ρυθμίζετε προληπτική παρακολούθηση και ειδοποιήσεις για ετοιμότητα ανάπτυξης
- Εντοπίζετε προβλήματα πριν την ανάπτυξη και εφαρμόζετε διορθωτικές ενέργειες
- Ενσωματώνετε ελέγχους πριν την ανάπτυξη σε DevOps pipelines και αυτοματοποιημένες ροές εργασίας
...
Οι έλεγχοι πριν την ανάπτυξη είναι απαραίτητες επικυρώσεις που πραγματοποιούνται πριν την ανάπτυξη για να διασφαλιστεί:

- **Διαθεσιμότητα πόρων** και όρια στις επιλεγμένες περιοχές
- **Αυθεντικοποίηση και δικαιώματα** που έχουν ρυθμιστεί σωστά
- **Εγκυρότητα προτύπων** και ορθότητα παραμέτρων
- **Συνδεσιμότητα δικτύου** και εξαρτήσεις
- **Συμμόρφωση ασφαλείας** με πολιτικές οργανισμών
...
- [ ] Το Azure CLI είναι εγκατεστημένο και έχει γίνει αυθεντικοποίηση
- [ ] Έχει επιλεγεί η σωστή συνδρομή Azure
...
- [ ] Έχει γίνει επιτυχής αυθεντικοποίηση με `azd auth login`
- [ ] Ο χρήστης έχει ρόλο Contributor στη συνδρομή/ομάδα πόρων στόχου
- [ ] Έχει ρυθμιστεί service principal για CI/CD (αν ισχύει)
...
- [ ] Τα πρότυπα Bicep στον φάκελο `infra/` είναι παρόντα
...
#### ✅ Σχεδιασμός Πόρων
- [ ] Έχει επιλεγεί και επικυρωθεί η περιοχή Azure στόχου
- [ ] Οι απαιτούμενες υπηρεσίες Azure είναι διαθέσιμες στην περιοχή στόχου
- [ ] Υπάρχουν επαρκή όρια για τους προγραμματισμένους πόρους
- [ ] Έχουν ελεγχθεί συγκρούσεις ονομάτων πόρων
- [ ] Έχουν κατανοηθεί οι εξαρτήσεις μεταξύ των πόρων

#### ✅ Δίκτυο & Ασφάλεια
- [ ] Έχει επαληθευτεί η συνδεσιμότητα δικτύου με τα endpoints του Azure
- [ ] Έχουν ρυθμιστεί οι ρυθμίσεις firewall/proxy αν χρειάζεται
- [ ] Έχει ρυθμιστεί το Key Vault για διαχείριση μυστικών
- [ ] Χρησιμοποιούνται διαχειριζόμενες ταυτότητες όπου είναι δυνατόν
- [ ] Έχει ενεργοποιηθεί η επιβολή HTTPS για εφαρμογές web

#### ✅ Διαχείριση Κόστους
- [ ] Έχουν υπολογιστεί εκτιμήσεις κόστους με το Azure Pricing Calculator
- [ ] Έχουν ρυθμιστεί ειδοποιήσεις προϋπολογισμού αν απαιτείται
- [ ] Έχουν επιλεγεί κατάλληλα SKUs για τον τύπο περιβάλλοντος
- [ ] Έχει ληφθεί υπόψη η δεσμευμένη χωρητικότητα για εργασίες παραγωγής

#### ✅ Παρακολούθηση & Παρατηρησιμότητα
- [ ] Έχει ρυθμιστεί το Application Insights στα πρότυπα
- [ ] Έχει προγραμματιστεί χώρος εργασίας Log Analytics
- [ ] Έχουν οριστεί κανόνες ειδοποίησης για κρίσιμες μετρήσεις
- [ ] Έχουν υλοποιηθεί endpoints ελέγχου υγείας στις εφαρμογές

#### ✅ Αντίγραφα Ασφαλείας & Ανάκτηση
- [ ] Έχει οριστεί στρατηγική αντιγράφων ασφαλείας για πόρους δεδομένων
- [ ] Έχουν τεκμηριωθεί οι στόχοι χρόνου ανάκτησης (RTO)
- [ ] Έχουν τεκμηριωθεί οι στόχοι σημείου ανάκτησης (RPO)
...
1. **Αυτοματοποίηση Όπου Είναι Δυνατόν**
   - Ενσωματώστε ελέγχους στα CI/CD pipelines
...
3. **Παράβλεψη ορίων** μέχρι να αποτύχει η ανάπτυξη
4. **Μη επικύρωση προτύπων** στα CI/CD pipelines
...
**Συμβουλή**: Εκτελέστε τους ελέγχους πριν την ανάπτυξη ως ξεχωριστή εργασία στο CI/CD pipeline πριν την κύρια εργασία ανάπτυξης. Αυτό σας επιτρέπει να εντοπίζετε προβλήματα νωρίς και να παρέχετε γρηγορότερη ανατροφοδότηση στους προγραμματιστές.
