...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:34:01+00:00",
...
### .azure/config.json
Διαμόρφωση συγκεκριμένη για το περιβάλλον:
```json
{
  "version": 1,
...
- Διατηρήστε τη διαμόρφωση υπό έλεγχο έκδοσης
...
4. Διαμορφώσεις επιπέδου επιχείρησης

## Επόμενα Βήματα

- [Εγκατάσταση & Ρύθμιση](installation.md) - Εγκαταστήστε και διαμορφώστε το azd
- [Το Πρώτο σας Έργο](first-project.md) - Εκπαιδευτικό μάθημα
- [Οδηγός Διαμόρφωσης](configuration.md) - Προχωρημένες επιλογές διαμόρφωσης
...
**Πλοήγηση**
- **Προηγούμενο Μάθημα**: [README](../../README.md)
