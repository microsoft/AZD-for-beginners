...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:20:44+00:00",
...
- Ρυθμίστηκε κώδικας υποδομής στον φάκελο `infra/`
...
3. **Διαγραφή στοιχείων** - Αφαιρέστε στοιχεία που δεν χρειάζεστε πλέον
