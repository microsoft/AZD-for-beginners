...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T20:54:00+00:00",
...
**Προηγούμενο:** [Ρύθμιση](configuration.md) | **Επόμενο:** [Ενσωμάτωση Azure AI Foundry](../ai-foundry/azure-ai-foundry-integration.md)

## Εισαγωγή

Καλώς ήρθατε στο πρώτο σας έργο με το Azure Developer CLI! Αυτός ο αναλυτικός εργαστηριακός οδηγός σας παρέχει μια πλήρη περιήγηση στη δημιουργία, ανάπτυξη και διαχείριση μιας εφαρμογής πλήρους στοίβας στο Azure χρησιμοποιώντας το azd. Θα εργαστείτε με μια πραγματική εφαρμογή λίστας εργασιών που περιλαμβάνει frontend React, backend API Node.js και βάση δεδομένων MongoDB.

## Στόχοι Μάθησης

Ολοκληρώνοντας αυτόν τον οδηγό, θα:
- Κατανοήσετε τη διαδικασία αρχικοποίησης έργου azd χρησιμοποιώντας πρότυπα
- Εξοικειωθείτε με τη δομή έργου και τα αρχεία ρύθμισης του Azure Developer CLI
- Εκτελέσετε πλήρη ανάπτυξη εφαρμογής στο Azure με προμήθεια υποδομής
- Εφαρμόσετε ενημερώσεις εφαρμογών και στρατηγικές επανα-ανάπτυξης
...
- Πλοηγείστε και τροποποιείτε τη δομή έργων azd αποτελεσματικά
...
Ας ξεκινήσουμε με ένα δημοφιλές πρότυπο εφαρμογής λίστας εργασιών που περιλαμβάνει frontend React και backend API Node.js.
...
### Δοκιμή της Εφαρμογής Λίστας Εργασιών
1. **Προσθήκη στοιχείου λίστας** - Κάντε κλικ στο "Add Todo" και εισάγετε μια εργασία
2. **Σήμανση ως ολοκληρωμένο** - Επιλέξτε ολοκληρωμένα στοιχεία
3. **Διαγραφή στοιχείων** - Αφαιρέστε εργασίες που δεν χρειάζεστε πλέον
...
Δημιουργήστε ένα περιβάλλον δοκιμών για να ελέγξετε αλλαγές πριν την παραγωγή:
...
- Εξερευνήσει τη δομή έργου και βασικά αρχεία
...
- [Επίσημη Γκαλερί Προτύπων](https://azure.github.io/awesome-azd/)
- [Πρότυπα Κοινότητας](https://github.com/Azure-Samples/azd-templates)
- [Επιχειρηματικά Μοτίβα](https://github.com/Azure/azure-dev/tree/main/templates)
