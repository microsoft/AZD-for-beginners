...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T21:33:56+00:00",
...
**Προηγούμενο:** [Ανάπτυξη Μοντέλου AI](ai-model-deployment.md) | **Επόμενο:** [Πρακτικές AI για Παραγωγή](production-ai-practices.md)

## Επισκόπηση Εργαστηρίου

Αυτό το πρακτικό εργαστήριο καθοδηγεί τους προγραμματιστές στη διαδικασία μετατροπής μιας υπάρχουσας εφαρμογής AI ώστε να είναι έτοιμη για ανάπτυξη χρησιμοποιώντας το Azure Developer CLI (AZD). Θα μάθετε βασικά πρότυπα για αναπτύξεις AI σε παραγωγή χρησιμοποιώντας τις υπηρεσίες Azure AI Foundry.
...
1. **API keys OpenAI**: Επαληθεύστε ότι έχουν οριστεί σωστά
...
## Ενότητα 3: Εξατομίκευση Εφαρμογών AI για τις Ανάγκες σας
...
## Ενότητα 4: Ασφάλεια και Καλύτερες Πρακτικές Παραγωγής
...
1. **Ανασκόπηση της διαμόρφωσης ασφάλειας στο πρότυπό σας:**
```bash
...
**Εργασία**: Ελέγξτε την ανάπτυξή σας για βέλτιστες πρακτικές ασφάλειας.

**Λίστα ελέγχου:**
- [ ] Δεν υπάρχουν ενσωματωμένα μυστικά στον κώδικα ή τη διαμόρφωση
...
## Ενότητα 6: Εντοπισμός Κοινών Προβλημάτων
...
2. Ανασκόπηση μετρήσεων υπηρεσίας OpenAI στο Azure portal
3. Επαληθεύστε τη συνδεσιμότητα δικτύου και την καθυστέρηση

**Λύσεις:**
- Εφαρμόστε caching για κοινά ερωτήματα
- Χρησιμοποιήστε κατάλληλο μοντέλο OpenAI για την περίπτωσή σας
- Εξετάστε αναγνώσεις αντιγράφων για σενάρια υψηλού φορτίου
...
4. Ανασκόπηση διαμόρφωσης

**Εργαλεία για χρήση:**
- `azd show` για επισκόπηση ανάπτυξης
- Azure portal για λεπτομερή αρχεία καταγραφής υπηρεσιών
...
Μεταβείτε στο Azure portal και δημιουργήστε έναν πίνακα με:
...
**Στρατηγικές για δοκιμή:**
-
- ✅ Εφαρμόστε βέλτιστες πρακτικές ασφαλείας για φόρτους εργασίας AI  
- ✅ Παρακολουθήστε και βελτιστοποιήστε την απόδοση των εφαρμογών AI  
- ✅ Εντοπίστε και διορθώστε κοινά προβλήματα ανάπτυξης  
...
4. Εξερευνήστε προχωρημένα θέματα όπως οι αναπτύξεις σε πολλές περιοχές  
...
**Προηγούμενο:** [AI Model Deployment](ai-model-deployment.md) | **Επόμενο:** [Production AI Practices](production-ai-practices.md)  
