...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T21:50:38+00:00",
...
**Προηγούμενο:** [Ενσωμάτωση του Azure AI Foundry](azure-ai-foundry-integration.md) | **Επόμενο:** [Εργαστήριο AI Workshop](ai-workshop-lab.md)
...
1. **Ανασκόπηση του [Οδηγού Ενσωμάτωσης του Azure AI Foundry](azure-ai-foundry-integration.md)** για μοτίβα ενσωμάτωσης υπηρεσιών
