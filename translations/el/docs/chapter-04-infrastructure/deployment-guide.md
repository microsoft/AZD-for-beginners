# Οδηγός Ανάπτυξης - Κυριαρχία στις Αναπτύξεις AZD

**Πλοήγηση Κεφαλαίου:**
- **📚 Course Home**: [AZD για Αρχάριους](../../README.md)
- **📖 Current Chapter**: Κεφάλαιο 4 - Υποδομή ως Κώδικας & Ανάπτυξη
- **⬅️ Previous Chapter**: [Κεφάλαιο 3: Διαμόρφωση](../chapter-03-configuration/configuration.md)
- **➡️ Next**: [Παροχή Πόρων](provisioning.md)
- **🚀 Next Chapter**: [Κεφάλαιο 5: Λύσεις Πολλαπλών Πρακτόρων Τεχνητής Νοημοσύνης](../../examples/retail-scenario.md)

## Εισαγωγή

Αυτό## Κατανόηση της Διαδικασίας Ανάπτυξηςεκτενής οδηγός καλύπτει όλα όσα πρέπει να γνωρίζετε για την ανάπτυξη εφαρμογών χρησιμοποιώντας το Azure Developer CLI, από τις βασικές αναπτύξεις με μια εντολή μέχρι σύνθετα σενάρια παραγωγής με προσαρμοσμένα hooks, πολλαπλά περιβάλλοντα και ενσωμάτωση CI/CD. Κατακτήστε ολόκληρο τον κύκλο ζωής ανάπτυξης με πρακτικά παραδείγματα και βέλτιστες πρακτικές.

## Στόχοι Μάθησης

By completing this guide, you will:
- Κατακτήστε όλες τις εντολές και ροές εργασίας ανάπτυξης του Azure Developer CLI
- Κατανοήστε ολόκληρο τον κύκλο ζωής ανάπτυξης από την παροχή πόρων έως την παρακολούθηση
- Υλοποιήστε προσαρμοσμένα hooks ανάπτυξης για αυτοματοποίηση πριν και μετά την ανάπτυξη
- Διαμορφώστε πολλαπλά περιβάλλοντα με παραμέτρους ειδικές για κάθε περιβάλλον
- Ρυθμίστε προηγμένες στρατηγικές ανάπτυξης συμπεριλαμβανομένων blue-green και canary deployments
- Ενσωματώστε τις αναπτύξεις azd σε pipelines CI/CD και ροές εργασίας DevOps

## Μαθησιακά Αποτελέσματα

Upon completion, you will be able to:
- Εκτελέστε και αντιμετωπίστε προβλήματα σε όλες τις ροές εργασίας ανάπτυξης azd ανεξάρτητα
- Σχεδιάστε και υλοποιήστε προσαρμοσμένη αυτοματοποίηση ανάπτυξης χρησιμοποιώντας hooks
- Διαμορφώστε αναπτύξεις έτοιμες για παραγωγή με κατάλληλη ασφάλεια και παρακολούθηση
- Διαχειριστείτε σύνθετα σενάρια ανάπτυξης πολλαπλών περιβαλλόντων
- Βελτιστοποιήστε την απόδοση ανάπτυξης και εφαρμόστε στρατηγικές επαναφοράς
- Ενσωματώστε τις αναπτύξεις azd στις πρακτικές DevOps του οργανισμού

## Επισκόπηση Ανάπτυξης

Azure Developer CLI provides several deployment commands:
- `azd up` - Πλήρης ροή εργασίας (παροχή + ανάπτυξη)
- `azd provision` - Δημιουργεί/ενημερώνει μόνο πόρους Azure
- `azd deploy` - Αναπτύσσει μόνο τον κώδικα της εφαρμογής
...
- ✅ Η εφαρμογή απαντά σε δοκιμαστικά αιτήματα
...
- Πακετάρει για την στοχευόμενη πλατφόρμα (containers, αρχεία ZIP, κ.λπ.)
...
- Αναπτύσσει τα πακεταρισμένα αρχεία εφαρμογών στις υπηρεσίες Azure
...
### Ρυθμίσεις Ανάπτυξης Ειδικές για κάθε Υπηρεσία
```yaml
# azure.yaml
services:
  web:
...
# Μεταφέρετε την κυκλοφορία στο μπλε (χειροκίνητη ενημέρωση DNS/ισορροπιστή φορτίου)
...
### Αναπτύξεις Ειδικές για Κάθε Υπηρεσία
```bash
...
# Αυτό παρακάμπτει τη διαμόρφωση της υποδομής και είναι πολύ πιο γρήγορο
azd deploy
...
### Γρήγορη Επαναφορά
```bash
# AZD δεν έχει ενσωματωμένη δυνατότητα επαναφοράς. Συνιστώμενες προσεγγίσεις:
...
### Επαναφορά Υποδομής
```bash
# Προεπισκόπηση αλλαγών στην υποδομή πριν την εφαρμογή τους
azd provision --preview

# Για επαναφορά της υποδομής, χρησιμοποιήστε σύστημα ελέγχου εκδόσεων:
...
# Διατηρήστε την αντιστοιχία των περιβαλλόντων
./scripts/sync-environments.sh
```

### 2. Επικύρωση Υποδομής
```bash
# Προεπισκόπηση αλλαγών στην υποδομή πριν την ανάπτυξη
azd provision --preview
...
- [Σχεδιασμός πριν την Ανάπτυξη](../chapter-06-pre-deployment/capacity-planning.md) - Σχεδιάστε τη στρατηγική ανάπτυξης σας
- [Συνηθισμένα Προβλήματα](../chapter-07-troubleshooting/common-issues.md) - Επίλυση θεμάτων ανάπτυξης
...
# Καταγράψτε την ώρα της αρχικής ανάπτυξης
...
- [ ] Οι αλλαγές στον κώδικα αντικατοπτρίζονται στην αναπτυγμένη εφαρμογή
...
- [ ] Το post-deploy smoke test επικυρώνει την υγεία
- [ ] Τα hooks εκτελούνται στη σωστή σειρά

### Άσκηση 3: Στρατηγική Ανάπτυξης Πολλαπλών Περιβαλλόντων (45 λεπτά)
**Στόχος**: Υλοποιήστε ροή εργασίας σταδιακής ανάπτυξης (dev → staging → production)
...
# Βήμα 3: Χειροκίνητη έγκριση για το περιβάλλον παραγωγής
echo "
...
**Στόχος**: Υλοποιήστε και δοκιμάστε την επαναφορά ανάπτυξης χρησιμοποιώντας Git
...
# Αποθήκευση hash του commit της v1
...
Αποποίηση ευθυνών:
Αυτό το έγγραφο έχει μεταφραστεί με χρήση της υπηρεσίας αυτόματης μετάφρασης με τεχνητή νοημοσύνη [Co-op Translator](https://github.com/Azure/co-op-translator). Παρότι καταβάλουμε προσπάθειες για ακρίβεια, λάβετε υπόψη ότι οι αυτοματοποιημένες μεταφράσεις ενδέχεται να περιέχουν σφάλματα ή ανακρίβειες. Το πρωτότυπο έγγραφο στη γλώσσα του πρέπει να θεωρείται η αυθεντική πηγή. Για κρίσιμες πληροφορίες συνιστάται επαγγελματική ανθρώπινη μετάφραση. Δεν φέρουμε ευθύνη για τυχόν παρεξηγήσεις ή λανθασμένες ερμηνείες που προκύπτουν από τη χρήση αυτής της μετάφρασης.
