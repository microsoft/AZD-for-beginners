...
![Pick](../../../../../translated_images/01-pick-template.60d2d5fff5ebc374d04f05f556f505a3800b2b5fb08e03153b1b878939b49da6.te.png)
...
![Arch](../../../../../translated_images/architecture.8cec470ec15c65c743dcc1aa383d2500be4d6a9270693b8bfeb3d8deca4a22e1.te.png)
...
1. మీ Azure పోర్టల్ ఇప్పుడు ఆ ఎన్విరాన్‌మెంట్ పేరుతో ప్రొవిజన్ చేసిన రిసోర్స్ గ్రూప్‌ను కలిగి ఉంటుంది:
      ...
      ![Infra](../../../../../translated_images/02-provisioned-infra.46c706b14f56e0bf36cb90ba441d16690ce10a00d42990bb9441126ceff08990.te.png)
...
1. మీరు హోస్ట్ చేసిన అప్లికేషన్ ఫ్రంట్-ఎండ్ UIని ఇలా చూడగలరు:
   ...
   ![App](../../../../../translated_images/03-test-application.471910da12c3038e4a3c20e98ebf080abb227e122699ef7b7a262b87af6f98c3.te.png)
...
1. మీరు క్రింద చూపిన వాటికి సమానమైన సమాధానాలను పొందాలి. _కానీ ఇది ఎలా పనిచేస్తుంది?_ 
      ...
      ![App](../../../../../translated_images/03-test-question.521c1e863cbaddb604172e95d704407b4b6304c0e04d9130e51b7994f951b026.te.png)
...
1. మీరు ఇలా చూడగలరు. `Azure AI Foundry Portalకు వెళ్ళండి` బటన్‌పై క్లిక్ చేయండి. 
   ![Foundry](../../../../../translated_images/04-view-foundry-project.fb94ca41803f28f3a7baa67099e11360380dc7f17bfb0583689cf34419b80498.te.png)

1. మీ AI అప్లికేషన్ కోసం Foundry ప్రాజెక్ట్ పేజీని చూడగలరు
   ![Project](../../../../../translated_images/05-visit-foundry-portal.d734e98135892d7e96324cebee01acfa6c339706b2d5e50ede4682beb5d431d9.te.png)

1. `Agents`పై క్లిక్ చేయండి - మీ ప్రాజెక్ట్‌లో ప్రొవిజన్ చేసిన డిఫాల్ట్ ఏజెంట్‌ను చూడగలరు
   ![Agents](../../../../../translated_images/06-visit-agents.bccb263f77b00a0917878ae22b420c3b0df0ade50c0df8e20e6e45d49a220514.te.png)
...
1. దానిని ఎంచుకోండి - మరియు మీరు ఏజెంట్ వివరాలను చూడగలరు. ఈ క్రింది వాటిని గమనించండి:
      ...
      ![Agents](../../../../../translated_images/07-view-agent-details.0e049f37f61eae6292faf47da2651994dab9ac9cf06c20e7c996c54dbca02245.te.png)
...
1. ఎడమ మెనులో `Data+indexes` ఆప్షన్ కోసం చూడండి మరియు వివరాల కోసం క్లిక్ చేయండి. 
      ...
      ![Data](../../../../../translated_images/08-visit-data-indexes.5a4cc1686fa0d19a49625f0d4956f3b22681ae275a62c35516dabf1eb9d49a89.te.png)
...
![Data](../../../../../translated_images/09-ask-in-aca.4102297fc465a4d5617af2a71501c3b7607d198df9e598f84abacc32423c17b9.te.png)
...
1. అదే ప్రశ్న అడగండి: `అమాండా పెరెజ్ ఏ ఉత్పత్తులను కలిగి ఉంది?`
    ...
    ![Data](../../../../../translated_images/09-ask-in-playground.a1b93794f78fa676c13e7b81dd60bc8589c742cf1069dc4589acf36ac050298d.te.png)
...
1. స్పందన సేఫ్టీ స్థాయి కోసం అంచనా రేటింగ్ మీకు సరైనదిగా అనిపిస్తుందా?
      ...
      ![Data](../../../../../translated_images/10-view-run-info-meter.6cdb89a0eea5531fced8249c58037ab5fb939478145db95b840a6aab8b21d85e.te.png)
...
1. `View Run Info` బటన్‌పై క్లిక్ చేయండి - మీరు ఈ వీక్షణను చూడగలరు. ఇది [Agent tracing](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/develop/trace-agents-sdk#view-trace-results-in-the-azure-ai-foundry-agents-playground) యొక్క ఉదాహరణ. _మీరు టాప్-లెవల్ మెనులో Thread Logs క్లిక్ చేయడం ద్వారా కూడా ఈ వీక్షణను పొందవచ్చు_.
   ...
   - లేటెన్సీని అర్థం చేసుకోండి మరియు ఎగ్జిక్యూషన్‌లో సమయం ఎక్కడ ఖర్చు అవుతుంది
      ...
      ![Agent](../../../../../translated_images/10-view-run-info.b20ebd75fef6a1cc01382282300bc7d4afe4aa289de08bc97d1e097d7dc4b77d.te.png)
...
1. రన్‌కు సంబంధించిన అదనపు గుణాలను చూడటానికి `Metadata` ట్యాబ్‌పై క్లిక్ చేయండి, ఇవి తర్వాత సమస్యలను డీబగ్ చేయడానికి ఉపయోగకరమైన సందర్భాన్ని అందించవచ్చు.   
      ...
      ![Agent](../../../../../translated_images/11-view-run-info-metadata.7966986122c7c2dfef2df06e56db549f922c09658b51496fac040106de75e2b9.te.png)
...
1. ఏజెంట్ స్పందనపై ఆటో-అసెస్‌మెంట్‌లను చూడటానికి `Evaluations` ట్యాబ్‌పై క్లిక్ చేయండి. వీటిలో సేఫ్టీ ఎవాల్యుయేషన్లు (ఉదా., Self-harm) మరియు ఏజెంట్-స్పెసిఫిక్ ఎవాల్యుయేషన్లు (ఉదా., Intent resolution, Task adherence) ఉన్నాయి.
      ...
      ![Agent](../../../../../translated_images/12-view-run-info-evaluations.ef25e4577d70efeb777dfadf51fed1694661fa370dd5a4e5fea4aec8de234568.te.png)
...
1. చివరగా, సైడ్‌బార్ మెనులో `Monitoring` ట్యాబ్‌పై క్లిక్ చేయండి.
      ...
      ![Agent](../../../../../translated_images/13-monitoring-resources.5148015f7311807f774aaa6a45b7156969ce1b1861d1c34d191c98b61d6d8b84.te.png)
