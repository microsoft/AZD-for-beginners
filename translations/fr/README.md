...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T16:05:09+00:00",
...
3. **Rejoignez la communauté** : [Communautés Azure Discord](https://discord.com/invite/ByRwuEEgH4) pour un support d'experts
...
Maîtrisez Azure Developer CLI (azd) grâce à des chapitres structurés conçus pour un apprentissage progressif. **Accent particulier sur le déploiement d'applications d'IA avec l'intégration de Microsoft Foundry.**

### Pourquoi ce cours est essentiel pour les développeurs modernes

D'après les retours de la communauté Discord Microsoft Foundry, **45 % des développeurs souhaitent utiliser AZD pour des charges de travail IA**, mais rencontrent des difficultés avec :
...
- Comprendre les bases d'Azure Developer CLI
...
- **📖 Théorie** : [Bases d'AZD](docs/getting-started/azd-basics.md) - Concepts et terminologie clés
- **⚙️ Configuration** : [Installation & Configuration](docs/getting-started/installation.md) - Guides spécifiques à chaque plateforme
...
**📈 Niveau de compétence après :** Capable de déployer des applications simples de manière autonome
...
- **🛠️ Atelier** : [Atelier IA](docs/microsoft-foundry/ai-workshop-lab.md) - Préparer vos solutions IA pour AZD
- **🎥 Guide interactif** : [Matériel d'atelier](workshop/README.md) - Apprentissage basé sur le navigateur avec MkDocs * DevContainer Environment
...
**💰 Conscience des coûts :** Comprendre les coûts de 80-150 $/mois en dev, 300-3500 $/mois en production

#### 💰 Considérations sur les coûts pour les déploiements IA

**Environnement de développement (estimé à 80-150 $/mois) :**
- Azure OpenAI (paiement à l'utilisation) : 0-50 $/mois (selon l'utilisation des tokens)
...
- Azure OpenAI (PTU pour des performances constantes) : 3,000+ $/mois OU paiement à l'utilisation avec volume élevé
- AI Search (niveau standard) : 250 $/mois
- Applications conteneurisées (dédiées) : 50-100 $/mois
...
- Commencez avec une facturation basée sur la consommation, passez au PTU uniquement pour la production
...
- **📝 Exemples** : [Exemple d'application avec base de données](examples/database-app/README.md) - Exemples AZD avec base de données

#### Exercices pratiques
- Configurer plusieurs environnements (dev, staging, prod)
- Mettre en place une authentification avec identité managée
...
#### Ressources d'apprentissage
- **🤖 Projet en vedette** : [Solution multi-agents pour le commerce de détail](examples/retail-scenario.md) - Implémentation complète
...
#### Ressources d'apprentissage
- **📊 Planification** : [Planification de la capacité](docs/pre-deployment/capacity-planning.md) - Validation des ressources
- **💰 Sélection** : [Sélection des SKU](docs/pre-deployment/sku-selection.md) - Choix rentables
...
- Mettre en œuvre des vérifications préalables automatisées
...
- **🤖 Problèmes IA** : [Dépannage spécifique à l'IA](docs/troubleshooting/ai-troubleshooting.md) - Problèmes liés aux services IA
...
**💡 Résultat du chapitre** : Déployer des applications prêtes pour l'entreprise avec des capacités complètes de production

---

## 🎓 Aperçu de l'atelier : Expérience d'apprentissage pratique

> **⚠️ STATUT DE L'ATELIER : En cours de développement**  
> Les supports de l'atelier sont actuellement en cours de développement et de perfectionnement. Les modules de base sont fonctionnels, mais certaines sections avancées sont incomplètes. Nous travaillons activement à compléter tout le contenu. [Suivre les progrès →](workshop/README.md)
...
- **Interface basée sur le navigateur** : Atelier alimenté par MkDocs avec recherche, copie et fonctionnalités de thème
- **Intégration GitHub Codespaces** : Configuration en un clic de l'environnement de développement
...
- **📋 Instructions pas à pas** : [Exercices guidés](../../workshop/docs/instructions) - Explications détaillées
- **🛠️ Laboratoire IA de l'atelier** : [Laboratoire IA](docs/microsoft-foundry/ai-workshop-lab.md) - Exercices axés sur l'IA
- **💡 Démarrage rapide** : [Guide de configuration de l'atelier](workshop/README.md#quick-start) - Configuration de l'environnement

**Idéal pour** : Formations en entreprise, cours universitaires, apprentissage autonome et bootcamps pour développeurs.

---

## 📖 Qu'est-ce que l'Azure Developer CLI ?
...
**Pourquoi choisir AZD pour les solutions IA ?** AZD répond aux principaux défis rencontrés par les développeurs IA :
...
- **Modèles IA en production** - Bonnes pratiques pour des déploiements d'applications IA évolutifs et rentables
...
> **Note :** Ces modèles illustrent divers modèles IA. Certains proviennent d'Azure Samples externes, d'autres sont des implémentations locales.

| Modèle | Chapitre | Complexité | Services | Type |
|--------|----------|------------|----------|------|
| [**Commencer avec le chat IA**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 2 | ⭐⭐ | AzureOpenAI + API d'inférence de modèle Azure AI + Azure AI Search + Azure Container Apps + Application Insights | Externe |
| [**Commencer avec les agents IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Chapitre 2 | ⭐⭐ | Service d'agent Azure AI + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights | Externe |
| [**Démo Azure Search + OpenAI**](https://github.com/Azure-Samples/azure-search-openai-demo) | Chapitre 2 | ⭐⭐ | AzureOpenAI + Azure AI Search + App Service + Stockage | Externe |
| [**Démarrage rapide de l'application de chat OpenAI**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Chapitre 2 | ⭐ | AzureOpenAI + Container Apps + Application Insights | Externe |
...
| [**Solution multi-agents pour le commerce de détail**](examples/retail-scenario.md) | Chapitre 5 | ⭐⭐⭐⭐ | AzureOpenAI + AI Search + Stockage + Container Apps + Cosmos DB | **Local** |
...
- [**Solution multi-agents pour le commerce de détail**](examples/retail-scenario.md) - Implémentation complète prête pour la production avec modèles ARM
...
- [**Exemples d'applications conteneurisées**](examples/container-app/README.md) - Guide complet pour les déploiements conteneurisés
  - [API Flask simple](../../examples/container-app/simple-flask-api) - API REST de base avec mise à l'échelle à zéro
  - [Architecture de microservices](../../examples/container-app/microservices) - Déploiement multi-services prêt pour la production
  - Modèles de déploiement rapide, production et avancé
...
- [Application conteneurisée - Python Flask](https://github.com/Azure-Samples/container-apps-store-api-microservice) - Déploiement d'API REST
...
- [Fonctions + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - Flux de données sans serveur
...
- [Jobs pour applications conteneurisées](https://github.com/Azure-Samples/container-apps-jobs) - Traitement en arrière-plan  
...
- [**Galerie officielle de modèles AZD**](https://azure.github.io/awesome-azd/) - Collection organisée de modèles officiels et communautaires
...
- [**Guide Atelier Interactif**](workshop/README.md) - Atelier basé sur navigateur avec MkDocs et environnement DevContainer
...
- [**Atelier AZD pour Débutants**](workshop/README.md) - Matériel d'atelier complet avec intégration GitHub Codespaces
...
```bash
# Essayez une région Azure différente
...
### ❌ "La ressource existe déjà" ou conflits de nommage
...
- [ ] **Chapitre 1** : Fondations & Démarrage Rapide ✅
- [ ] **Chapitre 2** : Développement IA en priorité ✅  
...
- **Problèmes Techniques** : [Signalez des bugs et demandez des fonctionnalités](https://github.com/microsoft/azd-for-beginners/issues)
...
### Aperçus Communautaires de Microsoft Foundry Discord
...
- **Signalement de Bugs** : Améliorer la précision et la clarté
...
### Ressources d'Apprentissage Associées de Microsoft
...
[![IoT pour les débutants](https://img.shields.io/badge/IoT%20pour%20les%20débutants-14B8A6?style=for-the-badge&labelColor=E5E7EB&color=14B8A6)](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)  
[![Développement XR pour les débutants](https://img.shields.io/badge/D%C3%A9veloppement%20XR%20pour%20les%20d%C3%A9butants-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)

---

### Série Copilot  
[![Copilot pour la programmation en duo avec l'IA](https://img.shields.io/badge/Copilot%20pour%20la%20programmation%20en%20duo%20avec%20l'IA-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
...
**Prochaines étapes** : [Commencer le Chapitre 1 - Bases d'AZD](docs/getting-started/azd-basics.md) →
