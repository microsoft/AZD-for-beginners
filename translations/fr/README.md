...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:01:35+00:00",
...
1. **Forkez le dépôt** : Cliquez [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
...
Maîtrisez Azure Developer CLI (azd) grâce à des chapitres structurés conçus pour un apprentissage progressif. **Accent particulier sur le déploiement d'applications d'IA avec l'intégration d'Azure AI Foundry.**
...
- Les meilleures pratiques de déploiement en production pour l'IA  
...
- **📖 Théorie** : [Bases d'AZD](docs/getting-started/azd-basics.md) - Concepts et terminologie essentiels
...
- **📝 Exemples** : [Exemple d'application base de données](../../examples/database-app) - Modèles de configuration
...
**Prérequis** : Tout chapitre de déploiement complété  
**Durée** : 1-1.5 heures  
**Complexité** : ⭐⭐
...
- **🤖 Problèmes IA** : [Résolution de problèmes IA](docs/troubleshooting/ai-troubleshooting.md) - Problèmes liés aux services IA
...
#### Ressources d'apprentissage
- **🏭 Production** : [Meilleures pratiques IA en production](docs/ai-foundry/production-ai-practices.md) - Modèles pour les entreprises
...
- **Résoudre les problèmes de déploiement** : Identifier et corriger les problèmes courants de manière autonome  
...
- **📋 Instructions étape par étape** : [Exercices guidés](../../workshop/docs/instructions) - Explications détaillées  
...
- **Conçu pour les développeurs** - Optimisé pour la productivité et l'expérience des développeurs  

### **AZD + Azure AI Foundry : Idéal pour les déploiements IA**  
...
| [**Commencer avec les agents IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Chapitre 2 | ⭐⭐ | Service d'agent Azure AI + AzureOpenAI + Recherche Azure AI + Applications conteneurisées Azure + Application Insights |  
| [**Automatisation des flux de travail multi-agents**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 5 | ⭐⭐⭐ | AzureOpenAI + Service d'agent Azure AI + Kernel sémantique + Azure CosmosDB + Applications conteneurisées Azure |  
...
| [**Moderniser votre code avec des agents**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 5 | ⭐⭐⭐ | AzureOpenAI + Service d'agent Azure + Kernel sémantique + Azure CosmosDB + Applications conteneurisées Azure |  
| [**Construire votre agent conversationnel**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 4 | ⭐⭐⭐ | Langage IA + AzureOpenAI + Recherche IA + Stockage Azure + Registre de conteneurs Azure |  
| [**Découvrir des insights à partir de données conversationnelles**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 8 | ⭐⭐⭐ | AzureOpenAI + Recherche IA + Kernel sémantique + Service d'agent Azure + Compréhension de contenu IA |  
| [**Traitement de contenu multimodal**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 8 | ⭐⭐⭐⭐ | AzureOpenAI + Compréhension de contenu Azure + Azure CosmosDB + Applications conteneurisées Azure |  
...
| [**agent-openai-python-prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Chapitre 5 | ⭐⭐⭐ | Cadre d'agent et appel de fonction |  
...
- [Site statique](../../examples/static-site) - Déploiement de contenu statique  
- [API de base](../../examples/basic-api) - Déploiement d'API REST  

#### Intégration de base de données (Chapitres 3-4)  
- [Application de base de données](../../examples/database-app) - Modèles de connectivité de base de données  
...
- [Solutions d'entreprise](../../examples/enterprise) - Modèles prêts pour la production  

### Collections de modèles externes  
- [**Modèles AZD Azure-Samples**](https://github.com/Azure-Samples/azd-templates) - Exemples officiels de Microsoft  
- [**Galerie Awesome AZD**](https://azure.github.io/awesome-azd/) - Modèles contribué par la communauté  
...
### Références rapides  
- [**Aide-mémoire des commandes**](resources/cheat-sheet.md) - Commandes essentielles azd organisées par chapitre  
...
- [ ] **Chapitre 3** : Configuration et authentification ✅  
...
En complétant tous les chapitres, vous aurez :  
...
- **Aide spécifique à l'IA** : Rejoignez le [canal #Azure](https://discord.gg/microsoft-azure) pour des discussions sur AZD + AI Foundry  
...
### Insights communautaires de Discord Azure AI Foundry  
...
- **Rapports de bugs** : Améliorer l'exactitude et la clarté  
- **Normes communautaires** : Suivre nos directives inclusives pour la communauté  
...
- [Protocole de contexte de modèle (MCP) pour débutants](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)
...
**Débutants** : Commencez par [Chapitre 1 : Fondations et démarrage rapide](../..)  
**Développeurs IA** : Passez directement au [Chapitre 2 : Développement axé sur l'IA](../..)  
**Développeurs expérimentés** : Commencez par [Chapitre 3 : Configuration et authentification](../..)
