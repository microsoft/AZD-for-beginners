...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T13:16:55+00:00",
...
- **Implémenter l'infrastructure comme code** : Gérer les ressources Azure avec des modèles Bicep
...
### 🏗️ Chapitre 4 : Infrastructure comme Code & Déploiement
...
- Infrastructure comme code avec Bicep
...
- **Modèles de production IA** - Meilleures pratiques pour des déploiements d'applications IA évolutifs et rentables
...
- **Intégration avec Azure AI Foundry** - Connexion transparente au catalogue de modèles et aux points de terminaison d'AI Foundry
...
|----------|---------|------------|----------|
| [**Commencer avec le chat IA**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 2 | ⭐⭐ | AzureOpenAI + API d'inférence de modèle Azure AI + Recherche Azure AI + Azure Container Apps + Application Insights |
| [**Commencer avec les agents IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Chapitre 2 | ⭐⭐ | Service d'agent Azure AI + AzureOpenAI + Recherche Azure AI + Azure Container Apps + Application Insights|
| [**Automatisation des flux de travail multi-agents**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 5 | ⭐⭐⭐ | AzureOpenAI + Service d'agent Azure AI + Kernel sémantique + Azure CosmosDB + Azure Container Apps|
...
| [**Moderniser votre code avec des agents**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 5 | ⭐⭐⭐ | AzureOpenAI + Service d'agent Azure + Kernel sémantique + Azure CosmosDB + Azure Container Apps|
...
| [**Traitement de contenu multimodal**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chapitre 8 | ⭐⭐⭐⭐ | AzureOpenAI + Compréhension de contenu Azure + Azure CosmosDB + Azure Container Apps|
...
| [**agent-openai-python-prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Chapitre 5 | ⭐⭐⭐ | Cadre d'agent et appel de fonctions |
...
#### Intégration de base de données (Chapitre 3-4)  
...
### Ateliers pratiques
- [**Laboratoire d'atelier IA**](docs/ai-foundry/ai-workshop-lab.md) - Rendre vos solutions IA déployables avec AZD
- [**Atelier AZD pour débutants**](workshop/README.md) - Matériel d'atelier pratique complet
...
- **Expérience de production** : Déployé de véritables applications IA sur Azure
...
**Débutants** : Commencez avec [Chapitre 1 : Fondations et démarrage rapide](../..)  
**Développeurs IA** : Passez directement à [Chapitre 2 : Développement axé sur l'IA](../..)
**Développeurs expérimentés** : Commencez par [Chapitre 3 : Configuration et Authentification](../..)

**Prochaines étapes** : [Commencez le Chapitre 1 - Notions de base sur AZD](docs/getting-started/azd-basics.md) →
