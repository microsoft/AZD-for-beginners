...
- Installerez avec succès Azure Developer CLI sur votre système d'exploitation
- Configurerez l'authentification avec Azure en utilisant plusieurs méthodes
- Préparerez votre environnement de développement avec les prérequis nécessaires
- Comprendrez les différentes options d'installation et quand utiliser chacune
- Résoudrez les problèmes courants d'installation et de configuration

## Résultats d'apprentissage

Après avoir terminé cette leçon, vous serez capable de :
- Installer azd en utilisant la méthode appropriée pour votre plate-forme
...
2. Décompressez dans `C:\Program Files\azd\`
...
**Note** : Le numéro de version réel peut varier. Consultez les [versions d'Azure Developer CLI](https://github.com/Azure/azure-dev/releases) pour la dernière version.

**✅ Liste de vérification de l'installation réussie :**
...
**Si tous les contrôles sont concluants, vous êtes prêt à passer à [Votre premier projet](first-project.md) !**

## Configuration de l'authentification

### Authentification via Azure CLI (recommandé)
```bash
# Installer Azure CLI si ce n'est pas déjà installé
...
- Commandes dans le terminal intégré
- Navigation des modèles
- Surveillance des déploiements

### GitHub Codespaces
Créez un `.devcontainer/devcontainer.json` :
```json
{
...
**Azure Developer CLI (azd)** : Outil de haut niveau pour des déploiements d'applications complets
...
azd lui-même est **entièrement gratuit** et open-source. Vous ne payez que :
...
1. **Complétez l'authentification** : Assurez-vous de pouvoir accéder à votre abonnement Azure
...
4. **Configurez votre IDE** : Mettez en place votre environnement de développement
...
**✅ Installation terminée !** Continuez vers [Votre premier projet](first-project.md) pour commencer à construire avec azd.

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
Avis de non-responsabilité :
Ce document a été traduit à l'aide du service de traduction par IA Co-op Translator (https://github.com/Azure/co-op-translator). Bien que nous nous efforcions d'en assurer l'exactitude, veuillez noter que les traductions automatisées peuvent contenir des erreurs ou des inexactitudes. Le document original, dans sa langue d'origine, doit être considéré comme la source faisant foi. Pour les informations critiques, il est recommandé de faire appel à une traduction professionnelle réalisée par un traducteur humain. Nous déclinons toute responsabilité en cas de malentendus ou d'interprétations erronées résultant de l'utilisation de cette traduction.
