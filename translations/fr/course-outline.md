...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T10:58:47+00:00",
  "source_file": "course-outline.md",
  "language_code": "fr"
}
-->
# AZD pour les Débutants : Plan de Cours & Cadre d'Apprentissage

## Aperçu du Cours

Maîtrisez Azure Developer CLI (azd) grâce à des chapitres structurés pour un apprentissage progressif. **Accent particulier sur le déploiement d'applications d'IA avec l'intégration de Microsoft Foundry.**
...
- La résolution des problèmes spécifiques au déploiement d'IA
...
- **Déployer des Applications d'IA** : Utiliser AZD avec les services Microsoft Foundry
...
- **Environnement DevContainer Interactif** : Aucune configuration locale requise - commencez à coder immédiatement
...
- **Développement de Portefeuille** : Construisez des projets déployables pour enrichir votre portfolio professionnel
...
- **Vue d'Ensemble Stratégique** : Proposition de valeur d'AZD et impact commercial (1 heure)
...
- **Planification de l'Implémentation** : Stratégie d'adoption organisationnelle (1-2 heures)

#### 🛠️ Méthodologie d'Apprentissage en Atelier
**Approche Découverte → Déploiement → Personnalisation pour un développement pratique des compétences**
...
- **Implémentation Guidée** : Déploiement pas à pas d'applications IA avec AZD
- **Configuration des Services** : Configurer les services Azure AI, points de terminaison et authentification
- **Mise en Œuvre de la Sécurité** : Appliquer des modèles de sécurité d'entreprise et des contrôles d'accès
...
- **Planification des Étapes Suivantes** : Définir un chemin d'apprentissage pour le développement continu des compétences
...
**Boîte à outils complète pour les facilitateurs et les apprenants**
...
- **Documentation de Référence** : [Atelier IA](docs/ai-foundry/ai-workshop-lab.md) - Approfondissements axés sur l'IA
...
- **Montée en Compétence des Équipes** : Ateliers trimestriels pour les équipes de développement existantes (1-2 jours)
- **Revue d'Architecture** : Sessions mensuelles pour les ingénieurs et architectes seniors (4 heures)
- **Briefings pour Dirigeants** : Ateliers pour les décideurs techniques (demi-journée)
...
- [Atelier IA](docs/microsoft-foundry/ai-workshop-lab.md) - **NOUVEAU** : Atelier pratique complet de 2-3 heures
...
- Modèles de sécurité et identité managée
...
### Chapitre 7 : Dépannage & Débogage (1-1.5 heures) 🔧
...
- [Guide de Débogage](docs/troubleshooting/debugging.md) - Stratégies pas à pas
...
#### Ressources d'apprentissage
- [Bonnes pratiques IA en production](docs/microsoft-foundry/production-ai-practices.md) - Modèles d'entreprise
- Microservices et exemples pour les entreprises
...
- **🏢 Entreprise** : Terminez tous les chapitres, concentrez-vous sur le Chapitre 8 (Modèles de production)

### Indicateurs de complexité

- **⭐ Basique** : Concepts simples, tutoriels guidés, 30-60 minutes
- **⭐⭐ Intermédiaire** : Concepts multiples, pratique concrète, 1-2 heures  
...
#### 🎯 Parcours accéléré pour développeurs IA (4-6 heures)
1. **Chapitre 1** : Fondations & démarrage rapide (45 min)
2. **Chapitre 2** : Développement IA en priorité (2 heures)  
...
6. **Chapitre 8** : Modèles de production et d'entreprise (2 heures)

#### 🎓 Parcours complet d'apprentissage (8-12 heures)
Achèvement séquentiel des 8 chapitres avec pratique concrète et validation
...
- **Validation communautaire** : Partager ses expériences sur les canaux Discord Azure
...
- ✅ Effectuer une planification de capacité et une optimisation des coûts
...
- **Badge de complétion du cours** : Terminer les 8 chapitres avec validation pratique
...
### Niveau fondamental (Chapitres 1-2)
À l'issue des chapitres fondamentaux, les apprenants démontreront :

**Capacités techniques :**
- Déployer des applications web simples sur Azure avec les commandes AZD
- Configurer et déployer des applications de chat IA avec des capacités RAG
- Comprendre les concepts clés d'AZD : modèles, environnements, workflows de provisionnement
- Intégrer les services Microsoft Foundry avec les déploiements AZD
...
- Résoudre les problèmes de déploiement basiques en utilisant les journaux et la documentation
...
- ✅ Terminer les exercices interactifs de l'atelier (phase de découverte)
- ✅ Participer aux discussions communautaires sur Discord Azure

### Niveau intermédiaire (Chapitres 3-4)
À l'issue des chapitres intermédiaires, les apprenants démontreront :

**Capacités techniques :**
- Gérer des déploiements multi-environnements (dev, staging, production)
- Créer des modèles Bicep personnalisés pour l'infrastructure en tant que code
- Implémenter des modèles d'authentification sécurisés avec identité gérée
- Déployer des applications multi-services complexes avec des configurations personnalisées
- Optimiser les stratégies de provisionnement des ressources pour le coût et la performance
...
- Évaluer et sélectionner les services Azure appropriés selon les besoins

**Validation de l'apprentissage :**
- ✅ Configurer des environnements distincts avec des paramètres spécifiques
- ✅ Créer et déployer un modèle Bicep personnalisé pour une application multi-services
- ✅ Implémenter une authentification par identité gérée pour un accès sécurisé
- ✅ Terminer les exercices de gestion de configuration avec des scénarios réels

### Niveau avancé (Chapitres 5-6)
À l'issue des chapitres avancés, les apprenants démontreront :
...
- Effectuer une planification de capacité et une validation des ressources approfondies
- Exécuter une validation automatisée avant déploiement et optimisation
...
- Encadrer des développeurs juniors sur les meilleures pratiques AZD et IA
- Évaluer et recommander des modèles d'architecture IA selon les besoins métier

**Validation de l'apprentissage :**
- ✅ Déployer une solution multi-agents complète pour la vente au détail avec des modèles ARM
- ✅ Démontrer la coordination des agents et l'orchestration des workflows
- ✅ Terminer les exercices de planification de capacité avec des contraintes réelles
- ✅ Valider la préparation au déploiement via des vérifications automatisées

### Niveau expert (Chapitres 7-8)
À l'issue des chapitres experts, les apprenants démontreront :

**Capacités techniques :**
- Diagnostiquer et résoudre de manière autonome des problèmes complexes de déploiement
- Implémenter des modèles de sécurité et de gouvernance de niveau entreprise
- Concevoir des stratégies complètes de surveillance et d'alerte
- Optimiser les déploiements en production pour la scalabilité, le coût et la performance
- Établir des pipelines CI/CD avec tests et validation appropriés

**Compétences professionnelles :**
- Diriger des initiatives de transformation cloud pour les entreprises
- Concevoir et implémenter des standards de déploiement organisationnels
...
- ✅ Terminer l'implémentation d'un cadre de gouvernance d'entreprise

## 🎯 Certification de complétion du cours

### Cadre de suivi de progression
Suivez votre progression d'apprentissage grâce à des points de contrôle structurés :
...
3. **Engagement communautaire** : Partager ses expériences et obtenir des retours sur Discord Azure
...
Après avoir terminé tous les chapitres avec vérification, les diplômés auront :
...
- **Maîtrise du dépannage** : Résolution autonome des problèmes de déploiement et de configuration

**Développement professionnel :**
- **Reconnaissance dans l'industrie** : Compétences vérifiables dans des domaines AZD et IA très demandés
- **Avancement de carrière** : Qualifications pour des rôles d'architecte cloud et spécialiste en déploiement IA
...
Les diplômés sont préparés à une spécialisation avancée dans :
- **Expert Microsoft Foundry** : Spécialisation approfondie dans le déploiement et l'orchestration de modèles IA
- **Leadership en architecture cloud** : Conception de déploiements à l'échelle de l'entreprise et gouvernance
- **Leadership communautaire pour les développeurs** : Contribution aux exemples Azure et aux ressources communautaires
- **Formation en entreprise** : Enseignement des compétences AZD et déploiement IA au sein des organisations
