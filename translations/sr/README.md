...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:15:14+00:00",
...
Овладајте Azure Developer CLI (azd) кроз структурисана поглавља која су дизајнирана за прогресивно учење. **Посебан фокус на примену AI апликација уз интеграцију Azure AI Foundry.**
...
- **📋 Брза референца**: [Листa команди](resources/cheat-sheet.md)
...
- Поставите аутентикацију управљаним идентитетом
...
#### Шта ћете научити
- Стратегије примене у продукцији
- Шаблони за безбедност у предузећима
- Праћење и оптимизација трошкова

#### Ресурси за учење
- **🏭 Продукција**: [Најбоље праксе за AI у продукцији](docs/ai-foundry/production-ai-practices.md) - Шаблони за предузећа
- **📝 Примери**: [Пример микросервиса](../../examples/microservices) - Комплексне архитектуре
- **📊 Надгледање**: Интеграција са Application Insights

#### Практичне вежбе
- Примена безбедносних шаблона за предузећа
- Постављање свеобухватног надгледања
- Деплој у продукцију уз одговарајуће управљање

**💡 Резултат поглавља**: Деплој апликација спремних за предузећа са пуним продукционим могућностима
...
Материјали радионице пружају структуриран, интерактиван процес учења који допуњује наставни план и програм заснован на поглављима. Радионица је осмишљена за самостално учење и сесије које води инструктор.
...
- **Откривање → Деплој → Прилагођавање**: Прогресивна методологија
- **Интерактивно DevContainer окружење**: Унапред конфигурисани алати и зависности

#### 📚 Структура радионице
Радионица прати методологију **Откривање → Деплој → Прилагођавање**:

1. **Фаза откривања** (45 минута)
   - Истражите шаблоне и услуге Azure AI Foundry
   - Разумите архитектонске шаблоне са више агената
   - Прегледајте захтеве и предуслове за деплој

2. **Фаза деплоја** (2 сата)
   - Практичан деплој AI апликација уз AZD
...
3. **Фаза прилагођавања** (45 минута)
   ...
   - Оптимизујте за продукциони деплој
...
- **Деплојовати продукционе AI апликације**: Користити AZD са Azure AI Foundry услугама
...
- **Оптимизовати за скалабилност**: Дизајнирати економичне и ефикасне деплоје
- **Решавати проблеме са деплојем**: Независно решавати уобичајене проблеме
...
- **🛠️ Лабораторија AI радионице**: [AI Workshop Lab](docs/ai-foundry/ai-workshop-lab.md) - Вежбе фокусиране на AI
- **💡 Брзи почетак**: [Водич за постављање радионице](workshop/README.md#quick-start) - Конфигурација окружења

**Идеално за**: Корпоративну обуку, универзитетске курсеве, самостално учење и програме за развој програмера.

---

## 📖 Шта је Azure Developer CLI?

Azure Developer CLI (azd) је командна линија усмерена на програмере која убрзава процес изградње и деплоја апликација на Azure. Пружа:

- **Деплоје засноване на шаблонима** - Користите унапред припремљене шаблоне за уобичајене шаблоне апликација
- **Инфраструктура као код** - Управљајте Azure ресурсима користећи Bicep или Terraform  
- **Интегрисани токови рада** - Беспрекорно обезбеђујте, деплојте и надгледајте апликације
- **Прилагођено програмерима** - Оптимизовано за продуктивност и искуство програмера

### **AZD + Azure AI Foundry: Идеално за AI деплоје**
...
- **Безбедни AI деплоји** - Уграђени шаблони за безбедност AI услуга, API кључева и крајњих тачака модела  
- **Шаблони за продукционе AI апликације** - Најбоље праксе за скалабилне и економичне деплоје AI апликација
- **Крајњи токови рада за AI** - Од развоја модела до продукционог деплоја уз одговарајуће надгледање
...
|--------|----------------|-------------|-------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Поглавље 2 | ⭐ | Основни шаблони за AI деплој |
...
- [Једноставна веб апликација](../../examples/simple-web-app) - Основни шаблони за деплој
- [Статички сајт](../../examples/static-site) - Деплој статичког садржаја
- [Основни API](../../examples/basic-api) - Деплој REST API-ја

#### Интеграција са базама података (Поглавља 3-4)  
- [Апликација са базом података](../../examples/database-app) - Шаблони за повезивање са базом података
- [Обрада података](../../examples/data-processing) - Деплој ETL радних токова

#### Напредни шаблони (Поглавља 4-8)
- [Апликације у контејнерима](../../examples/container-app) - Деплој у контејнерима
...
### Практичне радионице
- [**Лабораторија AI радионице**](docs/ai-foundry/ai-workshop-lab.md) - Учините ваша AI решења спремним за AZD деплој (2-3 сата)
- [**Интерактивни водич радионице**](workshop/README.md) - Радионица у претраживачу са MkDocs и DevContainer окружењем
- [**Структурирани пут учења**](../../workshop/docs/instructions) - 7 корака вођених вежби (Откривање → Деплој → Прилагођавање)
...
1. **Практична вежба**: Завршите практичан деплој за поглавље
...
- **Искуство у продукцији**: Деплојовали сте стварне AI апликације на Azure
- **Професионалне вештине**: Способности за деплој спреман за предузећа  
- **Признање у заједници**: Активан члан Azure заједнице програмера
- **Напредак у каријери**: Тражене вештине за AZD и AI деплој
...
### Увид из Azure AI Foundry Discord заједнице
...
**AI програмери**: Прескочите на [Поглавље 2: AI-прво развој](../..)  
**Искусни програмери**: Почните са [Поглављем 3: Конфигурација и аутентикација](../..)

**Следећи кораци**: [Почните Поглавље 1 - Основе AZD-а](docs/getting-started/azd-basics.md) →
