...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T14:05:49+00:00",
...
- **📋 Брзи преглед**: [Командни пречасник](resources/cheat-sheet.md)
...
# Постављате питања и добијате одговоре које покреће вештачка интелигенција са изворима
...
**📈 Ниво вештине након:** Може имплементирати и конфигурисати продукцијски спремне AI апликације  
...
- Почните са наплатом по конзумацији, PTU користите само за продукцију
...
- Продукцијски спремне AI имплементације
...
- **💰 Избор**: [Избор SKU](docs/pre-deployment/sku-selection.md) - Исплативи избори
...
- Оптимизовати избор SKU за трошкове
...
- **GitHub Codespaces интеграција**: Једнокликовно подешавање развојног окружења
...
2. **Фаза постављања** (2 сата)
   - Практично постављање AI апликација са AZD
   - Конфигурисати Azure AI сервисе и крајње тачке
   - Имплементирати безбедносне и аутентификационе обрасце
...
**Зашто AZD за AI решења?** AZD решава главне изазове са којима се AI развојни инжењери суочавају:
...
- [**Примери апликација у контејнерима**](examples/container-app/README.md) - Комплетан водич за постављање у контејнере
  ...
  - [Архитектура микросервиса](../../examples/container-app/microservices) - Постављање више сервиса спремних за производњу
...
### ❌ "InsufficientQuota" или "Квота је прешла лимит"
...
<details>
<summary><strong>❌ "InsufficientQuota" или "Квота је прешла лимит"</strong></summary>
...
# Ако сте заглавили више од 30 минута, проверите Azure портал:
azd monitor
...
1. **Практична вежба**: Завршите практични деплој поглавља
2. **Провера знања**: Прегледајте FAQ одељак за своје поглавље
3. **Заједничка дискусија**: Поделите своје искуство у Azure Discord заједници
...
- **Напредак у каријери**: Тражено знање у AZD и AI деплоју
...
- Делите своја искуства са AZD + AI и добијете помоћ
...
- **Превођењу**: Помозите у одржавању подршке за више језика
- **Пријавама грешака**: Побољшајте тачност и јасноћу
- **Стандардима заједнице**: Пратите наше инклузивне смернице за заједницу
