...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T15:52:02+00:00",
...
# Постављате питања и добијате одговоре подржане вештачком интелигенцијом са изворима
...
- **🛠️ AI радионица лабораторија**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - AI фокусиране вежбе
...
- **Обрасци за производни AI** - Најбоље праксе за скалабилна и исплатива AI постављања
...
- **Искуство у продукцији**: Деплојоване праве AI апликације на Azure
...
- **Највећи изазови**: Деплоји више сервиса, управљање акредитивима, спремност за продукцију  
