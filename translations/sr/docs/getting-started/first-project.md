...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T13:39:48+00:00",
...
Добродошли у ваш први Azure Developer CLI пројекат! Овај свеобухватни практични туторијал пружа комплетан водич за креирање, постављање и управљање full-stack апликацијом на Azure-у користећи azd. Радићете са правом todo апликацијом која укључује React frontend, Node.js API backend и MongoDB базу података.

## Циљеви учења

Завршетком овог туторијала, научићете:
- Како да савладате процес иницијализације azd пројекта користећи шаблоне
- Структуру пројекта Azure Developer CLI и конфигурационе фајлове
...
- Постављате full-stack апликације на Azure користећи једноставне команде
...
Почнимо са популарним шаблоном за todo апликацију који укључује React frontend и Node.js API backend.
...
1. **Додајте ставку у todo листу** - Кликните "Add Todo" и унесите задатак
...
- [Додајте базе података, складиште и друге сервисе](../deployment/provisioning.md#adding-services)
