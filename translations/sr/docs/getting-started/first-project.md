...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:36:41+00:00",
...
**Претходно:** [Конфигурација](configuration.md) | **Следеће:** [Интеграција са Azure AI Foundry](../ai-foundry/azure-ai-foundry-integration.md)
...
Почнимо са популарним шаблоном за todo апликацију који укључује React фронтенд и Node.js API бекенд.
