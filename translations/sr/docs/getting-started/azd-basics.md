...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T13:40:35+00:00",
...
Ова лекција вас упознаје са Azure Developer CLI (azd), моћним алатом командне линије који убрзава ваш пут од локалног развоја до Azure деплоја. Научићете основне концепте, кључне функције и разумети како azd поједностављује деплој cloud-native апликација.
...
- Истражити кључне функције, укључујући развој заснован на шаблонима и Infrastructure as Code
- Разумети структуру пројекта azd и ток рада
- Бити спремни за инсталацију и конфигурацију azd за ваш развојни оквир

## Исходи учења

Након завршетка ове лекције, моћи ћете:
- Објаснити улогу azd у модерним токовима рада cloud развоја
- Идентификовати компоненте структуре azd пројекта
- Описати како шаблони, окружења и сервиси функционишу заједно
- Разумети предности Infrastructure as Code са azd
- Препознати различите azd команде и њихове сврхе

## Шта је Azure Developer CLI (azd)?

Azure Developer CLI (azd) је алат командне линије дизајниран да убрза ваш пут од локалног развоја до Azure деплоја. Поједностављује процес изградње, деплоја и управљања cloud-native апликацијама на Azure-у.
...
- **Staging** - Пред-продукцијско окружење
- **Продукција** - Живо продукцијско окружење

Сваки оквир одржава своје:
...
- Документирајте поставке специфичне за окружење

## Прогресија учења

### Почетник (1-2 недеље)
1. Инсталирајте azd и аутентификујте се
2. Деплој једноставног шаблона
