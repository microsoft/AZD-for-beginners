...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T06:04:34+00:00",
...
2. **Пробајте први деплојмент**: Пратите [Водич за први пројекат](first-project.md)
3. **Истражите шаблоне**: Прегледајте доступне шаблоне са `azd template list`
4. **Конфигуришите ваш IDE**: Подесите своје развојно окружење
...
- [Дискусије у заједници](https://github.com/Azure/azure-dev/discussions)
- [Azure подршка](https://azure.microsoft.com/support/)

---

**Навигација**
- **Претходна лекција**: [Основе AZD-а](azd-basics.md)
- **Следећа лекција**: [Конфигурација](configuration.md)
