...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:37:26+00:00",
...
**Претходно:** [AZD Основе](azd-basics.md) | **Следеће:** [Први пројекат](first-project.md)

## Увод

Овај свеобухватни водич покрива све аспекте конфигурације Azure Developer CLI за оптималне токове развоја и примене. Научићете о хијерархији конфигурације, управљању окружењима, методама аутентификације и напредним обрасцима конфигурације који омогућавају ефикасне и безбедне Azure примене.
...
- Решавати проблеме везане за конфигурацију
- Прилагодити понашање azd за специфичне организационе захтеве

Овај свеобухватни водич покрива све аспекте конфигурације Azure Developer CLI за оптималне токове развоја и примене.
...
- [Провизионисање ресурса](../deployment/provisioning.md) - Конфигурације спремне за продукцију
