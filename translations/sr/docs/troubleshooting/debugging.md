...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T06:34:12+00:00",
  "source_file": "docs/troubleshooting/debugging.md",
  "language_code": "sr"
}
-->
# Водич за отклањање грешака - Напредне технике анализе логова

## Увод

Овај свеобухватни водич пружа напредне стратегије, алате и технике за дијагностиковање и решавање сложених проблема са Azure Developer CLI имплементацијама. Научите систематске методологије за отклањање грешака, технике анализе логова, профилисање перформанси и напредне дијагностичке алате за ефикасно решавање проблема са имплементацијом и извршавањем.

## Циљеви учења

Завршетком овог водича, научићете:
- Да савладате систематске методологије за отклањање грешака у Azure Developer CLI
...
- Да примените технике за отклањање грешака у мрежи и безбедности
- Да конфигуришете свеобухватно праћење и упозорења за проактивно откривање проблема

## Исходи учења

По завршетку, бићете у могућности да:
- Примените TRIAGE методологију за систематско отклањање сложених проблема са имплементацијом
...
## Методологија за отклањање грешака
...
- **E**scalate: Када потражити додатну помоћ
...
### Отклањање грешака у вези са базом података
```bash
...
### Отклањање грешака у интеграционим тестовима
```bash
#!/bin/bash
...
## 🔧 Отклањање инфраструктурних грешака
...
## 🔒 Отклањање безбедносних грешака

### Отклањање грешака у току аутентификације
```bash
...
### Отклањање грешака у мрежној безбедности
```bash
...
## 📱 Отклањање грешака специфичних за апликације

### Отклањање грешака у Node.js апликацијама
```javascript
...
### Отклањање грешака у упитима базе података
```javascript
...
5. **Држите алате за отклањање грешака ажурним** са променама у апликацији
6. **Вежбајте процедуре за отклањање грешака** ван времена инцидената

## Следећи кораци

- [Планирање капацитета](../pre-deployment/capacity-planning.md) - Планирање потреба за ресурсима
...
- [Брзи водич](../../resources/cheat-sheet.md) - Брзе референтне команде
