...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T06:23:14+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "sr"
}
-->
# Обезбеђивање ресурса - Инфраструктура као код са AZD

## Увод

Овај свеобухватни водич покрива све што треба да знате о обезбеђивању и управљању Azure ресурсима користећи Azure Developer CLI. Научите како да примените шаблоне Инфраструктуре као кода (IaC), од основног креирања ресурса до напредних инфраструктурних архитектура на нивоу предузећа користећи Bicep, ARM шаблоне, Terraform и Pulumi.

## Циљеви учења

Завршетком овог водича, научићете:
- Основне принципе Инфраструктуре као кода и обезбеђивање Azure ресурса
...
- Дизајнирате и обезбеђујете Azure инфраструктуру користећи Bicep и ARM шаблоне
...
- Решавате проблеме са обезбеђивањем инфраструктуре и отклањате грешке у имплементацији
...
## Преглед обезбеђивања инфраструктуре
...
### Датотеке параметара за различита окружења
```json
...
## 🚀 Напредни шаблони обезбеђивања

### Дистрибуција у више региона
```bicep
...
- [Планирање пре имплементације](../pre-deployment/capacity-planning.md) - Валидација доступности ресурса
- [Уобичајени проблеми](../troubleshooting/common-issues.md) - Решавање проблема са инфраструктуром
- [Водич за отклањање грешака](../troubleshooting/debugging.md) - Отклањање проблема са обезбеђивањем
...
- [ARM шаблони за Azure Resource Manager](https://learn.microsoft.com/en-us/azure/azure-resource-manager/templates/)
...
**Навигација**
- **Претходна лекција**: [Водич за имплементацију](deployment-guide.md)
