...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:18:04+00:00",
...
## Контролна листа за продукцијску спремност
...
- [ ] Пуловање веза за базу података
...
На основу повратних информација Azure AI Foundry Discord заједнице:
