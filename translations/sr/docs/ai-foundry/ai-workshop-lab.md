...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T14:46:06+00:00",
...
Ова практична радионица води програмере кроз процес узимања постојећег AI шаблона и његовог деплојмента уз помоћ Azure Developer CLI (AZD). Научићете основне шаблоне за продукцијске AI деплојменте користећи Azure AI Foundry услуге.

**Трајање:** 2-3 сата  
**Ниво:** Средњи  
**Предуслови:** Основно знање о Azure-у, упознатост са AI/ML концептима
...
- ✅ Деплојтујете продукцијске AI апликације са мониторингом
...
2. **Захтеви за сигурност:**
   ...
   - Које захтеве за усаглашеност имате?
...
Задатак вам је да креирате продукцијски спреман AI-покретан четбот за корисничку подршку са следећим захтевима:

**Функционални захтеви:**
- Веб интерфејс за интеракцију са корисницима
- Интеграција са Azure OpenAI за одговоре
- Способност претраге докумената користећи Cognitive Search
- Интеграција са постојећом базом података корисника
- Подршка за више језика

**Нефункционални захтеви:**
- Обрада 1000 корисника истовремено
...
- **⬅️ Претходно**: [Деплој модела заснованих на вештачкој интелигенцији](ai-model-deployment.md)
