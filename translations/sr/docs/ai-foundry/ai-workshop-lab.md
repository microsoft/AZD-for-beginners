...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:05:24+00:00",
...
**Претходно:** [Деплојмент AI модела](ai-model-deployment.md) | **Следеће:** [Практике за продукцију AI](production-ai-practices.md)

## Преглед радионице

Ова практична радионица води програмере кроз процес припреме постојеће AI апликације за деплојмент користећи Azure Developer CLI (AZD). Научићете основне шаблоне за продукцијске AI деплојменте користећи Azure AI Foundry услуге.
...
На крају ове радионице, моћи ћете:
- ✅ Претворити постојећу AI апликацију у AZD шаблон
- ✅ Конфигурисати Azure AI Foundry услуге са AZD-ом
- ✅ Имплементирати сигурно управљање акредитивима за AI услуге
- ✅ Деплојовати продукцијске AI апликације са мониторингом
- ✅ Решавати уобичајене проблеме са AI деплојментом
...
- Едитор кода (препоручује се VS Code)
...
## Модул 2: Деплојовање ваше прве AI апликације
...
### Корак 2.2: Деплојовање инфраструктуре и апликације

1. **Деплојовање са AZD-ом:**
```bash
azd up
```
...
- ✅ Деплојује код апликације
- ✅ Поставља мониторинг и логовање

2. **Пратите напредак деплојмента** и забележите креиране ресурсе.

### Корак 2.3: Верификација деплојмента

1. **Проверите деплојоване ресурсе:**
```bash
azd show
```

2. **Отворите деплојовану апликацију:**
```bash
...
### **Вежба 2.1: Практика решавања проблема**
...
### Корак 3.1: Модификација AI конфигурације
...
3. Деплојујте и упоредите трошкове са продукцијском конфигурацијом
...
1. **Омогућите приватне крајње тачке** (ако нису већ конфигурисане):
...
- Мониторишите употребу токена за OpenAI
...
- Могућност претраге докумената користећи Cognitive Search
...
3. **Имплементирајте мере сигурности**
4. **Поставите мониторинг и аларме**
5. **Креирајте деплојментне цевоводе**
6. **Документујте решење**

### Критеријуми за евалуацију

- ✅ **Функционалност**: Да ли испу
- ✅ Примените најбоље праксе за безбедност AI радних оптерећења  
- ✅ Пратите и оптимизујте перформансе AI апликација  
- ✅ Решите уобичајене проблеме приликом имплементације  
...
4. Истражите напредне теме као што су имплементације у више региона  
...
**Претходно:** [AI Model Deployment](ai-model-deployment.md) | **Следеће:** [Production AI Practices](production-ai-practices.md)  

**Потребна помоћ?** Придружите се нашој заједници за подршку и дискусије о AZD и AI имплементацијама.  
