...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:13:29+00:00",
  "source_file": "docs/ai-foundry/azure-ai-foundry-integration.md",
  "language_code": "sr"
}
-->
# Azure AI Foundry Интеграција са AZD

**Претходно:** [Први пројекат](../getting-started/first-project.md) | **Следеће:** [Деплој AI модела](ai-model-deployment.md)

## Преглед

Овај водич показује како да интегришете Azure AI Foundry услуге са Azure Developer CLI (AZD) ради поједностављеног деплоја AI апликација. Azure AI Foundry пружа свеобухватну платформу за креирање, деплој и управљање AI апликацијама, док AZD олакшава процес инфраструктуре и деплоја.

## Шта је Azure AI Foundry?

Azure AI Foundry је Microsoft-ова унифицирана платформа за AI развој која укључује:

- **Каталог модела**: Приступ најсавременијим AI моделима
- **Prompt Flow**: Визуелни дизајнер за AI токове рада
- **AI Foundry портал**: Интегрисано окружење за развој AI апликација
- **Опције деплоја**: Више опција за хостовање и скалирање
- **Безбедност и сигурност**: Уграђене функције за одговорни AI
...
| **Управљање окружењем** | Фокус на једно окружење | Више окружења (dev/staging/prod) |
...
**Случај употребе**: Деплој чет апликација са Azure OpenAI моделима
...
**Случај употребе**: Деплој апликација за претрагу уз помоћ RAG (retrieval-augmented generation)
...
**Симптоми:**
- Деплој не успева због грешака у квоти
...
**Симптоми:**
- 401/403 грешке при позиву AI услуга
...
5. **Обезбедите свој деплој**: Примените безбедносне обрасце за предузећа
6. **Скалирајте за продукцију**: Додајте мулти-регионалне и функције високе доступности
...
**Потребна помоћ?** Придружите се дискусијама у заједници или отворите проблем у репозиторијуму. Azure AI + AZD заједница је ту да вам помогне да успете!
