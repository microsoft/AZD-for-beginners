...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T18:36:56+00:00",
...
บทเรียนนี้จะแนะนำคุณให้รู้จักกับ Azure Developer CLI (azd) ซึ่งเป็นเครื่องมือบรรทัดคำสั่งที่ทรงพลังที่ช่วยเร่งการพัฒนาจากเครื่องท้องถิ่นไปจนถึงการปรับใช้บน Azure คุณจะได้เรียนรู้แนวคิดพื้นฐาน ฟีเจอร์สำคัญ และเข้าใจว่า azd ช่วยให้การปรับใช้แอปพลิเคชันแบบ cloud-native ง่ายขึ้นได้อย่างไร
...
- อธิบายบทบาทของ azd ในกระบวนการพัฒนาบนคลาวด์ยุคใหม่
- ระบุองค์ประกอบของโครงสร้างโปรเจกต์ azd
- อธิบายการทำงานร่วมกันของเทมเพลต สภาพแวดล้อม และบริการ
...
Azure Developer CLI (azd) เป็นเครื่องมือบรรทัดคำสั่งที่ออกแบบมาเพื่อช่วยเร่งการพัฒนาจากเครื่องท้องถิ่นไปจนถึงการปรับใช้บน Azure มันช่วยให้กระบวนการสร้าง ปรับใช้ และจัดการแอปพลิเคชันแบบ cloud-native บน Azure ง่ายขึ้น
...
### บริการ
บริการคือองค์ประกอบของแอปพลิเคชันของคุณ:
...
- **Bicep** - ภาษาที่เฉพาะเจาะจงสำหรับ Azure
...
ป้องกันไม่ให้ azd "จดจำ" การปรับใช้ก่อนหน้า ซึ่งอาจทำให้เกิดปัญหา เช่น กลุ่มทรัพยากรที่ไม่ตรงกันหรือการอ้างอิง registry ที่ล้าสมัย
...
- สถานการณ์ identity federation อื่น ๆ
...
### แนวทางปฏิบัติที่ดีที่สุดสำหรับการรับรองความถูกต้อง
...
1. **การจัดเก็บข้อมูลรับรอง**: ห้ามจัดเก็บข้อมูลรับรองในโค้ดต้นฉบับ
...
- [โปรเจกต์แรกของคุณ](first-project.md) - ทำแบบฝึกหัดเชิงปฏิบัติ
