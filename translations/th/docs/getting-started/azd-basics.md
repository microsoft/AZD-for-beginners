...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T20:59:22+00:00",
...
**ก่อนหน้า:** [การติดตั้งและตั้งค่า](installation.md) | **ถัดไป:** [การกำหนดค่า](configuration.md)

## บทนำ

บทเรียนนี้จะแนะนำคุณเกี่ยวกับ Azure Developer CLI (azd) ซึ่งเป็นเครื่องมือบรรทัดคำสั่งที่ทรงพลังที่ช่วยเร่งกระบวนการจากการพัฒนาในเครื่องไปจนถึงการปรับใช้บน Azure คุณจะได้เรียนรู้แนวคิดพื้นฐาน ฟีเจอร์หลัก และเข้าใจว่า azd ช่วยให้การปรับใช้แอปพลิเคชันแบบคลาวด์เนทีฟง่ายขึ้นได้อย่างไร
...
Azure Developer CLI (azd) เป็นเครื่องมือบรรทัดคำสั่งที่ออกแบบมาเพื่อช่วยเร่งกระบวนการจากการพัฒนาในเครื่องไปจนถึงการปรับใช้บน Azure มันช่วยให้การสร้าง ปรับใช้ และจัดการแอปพลิเคชันแบบคลาวด์เนทีฟบน Azure ง่ายขึ้น
...
- **การพัฒนา** - สำหรับการทดสอบและพัฒนา
- **การทดสอบ** - สภาพแวดล้อมก่อนการผลิต
- **การผลิต** - สภาพแวดล้อมการผลิตจริง
...
### บริการ
บริการเป็นองค์ประกอบของแอปพลิเคชันของคุณ:
...
คำสั่ง `azd down --force --purge` เป็นวิธีที่ทรงพลังในการลบสภาพแวดล้อม azd และทรัพยากรที่เกี่ยวข้องทั้งหมดอย่างสมบูรณ์ นี่คือรายละเอียดของแต่ละตัวเลือก:
```
--force
```
- ข้ามการยืนยัน
...
- อย่าปรับใช้โดยตรงไปยัง production จากเครื่องในเครื่อง
...
**ก่อนหน้า:** [การติดตั้งและตั้งค่า](installation.md) | **ถัดไป:** [การกำหนดค่า](configuration.md)
- **บทเรียนถัดไป**: [การติดตั้งและตั้งค่า](installation.md)
