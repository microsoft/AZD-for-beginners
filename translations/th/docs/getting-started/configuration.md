...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T13:17:24+00:00",
...
คู่มือฉบับสมบูรณ์นี้ครอบคลุมทุกแง่มุมของการตั้งค่า Azure Developer CLI เพื่อการพัฒนาและการปรับใช้ที่มีประสิทธิภาพ คุณจะได้เรียนรู้เกี่ยวกับลำดับชั้นของการตั้งค่า การจัดการสภาพแวดล้อม วิธีการรับรองความถูกต้อง และรูปแบบการตั้งค่าขั้นสูงที่ช่วยให้การปรับใช้ Azure มีประสิทธิภาพและปลอดภัย

## เป้าหมายการเรียนรู้

เมื่อจบบทเรียนนี้ คุณจะสามารถ:
- เข้าใจลำดับชั้นของการตั้งค่า azd และลำดับความสำคัญของการตั้งค่า
- ตั้งค่าระดับโลกและระดับโปรเจกต์ได้อย่างมีประสิทธิภาพ
- จัดการหลายสภาพแวดล้อมที่มีการตั้งค่าต่างกัน
- ใช้รูปแบบการรับรองความถูกต้องและการอนุญาตที่ปลอดภัย
...
คู่มือฉบับสมบูรณ์นี้ครอบคลุมทุกแง่มุมของการตั้งค่า Azure Developer CLI เพื่อการพัฒนาและการปรับใช้ที่มีประสิทธิภาพ
...
### การรับรองความถูกต้องด้วย Service Principal
...
**การนำทาง**
- **บทเรียนก่อนหน้า**: [การติดตั้งและการตั้งค่า](installation.md)
