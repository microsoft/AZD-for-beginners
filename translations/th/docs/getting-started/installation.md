...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:26:38+00:00",
...
- เข้าใจตัวเลือกการติดตั้งต่าง ๆ และเลือกใช้ในสถานการณ์ที่เหมาะสม
...
คู่มือนี้จะช่วยคุณติดตั้งและตั้งค่า Azure Developer CLI บนระบบของคุณ ไม่ว่าคุณจะใช้ระบบปฏิบัติการหรือสภาพแวดล้อมการพัฒนาแบบใดก็ตาม
...
azd มาพร้อมการติดตั้งใน GitHub Codespaces เพียงสร้าง codespace และเริ่มใช้งาน azd ได้ทันที
...
สำหรับระบบที่ไม่มีหน้าจอหรือมีปัญหาเกี่ยวกับเบราว์เซอร์:
```bash
...
### ตัวแปรสภาพแวดล้อม
เพิ่มลงในโปรไฟล์ shell (`.bashrc`, `.zshrc`, `.profile`):
```bash
# Azure configuration
...
1. **ตั้งค่าการยืนยันตัวตนให้สมบูรณ์**: ตรวจสอบว่าคุณสามารถเข้าถึงการสมัครสมาชิก Azure ของคุณ
...
**การนำทาง**
- **บทเรียนก่อนหน้า**: [AZD Basics](azd-basics.md)
- **บทเรียนถัดไป**: [Configuration](configuration.md)
