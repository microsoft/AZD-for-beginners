...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:21:11+00:00",
...
ยินดีต้อนรับสู่โครงการแรกของคุณกับ Azure Developer CLI! บทเรียนแบบลงมือทำนี้จะพาคุณผ่านขั้นตอนการสร้าง, การปรับใช้, และการจัดการแอปพลิเคชันแบบเต็มรูปแบบบน Azure โดยใช้ azd คุณจะได้ทำงานกับแอปพลิเคชัน todo จริงที่มี React เป็นส่วนหน้าของระบบ, Node.js API เป็นส่วนหลังของระบบ, และฐานข้อมูล MongoDB
...
คำสั่ง `azd up` ทำขั้นตอนเหล่านี้:
1. **Provision** (`azd provision`) - สร้างทรัพยากรบน Azure
...
เมื่อคุณทดลองเสร็จแล้ว ล้างทรัพยากรเพื่อหลีกเลี่ยงค่าใช้จ่ายที่ต่อเนื่อง:
...
**ยินดีด้วยที่คุณทำโครงการ azd แรกของคุณสำเร็จ!** ตอนนี้คุณพร้อมที่จะสร้างและปรับใช้แอปพลิเคชันที่ยอดเยี่ยมบน Azure ด้วยความมั่นใจแล้ว
