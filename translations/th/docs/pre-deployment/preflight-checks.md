...
-->
# การตรวจสอบก่อนการเริ่มต้น - การตรวจสอบความพร้อมในการปรับใช้

## บทนำ

คู่มือฉบับสมบูรณ์นี้ให้สคริปต์และขั้นตอนการตรวจสอบก่อนการปรับใช้ เพื่อให้มั่นใจว่าการปรับใช้ Azure Developer CLI จะประสบความสำเร็จก่อนเริ่มต้น เรียนรู้วิธีการดำเนินการตรวจสอบอัตโนมัติสำหรับการตรวจสอบสิทธิ์ ความพร้อมใช้งานของทรัพยากร โควตา การปฏิบัติตามข้อกำหนดด้านความปลอดภัย และข้อกำหนดด้านประสิทธิภาพ เพื่อป้องกันความล้มเหลวในการปรับใช้และเพิ่มอัตราความสำเร็จในการปรับใช้

## เป้าหมายการเรียนรู้

เมื่อจบคู่มือนี้ คุณจะ:
- เชี่ยวชาญเทคนิคและสคริปต์การตรวจสอบก่อนการปรับใช้อัตโนมัติ
- เข้าใจกลยุทธ์การตรวจสอบที่ครอบคลุมสำหรับการตรวจสอบสิทธิ์ การอนุญาต และโควตา
- ดำเนินการขั้นตอนการตรวจสอบความพร้อมใช้งานและความจุของทรัพยากร
- กำหนดค่าการตรวจสอบความปลอดภัยและการปฏิบัติตามข้อกำหนดตามนโยบายองค์กร
- ออกแบบกระบวนการตรวจสอบงบประมาณและการประมาณค่าใช้จ่าย
- สร้างระบบอัตโนมัติสำหรับการตรวจสอบก่อนการเริ่มต้นที่ปรับแต่งได้สำหรับ CI/CD pipelines

## ผลลัพธ์การเรียนรู้

เมื่อจบคู่มือ คุณจะสามารถ:
- สร้างและดำเนินการสคริปต์การตรวจสอบก่อนการเริ่มต้นที่ครอบคลุม
- ออกแบบกระบวนการตรวจสอบอัตโนมัติสำหรับสถานการณ์การปรับใช้ต่างๆ
- ดำเนินการขั้นตอนและนโยบายการตรวจสอบเฉพาะสำหรับแต่ละสภาพแวดล้อม
- กำหนดค่าการตรวจสอบเชิงรุกและการแจ้งเตือนสำหรับความพร้อมในการปรับใช้
- แก้ไขปัญหาก่อนการปรับใช้และดำเนินการแก้ไข
- ผสานรวมการตรวจสอบก่อนการเริ่มต้นเข้ากับ DevOps pipelines และกระบวนการอัตโนมัติ

## สารบัญ

- [ภาพรวม](../../../../docs/pre-deployment)
- [สคริปต์การตรวจสอบก่อนการเริ่มต้นอัตโนมัติ](../../../../docs/pre-deployment)
...
การตรวจสอบก่อนการเริ่มต้นเป็นการตรวจสอบที่สำคัญที่ดำเนินการก่อนการปรับใช้เพื่อให้มั่นใจว่า:

- **ความพร้อมใช้งานของทรัพยากร** และโควตาในภูมิภาคเป้าหมาย
- **การตรวจสอบสิทธิ์และการอนุญาต** ถูกกำหนดค่าอย่างถูกต้อง
...
### เมื่อใดควรดำเนินการตรวจสอบก่อนการเริ่มต้น
...
## สคริปต์การตรวจสอบก่อนการเริ่มต้นอัตโนมัติ
...
- [ ] ติดตั้ง Azure CLI และตรวจสอบสิทธิ์
...
- [ ] ตรวจสอบสิทธิ์สำเร็จด้วย `azd auth login`
...
- [ ] พารามิเตอร์ที่จำเป็นทั้งหมดมีค่าเริ่มต้นหรือจะถูกจัดเตรียม
- [ ] ไม่มีความลับที่ถูกฮาร์ดโค้ดในเทมเพลต
...
#### ✅ การจัดการค่าใช้จ่าย
- [ ] คำนวณค่าใช้จ่ายโดยประมาณโดยใช้ Azure Pricing Calculator
...
### ✅ แนวปฏิบัติที่ดีที่สุดสำหรับการตรวจสอบก่อนการเริ่มต้น

1. **ทำให้อัตโนมัติเมื่อเป็นไปได้**
   - ผสานรวมการตรวจสอบเข้ากับ CI/CD pipelines
   - ใช้สคริปต์สำหรับการตรวจสอบที่ทำซ้ำได้
   - เก็บผลลัพธ์สำหรับการตรวจสอบย้อนหลัง
...
### ข้อผิดพลาดทั่วไปในการตรวจสอบก่อนการเริ่มต้น

1. **ข้ามการตรวจสอบ** เพื่อการปรับใช้อย่างรวดเร็ว
2. **การตรวจสอบสิทธิ์ไม่เพียงพอ** ก่อนการปรับใช้
3. **ละเลยข้อจำกัดโควตา** จนกว่าการปรับใช้จะล้มเหลว
...
**เคล็ดลับ**: ดำเนินการตรวจสอบก่อนการเริ่มต้นเป็นงานแยกใน CI/CD pipeline ของคุณก่อนงานการปรับใช้จริง วิธีนี้ช่วยให้คุณจับปัญหาได้เร็วขึ้นและให้ข้อเสนอแนะที่รวดเร็วแก่ผู้พัฒนา
