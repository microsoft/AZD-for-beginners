...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T14:28:01+00:00",
...
เวิร์กช็อปนี้เป็นการฝึกปฏิบัติที่ช่วยให้นักพัฒนาสามารถนำเทมเพลต AI ที่มีอยู่มาปรับใช้โดยใช้ Azure Developer CLI (AZD) คุณจะได้เรียนรู้รูปแบบสำคัญสำหรับการปรับใช้ AI ในการผลิตโดยใช้บริการ Azure AI Foundry
...
- ✅ ใช้การจัดการข้อมูลรับรองอย่างปลอดภัยสำหรับบริการ AI
...
- ความคุ้นเคยกับส่วนติดต่อบรรทัดคำสั่ง
...
- การตั้งค่าความปลอดภัยของเครือข่าย
...
- **ความสามารถในการปรับขนาด**: งาน AI มีข้อกำหนดเฉพาะสำหรับการปรับขนาด
- **การจัดการต้นทุน**: บริการ AI อาจมีค่าใช้จ่ายสูงหากไม่ได้รับการตั้งค่าอย่างเหมาะสม

## โมดูล 2: ปรับใช้แอปพลิเคชัน AI ครั้งแรกของคุณ
...
2. **ติดตามความคืบหน้าการปรับใช้** และสังเกตทรัพยากรที่ถูกสร้างขึ้น

### ขั้นตอน 2.3: ตรวจสอบการปรับใช้ของคุณ

1. **ตรวจสอบทรัพยากรที่ปรับใช้แล้ว:**
```bash
azd show
```

2. **เปิดแอปพลิเคชันที่ปรับใช้แล้ว:**
```bash
...
**ความท้าทาย**: ตั้งค่าเทมเพลตให้เหมาะสมกับการพัฒนาที่มีต้นทุนต่ำ

**งานที่ต้องทำ:**
1. ระบุว่า SKU ใดสามารถตั้งค่าเป็นระดับฟรี/พื้นฐานได้
2. ตั้งค่าตัวแปรสภาพแวดล้อมให้มีต้นทุนต่ำที่สุด
...
- พิจารณาใช้สำเนาอ่านสำหรับสถานการณ์ที่มีโหลดสูง
...
- ความสามารถในการค้นหาเ
ยินดีด้วย! คุณได้ทำเวิร์กช็อป AI Workshop Lab เสร็จเรียบร้อยแล้ว ตอนนี้คุณควรจะสามารถ:
...
**ความคิดเห็นเกี่ยวกับเวิร์กช็อป**: ช่วยเราปรับปรุงเวิร์กช็อปนี้โดยแบ่งปันประสบการณ์ของคุณใน [Azure AI Foundry Discord #Azure channel](https://discord.gg/microsoft-azure)

---

**การนำทางบทเรียน:**
- **📚 หน้าแรกของคอร์ส**: [AZD For Beginners](../../README.md)
- **📖 บทเรียนปัจจุบัน**: บทที่ 2 - การพัฒนาแบบ AI-First
- **⬅️ ก่อนหน้า**: [การปรับใช้โมเดล AI](ai-model-deployment.md)
