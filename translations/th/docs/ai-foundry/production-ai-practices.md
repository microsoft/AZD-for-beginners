...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T21:46:49+00:00",
...
**ก่อนหน้า:** [AI Workshop Lab](ai-workshop-lab.md) | **ถัดไป:** [AI Troubleshooting Guide](../troubleshooting/ai-troubleshooting.md)

## ภาพรวม

คู่มือนี้นำเสนอแนวทางปฏิบัติที่ครอบคลุมสำหรับการปรับใช้งาน AI ที่พร้อมสำหรับการผลิตโดยใช้ Azure Developer CLI (AZD) โดยอ้างอิงจากความคิดเห็นของชุมชน Azure AI Foundry Discord และการปรับใช้ของลูกค้าในโลกจริง แนวทางเหล่านี้ช่วยแก้ไขปัญหาที่พบบ่อยที่สุดในระบบ AI สำหรับการผลิต

## ความท้าทายสำคัญที่ได้รับการแก้ไข

จากผลสำรวจของชุมชน นี่คือความท้าทายหลักที่นักพัฒนาต้องเผชิญ:

- **45%** มีปัญหาในการปรับใช้ AI หลายบริการ
...
- [ ] ใช้การเชื่อมต่อฐานข้อมูลแบบพูล
...
1. **เริ่มต้นเล็กและปรับขนาดอย่างค่อยเป็นค่อยไป**: เริ่มต้นด้วย SKU พื้นฐานและปรับขนาดตามการใช้งานจริง
...
5. **วางแผนต้นทุน**: ตรวจสอบการใช้โทเค็นและตั้งค่าการแจ้งเตือนงบประมาณตั้งแต่เนิ่นๆ
