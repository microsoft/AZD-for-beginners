...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:45:33+00:00",
...
คู่มือการแก้ไขปัญหาฉบับสมบูรณ์นี้ครอบคลุมปัญหาที่พบบ่อยที่สุดเมื่อใช้งาน Azure Developer CLI เรียนรู้วิธีวินิจฉัย แก้ไข และจัดการปัญหาทั่วไปเกี่ยวกับการยืนยันตัวตน การปรับใช้ การจัดเตรียมโครงสร้างพื้นฐาน และการตั้งค่าการใช้งานแอปพลิเคชัน แต่ละปัญหามีอาการ สาเหตุ และขั้นตอนการแก้ไขอย่างละเอียด
...
- แก้ไขปัญหาการปรับใช้ การจัดเตรียมโครงสร้างพื้นฐาน และการตั้งค่าการใช้งาน
- ใช้กลยุทธ์การตรวจสอบและการดีบักเชิงรุก
- ใช้ระเบียบวิธีการแก้ไขปัญหาอย่างเป็นระบบสำหรับปัญหาที่ซับซ้อน
...
- ดีบักปัญหาการตั้งค่าการใช้งานและปัญหาเฉพาะสภาพแวดล้อม
- ใช้การตรวจสอบและการแจ้งเตือนเพื่อระบุปัญหาที่อาจเกิดขึ้นล่วงหน้า
- ใช้แนวทางปฏิบัติที่ดีที่สุดสำหรับการบันทึก การดีบัก และการแก้ไขปัญหา
...
**อาการ:**
- การปรับใช้ล้มเหลวพร้อมข้อผิดพลาดสิทธิ์
...
## 🏗️ ปัญหาการจัดเตรียมโครงสร้างพื้นฐาน
...
**อาการ:**
- แอปพลิเคชันล้มเหลวในการสร้างระหว่างการปรับใช้
...
- ตัวแปรสภาพแวดล้อมปรากฏว่าเป็นค่าว่าง
...
### ปัญหา: เวลาการปรับใช้ช้า
**อาการ:**
- การปรับใช้ใช้เวลานานเกินไป
- ข้อผิดพลาดหมดเวลาระหว่างการปรับใช้
