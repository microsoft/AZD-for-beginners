...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:42:07+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "th"
}
-->
# การจัดเตรียมทรัพยากร - โครงสร้างพื้นฐานเป็นโค้ดด้วย AZD
...
เมื่อคุณทำคู่มือนี้เสร็จ คุณจะ:
- เชี่ยวชาญหลักการโครงสร้างพื้นฐานเป็นโค้ดและการจัดเตรียมทรัพยากร Azure
- เข้าใจผู้ให้บริการ IaC หลายรายที่รองรับโดย Azure Developer CLI
- ออกแบบและนำ Bicep templates ไปใช้สำหรับสถาปัตยกรรมแอปพลิเคชันทั่วไป
- กำหนดค่าพารามิเตอร์ทรัพยากร ตัวแปร และการตั้งค่าสำหรับสภาพแวดล้อมเฉพาะ
...
- กำหนดค่าโครงสร้างพื้นฐานหลายบริการที่ซับซ้อนพร้อมการพึ่งพาทรัพยากรที่เหมาะสม
- นำ templates ที่มีพารามิเตอร์ไปใช้สำหรับหลายสภาพแวดล้อมและการกำหนดค่า
...
- **Bicep** (แนะนำ) - ภาษาที่เฉพาะเจาะจงสำหรับ Azure
- **ARM Templates** - เทมเพลต JSON สำหรับ Azure Resource Manager
