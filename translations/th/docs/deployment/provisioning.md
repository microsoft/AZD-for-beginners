...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T22:59:51+00:00",
...
- **⬅️ บทก่อนหน้า**: [คู่มือการปรับใช้](deployment-guide.md)
...
- ออกแบบและนำเทมเพลต Bicep ไปใช้สำหรับสถาปัตยกรรมแอปพลิเคชันทั่วไป
...
- กำหนดค่าโครงสร้างหลายบริการที่ซับซ้อนพร้อมการพึ่งพาทรัพยากรที่เหมาะสม
- นำเทมเพลตที่มีพารามิเตอร์ไปใช้สำหรับหลายสภาพแวดล้อมและการตั้งค่า
...
## 🔧 การกำหนดค่าสำหรับสภาพแวดล้อมเฉพาะ
