...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T11:30:41+00:00",
...
- **📋 อ้างอิงด่วน**: [Cheat Sheet คำสั่ง](resources/cheat-sheet.md)
...
- ใช้ **Free Tier** Azure OpenAI สำหรับการเรียนรู้ (รวม 50,000 โทเค็น/เดือน)
...
**💡 ผลลัพธ์ของบทนี้**: จัดการหลายสภาพแวดล้อมด้วยการรับรองความถูกต้องและความปลอดภัยที่เหมาะสม
...
- **🛠️ ARM Templates**: [แพ็คเกจ ARM Template](../../examples/retail-multiagent-arm-template) - ติดตั้งได้ในคลิกเดียว
- **📖 สถาปัตยกรรม**: [รูปแบบการประสานงานของ Multi-agent](/docs/pre-deployment/coordination-patterns.md) - รูปแบบต่างๆ

#### แบบฝึกหัดปฏิบัติ
```bash
# ปรับใช้โซลูชันตัวแทนหลายตัวสำหรับการค้าปลีกอย่างสมบูรณ์
...
**💡 ผลลัพธ์ของบทนี้**: ติดตั้งและจัดการโซลูชัน AI แบบ Multi-agent ที่พร้อมใช้งานในระดับการผลิตด้วย Customer และ Inventory agents

---

### 🔍 บทที่ 6: การตรวจสอบและวางแผนก่อนการติดตั้ง
**ข้อกำหนดเบื้องต้น**: ต้องผ่านบทที่ 4  
**ระยะเวลา**: 1 ชั่วโมง  
**ความซับซ้อน**: ⭐⭐
...
- กลยุทธ์การเลือก SKU
- การตรวจสอบเบื้องต้นและการทำงานอัตโนมัติ
...
- **✅ การตรวจสอบ**: [การตรวจสอบเบื้องต้น](docs/pre-deployment/preflight-checks.md) - สคริปต์อัตโนมัติ

#### แบบฝึกหัดปฏิบัติ
- รันสคริปต์ตรวจสอบความจุ
- ปรับแต่งการเลือก SKU ให้เหมาะสมกับค่าใช้จ่าย
- ใช้การตรวจสอบก่อนการติดตั้งแบบอัตโนมัติ

**💡 ผลลัพธ์ของบทนี้**: ตรวจสอบและปรับแต่งการติดตั้งให้เหมาะสมก่อนดำเนินการ

---

### 🚨 บทที่ 7: การแก้ไขปัญหาและการดีบัก
**ข้อกำหนดเบื้องต้น**: ต้องผ่านบทการติดตั้งใดๆ  
**ระยะเวลา**: 1-1.5 ชั่วโมง  
**ความซับซ้อน**: ⭐⭐
...
#### แบบฝึกหัดปฏิบัติ
- วินิจฉัยความล้มเหลวในการติดตั้ง
- แก้ไขปัญหาการยืนยันตัวตน
- ดีบักการเชื่อมต่อบริการ AI

**💡 ผลลัพธ์ของบทนี้**: วินิจฉัยและแก้ไขปัญหาการติดตั้งทั่วไปได้ด้วยตัวเอง
...
#### สิ่งที่คุณจะได้เรียนรู้
- กลยุทธ์การติดตั้งในระดับการผลิต
...
- ติดตั้งในระดับการผลิตด้วยการกำกับดูแลที่เหมาะสม

**💡 ผลลัพธ์ของบทนี้**: ติดตั้งแอปพลิเคชันที่พร้อมใช้งานในองค์กรด้วยความสามารถในระดับการผลิต
...
> วัสดุการเรียนรู้ของเวิร์กชอปกำลังอยู่ในระหว่างการพัฒนาและปรับปรุง โมดูลหลักพร้อมใช้งานแล้ว แต่บางส่วนขั้นสูงยังไม่สมบูรณ์ เรากำลังดำเนินการเพื่อให้เนื้อหาทั้งหมดเสร็จสมบูรณ์ [ติดตามความคืบหน้า →](workshop/README.md)

### วัสดุการเรียนรู้แบบโต้ตอบ
**การเรียนรู้แบบลงมือทำที่ครอบคลุมด้วยเครื่องมือในเบราว์เซอร์และแบบฝึกหัดที่มีคำแนะนำ**

วัสดุการเรียนรู้ของเวิร์กชอปของเรามอบประสบการณ์การเรียนรู้ที่มีโครงสร้างและโต้ตอบได้ ซึ่งเสริมหลักสูตรที่แบ่งเป็นบทข้างต้น เวิร์กชอปนี้ออกแบบมาสำหรับการเรียนรู้ด้วยตนเองและการเรียนรู้ที่มีผู้สอนนำ

#### 🛠️ คุณสมบัติของเวิร์กชอป
- **อินเทอร์เฟซในเบราว์เซอร์**: เวิร์กชอปที่ขับเคลื่อนด้วย MkDocs พร้อมฟีเจอร์ค้นหา คัดลอก และธีม
- **การผสาน GitHub Codespaces**: ตั้งค่าสภาพแวดล้อมการพัฒนาได้ในคลิกเดียว
- **เส้นทางการเรียนรู้ที่มีโครงสร้าง**: แบบฝึกหัดที่มีคำแนะนำ 7 ขั้นตอน (รวม 3.5 ชั่วโมง)
- **การค้นพบ → การติดตั้ง → การปรับแต่ง**: ระเบียบวิธีแบบก้าวหน้า
- **สภาพแวดล้อม DevContainer แบบโต้ตอบ**: เครื่องมือและการพึ่งพาที่กำหนดค่าไว้ล่วงหน้า

#### 📚 โครงสร้างของเวิร์กชอป
เวิร์กชอปนี้ใช้ระเบียบวิธี **การค้นพบ → การติดตั้ง → การปรับแต่ง**:

1. **ระยะการค้นพบ** (45 นาที)
   - สำรวจเทมเพลตและบริการของ Microsoft Foundry
   - เข้าใจรูปแบบสถาปัตยกรรม Multi-agent
   - ทบทวนข้อกำหนดและข้อกำหนดเบื้องต้นสำหรับการติดตั้ง

2. **ระยะการติดตั้ง** (2 ชั่วโมง)
   - การติดตั้งแอปพลิเคชัน AI แบบลงมือทำด้วย AZD
   - กำหนดค่าบริการ Azure AI และจุดเชื่อมต่อ
   - ใช้รูปแบบความปลอดภัยและการยืนยันตัวตน

3. **ระยะการปรับแต่ง** (45 นาที)
   - ปรับแต่งแอปพลิเคชันให้เหมาะกับกรณีการใช้งานเฉพาะ
   - ปรับแต่งสำหรับการติดตั้งในระดับการผลิต
...
เมื่อจบเวิร์กชอป ผู้เข้าร่วมจะสามารถ:
- **ติดตั้งแอปพลิเคชัน AI ในระดับการผลิต**: ใช้ AZD กับบริการของ Microsoft Foundry
- **เชี่ยวชาญสถาปัตยกรรม Multi-Agent**: ใช้โซลูชัน AI agent ที่ประสานงานกัน
- **ใช้แนวปฏิบัติที่ดีที่สุดด้านความปลอดภัย**: กำหนดค่าการยืนยันตัวตนและการควบคุมการเข้าถึง
- **ปรับแต่งสำหรับการขยายขนาด**: ออกแบบการติดตั้งที่คุ้มค่าและมีประสิทธิภาพ
- **แก้ไขปัญหาการติดตั้ง**: แก้ไขปัญหาทั่วไปได้ด้วยตัวเอง

#### 📖 ทรัพยากรของเวิร์กชอป
- **🎥 คู่มือแบบโต้ตอบ**: [วัสดุการเรียนรู้ของเวิร์กชอป](workshop/README.md) - สภาพแวดล้อมการเรียนรู้ในเบราว์เซอร์
...
Azure Developer CLI (azd) เป็นอินเทอร์เฟซบรรทัดคำสั่งที่เน้นนักพัฒนา ซึ่งช่วยเร่งกระบวนการสร้างและติดตั้งแอปพลิเคชันไปยัง Azure โดยมีคุณสมบัติ:

- **การติดตั้งตามเทมเพลต** - ใช้เทมเพลตที่สร้างไว้ล่วงหน้าสำหรับรูปแบบแอปพลิเคชันทั่วไป
- **โครงสร้างพื้นฐานเป็นโค้ด** - จัดการทรัพยากร Azure ด้วย Bicep หรือ Terraform  
- **เวิร์กโฟลว์แบบบูรณาการ** - จัดเตรียม ติดตั้ง และตรวจสอบแอปพลิเคชันได้อย่างราบรื่น
- **เหมาะสำหรับนักพัฒนา** - เพิ่มประสิทธิภาพสำหรับการทำงานและประสบการณ์ของนักพัฒนา
...
- **การติดตั้ง AI ที่ปลอดภัย** - รูปแบบความปลอดภัยในตัวสำหรับบริการ AI, คีย์ API และจุดเชื่อมต่อโมเดล  
- **รูปแบบ AI ในระดับการผลิต** - แนวปฏิบัติที่ดีที่สุดสำหรับการติดตั้งแอปพลิเคชัน AI ที่ขยายขนาดได้และคุ้มค่า
- **เวิร์กโฟลว์ AI แบบครบวงจร** - ตั้งแต่การพัฒนาโมเดลไปจนถึงการติดตั้งในระดับการผลิตพร้อมการตรวจสอบที่เหมาะสม
- **การปรับแต่งค่าใช้จ่าย** - กลยุทธ์การจัดสรรทรัพยากรและการขยายขนาดที่ชาญฉลาดสำหรับ workloads AI
- **การผสาน Microsoft Foundry** - การเชื่อมต่อที่ราบรื่นกับแคตตาล็อกโมเดลและจุดเชื่อมต่อของ Microsoft Foundry
...
**เริ่มต้นที่นี่หากคุณกำลังติดตั้งแอปพลิเคชัน AI!**

> **หมายเหตุ:** เทมเพลตเหล่านี้แสดงรูปแบบ AI ต่างๆ บางส่วนเป็น Azure Samples ภายนอก บางส่วนเป็นการใช้งานในพื้นที่
...
**เทมเพลตแอปพลิเคชันที่พร้อมใช้งานในระดับการผลิตที่เชื่อมโยงกับบทการเรียนรู้**
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | บทที่ 5 | ⭐⭐⭐⭐ | สถาปัตยกรรม Multi-agent พร้อม Customer และ Inventory agents |

### การเรียนรู้จากตัวอย่างตามประเภท
...
- [**โซลูชัน Multi-Agent สำหรับการค้าปลีก**](examples/retail-scenario.md) - การใช้งานที่พร้อมใช้งานในระดับการผลิตพร้อม ARM templates
  - สถาปัตยกรรม Multi-agent (Customer + Inventory agents)
  - การตรวจสอบและการประเมินผลที่ครอบคลุม
  - การติดตั้งได้ในคลิกเดียวผ่าน ARM template

#### ตัวอย่างในพื้นที่ - แอปพลิเคชัน Container (บทที่ 2-5)
**ตัวอย่างการติดตั้ง Container ที่ครอบคลุมใน repo นี้:**
- [**ตัวอย่าง Container App**](examples/container-app/README.md) - คู่มือการติดตั้ง Container อย่างสมบูรณ์
  - [Simple Flask API](../../examples/container-app/simple-flask-api) - REST API พื้นฐานพร้อม scale-to-zero
  - [Microservices Architecture](../../examples/container-app/microservices) - การติดตั้งหลายบริการที่พร้อมใช้งานในระดับการผลิต
  - รูปแบบการติดตั้งแบบเริ่มต้น การผลิต และขั้นสูง
...
- [Simple Web App - Node.js + MongoDB](https://github.com/Azure-Samples/todo-nodejs
- [**ชีทคำสั่ง**](resources/cheat-sheet.md) - คำสั่ง azd ที่สำคัญจัดเรียงตามบท
- [**อภิธานศัพท์**](resources/glossary.md) - คำศัพท์ Azure และ azd  
- [**คำถามที่พบบ่อย**](resources/faq.md) - คำถามทั่วไปจัดเรียงตามบทเรียน
- [**คู่มือการศึกษา**](resources/study-guide.md) - แบบฝึกหัดที่ครอบคลุม

### เวิร์กช็อปแบบลงมือทำ
- [**ห้องปฏิบัติการ AI Workshop**](docs/microsoft-foundry/ai-workshop-lab.md) - ทำให้โซลูชัน AI ของคุณสามารถใช้งานกับ AZD ได้ (2-3 ชั่วโมง)
- [**คู่มือเวิร์กช็อปแบบโต้ตอบ**](workshop/README.md) - เวิร์กช็อปบนเบราว์เซอร์ด้วย MkDocs และ DevContainer Environment
- [**เส้นทางการเรียนรู้แบบมีโครงสร้าง**](../../workshop/docs/instructions) - แบบฝึกหัด 7 ขั้นตอน (การค้นหา → การปรับใช้ → การปรับแต่ง)
- [**เวิร์กช็อป AZD สำหรับผู้เริ่มต้น**](workshop/README.md) - วัสดุเวิร์กช็อปแบบลงมือทำครบถ้วนพร้อมการผสาน GitHub Codespaces
...
1. **แบบฝึกหัดปฏิบัติ**: ทำการปรับใช้แบบลงมือทำของบทนั้น
...
**สำหรับผู้เริ่มต้น**: เริ่มต้นที่ [บทที่ 1: พื้นฐานและเริ่มต้นอย่างรวดเร็ว](../..)  
**สำหรับนักพัฒนา AI**: ข้ามไปที่ [บทที่ 2: การพัฒนาแบบ AI-First](../..)  
**สำหรับนักพัฒนาที่มีประสบการณ์**: เริ่มต้นที่ [บทที่ 3: การตั้งค่าและการยืนยันตัวตน](../..)
