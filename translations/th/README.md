...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T12:13:40+00:00",
...
เมื่อคุณทำคอร์สนี้เสร็จสิ้น คุณจะ:
...
**💡 ผลลัพธ์ของบทเรียน**: ปรับใช้เว็บแอปพลิเคชันง่าย ๆ บน Azure ด้วย AZD ได้สำเร็จ
...
**ข้อกำหนดเบื้องต้น**: ทำบทที่ 1 เสร็จ  
...
**ข้อกำหนดเบื้องต้น**: ทำบทที่ 1-3 เสร็จ  
...
**ข้อกำหนดเบื้องต้น**: ทำบทที่ 1-2 เสร็จ  
...
- **เวิร์กโฟลว์ AI แบบครบวงจร** - ตั้งแต่การพัฒนาโมเดลจนถึงการปรับใช้ในสภาพแวดล้อมการผลิตพร้อมการตรวจสอบที่เหมาะสม
