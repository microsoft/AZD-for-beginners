...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T23:07:02+00:00",
...
อ้างอิงจากข้อมูลในชุมชน Microsoft Foundry Discord, **45% ของนักพัฒนาต้องการใช้ AZD สำหรับงาน AI** แต่พบความท้าทายกับ:
...
เมื่อคุณทำหลักสูตรนี้จนจบ คุณจะ:
...
**💡 ผลลัพธ์ของบทเรียน**: ปรับใช้เว็บแอปพลิเคชันง่าย ๆ บน Azure โดยใช้ AZD ได้สำเร็จ
...
**ข้อกำหนดเบื้องต้น**: ทำบทที่ 1 เสร็จแล้ว  
...
- **🎥 คู่มือเชิงโต้ตอบ**: [วัสดุเวิร์กช็อป](workshop/README.md) - เรียนรู้ผ่านเบราว์เซอร์ด้วย MkDocs * สภาพแวดล้อม DevContainer
...
**💰 ความเข้าใจต้นทุน:** เข้าใจต้นทุนการพัฒนา $80-150/เดือน, ต้นทุนการผลิต $300-3500/เดือน
...
- เริ่มด้วยการคิดค่าบริการแบบบริโภค อัปเกรดเป็น PTU เฉพาะสำหรับการผลิต
...
**ข้อกำหนดเบื้องต้น**: ทำบทที่ 1-3 เสร็จแล้ว  
...
#### แบบฝึกหัดปฏิบัติ
```bash
# ปรับใช้โซลูชันตัวแทนหลายรายค้าปลีกครบวงจร
...
**💡 ผลลัพธ์บทเรียน**: ตรวจสอบและปรับแต่งการปรับใช้ก่อนดำเนินการ
...
> วัสดุเวิร์กช็อปกำลังอยู่ในระหว่างการพัฒนาและปรับปรุง โมดูลหลักใช้งานได้ แต่บางส่วนของเนื้อหาขั้นสูงยังไม่สมบูรณ์ เรากำลังดำเนินการให้เสร็จสมบูรณ์ทั้งหมด [ติดตามความคืบหน้า →](workshop/README.md)
...
- **ปรับแต่งเพื่อขยายขนาด**: ออกแบบการปรับใช้ที่คุ้มค่าและมีประสิทธิภาพ
...
- **🛠️ ห้องปฏิบัติการ AI Workshop**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - แบบฝึกหัดเน้น AI
...
Azure Developer CLI (azd) คืออินเทอร์เฟซบรรทัดคำสั่งที่เน้นนักพัฒนา ช่วยเร่งกระบวนการสร้างและปรับใช้แอปพลิเคชันไปยัง Azure โดยมีคุณสมบัติดังนี้:
...
> **หมายเหตุ:** เทมเพลตเหล่านี้แสดงรูปแบบ AI ต่างๆ บางส่วนเป็นตัวอย่าง Azure ภายนอก บางส่วนเป็นการใช้งานภายใน
...
**เทมเพลตแอปพร้อมใช้งานสำหรับการผลิตที่จับคู่กับบทเรียน**
...
> **ตัวอย่างภายใน** (ในที่เก็บนี้) = พร้อมใช้งานทันที  
> **ตัวอย่างภายนอก** (Azure Samples) = โคลนจากที่เก็บที่ลิงก์ไว้

#### ตัวอย่างภายใน (พร้อมใช้งาน)
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - การใช้งานจริงที่สมบูรณ์พร้อมเทมเพลต ARM
...
- [**Examples Directory**](examples/README.md) - ตัวอย่างการเรียนรู้ภายในพร้อมคำอธิบายละเอียด
...
3. **อภิปรายชุมชน:** แบ่งปันประสบการณ์ของคุณใน Azure Discord
4. **บทถัดไป:** ไปยังระดับความซับซ้อนถัดไป

### ประโยชน์จากการสำเร็จหลักสูตร
เมื่อจบบททั้งหมดแล้ว คุณจะมี:
...
- แบ่งปันประสบการณ์ AZD + AI และรับความช่วยเหลือ
