...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:45:02+00:00",
...
- **🛠️ การปฏิบัติ**: [โปรเจกต์แรกของคุณ](docs/getting-started/first-project.md) - บทเรียนทีละขั้นตอน
...
**💡 ผลลัพธ์ของบทนี้**: ปรับใช้และจัดการโซลูชัน AI Multi-Agent ที่พร้อมสำหรับการผลิตพร้อม Agent ลูกค้าและสินค้าคงคลัง
...
#### สิ่งที่คุณจะได้เรียนรู้
- กลยุทธ์การนำไปใช้งานในระดับผลิต
- รูปแบบความปลอดภัยสำหรับองค์กร
- การตรวจสอบและการปรับปรุงต้นทุน

#### แหล่งข้อมูลการเรียนรู้
- **🏭 การผลิต**: [Production AI Best Practices](docs/ai-foundry/production-ai-practices.md) - รูปแบบสำหรับองค์กร
...
- นำไปใช้งานในระดับผลิตด้วยการกำกับดูแลที่เหมาะสม

**💡 ผลลัพธ์ของบทนี้**: นำแอปพลิเคชันที่พร้อมสำหรับองค์กรไปใช้งานในระดับผลิตได้อย่างสมบูรณ์
...
วัสดุเวิร์กช็อปของเรามอบประสบการณ์การเรียนรู้ที่มีโครงสร้างและโต้ตอบได้ ซึ่งเสริมหลักสูตรตามบทที่กล่าวถึงข้างต้น เวิร์กช็อปนี้ออกแบบมาสำหรับการเรียนรู้ด้วยตนเองและการเรียนรู้แบบมีผู้สอน
...
2. **ขั้นตอนการนำไปใช้งาน** (2 ชั่วโมง)
   - การนำแอปพลิเคชัน AI ไปใช้งานแบบลงมือทำด้วย AZD
...
3. **ขั้นตอนการปรับแต่ง** (45 นาที)
   ...
   - ปรับให้เหมาะสมสำหรับการนำไปใช้งานในระดับผลิต
...
- **นำแอปพลิเคชัน AI ไปใช้งานในระดับผลิต**: ใช้ AZD กับบริการ Azure AI Foundry
...
- **แก้ไขปัญหาการนำไปใช้งาน**: แก้ไขปัญหาทั่วไปได้ด้วยตนเอง
...
- **เทมเพลตที่พร้อมสำหรับ AI** - เทมเพลตที่ตั้งค่าล่วงหน้าสำหรับ Azure OpenAI, Cognitive Services และ ML workloads
- **การนำ AI ไปใช้งานอย่างปลอดภัย** - รูปแบบความปลอดภัยในตัวสำหรับบริการ AI คีย์ API และจุดสิ้นสุดของโมเดล  
- **รูปแบบ AI ในระดับผลิต** - แนวปฏิบัติที่ดีที่สุดสำหรับการนำแอปพลิเคชัน AI ไปใช้งานที่ขยายขนาดได้และคุ้มค่า
- **เวิร์กโฟลว์ AI แบบครบวงจร** - ตั้งแต่การพัฒนาโมเดลไปจนถึงการนำไปใช้งานในระดับผลิตพร้อมการตรวจสอบที่เหมาะสม
- **การปรับปรุงต้นทุน** - กลยุทธ์การจัดสรรทรัพยากรและการขยายขนาดที่ชาญฉลาดสำหรับ workloads AI
- **การผสาน Azure AI Foundry** - การเชื่อมต่อที่ราบรื่นกับแคตตาล็อกโมเดลและจุดสิ้นสุดของ AI Foundry
...
- [Enterprise Solutions](../../examples/enterprise) - รูปแบบที่พร้อมสำหรับการผลิต
...
- [**Interactive Workshop Guide**](workshop/README.md) - เวิร์กช็อปบนเบราว์เซอร์ด้วย MkDocs และ DevContainer Environment
- [**Structured Learning Path**](../../workshop/docs/instructions) - แบบฝึกหัดที่มีคำแนะนำ 7 ขั้นตอน (การค้นพบ → การนำไปใช้งาน → การปรับแต่ง)
- [**AZD For Beginners Workshop**](workshop/README.md) - วัสดุเวิร์กช็อปแบบลงมือทำที่สมบูรณ์พร้อมการผสาน GitHub Codespaces
...
2. **การตรวจสอบความรู้**: ทบทวนส่วน FAQ ของบทเรียน
3. **การสนทนาในชุมชน**: แบ่งปันประสบการณ์ของคุณใน Discord ของ Azure
4. **บทถัดไป**: ย้ายไปยังระดับความซับซ้อนถัดไป

### ประโยชน์จากการจบหลักสูตร
เมื่อจบบทเรียนทั้งหมด คุณจะมี:
- **ประสบการณ์การผลิต**: นำแอปพลิเคชัน AI จริงไปใช้งานบน Azure
- **ทักษะระดับมืออาชีพ**: ความสามารถในการนำไปใช้งานที่พร้อมสำหรับองค์กร  
...
##
- มีส่วนร่วมในแนวทางปฏิบัติที่ดีที่สุดสำหรับการใช้งาน AI  
- มีอิทธิพลต่อการพัฒนาฟีเจอร์ AI + AZD ในอนาคต  

### การมีส่วนร่วมในหลักสูตร  
เรายินดีต้อนรับการมีส่วนร่วม! โปรดอ่าน [คู่มือการมีส่วนร่วม](CONTRIBUTING.md) เพื่อดูรายละเอียดเกี่ยวกับ:  
- **การปรับปรุงเนื้อหา**: เพิ่มประสิทธิภาพบทและตัวอย่างที่มีอยู่  
- **ตัวอย่างใหม่**: เพิ่มสถานการณ์จริงและเทมเพลต  
- **การแปลภาษา**: ช่วยสนับสนุนการรองรับหลายภาษา  
