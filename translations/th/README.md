...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T15:13:44+00:00",
...
- การรวมและการตั้งค่าบริการ Azure AI
...
- นำแนวทางปฏิบัติที่ดีที่สุดด้านความปลอดภัยและการปรับค่าใช้จ่ายไปใช้
...
- นำแนวทางปฏิบัติที่ดีที่สุดด้านการตรวจสอบ ความปลอดภัย และการจัดการค่าใช้จ่ายไปใช้
- รวมเวิร์กโฟลว์ AZD เข้ากับ CI/CD pipelines
...
- **เทมเพลตที่พร้อมสำหรับ AI** - เทมเพลตที่กำหนดค่าไว้ล่วงหน้าสำหรับ Azure OpenAI, Cognitive Services และงาน ML
...
- **การปรับค่าใช้จ่ายให้เหมาะสม** - กลยุทธ์การจัดสรรทรัพยากรและการปรับขนาดที่ชาญฉลาดสำหรับงาน AI
- **การรวม Azure AI Foundry** - การเชื่อมต่อที่ราบรื่นกับแคตตาล็อกโมเดลและ endpoints ของ AI Foundry
...
### สำหรับนักพัฒนา AI (แนะนำให้เริ่มที่นี่!)
1. **เริ่มต้นอย่างรวดเร็ว**: ลองใช้เทมเพลต [azure-search-openai-demo](https://github.com/Azure-Samples/azure-search-openai-demo)
...
4. **พร้อมสำหรับการผลิต**: ทบทวน [Production AI Best Practices](docs/ai-foundry/production-ai-practices.md)
...
4. ตัวอย่างขั้นสูง [Microservices Example](../../examples/microservices)
...
### AI และ Azure AI Foundry
- [**การรวม Azure AI Foundry**](docs/ai-foundry/azure-ai-foundry-integration.md) - เชื่อมต่อ AZD กับบริการ Azure AI Foundry
...
- [**การแก้ไขปัญหาเฉพาะ AI**](docs/troubleshooting/ai-troubleshooting.md) - ปัญหาการให้บริการ AI และการปรับใช้โมเดล  
...
| [**สร้างเอกสารจากข้อมูลของคุณ**](https://github.com/Azure-Samples/get-started-with-ai-chat) | เร่งการสร้างเอกสาร เช่น สัญญา ใบแจ้งหนี้ และข้อเสนอการลงทุน โดยค้นหาและสรุปข้อมูลที่เกี่ยวข้องจากข้อมูลของคุณ |⭐⭐⭐ | AzureOpenAI + Azure AI Search + Azure AI Services + Azure CosmosDB|  
...
| [**สร้างเอเจนต์สนทนาของคุณ**](https://github.com/Azure-Samples/get-started-with-ai-chat) | ใช้ความเข้าใจการสนทนาขั้นสูงเพื่อสร้างและปรับปรุงแชทบอทและเอเจนต์ด้วยเวิร์กโฟลว์ที่กำหนดและควบคุมโดยมนุษย์ |⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Azure Storage + Azure Container Registry|  
...
### ห้องปฏิบัติการและเวิร์กช็อป  
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - **ใหม่**: ทำให้โซลูชัน AI ของคุณสามารถปรับใช้ด้วย AZD  
- [**AZD For Beginners Workshop**](workshop/README.md) - มุ่งเน้นไปที่การปรับใช้เทมเพลต AZD สำหรับ AI Agents  
...
- [**Study Guide**](resources/study-guide.md) - วัตถุประสงค์การเรียนรู้และแบบฝึกหัดที่ครอบคลุม  
...
- **ปัญหา**: [รายงานข้อบกพร่องและคำขอฟีเจอร์](https://github.com/microsoft/azd-for-beginners/issues)  
- **การสนทนา**: [ชุมชน Microsoft Azure Discord Q&A และการสนทนา](https://discord.gg/microsoft-azure)  
- **การสนับสนุนเฉพาะ AI**: เข้าร่วม [#Azure channel](https://discord.gg/microsoft-azure) สำหรับการสนทนา AZD + AI Foundry  
...
- **สิ่งที่ร้องขอมากที่สุด**: เทมเพลตเฉพาะ AI คู่มือการแก้ไขปัญหา แนวทางปฏิบัติที่ดีที่สุด  
...
- มีอิทธิพลต่อการพัฒนา AI + AZD ในอนาคต  
...
ทีมของเราผลิตหลักสูตรอื่น ๆ! ดูเพิ่มเติม:  
...
**การนำทาง**  
- **บทเรียนถัดไป**: [AZD Basics](docs/getting-started/azd-basics.md)  
