...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T22:44:27+00:00",
  "source_file": "resources/cheat-sheet.md",
  "language_code": "th"
}
-->
# ชีทคำสั่ง - คำสั่ง AZD ที่สำคัญ

## บทนำ

ชีทคำสั่งนี้รวบรวมคำสั่ง Azure Developer CLI ที่ใช้บ่อยที่สุด โดยจัดหมวดหมู่พร้อมตัวอย่างการใช้งาน เหมาะสำหรับการค้นหาอย่างรวดเร็วระหว่างการพัฒนา การแก้ไขปัญหา และการดำเนินงานประจำวันในโปรเจกต์ azd
...
- ค้นหาตัวเลือกการตั้งค่าและการปรับแต่งขั้นสูงได้อย่างมีประสิทธิภาพ
...
- ใช้ฟีเจอร์ azd ขั้นสูงและตัวเลือกการตั้งค่าเมื่อจำเป็น
