...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T21:58:37+00:00",
  "source_file": "workshop/README.md",
  "language_code": "th"
}
-->
# AZD สำหรับเวิร์กช็อปนักพัฒนาปัญญาประดิษฐ์

**ก่อนหน้า:** [AI Troubleshooting Guide](../docs/troubleshooting/ai-troubleshooting.md) | **ถัดไป:** [Workshop Lab Modules](../../../workshop)

ยินดีต้อนรับสู่เวิร์กช็อปแบบลงมือปฏิบัติสำหรับการเรียนรู้ Azure Developer CLI (AZD) โดยเน้นการปรับใช้แอปพลิเคชัน AI เวิร์กช็อปนี้ออกแบบมาเพื่อพาคุณจากพื้นฐานของ AZD ไปจนถึงการปรับใช้โซลูชัน AI ที่พร้อมใช้งานในระดับการผลิต

## ภาพรวมของเวิร์กช็อป

**ระยะเวลา:** 2-3 ชั่วโมง  
**ระดับ:** ผู้เริ่มต้นถึงระดับกลาง  
**ข้อกำหนดเบื้องต้น:** ความรู้พื้นฐานเกี่ยวกับ Azure, เครื่องมือบรรทัดคำสั่ง และแนวคิดเกี่ยวกับ AI

### สิ่งที่คุณจะได้เรียนรู้

- **พื้นฐานของ AZD**: ทำความเข้าใจ Infrastructure as Code ด้วย AZD
...
- **แลป**: ปรับใช้แอปพลิเคชันแชทด้วย GPT-4
...
- **แลป**: ปรับใช้ในระดับการผลิตพร้อมการสังเกตการณ์
...
เรียกใช้สคริปต์นี้เพื่อยืนยันการตั้งค่าของคุณ:
...
## วัสดุสำหรับเวิร์กช็อป

### การฝึกปฏิบัติในแลป

แต่ละโมดูลมีแลปแบบลงมือปฏิบัติพร้อมโค้ดเริ่มต้นและคำแนะนำทีละขั้นตอน:
...
### ตัวเลือกที่ 3: เวิร์กช็อปที่มีผู้สอน

หากคุณเข้าร่วมเซสชันที่มีผู้สอน:
...
✅ **ตั้งค่าบริการ Azure OpenAI** ด้วยความปลอดภัยที่เหมาะสม  
...
2. **การผสาน CI/CD**: ตั้งค่า [GitHub Actions workflows](../docs/deployment/github-actions.md)  
...
- 📝 **เขียนบล็อกโพสต์** เกี่ยวกับการเดินทางปรับใช้ AI ของคุณ  
