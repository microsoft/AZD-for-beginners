...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:49:40+00:00",
...
**Anterior:** [Guia de Resolução de Problemas de IA](../docs/troubleshooting/ai-troubleshooting.md) | **Próximo:** [Módulos do Workshop](../../../workshop)

Bem-vindo ao workshop prático para aprender a CLI do Azure Developer (AZD) com foco na implementação de aplicações de IA. Este workshop foi projetado para levar você dos fundamentos do AZD até a implementação de soluções de IA prontas para produção.
...
- **Implementação em Contêineres**: Usar Azure Container Apps para aplicações de IA
- **Melhores Práticas de Segurança**: Implementar Identidade Gerenciada e configurações seguras
- **Monitoramento e Observabilidade**: Configurar Application Insights para cargas de trabalho de IA
...
- **[Práticas de IA em Produção](../docs/ai-foundry/production-ai-practices.md)** - Padrões de implementação para empresas
...
✅ **Configurar serviços Azure OpenAI** com segurança adequada  
✅ **Construir aplicações RAG** com integração ao Azure AI Search  
✅ **Aplicar padrões de produção** para cargas de trabalho de IA empresariais  
✅ **Monitorar e solucionar problemas** em implementações de aplicações de IA  
...
- **Problemas no GitHub**: [Relatar problemas com modelos](https://github.com/YOUR_ORG/AZD-for-beginners/issues)  
...
1. **Cenários Avançados**: Explore [implementações em múltiplas regiões](../docs/ai-foundry/production-ai-practices.md#multi-region-deployment)  
2. **Integração com CI/CD**: Configure [fluxos de trabalho com GitHub Actions](../docs/deployment/github-actions.md)  
...
2. **Modelos**: Comece com nossos [modelos específicos para IA](../../../workshop/templates)  
3. **Suporte**: Participe do [Discord Azure AI Foundry](https://aka.ms/foundry/discord)  

### Compartilhe Seu Sucesso

- ⭐ **Dê uma estrela ao repositório** se este workshop foi útil para você  
