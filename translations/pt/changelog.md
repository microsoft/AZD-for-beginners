...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:49:11+00:00",
...
Este changelog documenta todas as alterações, atualizações e melhorias notáveis no repositório AZD Para Iniciantes. Seguimos os princípios de versionamento semântico e mantemos este registo para ajudar os utilizadores a compreenderem o que mudou entre as versões.

## Objetivos de Aprendizagem

Ao rever este changelog, irá:
- Manter-se informado sobre novas funcionalidades e adições de conteúdo
- Compreender melhorias feitas na documentação existente
...
**Esta versão introduz materiais abrangentes de workshop com guias interativos baseados no navegador e percursos de aprendizagem estruturados.**

#### Adicionado
- **🎥 Guia Interativo de Workshop**: Experiência de workshop no navegador com capacidade de pré-visualização MkDocs
- **📝 Instruções Estruturadas de Workshop**: Percurso de aprendizagem guiado em 7 passos, desde a descoberta até à personalização
...
- **🛠️ Ferramentas de Workshop**: Configuração MkDocs com tema Material para uma experiência de aprendizagem melhorada
- **🎯 Percurso de Aprendizagem Prático**: Metodologia de 3 passos (Descoberta → Implementação → Personalização)
- **📱 Integração com GitHub Codespaces**: Configuração de ambiente de desenvolvimento sem complicações

#### Melhorado
- **Laboratório de Workshop AI**: Expandido com uma experiência de aprendizagem estruturada de 2-3 horas
- **Documentação de Workshop**: Apresentação profissional com navegação e recursos visuais
...
#### Aperfeiçoado
- **Acessibilidade**: Interface baseada no navegador com pesquisa, funcionalidade de copiar e alternância de tema
- **Aprendizagem ao Ritmo Próprio**: Estrutura flexível de workshop que acomoda diferentes velocidades de aprendizagem
...
- **Copiar Blocos de Código**: Funcionalidade de copiar ao passar o cursor sobre exemplos de código
- **Alternância de Tema**: Suporte para modo claro/escuro conforme preferências
...
**Esta versão introduz uma estrutura de aprendizagem baseada em capítulos com navegação melhorada em todo o repositório.**

#### Adicionado
- **📚 Sistema de Aprendizagem Baseado em Capítulos**: Curso reestruturado em 8 capítulos progressivos de aprendizagem
...
- **Navegação na Documentação**: Cada página agora inclui contexto do capítulo e orientação de progressão
- **Organização de Templates**: Exemplos e templates mapeados para capítulos de aprendizagem apropriados
- **Integração de Recursos**: Resumos, FAQs e guias de estudo conectados a capítulos relevantes
- **Integração de Workshops**: Laboratórios práticos mapeados para objetivos de aprendizagem de múltiplos capítulos
...
#### Aperfeiçoado
- **Experiência do Utilizador**: Navegação clara com indicadores de progressão de capítulos
...
- **Eficiência de Aprendizagem**: Redução do tempo para encontrar conteúdo relevante através de organização melhorada

#### Implementação Técnica
- **Cabeçalhos de Navegação**: Navegação padronizada por capítulos em mais de 40 ficheiros de documentação
- **Rodapé de Navegação**: Orientação consistente de progressão e indicadores de conclusão de capítulos
- **Ligação Cruzada**: Sistema abrangente de ligação interna conectando conceitos relacionados
...
**Esta versão melhora a solução de retalho multi-agente com melhor nomenclatura de agentes e documentação aprimorada.**
...
- **Consistência na Documentação**: Garantido que todas as referências utilizam nomes de agentes profissionais e descritivos

#### Melhorado
- **Pacote de Templates ARM**: Template retail-multiagent-arm-template atualizado com referências ao agente Cliente
- **Diagramas de Arquitetura**: Diagramas Mermaid renovados com nomenclatura de agente atualizada
...
- **Materiais de Aprendizagem**: Nomenclatura de agentes mais intuitiva para fins educacionais
- **Usabilidade de Templates**: Compreensão simplificada das funções dos agentes e padrões de implementação
...
- Comandos de implementação e configurações de contêiner renovados

### [v3.0.0] - 2025-09-12

#### Alterações Principais - Foco em Desenvolvedores AI e Integração com Azure AI Foundry
...
#### Adicionado
- **🤖 Percurso de Aprendizagem AI-First**: Reestruturação completa priorizando desenvolvedores e engenheiros de AI
- **Guia de Integração Azure AI Foundry**: Documentação abrangente para conectar AZD com serviços Azure AI Foundry
- **Padrões de Implementação de Modelos AI**: Guia detalhado sobre seleção de modelos, configuração e estratégias de implementação em produção
- **Laboratório de Workshop AI**: Workshop prático de 2-3 horas para converter aplicações AI em soluções implementáveis com AZD
- **Melhores Práticas de Produção AI**: Padrões prontos para empresas para escalar, monitorizar e proteger cargas de trabalho AI
- **Guia de Resolução de Problemas AI**: Resolução abrangente de problemas para Azure OpenAI, Cognitive Services e questões de implementação AI
...
#### Melhorado
- **Estrutura do README**: Focado em desenvolvedores AI com 45% de dados de interesse comunitário do Discord Azure AI Foundry
...
- **Integração Comunitária**: Suporte comunitário melhorado no Discord com canais e discussões específicas de AI

#### Foco em Segurança e Produção
- **Padrões de Identidade Gerida**: Configurações de autenticação e segurança específicas de AI
- **Otimização de Custos**: Rastreamento de uso de tokens e controlos de orçamento para cargas de trabalho AI
- **Implementação Multi-Região**: Estratégias para implementação global de aplicações AI
- **Monitorização de Desempenho**: Métricas específicas de AI e integração com Application Insights

#### Qualidade da Documentação
- **Estrutura de Curso Linear**: Progressão lógica de conceitos básicos para padrões avançados de implementação AI
...
- **Pronto para Produção**: Padrões de implementação empresariais com exemplos reais

### [v2.0.0] - 2025-09-09

#### Alterações Principais - Reestruturação do Repositório e Aperfeiçoamento Profissional
**Esta versão representa uma revisão significativa na estrutura do repositório e apresentação de conteúdo.**
...
- **Sistema de Navegação**: Adicionados links de lição anterior/próxima em toda a documentação para progressão guiada de aprendizagem
- **Guia de Estudo**: Guia de estudo abrangente com objetivos de aprendizagem, exercícios práticos e materiais de avaliação
...
#### Alterado
- **Formato da Documentação**: Padronização de toda a documentação com estrutura consistente focada na aprendizagem
- **Fluxo de Navegação**: Implementação de progressão lógica em todos os materiais de aprendizagem
- **Apresentação de Conteúdo**: Remoção de elementos decorativos em favor de formatação clara e profissional
...
- **Aparência Profissional**: Apresentação limpa, estilo académico, adequada para aprendizagem empresarial
...
- **Módulo de Introdução**
  - Fundamentos AZD: Conceitos e terminologia principais
  - Guia de Instalação: Instruções de configuração específicas da plataforma
...
- **Módulo de Validação Pré-Implementação**
  - Planeamento de Capacidade: Validação de disponibilidade de recursos Azure
...
- **Recursos e Referências**
  - Resumo de Comandos: Referência rápida para comandos essenciais
...
- **Exemplos e Templates**
  ...
  - Template de implementação de Website Estático
...
- **Vários Níveis de Competência**: Conteúdo projetado para estudantes e programadores profissionais  
...
- **Gestão Abrangente de Erros**: Soluções para problemas comuns  
...
- **Observabilidade de IA**: Monitorização melhorada para desempenho de modelos, uso de tokens e qualidade de respostas  

#### Experiência do Desenvolvedor  
- **Extensão para VS Code**: Experiência de desenvolvimento integrada AZD + AI Foundry  
...
- **Implementação de IA na Periferia**: Integração com Azure IoT Edge e instâncias de contentores  
- **IA em Nuvem Híbrida**: Padrões de implementação multi-nuvem e híbrida para cargas de trabalho de IA  
...
- **Otimização de Desempenho**: Estratégias avançadas de ajuste e escalabilidade para aplicações de IA de alto desempenho  
...
- **Integração de Ferramentas**: Guias melhorados para integração com IDEs e editores  
...
- **Integração Melhorada com IDEs**: Extensão para VS Code para fluxos de trabalho AZD + IA  
- **Painel da Comunidade**: Métricas em tempo real e acompanhamento de contribuições da comunidade  
...
- Reestruturação substancial de conteúdo ou organização  
...
- **Discussões no Discord**: Partilhar ideias e interagir com a comunidade do Azure AI Foundry  
- **Pull Requests**: Contribuir com melhorias diretas para o conteúdo, especialmente modelos e guias de IA  
- **Discord do Azure AI Foundry**: Participar no canal #Azure para discussões sobre AZD + IA  
- **Fóruns da Comunidade**: Participar em discussões mais amplas de programadores do Azure  

### Categorias de Feedback  
- **Precisão do Conteúdo de IA**: Correções para integração e implementação de serviços de IA  
...
- **Integração de Ferramentas de IA**: Sugestões para melhorar o fluxo de trabalho de desenvolvimento de IA  
- **Padrões de IA em Produção**: Pedidos de padrões de implementação empresarial de IA  
