...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T19:26:04+00:00",
...
Siga estes passos para iniciar a sua jornada de aprendizagem com o AZD:

1. **Faça um Fork do Repositório**: Clique em [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Clone o Repositório**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **Junte-se à Comunidade**: [Comunidades Azure no Discord](https://discord.com/invite/ByRwuEEgH4) para suporte especializado
...
Domine o Azure Developer CLI (azd) através de capítulos estruturados para uma aprendizagem progressiva. **Foco especial na implementação de aplicações de IA com integração ao Microsoft Foundry.**
...
- **Implementar Infraestrutura como Código**: Gerir recursos do Azure com templates Bicep
...
**Pré-requisitos**: Assinatura Azure, conhecimentos básicos de linha de comando  
...
**💡 Resultado do Capítulo**: Implementar com sucesso uma aplicação web simples no Azure usando o AZD
...
azd up                  # Faz a implementação no Azure
...
**📊 Tempo de Investimento:** 30-45 minutos  
**📈 Nível de Habilidade Após:** Capaz de implementar aplicações básicas de forma independente
...
#### Recursos de Aprendizagem
- **🎯 Comece Aqui**: [Integração com o Microsoft Foundry](docs/microsoft-foundry/microsoft-foundry-integration.md)
- **📖 Padrões**: [Implementação de Modelos de IA](docs/microsoft-foundry/ai-model-deployment.md) - Implementar e gerir modelos de IA
...
- **📝 Exemplos**: [Exemplos de Implementação com AZD](examples/README.md)
...
**📊 Tempo de Investimento:** 1-2 horas  
**📈 Nível de Habilidade Após:** Capaz de implementar e configurar aplicações de IA prontas para produção  
...
- Use o **Plano Gratuito** do Azure OpenAI para aprendizagem (50,000 tokens/mês incluídos)
- Execute `azd down` para desalocar recursos quando não estiver a desenvolver ativamente
- Comece com faturação baseada em consumo, atualize para PTU apenas para produção
- Use `azd provision --preview` para estimar custos antes da implementação
- Ative a auto-escalabilidade: pague apenas pelo uso real
...
- **📝 Exemplos**: [Exemplo de Aplicação com Base de Dados](examples/database-app/README.md) - Exemplos de bases de dados com AZD

#### Exercícios Práticos
- Configurar múltiplos ambientes (desenvolvimento, staging, produção)
...
- **📝 Exemplos**: [Exemplo de Aplicação em Container](../../examples/container-app) - Implementações em containers
...
#### Exercícios Práticos
```bash
# Implementar a solução completa de múltiplos agentes para retalho
...
**💡 Resultado do Capítulo**: Implementar aplicações prontas para empresas com capacidades completas de produção
...
> Os materiais do workshop estão atualmente em desenvolvimento e refinamento. Os módulos principais estão funcionais, mas algumas secções avançadas estão incompletas. Estamos a trabalhar ativamente para concluir todo o conteúdo. [Acompanhar progresso →](workshop/README.md)
...
Os materiais do workshop oferecem uma experiência de aprendizagem estruturada e interativa que complementa o currículo baseado nos capítulos acima. O workshop foi concebido tanto para aprendizagem autónoma como para sessões lideradas por instrutores.

#### 🛠️ Funcionalidades do Workshop
- **Interface Baseada no Navegador**: Workshop alimentado por MkDocs com pesquisa, cópia e funcionalidades de tema
...
- **Implementar Aplicações de IA em Produção**: Usar AZD com serviços do Microsoft Foundry
...
- **Resolver Problemas de Implementação**: Resolver problemas comuns de forma independente
...
O Azure Developer CLI (azd) é uma interface de linha de comandos centrada no desenvolvedor que acelera o processo de criação e implementação de aplicações no Azure. Oferece:

- **Implementações baseadas em templates** - Usar templates pré-construídos para padrões de aplicação comuns
...
**Por que usar AZD para Soluções de IA?** O AZD aborda os principais desafios enfrentados pelos desenvolvedores de IA:
...
- **Workflows de IA de Ponta a Ponta** - Desde o desenvolvimento do modelo até a implementação em produção com monitorização adequada
- **Otimização de Custos** - Estratégias inteligentes de alocação e escalabilidade de recursos para cargas de trabalho de IA
- **Integração com Microsoft Foundry** - Conexão perfeita ao catálogo de modelos e endpoints do Microsoft Foundry
...
> **Nota:** Estes templates demonstram vários padrões de IA. Alguns são exemplos externos do Azure, outros são implementações locais.

| Template | Capítulo | Complexidade | Serviços | Tipo |
|----------|---------|------------|----------|------|
| [**Começar com Chat de IA**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 2 | ⭐⭐ | AzureOpenAI + API de Inferência de Modelos de IA do Azure + Pesquisa de IA do Azure + Aplicações de Contêiner do Azure + Application Insights | Externo |
| [**Começar com Agentes de IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Capítulo 2 | ⭐⭐ | Serviço de Agentes de IA do Azure + AzureOpenAI + Pesquisa de IA do Azure + Aplicações de Contêiner do Azure + Application Insights| Externo |
| [**Demo de Pesquisa do Azure + OpenAI**](https://github.com/Azure-Samples/azure-search-openai-demo) | Capítulo 2 | ⭐⭐ | AzureOpenAI + Pesquisa de IA do Azure + App Service + Armazenamento | Externo |
| [**Início Rápido de App de Chat OpenAI**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Capítulo 2 | ⭐ | AzureOpenAI + Aplicações de Contêiner + Application Insights | Externo |
...
| [**Contoso Chat RAG**](https://github.com/Azure-Samples/contoso-chat) | Capítulo 8 | ⭐⭐⭐⭐ | AzureOpenAI + Pesquisa de IA + Cosmos DB + Aplicações de Contêiner | Externo |
| [**Solução Multi-Agente para Retalho**](examples/retail-scenario.md) | Capítulo 5 | ⭐⭐⭐⭐ | AzureOpenAI + Pesquisa de IA + Armazenamento + Aplicações de Contêiner + Cosmos DB | **Local** |
...
#### Exemplos Locais - Aplicações de Contêiner (Capítulos 2-5)
**Exemplos abrangentes de implementação de contêineres neste repositório:**
- [**Exemplos de Aplicações de Contêiner**](examples/container-app/README.md) - Guia completo para implementações em contêineres
  ...
  - Padrões de implementação Rápida, Produção e Avançada
...
- [Aplicação de Contêiner - Python Flask](https://github.com/Azure-Samples/container-apps-store-api-microservice) - Implementação de API REST

#### Exemplos Externos - Integração com Base de Dados (Capítulo 3-4)  
- [Aplicação com Base de Dados - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - Padrões de conectividade com base de dados
...
- [Jobs em Aplicações de Contêiner](https://github.com/Azure-Samples/container-apps-jobs) - Processamento em segundo plano  
...
### Workshops Práticos
- [**Laboratório de Workshop de IA**](docs/microsoft-foundry/ai-workshop-lab.md) - Torne as suas soluções de IA prontas para implantação com AZD (2-3 horas)
- [**Guia Interativo de Workshop**](workshop/README.md) - Workshop baseado em navegador com MkDocs e Ambiente DevContainer
- [**Caminho de Aprendizagem Estruturado**](../../workshop/docs/instructions) - Exercícios guiados em 7 etapas (Descoberta → Implantação → Personalização)
...
# Ou utilize SKUs menores em desenvolvimento
...
# Tente novamente com um ambiente novo
azd env new dev-v2
azd up
```
...
# Se estiver bloqueado >30 minutos, verificar o Portal Azure:
azd monitor
# Procurar por implementações falhadas
```
...
# Necessita pelo menos do papel de "Colaborador"
...
### ❌ Não consegue encontrar o URL da aplicação implantada
...
- [ ] **Capítulo 6**: Validação Pré-Implantação e Planeamento ✅
- [ ] **Capítulo 7**: Resolução de Problemas e Depuração ✅
- [ ] **Capítulo 8**: Padrões de Produção e Empresariais ✅
...
2. **Verificação de Conhecimento**: Revise a seção de FAQ do capítulo
...
- **Problemas Técnicos**: [Relatar erros e solicitar funcionalidades](https://github.com/microsoft/azd-for-beginners/issues)
...
- **Principais desafios**: Implantação de múltiplos serviços, gestão de credenciais, prontidão para produção  
- **Mais solicitado**: Templates específicos de IA, guias de resolução de problemas, melhores práticas

**Junte-se à nossa comunidade para:**
- Partilhar as suas experiências com AZD + IA e obter ajuda
- Aceder a pré-visualizações antecipadas de novos templates de IA
...
- **Relatórios de Erros**: Melhorar precisão e clareza
...
[![Desenvolvimento XR para Principiantes](https://img.shields.io/badge/Desenvolvimento%20XR%20para%20Principiantes-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
...
**Principiantes**: Comece com [Capítulo 1: Fundamentos e Início Rápido](../..)  
**Desenvolvedores de IA**: Avance para [Capítulo 2: Desenvolvimento com Foco em IA](../..)  
**Desenvolvedores Experientes**: Inicie com [Capítulo 3: Configuração e Autenticação](../..)
