...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T14:24:38+00:00",
...
Siga estes passos para iniciar a sua jornada de aprendizagem do AZD:

1. **Faça fork do Repositório**: Clique [![Forks do GitHub](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Clone o Repositório**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **Junte-se à Comunidade**: [Comunidades Discord Azure](https://discord.com/invite/ByRwuEEgH4) para suporte de especialistas
...
Domine o Azure Developer CLI (azd) através de capítulos estruturados concebidos para uma aprendizagem progressiva. **Foco especial na implantação de aplicações de IA com integração Microsoft Foundry.**

### Porque é que este Curso é Essencial para Desenvolvedores Modernos

Com base em perceções da comunidade do Discord do Microsoft Foundry, **45% dos desenvolvedores querem usar o AZD para cargas de trabalho de IA** mas enfrentam desafios com:
...
- **Otimizar para Produção**: Segurança, dimensionamento, monitorização e gestão de custos
...
azd version              # Mostra a versão instalada
azd init --template todo-nodejs-mongo  # Inicializa o projeto
azd up                  # Faz deploy para o Azure
azd show                # Mostra a URL da aplicação em execução
# A aplicação abre no navegador e funciona
azd down --force --purge  # Limpa os recursos
```
...
- **📖 Padrões**: [Implantação de Modelos de IA](docs/microsoft-foundry/ai-model-deployment.md) - Implantar e gerir modelos de IA
- **🛠️ Workshop**: [Laboratório do Workshop de IA](docs/microsoft-foundry/ai-workshop-lab.md) - Preparar as suas soluções de IA para AZD
- **🎥 Guia Interativo**: [Materiais do Workshop](workshop/README.md) - Aprendizagem baseada no navegador com MkDocs * DevContainer Environment
...
**💡 Resultado do Capítulo**: Implantar e configurar uma aplicação de chat potenciadas por IA com capacidades RAG
...
**💰 Consciência de Custos:** Compreender custos de desenvolvimento de $80-150/mês, custos de produção de $300-3500/mês
...
- Azure OpenAI (PTU para desempenho consistente): $3,000+/mês OU Pay-as-you-go com elevado volume
...
- Use a **Camada Gratuita** do Azure OpenAI para aprendizagem (50.000 tokens/mês incluídos)
...
- Ative o autoescalamento: pague apenas pelo uso efetivo
...
- **🔐 Segurança**: [Padrões de autenticação e managed identity](docs/getting-started/authsecurity.md) - Padrões de autenticação
- **📝 Exemplos**: [Exemplo de Aplicação com Base de Dados](examples/database-app/README.md) - Exemplos de Base de Dados AZD

#### Exercícios Práticos
- Configurar múltiplos ambientes (dev, staging, prod)
- Configurar autenticação com managed identity
...
#### Recursos de Aprendizagem
- **📖 Implantação**: [Guia de Implantação](docs/deployment/deployment-guide.md) - Workflows completos
- **🏗️ Provisionamento**: [Provisionamento de Recursos](docs/deployment/provisioning.md) - Gestão de recursos Azure
- **📝 Exemplos**: [Exemplo Container App](../../examples/container-app) - Implantações conteinerizadas
...
- **🛠️ ARM Templates**: [Pacote de Modelos ARM](../../examples/retail-multiagent-arm-template) - Implementação com um clique
- **📖 Arquitetura**: [Padrões de coordenação multiagente](/docs/pre-deployment/coordination-patterns.md) - Padrões

#### Exercícios Práticos
```bash
# Implantar a solução multiagente completa de retalho
...
**💡 Resultado do Capítulo**: Implantar e gerir uma solução de IA multiagente pronta para produção com agentes de Cliente e Inventário
...
- **💰 Seleção**: [Seleção de SKU](docs/pre-deployment/sku-selection.md) - Opções rentáveis
...
- Otimizar a seleção de SKUs para reduzir custos
...
**💡 Resultado do Capítulo**: Implementar aplicações preparadas para empresas com capacidades completas de produção
...
> Os materiais do workshop estão atualmente a ser desenvolvidos e refinados. Os módulos principais estão funcionais, mas algumas secções avançadas estão incompletas. Estamos a trabalhar ativamente para completar todo o conteúdo. [Acompanhar o progresso →](workshop/README.md)
...
Os materiais do workshop fornecem uma experiência de aprendizagem estruturada e interativa que complementa o currículo por capítulos acima. O workshop foi concebido tanto para aprendizagem em ritmo próprio como para sessões orientadas por um instrutor.

#### 🛠️ Funcionalidades do Workshop
- **Interface Baseada no Navegador**: Workshop completo baseado em MkDocs com funcionalidades de pesquisa, cópia e temas
...
1. **Fase de Descoberta** (45 minutos)
   - Explorar modelos e serviços do Microsoft Foundry
...
#### 🚀 Como Começar no Workshop
```bash
# Opção 1: GitHub Codespaces (Recomendado)
# Clique em "Code" → "Criar codespace no ramo main" no repositório
...
- **Implementar Aplicações de IA em Produção**: Usar AZD com os serviços Microsoft Foundry
...
- **Otimizar para Escala**: Desenhar implementações eficientes e com boa relação custo-desempenho
- **Resolução de Problemas em Implementações**: Resolver problemas comuns de forma independente
...
- **🛠️ Laboratório do Workshop de IA**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Exercícios focados em IA
- **💡 Início Rápido**: [Guia de Configuração do Workshop](workshop/README.md#quick-start) - Configuração do ambiente

**Ideal para**: Formação corporativa, cursos universitários, aprendizagem em ritmo próprio e bootcamps para desenvolvedores.

---

## 📖 O que é o Azure Developer CLI?

Azure Developer CLI (azd) é uma interface de linha de comandos centrada no desenvolvedor que acelera o processo de construção e implantação de aplicações para o Azure. Fornece:

- **Implementações baseadas em modelos** - Utilizar modelos pré-construídos para padrões comuns de aplicação
...
- **Orientado para o desenvolvedor** - Otimizado para produtividade e experiência do desenvolvedor

### **AZD + Microsoft Foundry: Perfeito para Implementações de IA**

**Porque usar AZD para Soluções de IA?** O AZD responde aos principais desafios que os desenvolvedores de IA enfrentam:
...
- **Padrões para IA em Produção** - Melhores práticas para implementações de aplicações de IA escaláveis e custo-efetivas
- **Fluxos de Trabalho de IA de Ponta a Ponta** - Desde o desenvolvimento do modelo até a implantação em produção com monitorização adequada
...
| [**Agente OpenAI Python Prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Azure Functions + Prompty | Externo |
...
| [**Solução Multiagente para Retalho**](examples/retail-scenario.md) | Capítulo 5 | ⭐⭐⭐⭐ | AzureOpenAI + AI Search + Storage + Container Apps + Cosmos DB | **Local** |
...
| Modelo | Capítulo de Aprendizagem | Complexidade | Aprendizagem Principal |
|----------|------------------|------------|--------------|
...
- [**Solução Multiagente para Retalho**](examples/retail-scenario.md) - Implementação completa pronta para produção com Modelos ARM
  - Arquitetura multiagente (agentes Cliente + Inventário)
  - Monitorização e avaliação abrangentes
  - Implementação com um clique via Modelo ARM
...
- [**Exemplos de Container App**](examples/container-app/README.md) - Guia completo para implantações em contentores
  ...
  - Início Rápido, Produção e padrões de implementação avançados
  - Monitorização, segurança e orientação para otimização de custos
...
### Colecções de Templates Externas
- [**Galeria Oficial de Templates AZD**](https://azure.github.io/awesome-azd/) - Colecção seleccionada de templates oficiais e da comunidade
...
- [**Guia do Workshop Interativo**](workshop/README.md) - Workshop baseado no navegador com MkDocs e ambiente DevContainer
- [**Caminho de Aprendizagem Estruturado**](../../workshop/docs/instructions) -7-step guided exercises (Discovery → Deployment → Customization)
- [**Workshop AZD para Principiantes**](workshop/README.md) - Materiais completos do workshop prático com integração GitHub Codespaces
...
- Aplicações de IA: 15-25 minutos (o aprovisionamento do OpenAI é lento)

```bash
# Verificar progresso
azd show

# Se estiver preso >30 minutos, verifique o Portal do Azure:
azd monitor
...
# Peça ao seu administrador do Azure que conceda:
...
# Se ficar preso mais de 30 minutos, verifique o Portal do Azure:
azd monitor
...
2. **Verificação de Conhecimentos**: Reveja a secção de FAQ do capítulo
...
- **Experiência em Produção**: Implantação de aplicações reais de IA no Azure
...
- **Questões de Aprendizagem**: [Comunidade Microsoft Azure Discord](https://discord.gg/microsoft-azure) and [![Discord da Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
- **Ajuda Específica para IA**: Join the [![Discord da Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
### Perspetivas da Comunidade do Discord da Microsoft Foundry
...
- Influenciar o desenvolvimento de futuras funcionalidades IA + AZD
...
- **Normas da Comunidade**: Siga as nossas diretrizes de comunidade inclusivas
...
### Licença
Este projeto está licenciado ao abrigo da Licença MIT - consulte o [LICENSE](../../LICENSE) ficheiro para detalhes.
