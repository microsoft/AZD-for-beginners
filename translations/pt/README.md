...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:46:52+00:00",
...
Com base em insights da comunidade Discord do Azure AI Foundry, **45% dos desenvolvedores querem usar AZD para cargas de trabalho de IA**, mas enfrentam desafios com:
...
- **📖 Teoria**: [Fundamentos do AZD](docs/getting-started/azd-basics.md) - Conceitos principais e terminologia
...
#### Recursos de Aprendizagem
- **🏭 Produção**: [Práticas de IA em Produção](docs/ai-foundry/production-ai-practices.md) - Padrões empresariais
...
Os materiais do workshop oferecem uma experiência de aprendizagem estruturada e interativa que complementa o currículo baseado em capítulos acima. O workshop foi concebido tanto para aprendizagem autónoma como para sessões lideradas por instrutores.
...
- **Infraestrutura como Código** - Gerir recursos do Azure utilizando Bicep ou Terraform  
...
| [**Automação de workflow multi-agente**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Serviço de Agentes do Azure AI + Kernel Semântico + Azure CosmosDB + Azure Container Apps|
...
| [**Construir o teu agente conversacional**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 4 | ⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Azure Storage + Azure Container Registry|
...
- [Aplicações em Container](../../examples/container-app) - Implementações containerizadas
...
- [**Templates AZD Azure-Samples**](https://github.com/Azure-Samples/azd-templates) - Exemplos oficiais da Microsoft
...
Após completar cada capítulo, verifica o teu conhecimento através de:
1. **Exercício Prático**: Completa a implementação prática do capítulo
2. **Verificação de Conhecimento**: Revê a secção FAQ do capítulo
...
Ao completar todos os capítulos, terás:
...
- **Avanço na Carreira**: Expertise em AZD e implementação de IA em alta demanda
...
**Programadores Experientes**: Inicie com [Capítulo 3: Configuração e Autenticação](../..)  
