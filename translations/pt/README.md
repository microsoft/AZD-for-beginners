...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:28:08+00:00",
...
- **📖 Padrões**: [Implementação de Modelos de IA](docs/ai-foundry/ai-model-deployment.md) - Gerenciar e implementar modelos de IA
- **🛠️ Workshop**: [Laboratório de IA](docs/ai-foundry/ai-workshop-lab.md) - Prepare suas soluções de IA para AZD
- **🎥 Guia Interativo**: [Materiais do Workshop](workshop/README.md) - Aprendizagem baseada em navegador com MkDocs * Ambiente DevContainer
...
**💡 Resultado do Capítulo**: Implementar e configurar uma aplicação de chat com IA utilizando capacidades RAG
...
- **🏗️ Provisionamento**: [Provisionamento de Recursos](docs/deployment/provisioning.md) - Gestão de recursos do Azure
...
Os materiais do workshop oferecem uma experiência de aprendizagem estruturada e interativa que complementa o currículo baseado em capítulos acima. O workshop foi concebido tanto para aprendizagem autónoma como para sessões orientadas por instrutores.

#### 🛠️ Funcionalidades do Workshop
- **Interface Baseada no Navegador**: Workshop completo com MkDocs, incluindo pesquisa, cópia e funcionalidades de tema
...
O workshop segue uma metodologia de **Descoberta → Implementação → Personalização**:

1. **Fase de Descoberta** (45 minutos)
   - Explorar modelos e serviços do Azure AI Foundry
...
- **Implementações baseadas em modelos** - Usar modelos pré-construídos para padrões comuns de aplicações
- **Infraestrutura como Código** - Gerir recursos do Azure com Bicep ou Terraform  
...
**Por que usar AZD para soluções de IA?** O AZD resolve os principais desafios enfrentados pelos desenvolvedores de IA:
...
- **Fluxos de Trabalho de IA de Ponta a Ponta** - Desde o desenvolvimento do modelo até à implementação em produção com monitorização adequada
...
### Destaque: Modelos do Azure AI Foundry
**Começa aqui se estás a implementar aplicações de IA!**

| Modelo | Capítulo | Complexidade | Serviços |
|----------|---------|------------|----------|
| [**Começar com Chat de IA**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 2 | ⭐⭐ | AzureOpenAI + API de Inferência de Modelos do Azure AI + Pesquisa do Azure AI + Azure Container Apps + Application Insights |
| [**Começar com Agentes de IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Capítulo 2 | ⭐⭐ | Serviço de Agentes do Azure AI + AzureOpenAI + Pesquisa do Azure AI + Azure Container Apps + Application Insights|
| [**Automação de Fluxo de Trabalho Multi-Agente**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Serviço de Agentes do Azure AI + Kernel Semântico + Azure CosmosDB + Azure Container Apps|
...
| [**Modernizar o teu Código com Agentes**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Serviço de Agentes + Kernel Semântico + Azure CosmosDB + Azure Container Apps|
| [**Construir o teu Agente Conversacional**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 4 | ⭐⭐⭐ | Linguagem de IA + AzureOpenAI + Pesquisa de IA + Armazenamento do Azure + Azure Container Registry|
| [**Desbloquear Insights de Dados Conversacionais**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 8 | ⭐⭐⭐ | AzureOpenAI + Pesquisa de IA + Kernel Semântico + Serviço de Agentes + Compreensão de Conteúdo de IA|
...
- [Processamento de Dados](../../examples/data-processing) - Implementação de fluxos de trabalho ETL

#### Padrões Avançados (Capítulos 4-8)
- [Aplicações em Contentores](../../examples/container-app) - Implementações contentorizadas
...
- [**Galeria Oficial de Modelos AZD**](https://azure.github.io/awesome-azd/) - Coleção curada de modelos oficiais e da comunidade
- [**Modelos do Azure Developer CLI**](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/azd-templates) - Documentação de modelos no Microsoft Learn
...
### Workshops Práticos
- [**Laboratório de IA do Workshop**](docs/ai-foundry/ai-workshop-lab.md) - Torna as tuas soluções de IA implementáveis com AZD (2-3 horas)
- [**Guia Interativo do Workshop**](workshop/README.md) - Workshop baseado no navegador com MkDocs e Ambiente DevContainer
- [**Caminho de Aprendizagem Estruturado**](../../workshop/docs/instructions) - 7 exercícios guiados (Descoberta → Implementação → Personalização)
...
Após concluir cada capítulo, verifica os teus conhecimentos:
1. **Exercício Prático**: Completa a implementação prática do capítulo
2. **Revisão de Conhecimentos**: Consulta a secção FAQ do capítulo
...
- **Competências Profissionais**: Capacidades de implementação prontas para empresas  
- **Reconhecimento na Comunidade**: Membro ativo da comunidade de desenvolvedores do Azure
- **Avanço na Carreira**: Competências em AZD e implementação de IA em alta procura
...
- **Dúvidas de Aprendizagem**: [Comunidade Discord da Microsoft Azure](https://discord.gg/microsoft-azure) e [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
- **Ajuda Específica de IA**: Junta-te ao [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
**Resultados Recentes de Sondagens no Canal #Azure:**
...
- **Mais solicitado**: Modelos específicos para IA, guias de resolução de problemas, melhores práticas

**Junta-te à nossa comunidade para:**
...
Agradecemos as suas contribuições! Por favor, leia o nosso [Guia de Contribuição](CONTRIBUTING.md) para obter detalhes sobre:  
...
- **Tradução**: Ajudar a manter o suporte a múltiplos idiomas  
- **Relatórios de Erros**: Melhorar a precisão e clareza  
- **Normas da Comunidade**: Seguir as nossas diretrizes inclusivas para a comunidade  
...
**Desenvolvedores Experientes**: Inicie com [Capítulo 3: Configuração & Autenticação](../..)  
