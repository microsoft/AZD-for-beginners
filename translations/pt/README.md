...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T22:32:49+00:00",
...
![AZD-for-beginners](../../translated_images/azdbeginners.5527441dd9f7406899cccfc907016b09f9370137543280d95f62ebf23637a2ee.pt.png) 
...
Domine o Azure Developer CLI (azd) através de capítulos estruturados concebidos para uma aprendizagem progressiva. **Foco especial na implementação de aplicações de IA com integração Microsoft Foundry.**
...
- **Resolver Problemas de Implementação**: Diagnosticar e corrigir problemas comuns
...
- **🛠️ Workshop**: [Laboratório de IA](docs/microsoft-foundry/ai-workshop-lab.md) - Prepare as suas soluções de IA para AZD
...
- Use o Azure OpenAI **Nível Gratuito** para aprendizagem (50.000 tokens/mês incluídos)
...
- Ative auto-escalamento: pague apenas pelo uso real
...
- **📝 Exemplos**: [Exemplo de Aplicação de Base de Dados](examples/database-app/README.md) - Exemplos AZD para bases de dados
...
- **📝 Exemplos**: [Exemplo de Container App](../../examples/container-app) - Implementações conteinerizadas
...
- **🛠️ ARM Templates**: [Pacote de Template ARM](../../examples/retail-multiagent-arm-template) - Implementação com um clique
...
Os materiais do workshop fornecem uma experiência de aprendizagem estruturada e interativa que complementa o currículo baseado em capítulos acima. O workshop é desenhado tanto para aprendizagem autónoma como para sessões conduzidas por instrutores.
...
- **Otimizar para Escalabilidade**: Projetar implementações custo-efetivas e performantes
...
Azure Developer CLI (azd) é uma interface de linha de comandos centrada no programador que acelera o processo de construção e implementação de aplicações no Azure. Fornece:
...
**Porquê AZD para Soluções de IA?** AZD resolve os principais desafios que os programadores de IA enfrentam:
...
- **Padrões de IA para Produção** - Melhores práticas para implementações escaláveis e custo-efetivas de aplicações de IA
...
- **Otimização de Custos** - Alocação inteligente de recursos e estratégias de escalabilidade para cargas de trabalho de IA
- **Integração com Microsoft Foundry** - Ligação perfeita ao catálogo de modelos e endpoints Microsoft Foundry
...
| [**Começar com agentes IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Capítulo 2 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights| Externo |
...
- [Aplicação de Base de Dados - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - Padrões de conectividade de base de dados
...
### Workshops Práticos
- [**Laboratório do Workshop de IA**](docs/microsoft-foundry/ai-workshop-lab.md) - Torne as suas soluções de IA implantáveis com AZD (2-3 horas)
...
- [**Workshop AZD para Iniciantes**](workshop/README.md) - Materiais completos de workshop prático com integração GitHub Codespaces
...
- Influenciar o desenvolvimento futuro de funcionalidades IA + AZD
...
- **Normas Comunitárias**: Siga as nossas diretrizes inclusivas da comunidade
