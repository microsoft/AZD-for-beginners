...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:47:43+00:00",
...
Com base nos insights da comunidade Discord do Azure AI Foundry, **45% dos desenvolvedores querem usar AZD para cargas de trabalho de IA**, mas enfrentam desafios com:
...
- **🛠️ Workshop**: [Laboratório de IA](docs/ai-foundry/ai-workshop-lab.md) - Prepare as suas soluções de IA para AZD
...
**💡 Resultado do Capítulo**: Implementar e configurar uma aplicação de chat com IA com capacidades RAG
...
- Fazer o deployment para produção com a devida governança  

**💡 Resultado do Capítulo**: Implementar aplicações empresariais prontas para produção com todas as capacidades necessárias  
...
Os materiais do workshop oferecem uma experiência de aprendizagem estruturada e interativa que complementa o currículo baseado em capítulos acima. O workshop foi projetado tanto para aprendizagem autodidata quanto para sessões lideradas por instrutores.  

#### 🛠️ Funcionalidades do Workshop  
- **Interface Baseada no Navegador**: Workshop completo com MkDocs, incluindo pesquisa, cópia e temas  
- **Integração com GitHub Codespaces**: Configuração do ambiente de desenvolvimento com um clique  
- **Caminho de Aprendizagem Estruturado**: 7 etapas de exercícios guiados (3,5 horas no total)  
- **Descoberta → Deployment → Personalização**: Metodologia progressiva  
- **Ambiente Interativo DevContainer**: Ferramentas e dependências pré-configuradas  

#### 📚 Estrutura do Workshop  
O workshop segue a metodologia **Descoberta → Deployment → Personalização**:  
...
1. **Fase de Descoberta** (45 min)  
   ...
   - Rever requisitos e pré-requisitos de deployment  

2. **Fase de Deployment** (2 horas)  
   - Deployment prático de aplicações de IA com AZD  
...
3. **Fase de Personalização** (45 min)  
   ...
   - Otimizar para deployment em produção  
...
- **Implementar Aplicações de IA em Produção**: Usar AZD com serviços do Azure AI Foundry  
...
- **Otimizar para Escalabilidade**: Projetar deployments eficientes e de alto desempenho  
- **Resolver Problemas de Deployment**: Solucionar problemas comuns de forma independente  
...
- **🛠️ Laboratório de IA do Workshop**: [Laboratório de IA](docs/ai-foundry/ai-workshop-lab.md) - Exercícios focados em IA  
- **💡 Início Rápido**: [Guia de Configuração do Workshop](workshop/README.md#quick-start) - Configuração do ambiente  

**Ideal para**: Formação corporativa, cursos universitários, aprendizagem autodidata e bootcamps para desenvolvedores.  

---

## 📖 O que é o Azure Developer CLI?  

O Azure Developer CLI (azd) é uma interface de linha de comando centrada no desenvolvedor que acelera o processo de criação e deployment de aplicações no Azure. Ele oferece:  

- **Deployments baseados em templates** - Use templates pré-construídos para padrões comuns de aplicações  
...
**Por que usar AZD para soluções de IA?** O AZD resolve os principais desafios enfrentados por desenvolvedores de IA:  

- **Templates Prontos para IA** - Templates pré-configurados para Azure OpenAI, Cognitive Services e workloads de ML  
- **Deployments de IA Seguros** - Padrões de segurança integrados para serviços de IA, chaves de API e endpoints de modelos  
- **Padrões de IA para Produção** - Melhores práticas para deployments escaláveis e econômicos de aplicações de IA  
- **Workflows de IA de Ponta a Ponta** - Desde o desenvolvimento do modelo até o deployment em produção com monitorização adequada  
- **Otimização de Custos** - Estratégias inteligentes de alocação e escalabilidade de recursos para workloads de IA  
- **Integração com Azure AI Foundry** - Conexão perfeita ao catálogo de modelos e endpoints do AI Foundry  
...
| [**Introdução a Agentes de IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Capítulo 2 | ⭐⭐ | Serviço de Agente do Azure AI + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights|  
| [**Automação de Workflow Multi-Agente**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Serviço de Agente do Azure AI + Semantic Kernel + Azure CosmosDB + Azure Container Apps|  
| [**Gerar Documentos a partir dos seus Dados**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 4 | ⭐⭐⭐  | AzureOpenAI + Azure AI Search + Serviços do Azure AI + Azure CosmosDB|  
| [**Melhorar Reuniões com Clientes usando Agentes**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐| AzureOpenAI + Azure AI Search + Azure CosmosDB + Base de Dados SQL do Azure |  
| [**Modernizar o Código com Agentes**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Serviço de Agente do Azure + Semantic Kernel + Azure CosmosDB + Azure Container Apps|  
| [**Construir o seu Agente Conversacional**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 4 | ⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Armazenamento do Azure + Azure Container Registry|  
| [**Desbloquear Insights a partir de Dados Conversacionais**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 8 | ⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Serviço de Agente do Azure + Compreensão de Conteúdo de IA|  
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | Capítulo 2 | ⭐⭐ | Implementação de RAG com Azure AI Search |  
...
- [Processamento de Dados](../../examples/data-processing) - Deployment de workflow ETL  

#### Padrões Avançados (Capítulos 4-8)  
- [Aplicações em Contêiner](../../examples/container-app) - Deployments containerizados  
...
### Workshops Práticos  
- [**Laboratório de IA do Workshop**](docs/ai-foundry/ai-workshop-lab.md) - Torne as suas soluções de IA compatíveis com AZD (2-3 horas)  
- [**Guia Interativo do Workshop**](workshop/README.md) - Workshop baseado no navegador com MkDocs e Ambiente DevContainer  
- [**Caminho de Aprendizagem Estruturado**](../../workshop/docs/instructions) - 7 etapas de exercícios guiados (Descoberta → Deployment → Personalização)  
- [**Workshop AZD para Iniciantes**](workshop/README.md) - Materiais completos para workshops práticos com integração ao GitHub Codespaces  
...
Após concluir cada capítulo, verifique o seu conhecimento:  
...
- **Competências Profissionais**: Capacidades de deployment prontas para o mercado  
- **Reconhecimento na Comunidade**: Membro ativo da comunidade de desenvolvedores do Azure  
- **Avanço na Carreira**: Competências em AZD e deployment de IA em alta demanda  
...
- **45%** dos desenvolvedores querem usar AZD para workloads de IA  
...
- **Padrões da Comunidade**: Siga as nossas diretrizes inclusivas da comunidade  
...
- [Aprendizagem Automática para Iniciantes](https://aka.ms/ml-beginners?WT.mc_id=academic-105485-koreyst)
...
**Iniciantes**: Começa com [Capítulo 1: Fundamentos e Início Rápido](../..)  
**Desenvolvedores de IA**: Avança para [Capítulo 2: Desenvolvimento com Foco em IA](../..)  
**Desenvolvedores Experientes**: Começa com [Capítulo 3: Configuração e Autenticação](../..)

**Próximos Passos**: [Inicia o Capítulo 1 - Conceitos Básicos do AZD](docs/getting-started/azd-basics.md) →
