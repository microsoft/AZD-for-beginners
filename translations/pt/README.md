...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T10:50:10+00:00",
...
![AZD-for-beginners](../../../../translated_images/pt/azdbeginners.5527441dd9f74068.webp) 
...
Siga estes passos para iniciar a sua jornada de aprendizagem com AZD:

1. **Faça Fork do Repositório**: Clique [![GitHub forks](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Clone o Repositório**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **Junte-se à Comunidade**: [Comunidades Azure Discord](https://discord.com/invite/ByRwuEEgH4) para apoio especializado
...
[Árabe](../ar/README.md) | [Bengali](../bn/README.md) | [Búlgaro](../bg/README.md) | [Birmanês (Myanmar)](../my/README.md) | [Chinês (Simplificado)](../zh/README.md) | [Chinês (Tradicional, Hong Kong)](../hk/README.md) | [Chinês (Tradicional, Macau)](../mo/README.md) | [Chinês (Tradicional, Taiwan)](../tw/README.md) | [Croata](../hr/README.md) | [Checo](../cs/README.md) | [Dinamarquês](../da/README.md) | [Holandês](../nl/README.md) | [Estónio](../et/README.md) | [Finlandês](../fi/README.md) | [Francês](../fr/README.md) | [Alemão](../de/README.md) | [Grego](../el/README.md) | [Hebraico](../he/README.md) | [Hindi](../hi/README.md) | [Húngaro](../hu/README.md) | [Indonésio](../id/README.md) | [Italiano](../it/README.md) | [Japonês](../ja/README.md) | [Kannada](../kn/README.md) | [Coreano](../ko/README.md) | [Lituano](../lt/README.md) | [Malaio](../ms/README.md) | [Malaiala](../ml/README.md) | [Marati](../mr/README.md) | [Nepali](../ne/README.md) | [Pidgin Nigeriano](../pcm/README.md) | [Norueguês](../no/README.md) | [Persa (Farsi)](../fa/README.md) | [Polaco](../pl/README.md) | [Português (Brasil)](../br/README.md) | [Português (Portugal)](./README.md) | [Punjabi (Gurmukhi)](../pa/README.md) | [Romeno](../ro/README.md) | [Russo](../ru/README.md) | [Servo (Cirílico)](../sr/README.md) | [Eslovaco](../sk/README.md) | [Esloveno](../sl/README.md) | [Espanhol](../es/README.md) | [Suaíli](../sw/README.md) | [Sueco](../sv/README.md) | [Tagalog (Filipino)](../tl/README.md) | [Tâmil](../ta/README.md) | [Telugu](../te/README.md) | [Tailandês](../th/README.md) | [Turco](../tr/README.md) | [Ucraniano](../uk/README.md) | [Urdu](../ur/README.md) | [Vietnamita](../vi/README.md)
...
Domine a Azure Developer CLI (azd) através de capítulos estruturados desenhados para uma aprendizagem progressiva. **Foco especial na implementação de aplicações de IA com integração Microsoft Foundry.**
...
- Arquiteturas de IA complexas e multi-serviço
...
- **Resolver Problemas de Implementação**: Diagnosticar e depurar questões comuns
...
#### O Que Vai Aprender
- Compreensão dos fundamentos da Azure Developer CLI
- Instalar AZD na sua plataforma
- A sua primeira implementação bem-sucedida

#### Recursos de Aprendizagem
- **🎯 Comece Aqui**: [O que é Azure Developer CLI?](../..)
- **📖 Teoria**: [Fundamentos do AZD](docs/getting-started/azd-basics.md) - Conceitos e terminologia essenciais
- **⚙️ Configuração**: [Instalação & Configuração](docs/getting-started/installation.md) - Guias específicos para a plataforma
...
### 🤖 Capítulo 2: Desenvolvimento com Prioridade em IA (Recomendado para Desenvolvedores de IA)
...
- Implementação de aplicações alimentadas por IA
...
- **🛠️ Workshop**: [Laboratório de IA](docs/microsoft-foundry/ai-workshop-lab.md) - Torne as suas soluções de IA prontas para AZD
- **🎥 Guia Interativo**: [Materiais do Workshop](workshop/README.md) - Aprendizagem no browser com MkDocs * Ambiente DevContainer
...
**💡 Resultado do Capítulo**: Implementar e configurar uma aplicação de chat alimentada por IA com capacidades RAG
...
#### 💰 Considerações de Custo para Implementações de IA
...
- Use a camada **Grátis** do Azure OpenAI para aprendizado (inclui 50,000 tokens/mês)
- Execute `azd down` para desalocar recursos quando não estiver a desenvolver ativamente
- Comece com faturação por consumo, faça upgrade para PTU somente em produção
- Use `azd provision --preview` para estimar custos antes da implementação
- Ative autoescalabilidade: pague apenas pelo uso real
...
# Monitorizar custos reais no Portal do Azure
...
- **📝 Exemplos**: [Exemplo de Aplicação de Base de Dados](examples/database-app/README.md) - Exemplos AZD Base de Dados
...
#### Exercícios Práticos  
```bash
# Implementar a solução multiagente completa para retalho
...
**💡 Resultado do Capítulo**: Implementar e gerir uma solução AI multi-agente pronta para produção com agentes de Cliente e Inventário  
...
- **💰 Seleção**: [Seleção SKU](docs/pre-deployment/sku-selection.md) - Opções economicamente eficazes  
...
#### O que Vai Aprender  
- Abordagens sistemáticas de debugging  
...
- **🕵️ Debugging**: [Guia de Debugging](docs/troubleshooting/debugging.md) - Estratégias passo a passo  
- **🤖 Problemas de IA**: [Resolução de Problemas Específicos de IA](docs/troubleshooting/ai-troubleshooting.md) - Problemas de serviços de IA  

#### Exercícios Práticos  
- Diagnosticar falhas na implementação  
...
> Os materiais do workshop estão em desenvolvimento e aperfeiçoamento. Os módulos essenciais estão funcionais, mas algumas secções avançadas ainda estão incompletas. Estamos a trabalhar ativamente para concluir todo o conteúdo. [Acompanhe o progresso →](workshop/README.md)  
...
Os materiais do workshop proporcionam uma experiência de aprendizagem estruturada e interativa que complementa o currículo por capítulos acima. O workshop é desenhado tanto para aprendizagem auto-guiada como para sessões conduzidas por instrutores.  

#### 🛠️ Características do Workshop  
- **Interface Baseada no Navegador**: Workshop completo com MkDocs, com pesquisa, cópia e funcionalidades de tema  
...
1. **Fase de Descoberta** (45 minutos)  
   ...
   - Rever requisitos e pré-requisitos da implementação  

2. **Fase de Implementação** (2 horas)  
   - Implementação prática de aplicações IA com AZD  
...
# Clique em "Código" → "Criar codespace na main" no repositório
...
- **Implementar Aplicações IA em Produção**: Usar AZD com serviços Microsoft Foundry  
...
- **Otimizar para Escalabilidade**: Projetar implementações eficientes em custo e desempenho  
- **Resolver Problemas de Implementação**: Diagnosticar e corrigir problemas comuns de forma independente  
...
- **🛠️ Laboratório de IA do Workshop**: [Laboratório de IA](docs/microsoft-foundry/ai-workshop-lab.md) - Exercícios focados em IA  
- **💡 Guia de Início Rápido**: [Guia de Configuração do Workshop](workshop/README.md#quick-start) - Configuração do ambiente  

**Perfeito para**: Formação corporativa, cursos universitários, aprendizagem auto-guiada e bootcamps para desenvolvedores.  

---

## 📖 O que é o Azure Developer CLI?  

Azure Developer CLI (azd) é uma interface de linha de comando centrada no programador que acelera o processo de construção e implementação de aplicações para Azure. Proporciona:  
...
- **Fluxos de trabalho integrados** - Provisão, implementação e monitorização contínua de aplicações  
...
**Porquê AZD para Soluções IA?** AZD resolve os principais desafios que os programadores de IA enfrentam:  

- **Templates Prontos para IA** - Templates pré-configurados para Azure OpenAI, Serviços Cognitivos e cargas ML  
- **Implementações Seguras de IA** - Padrões de segurança incorporados para serviços IA, chaves API e endpoints de modelos  
- **Padrões de IA para Produção** - Melhores práticas para implementações de IA escaláveis e custo-efetivas  
- **Fluxos de Trabalho IA End-to-End** - Do desenvolvimento do modelo à implementação em produção com monitorização adequada  
- **Otimização de Custos** - Estratégias inteligentes para alocação e escalabilidade de recursos IA  
- **Integração Microsoft Foundry** - Ligação fluida ao catálogo e endpoints de modelos Microsoft Foundry  
...
**Comece aqui se for implementar aplicações IA!**  

> **Nota:** Estes templates demonstram vários padrões IA. Alguns são amostras externas Azure, outros são implementações locais.  

| Template | Capítulo | Complexidade | Serviços | Tipo |  
|----------|----------|--------------|----------|------|  
| [**Introdução ao chat IA**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 2 | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights | Externo |  
| [**Introdução a agentes IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Capítulo 2 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights | Externo |  
...
| [**agent-openai-python-prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Capítulo 5 | ⭐⭐⭐ | Framework de agente e chamadas a funções |  
...
- [**Exemplos de Container App**](examples/container-app/README.md) - Guia completo para implementações conteinerizadas  
  ...
  - [Arquitetura de Microsserviços](../../examples/container-app/microservices) - Implementação multi-serviço pronta para produção  
...
- [Container App - Python Flask](https://github.com/Azure-Samples/container-apps-store-api-microservice) - Implementação API REST  
...
- [**Templates Azure Developer CLI**](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/azd-templates) - Documentação oficial de templates Microsoft Learn
...
- [**Guia de Workshop Interativo**](workshop/README.md) - Workshop baseado no navegador com MkDocs e Ambiente DevContainer
- [**Caminho de Aprendizagem Estruturado**](../../workshop/docs/instructions) - Exercícios guiados em 7 passos (Descoberta → Implantação → Customização)
- [**Workshop AZD Para Iniciantes**](workshop/README.md) - Material completo para workshop prático com integração GitHub Codespaces
...
### ❌ "InsufficientQuota" ou "Quota excedida"

```bash
# Tente uma região diferente da Azure
...
### ❌ "Autenticação falhou" ou "Token expirou"
...
# Depois tente novamente com um ambiente novo
azd env new dev-v2
azd up
```

### ❌ Implantação de modelo a demorar demasiado

**Tempos normais de espera:**
- Aplicação web simples: 5-10 minutos
- Aplicação com base de dados: 10-15 minutos
- Aplicações de IA: 15-25 minutos (fornecimento OpenAI é lento)
...
# Precisa no mínimo do papel de "Contribuidor"
...
<details>
<summary><strong>❌ "Autenticação falhou" ou "Token expirou"</strong></summary>
...
Ao terminar todos os capítulos, terá:
- **Experiência em Produção**: Implantação real de aplicações de IA no Azure
- **Competências Profissionais**: Capacidades de implantação prontas para ambiente empresarial  
- **Reconhecimento Comunitário**: Membro ativo da comunidade de desenvolvedores Azure
- **Avanço na Carreira**: Especialização procurada em implantação AZD e IA
...
- **Mais pedidos**: Modelos específicos de IA, guias de resolução de problemas, melhores práticas

**Junte-se à nossa comunidade para:**
- Partilhar as suas experiências AZD + IA e obter ajuda
- Aceder a prévias antecipadas de novos modelos IA
...
- **Novos Exemplos**: Adicionar cenários do mundo real e modelos  
- **Tradução**: Ajudar a manter o suporte multilíngue
- **Relatórios de Bugs**: Melhorar a precisão e clareza
- **Padrões Comunitários**: Seguir as nossas diretrizes inclusivas da comunidade
...
**Próximos Passos**: [Começar Capítulo 1 - Noções Básicas de AZD](docs/getting-started/azd-basics.md) →
