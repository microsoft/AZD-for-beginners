...
#### Tafsiri za Kiotomatiki (Daima Zilizosasishwa)
...
Jifunze Azure Developer CLI (azd) kupitia sura zilizopangwa kwa ajili ya kujifunza hatua kwa hatua. **Mwelekeo maalum juu ya usambazaji wa programu za AI kwa ushirikiano wa Microsoft Foundry.**
...
- **🛠️ Vitendo**: [Mradi Wako wa Kwanza](docs/getting-started/first-project.md) - Mafunzo hatua kwa hatua
...
- **🎥 Mwongozo wa Kuingiliana**: [Vifaa vya Warsha](workshop/README.md) - Kujifunza kupitia kivinjari na MkDocs * Mazingira ya DevContainer
...
**Mahitaji**: Sura 1-3 zimemalizika  
**Muda**: Saa 1-1.5  
**Ugumu**: ⭐⭐⭐

#### Utajifunza Nini
- Mifumo ya usambazaji wa hali ya juu
...
**Mahitaji**: Sura 1-2 zimemalizika  
**Muda**: Saa 2-3  
**Ugumu**: ⭐⭐⭐⭐
...
- Ukaguzi wa kabla ya kuanza na uendeshaji wa kiotomatiki
...
- **✅ Uthibitishaji**: [Ukaguzi wa Kabla ya Kuanzisha](docs/pre-deployment/preflight-checks.md) - Skripti za kiotomatiki

#### Mazoezi ya Kivitendo
- Endesha skripti za uthibitishaji wa uwezo
- Boresha uchaguzi wa SKU kwa gharama
- Tekeleza ukaguzi wa kiotomatiki kabla ya utekelezaji
...
#### Utajifunza Nini
- Mbinu za urekebishaji wa mfumo kwa mpangilio
- Matatizo ya kawaida na suluhisho
- Utatuzi wa matatizo maalum ya AI

#### Vyanzo vya Kujifunza
- **🔧 Matatizo ya Kawaida**: [Matatizo ya Kawaida](docs/troubleshooting/common-issues.md) - Maswali yanayoulizwa mara kwa mara na suluhisho
- **🕵️ Urekebishaji**: [Mwongozo wa Urekebishaji](docs/troubleshooting/debugging.md) - Mikakati hatua kwa hatua
- **🤖 Matatizo ya AI**: [Utatuzi wa Matatizo ya AI](docs/troubleshooting/ai-troubleshooting.md) - Matatizo ya huduma za AI
...
**💡 Matokeo ya Sura**: Tambua na tatua matatizo ya kawaida ya utekelezaji kwa uhuru
...
#### Vyanzo vya Kujifunza
- **🏭 Uzalishaji**: [Mbinu Bora za AI za Uzalishaji](docs/microsoft-foundry/production-ai-practices.md) - Mifumo ya biashara
...
- Tekeleza kwenye uzalishaji kwa usimamizi sahihi

**💡 Matokeo ya Sura**: Tekeleza programu za biashara tayari kwa uzalishaji zenye uwezo kamili
...
2. **Awamu ya Utekelezaji** (saa 2)
   - Tekeleza programu za AI kwa vitendo kwa kutumia AZD
...
# Bonyeza "Code" → "Create codespace on main" katika hifadhi
...
- **📋 Maelekezo Hatua kwa Hatua**: [Mazoezi Yaliyoongozwa](../../workshop/docs/instructions) - Maelezo ya kina
...
**Inafaa kwa**: Mafunzo ya kampuni, kozi za vyuo vikuu, kujifunza kwa kasi binafsi, na mafunzo ya waendelezaji.
...
- **Mtiririko wa kazi uliounganishwa** - Toa, tekeleza, na fuatilia programu kwa urahisi
- **Rafiki kwa waendelezaji** - Imekusudiwa kuongeza tija na uzoefu wa waendelezaji

### **AZD + Microsoft Foundry: Kamili kwa Utekelezaji wa AI**

**Kwa Nini AZD kwa Suluhisho za AI?** AZD inashughulikia changamoto kuu zinazokabiliwa na waendelezaji wa AI:
...
#### Mifano ya Nje - Programu Rahisi (Suras 1-2)
**Nakili repositori hizi za Sampuli za Azure kuanza:**
...
#### Mifano ya Nje - Mifumo ya Juu (Suras 4-8)
...
**Matatizo ya kawaida yanayokumbwa na waanzilishi na suluhisho za haraka:**
...
### ❌ "Hakuna usajili ulio patikana" au "Usajili haujawekwa"
...
### ❌ "Uthibitishaji umeshindwa" au "Tokeni imeisha muda wake"
...
### ❌ "Ruhusa imekataliwa" au "Imezuiwa"
...
- **Mwongozo wa Kurekebisha:** [Kurekebisha Hatua kwa Hatua](docs/troubleshooting/debugging.md)
...
<details>
<summary><strong>❌ "Hakuna usajili ulio patikana" au "Usajili haujawekwa"</strong></summary>
...
<details>
<summary><strong>❌ "Uthibitishaji umeshindwa" au "Tokeni imeisha muda wake"</strong></summary>
...
<details>
<summary><strong>❌ Haiwezi kupata URL ya programu iliyotekelezwa</strong></summary>
...
4. **Sura Ifuatayo**: Hamia kwenye kiwango kinachofuata cha ugumu
