...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:15:13+00:00",
...
Jifunze Azure Developer CLI (azd) kupitia sura zilizopangwa kwa kujifunza hatua kwa hatua. **Mkazo maalum kwenye usambazaji wa programu za AI kwa ushirikiano wa Azure AI Foundry.**
...
- Mazoea bora ya usambazaji wa AI kwa uzalishaji  
...
- **Kusambaza Programu za AI**: Tumia AZD na huduma za Azure AI Foundry
- **Kutumia Miundombinu kama Nambari**: Dhibiti rasilimali za Azure kwa kutumia templeti za Bicep
- **Kutatua Matatizo ya Usambazaji**: Suluhisha masuala ya kawaida na urekebishe matatizo
- **Kuboresha kwa Uzalishaji**: Usalama, upanuzi, ufuatiliaji, na usimamizi wa gharama
- **Kujenga Suluhisho za Wakala Wengi**: Sambaza miundombinu ya AI yenye huduma nyingi
...
- **⚙️ Usakinishaji**: [Mwongozo wa Usakinishaji](docs/getting-started/installation.md) - Mwongozo maalum wa jukwaa
...
- Kusambaza programu zinazoendeshwa na AI
- Kuelewa usanidi wa huduma za AI

#### Rasilimali za Kujifunza
- **🎯 Anza Hapa**: [Ushirikiano wa Azure AI Foundry](docs/ai-foundry/azure-ai-foundry-integration.md)
- **📖 Mifumo**: [Usambazaji wa Modeli za AI](docs/ai-foundry/ai-model-deployment.md) - Kusambaza na kudhibiti modeli za AI
- **🛠️ Warsha**: [Maabara ya Warsha ya AI](docs/ai-foundry/ai-workshop-lab.md) - Tengeneza suluhisho zako za AI ziwe tayari kwa AZD
...
**💡 Matokeo ya Sura**: Kusambaza na kusanidi programu ya mazungumzo inayotumia AI na uwezo wa RAG
...
### 🏗️ Sura ya 4: Miundombinu kama Nambari & Usambazaji
...
#### Rasilimali za Kujifunza
- **📖 Usambazaji**: [Mwongozo wa Usambazaji](docs/deployment/deployment-guide.md) - Mifumo kamili
- **🏗️ Utoaji**: [Utoaji wa Rasilimali](docs/deployment/provisioning.md) - Usimamizi wa rasilimali za Azure
- **📝 Mifano**: [Mfano wa Programu ya Kontena](../../examples/container-app) - Usambazaji wa programu zilizowekwa kwenye kontena
...
**💡 Matokeo ya Sura**: Kusambaza programu zenye huduma nyingi kwa kutumia templeti za miundombinu maalum
...
- Usambazaji wa AI ulio tayari kwa uzalishaji

#### Rasilimali za Kujifunza
- **🤖 Mradi Maarufu**: [Suluhisho la Wakala Wengi wa Rejareja](examples/retail-scenario.md) - Utekelezaji kamili
- **🛠️ Templeti za ARM**: [Pakiti ya Templeti za ARM](../../examples/retail-multiagent-arm-template) - Usambazaji wa bonyeza moja
...
**💡 Matokeo ya Sura**: Kusambaza na kusimamia suluhisho la AI la wakala wengi lililo tayari kwa uzalishaji na mawakala wa Wateja na Hifadhi

---

### 🔍 Sura ya 6: Uthibitishaji Kabla ya Usambazaji & Mipango
...
- Tekeleza ukaguzi wa awali wa usambazaji otomatiki

**💡 Matokeo ya Sura**: Uthibitisha na boresha usambazaji kabla ya utekelezaji
...
**💡 Matokeo ya Sura**: Kutambua na kutatua matatizo ya kawaida ya usambazaji kwa kujitegemea
...
#### Unachojifunza
- Mikakati ya kupeleka programu katika uzalishaji
- Mifumo ya usalama kwa mashirika
- Ufuatiliaji na uboreshaji wa gharama

#### Rasilimali za Kujifunza
- **🏭 Uzalishaji**: [Mbinu Bora za AI za Uzalishaji](docs/ai-foundry/production-ai-practices.md) - Mifumo ya mashirika
- **📝 Mifano**: [Mfano wa Huduma Ndogo](../../examples/microservices) - Miundombinu changamano
- **📊 Ufuatiliaji**: Muunganisho wa Application Insights

#### Mazoezi ya Vitendo
- Tekeleza mifumo ya usalama kwa mashirika
- Sanidi ufuatiliaji wa kina
- Peleka programu katika uzalishaji kwa usimamizi sahihi

**💡 Matokeo ya Sura**: Peleka programu zilizo tayari kwa mashirika zenye uwezo kamili wa uzalishaji
...
Vifaa vyetu vya warsha vinatoa uzoefu wa kujifunza ulio na muundo, unaoingiliana, unaosaidia mtaala wa sura ulioainishwa hapo juu. Warsha imeundwa kwa ajili ya kujifunza kwa kasi yako mwenyewe na vipindi vinavyoongozwa na wakufunzi.
...
- **Njia ya Kujifunza Iliyo na Muundo**: Mazoezi yaliyoongozwa hatua 7 (jumla ya saa 3.5)
- **Ugunduzi → Uzalishaji → Ubinafsishaji**: Mbinu ya maendeleo
- **Mazingira ya DevContainer ya Kuingiliana**: Zana na utegemezi uliosanidiwa awali
...
1. **Awamu ya Ugunduzi** (Dakika 45)
   ...
   - Kagua mahitaji ya kupeleka programu na masharti

2. **Awamu ya Uzalishaji** (Saa 2)
   - Utekelezaji wa vitendo wa kupeleka programu za AI kwa AZD
...
3. **Awamu ya Ubinafsishaji** (Dakika 45)
   ...
   - Boresha kwa ajili ya kupeleka programu katika uzalishaji
...
- **Kupeleka Programu za AI za Uzalishaji**: Tumia AZD na huduma za Azure AI Foundry
- **Kumudu Miundombinu ya Mawakala Wengi**: Tekeleza suluhisho za mawakala wa AI zilizo na uratibu
- **Tekeleza Mbinu Bora za Usalama**: Sanidi uthibitishaji na udhibiti wa ufikiaji
- **Boresha kwa Upeo**: Unda miundombinu ya gharama nafuu na yenye utendaji mzuri
- **Tatua Changamoto za Uzalishaji**: Suluhisha masuala ya kawaida kwa kujitegemea
...
- **Upelekwaji wa templeti** - Tumia templeti zilizotengenezwa awali kwa mifumo ya programu ya kawaida
...
### **AZD + Azure AI Foundry: Bora kwa Upelekwaji wa AI**
...
- **Upelekwaji wa AI Salama** - Mifumo ya usalama iliyojengwa ndani kwa huduma za AI, funguo za API, na vituo vya mwisho vya modeli  
- **Mifumo ya AI ya Uzalishaji** - Mbinu bora za kupeleka programu za AI zinazoweza kupanuka na za gharama nafuu
- **Mtiririko wa Kazi wa AI wa Mwisho hadi Mwisho** - Kutoka kwa maendeleo ya modeli hadi upelekwaji wa uzalishaji na ufuatiliaji sahihi
...
### Iliyoangaziwa: Templeti za Azure AI Foundry
**Anza hapa ikiwa unapeleka programu za AI!**

| Templeti | Sura | Ugumu | Huduma |
|----------|---------|------------|----------|
| [**Anza na Gumzo la AI**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Sura ya 2 | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights |
...
| [**Boresha Mikutano ya Wateja na Mawakala**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Sura ya 5 | ⭐⭐⭐| AzureOpenAI + Azure AI Search + Azure CosmosDB + Azure SQL Database |
| [**Boresha Msimbo Wako na Mawakala**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Sura ya 5 | ⭐⭐⭐ | AzureOpenAI + Azure Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
...
### Iliyoangaziwa: Mifano Kamili ya Kujifunza
**Templeti za programu zilizo tayari kwa uzalishaji zimepangwa kwa sura za kujifunza**

| Templeti | Sura ya Kujifunza | Ugumu | Kujifunza Muhimu |
|----------|------------------|------------|--------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Sura ya 2 | ⭐ | Mifumo ya msingi ya upelekwaji wa AI |
...
| [**ai-document-processing**](https://github.com/Azure-Samples/ai-document-processing) | Sura ya 4 | ⭐⭐ | Muunganisho wa Ujasusi wa Nyaraka |
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Sura ya 8 | ⭐⭐⭐ | Uratibu wa AI kwa mashirika |
...
- [Programu Rahisi ya Wavuti](../../examples/simple-web-app) - Mifumo ya msingi ya upelekwaji
- [Tovuti ya Kawaida](../../examples/static-site) - Upelekwaji wa maudhui ya kawaida
- [API ya Msingi](../../examples/basic-api) - Upelekwaji wa API ya REST

#### Muunganisho wa Hifadhidata (Sura ya 3-4)  
- [Programu ya Hifadhidata](../../examples/database-app) - Mifumo ya muunganisho wa hifadhidata
- [Usindikaji wa Data](../../examples/data-processing) - Upelekwaji wa mtiririko wa kazi wa ETL

#### Mifumo ya Juu (Sura ya 4-8)
- [Programu za Kontena](../../examples/container-app) - Upelekwaji wa programu zilizowekwa kwenye kontena
- [Huduma Ndogo](../../examples/microservices) - Miundombinu ya huduma nyingi  
- [Suluhisho za Mashirika](../../examples/enterprise) - Mifumo iliyo tayari kwa uzalishaji

### Maktaba za Templeti za Nje
- [**Maktaba Rasmi ya Templeti za AZD**](https://azure.github.io/awesome-azd/) - Mkusanyiko ulioratibiwa wa templeti rasmi na za jamii
...
### Marejeleo ya Haraka
- [**Karatasi ya Amri**](resources/cheat-sheet.md) - Amri muhimu za azd zimepangwa kwa sura
...
- [**Njia ya Kujifunza Iliyo na Muundo**](../../workshop/docs/instructions) - Mazoezi yaliyoongozwa hatua 7 (Ugunduzi → Uzalishaji → Ubinafsishaji)
...
- [ ] **Sura ya 4**: Miundombinu kama Msimbo na Upelekwaji ✅
- [ ] **Sura ya 5**: Suluhisho za AI za Mawakala Wengi ✅
- [ ] **Sura ya 6**: Uthibitishaji wa Kabla ya Upelekwaji na Mipango ✅
- [ ] **Sura ya 7**: Utatuzi wa Changamoto na Urekebishaji ✅
- [ ] **Sura ya 8**: Mifumo ya Uzalishaji na Mashirika ✅

### Uthibitishaji wa Kujifunza
Baada ya kukamilisha kila sura, thibitisha maarifa yako kwa:
1. **Zoezi la Vitendo**: Kamilisha upelekwaji wa sura husika
...
- **Ujuzi wa Kitaalamu**: Uwezo wa kupeleka programu zilizo tayari kwa mashirika  
- **Kutambulika na Jamii**: Mwanachama hai wa jamii ya watengenezaji wa Azure
- **Maendeleo ya Kazi**: Utaalamu wa AZD na upelekwaji wa AI unaohitajika
...
### Rasilimali Zinazohusiana za Kujifunza kutoka Microsoft  
...
[![AI Jenereta kwa Kompyuta](https://img.shields.io/badge/AI%20Jenereta%20kwa%20Kompyuta-8B5CF6?style=for-the-badge&labelColor=E5E7EB&color=8B5CF6)](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)  
[![AI Jenereta (.NET)](https://img.shields.io/badge/AI%20Jenereta%20(.NET)-9333EA?style=for-the-badge&labelColor=E5E7EB&color=9333EA)](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)  
[![AI Jenereta (Java)](https://img.shields.io/badge/AI%20Jenereta%20(Java)-C084FC?style=for-the-badge&labelColor=E5E7EB&color=C084FC)](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)  
[![AI Jenereta (JavaScript)](https://img.shields.io/badge/AI%20Jenereta%20(JavaScript)-E879F9?style=for-the-badge&labelColor=E5E7EB&color=E879F9)](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)  
