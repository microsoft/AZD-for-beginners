...
function Test-Prerequisites {
    ...
    # Controleer Azure CLI-installatie
    try {
...
function Test-Permissions {
    ...
    try {
        # Haal roltoewijzingen van de huidige gebruiker op
...
function Test-QuotasAndLimits {
    ...
    try {
        ...
        # Controleer App Service-limieten
        try {
        ...
        # Controleer opslagaccountlimieten
...
function Test-TemplateValidation {
    ...
    # Controleer of azure.yaml bestaat
    if (Test-Path "azure.yaml") {
        Write-Status "azure.yaml found" "Success"
        
        # Analyseer azure.yaml
        try {
    ...
    # Controleer op infrastructuurbestanden
    if (Test-Path "infra") {
...
function Test-RegionalAvailability {
    ...
    try {
        # Controleer of locatie geldig is
...
function Test-SecurityCompliance {
    ...
    # Controleer op gangbare beveiligingspraktijken
    try {
        # Controleer of Key Vault is geconfigureerd
...
check_template_validation() {
    ...
    # Controleer azure.yaml
    if [[ -f "azure.yaml" ]]; then
        print_status "azure.yaml found" "success"
        
        # Basis YAML-validatie
    ...
    # Controleer infrastructuurbestanden
    if [[ -d "infra" ]]; then
...
check_regional_availability() {
    ...
    # Controleer servicebeschikbaarheid
...
```bash
#!/bin/bash
# Validaties specifiek voor de ontwikkelomgeving

validate_dev_environment() {
    echo "=== Development Environment Validation ==="
    
    # Controleer op ontwikkelvriendelijke configuraties
    ...
    # Controleer op configuraties voor automatische uitschakeling
    ...
    # Valideer databaseconfiguraties voor de ontwikkelomgeving
...
```bash
#!/bin/bash
# Specifieke validaties voor de productieomgeving

validate_prod_environment() {
    echo "=== Production Environment Validation ==="
    
    # Controleer op configuraties voor hoge beschikbaarheid
    ...
    # Controleer op back-upconfiguraties
    ...
    # Controleer op beveiligingsconfiguraties
...
def check_storage_limits(location: str) -> bool:
    ...
    max_accounts = 250  # Standaard Azure-limiet
...
def check_network_limits(location: str) -> bool:
    ...
    # Controleer virtuele netwerken
    vnets = run_command(['az', 'network', 'vnet', 'list'])
    if vnets is not None:
        vnet_count = len(vnets)
        print(f"✅ Virtual Networks: {vnet_count}/1000")
    
    # Controleer openbare IP-adressen
