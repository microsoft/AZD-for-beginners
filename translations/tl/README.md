...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T21:28:35+00:00",
...
Maligayang pagdating sa komprehensibong gabay para sa Azure Developer CLI (azd). Ang repository na ito ay idinisenyo upang tulungan ang mga developer sa lahat ng antas—mula sa mga estudyante hanggang sa mga propesyonal—na matutunan at ma-master ang Azure Developer CLI para sa mas epektibong cloud deployments, **na may espesyal na pokus sa AI application deployment gamit ang Azure AI Foundry**. Ang structured learning resource na ito ay nagbibigay ng hands-on na karanasan sa Azure cloud deployments, pag-troubleshoot ng mga karaniwang isyu, at pagpapatupad ng best practices para sa matagumpay na AZD template deployments.

### **Bakit Mahalaga ang Gabay na Ito para sa AI Developers**
Batay sa aming kamakailang poll sa Azure AI Foundry Discord community, **45% ng mga developer ay interesado sa paggamit ng AZD para sa AI workloads** ngunit nahaharap sa mga hamon tulad ng:  
...
- Makakapag-troubleshoot ng mga problema sa authentication, infrastructure, at deployment  
...
- [Mga Halimbawa at Templates](../..)  
  - [Tampok: Azure AI Foundry Templates](../..)  
  - [Tampok: Azure AI Foundry E2E Scenarios](../..)  
...
- **Template-based deployments** - Gumamit ng mga pre-built templates para sa karaniwang application patterns  
...
- **AI-Ready Templates** - Pre-configured templates para sa Azure OpenAI, Cognitive Services, at ML workloads  
- **Secure AI Deployments** - Built-in security patterns para sa AI services, API keys, at model endpoints  
...
- **Cost Optimization** - Smart resource allocation at scaling strategies para sa AI workloads  
...
### Pag-troubleshoot  
- [**Karaniwang Isyu**](docs/troubleshooting/common-issues.md) - Mga madalas na problema at solusyon  
...
| Template | Deskripsyon | Komplikasyon | Mga Serbisyo |  
|----------|-------------|------------|----------|  
...
| [**Multi-agent workflow automation**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Pagandahin ang pagpaplano ng gawain at automation sa pamamagitan ng pag-orchestrate at pamamahala ng grupo ng AI agents.|⭐⭐⭐ | AzureOpenAI + Azure AI Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|  
...
| [**Pagandahin ang mga client meeting gamit ang agents**](https://github.com/Azure-Samples/get-started-with-ai-chat) | I-migrate ang legacy code sa mga modernong wika gamit ang isang team ng agents. |⭐⭐⭐| AzureOpenAI + Azure AI Search + Azure CosmosDB + Azure SQL Database |  
| [**Modernize ang iyong code gamit ang agents**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Gumawa at mag-deploy ng simpleng chat application na isinama sa iyong data at telemetry insights gamit ang Azure Container Apps |⭐⭐⭐ | AzureOpenAI + Azure Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|  
| [**Gumawa ng iyong conversational agent**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Gamitin ang advanced conversational understanding para gumawa at pagandahin ang chatbots at agents na may deterministic at human-controllable workflows. |⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Azure Storage + Azure Container Registry|  
...
- [**Study Guide**](resources/study-guide.md) - Komprehensibong mga layunin sa pag-aaral at mga pagsasanay  
...
- Paano magsumite ng mga isyu at kahilingan sa feature  
...
- **Mga Isyu**: [Mag-ulat ng mga bug at humiling ng mga feature](https://github.com/microsoft/azd-for-beginners/issues)  
