...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T15:08:37+00:00",
...
Matutunan ang Azure Developer CLI (azd) sa pamamagitan ng mga nakabalangkas na kabanata na idinisenyo para sa progresibong pag-aaral. **Espesyal na pokus sa pag-deploy ng AI application gamit ang Azure AI Foundry integration.**
...
#### Mga Mapagkukunan sa Pag-aaral
- **🎯 Simulan Dito**: [Azure AI Foundry Integration](docs/ai-foundry/azure-ai-foundry-integration.md)
...
- **✅ Validation**: [Pre-flight Checks](docs/pre-deployment/preflight-checks.md) - Mga automated na script

#### Mga Praktikal na Ehersisyo
- Magpatakbo ng mga capacity validation scripts
- Mag-optimize ng SKU selections para sa gastos
- Magpatupad ng automated pre-deployment checks

**💡 Resulta ng Kabanata**: Ma-validate at ma-optimize ang mga deployments bago ito isagawa
...
#### Mga Praktikal na Ehersisyo
- Mag-diagnose ng mga deployment failures
...
- **🏭 Produksyon**: [Mga Pinakamahusay na Praktika sa Production AI](docs/ai-foundry/production-ai-practices.md) - Mga pattern ng enterprise
...
#### Mga Praktikal na Ehersisyo
- Ipatupad ang mga pattern sa seguridad ng enterprise
...
- **Interface na Batay sa Browser**: Kumpletong workshop na pinapagana ng MkDocs na may search, copy, at mga tampok ng tema
- **Integrasyon ng GitHub Codespaces**: Isang-click na pag-set up ng development environment
- **Istrukturadong Landas ng Pag-aaral**: 7-hakbang na mga gabay na ehersisyo (kabuuang 3.5 oras)
...
1. **Phase ng Pagdiskubre** (45 minuto)
   - Tuklasin ang mga template at serbisyo ng Azure AI Foundry
   - Unawain ang mga pattern ng multi-agent architecture
   - Suriin ang mga kinakailangan at paunang kondisyon sa pag-deploy

2. **Phase ng Pag-deploy** (2 oras)
...
3. **Phase ng Pag-customize** (45 minuto)
...
- **Ipatupad ang Mga Pinakamahusay na Praktika sa Seguridad**: I-configure ang authentication at access control
...
- **Secure AI Deployments** - Mga built-in na pattern sa seguridad para sa mga serbisyo ng AI, API keys, at model endpoints  
- **Production AI Patterns** - Mga pinakamahusay na praktika para sa scalable at cost-effective na AI application deployments
...
- **Integrasyon ng Azure AI Foundry** - Seamless na koneksyon sa AI Foundry model catalog at endpoints
...
#### Mga Simpleng Application (Mga Kabanata 1-2)
...
#### Integrasyon ng Database (Mga Kabanata 3-4)  
...
#### Mga Advanced na Pattern (Mga Kabanata 4-8)
...
- [**Azure-Samples AZD Templates**](https://github.com/Azure-Samples/azd-templates) - Mga opisyal na sample ng Microsoft
...
- [**Istrukturadong Landas ng Pag-aaral**](../../workshop/docs/instructions) - 7-hakbang na mga gabay na ehersisyo (Pagdiskubre → Pag-deploy → Pag-customize)
- [**AZD Para sa Mga Baguhan Workshop**](workshop/README.md) - Kumpletong materyales ng hands-on na workshop na may integrasyon ng GitHub Codespaces

### Mga Panlabas na Mapagkukunan ng Pag-aaral
...
Pagkatapos kumpletuhin ang bawat kabanata, i-verify ang iyong kaalaman sa pamamagitan ng:
...
3. **Diskusyon ng Komunidad**: Ibahagi ang iyong karanasan sa Azure Discord
4. **Susunod na Kabanata**: Lumipat sa susunod na antas ng komplikasyon

### Mga Benepisyo ng Pagkumpleto ng Kurso
Sa pagkumpleto ng lahat ng kabanata, magkakaroon ka ng:
...
- **Pag-unlad sa Karera**: Ekspertis sa AZD at AI deployment na in-demand
...
- **Mga Tanong sa Pag-aaral**: [Komunidad ng Microsoft Azure Discord](https://discord.gg/microsoft-azure)
...
- **Pinakamaraming Hiniling**: Mga template na nakatuon sa AI, mga gabay sa troubleshooting, pinakamahusay na praktika
...
- Mag-ambag sa mga pinakamahusay na praktika sa AI deployment
- Makaimpluwensya sa hinaharap na pag-unlad ng tampok sa AI + AZD
...
- **Mga Pagpapabuti sa Nilalaman**: Pagandahin ang mga umiiral na kabanata at halimbawa
- **Mga Bagong Halimbawa**: Magdagdag ng mga senaryo at template na may kaugnayan sa totoong mundo  
- **Pagsasalin**: Tumulong sa pagpapanatili ng suporta para sa maraming wika  
