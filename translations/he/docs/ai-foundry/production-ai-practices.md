...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T21:48:54+00:00",
...
**קודם:** [AI Workshop Lab](ai-workshop-lab.md) | **הבא:** [AI Troubleshooting Guide](../troubleshooting/ai-troubleshooting.md)

## סקירה כללית

מדריך זה מספק שיטות עבודה מומלצות מקיפות לפריסת עומסי עבודה של AI מוכנים לייצור באמצעות Azure Developer CLI (AZD). בהתבסס על משוב מקהילת Azure AI Foundry ב-Discord ועל פריסות לקוחות בעולם האמיתי, שיטות אלו מתמודדות עם האתגרים הנפוצים ביותר במערכות AI בייצור.
...
### תבנית 2: עיבוד AI מבוסס אירועים
...
### 3. בדיקות בריאות וניטור זמן פעילות
...
- [ ] התאמת משאבים  
- [ ] הנחות dev/test מיושמות  
- [ ] רכישת instances שמורים  
...
בהתבסס על משוב מקהילת Azure AI Foundry ב-Discord:
...
4. **לבדוק ביסודיות**: לכלול בדיקות ספציפיות ל-AI בצנרת  
