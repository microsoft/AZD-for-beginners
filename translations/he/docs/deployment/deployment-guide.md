...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T21:40:14+00:00",
...
- להבין את מחזור החיים המלא של הפריסה, החל מהקצאה ועד לניטור
...
## זרימות פריסה בסיסיות

### פריסה מלאה (azd up)
הזרימה הנפוצה ביותר עבור פרויקטים חדשים:
```bash
...
- [הקצאת משאבים](provisioning.md) - מדריך מעמיק לניהול תשתית
