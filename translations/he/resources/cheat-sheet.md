...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T22:46:04+00:00",
...
דף עזר מקיף זה מספק הפניה מהירה לפקודות CLI של Azure Developer הנפוצות ביותר, מאורגנות לפי קטגוריות עם דוגמאות מעשיות. מושלם לחיפושים מהירים במהלך פיתוח, פתרון בעיות ותפעול יומיומי עם פרויקטים של azd.
...
- להיעזר בדוגמאות מעשיות לתרחישי פיתוח ופריסה נפוצים
- לגשת לפקודות פתרון בעיות לפתרון מהיר של תקלות
- למצוא ביעילות אפשרויות מתקדמות של הגדרות והתאמות אישיות
- לאתר פקודות לניהול סביבות ולעבודה עם מספר סביבות

## תוצאות למידה

עם שימוש קבוע בדף עזר זה, תוכלו:
- לבצע פקודות azd בביטחון ללא צורך בהפניה לתיעוד מלא
...
- לייעל תהליכי עבודה באמצעות שימוש אפקטיבי בקיצורי דרך ואפשרויות של azd
