# AZD Cho Người Mới: Hành Trình Học Có Cấu Trúc
...
**Azure Developer CLI (azd)** là một công cụ dòng lệnh thân thiện với nhà phát triển, giúp đơn giản hóa việc triển khai ứng dụng lên Azure. Thay vì phải tự tạo và kết nối hàng chục tài nguyên Azure, bạn có thể triển khai toàn bộ ứng dụng chỉ với một lệnh duy nhất.
...
**Xong rồi!** Không cần click trong Azure Portal, không cần học các template ARM phức tạp trước, không cần cấu hình thủ công - chỉ là các ứng dụng hoạt động trên Azure.

---

## ❓ Azure Developer CLI so với Azure CLI: Sự khác biệt là gì?
...
|---------|---------------------|--------------------------------|
| **Mục đích** | Quản lý từng tài nguyên Azure | Triển khai ứng dụng hoàn chỉnh |
| **Tư duy** | Tập trung vào hạ tầng | Tập trung vào ứng dụng |
| **Ví dụ** | `az webapp create --name myapp...` | `azd up` |
| **Độ khó học** | Cần hiểu các dịch vụ Azure | Chỉ cần biết ứng dụng của bạn |
| **Phù hợp cho** | DevOps, Hạ tầng | Các nhà phát triển, Tạo nguyên mẫu |

### Phép so sánh đơn giản

- **Azure CLI** giống như có tất cả công cụ để xây dựng một ngôi nhà - búa, cưa, đinh. Bạn có thể xây bất cứ thứ gì, nhưng bạn cần biết cách xây dựng.
- **Azure Developer CLI** giống như thuê một nhà thầu - bạn mô tả những gì bạn muốn, và họ sẽ lo phần xây dựng.
...
AZD sử dụng Azure CLI ở phía sau. Bạn có thể dùng cả hai:
```bash
# Triển khai ứng dụng của bạn với AZD
azd up

# Sau đó tinh chỉnh các tài nguyên cụ thể với Azure CLI
...
Đừng bắt đầu từ con số không! **Awesome AZD** là bộ sưu tập cộng đồng các mẫu sẵn sàng triển khai:

| Tài nguyên | Mô tả |
|----------|-------------|
| 🔗 [**Thư viện Awesome AZD**](https://azure.github.io/awesome-azd/) | Duyệt hơn 200 mẫu và triển khai chỉ với một nhấp chuột |
| 🔗 [**Gửi một mẫu**](https://github.com/Azure/awesome-azd/issues) | Đóng góp mẫu của bạn cho cộng đồng |
| 🔗 [**Kho GitHub**](https://github.com/Azure/awesome-azd) | Gắn sao và khám phá mã nguồn |

### Các mẫu AI phổ biến từ Awesome AZD

```bash
# RAG Chat với Azure OpenAI + AI Search
...
Khóa học này được thiết kế cho **học tiến bộ** - bắt đầu từ nơi bạn thoải mái và nâng dần mức độ:

| Kinh nghiệm của bạn | Bắt đầu ở đây |
|-----------------|------------|
| **Hoàn toàn mới với Azure** | [Chương 1: Nền tảng](../..) |
| **Biết Azure, mới với AZD** | [Chương 1: Nền tảng](../..) |
| **Muốn triển khai ứng dụng AI** | [Chương 2: Phát triển ưu tiên AI](../..) |
| **Muốn thực hành trực tiếp** | [🎓 Hội thảo tương tác](workshop/README.md) - bài lab hướng dẫn 3-4 giờ |
| **Cần các mẫu cho sản xuất** | [Chương 8: Sản xuất & Doanh nghiệp](../..) |

### Thiết lập nhanh

1. **Tạo Fork kho lưu trữ này**: [![Forks trên GitHub](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
...
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Điều này cung cấp cho bạn mọi thứ cần thiết để hoàn thành khóa học với dung lượng tải xuống nhanh hơn.


## Tổng quan Khóa học

Nắm vững Azure Developer CLI (azd) thông qua các chương được cấu trúc cho việc học tiến bộ. **Tập trung đặc biệt vào triển khai ứng dụng AI với tích hợp Microsoft Foundry.**

### Tại sao Khóa học này cần thiết cho các nhà phát triển hiện đại

Dựa trên thông tin từ cộng đồng Microsoft Foundry trên Discord, **45% nhà phát triển muốn sử dụng AZD cho khối lượng công việc AI** nhưng gặp phải các thách thức với:
...
- **Nắm vững các nguyên tắc cơ bản của AZD**: Các khái niệm cốt lõi, cài đặt và cấu hình
- **Triển khai ứng dụng AI**: Sử dụng AZD với các dịch vụ Microsoft Foundry
- **Thực hiện Hạ tầng như Mã (IaC)**: Quản lý tài nguyên Azure với các mẫu Bicep
...
|---------|-------|---------|----------|------------|
| **[Ch 1: Nền tảng](docs/chapter-01-foundation/README.md)** | Bắt đầu | [AZD Cơ bản](docs/chapter-01-foundation/azd-basics.md) &#124; [Cài đặt](docs/chapter-01-foundation/installation.md) &#124; [Dự án đầu tiên](docs/chapter-01-foundation/first-project.md) | 30-45 min | ⭐ |
| **[Ch 2: Phát triển ưu tiên AI](docs/chapter-02-ai-development/README.md)** | Ứng dụng lấy AI làm trung tâm | [Tích hợp Foundry](docs/chapter-02-ai-development/microsoft-foundry-integration.md) &#124; [Tác nhân AI](docs/chapter-02-ai-development/agents.md) &#124; [Triển khai mô hình AI](docs/chapter-02-ai-development/ai-model-deployment.md) &#124; [Workshop](docs/chapter-02-ai-development/ai-workshop-lab.md) | 1-2 giờ | ⭐⭐ |
...
| **[Ch 5: Đa tác nhân](docs/chapter-05-multi-agent/README.md)** | Giải pháp Tác nhân AI | [Kịch bản Bán lẻ](examples/retail-scenario.md) &#124; [Mẫu phối hợp](docs/chapter-06-pre-deployment/coordination-patterns.md) | 2-3 hrs | ⭐⭐⭐⭐ |
| **[Ch 6: Trước Triển khai](docs/chapter-06-pre-deployment/README.md)** | Lập kế hoạch & Xác thực | [Kiểm tra trước triển khai](docs/chapter-06-pre-deployment/preflight-checks.md) &#124; [Lập kế hoạch công suất](docs/chapter-06-pre-deployment/capacity-planning.md) &#124; [Lựa chọn SKU](docs/chapter-06-pre-deployment/sku-selection.md) &#124; [Application Insights](docs/chapter-06-pre-deployment/application-insights.md) | 1 hr | ⭐⭐ |
| **[Ch 7: Khắc phục sự cố](docs/chapter-07-troubleshooting/README.md)** | Gỡ lỗi & Sửa | [Sự cố phổ biến](docs/chapter-07-troubleshooting/common-issues.md) &#124; [Gỡ lỗi](docs/chapter-07-troubleshooting/debugging.md) &#124; [Sự cố AI](docs/chapter-07-troubleshooting/ai-troubleshooting.md) | 1-1.5 hrs | ⭐⭐ |
| **[Ch 8: Sản xuất](docs/chapter-08-production/README.md)** | Mẫu Doanh nghiệp | [Thực tiễn sản xuất](docs/chapter-08-production/production-ai-practices.md) | 2-3 hrs | ⭐⭐⭐⭐ |
| **[🎓 Workshop](workshop/README.md)** | Thực hành | [Giới thiệu](workshop/docs/instructions/0-Introduction.md) &#124; [Lựa chọn](workshop/docs/instructions/1-Select-AI-Template.md) &#124; [Xác thực](workshop/docs/instructions/2-Validate-AI-Template.md) &#124; [Phân tích](workshop/docs/instructions/3-Deconstruct-AI-Template.md) &#124; [Cấu hình](workshop/docs/instructions/4-Configure-AI-Template.md) &#124; [Tùy chỉnh](workshop/docs/instructions/5-Customize-AI-Template.md) &#124; [Gỡ bỏ](workshop/docs/instructions/6-Teardown-Infrastructure.md) &#124; [Tổng kết](workshop/docs/instructions/7-Wrap-up.md) | 3-4 hrs | ⭐⭐ |

**Tổng Thời Lượng Khóa Học:** ~10-14 hours | **Tiến trình Kỹ năng:** Người mới → Sẵn sàng cho Sản xuất
...
- Triển khai đầu tiên thành công của bạn
...
- **🤖 Tác nhân AI**: [Hướng dẫn Tác nhân AI](docs/chapter-02-ai-development/agents.md) - Triển khai tác nhân thông minh bằng AZD
- **📖 Mẫu**: [Triển khai mô hình AI](docs/chapter-02-ai-development/ai-model-deployment.md) - Triển khai và quản lý mô hình AI
- **🛠️ Phòng thí nghiệm**: [Phòng thí nghiệm AI](docs/chapter-02-ai-development/ai-workshop-lab.md) - Chuẩn bị giải pháp AI cho AZD
...
**💡 Kết quả chương**: Triển khai và cấu hình một ứng dụng chat chạy AI với khả năng RAG
...
azd init --template azure-search-openai-demo
azd up
# Kiểm thử giao diện chat AI
# Đặt câu hỏi và nhận phản hồi do AI tạo kèm nguồn
...
**📈 Trình độ sau khi hoàn thành:** Có thể triển khai và cấu hình ứng dụng AI sẵn sàng cho production  
**💰 Nhận thức về chi phí:** Hiểu chi phí phát triển $80-150/month, chi phí production $300-3500/month

#### 💰 Cân nhắc chi phí cho triển khai AI

**Môi trường phát triển (Ước tính $80-150/tháng):**
- Azure OpenAI (Trả theo mức sử dụng): $0-50/month (tùy vào lượng token)
- AI Search (hạng cơ bản): $75/month
- Container Apps (Consumption): $0-20/month
- Storage (Standard): $1-5/month

**Môi trường sản xuất (Ước tính $300-3,500+/tháng):**
- Azure OpenAI (PTU for consistent performance): $3,000+/month HOẶC Trả theo mức sử dụng với khối lượng lớn
- AI Search (hạng Standard): $250/month
- Container Apps (Dedicated): $50-100/month
- Application Insights: $5-50/month
- Storage (Premium): $10-50/month

**💡 Mẹo tối ưu chi phí:**
- Sử dụng **Free Tier** Azure OpenAI để học (bao gồm 50,000 tokens/month)
...
**💡 Kết quả chương**: Triển khai ứng dụng nhiều dịch vụ phức tạp sử dụng mẫu hạ tầng tuỳ chỉnh

---

### 🎯 Chương 5: Giải pháp AI Đa tác nhân (Nâng cao)
**Yêu cầu tiên quyết**: Hoàn thành Chương 1-2  
**Thời lượng**: 2-3 hours  
**Độ phức tạp**: ⭐⭐⭐⭐

#### Những gì bạn sẽ học
- Mẫu kiến trúc đa tác nhân
- Điều phối và phối hợp tác nhân
- Triển khai AI sẵn sàng cho môi trường production
...
- **📖 Kiến trúc**: [Mẫu phối hợp đa tác nhân](docs/chapter-06-pre-deployment/coordination-patterns.md) - Mẫu
...
**💡 Kết quả chương**: Triển khai và quản lý một giải pháp AI đa tác nhân sẵn sàng cho production với các tác nhân Khách hàng và Tồn kho
...
- **✅ Xác thực**: [Kiểm tra trước triển khai](docs/chapter-06-pre-deployment/preflight-checks.md) - Script tự động

#### Bài tập thực hành
- Chạy script xác thực năng lực
- Tối ưu lựa chọn SKU cho chi phí
...
#### Tài nguyên học tập
- **🔧 Sự cố phổ biến**: [Sự cố phổ biến](docs/chapter-07-troubleshooting/common-issues.md) - FAQ và giải pháp
- **🕵️ Gỡ lỗi**: [Hướng dẫn Gỡ lỗi](docs/chapter-07-troubleshooting/debugging.md) - Chiến lược từng bước
- **🤖 Sự cố AI**: [Khắc phục sự cố AI](docs/chapter-07-troubleshooting/ai-troubleshooting.md) - Vấn đề dịch vụ AI

#### Bài tập thực hành
- Chẩn đoán lỗi triển khai
- Khắc phục vấn đề xác thực
- Gỡ lỗi kết nối dịch vụ AI

**💡 Kết quả chương**: Tự chẩn đoán và khắc phục các sự cố triển khai phổ biến
...
#### Tài nguyên học tập
- **🏭 Sản xuất**: [Thực tiễn AI cho sản xuất](docs/chapter-08-production/production-ai-practices.md) - Mẫu doanh nghiệp
...
- Triển khai lên môi trường production với quản trị phù hợp

**💡 Kết quả chương**: Triển khai ứng dụng sẵn sàng cho doanh nghiệp với đầy đủ khả năng production
...
> Tài liệu hội thảo hiện đang được phát triển và hoàn thiện. Các mô-đun cốt lõi đã hoạt động, nhưng một số phần nâng cao chưa hoàn chỉnh. Chúng tôi đang tích cực làm việc để hoàn thành toàn bộ nội dung. [Theo dõi tiến độ →](workshop/README.md)

### Tài liệu Hội thảo Tương tác
**Học thực hành toàn diện với công cụ trên trình duyệt và bài tập hướng dẫn**

Tài liệu hội thảo của chúng tôi cung cấp trải nghiệm học có cấu trúc, tương tác, bổ trợ cho chương trình giảng dạy theo chương ở trên. Hội thảo được thiết kế cho cả học tự học theo tốc độ riêng và các buổi do giảng viên hướng dẫn.

#### 🛠️ Tính năng Hội thảo
- **Giao diện trên trình duyệt**: Hội thảo hoàn chỉnh chạy bằng MkDocs với chức năng tìm kiếm, sao chép và các chủ đề
...
- **Phương pháp tiến triển**: Giới thiệu → Lựa chọn → Xác thực → Phân tích → Cấu hình → Tùy chỉnh → Dọn dẹp → Tổng kết
- **Môi trường DevContainer tương tác**: Công cụ và phụ thuộc được cấu hình sẵn

#### 📚 Cấu trúc Mô-đun Hội thảo
Hội thảo theo một **phương pháp 8 mô-đun tiến triển** đưa bạn từ khám phá đến thành thạo triển khai:
...
| **2. Validation** | Triển khai & Xác minh | Triển khai mẫu với `azd up` và xác minh hạ tầng hoạt động | 30 phút |
| **3. Deconstruction** | Hiểu cấu trúc | Sử dụng GitHub Copilot để khám phá kiến trúc mẫu, các file Bicep và tổ chức mã | 30 phút |
| **4. Configuration** | Tìm hiểu sâu azure.yaml | Thành thạo cấu hình `azure.yaml`, hooks vòng đời và biến môi trường | 30 phút |
| **5. Customization** | Làm cho nó thuộc về bạn | Kích hoạt AI Search, tracing, evaluation, và tùy chỉnh cho kịch bản của bạn | 45 phút |
| **6. Dọn dẹp** | Dọn dẹp | Hủy tài nguyên an toàn với `azd down --purge` | 15 phút |
| **7. Tổng kết** | Bước tiếp theo | Ôn lại thành tựu, các khái niệm chính và tiếp tục hành trình học của bạn | 15 phút |
...
- **Tối ưu cho Mở rộng**: Thiết kế triển khai hiệu quả về chi phí và hiệu năng
...
- **📋 Hướng dẫn theo Mô-đun**:
  ...
  - [4. Configuration](workshop/docs/instructions/4-Configure-AI-Template.md) - Thành thạo azure.yaml
  ...
  - [7. Wrap-up](workshop/docs/instructions/7-Wrap-up.md) - Ôn lại và bước tiếp theo
...
**Phù hợp cho**: Đào tạo doanh nghiệp, khóa học đại học, học tự học theo tốc độ riêng, và bootcamp dành cho nhà phát triển.
...
- **Hạ tầng như Mã (Infrastructure as Code)** - Quản lý tài nguyên Azure bằng Bicep hoặc Terraform  
- **Luồng công việc tích hợp** - Cung cấp, triển khai và giám sát ứng dụng liền mạch
...
- **Triển khai AI an toàn** - Các mẫu bảo mật tích hợp cho dịch vụ AI, khóa API và endpoints mô hình  
- **Mẫu AI cho Sản xuất** - Thực hành tốt nhất cho triển khai ứng dụng AI có thể mở rộng và tiết kiệm chi phí
- **Luồng công việc AI toàn diện** - Từ phát triển mô hình đến triển khai sản xuất với giám sát thích hợp
- **Tối ưu chi phí** - Phân bổ tài nguyên thông minh và chiến lược tự động mở rộng cho khối lượng công việc AI
- **Tích hợp Microsoft Foundry** - Kết nối liền mạch với danh mục mô hình và endpoints của Microsoft Foundry
...
| [**Get started with AI agents**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Chương 2 | ⭐⭐ | Foundry Agents + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights| Bên ngoài |
...
**Mẫu ứng dụng sẵn sàng cho sản xuất gắn với các chương học**
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Chương 5 | ⭐⭐⭐⭐ | Kiến trúc đa-tác nhân với các tác nhân Khách hàng và Kho hàng |
...
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Triển khai hoàn chỉnh sẵn sàng cho sản xuất với ARM templates
  - Kiến trúc đa-tác nhân (Khách hàng + Tác nhân Kho)
...
- [**FAQ**](resources/faq.md) - Các câu hỏi thường gặp được tổ chức theo chương học
- [**Study Guide**](resources/study-guide.md) - Bài tập thực hành toàn diện

### Hội thảo Thực hành
- [**AI Workshop Lab**](docs/chapter-02-ai-development/ai-workshop-lab.md) - Biến giải pháp AI của bạn có thể triển khai bằng AZD (2-3 giờ)
- [**Interactive Workshop**](workshop/README.md) - Bài tập hướng dẫn 8 mô-đun với MkDocs và GitHub Codespaces
...
Các vấn đề phổ biến người mới gặp và giải pháp ngay lập tức:
...
<details>
<summary><strong>❌ "Resource already exists" hoặc xung đột tên</strong></summary>
...
# Nếu bị mắc kẹt >30 phút, kiểm tra Azure Portal:
azd monitor
...
- **Sự cố liên quan đến AI:** [Khắc phục sự cố AI](docs/chapter-07-troubleshooting/ai-troubleshooting.md)
...
- [ ] **Chương 1**: Nền tảng & Bắt đầu nhanh ✅
- [ ] **Chương 2**: Phát triển lấy AI làm trọng tâm ✅  
...
2. **Kiểm tra kiến thức**: Xem lại phần Câu hỏi thường gặp của chương
...
- **Kinh nghiệm thực tế**: Đã triển khai các ứng dụng AI thực tế lên Azure
...
- **Câu hỏi học tập**: [Cộng đồng Microsoft Azure trên Discord](https://discord.gg/microsoft-azure) và [![Discord Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
- **Hỗ trợ dành cho AI**: Tham gia [![Discord Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
- **Tài liệu**: [Tài liệu chính thức về Azure Developer CLI](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)

### Những thông tin cộng đồng từ Discord Microsoft Foundry

**Kết quả khảo sát gần đây từ kênh #Azure:**
- **45%** nhà phát triển muốn sử dụng AZD cho khối lượng công việc AI
- **Thách thức hàng đầu**: Triển khai nhiều dịch vụ, quản lý thông tin xác thực, sẵn sàng cho môi trường sản xuất  
- **Yêu cầu nhiều nhất**: Mẫu chuyên cho AI, hướng dẫn khắc phục sự cố, các phương pháp hay nhất

**Tham gia cộng đồng của chúng tôi để:**
- Chia sẻ kinh nghiệm AZD + AI của bạn và nhận trợ giúp
- Truy cập các bản xem trước sớm của các mẫu AI mới
...
- **Báo cáo lỗi**: Cải thiện độ chính xác và tính rõ ràng
- **Tiêu chuẩn cộng đồng**: Tuân thủ các hướng dẫn cộng đồng bao gồm
...
Nhóm của chúng tôi cung cấp các khóa học toàn diện khác:
...
**Người mới**: Bắt đầu với [Chương 1: Nền tảng & Bắt đầu Nhanh](../..)  
**Nhà phát triển AI**: Chuyển đến [Chương 2: Phát triển ưu tiên AI](../..)  
**Những nhà phát triển có kinh nghiệm**: Bắt đầu với [Chương 3: Cấu hình & Xác thực](../..)
...
Tài liệu này đã được dịch bằng dịch vụ dịch thuật AI Co-op Translator (https://github.com/Azure/co-op-translator). Mặc dù chúng tôi cố gắng đảm bảo độ chính xác, xin lưu ý rằng các bản dịch tự động có thể chứa lỗi hoặc sai sót. Văn bản gốc bằng ngôn ngữ gốc nên được coi là nguồn chính thức. Đối với thông tin quan trọng, nên sử dụng dịch vụ dịch thuật chuyên nghiệp do con người thực hiện. Chúng tôi không chịu trách nhiệm đối với bất kỳ sự hiểu lầm hoặc giải thích sai nào phát sinh từ việc sử dụng bản dịch này.
