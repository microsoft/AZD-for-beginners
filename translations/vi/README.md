...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:04:04+00:00",
...
- **📖 Lý Thuyết**: [Các Nguyên Tắc Cơ Bản của AZD](docs/getting-started/azd-basics.md) - Các khái niệm và thuật ngữ cốt lõi
...
- Thực hiện chiến lược triển khai xanh-xanh
...
- **🛠️ Mẫu ARM**: [Gói Mẫu ARM](../../examples/retail-multiagent-arm-template) - Triển khai chỉ với một cú nhấp chuột
...
- **✅ Xác Thực**: [Kiểm Tra Trước](docs/pre-deployment/preflight-checks.md) - Các script tự động

#### Bài Tập Thực Hành
- Chạy các script xác thực dung lượng
...
- **Triển khai ứng dụng AI sản phẩm**: Sử dụng AZD với dịch vụ Azure AI Foundry
...
- **Triển khai AI an toàn** - Mô hình bảo mật tích hợp cho dịch vụ AI, khóa API và điểm cuối mô hình  
- **Mô hình AI sản phẩm** - Thực hành tốt nhất cho triển khai ứng dụng AI có khả năng mở rộng và hiệu quả về chi phí
...
**Mẫu ứng dụng sẵn sàng sản xuất được ánh xạ với các chương học tập**
...
- [Website tĩnh](../../examples/static-site) - Triển khai nội dung tĩnh
...
- **Hỗ trợ cụ thể về AI**: Tham gia [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- Đóng góp vào các thực hành tốt nhất triển khai AI  
- Ảnh hưởng đến sự phát triển tính năng AI + AZD trong tương lai  

### Đóng góp cho khóa học  
Chúng tôi hoan nghênh sự đóng góp! Vui lòng đọc [Hướng dẫn Đóng góp](CONTRIBUTING.md) để biết chi tiết về:  
