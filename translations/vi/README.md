...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T15:05:04+00:00",
...
- Xử lý sự cố triển khai AI cụ thể
...
- **🛠️ ARM Templates**: [Gói ARM Template](../../examples/retail-multiagent-arm-template) - Triển khai một lần nhấn
...
- **✅ Xác Thực**: [Kiểm Tra Trước Triển Khai](docs/pre-deployment/preflight-checks.md) - Các script tự động

#### Bài Tập Thực Hành
- Chạy script xác thực dung lượng
- Tối ưu hóa lựa chọn SKU để tiết kiệm chi phí
- Thực hiện kiểm tra trước triển khai tự động
...
- **🤖 Vấn Đề AI**: [Xử Lý Sự Cố AI](docs/troubleshooting/ai-troubleshooting.md) - Các vấn đề dịch vụ AI
...
### 🏢 Chương 8: Các Mẫu Sản Xuất & Doanh Nghiệp
...
- **Giao diện trên trình duyệt**: Workshop được hỗ trợ bởi MkDocs với tính năng tìm kiếm, sao chép và tùy chỉnh giao diện
...
- **Thành thạo kiến trúc đa tác nhân**: Triển khai giải pháp AI phối hợp
...
- **Triển khai AI an toàn** - Mô hình bảo mật tích hợp cho các dịch vụ AI, khóa API và điểm cuối mô hình  
- **Mô hình AI sản xuất** - Các thực hành tốt nhất cho triển khai ứng dụng AI có khả năng mở rộng và hiệu quả về chi phí
- **Luồng công việc AI từ đầu đến cuối** - Từ phát triển mô hình đến triển khai sản phẩm với giám sát phù hợp
...
|----------|---------|------------|----------|
| [**Bắt đầu với AI chat**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 2 | ⭐⭐ | AzureOpenAI + API Suy luận Mô hình Azure AI + Tìm kiếm Azure AI + Ứng dụng Container Azure + Application Insights |
| [**Bắt đầu với AI agents**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Chương 2 | ⭐⭐ | Dịch vụ Tác nhân Azure AI + AzureOpenAI + Tìm kiếm Azure AI + Ứng dụng Container Azure + Application Insights|
| [**Tự động hóa quy trình làm việc đa tác nhân**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 5 | ⭐⭐⭐ | AzureOpenAI + Dịch vụ Tác nhân Azure AI + Semantic Kernel + Azure CosmosDB + Ứng dụng Container Azure|
| [**Tạo tài liệu từ dữ liệu của bạn**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 4 | ⭐⭐⭐  | AzureOpenAI + Tìm kiếm Azure AI + Dịch vụ Azure AI + Azure CosmosDB|
| [**Cải thiện cuộc họp khách hàng với tác nhân**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 5 | ⭐⭐⭐| AzureOpenAI + Tìm kiếm Azure AI + Azure CosmosDB + Cơ sở dữ liệu SQL Azure |
| [**Hiện đại hóa mã của bạn với tác nhân**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 5 | ⭐⭐⭐ | AzureOpenAI + Dịch vụ Tác nhân Azure + Semantic Kernel + Azure CosmosDB + Ứng dụng Container Azure|
| [**Xây dựng tác nhân hội thoại của bạn**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 4 | ⭐⭐⭐ | AI Language + AzureOpenAI + Tìm kiếm AI + Lưu trữ Azure + Azure Container Registry|
| [**Khám phá thông tin từ dữ liệu hội thoại**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 8 | ⭐⭐⭐ | AzureOpenAI + Tìm kiếm AI + Semantic Kernel + Dịch vụ Tác nhân Azure + Hiểu nội dung AI|
| [**Xử lý nội dung đa phương tiện**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Chương 8 | ⭐⭐⭐⭐ | AzureOpenAI + Hiểu nội dung Azure + Azure CosmosDB + Ứng dụng Container Azure|

### Nổi bật: Kịch bản học tập hoàn chỉnh
**Mẫu ứng dụng sẵn sàng sản xuất được ánh xạ tới các chương học tập**
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | Chương 2 | ⭐⭐ | Triển khai RAG với Tìm kiếm Azure AI |
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Chương 5 | ⭐⭐⭐⭐ | Kiến trúc đa tác nhân với Tác nhân Khách hàng và Tác nhân Hàng tồn kho |
...
- [**Thư viện AZD Tuyệt vời**](https://azure.github.io/awesome-azd/) - Mẫu đóng góp từ cộng đồng
...
### Tham khảo nhanh
- [**Bảng lệnh Cheat Sheet**](resources/cheat-sheet.md) - Các lệnh azd cần thiết được tổ chức theo chương
...
- **Dịch thuật**: Hỗ trợ duy trì tính năng đa ngôn ngữ  
...
Nhóm của chúng tôi cung cấp các khóa học học tập toàn diện khác:  
...
- [Tác nhân AI cho Người mới bắt đầu](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)  
...
**Người mới bắt đầu**: Bắt đầu với [Chương 1: Nền tảng & Khởi động nhanh](../..)  
