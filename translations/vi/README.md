...
Dựa trên những hiểu biết từ cộng đồng Microsoft Foundry Discord, **45% nhà phát triển muốn sử dụng AZD cho các khối lượng công việc AI** nhưng gặp phải các thách thức với:
- Kiến trúc AI đa dịch vụ phức tạp
- Thực hành tốt nhất cho triển khai AI trong môi trường sản xuất  
...
**Yêu cầu trước**: Có đăng ký Azure, kiến thức cơ bản về dòng lệnh  
...
- **📖 Lý Thuyết**: [AZD Cơ Bản](docs/getting-started/azd-basics.md) - Khái niệm và thuật ngữ cốt lõi
- **⚙️ Cài Đặt**: [Hướng Dẫn Cài Đặt & Thiết Lập](docs/getting-started/installation.md) - Hướng dẫn theo nền tảng
...
**📈 Trình Độ Sau Khi Học:** Có thể triển khai ứng dụng cơ bản độc lập
...
- **🛠️ Workshop**: [Phòng Thí Nghiệm AI](docs/microsoft-foundry/ai-workshop-lab.md) - Chuẩn bị giải pháp AI sẵn sàng với AZD
- **🎥 Hướng Dẫn Tương Tác**: [Tài Liệu Workshop](workshop/README.md) - Học qua trình duyệt với MkDocs * Môi trường DevContainer
- **📋 Mẫu**: [Mẫu Microsoft Foundry Nổi Bật](../..)
...
**📈 Trình Độ Sau Khi Học:** Có thể triển khai và cấu hình ứng dụng AI sẵn sàng cho sản xuất  
...
- Azure OpenAI (PTU cho hiệu suất ổn định): $3,000+/tháng HOẶC Trả theo mức sử dụng với khối lượng lớn
- AI Search (Cấp độ chuẩn): $250/tháng
...
- Bắt đầu với thanh toán theo mức tiêu thụ, nâng cấp lên PTU chỉ cho sản xuất
- Dùng `azd provision --preview` để ước tính chi phí trước khi triển khai
- Bật tự động mở rộng: chỉ trả tiền cho mức sử dụng thực tế
...
- **🛠️ ARM Templates**: [Gói mẫu ARM](../../examples/retail-multiagent-arm-template) - Triển khai chỉ với một cú nhấp chuột
...
**💡 Kết quả chương học**: Triển khai và quản lý giải pháp AI đa tác nhân sẵn sàng sản xuất với các tác nhân Khách hàng và Kho hàng
...
- **✅ Xác thực**: [Kiểm tra trước khi bay](docs/pre-deployment/preflight-checks.md) - Kịch bản tự động

#### Bài tập thực hành
- Chạy các kịch bản xác thực năng lực
...
#### Tài nguyên học tập
- **🔧 Vấn đề phổ biến**: [Vấn đề phổ biến](docs/troubleshooting/common-issues.md) - Câu hỏi thường gặp và giải pháp
- **🕵️ Gỡ lỗi**: [Hướng dẫn gỡ lỗi](docs/troubleshooting/debugging.md) - Chiến lược từng bước
- **🤖 Vấn đề AI**: [Khắc phục sự cố AI](docs/troubleshooting/ai-troubleshooting.md) - Vấn đề dịch vụ AI
...
**💡 Kết quả chương học**: Tự chẩn đoán và giải quyết các vấn đề triển khai phổ biến
...
**💡 Kết quả chương học**: Triển khai ứng dụng sẵn sàng doanh nghiệp với đầy đủ khả năng sản xuất
...
**Phù hợp cho**: Đào tạo doanh nghiệp, khóa học đại học, học tự học và bootcamp lập trình viên.
...
- **Mẫu sẵn sàng AI** - Mẫu cấu hình sẵn cho Azure OpenAI, Cognitive Services và khối lượng công việc ML
...
- **Quy trình AI đầu-cuối** - Từ phát triển mô hình đến triển khai sản xuất với giám sát phù hợp
...
| [**Khởi động nhanh OpenAI Chat App**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Chương 2 | ⭐ | AzureOpenAI + Container Apps + Application Insights | Bên ngoài |
...
- [Pipeline ML doanh nghiệp](https://github.com/Azure-Samples/mlops-v2) - Mẫu ML sẵn sàng sản xuất

### Bộ sưu tập mẫu bên ngoài
- [**Thư viện mẫu AZD chính thức**](https://azure.github.io/awesome-azd/) - Bộ sưu tập mẫu chính thức và cộng đồng được tuyển chọn
...
- [**Thư mục Ví dụ**](examples/README.md) - Ví dụ học tập nội bộ với giải thích chi tiết
...
### Hội thảo thực hành
- [**Phòng thí nghiệm Hội thảo AI**](docs/microsoft-foundry/ai-workshop-lab.md) - Làm cho giải pháp AI của bạn có thể triển khai bằng AZD (2-3 giờ)
...
- **Vấn đề AI cụ thể:** [Khắc phục sự cố AI](docs/troubleshooting/ai-troubleshooting.md)
...
3. **Thảo luận cộng đồng**: Chia sẻ kinh nghiệm trên Azure Discord
...
- **Trợ giúp AI cụ thể**: Tham gia [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- Đóng góp vào thực hành tốt nhất triển khai AI
...
- **Tiêu chuẩn cộng đồng**: Tuân thủ hướng dẫn cộng đồng bao gồm
