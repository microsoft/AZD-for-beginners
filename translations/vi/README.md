...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T17:39:19+00:00",
...
1. **Tạo Fork kho lưu trữ**: Nhấp vào [![Forks trên GitHub](https://img.shields.io/github/forks/microsoft/azd-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/azd-for-beginners/fork)
2. **Clone kho lưu trữ**: `git clone https://github.com/microsoft/azd-for-beginners.git`
3. **Tham gia Cộng đồng**: [Cộng đồng Discord Azure](https://discord.com/invite/ByRwuEEgH4) để nhận hỗ trợ chuyên gia
4. **Chọn Lộ trình Học**: Chọn một chương dưới đây phù hợp với trình độ của bạn
...
Làm chủ Azure Developer CLI (azd) thông qua các chương có cấu trúc được thiết kế để học tiến bộ. **Tập trung đặc biệt vào triển khai ứng dụng AI với tích hợp Microsoft Foundry.**

### Tại sao Khóa học này Quan trọng đối với Nhà phát triển Hiện đại

Dựa trên thông tin từ cộng đồng Discord Microsoft Foundry, **45% nhà phát triển muốn sử dụng AZD cho khối lượng công việc AI** nhưng gặp các thách thức về:
- Kiến trúc AI phức tạp nhiều dịch vụ
- Các thực hành tốt nhất cho triển khai AI lên sản xuất  
...
- **Làm chủ các Kiến thức Cơ bản của AZD**: Các khái niệm cốt lõi, cài đặt và cấu hình
- **Triển khai Ứng dụng AI**: Sử dụng AZD với các dịch vụ Microsoft Foundry
- **Áp dụng Cơ sở hạ tầng như Mã**: Quản lý tài nguyên Azure bằng các mẫu Bicep
...
- **📖 Lý thuyết**: [AZD Cơ bản](docs/getting-started/azd-basics.md) - Các khái niệm cốt lõi và thuật ngữ
...
### 🤖 Chương 2: Phát triển Ưu tiên AI (Đề xuất cho Nhà phát triển AI)
...
- Triển khai ứng dụng được hỗ trợ bởi AI
...
- **🛠️ Xưởng thực hành**: [Phòng thí nghiệm AI](docs/microsoft-foundry/ai-workshop-lab.md) - Chuẩn bị giải pháp AI của bạn sẵn sàng với AZD
- **🎥 Hướng dẫn Tương tác**: [Tài liệu Xưởng](workshop/README.md) - Học trên trình duyệt với MkDocs * DevContainer Environment
...
**💡 Kết quả Chương**: Triển khai và cấu hình một ứng dụng chat được hỗ trợ AI với khả năng RAG
...
#### 💰 Các Xem Xét Chi phí cho Triển khai AI

**Môi trường Phát triển (Ước tính $80-150/tháng):**
- Azure OpenAI (Trả theo sử dụng): $0-50/tháng (tùy theo lượng token)
...
- Azure OpenAI (PTU cho hiệu suất ổn định): $3,000+/tháng HOẶC Trả theo sử dụng với khối lượng lớn
...
**💡 Mẹo Tối ưu Chi phí:**
- Sử dụng **Tầng Miễn phí** Azure OpenAI để học (bao gồm 50.000 tokens/tháng)
...
- Bật tự động co giãn: chỉ trả cho lượng sử dụng thực tế
...
# Theo dõi chi phí thực tế trong Cổng Azure
...
### 🏗️ Chương 4: Cơ sở hạ tầng như Mã & Triển khai
**Điều kiện tiên quyết**: Đã hoàn thành Chương 1-3  
**Thời lượng**: 1-1.5 giờ  
**Độ phức tạp**: ⭐⭐⭐

#### Những gì bạn sẽ học
- Các mẫu triển khai nâng cao
- Cơ sở hạ tầng như Mã với Bicep
...
- **📝 Ví dụ**: [Ví dụ Ứng dụng Container](../../examples/container-app) - Triển khai container
...
**💡 Kết quả Chương**: Triển khai ứng dụng phức tạp nhiều dịch vụ bằng các mẫu hạ tầng tùy chỉnh

---

### 🎯 Chương 5: Giải pháp AI Đa Tác nhân (Nâng cao)
**Điều kiện tiên quyết**: Đã hoàn thành Chương 1-2  
**Thời lượng**: 2-3 giờ  
**Độ phức tạp**: ⭐⭐⭐⭐
...
- Các triển khai AI sẵn sàng cho sản xuất

#### Tài nguyên Học tập
- **🤖 Dự án Nổi bật**: [Giải pháp AI Đa Tác nhân cho Bán lẻ](examples/retail-scenario.md) - Triển khai hoàn chỉnh
- **🛠️ ARM Templates**: [ARM Template Package](../../examples/retail-multiagent-arm-template) - Triển khai chỉ với một cú nhấp
- **📖 Architecture**: [Multi-agent coordination patterns](/docs/pre-deployment/coordination-patterns.md) - Các mẫu
...
**💡 Chapter Outcome**: Triển khai và quản lý một giải pháp AI đa tác nhân sẵn sàng cho sản xuất với các tác nhân Customer và Inventory
...
#### Tài nguyên học tập
- **📊 Lập kế hoạch**: [Capacity Planning](docs/pre-deployment/capacity-planning.md) - Xác thực tài nguyên
- **💰 Lựa chọn**: [SKU Selection](docs/pre-deployment/sku-selection.md) - Lựa chọn tiết kiệm chi phí
- **✅ Xác thực**: [Pre-flight Checks](docs/pre-deployment/preflight-checks.md) - Script tự động

#### Bài tập thực hành
- Chạy các script xác thực công suất
- Tối ưu lựa chọn SKU theo chi phí
- Thiết lập kiểm tra tự động trước khi triển khai

**💡 Chapter Outcome**: Xác thực và tối ưu triển khai trước khi thực hiện
...
#### Tài nguyên học tập
- **🔧 Sự cố phổ biến**: [Common Issues](docs/troubleshooting/common-issues.md) - Câu hỏi thường gặp và giải pháp
- **🕵️ Gỡ lỗi**: [Debugging Guide](docs/troubleshooting/debugging.md) - Chiến lược từng bước
- **🤖 Sự cố AI**: [AI-Specific Troubleshooting](docs/troubleshooting/ai-troubleshooting.md) - Vấn đề dịch vụ AI

#### Bài tập thực hành
- Chẩn đoán sự cố triển khai
- Giải quyết các vấn đề xác thực
- Gỡ lỗi kết nối dịch vụ AI

**💡 Chapter Outcome**: Tự chủ chẩn đoán và giải quyết các sự cố triển khai phổ biến
...
#### Tài nguyên học tập
- **🏭 Sản xuất**: [Production AI Best Practices](docs/microsoft-foundry/production-ai-practices.md) - Mẫu doanh nghiệp
- **📝 Ví dụ**: [Microservices Example](../../examples/microservices) - Kiến trúc phức tạp
- **📊 Giám sát**: [Application Insights integration](docs/pre-deployment/application-insights.md) - Giám sát

#### Bài tập thực hành
- Triển khai các mẫu bảo mật doanh nghiệp
- Thiết lập giám sát toàn diện
- Triển khai vào môi trường sản xuất với quản trị phù hợp

**💡 Chapter Outcome**: Triển khai các ứng dụng sẵn sàng cho doanh nghiệp với đầy đủ khả năng sản xuất
...
> Tài liệu hội thảo hiện đang được phát triển và hoàn thiện. Các mô-đun cốt lõi hoạt động, nhưng một số phần nâng cao chưa hoàn thiện. Chúng tôi đang tích cực hoàn thành toàn bộ nội dung. [Theo dõi tiến độ →](workshop/README.md)

### Tài liệu hội thảo tương tác
**Trải nghiệm học tập thực hành toàn diện với công cụ dựa trên trình duyệt và bài tập được hướng dẫn**

Tài liệu hội thảo của chúng tôi cung cấp một trải nghiệm học tập tương tác, có cấu trúc, bổ sung cho chương trình theo chương ở trên. Hội thảo được thiết kế cho cả việc tự học theo tiến độ và các buổi có giảng viên hướng dẫn.

#### 🛠️ Tính năng hội thảo
- **Giao diện trên trình duyệt**: Hoàn chỉnh hội thảo chạy bằng MkDocs với tìm kiếm, sao chép và các tính năng giao diện
...
- **Khám phá → Triển khai → Tùy chỉnh**: Phương pháp luận tiến bộ
...
1. **Giai đoạn Khám phá** (45 phút)
   ...
   - Xem lại yêu cầu và các điều kiện tiên quyết để triển khai
...
3. **Giai đoạn Tùy chỉnh** (45 phút)
   - Sửa đổi ứng dụng cho các trường hợp sử dụng cụ thể
   - Tối ưu cho triển khai sản xuất
   - Thiết lập giám sát và quản lý chi phí
...
- **Triển khai Ứng dụng AI Sản xuất**: Sử dụng AZD với các dịch vụ Microsoft Foundry
- **Thành thạo Kiến trúc Đa tác nhân**: Triển khai các giải pháp điều phối tác nhân AI
- **Áp dụng Các Thực hành Bảo mật**: Cấu hình xác thực và điều khiển truy cập
- **Tối ưu cho qui mô**: Thiết kế triển khai hiệu quả về chi phí và hiệu năng
...
- **📋 Hướng dẫn từng bước**: [Guided Exercises](../../workshop/docs/instructions) - Hướng dẫn chi tiết
- **🛠️ Phòng lab AI Workshop**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Bài tập tập trung vào AI
- **💡 Bắt đầu nhanh**: [Workshop Setup Guide](workshop/README.md#quick-start) - Cấu hình môi trường

**Phù hợp cho**: Đào tạo doanh nghiệp, khóa học đại học, học tự học theo tiến độ, và các khóa đào tạo lập trình viên.

---

## 📖 Azure Developer CLI là gì?

Azure Developer CLI (azd) là một giao diện dòng lệnh hướng đến nhà phát triển giúp tăng tốc quá trình xây dựng và triển khai ứng dụng lên Azure. Nó cung cấp:
...
- **Mẫu sẵn sàng cho AI** - Mẫu cấu hình sẵn cho Azure OpenAI, Cognitive Services và khối lượng công việc ML
- **Triển khai AI an toàn** - Các mẫu bảo mật tích hợp cho dịch vụ AI, API keys và các endpoint mô hình  
- **Mẫu AI cho sản xuất** - Các thực hành tốt nhất cho triển khai ứng dụng AI có khả năng mở rộng và hiệu quả chi phí
...
- **Tích hợp Microsoft Foundry** - Kết nối liền mạch với danh mục mô hình và endpoint của Microsoft Foundry
...
**Bắt đầu ở đây nếu bạn đang triển khai các ứng dụng AI!**

> **Lưu ý:** Những mẫu này minh họa các mẫu AI khác nhau. Một số là Azure Samples bên ngoài, vài mẫu khác là triển khai cục bộ.
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Chương 5 | ⭐⭐⭐⭐ | Kiến trúc đa tác nhân với các tác nhân Customer và Inventory |
...
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Triển khai hoàn chỉnh sẵn sàng cho sản xuất với các ARM template
  - Kiến trúc đa tác nhân (Customer + Inventory agents)
  - Giám sát và đánh giá toàn diện
  - Triển khai một cú nhấp qua ARM template
...
- [**Container App Examples**](examples/container-app/README.md) - Hướng dẫn đầy đủ về triển khai container
  - [Simple Flask API](../../examples/container-app/simple-flask-api) - REST API cơ bản với khả năng scale-to-zero
  - [Microservices Architecture](../../examples/container-app/microservices) - Triển khai đa dịch vụ sẵn sàng cho sản xuất
  - Các mẫu Quick Start, Production và Advanced
...
### Hội thảo thực hành
- [**Phòng thí nghiệm Hội thảo AI**](docs/microsoft-foundry/ai-workshop-lab.md) - Làm cho giải pháp AI của bạn có thể triển khai bằng AZD (2-3 hours)
- [**Hướng dẫn Hội thảo Tương tác**](workshop/README.md) - Hội thảo trên trình duyệt với MkDocs và Môi trường DevContainer
- [**Lộ trình học có cấu trúc**](../../workshop/docs/instructions) -7-bước bài tập hướng dẫn (Khám phá → Triển khai → Tùy chỉnh)
- [**AZD Cho Người mới bắt đầu Workshop**](workshop/README.md) - Tài liệu hội thảo thực hành hoàn chỉnh với tích hợp GitHub Codespaces
...
**Những vấn đề phổ biến mà người mới gặp phải và giải pháp ngay lập tức:**
...
```bash
# Lựa chọn 1: Dọn sạch và thử lại
azd down --force --purge
azd up
...
```bash
# AZD tạo các tên duy nhất, nhưng nếu có xung đột:
azd down --force --purge
...
- **Hướng dẫn Các Vấn đề Phổ biến:** [Giải pháp chi tiết](docs/troubleshooting/common-issues.md)
- **Vấn đề dành cho AI:** [Khắc phục sự cố AI](docs/troubleshooting/ai-troubleshooting.md)
...
# Bạn cần ít nhất vai trò "Contributor"
# Yêu cầu quản trị viên Azure của bạn cấp quyền:
# - Contributor (cho các tài nguyên)
# - User Access Administrator (cho việc chỉ định vai trò)
```
</details>
...
- [ ] **Chương 7**: Khắc phục sự cố & Gỡ lỗi ✅
- [ ] **Chương 8**: Môi trường sản xuất & Mẫu doanh nghiệp ✅
...
- **Kỹ năng chuyên nghiệp**: Khả năng triển khai đạt chuẩn doanh nghiệp  
- **Sự công nhận từ cộng đồng**: Thành viên tích cực của cộng đồng nhà phát triển Azure
- **Phát triển nghề nghiệp**: Kỹ năng triển khai AZD và AI được săn đón
...
- **Được yêu cầu nhiều nhất**: Mẫu chuyên cho AI, hướng dẫn khắc phục sự cố, các thực hành tốt nhất

**Tham gia cộng đồng của chúng tôi để:**
- Chia sẻ kinh nghiệm AZD + AI và nhận hỗ trợ
- Truy cập bản xem trước sớm của các mẫu AI mới
- Đóng góp cho các thực hành tốt nhất về triển khai AI
...
- **Báo cáo lỗi**: Cải thiện tính chính xác và rõ ràng
- **Tiêu chuẩn cộng đồng**: Tuân theo các hướng dẫn cộng đồng bao dung của chúng tôi
...
### Các Tài nguyên Học tập Microsoft liên quan
...
[![Data Science cho Người mới bắt đầu](https://img.shields.io/badge/Data%20Science%20for%20Beginners-84CC16?style=for-the-badge&labelColor=E5E7EB&color=84CC16)](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
