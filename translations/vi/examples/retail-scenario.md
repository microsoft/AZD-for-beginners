...
- **⬅️ Yêu Cầu Trước**: [Chương 2: Phát triển Ưu tiên AI](../docs/microsoft-foundry/microsoft-foundry-integration.md)
- **➡️ Chương Tiếp Theo**: [Chương 6: Xác thực Trước Triển khai](../docs/pre-deployment/capacity-planning.md)
- **🚀 ARM Templates**: [Gói Triển khai](retail-multiagent-arm-template/README.md)

> **⚠️ HƯỚNG DẪN KIẾN TRÚC - KHÔNG PHẢI TRIỂN KHAI HOẠT ĐỘNG**  
> Tài liệu này cung cấp một **bản thiết kế kiến trúc toàn diện** cho việc xây dựng một hệ thống đa tác nhân.  
> **Những gì tồn tại:** ARM template để triển khai hạ tầng (Microsoft Foundry Models, AI Search, Container Apps, v.v.)  
> **Những gì bạn phải xây dựng:** Mã tác nhân, logic định tuyến, giao diện frontend, pipeline dữ liệu (ước tính 80-120 giờ)  
>  
...
> - ❌ KHÔNG phải một ứng dụng sẵn sàng chạy (cần phát triển đáng kể)

## Tổng quan

**Mục tiêu học tập:** Hiểu kiến trúc, các quyết định thiết kế và phương pháp triển khai để xây dựng một chatbot hỗ trợ khách hàng đa tác nhân sẵn sàng cho môi trường sản xuất cho nhà bán lẻ, với khả năng AI tinh vi bao gồm quản lý tồn kho, xử lý tài liệu và tương tác thông minh với khách hàng.
...
- Các lưu ý triển khai sản xuất và tối ưu chi phí

## Mục tiêu Kiến trúc

**Trọng tâm giáo dục:** Kiến trúc này minh họa các mẫu doanh nghiệp cho hệ thống đa tác nhân.

### Yêu cầu Hệ thống (Cho Việc Triển khai của Bạn)
...
- **Triển khai đa mô hình** với kế hoạch dung lượng phù hợp (gpt-4.1, gpt-4.1-mini, embeddings trên nhiều vùng)
...
- **Bảo mật chuẩn sản xuất** với xác thực red teaming (quét lỗ hổng + đánh giá tác nhân)

### Những Gì Hướng Dẫn Này Cung Cấp

✅ **Mẫu Kiến trúc** - Thiết kế đã được kiểm chứng cho hệ thống đa tác nhân có khả năng mở rộng  
...
❌ **Không Bao Gồm** - Ứng dụng hoàn chỉnh hoạt động ngay (cần nỗ lực phát triển)
...
**Mục tiêu:** Cấp phát tài nguyên Azure bằng ARM template
...
- ✅ Microsoft Foundry Models (3 vùng: gpt-4.1, gpt-4.1-mini, embeddings)
...
1. **Triển khai Tác nhân** (30-40 giờ)
   ...
   - Tác nhân dịch vụ khách hàng với gpt-4.1
   - Tác nhân tồn kho với gpt-4.1-mini
...
graph TB
    ...
    Router --> InvAgent[Đại lý Kho<br/>Quản lý Tồn kho]
    
    CustomerAgent --> OpenAI1[Mô hình Microsoft Foundry<br/>gpt-4.1<br/>Miền Đông Hoa Kỳ 2]
    InvAgent --> OpenAI2[Mô hình Microsoft Foundry<br/>gpt-4.1-mini<br/>Miền Tây Hoa Kỳ 2]
    
    CustomerAgent --> AISearch[Tìm kiếm AI Azure<br/>Danh mục Sản phẩm]
    CustomerAgent --> BingSearch[API Tìm kiếm Bing<br/>Thông tin theo thời gian thực]
    InvAgent --> AISearch
    
    AISearch --> Storage[Lưu trữ Azure<br/>Tài liệu & Tệp]
    Storage --> DocIntel[Trí tuệ Tài liệu<br/>Xử lý Nội dung]
    
    OpenAI1 --> Embeddings[Embedding Văn bản<br/>ada-002<br/>Pháp Trung tâm]
    OpenAI2 --> Embeddings
    ...
    GraderModel[gpt-4.1 Bộ chấm điểm<br/>Bắc Thụy Sĩ] --> Evaluation[Khuôn khổ Đánh giá]
    RedTeam[Trình Quét Đội Đỏ] --> SecurityReports[Báo cáo Bảo mật]
...
|-----------|---------|------------|---------|
| **Giao diện Web** | Giao diện người dùng cho tương tác với khách hàng | Container Apps | Khu vực chính |
| **Bộ định tuyến Tác nhân** | Định tuyến yêu cầu đến tác nhân phù hợp | Container Apps | Khu vực chính |
| **Tác nhân Khách hàng** | Xử lý câu hỏi dịch vụ khách hàng | Container Apps + gpt-4.1 | Khu vực chính |
| **Tác nhân Tồn kho** | Quản lý tồn kho và thực hiện đơn hàng | Container Apps + gpt-4.1-mini | Khu vực chính |
| **Microsoft Foundry Models** | Inference LLM cho các tác nhân | Azure AI Services | Đa vùng |
| **AI Search** | Tìm kiếm vector và RAG | AI Search Service | Khu vực chính |
| **Tài khoản Lưu trữ** | Lưu trữ tệp tải lên và tài liệu | Blob Storage | Khu vực chính |
| **Application Insights** | Giám sát và telemetri | Monitor | Khu vực chính |
| **Mô hình Grader** | Hệ thống đánh giá tác nhân | Microsoft Foundry Models | Khu vực phụ |

## 📁 Cấu trúc Dự án

> **📍 Chú thích Trạng thái:**  
> ✅ = Tồn tại trong repository  
> 📝 = Triển khai tham chiếu (ví dụ mã trong tài liệu này)  
> 🔨 = Bạn cần tạo cái này
...
**Những gì bạn nhận được:** Tất cả dịch vụ Azure được cấp phát và sẵn sàng cho phát triển
...
**Kết quả mong đợi:**
- ✅ Dịch vụ Microsoft Foundry Models được triển khai (3 vùng)
...
3. Hiểu quyết định thiết kế và những đánh đổi
...
- ✅ Ước tính công sức thực tế
- ✅ Kế hoạch triển khai

### Tùy chọn 3: Xây dựng Hệ thống Hoàn chỉnh (80-120 giờ)

**Những gì bạn nhận được:** Giải pháp đa tác nhân sẵn sàng cho sản xuất

1. **Giai đoạn 1:** Triển khai hạ tầng (đã nêu ở trên)
2. **Giai đoạn 2:** Triển khai các tác nhân sử dụng ví dụ mã bên dưới (30-40 giờ)
...
## 📚 Tham chiếu Kiến trúc & Hướng dẫn Triển khai

Các phần sau cung cấp các mẫu kiến trúc chi tiết, ví dụ cấu hình và mã tham chiếu để hướng dẫn việc triển khai của bạn.

## Yêu cầu Cấu hình Ban đầu

### 1. Nhiều Tác nhân & Cấu hình

**Mục tiêu**: Triển khai 2 tác nhân chuyên biệt - "Tác nhân Khách hàng" (dịch vụ khách hàng) và "Tác nhân Tồn kho" (quản lý kho)

> **📝 Lưu ý:** Các cấu hình azure.yaml và Bicep dưới đây là **ví dụ tham khảo** cho thấy cách cấu trúc triển khai đa tác nhân. Bạn sẽ cần tạo các tệp này và các triển khai tác nhân tương ứng.
...
**Mục tiêu**: Triển khai mô hình chat (Khách hàng), mô hình embeddings (tìm kiếm), và mô hình suy luận (grader) với quản lý quota phù hợp
...
**Mục tiêu**: Cấu hình AI Search cho cập nhật dữ liệu và lập chỉ mục tự động
...
#### Thiết lập Dữ liệu Sau Cấp phát:
...
**Mục tiêu**: Cấu hình tác nhân để sử dụng AI Search như một công cụ làm nền tảng
...
class CustomerAgent:
    ...
    async def process_query(self, user_query: str) -> str:
        # Trước tiên, tìm kiếm ngữ cảnh liên quan
...
**Mục tiêu**: Cho phép tác nhân xử lý tệp tải lên (sách hướng dẫn, tài liệu) cho ngữ cảnh RAG
...
**Mục tiêu**: Thêm khả năng Bing Search cho thông tin thời gian thực
...
**Mục tiêu**: Kiểm thử bảo mật tự động cho tác nhân và mô hình
...
class RedTeamScanner:
    ...
    async def _send_test_prompt(self, prompt: str) -> str:
        ...
        # Phần triển khai sẽ gửi yêu cầu HTTP tới điểm cuối của agent
...
# Xây dựng image tùy chỉnh với biến môi trường
docker build \
...
#### 1. Hạn mức Container Apps

**Vấn đề**: Triển khai thất bại do hạn mức vùng
...
def check_model_versions():
    ...
    # Điều này sẽ gọi API Microsoft Foundry Models để lấy các phiên bản hiện tại
    latest_versions = {
        "gpt-4.1": "2024-11-20",
...
**Vấn đề**: Làm thế nào tích hợp mô hình fine-tuned vào triển khai AZD
...
class ModelRouter:
    ...
    def estimate_cost_savings(self, usage_patterns: dict):
        ...
        # Việc triển khai sẽ tính toán mức tiết kiệm tiềm năng
        pass
```

**Tác động Chi phí:**
- **Tiết kiệm**: Giảm chi phí 60-80% cho các truy vấn đơn giản
- **Đánh đổi**: Tăng độ trễ nhẹ cho logic định tuyến
- **Giám sát**: Theo dõi độ chính xác so với số liệu chi phí

#### H: Tôi có thể khởi chạy job fine-tuning từ mẫu azd không?

**Đ: Có, sử dụng hook sau khi cấp phát:**
...
> Không giống các ví dụ mã mang tính khái niệm ở trên, mẫu ARM là một **triển khai hạ tầng thực sự, hoạt động** được bao gồm trong kho chứa này.

### Mẫu Này Thực Sự Làm Gì

Mẫu ARM tại [`retail-multiagent-arm-template/`](../../../examples/retail-multiagent-arm-template) cung cấp **tất cả hạ tầng Azure** cần thiết cho hệ thống đa-agent. Đây là **thành phần duy nhất sẵn sàng chạy** - mọi thứ khác yêu cầu phát triển.
...
- ✅ **Môi trường Container Apps** với tự động mở rộng
...
- ✅ **Document Intelligence** để xử lý file
- ✅ **Bing Search API** để lấy thông tin thời gian thực

#### **Chế Độ Triển Khai**
| Chế Độ | Trường Hợp Sử Dụng | Tài Nguyên | Chi Phí Ước Tính/Tháng |
|------|----------|-----------|---------------------|
| **Minimal** | Phát triển, Kiểm thử | SKU cơ bản, 1 vùng | $100-370 |
| **Standard** | Sản xuất, Quy mô vừa phải | SKU tiêu chuẩn, Đa vùng | $420-1,450 |
| **Premium** | Doanh nghiệp, Quy mô lớn | SKU cao cấp, cấu hình HA | $1,150-3,500 |

### 🎯 Tùy Chọn Triển Khai Nhanh

#### Tùy Chọn 1: Triển Khai Azure Một-Click
...
# Cho phép thực thi script triển khai
chmod +x deploy.sh

# Triển khai với cài đặt mặc định (chế độ tiêu chuẩn)
./deploy.sh -g myResourceGroup

# Triển khai cho môi trường sản xuất với tính năng cao cấp
./deploy.sh -g myProdRG -e prod -m premium -l eastus2

# Triển khai phiên bản tối giản cho phát triển
...
Mẫu ARM đảm nhiệm việc cung cấp hạ tầng. Sau khi triển khai:
...
- ✅ **Xác thực yêu cầu trước** (Azure CLI, hạn mức, quyền truy cập)
- ✅ **Đa vùng với khả năng sẵn sàng cao** với chuyển đổi dự phòng tự động
...
- ✅ **Cập nhật không gián đoạn** với revision của Container Apps
...
- **Azure Monitor**: Giám sát sức khỏe tài nguyên và khả năng sẵn sàng
...
Tài liệu kịch bản này kết hợp với mẫu ARM cung cấp mọi thứ cần thiết để triển khai một giải pháp hỗ trợ khách hàng đa-agent sẵn sàng cho môi trường sản xuất. Việc triển khai bao gồm:

✅ **Thiết Kế Kiến Trúc** - Thiết kế hệ thống toàn diện với mối quan hệ giữa các thành phần  
✅ **Cung cấp Hạ tầng** - Mẫu ARM hoàn chỉnh cho triển khai một-klik  
✅ **Cấu hình Agent** - Thiết lập chi tiết cho agent Khách hàng và Hàng tồn kho  
✅ **Triển khai Đa-mô hình** - Bố trí mô hình chiến lược trên nhiều vùng  
✅ **Tích hợp Tìm kiếm** - AI Search với khả năng vector và lập chỉ mục dữ liệu  
✅ **Triển khai Bảo mật** - Red teaming, quét lỗ hổng, và thực hành an toàn  
✅ **Giám sát & Đánh giá** - Telemetry toàn diện và khung đánh giá agent  
✅ **Sẵn Sàng Sản Xuất** - Triển khai cấp doanh nghiệp với HA và phục hồi thảm họa  
✅ **Tối ưu Chi phí** - Định tuyến thông minh và mở rộng theo mức sử dụng  
✅ **Hướng Dẫn Khắc Phục Sự Cố** - Các vấn đề thường gặp và chiến lược khắc phục

---

## 📊 Tóm Tắt: Những Gì Bạn Đã Học

### Các Mẫu Kiến Trúc Được Bao Quát

✅ **Thiết Kế Hệ Thống Đa-Agent** - Các agent chuyên biệt (Khách hàng + Hàng tồn kho) với mô hình riêng  
✅ **Triển Khai Đa-Vùng** - Bố trí mô hình chiến lược để tối ưu chi phí và dự phòng  
✅ **Kiến Trúc RAG** - Tích hợp AI Search với vector embeddings cho phản hồi có dẫn liệu  
✅ **Đánh Giá Agent** - Mô hình grader chuyên dụng để đánh giá chất lượng  
✅ **Khung Bảo mật** - Mẫu red teaming và quét lỗ hổng  
✅ **Tối ưu Chi phí** - Chiến lược định tuyến mô hình và kế hoạch năng lực  
✅ **Giám sát Sản xuất** - Application Insights với telemetry tùy chỉnh  

### Tài Liệu Này Cung Cấp Những Gì
...
| **Architecture Diagrams** | ✅ Hoàn chỉnh | Sơ đồ Mermaid ở trên |
| **Code Examples** | ✅ Triển khai tham khảo | Trong toàn bộ tài liệu này |
| **Configuration Patterns** | ✅ Hướng dẫn chi tiết | Các mục 1-10 ở trên |
| **Agent Implementations** | 🔨 Bạn Phải Xây Dựng | ~40 giờ phát triển |
| **Frontend UI** | 🔨 Bạn Phải Xây Dựng | ~25 giờ phát triển |
| **Data Pipelines** | 🔨 Bạn Phải Xây Dựng | ~10 giờ phát triển |
...
3. 🔨 Triển khai các agent sử dụng mẫu mã tham khảo (~40 giờ)
...
#### Nếu Bạn Muốn Học Các Mẫu Đa-Agent (Nghiên Cứu)
- 📖 Xem lại sơ đồ kiến trúc và mối quan hệ giữa các thành phần
...
1. **Hạ tầng vs. Ứng dụng** - Mẫu ARM cung cấp hạ tầng; các agent cần được phát triển  
2. **Chiến lược Đa-Vùng** - Bố trí mô hình chiến lược giảm chi phí và cải thiện độ tin cậy  
3. **Khung Đánh Giá** - Mô hình grader chuyên dụng cho phép đánh giá chất lượng liên tục  
4. **Ưu Tiên Bảo Mật** - Red teaming và quét lỗ hổng là cần thiết cho môi trường sản xuất  
...
| **Standard** | $420-1,450 | $15K-25K (nỗ lực tương tự) | $15.4K-26.5K |
| **Premium** | $1,150-3,500 | $15K-25K (nỗ lực tương tự) | $16.2K-28.5K |

**Lưu ý:** Hạ tầng chiếm <5% chi phí tổng cho các triển khai mới. Nỗ lực phát triển là khoản đầu tư chính.

### Tài Nguyên Liên Quan

- 📚 [Hướng Dẫn Triển Khai Mẫu ARM](retail-multiagent-arm-template/README.md) - Cài đặt hạ tầng
- 📚 [Thực hành tốt nhất Microsoft Foundry Models](https://learn.microsoft.com/azure/ai-services/openai/) - Triển khai mô hình
...
- 📚 [Application Insights](https://learn.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Cài đặt giám sát

### Câu Hỏi hoặc Vấn Đề?

- 🐛 [Báo cáo Vấn Đề](https://github.com/microsoft/AZD-for-beginners/issues) - Lỗi mẫu hoặc sai sót tài liệu
- 💬 [GitHub Discussions](https://github.com/microsoft/AZD-for-beginners/discussions) - Câu hỏi về kiến trúc
...
**Kịch bản toàn diện này cung cấp một bản thiết kế kiến trúc cấp doanh nghiệp cho hệ thống AI đa-agent, kèm theo các mẫu hạ tầng, hướng dẫn triển khai và thực hành tốt nhất cho môi trường sản xuất để xây dựng các giải pháp hỗ trợ khách hàng tinh vi với Azure Developer CLI.**
