...
!!! tip "ĐẾN CUỐI BÀI HỌC NÀY BẠN SẼ CÓ THỂ"
    ...
    - [ ] Sử dụng GitHub Copilot để nhận trợ giúp về cách dùng AZD
    - [ ] **Bài thực hành 2:** Triển khai & Xác thực mẫu AI Agents
...
**Bạn đã sẵn sàng để chọn và triển khai một mẫu với azd**
...
1. Your Azure Portal will now have a provisioned resource group with that env name:
      ...
      ![Cơ sở hạ tầng đã cấp phát](../../../../../translated_images/vi/02-provisioned-infra.46c706b14f56e0bf.webp)

1. **Bạn đã sẵn sàng để xác thực cơ sở hạ tầng và ứng dụng đã triển khai**.
...
1. Try asking a couple of [sample questions](https://github.com/Azure-Samples/get-started-with-ai-agents/blob/main/docs/sample_questions.md)
      ...
      1. Ask: ```Lều tốt nhất dưới $200 cho hai người là gì, và nó có những tính năng gì?```
...
1. **Refresh** If you had previously deployed infrastructure using an azd template - you can _refresh_ the state of your local environment variables based on the current state of your Azure deployment using this command:
      ...
      Đây là một cách mạnh mẽ để _đồng bộ_ biến môi trường giữa hai hoặc nhiều môi trường phát triển cục bộ (ví dụ: đội có nhiều nhà phát triển) - cho phép hạ tầng đã triển khai đóng vai trò là nguồn sự thật cho trạng thái các biến môi trường. Các thành viên trong nhóm chỉ cần _làm mới_ các biến để trở lại đồng bộ.
