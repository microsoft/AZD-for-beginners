...
![AZD-for-beginners](../../translated_images/azdbeginners.5527441dd9f7406899cccfc907016b09f9370137543280d95f62ebf23637a2ee.br.png) 
...
*Selecione seu caminho de aprendizado baseado no nível de experiência e objetivos*
...
- Comece com cobrança por consumo, faça upgrade para PTU somente para produção
...
- **📝 Exemplos**: [Exemplo de Aplicação de Banco de Dados](examples/database-app/README.md) - Exemplos AZD para banco de dados
...
Azure Developer CLI (azd) é uma interface de linha de comando centrada no desenvolvedor que acelera o processo de construção e implantação de aplicações no Azure. Ele oferece:
...
- **Integração com Microsoft Foundry** - Conexão perfeita com catálogo de modelos e endpoints Microsoft Foundry
...
**Próximos Passos**: [Comece o Capítulo 1 - Noções Básicas do AZD](docs/getting-started/azd-basics.md) →
