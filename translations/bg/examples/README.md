...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T15:25:50+00:00",
...
- Да овладеете модели за инфраструктура като код за различни Azure услуги
...
3. **[Контейнерно приложение](../../../examples/container-app)** - Внедряване на контейнеризирано приложение

### За средно напреднали
4. **[Приложение с база данни](../../../examples/database-app)** - Уеб приложение с PostgreSQL база данни
5. **[Сървърлес функция](../../../examples/serverless-function)** - Azure Functions с HTTP тригери
6. **[Микроуслуги](../../../examples/microservices)** - Приложение с множество услуги и API gateway
...
- Конфигурации за тестова среда
- Конфигурации за продукционна среда
...
- Конфигурации с оптимизирани разходи
...
|--------|--------|------------|--------------|------------|----------|
| Просто уеб приложение | 1 | ❌ | Основна | Основна | ⭐ |
| Статичен уебсайт | 1 | ❌ | ❌ | Основна | ⭐ |
| Контейнерно приложение | 1 | ❌ | Основна | Пълна | ⭐⭐ |
| Приложение с база данни | 2 | ✅ | Пълна | Пълна | ⭐⭐⭐ |
| Сървърлес функция | 3 | ✅ | Пълна | Пълна | ⭐⭐⭐ |
| Микроуслуги | 5+ | ✅ | Пълна | Пълна | ⭐⭐⭐⭐ |
...
- **Node.js**: Просто уеб приложение, Микроуслуги
- **Python**: Приложение с база данни, Сървърлес функция
- **Статични сайтове**: Статичен уебсайт
- **Контейнери**: Контейнерно приложение, Микроуслуги
- **Бази данни**: Приложение с база данни, Сървърлес функция

### По архитектурен модел
- **Монолитни**: Просто уеб приложение, Приложение с база данни
- **Статични**: Статичен уебсайт
- **Микроуслуги**: Пример за микроуслуги
- **Сървърлес**: Сървърлес функция
- **Хибридни**: Контейнерно приложение

### По ниво на сложност
- **Начинаещи**: Просто уеб приложение, Статичен уебсайт
- **Средно напреднали**: Контейнерно приложение, Приложение с база данни, Сървърлес функция  
- **Напреднали**: Микроуслуги
...
**Съвет**: Започнете с най-простия пример, който съответства на вашия технологичен стек, и постепенно преминавайте към по-сложни сценарии. Всеки пример надгражда концепциите от предишните!
...
- **Връщане към**: [Основно README](../README.md)
