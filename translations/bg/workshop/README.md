...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:31:26+00:00",
...
**Предишно:** [Ръководство за отстраняване на проблеми с AI](../docs/troubleshooting/ai-troubleshooting.md) | **Следващо:** [Модули на уъркшопа](../../../workshop)

Добре дошли в практическия уъркшоп за изучаване на Azure Developer CLI (AZD) с акцент върху внедряването на AI приложения. Този уъркшоп е създаден, за да ви преведе от основите на AZD до внедряването на готови за производство AI решения.
...
- **Практическа задача**: Внедряване на просто уеб приложение
...
- **Практическа задача**: Внедряване на чат приложение с GPT-4
...
- **Практическа задача**: Създаване на система за въпроси и отговори на документи
...
- **Практическа задача**: Внедряване в производство с наблюдение
...
Всеки модул включва практически задачи със стартов код и инструкции стъпка по стъпка:
...
- **[Ръководство за интеграция с AI Foundry](../docs/ai-foundry/azure-ai-foundry-integration.md)** - Комплексни модели за интеграция  
...
1. **Клонирайте хранилището на уъркшопа:**  
```bash
...
3. **Започнете с Практическа задача 1:**  
```bash
cd lab-1-azd-basics
...
- **Съвети**: Споделете открития с други участници  

### След уъркшопа

- 💬 **Discord**: [Azure AI Foundry общност](https://aka.ms/foundry/discord)  
- **GitHub проблеми**: [Докладвайте за проблеми с шаблони](https://github.com/YOUR_ORG/AZD-for-beginners/issues)  
...
1. **Разширени сценарии**: Разгледайте [внедрявания в множество региони](../docs/ai-foundry/production-ai-practices.md#multi-region-deployment)  
...
- ⭐ **Оценете хранилището**, ако този уъркшоп ви е помогнал  
- 🐦 **Споделете в социалните мрежи** с #AzureDeveloperCLI #AzureAI  
- 📝 **Напишете блог пост** за вашето пътуване с внедряването на AI  
...
**Предишно:** [Ръководство за отстраняване на проблеми с AI](../docs/troubleshooting/ai-troubleshooting.md) | **Следващо:** Започнете с [Практическа задача 1: Основи на AZD](../../../workshop/lab-1-azd-basics)

**Готови ли сте да започнете да изграждате AI приложения с AZD?**

[Започнете Практическа задача 1: Основи на AZD →](./lab-1-azd-basics/README.md)
