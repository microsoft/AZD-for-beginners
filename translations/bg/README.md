...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T13:58:30+00:00",
...
- **Внедрите AI приложения**: Използване на AZD с услуги на Microsoft Foundry
...
**📈 Ниво след завършване:** Може самостоятелно да внедрява основни приложения
...
- Azure OpenAI (плащане според използването): $0-50/месец (в зависимост от използваните токени)
...
- Използвайте **Безплатния план** на Azure OpenAI за обучение (включени 50,000 токена/месец)
- Изпълнявайте `azd down`, за да освободите ресурси, когато не разработвате активно
- Започнете с таксуване според потреблението, надграждайте до PTU само за продукция
...
- **📝 Примери**: [Пример с база данни](examples/database-app/README.md) - Примери за AZD бази данни
...
Материалите на работилницата предоставят структурирано, интерактивно обучение, което допълва горната глава-базирана учебна програма. Работилницата е предназначена както за самостоятелно обучение, така и за сесии с инструктор.
...
- **💡 Бърз старт**: [Ръководство за настройка на работилницата](workshop/README.md#quick-start) - Конфигуриране на среда
...
- **Ориентиран към разработчика** - Оптимизиран за продуктивност и удобство на разработчика
...
**Готови за продукция шаблони, съпоставени с учебни глави**
...
- [**Azure Developer CLI шаблони**](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/azd-templates) - Документация на Microsoft Learn за шаблони
...
- [**Глосарий**](resources/glossary.md) - Терминология на Azure и azd  
...
### ❌ "InsufficientQuota" или "Квотата е надвишена"
...
- AI приложения: 15-25 минути (Provisioning на OpenAI е бавен)
...
- **Кариера и развитие**: Търсени умения за AZD и AI разгръщане
...
### Принос към курса
Ние приветстваме приноси! Моля, прочетете нашето [Ръководство за принос](CONTRIBUTING.md) за подробности относно:
...
- **Общностни стандарти**: Следване на нашите приобщаващи насоки за общността
