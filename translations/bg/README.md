...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T15:16:43+00:00",
  "source_file": "README.md",
  "language_code": "bg"
}
-->
# AZD за начинаещи: Структурирано учебно пътешествие
...
Следвайте тези стъпки, за да започнете своето учебно пътешествие с AZD:
...
Според прозренията от общността на Azure AI Foundry Discord, **45% от разработчиците искат да използват AZD за AI работни натоварвания**, но срещат предизвикателства с:
...
- **Прилагайте инфраструктура като код**: Управлявайте ресурси на Azure с шаблони Bicep
- **Отстранявайте проблеми при внедрявания**: Решавайте често срещани проблеми и отстранявайте грешки
...
#### Практически упражнения
- Изпълнение на скриптове за валидиране на капацитет
- Оптимизиране на изборите на SKU за разходи
...
**💡 Резултат от главата**: Самостоятелна диагностика и решаване на често срещани проблеми при внедряване
...
Материалите за работилницата предоставят структурирано, интерактивно обучение, което допълва учебната програма, базирана на глави. Работилницата е подходяща както за самостоятелно обучение, така и за сесии с инструктор.

#### 🛠️ Характеристики на работилницата
- **Интерфейс в браузър**: Завършена работилница, базирана на MkDocs, с функции за търсене, копиране и теми
...
- **Внедрят AI приложения в продукция**: Използване на AZD с услуги на Azure AI Foundry
...
- **Оптимизират за мащабируемост**: Проектиране на икономични и ефективни внедрения
...
| [**Създайте вашия разговорен агент**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Глава 4 | ⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Azure Storage + Azure Container Registry|
| [**Отключете прозрения от разговорни данни**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Глава 8 | ⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
...
|--------|--------------|----------|------------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Глава 2 | ⭐ | Основни модели за AI внедрения |
...
- [Просто уеб приложение](../../examples/simple-web-app) - Основни модели за внедрение
- [Статичен уебсайт](../../examples/static-site) - Внедрение на статично съдържание
- [Основен API](../../examples/basic-api) - Внедрение на REST API

#### Интеграция с база данни (Глави 3-4)  
- [Приложение с база данни](../../examples/database-app) - Модели за свързване с база данни
- [Обработка на данни](../../examples/data-processing) - Внедрение на ETL работен поток

#### Напреднали модели (Глави 4-8)
- [Приложения в контейнери](../../examples/container-app) - Внедрения в контейнери
...
- [**Лаборатория за AI работилница**](docs/ai-foundry/ai-workshop-lab.md) - Направете вашите AI решения готови за AZD внедрение (2-3 часа)
- [**Интерактивно ръководство за работилница**](workshop/README.md) - Работилница в браузър с MkDocs и DevContainer среда
- [**Структуриран учебен път**](../../workshop/docs/instructions) - 7 стъпки с насочени упражнения (Откриване → Внедрение → Персонализация)
...
- [ ] **Глава 4**: Инфраструктура като код и внедрение ✅
- [ ] **Глава 5**: Многоагентни AI решения ✅
- [ ] **Глава 6**: Проверка и планиране преди внедрение ✅
- [ ] **Глава 7**: Отстраняване на проблеми и дебъгинг ✅
...
1. **Практическо упражнение**: Завършете практическото внедрение за главата
...
- **Професионални умения**: Възможности за внедрение, готови за корпоративна среда  
- **Признание в общността**: Активен член на общността на разработчиците в Azure
- **Кариерно развитие**: Търсени умения за AZD и AI внедрения
...
- **Помощ за AI**: Присъединете се към [#Azure канала](https://discord.gg/microsoft-azure) за дискусии относно AZD + AI Foundry
...
- **Най-желани**: Шаблони, специфични за AI, ръководства за отстраняване на проблеми, най
...
Нашият екип създава други изчерпателни обучителни курсове:  

- [Протокол за контекст на модел (MCP) за начинаещи](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)  
