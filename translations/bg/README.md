...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T15:45:04+00:00",
...
- **Създавате многоагентни решения**: Внедряване на сложни AI архитектури
...
### 🎯 Глава 5: Многоагентни AI решения (Разширено)
...
#### Учебни ресурси
- **🤖 Представен проект**: [Многоагентно решение за търговия на дребно](examples/retail-scenario.md) - Пълна реализация
...
Материалите на работилницата предоставят структурирано, интерактивно обучение, което допълва горната учебна програма по глави. Работилницата е предназначена както за самостоятелно обучение, така и за сесии с инструктор.
...
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Пълна готова за продукция имплементация с ARM шаблони
...
- [**Структуриран учебен път**](../../workshop/docs/instructions) - 7-стъпкови ръководени упражнения (Откриване → Разгръщане → Персонализация)
...
- Проста уеб апликация: 5-10 минути
- Апликация с база данни: 10-15 минути
