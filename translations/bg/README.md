...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:27:25+00:00",
...
- **🛠️ Работилница**: [Лаборатория за AI](docs/ai-foundry/ai-workshop-lab.md) - Направете вашите AI решения готови за AZD
- **🎥 Интерактивно ръководство**: [Материали за работилница](workshop/README.md) - Обучение в браузър с MkDocs * DevContainer Environment
...
#### Практически упражнения
- Изпълнете скриптове за валидация на капацитет
...
- **Интерфейс в браузър**: Работилница, захранвана от MkDocs, с функции за търсене, копиране и теми
...
- **Овладеят многослойни архитектури**: Прилагане на координирани AI решения с агенти
- **Прилагат най-добрите практики за сигурност**: Конфигуриране на автентикация и контрол на достъпа
- **Оптимизират за мащабиране**: Проектиране на икономични и ефективни внедрения
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Глава 5 | ⭐⭐⭐⭐ | Архитектура с многослойни агенти за клиенти и инвентар |
...
- [Приложения с контейнери](../../examples/container-app) - Внедряване с контейнери
- [Микросервиси](../../examples/microservices) - Архитектури с множество услуги  
...
- **Въпроси за обучение**: [Общност на Microsoft Azure в Discord](https://discord.gg/microsoft-azure) и [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
**Резултати от последната анкета
- Допринасяйте за най-добрите практики при внедряване на AI
- Влияйте върху бъдещото развитие на функциите AI + AZD

### Допринасяне към курса
Приветстваме вашите приноси! Моля, прочетете нашето [Ръководство за допринасяне](CONTRIBUTING.md) за подробности относно:
...
- **Стандарти на общността**: Спазване на нашите насоки за приобщаваща общност
