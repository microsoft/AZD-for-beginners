...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T07:43:11+00:00",
  "source_file": "resources/cheat-sheet.md",
  "language_code": "bg"
}
-->
# Команден наръчник - Основни команди на AZD

## Въведение

Този изчерпателен наръчник предоставя бърза справка за най-често използваните команди на Azure Developer CLI, организирани по категории с практически примери. Идеален за бързи справки по време на разработка, отстраняване на проблеми и ежедневни операции с проекти на azd.

## Цели на обучението

С използването на този наръчник ще:
...
- Се позовавате на практически примери за често срещани сценарии за разработка и внедряване
...
- Локализирате команди за управление на среди и работни потоци с множество среди

## Резултати от обучението

С редовно използване на този наръчник ще можете:
- Да изпълнявате команди на azd уверено, без да се позовавате на пълната документация
...
- Да прилагате разширени функции и опции за конфигурация на azd, когато е необходимо
- Да отстранявате проблеми с внедряването чрез систематични последователности от команди
- Да оптимизирате работните потоци чрез ефективно използване на съкращения и опции на azd
...
### Пълен работен поток за внедряване
```bash
...
### Съкратени имена за по-бърз работен поток
```bash
...
**Съвет**: Запазете този наръчник в отметките си и използвайте `Ctrl+F`, за да намерите бързо командите, които ви трябват!
