...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T11:31:40+00:00",
...
- Откривате напреднали опции за конфигурация и персонализация
- Управлявате ефективно среди и работни потоци с множество среди
...
- Прилагате напреднали функции и опции за конфигурация на azd, когато е необходимо
...
### Съкратени команди за по-бърз работен поток
```bash
...
**Съвет**: Запазете този наръчник и използвайте `Ctrl+F`, за да намерите бързо командите, които ви трябват!
