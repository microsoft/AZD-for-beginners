...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T11:23:47+00:00",
  "source_file": "docs/pre-deployment/preflight-checks.md",
  "language_code": "bg"
}
-->
# Предварителни проверки за AZD разгръщания

**Навигация по глави:**
- **📚 Начало на курса**: [AZD за начинаещи](../../README.md)
- **📖 Текуща глава**: Глава 6 - Валидиране и планиране преди разгръщане
...
Това подробно ръководство предоставя скриптове и процедури за валидиране преди разгръщане, за да се гарантира успешното разгръщане с Azure Developer CLI. Научете как да внедрите автоматизирани проверки за автентикация, наличност на ресурси, квоти, съответствие със сигурността и изисквания за производителност, за да предотвратите неуспехи и да оптимизирате успеха на разгръщанията.

## Цели на обучението

След завършване на това ръководство ще можете:
- Да овладеете техники и скриптове за автоматизирано валидиране преди разгръщане
- Да разберете стратегии за проверка на автентикация, разрешения и квоти
- Да внедрите процедури за валидиране на наличност и капацитет на ресурси
...
- Да създавате и изпълнявате подробни скриптове за валидиране преди разгръщане
...
- Да конфигурирате проактивно наблюдение и известяване за готовност за разгръщане
...
- [Валидиране на ресурси](../../../../docs/pre-deployment)
...
Проверките преди разгръщане са основни валидирания, извършвани преди разгръщане, за да се гарантира:
...
### Списък за предварително разгръщане

Разпечатайте този списък и проверете всяка точка преди разгръщане:

#### ✅ Настройка на средата
- [ ] Инсталиран и актуализиран AZD CLI до последната версия
- [ ] Инсталиран и автентикиран Azure CLI
- [ ] Избрана правилната Azure абонаментна услуга
- [ ] Името на средата е уникално и следва конвенциите за именуване
- [ ] Идентифицирана целевата ресурсна група или може да бъде създадена

#### ✅ Автентикация и разрешения
- [ ] Успешно автентикиране с `azd auth login`
- [ ] Потребителят има роля Contributor в целевата абонаментна услуга/ресурсна група
...
- [ ] Избран и валидиран целевият Azure регион
- [ ] Необходимите Azure услуги са налични в целевия регион
- [ ] Налични достатъчни квоти за планираните ресурси
- [ ] Проверени конфликти в именуването на ресурси
- [ ] Разбрани зависимости между ресурсите

#### ✅ Мрежа и сигурност
- [ ] Проверена мрежова свързаност с Azure крайни точки
...
- [ ] Активирано принудително HTTPS за уеб приложения

#### ✅ Управление на разходите
- [ ] Изчислени разходи с Azure Pricing Calculator
- [ ] Конфигурирани бюджетни известия, ако е необходимо
- [ ] Избрани подходящи SKU за типа среда
- [ ] Обмислен резервиран капацитет за продукционни натоварвания

#### ✅ Наблюдение и видимост
- [ ] Конфигуриран Application Insights в шаблоните
- [ ] Планирано Log Analytics работно пространство
- [ ] Дефинирани правила за известяване за критични метрики
- [ ] Реализирани крайни точки за проверка на здравето в приложенията
...
5. **Бързо спиране**
   ...
   - Осигуряване на ясни указания за разрешаване
   - Лесно повторно изпълнение на проверки

### Често срещани грешки при проверки преди разгръщане

1. **Пропускане на валидиране** за "бързи" разгръщания
2. **Недостатъчно проверяване на разрешения** преди разгръщане
3. **Игнориране на лимити на квоти** до провал на разгръщането
