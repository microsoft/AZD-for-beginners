...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T22:32:58+00:00",
...
**Предишно:** [Основна документация](../../README.md) | **Следващо:** [Основи на AZD](azd-basics.md)

## Въведение

Това подробно ръководство ще ви преведе през процеса на инсталиране и конфигуриране на Azure Developer CLI (azd) на вашата система. Ще научите различни методи за инсталиране за различни операционни системи, настройка на автентикация и първоначална конфигурация, за да подготвите вашата среда за разработка за внедряване в Azure.
...
- Да разберете различните опции за инсталиране и кога да използвате всяка от тях
- Да отстраните често срещани проблеми при инсталиране и настройка
...
- Самостоятелно да разрешавате често срещани проблеми при инсталиране
...
След инсталиране, проверете дали azd работи правилно:
