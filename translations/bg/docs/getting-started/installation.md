...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T06:04:12+00:00",
...
- Да настроите вашата среда за разработка с необходимите предварителни изисквания
- Да разберете различните опции за инсталация и кога да използвате всяка от тях
- Да отстраните често срещани проблеми при инсталация и настройка
...
- Да проверите вашата инсталация и да тествате основни команди на azd
- Да конфигурирате вашата среда за разработка за оптимална употреба на azd
- Да решавате често срещани проблеми с инсталацията самостоятелно
...
### Автентикация с код за устройство
...
Добавете към профила на вашата обвивка (`.bashrc`, `.zshrc`, `.profile`):
```bash
# Azure configuration
...
2. **Опитайте първото си разгръщане**: Следвайте [Ръководството за първи проект](first-project.md)
...
- [Общностни дискусии](https://github.com/Azure/azure-dev/discussions)
- [Поддръжка на Azure](https://azure.microsoft.com/support/)

---

**Навигация**
- **Предишен урок**: [Основи на AZD](azd-basics.md)
- **Следващ урок**: [Конфигурация](configuration.md)
