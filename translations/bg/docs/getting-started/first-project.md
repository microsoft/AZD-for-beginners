...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T13:38:27+00:00",
...
- Разберете структурата на проектите с Azure Developer CLI и конфигурационните файлове
- Изпълните пълно разгръщане на приложение в Azure с осигуряване на инфраструктура
- Реализирате стратегии за актуализация и повторно разгръщане на приложения
...
- Да решавате често срещани проблеми с разгръщането и автентикацията
- Да управлявате множество среди в Azure за различни етапи на разгръщане
- Да реализирате непрекъснати работни потоци за разгръщане на актуализации на приложения
...
Нека разгледаме какво е създадено от azd:
...
**azure.yaml** - Основният файл на вашия проект с azd:
```bash
...
### Тест на приложението за задачи
