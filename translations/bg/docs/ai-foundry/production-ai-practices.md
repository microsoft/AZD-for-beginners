...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:17:39+00:00",
...
**Предишно:** [AI Workshop Lab](ai-workshop-lab.md) | **Следващо:** [AI Troubleshooting Guide](../troubleshooting/ai-troubleshooting.md)

## Преглед

Това ръководство предоставя изчерпателни най-добри практики за внедряване на готови за производство AI натоварвания с помощта на Azure Developer CLI (AZD). Базирано на обратна връзка от общността в Discord на Azure AI Foundry и реални внедрения при клиенти, тези практики адресират най-често срещаните предизвикателства в производствените AI системи.

## Основни предизвикателства

Според резултатите от анкетата в нашата общност, това са основните предизвикателства, пред които се изправят разработчиците:
...
### Модел 1: Архитектура на микросервиси за AI
...
### Модел 2: AI обработка, базирана на събития
...
- Без комуникация между услуги без автентикация
...
- [ ] Реализирани прекъсвачи на веригата
...
### Съответствие ✅
- [ ] Спазени изисквания за местоположение на данни
...
Базирано на обратна връзка от общността в Discord на Azure AI Foundry:

### Основни препоръки от общността:

1. **Започнете малко, мащабирайте постепенно**: Започнете с базови SKUs и мащабирайте според реалното използване
...
4. **Тествайте задълбочено**: Включете тестове, специфични за AI, във вашия pipeline
5. **Планирайте разходите**: Наблюдавайте използването на токени и настройте известия за бюджет рано
