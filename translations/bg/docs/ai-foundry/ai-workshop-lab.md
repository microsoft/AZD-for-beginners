...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:04:37+00:00",
  "source_file": "docs/ai-foundry/ai-workshop-lab.md",
  "language_code": "bg"
}
-->
# AI Workshop Lab: Направете вашите AI решения готови за AZD разгръщане

**Предишно:** [AI Model Deployment](ai-model-deployment.md) | **Следващо:** [Production AI Practices](production-ai-practices.md)

## Преглед на работилницата

Тази практическа лаборатория води разработчиците през процеса на адаптиране на съществуващо AI приложение, за да бъде разгръщано с помощта на Azure Developer CLI (AZD). Ще научите основни модели за разгръщане на AI приложения в продукция, използвайки услугите на Azure AI Foundry.
...
- ✅ Да конфигурирате Azure AI Foundry услуги с AZD
...
**AZD решение**: Управлявана идентичност + интеграция с Key Vault.
...
- [ ] Използвана управлявана идентичност за автентикация между услуги
...
- Процент на грешки на приложението
...
- Проследявайте използването на токени за OpenAI
...
Вашата задача е да създадете готов за продукция AI-базиран чатбот за обслужване на клиенти със следните изисквания:
...
- SLA за време на работа от 99.9%
...
- ✅ **Сигурност**: Внедрени ли са най-добрите практики?
- ✅ **Мащабируемост**: Може ли да се справи с натоварването?
- ✅ **Поддръжка**: Добре ли са организирани кодът и инфраструктурата?
- ✅ **Разходи**: Остава ли в рамките на бюджета?

## Доп
- ✅ Прилагане на най-добрите практики за сигурност при AI натоварвания
- ✅ Наблюдение и оптимизация на производителността на AI приложения
- ✅ Отстраняване на често срещани проблеми при внедряване
...
**Обратна връзка за работилницата**: Помогнете ни да подобрим тази работилница, като споделите вашия опит в [Azure AI Foundry Discord #Azure канал](https://discord.gg/microsoft-azure).
