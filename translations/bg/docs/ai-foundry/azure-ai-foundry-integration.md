...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T23:13:11+00:00",
...
**Предишно:** [Първи проект](../getting-started/first-project.md) | **Следващо:** [Деплоймент на AI модел](ai-model-deployment.md)

## Преглед

Това ръководство показва как да интегрирате услугите на Azure AI Foundry с Azure Developer CLI (AZD) за улеснено разгръщане на AI приложения. Azure AI Foundry предоставя цялостна платформа за създаване, разгръщане и управление на AI приложения, докато AZD опростява процеса на инфраструктура и деплоймент.
...
- **Опции за разгръщане**: Множество възможности за хостинг и мащабиране
- **Безопасност и сигурност**: Вградени функции за отговорен AI

## AZD + Azure AI Foundry: По-добри заедно

| Функция | Azure AI Foundry | Полза от интеграцията с AZD |
|---------|-----------------|------------------------|
| **Деплоймент на модели** | Ръчно разгръщане през портал | Автоматизирани, повторяеми разгръщания |
| **Инфраструктура** | Настройка чрез кликвания | Инфраструктура като код (Bicep) |
...
**Приложение:** Разгръщане на приложения за извличане с допълнена генерация (RAG)
...
5. **Осигурете разгръщането си:** Реализирайте модели за сигурност на корпоративно ниво
...
**Нуждаете се от помощ?** Присъединете се към дискусиите в общността или отворете проблем в репозиторията. Общността Azure AI + AZD е тук, за да ви помогне да успеете!
