...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-10T05:36:37+00:00",
...
După finalizarea acestui curs, veți fi capabili să:
- Instalați, configurați și utilizați cu succes Azure Developer CLI
- Creați și implementați aplicații folosind șabloane AZD
- Rezolvați probleme de autentificare, infrastructură și implementare
- Efectuați verificări pre-implementare, inclusiv planificarea capacității și selecția SKU
- Aplicați cele mai bune practici de monitorizare, securitate și gestionare a costurilor
- Integrați fluxurile de lucru AZD în pipeline-uri CI/CD
...
### Șabloane de Start
- [**Aplicație Web Simplă**](../../examples/simple-web-app) - Implementare de bază a unei aplicații web Node.js
- [**Website Static**](../../examples/static-website) - Găzduire website static pe Azure Storage
- [**Aplicație Containerizată**](../../examples/container-app) - Implementare aplicație containerizată
- [**Aplicație cu Bază de Date**](../../examples/database-app) - Aplicație web cu integrare bază de date

### Scenarii Avansate
- [**Microservicii**](../../examples/microservices) - Arhitectură aplicație multi-serviciu
- [**Funcții Serverless**](../../examples/serverless-function) - Implementare Azure Functions
- [**Exemple de Configurare**](../../examples/configurations) - Modele de configurare reutilizabile
...
- [**Ghid de Studiu**](resources/study-guide.md) - Obiective de învățare și exerciții practice
...
4. Exersați cu [Exemplul Aplicației Web Simple](../../examples/simple-web-app)
...
3. Lucrați cu [Exemplul Aplicației cu Bază de Date](../../examples/database-app)
4. Explorați [Exemplul Aplicației Containerizate](../../examples/container-app)
...
3. Exersați [Planificarea Capacității](docs/pre-deployment/capacity-planning.md)
4. Avansați cu [Exemplul Microserviciilor](../../examples/microservices)
...
- **Discuții**: [Comunitatea Microsoft Azure Discord Q&A și discuții](https://discord.gg/microsoft-azure)
