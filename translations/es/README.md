...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:38:45+00:00",
...
- **🔐 Seguridad**: Patrones de autenticación e identidad gestionada
- **📝 Ejemplos**: [Ejemplo de Aplicación de Base de Datos](../../examples/database-app) - Patrones de configuración
...
- **🛠️ Laboratorio de IA**: [Laboratorio de IA](docs/ai-foundry/ai-workshop-lab.md) - Ejercicios enfocados en IA
...
Azure Developer CLI (azd) es una interfaz de línea de comandos centrada en desarrolladores que acelera el proceso de creación y despliegue de aplicaciones en Azure. Proporciona:
...
- **Despliegues de IA seguros** - Patrones de seguridad integrados para servicios de IA, claves API y puntos finales de modelos  
...
| [**Automatización de flujo de trabajo con múltiples agentes**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Servicio de agentes de Azure AI + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
...
| [**Modernizar tu código con agentes**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Servicio de agentes de Azure + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
| [**Construir tu agente conversacional**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 4 | ⭐⭐⭐ | AI Language + AzureOpenAI + AI Search + Azure Storage + Azure Container Registry|
| [**Descubrir información de datos conversacionales**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 8 | ⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Servicio de agentes de Azure + Comprensión de contenido de AI|
...
### Talleres prácticos
- [**Laboratorio de IA**](docs/ai-foundry/ai-workshop-lab.md) - Haz que tus soluciones de IA sean desplegables con AZD (2-3 horas)
...
- **Avance profesional**: Experiencia en AZD y despliegue de IA en demanda
...
- **Preguntas de aprendizaje**: [Comunidad de Discord de Microsoft Azure](https://discord.gg/microsoft-azure) y [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
- Contribuir a las mejores prácticas de implementación de IA  
- Influir en el desarrollo futuro de características de IA + AZD  

### Contribuir al Curso  
¡Agradecemos las contribuciones! Por favor, lee nuestra [Guía de Contribución](CONTRIBUTING.md) para más detalles sobre:  
...
- **Estándares Comunitarios**: Seguir nuestras pautas inclusivas de la comunidad  
