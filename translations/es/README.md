...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T14:58:02+00:00",
...
### 🤖 Capítulo 2: Desarrollo Enfocado en IA (Recomendado para Desarrolladores de IA)
...
- **💰 Selección**: [Selección de SKU](docs/pre-deployment/sku-selection.md) - Elecciones rentables
...
**💡 Resultado del Capítulo**: Validar y optimizar despliegues antes de ejecutarlos
...
- **Flujos de trabajo integrados** - Provisión, despliegue y monitoreo de aplicaciones sin interrupciones
- **Amigable para desarrolladores** - Optimizado para la productividad y experiencia del desarrollador

### **AZD + Azure AI Foundry: Ideal para Despliegues de IA**
...
- **Despliegues seguros de IA** - Patrones de seguridad integrados para servicios de IA, claves de API y puntos finales de modelos  
...
| [**Descubre información a partir de datos conversacionales**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 8 | ⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Servicio de Agentes de Azure + Comprensión de Contenido de Azure AI|
...
### Destacado: Escenarios de Aprendizaje Completo
...
### Talleres Prácticos
- [**Laboratorio de Taller de IA**](docs/ai-foundry/ai-workshop-lab.md) - Haz que tus soluciones de IA sean desplegables con AZD
- [**Taller AZD para Principiantes**](workshop/README.md) - Materiales completos para talleres prácticos
...
2. **Revisión de Conocimientos**: Consulta la sección de preguntas frecuentes del capítulo
...
### Beneficios de Finalización del Curso
...
- **Más solicitado**: Plantillas específicas de IA, guías de resolución de problemas, mejores prácticas
...
- Contribuir a mejores prácticas de despliegue de IA
...
- **Estándares Comunitarios**: Seguir nuestras pautas inclusivas de comunidad
...
**Principiantes**: Comienza con [Capítulo 1: Fundamentos e Inicio Rápido](../..)  
**Desarrolladores de IA**: Salta a [Capítulo 2: Desarrollo con enfoque en IA](../..)
