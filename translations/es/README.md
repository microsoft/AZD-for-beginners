...
![AZD-for-beginners](../../translated_images/azdbeginners.5527441dd9f7406899cccfc907016b09f9370137543280d95f62ebf23637a2ee.es.png) 
...
- **🛠️ Taller**: [Laboratorio de IA](docs/microsoft-foundry/ai-workshop-lab.md) - Prepara tus soluciones de IA para AZD
...
**💰 Conciencia de Costos:** Entiende costos de desarrollo de $80-150/mes, costos de producción de $300-3500/mes
...
- **🔐 Seguridad**: [Patrones de autenticación e identidad gestionada](docs/getting-started/authsecurity.md) - Patrones de autenticación
...
- **🏗️ Aprovisionamiento**: [Aprovisionamiento de Recursos](docs/deployment/provisioning.md) - Gestión de recursos en Azure
...
Azure Developer CLI (azd) es una interfaz de línea de comandos centrada en desarrolladores que acelera el proceso de construcción y despliegue de aplicaciones en Azure. Proporciona:
...
- **Flujos de trabajo integrados** - Provisionar, desplegar y monitorizar aplicaciones sin interrupciones
...
> **Nota:** Estas plantillas demuestran varios patrones de IA. Algunas son muestras externas de Azure, otras implementaciones locales.

| Plantilla | Capítulo | Complejidad | Servicios | Tipo |
|----------|---------|------------|----------|------|
| [**Comenzar con chat de IA**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Capítulo 2 | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights | Externa |
| [**Comenzar con agentes de IA**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Capítulo 2 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights| Externa |
| [**Demo Azure Search + OpenAI**](https://github.com/Azure-Samples/azure-search-openai-demo) | Capítulo 2 | ⭐⭐ | AzureOpenAI + Azure AI Search + App Service + Storage | Externa |
| [**Inicio rápido OpenAI Chat App**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | Capítulo 2 | ⭐ | AzureOpenAI + Container Apps + Application Insights | Externa |
| [**Agent OpenAI Python Prompty**](https://github.com/Azure-Samples/agent-openai-python-prompty) | Capítulo 5 | ⭐⭐⭐ | AzureOpenAI + Azure Functions + Prompty | Externa |
| [**Contoso Chat RAG**](https://github.com/Azure-Samples/contoso-chat) | Capítulo 8 | ⭐⭐⭐⭐ | AzureOpenAI + AI Search + Cosmos DB + Container Apps | Externa |
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Capítulo 8 | ⭐⭐⭐ | Orquestación empresarial de IA |
...
- [**Solución Multi-Agente Retail**](examples/retail-scenario.md) - Implementación completa lista para producción con plantillas ARM
  - Arquitectura multiagente (agentes Cliente + Inventario)
  - Monitorización y evaluación integral
...
- [Aplicación de Base de Datos - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - Patrones de conectividad a base de datos
- [Funciones + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - Flujo de trabajo de datos serverless
...
### ❌ "azd up" falla a mitad de proceso
...
### ❌ Despliegue de plantilla tarda demasiado
...
<details>
<summary><strong>❌ Despliegue de plantilla tarda demasiado</strong></summary>
...
- **Más solicitados**: Plantillas específicas de IA, guías de solución de problemas, mejores prácticas
