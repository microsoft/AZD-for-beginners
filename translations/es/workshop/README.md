...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T17:50:02+00:00",
...
**Anterior:** [Guía de Solución de Problemas de IA](../docs/troubleshooting/ai-troubleshooting.md) | **Siguiente:** [Módulos del Taller](../../../workshop)
...
- **Fundamentos de AZD**: Comprender la Infraestructura como Código con AZD
...
- **Mejores Prácticas de Seguridad**: Implementar Managed Identity y configuraciones seguras
...
- Configuración de acceso a la API y autenticación
...
- **Cierre**: Lista de verificación para preparación en producción
...
✅ **Configurar Azure OpenAI** con seguridad adecuada  
...
2. **Integración con CI/CD**: Configura [flujos de trabajo con GitHub Actions](../docs/deployment/github-actions.md)  
...
Tus comentarios nos ayudan a mejorar la experiencia del taller:
