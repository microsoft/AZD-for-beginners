...
- **➡️ Seguinte**: [Laboratório do Workshop de IA](ai-workshop-lab.md)
- **🚀 Próximo Capítulo**: [Capítulo 3: Configuração](../chapter-03-configuration/configuration.md)

Este guia fornece instruções abrangentes para implementar modelos de IA usando templates AZD, cobrindo desde a seleção do modelo até padrões de implementação em produção.
...
- [Padrões de Implementação](../../../../docs/chapter-02-ai-development)
- [Gestão de Modelos](../../../../docs/chapter-02-ai-development)
- [Considerações de Produção](../../../../docs/chapter-02-ai-development)
- [Monitorização e Observabilidade](../../../../docs/chapter-02-ai-development)

## Estratégia de Seleção de Modelos

### Modelos Azure OpenAI

Escolha o modelo certo para o seu caso de utilização:
...
| Tipo de Modelo | Caso de Utilização | Capacidade Recomendada | Considerações de Custo |
|------------|----------|---------------------|-------------------|
| GPT-4o-mini | Chat, Q&A | 10-50 TPM | Rentável para a maioria das cargas de trabalho |
| GPT-4 | Raciocínio complexo | 20-100 TPM | Custo mais elevado, utilizar para funcionalidades premium |
| Text-embedding-ada-002 | Pesquisa, RAG | 30-120 TPM | Essencial para pesquisa semântica |
| Whisper | Conversão de fala para texto | 10-50 TPM | Cargas de trabalho de processamento de áudio |
...
Combine o Azure OpenAI com outros serviços de IA:
...
Implemente múltiplas versões de modelos:
...
```python
# Exemplo de cálculo da capacidade
...
Configure o autoescalamento para Container Apps:
...
Implemente monitorização de integridade dos serviços de IA:
...
1. **Consulte o [Guia de Integração Microsoft Foundry](microsoft-foundry-integration.md)** para padrões de integração de serviços
...
- [Disponibilidade dos Modelos Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/concepts/models)
