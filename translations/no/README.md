...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T15:00:38+00:00",
...
Bli ekspert på Azure Developer CLI (azd) gjennom strukturerte kapitler designet for progressiv læring. **Spesiell fokus på utrulling av AI-applikasjoner med integrasjon av Azure AI Foundry.**
...
**💡 Kapittelresultat**: Vellykket utrulling av en enkel webapplikasjon til Azure ved bruk av AZD

---

### 🤖 Kapittel 2: AI-First utvikling (Anbefalt for AI-utviklere)
...
- **📖 Mønstre**: [Utrulling av AI-modeller](docs/ai-foundry/ai-model-deployment.md) - Utrulling og administrasjon av AI-modeller
- **🛠️ Workshop**: [AI Workshop Lab](docs/ai-foundry/ai-workshop-lab.md) - Gjør dine AI-løsninger klare for AZD
- **🎥 Interaktiv guide**: [Workshop-materiale](workshop/README.md) - Nettbasert læring med MkDocs * DevContainer Environment
...
**💡 Kapittelresultat**: Rulle ut og konfigurere en AI-drevet chatapplikasjon med RAG-funksjonalitet
...
#### Hva du vil lære
- Konfigurasjon og administrasjon av miljøer
- Beste praksis for autentisering og sikkerhet
- Navngivning og organisering av ressurser

#### Læringsressurser
- **📖 Konfigurasjon**: [Konfigurasjonsveiledning](docs/getting-started/configuration.md) - Oppsett av miljøer
...
### 🏗️ Kapittel 4: Infrastructure as Code & Utrulling
...
#### Læringsressurser
- **📖 Utrulling**: [Utrullingsveiledning](docs/deployment/deployment-guide.md) - Fullstendige arbeidsflyter
...
- Rull ut applikasjoner med flere tjenester
- Implementer blå-grønn utrullingsstrategi

**💡 Kapittelresultat**: Rull ut komplekse applikasjoner med flere tjenester ved bruk av tilpassede infrastruktursmaler
...
- AI-utrullinger klare for produksjon
...
- **📖 Arkitektur**: Mønstre for koordinering av flere agenter
...
**💡 Kapittelresultat**: Rull ut og administrer en produksjonsklar multi-agent AI-løsning med kunde- og lageragenter
...
#### Læringsressurser
- **📊 Planlegging**: [Kapasitetsplanlegging](docs/pre-deployment/capacity-planning.md) - Validering av ressurser
...
**💡 Kapittelresultat**: Valider og optimaliser utrullinger før gjennomføring
...
**💡 Kapittelresultat**: Diagnostiser og løs vanlige utrullingsproblemer på egen hånd
...
#### Læringsressurser
- **🏭 Produksjon**: [Produksjonspraksis for AI](docs/ai-foundry/production-ai-practices.md) - Mønstre for bedrifter
...
Workshopmaterialene våre gir en strukturert, interaktiv læringsopplevelse som utfyller kapittelbasert pensum ovenfor. Workshopen er designet for både selvstudium og instruktørledede sesjoner.
...
- **Optimalisere for skala**: Designe kostnadseffektive og ytelsessterke utplasseringer
...
Azure Developer CLI (azd) er et utviklerfokusert kommandolinjeverktøy som akselererer prosessen med å bygge og utplassere applikasjoner til Azure. Det tilbyr:

- **Malbaserte utplasseringer** - Bruk forhåndsbygde maler for vanlige applikasjonsmønstre
...
- **Produksjonsmønstre for AI** - Beste praksis for skalerbare, kostnadseffektive AI-applikasjonsutplasseringer
- **End-to-End AI-arbeidsflyter** - Fra modellutvikling til produksjonsutplassering med riktig overvåking
- **Kostnadsoptimalisering** - Smarte strategier for ressursallokering og skalering av AI-arbeidsbelastninger
- **Integrasjon med Azure AI Foundry** - Sømløs tilkobling til AI Foundry-modellkatalog og endepunkter
...
| [**Arbeidsflytautomatisering med multi-agent**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Kapittel 5 | ⭐⭐⭐ | AzureOpenAI + Azure AI Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
| [**Generere dokumenter fra dataene dine**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Kapittel 4 | ⭐⭐⭐  | AzureOpenAI + Azure AI Search + Azure AI Services + Azure CosmosDB|
...
### Utvalgte: Komplett læringsscenarier
...
| [**contoso-chat**](https://github.com/Azure-Samples/contoso-chat) | Kapittel 8 | ⭐⭐⭐ | Bedriftsorientert AI-orkestrering |
...
- [Enkel webapplikasjon](../../examples/simple-web-app) - Grunnleggende utplasseringsmønstre
...
### Hurtigreferanser
- [**Kommandosnarvei**](resources/cheat-sheet.md) - Essensielle azd-kommandoer organisert etter kapittel
...
### Praktiske workshops
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - Gjør AI-løsningene dine AZD-utplasserbare (2-3 timer)
...
- [ ] **Kapittel 4**: Infrastruktur som kode og utplassering ✅
- [ ] **Kapittel 5**: Multi-agent AI-løsninger ✅
- [ ] **Kapittel 6**: Validering og planlegging før utplassering ✅
- [ ] **Kapittel 7**: Feilsøking og debugging ✅
- [ ] **Kapittel 8**: Produksjon og mønstre for bedrifter ✅
...
Når du har fullført alle kapitler, vil du ha:
- **Produksjonserfaring**: Utplassert ekte AI-applikasjoner til Azure
- **Profesjonelle ferdigheter**: Kapasitet til bedriftsklare utplasseringer  
...
- **Oversettelse**: Hjelp med å opprettholde støtte for flere språk  
- **Feilrapporter**: Forbedre nøyaktighet og tydelighet  
- **Retningslinjer for fellesskapet**: Følg våre inkluderende retningslinjer for fellesskapet  
