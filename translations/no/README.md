...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T23:23:09+00:00",
...
![AZD-for-beginners](../../translated_images/azdbeginners.5527441dd9f7406899cccfc907016b09f9370137543280d95f62ebf23637a2ee.no.png) 
...
- **📖 Teori**: [AZD Grunnleggende](docs/getting-started/azd-basics.md) - Kjernebegreper og terminologi
...
- **🛠️ Workshop**: [AI Workshop Lab](docs/microsoft-foundry/ai-workshop-lab.md) - Gjør AI-løsningene dine AZD-klare
...
- Azure OpenAI (betal etter bruk): $0-50/måned (basert på tokenbruk)
...
- Azure OpenAI (PTU for konsistent ytelse): $3,000+/måned ELLER betal etter bruk med høyt volum
...
#### Læringsressurser
- **📖 Konfigurasjon**: [Konfigurasjonsguide](docs/getting-started/configuration.md) - Miljøoppsett
...
#### Læringsressurser
- **📖 Distribusjon**: [Distribusjonsguide](docs/deployment/deployment-guide.md) - Fullstendige arbeidsflyter
...
**💡 Kapittelresultat**: Distribuere komplekse applikasjoner med flere tjenester ved bruk av egendefinerte infrastrukturalternativer
...
#### Læringsressurser
- **🤖 Fremhevet prosjekt**: [Retail Multi-Agent Solution](examples/retail-scenario.md) - Fullstendig implementering
...
- Implementer automatiserte pre-distribusjonssjekker
...
- **🕵️ Debugging**: [Debugging-guide](docs/troubleshooting/debugging.md) - Trinnvise strategier
...
- **📝 Eksempler**: [Mikrotjenesteeksempel](../../examples/microservices) - Komplekse arkitekturer
- **📊 Overvåking**: [Application Insights-integrasjon](docs/pre-deployment/application-insights.md) - Overvåking

#### Praktiske øvelser
- Implementer bedriftsikkerhetsmønstre
...
> Workshop-materialene er under utvikling og forbedring. Kjerne-moduler fungerer, men noen avanserte seksjoner er ufullstendige. Vi jobber aktivt med å fullføre alt innhold. [Følg fremdriften →](workshop/README.md)

### Interaktive workshop-materialer
**Omfattende praktisk læring med nettleserbaserte verktøy og veiledede øvelser**

Våre workshop-materialer gir en strukturert, interaktiv læringsopplevelse som utfyller kapittelbasert pensum ovenfor. Workshoppen er designet for både selvstyrt læring og instruktørledede økter.
...
#### 📚 Workshop-struktur
Workshoppen følger metodikken **Oppdagelse → Distribusjon → Tilpasning**:
...
Azure Developer CLI (azd) er et utviklervennlig kommandolinjegrensesnitt som akselererer prosessen med å bygge og distribuere applikasjoner til Azure. Det tilbyr:
...
- **Kostnadsoptimalisering** - Smarte ressursallokeringer og skaleringsstrategier for AI-arbeidsbelastninger
...
### ❌ Finner ikke URL til distribuert applikasjon
...
- **Topp utfordringer**: Distribusjon av flere tjenester, håndtering av legitimasjon, produksjonsklarhet  
