...
- [用於 AI 模型的 AZD 配置](../../../../docs/chapter-02-ai-development)
...
| Text-embedding-ada-002 | 搜索、RAG | 30-120 TPM | 對語意搜尋至關重要 |
...
3. **實作 [生產 AI 實務](production-ai-practices.md)** 以供企業部署
...
免責聲明：
本文件由 AI 翻譯服務 Co-op Translator (https://github.com/Azure/co-op-translator) 所翻譯。雖然我們致力提供準確的翻譯，但請注意自動翻譯可能仍含有錯誤或不準確之處。以原始語言撰寫的原文應被視為具權威性的來源。若涉及重要資訊，建議委託專業人員進行人工翻譯。我們對因使用本翻譯而導致的任何誤解、誤譯或錯誤詮釋概不負責。
