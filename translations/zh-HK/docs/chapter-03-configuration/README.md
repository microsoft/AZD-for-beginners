...
**📚 課程**： [AZD 入門](../../README.md) | **⏱️ 時長**：45-60 分鐘 | **⭐ 複雜度**：中級

---

## 概述

本章涵蓋環境配置、身份驗證模式以及 Azure Developer CLI 部署的安全最佳實踐。

> 已於 2026 年 6 月使用 `azd 1.25.6` 進行驗證。
...
| 2 | [身份驗證與安全](authsecurity.md) | 管理身份和 RBAC 模式 | 30 分鐘 |
...
- [預部署檢查](../chapter-06-pre-deployment/README.md)
