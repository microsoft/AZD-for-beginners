...
![AZD-for-beginners](../../translated_images/pt-BR/azdbeginners.5527441dd9f74068.webp) 
...
4. **Escolha Seu Caminho de Aprendizado**: Selecione um capítulo abaixo que combine com seu nível de experiência
...
[Árabe](../ar/README.md) | [Bengali](../bn/README.md) | [Búlgaro](../bg/README.md) | [Birmanês (Myanmar)](../my/README.md) | [Chinês (Simplificado)](../zh-CN/README.md) | [Chinês (Tradicional, Hong Kong)](../zh-HK/README.md) | [Chinês (Tradicional, Macau)](../zh-MO/README.md) | [Chinês (Tradicional, Taiwan)](../zh-TW/README.md) | [Croata](../hr/README.md) | [Tcheco](../cs/README.md) | [Dinamarquês](../da/README.md) | [Holandês](../nl/README.md) | [Estoniano](../et/README.md) | [Finlandês](../fi/README.md) | [Francês](../fr/README.md) | [Alemão](../de/README.md) | [Grego](../el/README.md) | [Hebraico](../he/README.md) | [Hindi](../hi/README.md) | [Húngaro](../hu/README.md) | [Indonésio](../id/README.md) | [Italiano](../it/README.md) | [Japonês](../ja/README.md) | [Kannada](../kn/README.md) | [Coreano](../ko/README.md) | [Lituano](../lt/README.md) | [Malaio](../ms/README.md) | [Malayalam](../ml/README.md) | [Marathi](../mr/README.md) | [Nepali](../ne/README.md) | [Pidgin Nigeriano](../pcm/README.md) | [Norueguês](../no/README.md) | [Persa (Farsi)](../fa/README.md) | [Polonês](../pl/README.md) | [Português (Brasil)](./README.md) | [Português (Portugal)](../pt-PT/README.md) | [Punjabi (Gurmukhi)](../pa/README.md) | [Romeno](../ro/README.md) | [Russo](../ru/README.md) | [Sérvio (Cirílico)](../sr/README.md) | [Eslovaco](../sk/README.md) | [Esloveno](../sl/README.md) | [Espanhol](../es/README.md) | [Suaíli](../sw/README.md) | [Sueco](../sv/README.md) | [Tagalo (Filipino)](../tl/README.md) | [Tâmil](../ta/README.md) | [Telugu](../te/README.md) | [Tailandês](../th/README.md) | [Turco](../tr/README.md) | [Ucraniano](../uk/README.md) | [Urdu](../ur/README.md) | [Vietnamita](../vi/README.md)

> **Prefere Clonar Localmente?**

> Este repositório inclui traduções em mais de 50 idiomas, o que aumenta significativamente o tamanho do download. Para clonar sem traduções, use o checkout esparso:
> ```bash
...
Domine o Azure Developer CLI (azd) por meio de capítulos estruturados para aprendizado progressivo. **Foco especial na implantação de aplicações de IA com integração Microsoft Foundry.**

### Por Que Este Curso é Essencial para Desenvolvedores Modernos

Baseado nas percepções da comunidade Discord Microsoft Foundry, **45% dos desenvolvedores querem usar o AZD para cargas de trabalho de IA** mas enfrentam desafios com:
...
- Otimização de custos para cargas de IA
...
- **Solucionar Problemas de Implantação**: resolver problemas comuns e fazer debug
- **Otimizar Para Produção**: segurança, escalonamento, monitoramento e gestão de custos
...
**Pré-requisitos**: Assinatura do Azure, conhecimentos básicos de linha de comando  
**Duração**: 30-45 minutos  
**Complexidade**: ⭐

#### O Que Você Vai Aprender
- Entendendo os fundamentos do Azure Developer CLI
- Instalando AZD na sua plataforma
- Sua primeira implantação bem sucedida

#### Recursos de Aprendizado
- **🎯 Comece Aqui**: [O que é o Azure Developer CLI?](../..)
- **📖 Teoria**: [Conceitos Básicos do AZD](docs/getting-started/azd-basics.md) - conceitos centrais e terminologia
...
```bash
# Após concluir o Capítulo 1, você deve ser capaz de:
...
- Implantação de aplicações com inteligência artificial
...
- **🛠️ Oficina**: [Laboratório da Oficina de IA](docs/microsoft-foundry/ai-workshop-lab.md) - prepare suas soluções de IA para AZD
...
#### Exercícios Práticos
```bash
# Implemente sua primeira aplicação de IA
...
azd init --template azure-search-openai-demo
azd up
# Testar a interface de bate-papo com IA
...
**💰 Consciência de Custos:** Entende custos de dev de $80-150/mês, custos de produção de $300-3500/mês

#### 💰 Considerações de Custos para Implantações de IA

**Ambiente de Desenvolvimento (Estimado $80-150/mês):**
- Azure OpenAI (pague conforme uso): $0-50/mês (baseado no uso de tokens)
...
- Azure OpenAI (PTU para performance consistente): $3.000+/mês OU Pay-as-you-go com volume alto
...
- Use o **Nível Gratuito** do Azure OpenAI para aprendizado (50.000 tokens/mês incluídos)
- Execute `azd down` para desalocar recursos quando não estiver desenvolvendo ativamente
- Comece com faturamento por consumo, mude para PTU somente em produção
...
- **📝 Exemplos**: [Exemplo de Aplicação de Banco de Dados](examples/database-app/README.md) - Exemplos de Banco de Dados AZD

#### Exercícios Práticos
- Configurar múltiplos ambientes (dev, staging, prod)
- Configurar autenticação via identidade gerenciada
...
- **📝 Exemplos**: [Exemplo de Aplicação em Container](../../examples/container-app) - implantações containerizadas
...
**💡 Resultado do Capítulo**: Implantar aplicações multi-serviço complexas usando templates de infraestrutura personalizadas
...
- Implantação de IA pronta para produção
...
# Explore as configurações do agente
az deployment group show --resource-group <rg-name> --name <deployment-name>
```

**💡 Resultado do Capítulo**: Implantar e gerenciar uma solução de IA multiagente pronta para produção com agentes Cliente e Inventário
...
**💡 Resultado do Capítulo**: Implantar aplicações prontas para produção empresarial com capacidades completas
...
> Os materiais do workshop estão atualmente em desenvolvimento e refinamento. Módulos principais estão funcionais, mas algumas seções avançadas estão incompletas. Estamos trabalhando para concluir todo o conteúdo. [Acompanhar progresso →](workshop/README.md)

### Materiais Interativos do Workshop
**Aprendizagem prática completa com ferramentas baseadas em navegador e exercícios guiados**

Nossos materiais fornecem uma experiência de aprendizagem estruturada e interativa que complementa o currículo baseado em capítulos acima. O workshop é projetado tanto para aprendizado autodirigido quanto para sessões conduzidas por instrutores.

#### 🛠️ Recursos do Workshop
- **Interface baseada no navegador**: Workshop completo com MkDocs, busca, cópia e temas
- **Integração GitHub Codespaces**: Configuração de ambiente de desenvolvimento com um clique
...
O workshop segue a metodologia **Descoberta → Implantação → Personalização**:

1. **Fase de Descoberta** (45 min)
...
3. **Fase de Personalização** (45 min)
...
- **🎥 Guia Interativo**: [Materiais do Workshop](workshop/README.md) - Ambiente de aprendizado via navegador
- **📋 Instruções Passo a Passo**: [Exercícios Guiados](../../workshop/docs/instructions) - Tutoriais detalhados
- **🛠️ Laboratório AI Workshop**: [Laboratório AI Workshop](docs/microsoft-foundry/ai-workshop-lab.md) - Exercícios focados em IA
- **💡 Início Rápido**: [Guia de Configuração do Workshop](workshop/README.md#quick-start) - Configuração do ambiente

**Ideal para**: Treinamento corporativo, cursos universitários, aprendizado autodirigido e bootcamps para desenvolvedores.

---

## 📖 O Que é o Azure Developer CLI?

Azure Developer CLI (azd) é uma interface de linha de comando centrada no desenvolvedor que acelera o processo de criação e implantação de aplicações no Azure. Ele oferece:
...
- **Fluxos de trabalho integrados** - Provisionar, implantar e monitorar aplicações sem interrupções
...
**Por que usar AZD para soluções de IA?** AZD resolve os principais desafios enfrentados por desenvolvedores de IA:

- **Templates Prontos para IA** - Templates pré-configurados para Azure OpenAI, Cognitive Services e cargas de trabalho ML
- **Implantações Seguras de IA** - Padrões de segurança integrados para serviços de IA, chaves de API e endpoints de modelo  
- **Padrões de IA para Produção** - Melhores práticas para implantações escaláveis e custo-efetivas de aplicações de IA
- **Fluxos de Trabalho de IA de Ponta a Ponta** - Do desenvolvimento de modelos até implantação em produção com monitoramento adequado
- **Otimização de Custos** - Alocação inteligente e estratégias de escala para cargas de trabalho de IA
- **Integração Microsoft Foundry** - Conexão fluida com catálogo de modelos e endpoints Microsoft Foundry
...
> **Nota:** Estes templates demonstram vários padrões de IA. Alguns são Samples Azure externos, outros são implementações locais.
...
**Templates de aplicações prontas para produção alinhadas aos capítulos de aprendizado**
...
| [**ai-document-processing**](https://github.com/Azure-Samples/ai-document-processing) | Capítulo 4 | ⭐⭐ | Integração com inteligência documental |
...
> **Exemplos Externos** (Samples Azure) = Clone dos repositórios vinculados
...
- [**Exemplos de Container App**](examples/container-app/README.md) - Guia completo para implantações conteinerizadas
  ...
  - Padrões de implantação Início Rápido, Produção e Avançado
...
- [Funções + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - Fluxo de trabalho serverless de dados

#### Exemplos Externos - Padrões Avançados (Capítulos 4-8)
- [Microsserviços em Java](https://github.com/Azure-Samples/java-microservices-aca-lab) - Arquiteturas multi-serviço
- [Jobs para Container Apps](https://github.com/Azure-Samples/container-apps-jobs) - Processamento em background  
- [Pipeline de ML Empresarial](https://github.com/Azure-Samples/mlops-v2) - Padrões ML prontos para produção
...
- [**Modelos da Azure Developer CLI**](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/azd-templates) - Documentação de modelos Microsoft Learn
...
- [**Caminho de Aprendizado Estruturado**](../../workshop/docs/instructions) - Exercícios guiados em 7 passos (Descoberta → Implantação → Personalização)
- [**Oficina AZD para Iniciantes**](workshop/README.md) - Materiais completos da oficina prática com integração GitHub Codespaces
...
### ❌ Implantação do template demorando muito
...
# Você precisa de pelo menos a função "Contribuidor"
...
### ❌ Não consegue encontrar o URL do aplicativo implantado
...
### 📚 Recursos completos para solução de problemas
...
# Você precisa pelo menos do papel "Colaborador"
# Peça ao administrador do Azure para conceder:
# - Colaborador (para recursos)
# - Administrador de Acesso de Usuário (para atribuições de papéis)
```
</details>

<details>
<summary><strong>❌ Não consegue encontrar o URL do aplicativo implantado</strong></summary>
...
Acompanhe seu progresso de aprendizado por cada capítulo:
...
3. **Discussão na Comunidade**: Compartilhe sua experiência no Discord Azure
...
- **Avanço na Carreira**: Especialização em implantação AZD e IA em alta demanda
...
- **45%** dos desenvolvedores querem usar o AZD para cargas de trabalho de IA
- **Principais desafios**: Implantação multi-serviço, gerenciamento de credenciais, prontidão para produção  
...
- Compartilhar suas experiências AZD + IA e obter ajuda
...
- **Padrões Comunitários**: Siga nossas diretrizes inclusivas de comunidade
...
### Recursos Relacionados de Aprendizado Microsoft

Nossa equipe produz outros cursos completos de aprendizado:
...
**Próximos Passos**: [Comece o Capítulo 1 - Noções Básicas AZD](docs/getting-started/azd-basics.md) →
