...
[![Discord do Azure](https://dcbadge.limes.pink/api/server/https://discord.gg/microsoft-azure)](https://discord.gg/microsoft-azure)
...
[Árabe](../ar/README.md) | [Bengalês](../bn/README.md) | [Búlgaro](../bg/README.md) | [Birmanês (Myanmar)](../my/README.md) | [Chinês (Simplificado)](../zh-CN/README.md) | [Chinês (Tradicional, Hong Kong)](../zh-HK/README.md) | [Chinês (Tradicional, Macau)](../zh-MO/README.md) | [Chinês (Tradicional, Taiwan)](../zh-TW/README.md) | [Croata](../hr/README.md) | [Tcheco](../cs/README.md) | [Dinamarquês](../da/README.md) | [Holandês](../nl/README.md) | [Estoniano](../et/README.md) | [Finlandês](../fi/README.md) | [Francês](../fr/README.md) | [Alemão](../de/README.md) | [Grego](../el/README.md) | [Hebraico](../he/README.md) | [Hindi](../hi/README.md) | [Húngaro](../hu/README.md) | [Indonésio](../id/README.md) | [Italiano](../it/README.md) | [Japonês](../ja/README.md) | [Canarês](../kn/README.md) | [Coreano](../ko/README.md) | [Lituano](../lt/README.md) | [Malaio](../ms/README.md) | [Malayalam](../ml/README.md) | [Marathi](../mr/README.md) | [Nepali](../ne/README.md) | [Pidgin Nigeriano](../pcm/README.md) | [Norueguês](../no/README.md) | [Persa (Farsi)](../fa/README.md) | [Polonês](../pl/README.md) | [Português (Brasil)](./README.md) | [Português (Portugal)](../pt-PT/README.md) | [Punjabi (Gurmukhi)](../pa/README.md) | [Romeno](../ro/README.md) | [Russo](../ru/README.md) | [Sérvio (Cirílico)](../sr/README.md) | [Eslovaco](../sk/README.md) | [Esloveno](../sl/README.md) | [Espanhol](../es/README.md) | [Suaíli](../sw/README.md) | [Sueco](../sv/README.md) | [Tagalog (Filipino)](../tl/README.md) | [Tâmil](../ta/README.md) | [Telugu](../te/README.md) | [Tailandês](../th/README.md) | [Turco](../tr/README.md) | [Ucraniano](../uk/README.md) | [Urdu](../ur/README.md) | [Vietnamita](../vi/README.md)
...
> ```
> Isso lhe dá tudo o que você precisa para concluir o curso com um download muito mais rápido.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## 🚀 O que é o Azure Developer CLI (azd)?

**Azure Developer CLI (azd)** é uma ferramenta de linha de comando voltada para desenvolvedores que facilita implantar aplicações no Azure. Em vez de criar e conectar manualmente dezenas de recursos do Azure, você pode implantar aplicações inteiras com um único comando.
...
**É isso!** Nada de clicar no Portal do Azure, nada de templates ARM complexos para aprender primeiro, nada de configuração manual - apenas aplicações funcionando no Azure.
...
|---------|---------------------|--------------------------------|
| **Purpose** | Gerenciar recursos individuais do Azure | Implantar aplicações completas |
| **Mindset** | Focado em infraestrutura | Focado em aplicações |
| **Example** | `az webapp create --name myapp...` | `azd up` |
| **Learning Curve** | Precisa conhecer os serviços do Azure | Só precisa conhecer sua aplicação |
| **Best For** | DevOps, Infraestrutura | Desenvolvedores, Prototipagem |
...
```bash
# Implemente seu aplicativo com o AZD
azd up

# Em seguida, ajuste recursos específicos com o Azure CLI
...
|----------|-------------|
| 🔗 [**Galeria Awesome AZD**](https://azure.github.io/awesome-azd/) | Navegue por 200+ modelos com implantação com um clique |
| 🔗 [**Enviar um Modelo**](https://github.com/Azure/awesome-azd/issues) | Contribua com seu próprio modelo para a comunidade |
| 🔗 [**Repositório no GitHub**](https://github.com/Azure/awesome-azd) | Dê uma estrela e explore o código-fonte |

### Modelos Populares de IA do Awesome AZD
...
### Passo 3: Faça o Deploy do Seu Primeiro Aplicativo
...
**🎉 Pronto!** Seu aplicativo está agora ativo no Azure.
...
Este curso foi projetado para **aprendizado progressivo** - comece onde você se sente confortável e avance no seu ritmo:

| Sua Experiência | Comece Aqui |
|-----------------|------------|
| **Novo no Azure** | [Capítulo 1: Fundamentos](../..) |
| **Conhece o Azure, novo no AZD** | [Capítulo 1: Fundamentos](../..) |
| **Deseja implantar aplicativos de IA** | [Capítulo 2: Desenvolvimento de IA](../..) |
| **Quer prática prática** | [🎓 Interactive Workshop](workshop/README.md) - 3-4 hour guided lab |
...
3. **Obtenha Ajuda**: [Azure Discord Community](https://discord.com/invite/ByRwuEEgH4)
...
Domine o Azure Developer CLI (azd) através de capítulos estruturados projetados para aprendizado progressivo. **Foco especial em implantação de aplicativos de IA com integração ao Microsoft Foundry.**
...
- **Resolver Problemas de Implantação**: Solucionar problemas comuns e depurar falhas
...
|---------|-------|---------|----------|------------|
| **[Capítulo 1: Fundamentos](docs/chapter-01-foundation/README.md)** | Iniciando | [Noções Básicas do AZD](docs/chapter-01-foundation/azd-basics.md) &#124; [Instalação](docs/chapter-01-foundation/installation.md) &#124; [Primeiro Projeto](docs/chapter-01-foundation/first-project.md) | 30-45 min | ⭐ |
| **[Capítulo 2: Desenvolvimento de IA](docs/chapter-02-ai-development/README.md)** | Aplicativos com foco em IA | [Integração com Foundry](docs/chapter-02-ai-development/microsoft-foundry-integration.md) &#124; [Agentes de IA](docs/chapter-02-ai-development/agents.md) &#124; [Implantação de Modelos](docs/chapter-02-ai-development/ai-model-deployment.md) &#124; [Laboratório](docs/chapter-02-ai-development/ai-workshop-lab.md) | 1-2 hrs | ⭐⭐ |
...
| **[Capítulo 5: Multi-Agente](docs/chapter-05-multi-agent/README.md)** | Soluções de Agentes de IA | [Cenário de Varejo](examples/retail-scenario.md) &#124; [Padrões de Coordenação](docs/chapter-06-pre-deployment/coordination-patterns.md) | 2-3 horas | ⭐⭐⭐⭐ |
| **[Capítulo 6: Pré-Implantação](docs/chapter-06-pre-deployment/README.md)** | Planejamento & Validação | [Verificações Pré-Implantação](docs/chapter-06-pre-deployment/preflight-checks.md) &#124; [Planejamento de Capacidade](docs/chapter-06-pre-deployment/capacity-planning.md) &#124; [Seleção de SKU](docs/chapter-06-pre-deployment/sku-selection.md) &#124; [Application Insights](docs/chapter-06-pre-deployment/application-insights.md) | 1 hora | ⭐⭐ |
...
| **[Capítulo 8: Produção](docs/chapter-08-production/README.md)** | Padrões Empresariais | [Práticas de Produção](docs/chapter-08-production/production-ai-practices.md) | 2-3 horas | ⭐⭐⭐⭐ |
| **[🎓 Workshop](workshop/README.md)** | Laboratório Prático | [Introdução](workshop/docs/instructions/0-Introduction.md) &#124; [Seleção](workshop/docs/instructions/1-Select-AI-Template.md) &#124; [Validação](workshop/docs/instructions/2-Validate-AI-Template.md) &#124; [Desconstrução](workshop/docs/instructions/3-Deconstruct-AI-Template.md) &#124; [Configuração](workshop/docs/instructions/4-Configure-AI-Template.md) &#124; [Personalização](workshop/docs/instructions/5-Customize-AI-Template.md) &#124; [Desmontagem da Infraestrutura](workshop/docs/instructions/6-Teardown-Infrastructure.md) &#124; [Conclusão](workshop/docs/instructions/7-Wrap-up.md) | 3-4 horas | ⭐⭐ |
...
**📈 Nível de Habilidade Depois:** Consegue implantar aplicações básicas de forma independente

**✅ Validação de Sucesso:**
```bash
# Depois de concluir o Capítulo 1, você deverá ser capaz de:
...
#### O que você vai aprender
- Integração com Microsoft Foundry usando o AZD
...
- **🤖 Agentes de IA**: [Guia de Agentes de IA](docs/chapter-02-ai-development/agents.md) - Implantação de agentes inteligentes com AZD
...
- **🛠️ Workshop**: [Laboratório de IA](docs/chapter-02-ai-development/ai-workshop-lab.md) - Prepare suas soluções de IA para o AZD
- **🎥 Guia Interativo**: [Materiais do Workshop](workshop/README.md) - Aprendizado baseado em navegador com MkDocs * DevContainer Environment
- **📋 Modelos**: [Modelos do Microsoft Foundry](../..)
...
**📈 Nível de Habilidade Depois:** Consegue implantar e configurar aplicações de IA prontas para produção  
**💰 Consciência de Custos:** Entenda custos de $80-150/mês em desenvolvimento, $300-3.500/mês em produção

#### 💰 Considerações de Custo para Implantações de IA

**Ambiente de Desenvolvimento (Estimado $80-150/mês):**
- Azure OpenAI (Pay-as-you-go): $0-50/mês (baseado no uso de tokens)
...
- Azure OpenAI (PTU para desempenho consistente): $3.000+/mês OU Pay-as-you-go com alto volume
- AI Search (camada Standard): $250/mês
...
- Use a **Camada Gratuita** do Azure OpenAI para aprendizado (50.000 tokens/mês incluídos)
- Execute `azd down` para desalocar recursos quando não estiver desenvolvendo ativamente
- Comece com cobrança por consumo, faça upgrade para PTU apenas em produção
...
- **🔐 Segurança**: [Padrões de Autenticação e Managed Identity](docs/chapter-03-configuration/authsecurity.md) - Padrões de autenticação
- **📝 Exemplos**: [Exemplo de Aplicativo com Banco de Dados](examples/database-app/README.md) - Exemplos de Banco de Dados AZD

#### Exercícios Práticos
- Configure múltiplos ambientes (dev, staging, prod)
- Configure autenticação com managed identity
...
- Implemente estratégias de implantação blue-green
...
- **🛠️ ARM Templates**: [Pacote de Template ARM](../../examples/retail-multiagent-arm-template) - Implantação com um clique
- **📖 Arquitetura**: [Padrões de coordenação multi-agente](docs/chapter-06-pre-deployment/coordination-patterns.md) - Padrões

#### Exercícios Práticos
```bash
# Implantar a solução completa de múltiplos agentes no varejo
...
- Otimize a seleção de SKUs para custo
- Implemente verificações pré-implantação automatizadas
...
#### Exercícios Práticos
- Diagnostique falhas de implantação
- Resolva problemas de autenticação
- Depure conectividade de serviços de IA
...
#### Exercícios Práticos
- Implemente padrões de segurança corporativa
- Configure monitoramento abrangente
- Implemente em produção com governança adequada

**💡 Resultado do Capítulo**: Implantar aplicações prontas para ambiente corporativo com capacidades completas de produção

---

## 🎓 Visão Geral do Workshop: Experiência de Aprendizado Prática

> **⚠️ STATUS DO WORKSHOP: Em Desenvolvimento**  
> Os materiais do workshop estão atualmente sendo desenvolvidos e refinados. Os módulos principais estão funcionais, mas algumas seções avançadas estão incompletas. Estamos trabalhando ativamente para concluir todo o conteúdo. [Acompanhe o progresso →](workshop/README.md)
...
Nossos materiais de workshop oferecem uma experiência de aprendizado estruturada e interativa que complementa o currículo baseado em capítulos acima. O workshop é projetado tanto para aprendizado no próprio ritmo quanto para sessões conduzidas por instrutores.

#### 🛠️ Recursos do Workshop
- **Browser-Based Interface**: Workshop completo com MkDocs, com recursos de pesquisa, cópia e temas
- **GitHub Codespaces Integration**: Configuração do ambiente de desenvolvimento com um clique
- **Structured Learning Path**: Exercícios guiados em 8 módulos (3-4 horas no total)
- **Progressive Methodology**: Introdução → Seleção → Validação → Desconstrução → Configuração → Personalização → Desmontagem → Conclusão
- **Interactive DevContainer Environment**: Ferramentas e dependências pré-configuradas

#### 📚 Estrutura dos Módulos do Workshop
O workshop segue uma **metodologia progressiva de 8 módulos** que o leva da descoberta até a maestria em implantação:

| Module | Topic | What You'll Do | Duration |
|--------|-------|----------------|----------|
| **0. Introduction** | Workshop Overview | Entender objetivos de aprendizagem, pré-requisitos e a estrutura do workshop | 15 min |
| **1. Selection** | Template Discovery | Explore templates do AZD e selecione o template de IA certo para seu cenário | 20 min |
| **2. Validation** | Deploy & Verify | Implemente o template com `azd up` e valide se a infraestrutura funciona | 30 min |
| **3. Deconstruction** | Understand Structure | Use o GitHub Copilot para explorar a arquitetura do template, arquivos Bicep e a organização do código | 30 min |
| **4. Configuration** | azure.yaml Deep Dive | Domine a configuração do `azure.yaml`, hooks de ciclo de vida e variáveis de ambiente | 30 min |
| **5. Customization** | Make It Yours | Habilite AI Search, tracing, avaliação, e personalize para o seu cenário | 45 min |
| **6. Teardown** | Clean Up | Desprovisionar os recursos com segurança usando `azd down --purge` | 15 min |
| **7. Wrap-up** | Next Steps | Revise conquistas, conceitos-chave e continue sua jornada de aprendizado | 15 min |
...
- **Deploy Production AI Applications**: Use AZD com os serviços Microsoft Foundry
- **Master Multi-Agent Architectures**: Implemente soluções de agentes de IA coordenados
- **Implement Security Best Practices**: Configure autenticação e controle de acesso
- **Optimize for Scale**: Projete implantações econômicas e de alto desempenho
- **Troubleshoot Deployments**: Resolva problemas comuns de forma independente
...
- **📋 Instruções por Módulo**:
  ...
  - [6. Desmontagem](workshop/docs/instructions/6-Teardown-Infrastructure.md) - Limpe os recursos
  - [7. Conclusão](workshop/docs/instructions/7-Wrap-up.md) - Revisão e próximos passos
- **🛠️ Laboratório do Workshop de IA**: [Laboratório do Workshop de IA](docs/chapter-02-ai-development/ai-workshop-lab.md) - Exercícios focados em IA
- **💡 Início Rápido**: [Guia de Configuração do Workshop](workshop/README.md#quick-start) - Configuração do ambiente

**Perfeito para**: Treinamento corporativo, cursos universitários, aprendizado autodirigido e bootcamps para desenvolvedores.

---

## 📖 Aprofundamento: Capacidades do AZD

Além do básico, o AZD oferece recursos poderosos para implantações em produção:

- **Template-based deployments** - Use templates pré-construídos para padrões comuns de aplicação
- **Infrastructure as Code** - Gerencie recursos do Azure usando Bicep ou Terraform  
- **Integrated workflows** - Provisione, implante e monitore aplicações de forma contínua
- **Developer-friendly** - Otimizado para produtividade e experiência do desenvolvedor

### **AZD + Microsoft Foundry: Perfeito para Implantações de IA**

**Por que AZD para Soluções de IA?** O AZD aborda os principais desafios que desenvolvedores de IA enfrentam:

- **AI-Ready Templates** - Templates pré-configurados para Azure OpenAI, Cognitive Services e cargas de trabalho de ML
- **Secure AI Deployments** - Padrões de segurança integrados para serviços de IA, chaves de API e endpoints de modelos  
- **Production AI Patterns** - Melhores práticas para implantações de aplicações de IA escaláveis e econômicas
- **End-to-End AI Workflows** - Do desenvolvimento de modelos até a implantação em produção com monitoramento adequado
- **Cost Optimization** - Alocação inteligente de recursos e estratégias de escalonamento para cargas de trabalho de IA
- **Microsoft Foundry Integration** - Conexão perfeita ao catálogo de modelos e endpoints do Microsoft Foundry

---

## 🎯 Biblioteca de Templates e Exemplos

### Destaque: Templates do Microsoft Foundry
...
### Destaque: Cenários de Aprendizado Completos
**Templates de aplicações prontos para produção mapeados para os capítulos de aprendizado**
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | Capítulo 5 | ⭐⭐⭐⭐ | Arquitetura multi-agente com agentes Customer e Inventory |

### Aprendizado por Tipo de Exemplo

> **📌 Exemplos Locais vs. Externos:**  
> **Exemplos Locais** (neste repositório) = Prontos para uso imediato  
> **Exemplos Externos** (Azure Samples) = Clone a partir dos repositórios vinculados
...
- [**Retail Multi-Agent Solution**](examples/retail-scenario.md) - Implementação completa pronta para produção com templates ARM
  - Arquitetura multi-agente (agentes Customer + Inventory)
...
**Clone estes repositórios do Azure Samples para começar:**
...
#### Exemplos Externos - Integração de Banco de Dados (Capítulos 3-4)  
- [Database App - C# + SQL](https://github.com/Azure-Samples/todo-csharp-sql) - Padrões de conectividade com banco de dados
- [Functions + Cosmos DB](https://github.com/Azure-Samples/todo-python-mongo-swa-func) - Workflow serverless de dados
...
# Se estiver travado por mais de 30 minutos, verifique o Azure Portal:
azd monitor
...
# Você precisa, no mínimo, da função "Colaborador"
...
- **Experiência em Produção**: Implantado aplicações de IA reais no Azure
...
- **Avanço na Carreira**: Expertise em implantação AZD e IA em alta demanda
...
- **Dúvidas de Aprendizado**: [Comunidade Microsoft Azure Discord](https://discord.gg/microsoft-azure) and [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
### Percepções da Comunidade do Microsoft Foundry Discord
...
- Influenciar o desenvolvimento futuro de recursos AI + AZD
...
[![AI Agents para Iniciantes](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
**Desenvolvedores de IA**: Ir para [Capítulo 2: Desenvolvimento com IA em Primeiro Lugar](../..)  
