...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T12:44:45+00:00",
...
透過系統化章節掌握 Azure Developer CLI (azd)，逐步學習。**特別聚焦於使用 Azure AI Foundry 部署 AI 應用程式。**
...
Azure Developer CLI (azd) 是一個以開發者為中心的命令列介面，能加速在 Azure 上建置和部署應用程式的過程。它提供：
...
- **AI 就緒範本** - 預配置範本適用於 Azure OpenAI、Cognitive Services 和 ML 工作負載
...
| 範本 | 章節 | 複雜度 | 服務 |
|----------|---------|------------|----------|
| [**開始使用 AI 聊天**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 第 2 章 | ⭐⭐ | AzureOpenAI + Azure AI 模型推理 API + Azure AI 搜索 + Azure Container Apps + Application Insights |
| [**開始使用 AI 代理**](https://github.com/Azure-Samples/get-started-with-ai-agents) | 第 2 章 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI 搜索 + Azure Container Apps + Application Insights|
...
| [**構建您的對話代理**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 第 4 章 | ⭐⭐⭐ | AI Language + AzureOpenAI + AI 搜索 + Azure Storage + Azure Container Registry|
| [**從對話數據中解鎖洞察**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 第 8 章 | ⭐⭐⭐ | AzureOpenAI + AI 搜索 + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | 第 2 章 | ⭐⭐ | 使用 Azure AI 搜索實現 RAG |
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | 第 5 章 | ⭐⭐⭐⭐ | 客戶和庫存代理的多代理架構 |
...
### 為課程做出貢獻
我們歡迎貢獻！請閱讀 [貢獻指南](CONTRIBUTING.md) 了解詳細資訊：
- **內容改進**：增強現有章節和範例
- **新增範例**：添加真實場景和範本  
- **翻譯**：幫助維護多語言支持
- **錯誤回報**：提高準確性和清晰度
