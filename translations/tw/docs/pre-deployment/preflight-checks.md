...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:14:09+00:00",
...
本指南提供全面的部署前驗證腳本和程序，確保在開始之前成功完成 Azure Developer CLI 部署。學習如何實施自動化檢查，包括身份驗證、資源可用性、配額、安全合規性和性能需求，以防止部署失敗並優化部署成功率。
...
- [ ] 用戶在目標訂閱/資源群組中擁有 Contributor 角色
- [ ] 為 CI/CD 配置的服務主體（如適用）
- [ ] 沒有過期的證書或憑據
...
**專家提示**：在您的 CI/CD 管道中將部署前檢查作為單獨的作業運行，這樣可以提前發現問題並為開發人員提供更快的反饋。
...
**免責聲明**：  
本文件已使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。我們致力於提供準確的翻譯，但請注意，自動翻譯可能包含錯誤或不準確之處。原始文件的母語版本應被視為權威來源。對於關鍵資訊，建議尋求專業人工翻譯。我們對因使用此翻譯而引起的任何誤解或誤釋不承擔責任。