...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T14:09:38+00:00",
...
這個動手實驗將引導開發者使用 Azure Developer CLI (AZD) 部署現有的 AI 範本。您將學習使用 Azure AI Foundry 服務進行生產環境 AI 部署的基本模式。
