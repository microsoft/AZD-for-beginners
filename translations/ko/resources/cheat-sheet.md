...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T18:00:39+00:00",
...
이 종합 치트 시트는 가장 자주 사용되는 Azure Developer CLI 명령어를 카테고리별로 정리하고 실용적인 예제를 제공합니다. 개발, 문제 해결, 그리고 azd 프로젝트의 일상적인 작업 중 빠른 참조를 위해 완벽한 자료입니다.
