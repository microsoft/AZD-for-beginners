...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:15:47+00:00",
...
이 종합 가이드는 Azure Developer CLI 배포가 시작되기 전에 성공적인 배포를 보장하기 위한 사전 검증 스크립트와 절차를 제공합니다. 인증, 리소스 가용성, 할당량, 보안 준수, 성능 요구 사항에 대한 자동화된 점검을 구현하여 배포 실패를 방지하고 성공률을 최적화하는 방법을 배울 수 있습니다.

## 학습 목표

이 가이드를 완료하면 다음을 할 수 있습니다:
- 자동화된 사전 배포 검증 기술과 스크립트를 숙달
- 인증, 권한 및 할당량에 대한 종합적인 점검 전략 이해
...
- 종합적인 사전 점검 검증 스크립트 작성 및 실행
- 다양한 배포 시나리오에 대한 자동화된 점검 워크플로 설계
- 환경별 검증 절차 및 정책 구현
- 배포 준비를 위한 사전 모니터링 및 경고 구성
- 사전 배포 문제를 해결하고 수정 조치 실행
