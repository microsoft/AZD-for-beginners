...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T14:34:27+00:00",
...
이 포괄적인 가이드는 Azure Developer CLI를 사용하여 Azure 리소스를 프로비저닝하고 관리하는 데 필요한 모든 것을 다룹니다. Bicep, ARM 템플릿, Terraform, Pulumi를 사용하여 기본 리소스 생성부터 고급 엔터프라이즈급 인프라 아키텍처까지 코드로서의 인프라(IaC) 패턴을 구현하는 방법을 배울 수 있습니다.

## 학습 목표

이 가이드를 완료하면 다음을 할 수 있습니다:
- 코드로서의 인프라 원칙과 Azure 리소스 프로비저닝을 마스터하기
