...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:03:15+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "ko"
}
-->
# 리소스 프로비저닝 - AZD를 활용한 인프라 코드

## 소개

이 포괄적인 가이드는 Azure Developer CLI를 사용하여 Azure 리소스를 프로비저닝하고 관리하는 방법에 대해 다룹니다. Bicep, ARM 템플릿, Terraform, Pulumi를 사용하여 기본 리소스 생성부터 고급 엔터프라이즈급 인프라 아키텍처까지 인프라 코드(IaC) 패턴을 구현하는 방법을 배울 수 있습니다.

## 학습 목표

이 가이드를 완료하면 다음을 할 수 있습니다:
- 인프라 코드 원칙과 Azure 리소스 프로비저닝을 마스터하기
- Azure Developer CLI가 지원하는 다양한 IaC 제공자 이해하기
- 일반적인 애플리케이션 아키텍처를 위한 Bicep 템플릿 설계 및 구현
- 리소스 매개변수, 변수 및 환경별 설정 구성하기
- 네트워킹 및 보안을 포함한 고급 인프라 패턴 구현하기
- 리소스 라이프사이클, 업데이트 및 종속성 해결 관리하기
...
- 여러 환경 및 설정을 위한 매개변수화된 템플릿 구현
- 인프라 프로비저닝 문제를 해결하고 배포 실패를 복구
- Azure Well-Architected Framework 원칙을 인프라 설계에 적용
- 인프라 업데이트를 관리하고 인프라 버전 관리 전략 구현

## 인프라 프로비저닝 개요

Azure Developer CLI는 여러 인프라 코드(IaC) 제공자를 지원합니다:
- **Bicep** (권장) - Azure의 도메인 특화 언어
- **ARM 템플릿** - JSON 기반 Azure Resource Manager 템플릿
- **Terraform** - 멀티 클라우드 인프라 도구
- **Pulumi** - 프로그래밍 언어를 활용한 현대적인 인프라 코드
...
- [배포 전 계획](../pre-deployment/capacity-planning.md) - 리소스 가용성 확인
