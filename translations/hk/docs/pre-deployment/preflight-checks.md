...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T13:10:06+00:00",
...
本指南提供全面的部署前驗證腳本和程序，確保 Azure Developer CLI 部署在開始之前能順利進行。學習如何實施自動化檢查，包括身份驗證、資源可用性、配額、安全合規性和性能需求，以防止部署失敗並提高部署成功率。
