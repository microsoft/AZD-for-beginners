...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T17:37:33+00:00",
...
完成此學習指南後，你將能夠：
- 掌握 Azure Developer CLI 的基礎和進階概念
...
#### 學習目標
- 理解 Azure Developer CLI 的基礎和核心概念
- 成功在開發環境中安裝和配置 azd
- 使用現有模板完成首次部署
...
### 全職學習 (8 週)
- **第 1-2 週**：第一章至第二章 (入門、配置)  
- **第 3-4 週**：第三章至第四章 (部署、部署前驗證)  
- **第 5-6 週**：第五章至第六章 (故障排除、進階主題)  
- **第 7-8 週**：實踐項目與最終評估  
...
- **第 8-10 週**：第三章 (部署與配置)  
- **第 11-12 週**：第四章 (部署前驗證)  
- **第 13-14 週**：第五章 (故障排除與調試)  
- **第 15-16 週**：第六章 (進階主題與評估)  
...
### 建立實踐經驗
1. **從小開始**：從簡單的應用開始，逐步增加複雜性  
2. **從失敗中學習**：將故障排除練習視為學習機會  
3. **貢獻開源項目**：與社群分享你的模板和解決方案  
4. **教導他人**：向他人解釋概念能加強自己對內容的理解  
...
**導航**  
- **上一課**：[FAQ](faq.md)  
- **下一課**：[Changelog](../changelog.md)  

**學習進度追蹤**：使用本指南追蹤你的學習旅程，確保全面掌握所有 Azure Developer CLI 的概念和實踐。  
