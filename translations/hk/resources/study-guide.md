...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T10:38:44+00:00",
...
這份全面的學習指南提供結構化的學習目標、關鍵概念、練習題目及評估材料，幫助你掌握 Azure Developer CLI (azd)。使用這份指南來追蹤你的學習進度，確保你已涵蓋所有重要主題。

## 學習目標

完成這份學習指南後，你將能夠：
- 掌握 Azure Developer CLI 的基本及進階概念
- 發展部署及管理 Azure 應用程式的實用技能
- 建立解決問題及優化部署的信心
- 理解生產環境部署的實踐及安全考量
...
#### 實踐練習
1. **診斷技能**: 練習處理故意損壞的部署
2. **日誌分析**: 有效使用 Azure Monitor 及 Application Insights
3. **性能調整**: 優化性能較慢的應用程式
4. **恢復程序**: 實施備份及災難恢復
...
#### 學習目標
- 理解 Azure Developer CLI 的基本原理及核心概念
- 成功在你的開發環境中安裝及配置 azd
- 使用現有模板完成你的首次部署
- 瀏覽 azd 專案結構並理解其關鍵組件
...
#### 自我評估問題
1. 你如何將 azd 整合到現有的 CI/CD 工作流程中？
2. 自訂模板開發的主要考量是什麼？
3. 你如何在 azd 部署中實施治理與合規？
4. 企業級部署的最佳實踐是什麼？
5. 你如何有效地為 azd 社群作出貢獻？
...
#### 專業發展成果
- **作品集項目**：8 個適用於生產的部署
- **技術技能**：符合行業標準的 AZD 與 AI 部署專業知識
- **問題解決能力**：獨立故障排除與優化
- **社群認可**：積極參與 Azure 開發者社群
- **職業發展**：技能直接適用於雲端與 AI 職位
...
- **文檔**：為社群文檔與範例作出貢獻
- **反饋循環**: 提供有關課程內容和 Azure 服務的反饋

#### 職業發展
- **專業網絡**: 與 Azure 和 AI 專家建立聯繫
- **演講機會**: 在會議或聚會中分享學習成果
- **開源貢獻**: 為 AZD 模板和工具作出貢獻
- **指導**: 指導其他開發者學習 AZD
...
- **📚 課程主頁**: [AZD 初學者指南](../README.md)
- **📖 開始學習**: [第一章: 基礎與快速入門](../README.md#-chapter-1-foundation--quick-start)
- **🎯 進度追蹤**: 通過全面的 8 章學習系統追蹤你的進展
- **🤝 社群**: [Azure Discord](https://discord.gg/microsoft-azure) 提供支援和討論

**學習進度追蹤**: 使用這個結構化指南，通過漸進式、實用的學習方式掌握 Azure Developer CLI，並獲得可衡量的成果和職業發展的好處。
