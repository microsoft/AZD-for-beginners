...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-19T15:54:04+00:00",
...
2. **Clone 此倉庫**：`git clone https://github.com/microsoft/azd-for-beginners.git`
...
- **🛠️ 工作坊**：[AI 工作坊實驗室](docs/microsoft-foundry/ai-workshop-lab.md) - 讓你的 AI 解決方案適配 AZD
...
# 提問並獲得附有來源的AI驅動回應
# 驗證搜尋整合功能是否正常
azd monitor  # 檢查Application Insights是否顯示遙測數據
azd down --force --purge
```

**📊 時間投入：** 1-2 小時  
**📈 技能水平提升：** 能夠部署並配置生產環境的 AI 應用程式  
**💰 成本意識：** 了解 $80-150/月的開發成本，$300-3500/月的生產成本
...
**生產環境（估算 $300-3,500+/月）：**
- Azure OpenAI（PTU 保持穩定性能）：$3,000+/月 或 按使用量付費（高流量）
- AI 搜索（標準層）：$250/月
- 容器應用程式（專用）：$50-100/月
- 應用程式洞察：$5-50/月
- 儲存（高級）：$10-50/月
...
- **🔐 安全性**：[身份驗證模式與托管身份](docs/getting-started/authsecurity.md) - 身份驗證模式
...
- **📖 架構**：[多代理協作模式](/docs/pre-deployment/coordination-patterns.md) - 模式
...
**💡 章節成果**：部署及管理一個適合生產環境的多代理人工智能解決方案，包括客戶代理及庫存代理
...
- **✅ 驗證**：[預檢](docs/pre-deployment/preflight-checks.md) - 自動化腳本
...
#### 學習資源
- **🔧 常見問題**：[常見問題](docs/troubleshooting/common-issues.md) - FAQ及解決方案
- **🕵️ 除錯指南**：[除錯指南](docs/troubleshooting/debugging.md) - 步驟式策略
- **🤖 AI 問題**：[AI 特定故障排除](docs/troubleshooting/ai-troubleshooting.md) - AI服務問題
...
> **⚠️ 工作坊狀態：開發中**  
> 工作坊材料目前正在開發及完善中。核心模組已可使用，但部分進階章節尚未完成。我們正積極努力完成所有內容。[追蹤進度 →](workshop/README.md)

### 互動式工作坊材料
**透過瀏覽器工具及指導練習進行全面的實踐學習**

我們的工作坊材料提供結構化的互動學習體驗，補充上述章節式課程。工作坊適合自學及講師指導的課程。

#### 🛠️ 工作坊特色
- **瀏覽器介面**：完整的 MkDocs 驅動工作坊，具備搜尋、複製及主題功能
- **GitHub Codespaces 整合**：一鍵設置開發環境
- **結構化學習路徑**：7步指導練習（總時長3.5小時）
- **探索 → 部署 → 自訂**：漸進式方法
- **互動式 DevContainer 環境**：預配置工具及依賴項

#### 📚 工作坊結構
工作坊遵循 **探索 → 部署 → 自訂** 方法：

1. **探索階段**（45分鐘）
   - 探索 Microsoft Foundry 模板及服務
   - 理解多代理架構模式
   - 檢視部署需求及先決條件
...
# 點擊「Code」→「Create codespace on main」於倉庫中

# 選項 2：本地開發
git clone https://github.com/microsoft/azd-for-beginners.git
cd azd-for-beginners/workshop
# 按照 workshop/README.md 中的設置指引
```

#### 🎯 工作坊學習成果
完成工作坊後，參與者將能：
- **部署生產 AI 應用程式**：使用 AZD 配合 Microsoft Foundry 服務
- **掌握多代理架構**：實施協調的 AI 代理解決方案
- **實施安全最佳實踐**：配置身份驗證及存取控制
- **優化規模**：設計具成本效益及高效能的部署
- **故障排除部署問題**：獨立解決常見問題
...
- **🛠️ AI 工作坊實驗室**：[AI 工作坊實驗室](docs/microsoft-foundry/ai-workshop-lab.md) - 以 AI 為重點的練習
...
Azure Developer CLI (azd) 是一個以開發者為中心的命令行介面，加速應用程式在 Azure 上的構建及部署過程。它提供：

- **基於模板的部署** - 使用預建模板應對常見應用模式
...
- **安全 AI 部署** - 為 AI 服務、API 密鑰及模型端點提供內建安全模式  
- **生產 AI 模式** - 可擴展及具成本效益的 AI 應用部署最佳實踐
- **端到端 AI 工作流程** - 從模型開發到生產部署，配備完善的監控
- **成本優化** - 為 AI 工作負載提供智能資源分配及擴展策略
- **Microsoft Foundry 整合** - 無縫連接至 Microsoft Foundry 模型目錄及端點
...
| 模板 | 章節 | 難度 | 服務 | 類型 |
|------|------|------|------|------|
| [**AI 聊天入門**](https://github.com/Azure-Samples/get-started-with-ai-chat) | 第二章 | ⭐⭐ | AzureOpenAI + Azure AI 模型推理 API + Azure AI 搜索 + Azure 容器應用 + 應用洞察 | 外部 |
| [**AI 代理入門**](https://github.com/Azure-Samples/get-started-with-ai-agents) | 第二章 | ⭐⭐ | Azure AI 代理服務 + AzureOpenAI + Azure AI 搜索 + Azure 容器應用 + 應用洞察 | 外部 |
| [**Azure 搜索 + OpenAI 演示**](https://github.com/Azure-Samples/azure-search-openai-demo) | 第二章 | ⭐⭐ | AzureOpenAI + Azure AI 搜索 + 應用服務 + 存儲 | 外部 |
| [**OpenAI 聊天應用快速入門**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | 第二章 | ⭐ | AzureOpenAI + 容器應用 + 應用洞察 | 外部 |
...
| [**Contoso 聊天 RAG**](https://github.com/Azure-Samples/contoso-chat) | 第八章 | ⭐⭐⭐⭐ | AzureOpenAI + AI 搜索 + Cosmos DB + 容器應用 | 外部 |
| [**零售多代理解決方案**](examples/retail-scenario.md) | 第五章 | ⭐⭐⭐⭐ | AzureOpenAI + AI 搜索 + 存儲 + 容器應用 + Cosmos DB | **本地** |
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | 第二章 | ⭐⭐ | 使用 Azure AI 搜索的 RAG 實現 |
...
| [**retail-multi-agent-solution**](examples/retail-scenario.md) | 第五章 | ⭐⭐⭐⭐ | 包括客戶及庫存代理的多代理架構 |

### 按範例類型學習

> **📌 本地 vs 外部範例：**  
> **本地範例**（在此 repo）= 可立即使用  
> **外部範例**（Azure 範例）= 從鏈接的 repo 克隆
...
### 外部模板集合
- [**官方 AZD 模板庫**](https://azure.github.io/awesome-azd/) - 精選官方及社區模板
...
### 尋求幫助與支援
- **技術問題**：[回報錯誤與提出功能請求](https://github.com/microsoft/azd-for-beginners/issues)
...
### Microsoft Foundry Discord 的社群見解
...
[![XR 初學者課程](https://img.shields.io/badge/XR%20Development%20for%20Beginners-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
...
**免責聲明**：  
此文件已使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們致力於提供準確的翻譯，但請注意，自動翻譯可能包含錯誤或不準確之處。原始語言的文件應被視為權威來源。對於重要資訊，建議使用專業人工翻譯。我們對因使用此翻譯而引起的任何誤解或誤釋不承擔責任。
