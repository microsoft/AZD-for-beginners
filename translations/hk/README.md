...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T16:23:06+00:00",
...
歡迎來到 Azure Developer CLI (azd) 的全面指南。本儲存庫旨在幫助各級開發者，從學生到專業開發者，學習並掌握 Azure Developer CLI，以便高效進行雲端部署。這份結構化的學習資源提供了 Azure 雲端部署的實作經驗、常見問題的排解，以及成功部署 AZD 模板的最佳實踐。
