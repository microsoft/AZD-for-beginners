...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T12:57:31+00:00",
...
আপনার AZD শেখার যাত্রা শুরু করতে এই ধাপগুলি অনুসরণ করুন:
...
Azure Developer CLI (azd) দক্ষতা অর্জন করুন কাঠামোবদ্ধ অধ্যায়ের মাধ্যমে যা প্রগতিশীল শেখার জন্য ডিজাইন করা হয়েছে। **বিশেষভাবে Microsoft Foundry ইন্টিগ্রেশনের মাধ্যমে AI অ্যাপ্লিকেশন ডিপ্লয়মেন্টে ফোকাস।**

### কেন এই কোর্স আধুনিক ডেভেলপারদের জন্য অপরিহার্য

Microsoft Foundry Discord কমিউনিটির অন্তর্দৃষ্টির ভিত্তিতে, **৪৫% ডেভেলপার AI ওয়ার্কলোডের জন্য AZD ব্যবহার করতে চান** কিন্তু নিম্নলিখিত চ্যালেঞ্জের সম্মুখীন হন:
...
- সক্রিয় না থাকলে `azd down` চালিয়ে রিসোর্স ডিলোকেট করুন
...
**💡 অধ্যায়ের ফলাফল**: সঠিক প্রমাণীকরণ ও সিকিউরিটির সাথে একাধিক পরিবেশ পরিচালনা করুন
...
**ব্রাউজার-ভিত্তিক সরঞ্জাম এবং নির্দেশিত অনুশীলন সহ ব্যাপক হাতে-কলমে শেখার অভিজ্ঞতা**

আমাদের কর্মশালা উপকরণ একটি কাঠামোবদ্ধ, ইন্টারেক্টিভ শেখার অভিজ্ঞতা প্রদান করে যা উপরের অধ্যায়ভিত্তিক পাঠক্রমের পরিপূরক। কর্মশালা স্ব-গতি শেখার পাশাপাশি প্রশিক্ষক-নেতৃত্বাধীন সেশনের জন্য ডিজাইন করা হয়েছে।

#### 🛠️ কর্মশালা বৈশিষ্ট্য  
- **ব্রাউজার-ভিত্তিক ইন্টারফেস**: MkDocs-চালিত সম্পূর্ণ কর্মশালা সার্চ, কপি এবং থিম বৈশিষ্ট্য সহ  
...
- **প্রোডাকশন AI অ্যাপ্লিকেশন ডিপ্লয় করবেন**: Microsoft Foundry সার্ভিস সহ AZD ব্যবহার করে  
- **মাল্টি-এজেন্ট আর্কিটেকচার মাস্টার করবেন**: সমন্বিত AI এজেন্ট সমাধান বাস্তবায়ন  
- **সিকিউরিটি সেরা অনুশীলন বাস্তবায়ন করবেন**: প্রমাণীকরণ এবং অ্যাক্সেস নিয়ন্ত্রণ কনফিগারেশন  
- **স্কেল জন্য অপ্টিমাইজ করবেন**: খরচ-সাশ্রয়ী, কার্যকর ডিপ্লয়মেন্ট ডিজাইন  
- **ডিপ্লয়মেন্ট সমস্যা সমাধান করবেন**: স্বাধীনভাবে সাধারণ সমস্যা সমাধান
...
- **টেমপ্লেট-ভিত্তিক ডিপ্লয়মেন্ট** - সাধারণ অ্যাপ্লিকেশন প্যাটার্নের জন্য পূর্ব-নির্মিত টেমপ্লেট ব্যবহার  
- **ইনফ্রাস্ট্রাকচার অ্যাজ কোড** - Bicep বা Terraform ব্যবহার করে Azure সম্পদ পরিচালনা  
- **ইন্টিগ্রেটেড ওয়ার্কফ্লো** - নির্বিঘ্নে প্রোভিশন, ডিপ্লয় এবং মনিটরিং  
...
- **প্রোডাকশন AI প্যাটার্নস** - স্কেলেবল, খরচ-সাশ্রয়ী AI অ্যাপ্লিকেশন ডিপ্লয়মেন্টের সেরা অনুশীলন  
...
**শুরু করার জন্য এই Azure স্যাম্পল রিপোজিটরি ক্লোন করুন:**  
...
# আপনার কমপক্ষে "Contributor" ভূমিকা প্রয়োজন
# আপনার Azure প্রশাসকের কাছে অনুরোধ করুন:
# - Contributor (সম্পদের জন্য)
# - User Access Administrator (ভূমিকা নিয়োগের জন্য)
```
</details>
