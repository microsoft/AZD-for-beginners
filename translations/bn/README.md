...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T22:07:38+00:00",
...
- **🛠️ ওয়ার্কশপ**: [AI ওয়ার্কশপ ল্যাব](docs/microsoft-foundry/ai-workshop-lab.md) - আপনার AI সলিউশন AZD-রেডি করুন
...
- AI সার্চ (বেসিক স্তর): $৭৫/মাস
- কন্টেইনার অ্যাপস (কনজাম্পশন): $০-২০/মাস
- স্টোরেজ (স্ট্যান্ডার্ড): $১-৫/মাস

**প্রোডাকশন পরিবেশ (প্রায় $৩০০-৩,৫০০+/মাস):**
- Azure OpenAI (PTU ধারাবাহিক পারফরম্যান্সের জন্য): $৩,০০০+/মাস অথবা উচ্চ ভলিউমের জন্য Pay-as-you-go
- AI সার্চ (স্ট্যান্ডার্ড স্তর): $২৫০/মাস
...
- সক্রিয়ভাবে ডেভেলপ না করলে `azd down` চালিয়ে রিসোর্স ডিলোকেট করুন
...
### ⚙️ অধ্যায় ৩: কনফিগারেশন ও প্রমাণীকরণ
**প্রয়োজনীয়তা**: অধ্যায় ১ সম্পন্ন  
**সময়কাল**: ৪৫-৬০ মিনিট  
**জটিলতা**: ⭐⭐
...
- প্রমাণীকরণ ও সিকিউরিটির সেরা অনুশীলন
- রিসোর্স নামকরণ ও সংগঠন

#### শেখার উপকরণ
- **📖 কনফিগারেশন**: [কনফিগারেশন গাইড](docs/getting-started/configuration.md) - পরিবেশ সেটআপ
- **🔐 সিকিউরিটি**: [প্রমাণীকরণ প্যাটার্ন ও ম্যানেজড আইডেন্টিটি](docs/getting-started/authsecurity.md) - প্রমাণীকরণ প্যাটার্ন
...
- ম্যানেজড আইডেন্টিটি প্রমাণীকরণ সেটআপ করুন
- পরিবেশ-নির্দিষ্ট কনফিগারেশন বাস্তবায়ন করুন

**💡 অধ্যায়ের ফলাফল**: সঠিক প্রমাণীকরণ ও সিকিউরিটির মাধ্যমে একাধিক পরিবেশ পরিচালনা
...
#### আপনি যা শিখবেন  
- ক্ষমতা পরিকল্পনা এবং সম্পদ যাচাই  
- SKU নির্বাচন কৌশল  
- প্রি-ফ্লাইট চেক এবং অটোমেশন

#### শেখার সম্পদ  
- **📊 পরিকল্পনা**: [ক্ষমতা পরিকল্পনা](docs/pre-deployment/capacity-planning.md) - সম্পদ যাচাই  
...
> কর্মশালা উপকরণ বর্তমানে উন্নয়ন ও পরিমার্জনাধীন। মূল মডিউলগুলি কার্যকর, তবে কিছু উন্নত অংশ অসম্পূর্ণ। আমরা সক্রিয়ভাবে সমস্ত বিষয়বস্তু সম্পন্ন করার কাজ করছি। [অগ্রগতি ট্র্যাক করুন →](workshop/README.md)

### ইন্টারেক্টিভ কর্মশালা উপকরণ  
**ব্রাউজার-ভিত্তিক সরঞ্জাম এবং নির্দেশিত অনুশীলন সহ ব্যাপক হাতে কলম শেখা**

আমাদের কর্মশালা উপকরণ একটি কাঠামোবদ্ধ, ইন্টারেক্টিভ শেখার অভিজ্ঞতা প্রদান করে যা উপরের অধ্যায়ভিত্তিক পাঠক্রমের পরিপূরক। কর্মশালা স্ব-গতি শেখা এবং প্রশিক্ষক-নেতৃত্বাধীন সেশনের জন্য ডিজাইন করা হয়েছে।
...
- **স্কেলের জন্য অপ্টিমাইজ করুন**: খরচ-সাশ্রয়ী, কার্যকর ডিপ্লয়মেন্ট ডিজাইন করুন  
...
> **নোট:** এই টেমপ্লেটগুলো বিভিন্ন AI প্যাটার্ন প্রদর্শন করে। কিছু বাহ্যিক Azure স্যাম্পল, অন্যগুলো স্থানীয় বাস্তবায়ন।
...
- [**কমান্ড চিট শীট**](resources/cheat-sheet.md) - অধ্যায় অনুযায়ী সংগঠিত গুরুত্বপূর্ণ azd কমান্ডসমূহ  
...
### ❌ "প্রমাণীকরণ ব্যর্থ" অথবা "টোকেনের মেয়াদ শেষ"
...
### ❌ ডিপ্লয় করা অ্যাপ্লিকেশন URL খুঁজে পাওয়া যাচ্ছে না
...
<details>
<summary><strong>❌ "কোন সাবস্ক্রিপশন পাওয়া যায়নি" অথবা "সাবস্ক্রিপশন সেট করা হয়নি"</strong></summary>
...
<details>
<summary><strong>❌ "প্রমাণীকরণ ব্যর্থ" অথবা "টোকেনের মেয়াদ শেষ"</strong></summary>
...
<details>
<summary><strong>❌ ডিপ্লয় করা অ্যাপ্লিকেশন URL খুঁজে পাওয়া যাচ্ছে না</strong></summary>
...
[![শুরু করার জন্য AI এজেন্টস](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)  
...
**এআই ডেভেলপারদের জন্য**: [অধ্যায় ২: এআই-প্রথম উন্নয়ন](../..)  
**অভিজ্ঞ ডেভেলপারদের জন্য**: [অধ্যায় ৩: কনফিগারেশন ও প্রমাণীকরণ](../..)
