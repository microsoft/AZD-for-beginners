...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:15:34+00:00",
...
Azure Developer CLI (azd) দক্ষতা অর্জন করুন গঠিত অধ্যায়গুলোর মাধ্যমে যা ধাপে ধাপে শেখার জন্য তৈরি। **Azure AI Foundry ইন্টিগ্রেশনের মাধ্যমে AI অ্যাপ্লিকেশন ডিপ্লয়মেন্টে বিশেষ গুরুত্ব।**
...
- **AZD মৌলিক বিষয়গুলো শিখবেন**: মূল ধারণা, ইনস্টলেশন এবং কনফিগারেশন
- **AI অ্যাপ্লিকেশন ডিপ্লয় করবেন**: AZD ব্যবহার করে Azure AI Foundry সার্ভিসের সাথে
- **ইনফ্রাস্ট্রাকচার অ্যাজ কোড প্রয়োগ করবেন**: Bicep টেমপ্লেট দিয়ে Azure রিসোর্স পরিচালনা
...
**প্রয়োজনীয়তা**: যেকোনো ডিপ্লয়মেন্ট অধ্যায় সম্পন্ন  
**সময়কাল**: ১-১.৫ ঘণ্টা  
**জটিলতা**: ⭐⭐
...
**প্রয়োজনীয়তা**: অধ্যায় ১-৪ সম্পন্ন  
...
আমাদের ওয়ার্কশপ উপকরণ একটি গঠিত, ইন্টারঅ্যাকটিভ শেখার অভিজ্ঞতা প্রদান করে যা উপরের অধ্যায়-ভিত্তিক পাঠ্যক্রমের সাথে সম্পূরক। এই ওয়ার্কশপটি স্ব-গতিশীল শেখা এবং প্রশিক্ষক-নেতৃত্বাধীন সেশনের জন্য ডিজাইন করা হয়েছে।
...
- **সিকিউরিটি সেরা অনুশীলন বাস্তবায়ন**: অথেন্টিকেশন এবং অ্যাক্সেস কন্ট্রোল কনফিগার করুন
...
- **সুরক্ষিত AI ডিপ্লয়মেন্ট** - AI সার্ভিস, API কী এবং মডেল এন্ডপয়েন্টের জন্য বিল্ট-ইন সিকিউরিটি প্যাটার্ন  
...
| [**azure-search-openai-demo**](https://github.com/Azure-Samples/azure-search-openai-demo) | অধ্যায় ২ | ⭐⭐ | RAG বাস্তবায়ন Azure AI Search দিয়ে |
...
- [**FAQ**](resources/faq.md) - অধ্যায় অনুযায়ী সাধারণ প্রশ্ন
- [**Study Guide**](resources/study-guide.md) - ব্যাপক অনুশীলন

### হাতে-কলমে ওয়ার্কশপ
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - আপনার AI সমাধান AZD-ডিপ্লয়যোগ্য করুন (২-৩ ঘণ্টা)
- [**Interactive Workshop Guide**](workshop/README.md) - MkDocs এবং DevContainer এনভায়রনমেন্ট সহ ব্রাউজার-ভিত্তিক ওয়ার্কশপ
- [**Structured Learning Path**](../../workshop/docs/instructions) - ৭-ধাপ নির্দেশিত অনুশীলন (ডিসকভারি → ডিপ্লয়মেন্ট → কাস্টমাইজেশন)
...
2. **জ্ঞান যাচাই**: আপনার অধ্যায়ের FAQ বিভাগ পর্যালোচনা করুন
...
## 🤝 কমিউনিটি এবং সহ
- AI মোতায়েনের সেরা পদ্ধতিতে অবদান রাখুন  
...
আমাদের দল অন্যান্য ব্যাপক লার্নিং কোর্স তৈরি করে:  
...
**শুরুর শিক্ষার্থী**: [অধ্যায় ১: ভিত্তি ও দ্রুত শুরু](../..) দিয়ে শুরু করুন  
**AI ডেভেলপার**: [অধ্যায় ২: AI-প্রথম উন্নয়ন](../..) এ যান  
**অভিজ্ঞ ডেভেলপার**: [অধ্যায় ৩: কনফিগারেশন ও প্রমাণীকরণ](../..) দিয়ে শুরু করুন  

**পরবর্তী ধাপ**: [অধ্যায় ১ - AZD বেসিক শুরু করুন](docs/getting-started/azd-basics.md) →  
