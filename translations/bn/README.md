...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:45:46+00:00",
...
Azure Developer CLI (azd) এর জন্য একটি বিস্তৃত গাইডে আপনাকে স্বাগতম। এই রিপোজিটরি শিক্ষার্থী থেকে শুরু করে পেশাদার ডেভেলপারদের জন্য ডিজাইন করা হয়েছে যাতে তারা Azure Developer CLI শিখতে এবং দক্ষতার সাথে ক্লাউড ডিপ্লয়মেন্ট করতে পারে। **বিশেষত Azure AI Foundry ব্যবহার করে AI অ্যাপ্লিকেশন ডিপ্লয়মেন্টের উপর জোর দেওয়া হয়েছে।** এই কাঠামোবদ্ধ শিক্ষার রিসোর্সটি Azure ক্লাউড ডিপ্লয়মেন্ট, সাধারণ সমস্যার সমাধান এবং সফল AZD টেমপ্লেট ডিপ্লয়মেন্টের জন্য সেরা পদ্ধতি বাস্তবায়নের হাতে-কলমে অভিজ্ঞতা প্রদান করে।  
...
- Infrastructure as Code ব্যবহার করে Azure রিসোর্স ডিপ্লয় এবং প্রোভিশন করতে শিখবেন  
- সাধারণ AZD ডিপ্লয়মেন্ট সমস্যার সমাধান করার দক্ষতা অর্জন করবেন  
- প্রি-ডিপ্লয়মেন্ট যাচাই এবং ক্ষমতা পরিকল্পনা বুঝবেন  
...
- AZD ওয়ার্কফ্লো CI/CD পাইপলাইনে ইন্টিগ্রেট করতে পারবেন  
...
- **ইন্টিগ্রেটেড ওয়ার্কফ্লো** - অ্যাপ্লিকেশন প্রোভিশন, ডিপ্লয় এবং মনিটর করুন  
- **ডেভেলপার-বান্ধব** - ডেভেলপারদের উৎপাদনশীলতা এবং অভিজ্ঞতার জন্য অপ্টিমাইজড  

### **AZD + Azure AI Foundry: AI ডিপ্লয়মেন্টের জন্য আদর্শ**

**AI সমাধানের জন্য কেন AZD?** AZD AI ডেভেলপারদের শীর্ষ চ্যালেঞ্জগুলো সমাধান করে:  
...
- **প্রোডাকশন AI প্যাটার্ন** - স্কেলযোগ্য, খরচ-সাশ্রয়ী AI অ্যাপ্লিকেশন ডিপ্লয়মেন্টের সেরা পদ্ধতি  
...
5. **উন্নত স্তর**: [contoso-chat](https://github.com/Azure-Samples/contoso-chat) এন্টারপ্রাইজ টেমপ্লেট ডিপ্লয় করুন  
...
### DevOps ইঞ্জিনিয়ারদের জন্য  
1. [রিসোর্স প্রোভিশনিং](docs/deployment/provisioning.md) আয়ত্ত করুন  
...
- [**রিসোর্স প্রোভিশনিং**](docs/deployment/provisioning.md) - Azure রিসোর্স ব্যবস্থাপনা  

### প্রি-ডিপ্লয়মেন্ট চেক  
- [**ক্ষমতা পরিকল্পনা**](docs/pre-deployment/capacity-planning.md) - Azure রিসোর্স ক্ষমতা যাচাই  
...
- [**প্রোডাকশন AI সেরা পদ্ধতি**](docs/ai-foundry/production-ai-practices.md) - AI ওয়ার্কলোডের জন্য নিরাপত্তা, স্কেলিং এবং মনিটরিং  
...
**এআই অ্যাপ্লিকেশন ডিপ্লয় করতে এখানে শুরু করুন!**
...
| [**আপনার ডেটা থেকে ডকুমেন্ট তৈরি করুন**](https://github.com/Azure-Samples/get-started-with-ai-chat) | আপনার ডেটা থেকে প্রাসঙ্গিক তথ্য খুঁজে এবং সারসংক্ষেপ করে চুক্তি, ইনভয়েস এবং বিনিয়োগ প্রস্তাবের মতো ডকুমেন্ট তৈরি দ্রুততর করুন। |⭐⭐⭐  | AzureOpenAI + Azure AI Search + Azure AI Services + Azure CosmosDB|
...
- [**অসাধারণ AZD গ্যালারি**](https://azure.github.io/awesome-azd/) - কমিউনিটি-অবদানকৃত টেমপ্লেট

### হাতে-কলমে ল্যাব ও কর্মশালা
- [**এআই ওয়ার্কশপ ল্যাব**](docs/ai-foundry/ai-workshop-lab.md) - **নতুন**: আপনার এআই সমাধানগুলো AZD-ডিপ্লয়যোগ্য করুন
...
- **ইমেইল**: ব্যক্তিগত প্রশ্নের জন্য
- **Microsoft Learn**: [অফিসিয়াল Azure Developer CLI ডকুমেন্টেশন](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/)
...
- [গিটহাব কপাইলট মাস্টারিং এআই পেয়ারড প্রোগ্রামিংয়ের জন্য](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
- [গিটহাব কপাইলট মাস্টারিং C#/.NET ডেভেলপারদের জন্য](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
