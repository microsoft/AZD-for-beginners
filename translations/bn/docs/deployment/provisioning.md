...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:23:42+00:00",
  "source_file": "docs/deployment/provisioning.md",
  "language_code": "bn"
}
-->
# রিসোর্স প্রভিশনিং - AZD এর মাধ্যমে ইনফ্রাস্ট্রাকচার অ্যাজ কোড

## ভূমিকা

এই বিস্তৃত গাইডটি Azure Developer CLI ব্যবহার করে Azure রিসোর্স প্রভিশনিং এবং পরিচালনার জন্য প্রয়োজনীয় সবকিছু কভার করে। Bicep, ARM টেমপ্লেট, Terraform এবং Pulumi ব্যবহার করে বেসিক রিসোর্স তৈরি থেকে শুরু করে উন্নত এন্টারপ্রাইজ-গ্রেড ইনফ্রাস্ট্রাকচার আর্কিটেকচার পর্যন্ত Infrastructure as Code (IaC) প্যাটার্নগুলি বাস্তবায়ন করতে শিখুন।

## শেখার লক্ষ্য

এই গাইডটি সম্পন্ন করার মাধ্যমে, আপনি:
- Infrastructure as Code এর মূলনীতি এবং Azure রিসোর্স প্রভিশনিং আয়ত্ত করবেন
- Azure Developer CLI দ্বারা সমর্থিত বিভিন্ন IaC প্রদানকারী সম্পর্কে বুঝতে পারবেন
- সাধারণ অ্যাপ্লিকেশন আর্কিটেকচারের জন্য Bicep টেমপ্লেট ডিজাইন এবং বাস্তবায়ন করতে পারবেন
- রিসোর্স প্যারামিটার, ভেরিয়েবল এবং পরিবেশ-নির্দিষ্ট সেটিংস কনফিগার করতে পারবেন
- নেটওয়ার্কিং এবং সিকিউরিটি সহ উন্নত ইনফ্রাস্ট্রাকচার প্যাটার্ন বাস্তবায়ন করতে পারবেন
- রিসোর্স লাইফসাইকেল, আপডেট এবং ডিপেনডেন্সি রেজোলিউশন পরিচালনা করতে পারবেন

## শেখার ফলাফল

গাইডটি সম্পন্ন করার পর, আপনি সক্ষম হবেন:
- Bicep এবং ARM টেমপ্লেট ব্যবহার করে Azure ইনফ্রাস্ট্রাকচার ডিজাইন এবং প্রভিশন করতে
- সঠিক রিসোর্স ডিপেনডেন্সি সহ জটিল মাল্টি-সার্ভিস আর্কিটেকচার কনফিগার করতে
- একাধিক পরিবেশ এবং কনফিগারেশনের জন্য প্যারামিটারাইজড টেমপ্লেট বাস্তবায়ন করতে
- ইনফ্রাস্ট্রাকচার প্রভিশনিং সমস্যাগুলি সমাধান করতে এবং ডিপ্লয়মেন্ট ব্যর্থতা মোকাবিলা করতে
- Azure Well-Architected Framework এর নীতিগুলি ইনফ্রাস্ট্রাকচার ডিজাইনে প্রয়োগ করতে
...
- **Pulumi** - আধুনিক ইনফ্রাস্ট্রাকচার অ্যাজ কোড প্রোগ্রামিং ভাষার মাধ্যমে
...
- [প্রি-ডিপ্লয়মেন্ট পরিকল্পনা](../pre-deployment/capacity-planning.md) - রিসোর্স উপলব্ধতা যাচাই করুন
