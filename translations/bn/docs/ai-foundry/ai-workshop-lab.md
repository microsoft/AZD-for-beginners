...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T14:15:02+00:00",
...
এই হাতে-কলমের ল্যাব ডেভেলপারদের একটি বিদ্যমান AI টেমপ্লেট নিয়ে Azure Developer CLI (AZD) ব্যবহার করে ডিপ্লয় করার প্রক্রিয়া শেখায়। Azure AI Foundry সার্ভিস ব্যবহার করে প্রোডাকশন AI ডিপ্লয়মেন্টের জন্য প্রয়োজনীয় প্যাটার্ন শিখবেন।

**সময়কাল:** ২-৩ ঘণ্টা  
**স্তর:** মধ্যম  
**প্রয়োজনীয়তা:** বেসিক Azure জ্ঞান, AI/ML ধারণার সাথে পরিচিতি

## 🎓 শেখার লক্ষ্যসমূহ

এই ওয়ার্কশপ শেষে আপনি সক্ষম হবেন:
- ✅ একটি বিদ্যমান AI অ্যাপ্লিকেশনকে AZD টেমপ্লেটে রূপান্তর করতে
- ✅ AZD ব্যবহার করে Azure AI Foundry সার্ভিস কনফিগার করতে
- ✅ AI সার্ভিসের জন্য নিরাপদ ক্রেডেনশিয়াল ব্যবস্থাপনা বাস্তবায়ন করতে
...
- Azure সার্ভিসের মৌলিক ধারণা
- কমান্ড-লাইন ইন্টারফেসের সাথে পরিচিতি
- AI/ML ধারণার বেসিক (API, মডেল, প্রম্পট)
...
2. পরিবেশ ভেরিয়েবল কনফিগার করুন যাতে খরচ কম হয়
...
1. **প্রাইভেট এন্ডপয়েন্ট সক্রিয় করুন** (যদি ইতিমধ্যে কনফিগার না করা হয়):
...
**লক্ষণ:** ডিপ্লয়মেন্ট কোটা ত্রুটি দিয়ে ব্যর্থ হয়  
**সমাধান:**  
```bash
...
**তদন্তের ধাপ:**
1. Application Insights-এ পারফরম্যান্স মেট্রিক পরীক্ষা করুন
...
**পরিস্থিতি:** আপনার ডিপ্লয়মেন্ট সফল হয়েছে, কিন্তু অ্যাপ্লিকেশন 500 ত্রুটি ফেরত দিচ্ছে।
...
- Azure পোর্টাল সার্ভিস লগের বিস্তারিত তথ্যের জন্য
...
**কাজ:** আপনার AI অ্যাপ্লিকেশন পারফরম্যান্স এবং খরচের জন্য অপ্টিমাইজ করুন।
...
আপনাকে একটি প্রোডাকশন-রেডি AI-চালিত কাস্টমার সার্ভিস চ্যাটবট তৈরি করতে হবে যার প্রয়োজনীয়তা:
...
- ✅ প্রোডাকশন-প্রস্তুত AI অ্যাপ্লিকেশন ডিপ্লয় করতে
- ✅ AI ওয়ার্কলোডের জন্য নিরাপত্তার সেরা অনুশীলন বাস্তবায়ন করতে
- ✅ AI অ্যাপ্লিকেশনের কার্যকারিতা পর্যবেক্ষণ ও অপ্টিমাইজ করতে
...
**ওয়ার্কশপ ফিডব্যাক**: এই ওয়ার্কশপটি উন্নত করতে আমাদের সাহায্য করুন এবং আপনার অভিজ্ঞতা শেয়ার করুন [Azure AI Foundry Discord #Azure চ্যানেলে](https://discord.gg/microsoft-azure)।

---

**চ্যাপ্টার নেভিগেশন:**
- **📚 কোর্স হোম**: [AZD ফর বিগিনারস](../../README.md)
- **📖 বর্তমান চ্যাপ্টার**: চ্যাপ্টার ২ - AI-প্রথম ডেভেলপমেন্ট
- **⬅️ পূর্ববর্তী**: [AI মডেল ডিপ্লয়মেন্ট](ai-model-deployment.md)
- **➡️ পরবর্তী**: [প্রোডাকশন AI সেরা অনুশীলন](production-ai-practices.md)
- **🚀 পরবর্তী চ্যাপ্টার**: [চ্যাপ্টার ৩: কনফিগারেশন](../getting-started/configuration.md)

**সাহায্য দরকার?** AZD এবং AI ডিপ্লয়মেন্ট নিয়ে সহায়তা ও আলোচনা করতে আমাদের কমিউনিটিতে যোগ দিন।
