...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:15:41+00:00",
...
এই পাঠটি আপনাকে Azure Developer CLI (azd) এর সাথে পরিচয় করিয়ে দেবে, একটি শক্তিশালী কমান্ড-লাইন টুল যা স্থানীয় ডেভেলপমেন্ট থেকে Azure-এ ডিপ্লয়মেন্ট পর্যন্ত আপনার যাত্রাকে দ্রুততর করে। আপনি মৌলিক ধারণা, মূল বৈশিষ্ট্যগুলি শিখবেন এবং বুঝবেন কীভাবে azd ক্লাউড-নেটিভ অ্যাপ্লিকেশন ডিপ্লয়মেন্টকে সহজ করে তোলে।
...
- ডেভ/স্টেজিং/প্রোডের জন্য আলাদা এনভায়রনমেন্ট ব্যবহার করুন
...
### বিগিনার (সপ্তাহ ১-২)
1. azd ইনস্টল এবং প্রমাণীকরণ করুন
...
**নেভিগেশন**
- **পূর্ববর্তী পাঠ**: [README](../../README.md)
