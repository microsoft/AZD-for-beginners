...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:49:53+00:00",
...
**পূর্ববর্তী:** [ইনস্টলেশন ও সেটআপ](installation.md) | **পরবর্তী:** [কনফিগারেশন](configuration.md)

## ভূমিকা

এই পাঠে Azure Developer CLI (azd) পরিচিত করা হয়েছে, যা একটি শক্তিশালী কমান্ড-লাইন টুল যা স্থানীয় ডেভেলপমেন্ট থেকে Azure-এ ডিপ্লয়মেন্ট পর্যন্ত আপনার যাত্রাকে দ্রুততর করে। আপনি মৌলিক ধারণা, মূল বৈশিষ্ট্যগুলি শিখবেন এবং বুঝবেন কীভাবে azd ক্লাউড-নেটিভ অ্যাপ্লিকেশন ডিপ্লয়মেন্টকে সহজ করে তোলে।
...
- আপনার ডেভেলপমেন্ট এনভায়রনমেন্টের জন্য azd ইনস্টল এবং কনফিগার করতে প্রস্তুত থাকবেন
...
Azure Developer CLI (azd) একটি কমান্ড-লাইন টুল যা স্থানীয় ডেভেলপমেন্ট থেকে Azure-এ ডিপ্লয়মেন্ট পর্যন্ত আপনার যাত্রাকে দ্রুততর করতে ডিজাইন করা হয়েছে। এটি Azure-এ ক্লাউড-নেটিভ অ্যাপ্লিকেশন তৈরি, ডিপ্লয় এবং পরিচালনা করার প্রক্রিয়াকে সহজ করে তোলে।
...
- CLI যদি অসঙ্গতি সনাক্ত করে, তবুও টিয়ারডাউন বাধাহীনভাবে এগিয়ে যায়।
...
যখন `azd up`-এ লেগে যান পূর্ববর্তী স্টেট বা আংশিক ডিপ্লয়মেন্টের কারণে, এই কম্বো একটি **পরিষ্কার স্লেট** নিশ্চিত করে।

এটি বিশেষভাবে সহায়ক যখন Azure পোর্টালে ম্যানুয়াল রিসোর্স মুছে ফেলা হয়েছে বা টেমপ্লেট, এনভায়রনমেন্ট বা রিসোর্স গ্রুপ নামকরণ কনভেনশন পরিবর্তন করা হয়েছে।
...
- [আপনার প্রথম প্রজেক্ট](first-project.md) - হাতে-কলমে টিউটোরিয়াল
...
**পূর্ববর্তী:** [ইনস্টলেশন ও সেটআপ](installation.md) | **পরবর্তী:** [কনফিগারেশন](configuration.md)
- **পরবর্তী পাঠ:** [ইনস্টলেশন ও সেটআপ](installation.md)
