...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T18:48:39+00:00",
...
**পূর্ববর্তী:** [কনফিগারেশন](configuration.md) | **পরবর্তী:** [Azure AI Foundry Integration](../ai-foundry/azure-ai-foundry-integration.md)

## ভূমিকা

আপনার প্রথম Azure Developer CLI প্রকল্পে স্বাগতম! এই বিস্তারিত হাতে-কলমে টিউটোরিয়ালটি আপনাকে একটি সম্পূর্ণ স্ট্যাক অ্যাপ্লিকেশন তৈরি, ডিপ্লয় এবং পরিচালনা করার সম্পূর্ণ প্রক্রিয়া দেখাবে, যা azd ব্যবহার করে Azure-এ চালানো হবে। আপনি একটি বাস্তব টুডো অ্যাপ্লিকেশনের সাথে কাজ করবেন, যার মধ্যে রয়েছে React ফ্রন্টএন্ড, Node.js API ব্যাকএন্ড এবং MongoDB ডাটাবেস।

## শেখার লক্ষ্যসমূহ

এই টিউটোরিয়াল সম্পন্ন করার মাধ্যমে আপনি:
- টেমপ্লেট ব্যবহার করে azd প্রকল্প ইনিশিয়ালাইজেশন প্রক্রিয়া আয়ত্ত করবেন
- Azure Developer CLI প্রকল্পের গঠন এবং কনফিগারেশন ফাইলগুলি বুঝতে পারবেন
- Azure-এ সম্পূর্ণ অ্যাপ্লিকেশন ডিপ্লয়মেন্ট এবং অবকাঠামো প্রস্তুতি সম্পন্ন করবেন
...
- টেমপ্লেট থেকে azd প্রকল্প ইনিশিয়ালাইজ এবং কনফিগার করতে পারবেন
- azd প্রকল্পের গঠন কার্যকরভাবে নেভিগেট এবং পরিবর্তন করতে পারবেন
...
চলুন একটি জনপ্রিয় টুডো অ্যাপ্লিকেশন টেমপ্লেট দিয়ে শুরু করি, যার মধ্যে রয়েছে React ফ্রন্টএন্ড এবং Node.js API ব্যাকএন্ড।
...
- `infra/` ডিরেক্টরিতে অবকাঠামো কোড সেটআপ হয়েছে
...
3. **আইটেম মুছুন** - যেগুলি আর প্রয়োজন নেই সেগুলি সরিয়ে ফেলুন
