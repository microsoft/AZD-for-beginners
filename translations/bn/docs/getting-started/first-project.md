...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-09T19:04:02+00:00",
...
- ডেভেলপমেন্ট এবং স্টেজিংয়ের জন্য একাধিক environment পরিচালনা করবেন
- রিসোর্স ক্লিনআপ এবং খরচ ব্যবস্থাপনার পদ্ধতি প্রয়োগ করবেন

## শেখার ফলাফল

টিউটোরিয়াল সম্পন্ন করার পর আপনি:
- টেমপ্লেট থেকে azd প্রকল্প initialization এবং কনফিগারেশন স্বাধীনভাবে করতে পারবেন
- azd প্রকল্পের গঠনগুলি দক্ষতার সাথে নেভিগেট এবং পরিবর্তন করতে পারবেন
...
- বিভিন্ন ডিপ্লয়মেন্ট পর্যায়ের জন্য একাধিক Azure environment পরিচালনা করতে পারবেন
...
- একটি environment কনফিগারেশন তৈরি হয়েছে
...
### environment ভেরিয়েবল কনফিগার করুন
```bash
...
3. **আইটেম মুছুন** - অপ্রয়োজনীয় todo মুছে ফেলুন
...
চলুন একটি পরিবর্তন করি এবং দেখুন আপডেট করা কতটা সহজ:
...
## ধাপ ৭: একাধিক environment পরিচালনা করুন

প্রোডাকশনের আগে পরিবর্তন পরীক্ষা করার জন্য একটি স্টেজিং environment তৈরি করুন:
...
যখন আপনি পরীক্ষা শেষ করবেন, চলমান চার্জ এড়াতে ক্লিনআপ করুন:
...
- একাধিক environment পরিচালনা করেছেন
...
**নেভিগেশন**
- **পূর্ববর্তী পাঠ**: [কনফিগারেশন](configuration.md)
