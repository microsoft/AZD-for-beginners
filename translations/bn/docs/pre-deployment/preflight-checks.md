...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T19:26:38+00:00",
...
এই বিস্তৃত গাইডটি প্রি-ডিপ্লয়মেন্ট যাচাই স্ক্রিপ্ট এবং পদ্ধতি প্রদান করে যা Azure Developer CLI ডিপ্লয়মেন্ট সফলভাবে শুরু হওয়ার আগে নিশ্চিত করতে সাহায্য করে। যাচাইয়ের মাধ্যমে অটোমেটেড চেক বাস্তবায়ন শিখুন, যেমন: প্রমাণীকরণ, রিসোর্স উপলব্ধতা, কোটা, নিরাপত্তা নীতি, এবং পারফরম্যান্স প্রয়োজনীয়তা, যা ডিপ্লয়মেন্ট ব্যর্থতা প্রতিরোধ করে এবং সফলতার হার উন্নত করে।

## শেখার লক্ষ্য

এই গাইড সম্পন্ন করার মাধ্যমে আপনি:
- প্রি-ডিপ্লয়মেন্ট যাচাইয়ের অটোমেটেড কৌশল এবং স্ক্রিপ্ট আয়ত্ত করবেন
- প্রমাণীকরণ, অনুমতি এবং কোটা যাচাইয়ের বিস্তৃত কৌশল বুঝবেন
...
- বিস্তৃত প্রি-ফ্লাইট যাচাই স্ক্রিপ্ট তৈরি এবং কার্যকর করতে পারবেন
- বিভিন্ন ডিপ্লয়মেন্ট পরিস্থিতির জন্য অটোমেটেড যাচাই কর্মপ্রবাহ ডিজাইন করতে পারবেন
- পরিবেশ-নির্দিষ্ট যাচাই পদ্ধতি এবং নীতি বাস্তবায়ন করতে পারবেন
- ডিপ্লয়মেন্ট প্রস্তুতির জন্য সক্রিয় পর্যবেক্ষণ এবং সতর্কতা কনফিগার করতে পারবেন
- প্রি-ডিপ্লয়মেন্ট সমস্যাগুলি সমাধান করতে এবং সংশোধনমূলক পদক্ষেপ নিতে পারবেন
- প্রি-ফ্লাইট চেক DevOps পাইপলাইন এবং অটোমেশন কর্মপ্রবাহে সংহত করতে পারবেন

## বিষয়সূচি

- [ওভারভিউ](../../../../docs/pre-deployment)
- [অটোমেটেড প্রি-ফ্লাইট স্ক্রিপ্ট](../../../../docs/pre-deployment)
...
## অটোমেটেড প্রি-ফ্লাইট স্ক্রিপ্ট
...
- [ ] azure.yaml-এ সংজ্ঞায়িত সমস্ত পরিষেবার জন্য উৎস কোড রয়েছে
...
- [ ] রিসোর্সগুলির মধ্যে নির্ভরতা বোঝা গেছে

#### ✅ নেটওয়ার্ক ও নিরাপত্তা
- [ ] Azure এন্ডপয়েন্টে নেটওয়ার্ক সংযোগ যাচাই করা হয়েছে
...
- [ ] Log Analytics কর্মক্ষেত্র পরিকল্পনা করা হয়েছে
...
4. **পরিষ্কার রিপোর্টিং**
   ...
   - সমাধানের ধাপ সহ বিস্তারিত ত্রুটি বার্তা
...
1. **যাচাই এড়িয়ে যাওয়া** "দ্রুত" ডিপ্লয়মেন্টের জন্য
2. **অপর্যাপ্ত অনুমতি** যাচাই ডিপ্লয়মেন্টের আগে
3. **কোটা সীমা উপেক্ষা করা** যতক্ষণ না ডিপ্লয়মেন্ট ব্যর্থ হয়
4. **টেমপ্লেট যাচাই না করা** CI/CD পাইপলাইনে
5. **প্রোডাকশন পরিবেশের জন্য নিরাপত্তা যাচাই বাদ দেওয়া**
6. **অপর্যাপ্ত খরচ অনুমান** যা বাজেটের চমক সৃষ্টি করে

---

**প্রো টিপ**: আপনার CI/CD পাইপলাইনে প্রি-ফ্লাইট চেক একটি আলাদা জব হিসেবে চালান, যা মূল ডিপ্লয়মেন্ট জবের আগে। এটি সমস্যাগুলি দ্রুত ধরতে সাহায্য করে এবং ডেভেলপারদের দ্রুত প্রতিক্রিয়া প্রদান করে।
