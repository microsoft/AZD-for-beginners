...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:58:13+00:00",
...
Bemästra Azure Developer CLI (azd) genom strukturerade kapitel utformade för progressiv inlärning. **Särskilt fokus på AI-applikationsdistribution med Azure AI Foundry-integration.**
...
#### Inlärningsresurser
- **🎯 Börja Här**: [Azure AI Foundry Integration](docs/ai-foundry/azure-ai-foundry-integration.md)
...
**💡 Kapitelresultat**: Distribuera komplexa applikationer med flera tjänster med anpassade infrastrukturmallar
...
- Orkestrering och koordinering av agenter
- AI-distributioner redo för produktion
...
- **📖 Arkitektur**: Mönster för multi-agent koordinering
...
#### Praktiska Övningar
- Kör kapacitetsvalideringsskript
...
- Strategier för produktionsutveckling
...
Våra workshopmaterial erbjuder en strukturerad, interaktiv inlärningsupplevelse som kompletterar det kapitelbaserade läroplanen ovan. Workshopen är utformad för både självstudier och instruktörsledda sessioner.
...
- **Strukturerad inlärningsväg**: 7 steg guidade övningar (totalt 3,5 timmar)
...
- **Distribuera produktionsklara AI-applikationer**: Använd AZD med Azure AI Foundry-tjänster
...
- **Felsöka distributioner**: Lösa vanliga problem självständigt
...
- **Integration med Azure AI Foundry** - Smidig anslutning till AI Foundry-modellkatalog och slutpunkter
...
- [Grundläggande API](../../examples/basic-api) - Distribution av REST API

#### Databasintegration (Kapitel 3-4)  
- [Databasapp](../../examples/database-app) - Mönster för databasanslutning
- [Databehandling](../../examples/data-processing) - Distribution av ETL-arbetsflöden

#### Avancerade mönster (Kapitel 4-8)
- [Container-appar](../../examples/container-app) - Containeriserade distributioner
...
- [**Azure-Samples AZD-mallar**](https://github.com/Azure-Samples/azd-templates) - Officiella Microsoft-exempel
...
### Praktiska workshops
- [**AI Workshop Lab**](docs/ai-foundry/ai-workshop-lab.md) - Gör dina AI-lösningar AZD-distribuerbara (2-3 timmar)
- [**Interaktiv workshopguide**](workshop/README.md) - Webbläsarbaserad workshop med MkDocs och DevContainer-miljö
- [**Strukturerad inlärningsväg**](../../workshop/docs/instructions) - 7 steg guidade övningar (Upptäckt → Distribution → Anpassning)
...
### Framstegsspårning
Spåra din inlärningsframsteg genom varje kapitel:
...
- **Produktionsupplevelse**: Distribuerat verkliga AI-applikationer till Azure
- **Professionella färdigheter**: Företagsklara distributionsmöjligheter  
...
- **Största utmaningarna**: Multi-tjänstdistributioner, hantering av autentiseringsuppgifter, produktionsberedskap  
...
- **Översättning**: Hjälp till att upprätthålla stöd för flera språk  
- **Felsökning**: Förbättra noggrannhet och tydlighet  
