...
function Test-Prerequisites {
    ...
    # Kontrollera Azure CLI-installation
    try {
...
function Test-Permissions {
    ...
    try {
        ...
        # Testa skapande av resursgrupp (om angivet)
        if ($ResourceGroup) {
...
function Test-QuotasAndLimits {
    ...
    try {
        # Kontrollera beräkningskvoter
        $computeUsage = az vm list-usage --location $Location --output json | ConvertFrom-Json
        
        # Kontrollera specifika kvoter
        ...
        # Kontrollera App Service-gränser
        try {
...
function Test-TemplateValidation {
    ...
    # Kontrollera om azure.yaml finns
    ...
    # Kontrollera efter infrastrukturfiler
    if (Test-Path "infra") {
        $bicepFiles = Get-ChildItem -Path "infra" -Filter "*.bicep" -Recurse
        if ($bicepFiles.Count -gt 0) {
            Write-Status "Infrastructure templates" "Success" "$($bicepFiles.Count) Bicep files found"
            
            # Validera main.bicep om den finns
...
function Test-CostEstimation {
    ...
    # Grundläggande kostnadsuppskattning (skulle behöva Azure Pricing API för exakta uppskattningar)
    Write-Status "Cost estimation" "Info" "Use Azure Pricing Calculator for detailed estimates"
    Write-Status "Monitoring setup" "Info" "Set up Azure Cost Management alerts"
    
    # Kontrollera om budget finns
    try {
...
function Test-SecurityCompliance {
    ...
    # Kontrollera vanliga säkerhetspraxis
    try {
        # Kontrollera om Key Vault är konfigurerat
...
check_template_validation() {
    ...
    # Kontrollera azure.yaml
    if [[ -f "azure.yaml" ]]; then
        print_status "azure.yaml found" "success"
        
        # Grundläggande YAML-validering
    ...
    # Kontrollera infrastrukturfiler
    if [[ -d "infra" ]]; then
...
```bash
#!/bin/bash
# Valideringar specifika för utvecklingsmiljön
...
validate_dev_environment() {
    ...
    # Kontrollera konfigurationer för automatisk avstängning
...
validate_prod_environment() {
    ...
    # Kontrollera konfigurationer för hög tillgänglighet
    ...
    # Kontrollera konfigurationer för säkerhetskopiering
    ...
    # Kontrollera säkerhetskonfigurationer
...
def check_storage_limits(location: str) -> bool:
    ...
    # Hämta lagringskonton i prenumerationen
    ...
    max_accounts = 250  # Standardgräns för Azure
...
def check_network_limits(location: str) -> bool:
    ...
    # Kontrollera virtuella nätverk
    vnets = run_command(['az', 'network', 'vnet', 'list'])
    if vnets is not None:
        vnet_count = len(vnets)
        print(f"✅ Virtual Networks: {vnet_count}/1000")
    
    # Kontrollera offentliga IP-adresser
...
check_security_practices() {
    ...
    # Kontrollera användning av Key Vault
    ...
    # Kontrollera begränsningar för offentlig åtkomst
    ...
    # Kontrollera nätverkssäkerhetsgrupper
...
check_compliance_requirements() {
    ...
    # Kontrollera säkerhetskopierings- och behållningspolicyer
...
### ✅ Bästa praxis för förkontroller
...
4. **Tydlig rapportering**
   ...
   - Detaljerade felmeddelanden med åtgärdssteg
